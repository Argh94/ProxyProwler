...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:37 18-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `4.195.16.140` | `80` | 146.70ms | ✅ فعال |
| 2 | `212.47.232.28` | `80` | 140.91ms | ✅ فعال |
| 3 | `213.177.2.55` | `80` | 176.01ms | ✅ فعال |
| 4 | `47.89.184.18` | `3128` | 51.77ms | ✅ فعال |
| 5 | `221.202.27.194` | `10810` | 231.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 136.34ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 259.15ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 171.65ms | ✅ فعال |
| 4 | `72.37.217.3` | `4145` | 26.94ms | ✅ فعال |
| 5 | `145.223.46.128` | `5678` | 128.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 177.90ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 181.19ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 116.28ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 167.42ms | ✅ فعال |
| 5 | `94.130.177.190` | `9999` | 139.04ms | ✅ فعال |
