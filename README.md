...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:53 06-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `91.193.59.81` | `80` | 5.86ms | ✅ فعال |
| 2 | `104.18.10.78` | `80` | 5.99ms | ✅ فعال |
| 3 | `154.83.2.16` | `80` | 5.42ms | ✅ فعال |
| 4 | `87.121.49.238` | `4145` | 2178.92ms | ✅ فعال |
| 5 | `45.131.6.184` | `80` | 5.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.23.206.184` | `5990` | 11.66ms | ✅ فعال |
| 2 | `8.130.36.245` | `8080` | 258.08ms | ✅ فعال |
| 3 | `87.121.49.238` | `4145` | 125.19ms | ✅ فعال |
| 4 | `45.39.115.33` | `5444` | 35.17ms | ✅ فعال |
| 5 | `223.135.156.183` | `8080` | 176.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.84.182.59` | `80` | 5.56ms | ✅ فعال |
| 2 | `172.67.181.33` | `80` | 5.95ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 5.48ms | ✅ فعال |
| 4 | `45.12.31.28` | `80` | 6.33ms | ✅ فعال |
| 5 | `104.24.85.134` | `80` | 5.48ms | ✅ فعال |
