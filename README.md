...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:01 04-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.168.40` | `80` | 1.70ms | ✅ فعال |
| 2 | `103.160.204.92` | `80` | 1.50ms | ✅ فعال |
| 3 | `104.16.205.147` | `80` | 1.66ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 172.36ms | ✅ فعال |
| 5 | `104.21.231.230` | `80` | 18.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.220.92` | `17328` | 46.72ms | ✅ فعال |
| 2 | `139.59.1.14` | `1080` | 234.24ms | ✅ فعال |
| 3 | `8.213.197.208` | `9080` | 195.22ms | ✅ فعال |
| 4 | `45.8.211.218` | `80` | 1.62ms | ✅ فعال |
| 5 | `47.243.175.55` | `443` | 158.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.14.16` | `28080` | 171.43ms | ✅ فعال |
| 2 | `218.89.134.230` | `3333` | 218.88ms | ✅ فعال |
| 3 | `3.38.101.138` | `8337` | 133.48ms | ✅ فعال |
| 4 | `216.229.112.25` | `8080` | 51.73ms | ✅ فعال |
| 5 | `3.35.25.117` | `216` | 133.30ms | ✅ فعال |
