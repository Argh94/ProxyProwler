...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:52 21-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.58.190` | `4145` | 22.75ms | ✅ فعال |
| 2 | `197.221.249.198` | `80` | 288.91ms | ✅ فعال |
| 3 | `183.215.23.242` | `9091` | 218.63ms | ✅ فعال |
| 4 | `98.190.239.3` | `4145` | 110.45ms | ✅ فعال |
| 5 | `65.108.216.128` | `9050` | 173.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.161.27.244` | `995` | 139.02ms | ✅ فعال |
| 2 | `81.181.104.227` | `80` | 142.36ms | ✅ فعال |
| 3 | `86.21.239.166` | `9050` | 143.54ms | ✅ فعال |
| 4 | `176.9.62.93` | `1080` | 150.37ms | ✅ فعال |
| 5 | `209.141.35.94` | `28017` | 20.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 168.62ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 1303.03ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 63.67ms | ✅ فعال |
| 4 | `45.70.236.194` | `999` | 112.81ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 65.14ms | ✅ فعال |
