...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 02-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.117.102` | `80` | 2.36ms | ✅ فعال |
| 2 | `8.213.222.157` | `9999` | 196.92ms | ✅ فعال |
| 3 | `91.193.58.145` | `80` | 1.97ms | ✅ فعال |
| 4 | `139.177.229.215` | `8080` | 65.90ms | ✅ فعال |
| 5 | `104.20.52.233` | `80` | 1.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.11.111` | `51` | 205.93ms | ✅ فعال |
| 2 | `123.57.1.16` | `5555` | 203.79ms | ✅ فعال |
| 3 | `96.126.111.39` | `1081` | 67.29ms | ✅ فعال |
| 4 | `139.177.229.167` | `8080` | 72.17ms | ✅ فعال |
| 5 | `103.166.39.233` | `3629` | 1264.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 171.29ms | ✅ فعال |
| 2 | `115.178.49.143` | `8080` | 188.97ms | ✅ فعال |
| 3 | `45.225.207.183` | `999` | 2223.93ms | ✅ فعال |
| 4 | `157.175.43.137` | `8334` | 230.56ms | ✅ فعال |
| 5 | `43.198.99.209` | `8496` | 156.77ms | ✅ فعال |
