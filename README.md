...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 07-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.106.186` | `80` | 1.83ms | ✅ فعال |
| 2 | `104.19.126.103` | `80` | 10.25ms | ✅ فعال |
| 3 | `104.21.224.190` | `80` | 19.19ms | ✅ فعال |
| 4 | `185.221.160.4` | `80` | 2.44ms | ✅ فعال |
| 5 | `177.38.245.110` | `55713` | 191.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `201.174.239.28` | `4153` | 62.45ms | ✅ فعال |
| 2 | `167.172.86.46` | `10471` | 173.85ms | ✅ فعال |
| 3 | `1.20.227.66` | `4145` | 234.53ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 243.83ms | ✅ فعال |
| 5 | `202.40.181.220` | `31247` | 419.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.28.50` | `80` | 2.08ms | ✅ فعال |
| 2 | `45.80.108.229` | `80` | 2.01ms | ✅ فعال |
| 3 | `172.67.161.245` | `80` | 11.00ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 9.56ms | ✅ فعال |
| 5 | `104.19.66.163` | `80` | 1.97ms | ✅ فعال |
