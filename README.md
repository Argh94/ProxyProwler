...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:55 08-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.229.71` | `80` | 9.14ms | ✅ فعال |
| 2 | `45.80.111.24` | `80` | 9.19ms | ✅ فعال |
| 3 | `45.12.31.159` | `80` | 9.05ms | ✅ فعال |
| 4 | `185.162.228.7` | `80` | 8.93ms | ✅ فعال |
| 5 | `104.18.40.92` | `80` | 9.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `77.51.178.156` | `3629` | 180.87ms | ✅ فعال |
| 2 | `154.16.146.48` | `80` | 59.79ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 219.52ms | ✅ فعال |
| 4 | `47.116.210.163` | `8181` | 187.27ms | ✅ فعال |
| 5 | `45.56.71.129` | `1081` | 37.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.44.169.116` | `2526` | 136.56ms | ✅ فعال |
| 2 | `200.174.198.32` | `8888` | 164.21ms | ✅ فعال |
| 3 | `40.192.3.100` | `8141` | 1243.94ms | ✅ فعال |
| 4 | `54.180.143.12` | `38645` | 141.96ms | ✅ فعال |
| 5 | `78.12.220.164` | `52786` | 53.39ms | ✅ فعال |
