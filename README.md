...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 16-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `100` | 886.71ms | ✅ فعال |
| 2 | `104.19.206.119` | `80` | 6.13ms | ✅ فعال |
| 3 | `104.17.187.94` | `80` | 5.79ms | ✅ فعال |
| 4 | `141.101.123.80` | `80` | 5.86ms | ✅ فعال |
| 5 | `116.203.139.209` | `3128` | 90.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.246.130` | `6789` | 204.69ms | ✅ فعال |
| 2 | `47.243.175.55` | `443` | 204.94ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 232.11ms | ✅ فعال |
| 4 | `45.131.211.3` | `80` | 5.98ms | ✅ فعال |
| 5 | `72.195.34.42` | `4145` | 147.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.60.209.160` | `292` | 104.01ms | ✅ فعال |
| 2 | `13.115.193.75` | `9686` | 160.46ms | ✅ فعال |
| 3 | `199.48.129.114` | `3120` | 11.37ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 6.67ms | ✅ فعال |
| 5 | `51.20.184.59` | `1080` | 102.83ms | ✅ فعال |
