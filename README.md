...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 11-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `8889` | 152.64ms | ✅ فعال |
| 2 | `190.119.132.61` | `80` | 162.81ms | ✅ فعال |
| 3 | `147.45.175.151` | `3128` | 205.99ms | ✅ فعال |
| 4 | `185.162.228.160` | `80` | 1.62ms | ✅ فعال |
| 5 | `172.193.178.226` | `80` | 30.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.130.219.12` | `4153` | 147.67ms | ✅ فعال |
| 2 | `172.193.178.226` | `80` | 22.88ms | ✅ فعال |
| 3 | `8.215.3.250` | `119` | 185.40ms | ✅ فعال |
| 4 | `110.238.109.146` | `19` | 167.53ms | ✅ فعال |
| 5 | `174.77.111.196` | `4145` | 200.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `158.101.175.124` | `5566` | 182.32ms | ✅ فعال |
| 2 | `27.34.242.98` | `80` | 244.10ms | ✅ فعال |
| 3 | `78.12.193.250` | `52795` | 58.11ms | ✅ فعال |
| 4 | `40.192.16.115` | `297` | 214.62ms | ✅ فعال |
| 5 | `18.60.222.217` | `28731` | 221.80ms | ✅ فعال |
