...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 26-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `149.88.94.216` | `7890` | 209.81ms | ✅ فعال |
| 2 | `172.237.73.24` | `80` | 205.54ms | ✅ فعال |
| 3 | `45.43.64.193` | `6451` | 96.86ms | ✅ فعال |
| 4 | `46.17.47.48` | `80` | 162.87ms | ✅ فعال |
| 5 | `31.59.20.193` | `6771` | 95.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.58.18.236` | `6505` | 107.61ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 256.84ms | ✅ فعال |
| 3 | `198.105.111.29` | `6707` | 97.39ms | ✅ فعال |
| 4 | `45.43.70.137` | `6424` | 95.28ms | ✅ فعال |
| 5 | `20.57.138.93` | `1080` | 47.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 137.06ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1255.42ms | ✅ فعال |
| 3 | `179.96.28.58` | `80` | 152.88ms | ✅ فعال |
| 4 | `41.223.119.156` | `3128` | 260.89ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 205.75ms | ✅ فعال |
