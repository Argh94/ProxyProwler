...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:16 08-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `39.109.113.97` | `4090` | 217.54ms | ✅ فعال |
| 2 | `23.88.88.102` | `80` | 117.71ms | ✅ فعال |
| 3 | `20.78.118.91` | `8561` | 143.35ms | ✅ فعال |
| 4 | `27.34.242.98` | `80` | 232.71ms | ✅ فعال |
| 5 | `41.220.16.208` | `80` | 2355.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.221.203.121` | `4145` | 119.75ms | ✅ فعال |
| 2 | `5.10.246.144` | `80` | 1.86ms | ✅ فعال |
| 3 | `16.51.157.105` | `8080` | 196.26ms | ✅ فعال |
| 4 | `199.34.229.29` | `80` | 2.14ms | ✅ فعال |
| 5 | `199.229.254.129` | `4145` | 66.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.209.130.76` | `331` | 234.27ms | ✅ فعال |
| 2 | `43.198.99.209` | `10` | 192.29ms | ✅ فعال |
| 3 | `209.38.222.145` | `8080` | 122.18ms | ✅ فعال |
| 4 | `43.208.240.77` | `9007` | 1292.84ms | ✅ فعال |
| 5 | `13.59.97.103` | `20410` | 10.69ms | ✅ فعال |
