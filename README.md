...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:28 23-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.70` | `14282` | 71.41ms | ✅ فعال |
| 2 | `137.184.96.68` | `80` | 34.53ms | ✅ فعال |
| 3 | `162.248.165.72` | `1080` | 126.38ms | ✅ فعال |
| 4 | `205.209.118.30` | `3138` | 40.44ms | ✅ فعال |
| 5 | `43.167.227.161` | `1080` | 134.11ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (59 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.43.244.15` | `4153` | 147.25ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 152.67ms | ✅ فعال |
| 3 | `119.13.111.169` | `4006` | 198.89ms | ✅ فعال |
| 4 | `184.178.172.25` | `15291` | 156.74ms | ✅ فعال |
| 5 | `216.26.236.103` | `3129` | 23.67ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (20 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.122.187.196` | `80` | 2044.35ms | ✅ فعال |
| 2 | `45.136.130.217` | `8443` | 2089.61ms | ✅ فعال |
| 3 | `4.195.16.140` | `80` | 175.36ms | ✅ فعال |
| 4 | `35.224.171.0` | `80` | 28.31ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 117.21ms | ✅ فعال |
