...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:09 22-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.125.31.222` | `80` | 246.28ms | ✅ فعال |
| 2 | `40.89.145.14` | `80` | 124.53ms | ✅ فعال |
| 3 | `183.215.23.242` | `9091` | 259.52ms | ✅ فعال |
| 4 | `8.213.151.128` | `3128` | 176.17ms | ✅ فعال |
| 5 | `164.92.137.207` | `3128` | 115.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.113.219.226` | `59394` | 258.90ms | ✅ فعال |
| 2 | `47.243.175.55` | `443` | 183.70ms | ✅ فعال |
| 3 | `47.239.241.230` | `1111` | 186.35ms | ✅ فعال |
| 4 | `103.125.31.222` | `80` | 246.20ms | ✅ فعال |
| 5 | `8.220.136.174` | `1081` | 220.17ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (27 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.47.197.210` | `3128` | 133.22ms | ✅ فعال |
| 2 | `46.250.251.246` | `80` | 265.82ms | ✅ فعال |
| 3 | `51.79.135.131` | `8080` | 207.49ms | ✅ فعال |
| 4 | `45.136.130.175` | `8443` | 50.22ms | ✅ فعال |
| 5 | `4.195.16.140` | `80` | 184.87ms | ✅ فعال |
