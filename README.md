...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:09 23-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 180.38ms | ✅ فعال |
| 2 | `192.73.244.36` | `80` | 8.31ms | ✅ فعال |
| 3 | `216.26.236.103` | `3129` | 66.09ms | ✅ فعال |
| 4 | `45.167.124.52` | `8080` | 104.32ms | ✅ فعال |
| 5 | `141.98.153.86` | `80` | 143.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.161.81` | `4145` | 37.15ms | ✅ فعال |
| 2 | `47.254.153.78` | `999` | 139.72ms | ✅ فعال |
| 3 | `49.0.246.130` | `6789` | 153.51ms | ✅ فعال |
| 4 | `101.132.252.152` | `1337` | 196.01ms | ✅ فعال |
| 5 | `8.221.139.222` | `3128` | 109.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.60.196.214` | `80` | 128.37ms | ✅ فعال |
| 2 | `146.190.232.76` | `3128` | 134.76ms | ✅ فعال |
| 3 | `23.88.88.105` | `443` | 137.51ms | ✅ فعال |
| 4 | `23.247.136.254` | `80` | 24.79ms | ✅ فعال |
| 5 | `38.145.220.243` | `8443` | 1042.67ms | ✅ فعال |
