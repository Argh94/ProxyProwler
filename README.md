...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 02-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.174.138.183` | `80` | 8.80ms | ✅ فعال |
| 2 | `104.17.98.30` | `80` | 16.32ms | ✅ فعال |
| 3 | `8.148.22.214` | `20002` | 202.71ms | ✅ فعال |
| 4 | `46.254.92.163` | `80` | 10.01ms | ✅ فعال |
| 5 | `47.252.11.233` | `9080` | 63.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.40.181.220` | `31247` | 238.94ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 206.08ms | ✅ فعال |
| 3 | `201.148.125.126` | `4153` | 187.84ms | ✅ فعال |
| 4 | `47.254.36.213` | `9098` | 21.61ms | ✅ فعال |
| 5 | `38.154.233.163` | `5573` | 69.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.177.56.190` | `80` | 8.85ms | ✅ فعال |
| 2 | `45.131.7.142` | `80` | 8.84ms | ✅ فعال |
| 3 | `104.18.40.13` | `80` | 9.37ms | ✅ فعال |
| 4 | `206.238.236.139` | `80` | 8.85ms | ✅ فعال |
| 5 | `45.80.108.229` | `80` | 8.79ms | ✅ فعال |
