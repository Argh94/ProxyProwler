...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:22 29-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.233` | `10650` | 143.60ms | ✅ فعال |
| 2 | `206.123.156.224` | `15177` | 157.16ms | ✅ فعال |
| 3 | `8.209.255.13` | `3128` | 106.94ms | ✅ فعال |
| 4 | `206.123.156.196` | `6511` | 211.74ms | ✅ فعال |
| 5 | `206.123.156.200` | `4626` | 164.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.68.128.121` | `4145` | 127.24ms | ✅ فعال |
| 2 | `199.102.105.242` | `4145` | 22.90ms | ✅ فعال |
| 3 | `18.192.100.176` | `46` | 155.35ms | ✅ فعال |
| 4 | `104.200.152.30` | `4145` | 23.06ms | ✅ فعال |
| 5 | `8.213.215.187` | `30000` | 191.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `186.215.87.194` | `10312` | 203.39ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 175.24ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 174.38ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 180.69ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 127.28ms | ✅ فعال |
