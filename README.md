...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 15-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.11.133` | `80` | 12.19ms | ✅ فعال |
| 2 | `154.194.12.80` | `80` | 11.69ms | ✅ فعال |
| 3 | `47.74.46.81` | `45` | 836.99ms | ✅ فعال |
| 4 | `185.193.30.135` | `80` | 11.87ms | ✅ فعال |
| 5 | `185.162.230.47` | `80` | 14.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.200.152.30` | `4145` | 1125.00ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 1313.76ms | ✅ فعال |
| 3 | `107.181.154.202` | `5880` | 101.23ms | ✅ فعال |
| 4 | `178.185.221.186` | `8080` | 178.24ms | ✅ فعال |
| 5 | `185.191.165.28` | `1080` | 1195.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.20.192.194` | `20279` | 129.28ms | ✅ فعال |
| 2 | `43.208.25.125` | `21503` | 223.66ms | ✅ فعال |
| 3 | `91.121.106.55` | `4444` | 109.70ms | ✅ فعال |
| 4 | `78.12.223.246` | `54126` | 99.23ms | ✅ فعال |
| 5 | `43.208.251.198` | `80` | 223.35ms | ✅ فعال |
