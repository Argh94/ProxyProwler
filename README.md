...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:01 02-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `93.184.4.254` | `1080` | 124.18ms | ✅ فعال |
| 2 | `58.19.55.4` | `15087` | 236.82ms | ✅ فعال |
| 3 | `184.182.240.12` | `4145` | 86.38ms | ✅ فعال |
| 4 | `20.27.14.220` | `8561` | 155.34ms | ✅ فعال |
| 5 | `156.255.1.102` | `6666` | 100.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.18.217` | `6798` | 69.97ms | ✅ فعال |
| 2 | `135.181.45.223` | `9090` | 120.02ms | ✅ فعال |
| 3 | `191.101.25.84` | `6481` | 70.46ms | ✅ فعال |
| 4 | `152.32.132.190` | `7890` | 217.91ms | ✅ فعال |
| 5 | `203.190.8.59` | `1088` | 244.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.141.62.12` | `5555` | 57.72ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 157.25ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 229.01ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 220.15ms | ✅ فعال |
| 5 | `209.141.54.136` | `5555` | 76.52ms | ✅ فعال |
