...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:57 15-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.195.61.240` | `1080` | 90.09ms | ✅ فعال |
| 2 | `123.58.219.171` | `10808` | 202.31ms | ✅ فعال |
| 3 | `188.215.5.249` | `5279` | 62.01ms | ✅ فعال |
| 4 | `74.119.144.60` | `4145` | 60.07ms | ✅ فعال |
| 5 | `45.137.43.0` | `1081` | 99.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.85` | `193` | 644.84ms | ✅ فعال |
| 2 | `149.129.226.9` | `1080` | 238.75ms | ✅ فعال |
| 3 | `173.214.176.202` | `6173` | 65.70ms | ✅ فعال |
| 4 | `146.103.3.16` | `7069` | 83.02ms | ✅ فعال |
| 5 | `82.132.19.108` | `4153` | 109.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `71.14.23.121` | `8080` | 1025.75ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 3.34ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 158.61ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 3.74ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 119.32ms | ✅ فعال |
