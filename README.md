...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 02-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.9.206` | `80` | 6.14ms | ✅ فعال |
| 2 | `8.213.215.187` | `1081` | 255.52ms | ✅ فعال |
| 3 | `45.131.208.51` | `80` | 5.73ms | ✅ فعال |
| 4 | `192.111.139.162` | `4145` | 52.63ms | ✅ فعال |
| 5 | `206.238.237.4` | `80` | 5.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.224.56.162` | `10001` | 197.51ms | ✅ فعال |
| 2 | `45.43.81.33` | `5680` | 83.31ms | ✅ فعال |
| 3 | `47.243.50.83` | `81` | 204.74ms | ✅ فعال |
| 4 | `47.243.175.55` | `443` | 204.93ms | ✅ فعال |
| 5 | `119.13.111.169` | `4006` | 229.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.177.211.224` | `8705` | 76.23ms | ✅ فعال |
| 2 | `216.229.112.25` | `8080` | 43.56ms | ✅ فعال |
| 3 | `158.69.185.37` | `3129` | 25.09ms | ✅ فعال |
| 4 | `179.96.28.58` | `80` | 136.34ms | ✅ فعال |
| 5 | `116.203.139.209` | `3128` | 90.68ms | ✅ فعال |
