...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:39 24-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.150.152.27` | `84` | 219.65ms | ✅ فعال |
| 2 | `98.178.72.21` | `10919` | 92.68ms | ✅ فعال |
| 3 | `178.216.152.110` | `1191` | 168.50ms | ✅ فعال |
| 4 | `8.220.205.172` | `1337` | 164.94ms | ✅ فعال |
| 5 | `94.156.114.45` | `1080` | 127.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `50.238.47.86` | `32100` | 22.44ms | ✅ فعال |
| 2 | `47.91.89.3` | `139` | 113.65ms | ✅ فعال |
| 3 | `8.220.205.172` | `1337` | 166.40ms | ✅ فعال |
| 4 | `182.53.216.73` | `4145` | 2272.61ms | ✅ فعال |
| 5 | `197.221.240.178` | `80` | 250.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 223.36ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 16.29ms | ✅ فعال |
| 3 | `110.164.175.110` | `8080` | 238.48ms | ✅ فعال |
| 4 | `36.94.185.122` | `60080` | 276.53ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 220.93ms | ✅ فعال |
