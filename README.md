...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 29-10-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (22 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.214.108.67` | `4145` | 87.92ms | ✅ فعال |
| 2 | `181.78.202.28` | `8080` | 103.83ms | ✅ فعال |
| 3 | `166.88.235.34` | `5662` | 47.26ms | ✅ فعال |
| 4 | `141.105.107.152` | `5678` | 1198.88ms | ✅ فعال |
| 5 | `98.188.47.132` | `4145` | 114.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.68.1` | `8081` | 123.59ms | ✅ فعال |
| 2 | `216.74.115.213` | `6807` | 52.15ms | ✅ فعال |
| 3 | `72.195.114.169` | `4145` | 96.83ms | ✅ فعال |
| 4 | `72.37.216.68` | `4145` | 65.05ms | ✅ فعال |
| 5 | `5.199.173.161` | `9089` | 135.43ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (39 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.229.106.200` | `14541` | 196.25ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 135.90ms | ✅ فعال |
| 3 | `43.216.1.13` | `9746` | 201.37ms | ✅ فعال |
| 4 | `13.59.97.103` | `33386` | 23.09ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 23.63ms | ✅ فعال |
