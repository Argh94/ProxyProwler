...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:30 16-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `164.215.97.157` | `10808` | 136.37ms | ✅ فعال |
| 2 | `144.91.111.48` | `1088` | 130.32ms | ✅ فعال |
| 3 | `163.192.14.135` | `50161` | 44.86ms | ✅ فعال |
| 4 | `40.160.27.66` | `1080` | 20.59ms | ✅ فعال |
| 5 | `192.111.139.165` | `4145` | 69.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `83.143.29.161` | `1080` | 239.75ms | ✅ فعال |
| 2 | `199.102.106.94` | `4145` | 63.13ms | ✅ فعال |
| 3 | `8.209.96.245` | `5060` | 107.42ms | ✅ فعال |
| 4 | `184.178.172.23` | `4145` | 93.50ms | ✅ فعال |
| 5 | `24.249.199.4` | `4145` | 103.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 221.39ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 21.33ms | ✅ فعال |
| 3 | `45.174.168.36` | `999` | 1109.83ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 18.51ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 133.52ms | ✅ فعال |
