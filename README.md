...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 03-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `196.1.93.16` | `80` | 189.39ms | ✅ فعال |
| 2 | `39.102.214.152` | `8090` | 222.33ms | ✅ فعال |
| 3 | `98.188.47.132` | `4145` | 143.00ms | ✅ فعال |
| 4 | `152.232.15.52` | `8220` | 58.24ms | ✅ فعال |
| 5 | `193.222.99.32` | `1080` | 161.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.235.9` | `4145` | 24.79ms | ✅ فعال |
| 2 | `101.255.166.134` | `80` | 2258.55ms | ✅ فعال |
| 3 | `8.221.138.111` | `8072` | 117.83ms | ✅ فعال |
| 4 | `185.226.207.90` | `5639` | 138.45ms | ✅ فعال |
| 5 | `37.18.73.60` | `5566` | 180.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 178.52ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 175.01ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 119.81ms | ✅ فعال |
