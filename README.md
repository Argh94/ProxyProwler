...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:53 01-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `205.233.181.173` | `80` | 2.27ms | ✅ فعال |
| 2 | `192.252.208.70` | `14282` | 52.58ms | ✅ فعال |
| 3 | `159.246.55.113` | `80` | 2.58ms | ✅ فعال |
| 4 | `82.26.208.80` | `5387` | 7.63ms | ✅ فعال |
| 5 | `104.25.180.251` | `80` | 2.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 207.92ms | ✅ فعال |
| 2 | `87.239.31.42` | `80` | 126.70ms | ✅ فعال |
| 3 | `101.200.158.109` | `3128` | 211.28ms | ✅ فعال |
| 4 | `82.26.208.80` | `5387` | 7.89ms | ✅ فعال |
| 5 | `146.59.202.70` | `80` | 86.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.26.109` | `80` | 1.86ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 2.40ms | ✅ فعال |
| 3 | `173.245.49.93` | `80` | 8.01ms | ✅ فعال |
| 4 | `188.114.96.63` | `80` | 2.30ms | ✅ فعال |
| 5 | `216.24.57.248` | `80` | 1.71ms | ✅ فعال |
