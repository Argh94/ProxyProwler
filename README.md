...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:57 01-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `178.18.207.85` | `8888` | 170.52ms | ✅ فعال |
| 2 | `109.199.119.160` | `80` | 120.15ms | ✅ فعال |
| 3 | `94.78.67.171` | `80` | 162.58ms | ✅ فعال |
| 4 | `8.213.151.128` | `3128` | 163.66ms | ✅ فعال |
| 5 | `144.124.232.204` | `5222` | 112.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 252.25ms | ✅ فعال |
| 2 | `178.18.207.85` | `8888` | 1191.51ms | ✅ فعال |
| 3 | `8.213.128.6` | `8080` | 157.62ms | ✅ فعال |
| 4 | `220.158.232.118` | `1080` | 227.35ms | ✅ فعال |
| 5 | `34.44.49.215` | `80` | 26.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 215.43ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 196.28ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 161.57ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 134.93ms | ✅ فعال |
| 5 | `181.78.10.110` | `999` | 108.83ms | ✅ فعال |
