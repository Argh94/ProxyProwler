...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:05 30-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.235.9` | `4145` | 77.10ms | ✅ فعال |
| 2 | `155.254.38.238` | `5914` | 76.83ms | ✅ فعال |
| 3 | `142.54.226.214` | `4145` | 77.12ms | ✅ فعال |
| 4 | `85.198.82.207` | `1080` | 125.02ms | ✅ فعال |
| 5 | `47.91.29.151` | `9080` | 162.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `128.199.104.190` | `41354` | 2298.63ms | ✅ فعال |
| 2 | `67.203.23.79` | `8081` | 70.10ms | ✅ فعال |
| 3 | `13.214.205.160` | `40448` | 223.17ms | ✅ فعال |
| 4 | `77.222.54.205` | `3128` | 126.64ms | ✅ فعال |
| 5 | `185.49.31.205` | `8080` | 103.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.172.70.203` | `8080` | 1312.61ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 223.09ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 118.78ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 236.16ms | ✅ فعال |
| 5 | `177.234.217.238` | `999` | 2202.89ms | ✅ فعال |
