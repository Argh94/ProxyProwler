...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:39 02-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `91.107.148.58` | `53967` | 92.63ms | ✅ فعال |
| 2 | `51.141.175.118` | `80` | 71.34ms | ✅ فعال |
| 3 | `104.200.135.46` | `4145` | 71.29ms | ✅ فعال |
| 4 | `172.193.178.226` | `80` | 73.17ms | ✅ فعال |
| 5 | `72.49.49.11` | `31034` | 136.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.154.65` | `5743` | 76.58ms | ✅ فعال |
| 2 | `8.221.139.222` | `5060` | 166.07ms | ✅ فعال |
| 3 | `8.221.139.222` | `9098` | 155.66ms | ✅ فعال |
| 4 | `103.166.39.233` | `3629` | 246.02ms | ✅ فعال |
| 5 | `38.145.208.187` | `8443` | 57.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 93.09ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 163.13ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 373.04ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 222.57ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 218.82ms | ✅ فعال |
