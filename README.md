...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 13-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.107.168` | `80` | 5.86ms | ✅ فعال |
| 2 | `104.16.2.149` | `80` | 5.67ms | ✅ فعال |
| 3 | `104.17.173.56` | `80` | 6.51ms | ✅ فعال |
| 4 | `108.162.196.218` | `80` | 5.79ms | ✅ فعال |
| 5 | `184.168.47.192` | `80` | 5.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.160.16.234` | `8020` | 227.22ms | ✅ فعال |
| 2 | `203.160.59.249` | `4145` | 249.27ms | ✅ فعال |
| 3 | `47.113.219.226` | `59394` | 258.80ms | ✅ فعال |
| 4 | `27.77.238.72` | `1080` | 234.39ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 117.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.223.119.156` | `3128` | 239.04ms | ✅ فعال |
| 2 | `47.129.154.60` | `10021` | 225.67ms | ✅ فعال |
| 3 | `167.249.52.214` | `999` | 139.26ms | ✅ فعال |
| 4 | `13.232.2.142` | `404` | 200.76ms | ✅ فعال |
| 5 | `18.143.173.102` | `33937` | 227.42ms | ✅ فعال |
