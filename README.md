...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 20-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.1.57` | `80` | 2.77ms | ✅ فعال |
| 2 | `172.67.176.154` | `80` | 1.59ms | ✅ فعال |
| 3 | `45.80.108.108` | `80` | 2.07ms | ✅ فعال |
| 4 | `45.131.4.161` | `80` | 2.59ms | ✅ فعال |
| 5 | `68.1.210.189` | `4145` | 179.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.109.83.196` | `9098` | 261.08ms | ✅ فعال |
| 2 | `198.199.86.11` | `80` | 27.44ms | ✅ فعال |
| 3 | `39.104.62.128` | `5000` | 250.58ms | ✅ فعال |
| 4 | `101.132.248.7` | `1337` | 228.30ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 270.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.16.49.113` | `8585` | 308.87ms | ✅ فعال |
| 2 | `162.240.154.26` | `3128` | 36.69ms | ✅ فعال |
| 3 | `164.163.40.15` | `10000` | 162.51ms | ✅ فعال |
| 4 | `115.114.77.133` | `9090` | 219.23ms | ✅ فعال |
| 5 | `13.36.243.194` | `9239` | 103.27ms | ✅ فعال |
