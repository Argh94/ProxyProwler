...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:51 14-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `170.114.45.179` | `80` | 2.10ms | ✅ فعال |
| 2 | `165.22.204.47` | `3128` | 1132.25ms | ✅ فعال |
| 3 | `5.182.34.227` | `80` | 2.61ms | ✅ فعال |
| 4 | `47.74.46.81` | `80` | 163.54ms | ✅ فعال |
| 5 | `8.211.49.86` | `80` | 777.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `14.225.240.23` | `8562` | 1272.91ms | ✅ فعال |
| 2 | `185.216.106.65` | `6142` | 53.77ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 1171.52ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 250.09ms | ✅ فعال |
| 5 | `213.147.107.178` | `4153` | 1175.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.211.217` | `80` | 1.99ms | ✅ فعال |
| 2 | `104.24.85.134` | `80` | 2.97ms | ✅ فعال |
| 3 | `45.131.7.159` | `80` | 2.40ms | ✅ فعال |
| 4 | `45.80.108.229` | `80` | 1.92ms | ✅ فعال |
| 5 | `103.39.49.156` | `3128` | 241.76ms | ✅ فعال |
