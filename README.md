...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:25 11-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `20.27.14.220` | `8561` | 109.49ms | ✅ فعال |
| 2 | `46.29.162.166` | `80` | 205.43ms | ✅ فعال |
| 3 | `162.245.85.36` | `80` | 79.08ms | ✅ فعال |
| 4 | `113.108.13.120` | `4433` | 217.04ms | ✅ فعال |
| 5 | `4.213.98.253` | `80` | 229.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 212.57ms | ✅ فعال |
| 2 | `8.221.141.88` | `9098` | 108.34ms | ✅ فعال |
| 3 | `98.182.147.97` | `4145` | 119.02ms | ✅ فعال |
| 4 | `45.80.108.234` | `80` | 11.53ms | ✅ فعال |
| 5 | `98.181.137.80` | `4145` | 121.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.141.124` | `8326` | 183.13ms | ✅ فعال |
| 2 | `16.78.82.73` | `48293` | 191.64ms | ✅ فعال |
| 3 | `13.232.2.142` | `20161` | 231.07ms | ✅ فعال |
| 4 | `40.192.105.58` | `51056` | 218.54ms | ✅ فعال |
| 5 | `40.177.211.224` | `181` | 57.62ms | ✅ فعال |
