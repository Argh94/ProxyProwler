...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 04-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.5.200` | `80` | 17.83ms | ✅ فعال |
| 2 | `45.80.111.216` | `80` | 17.93ms | ✅ فعال |
| 3 | `172.67.180.19` | `80` | 17.64ms | ✅ فعال |
| 4 | `89.116.250.138` | `80` | 17.40ms | ✅ فعال |
| 5 | `185.162.231.66` | `80` | 17.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.0.162` | `7302` | 250.46ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 17.72ms | ✅ فعال |
| 3 | `185.193.29.18` | `80` | 18.18ms | ✅ فعال |
| 4 | `101.200.158.109` | `8880` | 231.50ms | ✅ فعال |
| 5 | `101.132.222.120` | `80` | 201.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.118.80` | `80` | 17.93ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 181.84ms | ✅ فعال |
| 3 | `104.25.1.112` | `80` | 19.08ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 17.69ms | ✅ فعال |
| 5 | `69.84.182.59` | `80` | 18.03ms | ✅ فعال |
