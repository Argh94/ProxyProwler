...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:50 07-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `8443` | 838.13ms | ✅ فعال |
| 2 | `72.207.33.64` | `4145` | 91.44ms | ✅ فعال |
| 3 | `43.133.90.161` | `8088` | 1203.36ms | ✅ فعال |
| 4 | `98.175.31.195` | `4145` | 109.12ms | ✅ فعال |
| 5 | `47.83.3.52` | `26426` | 1250.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.10.27.28` | `6706` | 66.39ms | ✅ فعال |
| 2 | `45.43.70.71` | `6358` | 84.36ms | ✅ فعال |
| 3 | `68.71.249.153` | `48606` | 78.68ms | ✅ فعال |
| 4 | `146.103.121.43` | `11080` | 113.52ms | ✅ فعال |
| 5 | `31.58.18.250` | `6519` | 84.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 171.80ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 224.32ms | ✅ فعال |
| 3 | `13.127.170.8` | `3128` | 239.28ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 119.40ms | ✅ فعال |
