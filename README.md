...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:32 12-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.151.128` | `3128` | 137.80ms | ✅ فعال |
| 2 | `50.250.205.21` | `32100` | 24.15ms | ✅ فعال |
| 3 | `184.185.2.12` | `4145` | 133.38ms | ✅ فعال |
| 4 | `62.60.239.29` | `3128` | 159.72ms | ✅ فعال |
| 5 | `104.253.77.157` | `5579` | 28.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.52.13.164` | `5678` | 162.02ms | ✅ فعال |
| 2 | `138.68.3.159` | `3128` | 16.51ms | ✅ فعال |
| 3 | `183.88.240.139` | `4153` | 1251.79ms | ✅ فعال |
| 4 | `13.125.44.24` | `80` | 138.87ms | ✅ فعال |
| 5 | `124.6.225.124` | `1088` | 251.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 188.00ms | ✅ فعال |
| 2 | `103.125.38.50` | `8080` | 1213.46ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 120.64ms | ✅ فعال |
| 4 | `45.230.170.13` | `999` | 77.94ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 2235.45ms | ✅ فعال |
