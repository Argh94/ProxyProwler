...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 01-08-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (23 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.61.200.104` | `36181` | 1131.56ms | ✅ فعال |
| 2 | `174.77.111.198` | `49547` | 125.03ms | ✅ فعال |
| 3 | `134.249.136.106` | `8080` | 226.15ms | ✅ فعال |
| 4 | `184.170.249.65` | `4145` | 135.88ms | ✅ فعال |
| 5 | `198.144.190.195` | `6042` | 63.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.113.66.208` | `5889` | 150.78ms | ✅ فعال |
| 2 | `34.222.65.100` | `1976` | 20.70ms | ✅ فعال |
| 3 | `213.19.205.198` | `1080` | 1206.76ms | ✅ فعال |
| 4 | `104.21.46.106` | `80` | 10.65ms | ✅ فعال |
| 5 | `136.0.126.37` | `5798` | 8.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.230.130` | `80` | 2.04ms | ✅ فعال |
| 2 | `195.245.221.183` | `80` | 2.03ms | ✅ فعال |
| 3 | `45.8.211.248` | `80` | 2.10ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 10.95ms | ✅ فعال |
| 5 | `45.131.4.9` | `80` | 1.97ms | ✅ فعال |
