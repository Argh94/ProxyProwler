...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:51 19-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.89.3` | `8040` | 94.65ms | ✅ فعال |
| 2 | `193.25.215.182` | `22222` | 108.99ms | ✅ فعال |
| 3 | `185.99.98.65` | `40001` | 122.63ms | ✅ فعال |
| 4 | `43.128.63.68` | `7890` | 209.20ms | ✅ فعال |
| 5 | `47.76.144.139` | `80` | 212.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.128.63.68` | `7890` | 1204.26ms | ✅ فعال |
| 2 | `98.103.88.158` | `46104` | 2095.81ms | ✅ فعال |
| 3 | `185.226.204.12` | `5565` | 82.48ms | ✅ فعال |
| 4 | `47.91.89.3` | `8040` | 329.85ms | ✅ فعال |
| 5 | `159.192.97.129` | `5678` | 2321.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 121.33ms | ✅ فعال |
| 2 | `131.100.48.73` | `999` | 85.43ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 236.02ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 257.12ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 229.61ms | ✅ فعال |
