...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 15-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.33.77` | `80` | 1.65ms | ✅ فعال |
| 2 | `104.16.186.5` | `80` | 1.78ms | ✅ فعال |
| 3 | `172.67.139.128` | `80` | 1.73ms | ✅ فعال |
| 4 | `160.153.0.26` | `80` | 1.83ms | ✅ فعال |
| 5 | `47.238.128.246` | `8181` | 161.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.8.60.34` | `1080` | 218.63ms | ✅ فعال |
| 2 | `85.102.10.94` | `4153` | 191.70ms | ✅ فعال |
| 3 | `174.77.111.197` | `4145` | 120.97ms | ✅ فعال |
| 4 | `46.188.2.42` | `5678` | 188.75ms | ✅ فعال |
| 5 | `89.237.33.193` | `51549` | 2257.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 198.38ms | ✅ فعال |
| 2 | `43.208.25.125` | `21503` | 200.42ms | ✅ فعال |
| 3 | `18.188.141.177` | `57521` | 60.55ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 175.75ms | ✅ فعال |
| 5 | `78.12.223.246` | `54126` | 70.20ms | ✅ فعال |
