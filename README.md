...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 10-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.104.195` | `80` | 5.90ms | ✅ فعال |
| 2 | `24.249.199.12` | `4145` | 90.39ms | ✅ فعال |
| 3 | `185.148.107.169` | `80` | 5.90ms | ✅ فعال |
| 4 | `104.24.3.102` | `80` | 5.97ms | ✅ فعال |
| 5 | `185.148.107.80` | `80` | 6.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.22.214` | `80` | 254.85ms | ✅ فعال |
| 2 | `39.104.62.128` | `5000` | 262.31ms | ✅ فعال |
| 3 | `47.113.221.120` | `3127` | 254.45ms | ✅ فعال |
| 4 | `116.100.223.56` | `1080` | 239.65ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 265.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.125.7.17` | `1036` | 197.10ms | ✅ فعال |
| 2 | `82.115.24.134` | `9090` | 96.16ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 247.92ms | ✅ فعال |
| 4 | `194.87.77.22` | `80` | 94.79ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 5.90ms | ✅ فعال |
