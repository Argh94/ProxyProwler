...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:39 28-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.241.125.46` | `8090` | 58.23ms | ✅ فعال |
| 2 | `186.246.14.205` | `9050` | 169.07ms | ✅ فعال |
| 3 | `111.119.162.248` | `10941` | 191.24ms | ✅ فعال |
| 4 | `142.54.226.214` | `4145` | 93.04ms | ✅ فعال |
| 5 | `72.207.33.64` | `4145` | 85.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.87.74` | `9050` | 69.52ms | ✅ فعال |
| 2 | `47.242.155.74` | `12522` | 201.23ms | ✅ فعال |
| 3 | `8.213.128.6` | `8192` | 183.98ms | ✅ فعال |
| 4 | `176.53.182.170` | `1080` | 622.14ms | ✅ فعال |
| 5 | `23.229.126.140` | `7669` | 55.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 161.00ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 235.30ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 222.29ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 110.39ms | ✅ فعال |
