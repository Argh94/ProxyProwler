...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:44 14-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.28.1` | `80` | 1.82ms | ✅ فعال |
| 2 | `8.211.194.78` | `3128` | 77.51ms | ✅ فعال |
| 3 | `107.152.98.5` | `4145` | 71.41ms | ✅ فعال |
| 4 | `192.111.130.2` | `4145` | 203.61ms | ✅ فعال |
| 5 | `104.24.91.178` | `80` | 7.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.20.227.66` | `4145` | 1294.74ms | ✅ فعال |
| 2 | `39.100.88.89` | `8080` | 251.19ms | ✅ فعال |
| 3 | `191.96.202.118` | `6164` | 68.95ms | ✅ فعال |
| 4 | `101.200.158.109` | `3128` | 254.03ms | ✅ فعال |
| 5 | `160.251.142.232` | `80` | 174.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.247.49` | `80` | 1.81ms | ✅ فعال |
| 2 | `23.227.39.103` | `80` | 2.39ms | ✅ فعال |
| 3 | `104.16.1.135` | `80` | 2.05ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 1.95ms | ✅ فعال |
| 5 | `104.18.40.13` | `80` | 1.77ms | ✅ فعال |
