...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 27-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.31.55` | `80` | 1.60ms | ✅ فعال |
| 2 | `141.101.123.57` | `80` | 1.79ms | ✅ فعال |
| 3 | `104.25.130.252` | `80` | 2.22ms | ✅ فعال |
| 4 | `108.162.193.246` | `80` | 1.67ms | ✅ فعال |
| 5 | `192.111.137.37` | `18762` | 89.74ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (67 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.16.199` | `30756` | 195.31ms | ✅ فعال |
| 2 | `110.238.116.82` | `55443` | 207.55ms | ✅ فعال |
| 3 | `5.199.174.153` | `9102` | 172.29ms | ✅ فعال |
| 4 | `93.127.163.52` | `80` | 145.51ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 203.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.216.111.113` | `80` | 72.76ms | ✅ فعال |
| 2 | `78.12.249.123` | `8019` | 57.83ms | ✅ فعال |
| 3 | `43.209.130.76` | `46487` | 196.85ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 111.02ms | ✅ فعال |
| 5 | `15.160.148.69` | `845` | 152.67ms | ✅ فعال |
