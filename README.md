...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 02-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.160.204.108` | `80` | 2.04ms | ✅ فعال |
| 2 | `104.18.17.56` | `80` | 1.76ms | ✅ فعال |
| 3 | `185.148.106.5` | `80` | 1.82ms | ✅ فعال |
| 4 | `154.194.12.250` | `80` | 1.75ms | ✅ فعال |
| 5 | `185.148.106.79` | `80` | 2.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.65.113.132` | `1080` | 180.11ms | ✅ فعال |
| 2 | `49.0.199.132` | `19` | 206.11ms | ✅ فعال |
| 3 | `91.198.95.61` | `5583` | 19.33ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 294.93ms | ✅ فعال |
| 5 | `43.210.30.230` | `507` | 195.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.176.96.235` | `25473` | 37.19ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 168.84ms | ✅ فعال |
| 3 | `164.163.40.15` | `10000` | 191.39ms | ✅ فعال |
| 4 | `43.208.129.50` | `5052` | 197.03ms | ✅ فعال |
| 5 | `43.198.185.30` | `464` | 153.23ms | ✅ فعال |
