...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:05 08-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.65.23` | `3128` | 133.68ms | ✅ فعال |
| 2 | `23.88.88.102` | `443` | 134.73ms | ✅ فعال |
| 3 | `184.181.217.210` | `4145` | 200.59ms | ✅ فعال |
| 4 | `91.84.117.49` | `10880` | 125.63ms | ✅ فعال |
| 5 | `185.172.3.70` | `8081` | 230.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.182.183` | `80` | 17.97ms | ✅ فعال |
| 2 | `46.8.69.113` | `8888` | 158.86ms | ✅ فعال |
| 3 | `193.221.203.121` | `5678` | 139.40ms | ✅ فعال |
| 4 | `174.77.111.198` | `49547` | 127.59ms | ✅ فعال |
| 5 | `193.221.203.121` | `8080` | 145.11ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (59 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.36.243.194` | `19077` | 122.12ms | ✅ فعال |
| 2 | `78.12.223.246` | `844` | 44.80ms | ✅ فعال |
| 3 | `51.85.49.118` | `58366` | 165.48ms | ✅ فعال |
| 4 | `40.177.211.224` | `4221` | 66.04ms | ✅ فعال |
| 5 | `78.12.193.250` | `10880` | 44.82ms | ✅ فعال |
