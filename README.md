...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 30-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.107.125` | `80` | 2.25ms | ✅ فعال |
| 2 | `45.80.111.29` | `80` | 2.37ms | ✅ فعال |
| 3 | `172.67.70.195` | `80` | 2.48ms | ✅ فعال |
| 4 | `185.148.104.217` | `80` | 1.89ms | ✅ فعال |
| 5 | `104.16.0.249` | `80` | 1.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.8.69.113` | `8080` | 258.68ms | ✅ فعال |
| 2 | `39.104.62.128` | `5000` | 229.34ms | ✅ فعال |
| 3 | `84.21.172.174` | `4145` | 173.86ms | ✅ فعال |
| 4 | `123.57.1.16` | `5555` | 219.27ms | ✅ فعال |
| 5 | `103.166.39.81` | `3629` | 211.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.109.113.97` | `4090` | 157.67ms | ✅ فعال |
| 2 | `34.96.238.40` | `8080` | 155.61ms | ✅ فعال |
| 3 | `27.34.242.98` | `80` | 234.84ms | ✅ فعال |
| 4 | `15.160.134.84` | `19386` | 165.45ms | ✅ فعال |
| 5 | `16.78.82.73` | `48293` | 183.21ms | ✅ فعال |
