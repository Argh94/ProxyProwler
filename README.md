...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:52 05-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.171.83.26` | `8080` | 2.49ms | ✅ فعال |
| 2 | `178.212.144.7` | `80` | 104.95ms | ✅ فعال |
| 3 | `8.211.194.85` | `100` | 77.03ms | ✅ فعال |
| 4 | `36.95.39.122` | `1080` | 2299.46ms | ✅ فعال |
| 5 | `138.124.59.186` | `1080` | 117.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.36.213` | `8888` | 65.54ms | ✅ فعال |
| 2 | `178.220.148.82` | `10801` | 115.59ms | ✅ فعال |
| 3 | `41.216.232.213` | `4153` | 2247.24ms | ✅ فعال |
| 4 | `151.145.63.243` | `1080` | 16.81ms | ✅ فعال |
| 5 | `192.144.15.110` | `1080` | 123.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.141.62.12` | `5555` | 64.18ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 2.52ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 244.37ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 118.41ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 10.13ms | ✅ فعال |
