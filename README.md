...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:15 30-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `183.215.23.242` | `9091` | 209.30ms | ✅ فعال |
| 2 | `47.238.130.212` | `8443` | 160.46ms | ✅ فعال |
| 3 | `12.50.107.221` | `80` | 65.09ms | ✅ فعال |
| 4 | `14.225.230.136` | `3128` | 177.03ms | ✅ فعال |
| 5 | `48.210.225.96` | `80` | 105.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.214.108.67` | `4145` | 166.56ms | ✅ فعال |
| 2 | `156.246.90.81` | `80` | 107.67ms | ✅ فعال |
| 3 | `185.114.89.74` | `1080` | 1216.89ms | ✅ فعال |
| 4 | `119.13.111.169` | `18081` | 172.66ms | ✅ فعال |
| 5 | `107.181.148.220` | `6080` | 135.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 155.89ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 111.74ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 172.36ms | ✅ فعال |
| 4 | `8.212.168.170` | `1111` | 758.60ms | ✅ فعال |
| 5 | `34.140.137.151` | `80` | 140.94ms | ✅ فعال |
