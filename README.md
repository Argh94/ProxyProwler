...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 11-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.237.224` | `80` | 2.75ms | ✅ فعال |
| 2 | `45.43.70.77` | `6364` | 77.50ms | ✅ فعال |
| 3 | `172.67.167.59` | `80` | 2.21ms | ✅ فعال |
| 4 | `107.172.156.186` | `5834` | 23.60ms | ✅ فعال |
| 5 | `104.21.57.236` | `80` | 2.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.104.62.128` | `5000` | 255.26ms | ✅ فعال |
| 2 | `116.100.223.56` | `1080` | 245.96ms | ✅ فعال |
| 3 | `8.209.68.1` | `8081` | 91.35ms | ✅ فعال |
| 4 | `109.248.236.150` | `60606` | 160.41ms | ✅ فعال |
| 5 | `27.73.21.139` | `1080` | 256.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `4.149.153.123` | `3128` | 72.68ms | ✅ فعال |
| 2 | `13.212.14.16` | `12747` | 230.82ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 3.05ms | ✅ فعال |
| 4 | `15.236.38.248` | `21` | 86.05ms | ✅ فعال |
| 5 | `195.225.109.132` | `3128` | 124.88ms | ✅ فعال |
