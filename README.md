...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 20-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.92.9.29` | `80` | 14.98ms | ✅ فعال |
| 2 | `8.221.141.88` | `3128` | 134.76ms | ✅ فعال |
| 3 | `23.227.60.68` | `80` | 15.87ms | ✅ فعال |
| 4 | `185.162.231.207` | `80` | 14.50ms | ✅ فعال |
| 5 | `147.185.161.6` | `80` | 12.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.92` | `5060` | 308.78ms | ✅ فعال |
| 2 | `142.54.232.6` | `4145` | 63.33ms | ✅ فعال |
| 3 | `101.132.222.120` | `80` | 206.95ms | ✅ فعال |
| 4 | `172.67.180.77` | `80` | 12.18ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 223.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.178` | `80` | 15.22ms | ✅ فعال |
| 2 | `104.24.197.20` | `80` | 13.49ms | ✅ فعال |
| 3 | `104.17.190.13` | `80` | 14.07ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 13.93ms | ✅ فعال |
| 5 | `103.169.142.78` | `80` | 15.30ms | ✅ فعال |
