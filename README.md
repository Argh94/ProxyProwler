...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 05-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.121.226` | `80` | 2.61ms | ✅ فعال |
| 2 | `1.180.0.162` | `7302` | 278.19ms | ✅ فعال |
| 3 | `104.24.95.136` | `80` | 2.83ms | ✅ فعال |
| 4 | `104.17.142.64` | `80` | 2.80ms | ✅ فعال |
| 5 | `104.24.58.40` | `80` | 2.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.224.56.162` | `10001` | 230.86ms | ✅ فعال |
| 2 | `43.208.240.77` | `10034` | 233.81ms | ✅ فعال |
| 3 | `179.1.209.73` | `5678` | 79.39ms | ✅ فعال |
| 4 | `49.0.246.130` | `6789` | 193.18ms | ✅ فعال |
| 5 | `96.126.111.39` | `1081` | 22.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `54.180.143.12` | `37751` | 173.62ms | ✅ فعال |
| 2 | `216.229.112.25` | `8080` | 37.05ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 1137.58ms | ✅ فعال |
| 4 | `3.110.127.255` | `5534` | 212.18ms | ✅ فعال |
| 5 | `18.143.173.102` | `162` | 211.25ms | ✅ فعال |
