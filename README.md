...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:58 23-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `118.70.82.27` | `1083` | 240.58ms | ✅ فعال |
| 2 | `185.190.154.121` | `4145` | 2263.11ms | ✅ فعال |
| 3 | `157.90.113.23` | `9052` | 150.48ms | ✅ فعال |
| 4 | `185.100.157.20` | `8000` | 172.00ms | ✅ فعال |
| 5 | `109.224.12.170` | `52015` | 226.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `92.42.8.20` | `4145` | 2252.77ms | ✅ فعال |
| 2 | `34.246.183.20` | `12397` | 132.87ms | ✅ فعال |
| 3 | `103.118.127.222` | `4153` | 182.53ms | ✅ فعال |
| 4 | `136.0.127.52` | `5761` | 66.16ms | ✅ فعال |
| 5 | `128.199.104.190` | `41354` | 167.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 168.13ms | ✅ فعال |
| 2 | `138.2.64.185` | `8118` | 169.32ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 146.35ms | ✅ فعال |
| 4 | `161.49.116.131` | `1337` | 166.68ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 187.76ms | ✅ فعال |
