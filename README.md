...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:47 27-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.56.213` | `5761` | 83.26ms | ✅ فعال |
| 2 | `193.158.12.141` | `4153` | 1120.70ms | ✅ فعال |
| 3 | `45.74.31.30` | `13700` | 95.64ms | ✅ فعال |
| 4 | `185.190.90.2` | `4145` | 2152.84ms | ✅ فعال |
| 5 | `196.223.129.21` | `80` | 202.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.172.156.186` | `5834` | 19.91ms | ✅ فعال |
| 2 | `185.130.219.12` | `4153` | 1155.48ms | ✅ فعال |
| 3 | `213.165.185.211` | `4153` | 130.74ms | ✅ فعال |
| 4 | `50.238.47.86` | `32100` | 15.80ms | ✅ فعال |
| 5 | `8.213.215.187` | `8008` | 839.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 118.79ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 242.77ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 188.43ms | ✅ فعال |
| 4 | `213.136.72.147` | `3128` | 152.57ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 218.77ms | ✅ فعال |
