...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:47 12-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.215.187` | `8080` | 191.34ms | ✅ فعال |
| 2 | `104.25.0.57` | `80` | 10.38ms | ✅ فعال |
| 3 | `104.18.18.240` | `80` | 1.51ms | ✅ فعال |
| 4 | `213.149.156.87` | `5678` | 2249.24ms | ✅ فعال |
| 5 | `104.17.121.10` | `80` | 2.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.0.162` | `7302` | 212.06ms | ✅ فعال |
| 2 | `185.226.204.30` | `5583` | 145.54ms | ✅ فعال |
| 3 | `46.202.59.68` | `5559` | 19.46ms | ✅ فعال |
| 4 | `192.252.215.2` | `4145` | 99.39ms | ✅ فعال |
| 5 | `187.44.211.118` | `4153` | 195.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 1.58ms | ✅ فعال |
| 2 | `185.162.230.130` | `80` | 1.82ms | ✅ فعال |
| 3 | `103.39.49.156` | `3128` | 206.71ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 1.72ms | ✅ فعال |
| 5 | `188.114.96.63` | `80` | 1.36ms | ✅ فعال |
