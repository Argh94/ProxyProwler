...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:00 10-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `95.85.252.153` | `21064` | 144.95ms | ✅ فعال |
| 2 | `161.123.154.73` | `6603` | 53.03ms | ✅ فعال |
| 3 | `74.176.195.135` | `80` | 112.13ms | ✅ فعال |
| 4 | `8.209.96.245` | `7070` | 143.11ms | ✅ فعال |
| 5 | `103.156.17.12` | `8818` | 197.09ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (49 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.114.169` | `4145` | 120.75ms | ✅ فعال |
| 2 | `103.118.127.222` | `4153` | 2246.30ms | ✅ فعال |
| 3 | `192.111.130.2` | `4145` | 81.54ms | ✅ فعال |
| 4 | `185.176.94.75` | `1080` | 144.27ms | ✅ فعال |
| 5 | `103.146.137.69` | `1081` | 1319.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `2.56.178.131` | `443` | 179.46ms | ✅ فعال |
| 2 | `41.191.203.163` | `80` | 277.11ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 116.42ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 129.99ms | ✅ فعال |
| 5 | `41.191.203.162` | `80` | 280.47ms | ✅ فعال |
