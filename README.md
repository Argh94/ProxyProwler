...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:30 25-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `221.231.13.198` | `1080` | 208.92ms | ✅ فعال |
| 2 | `98.64.128.182` | `3128` | 118.85ms | ✅ فعال |
| 3 | `216.26.236.103` | `3129` | 35.33ms | ✅ فعال |
| 4 | `192.252.215.5` | `16137` | 72.16ms | ✅ فعال |
| 5 | `183.110.216.159` | `8090` | 2189.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `50.238.47.86` | `32100` | 2111.02ms | ✅ فعال |
| 2 | `185.18.250.83` | `80` | 17.75ms | ✅ فعال |
| 3 | `216.26.236.103` | `3129` | 35.45ms | ✅ فعال |
| 4 | `8.220.204.92` | `4145` | 143.92ms | ✅ فعال |
| 5 | `103.166.39.81` | `3629` | 226.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 131.66ms | ✅ فعال |
| 2 | `41.223.119.156` | `3128` | 286.59ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 180.90ms | ✅ فعال |
| 4 | `103.146.170.193` | `82` | 2268.53ms | ✅ فعال |
| 5 | `45.119.85.216` | `3128` | 238.75ms | ✅ فعال |
