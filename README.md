...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:33 23-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `95.216.49.153` | `80` | 144.83ms | ✅ فعال |
| 2 | `101.47.73.135` | `3128` | 182.51ms | ✅ فعال |
| 3 | `15.235.133.171` | `8080` | 197.85ms | ✅ فعال |
| 4 | `5.9.218.168` | `3128` | 126.63ms | ✅ فعال |
| 5 | `41.185.72.62` | `3030` | 225.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.61.200.104` | `36181` | 1352.33ms | ✅ فعال |
| 2 | `68.71.249.153` | `48606` | 71.98ms | ✅ فعال |
| 3 | `8.212.177.126` | `8080` | 222.19ms | ✅ فعال |
| 4 | `47.238.130.212` | `8081` | 180.77ms | ✅ فعال |
| 5 | `184.185.2.12` | `4145` | 1124.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 131.22ms | ✅ فعال |
| 2 | `47.56.110.204` | `8989` | 174.16ms | ✅ فعال |
| 3 | `18.192.100.176` | `8080` | 119.18ms | ✅ فعال |
| 4 | `35.225.22.61` | `80` | 21.57ms | ✅ فعال |
| 5 | `45.151.182.9` | `3128` | 155.71ms | ✅ فعال |
