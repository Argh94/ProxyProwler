...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 02-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.35.211.88` | `80` | 8.79ms | ✅ فعال |
| 2 | `160.153.0.73` | `80` | 8.67ms | ✅ فعال |
| 3 | `45.194.53.59` | `80` | 8.98ms | ✅ فعال |
| 4 | `102.177.176.14` | `80` | 8.67ms | ✅ فعال |
| 5 | `104.18.14.83` | `80` | 8.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.105.100.176` | `6427` | 127.31ms | ✅ فعال |
| 2 | `124.108.6.20` | `8085` | 196.01ms | ✅ فعال |
| 3 | `49.0.199.132` | `19` | 215.77ms | ✅ فعال |
| 4 | `84.52.123.163` | `4145` | 1212.82ms | ✅ فعال |
| 5 | `185.26.168.17` | `4153` | 196.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.134.149.133` | `8080` | 235.20ms | ✅ فعال |
| 2 | `40.192.14.136` | `44860` | 217.21ms | ✅ فعال |
| 3 | `43.209.130.76` | `64` | 200.87ms | ✅ فعال |
| 4 | `157.175.170.170` | `8291` | 223.63ms | ✅ فعال |
| 5 | `16.78.82.73` | `19985` | 191.98ms | ✅ فعال |
