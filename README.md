...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 28-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.153.1.167` | `80` | 6.16ms | ✅ فعال |
| 2 | `5.10.246.136` | `80` | 5.95ms | ✅ فعال |
| 3 | `104.16.24.13` | `80` | 5.97ms | ✅ فعال |
| 4 | `34.216.224.9` | `40715` | 79.23ms | ✅ فعال |
| 5 | `185.226.204.42` | `5595` | 79.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.214.108.67` | `4145` | 133.81ms | ✅ فعال |
| 2 | `8.213.156.191` | `8001` | 826.81ms | ✅ فعال |
| 3 | `45.61.127.71` | `6010` | 35.18ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 227.71ms | ✅ فعال |
| 5 | `170.81.108.153` | `4153` | 1198.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.210.30.230` | `371` | 250.63ms | ✅ فعال |
| 2 | `51.85.49.118` | `8881` | 141.03ms | ✅ فعال |
| 3 | `43.209.211.192` | `8001` | 253.28ms | ✅ فعال |
| 4 | `13.232.2.142` | `39395` | 198.57ms | ✅ فعال |
| 5 | `43.217.97.201` | `8093` | 229.27ms | ✅ فعال |
