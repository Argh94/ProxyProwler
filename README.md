...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 11-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.128.246` | `9080` | 896.86ms | ✅ فعال |
| 2 | `104.25.0.173` | `80` | 18.09ms | ✅ فعال |
| 3 | `199.229.254.129` | `4145` | 75.23ms | ✅ فعال |
| 4 | `108.162.195.7` | `80` | 18.42ms | ✅ فعال |
| 5 | `185.18.250.56` | `80` | 18.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.11.111` | `51` | 212.50ms | ✅ فعال |
| 2 | `145.223.56.242` | `7294` | 49.79ms | ✅ فعال |
| 3 | `103.102.6.82` | `80` | 1198.34ms | ✅ فعال |
| 4 | `8.134.149.133` | `8081` | 222.27ms | ✅ فعال |
| 5 | `47.113.219.226` | `59394` | 214.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.96.28.58` | `80` | 169.91ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 187.19ms | ✅ فعال |
| 3 | `13.246.11.197` | `621` | 253.78ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 48.90ms | ✅ فعال |
| 5 | `220.128.223.136` | `8082` | 151.77ms | ✅ فعال |
