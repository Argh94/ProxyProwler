...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:45 24-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.92` | `4145` | 157.65ms | ✅ فعال |
| 2 | `47.76.144.139` | `8081` | 176.39ms | ✅ فعال |
| 3 | `154.29.233.170` | `5931` | 37.07ms | ✅ فعال |
| 4 | `58.216.109.13` | `800` | 236.99ms | ✅ فعال |
| 5 | `192.252.215.5` | `16137` | 69.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `93.90.212.2` | `4153` | 171.20ms | ✅ فعال |
| 2 | `8.210.17.35` | `80` | 187.28ms | ✅ فعال |
| 3 | `185.18.250.83` | `80` | 10.81ms | ✅ فعال |
| 4 | `124.6.225.124` | `1088` | 245.93ms | ✅ فعال |
| 5 | `8.221.139.222` | `3128` | 133.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 194.98ms | ✅ فعال |
| 2 | `203.205.49.2` | `10017` | 2255.25ms | ✅ فعال |
| 3 | `20.210.113.32` | `8123` | 135.61ms | ✅ فعال |
| 4 | `2.56.122.146` | `10808` | 111.62ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 128.62ms | ✅ فعال |
