...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:01 23-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.42.167` | `3128` | 94.62ms | ✅ فعال |
| 2 | `1.180.49.222` | `7302` | 255.61ms | ✅ فعال |
| 3 | `77.91.77.220` | `3128` | 1158.81ms | ✅ فعال |
| 4 | `184.95.235.194` | `1080` | 27.74ms | ✅ فعال |
| 5 | `194.87.85.207` | `1080` | 148.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.70.47` | `6334` | 81.41ms | ✅ فعال |
| 2 | `24.249.199.12` | `4145` | 85.87ms | ✅ فعال |
| 3 | `85.237.51.73` | `4145` | 137.01ms | ✅ فعال |
| 4 | `45.131.208.105` | `80` | 1.64ms | ✅ فعال |
| 5 | `8.213.222.157` | `312` | 243.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 115.66ms | ✅ فعال |
| 2 | `103.84.177.28` | `8083` | 2290.77ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 1302.96ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 1298.39ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 220.69ms | ✅ فعال |
