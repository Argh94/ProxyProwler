...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:37 02-07-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `57.128.231.218` | `1009` | 131.81ms | ✅ فعال |
| 2 | `192.111.137.35` | `4145` | 86.40ms | ✅ فعال |
| 3 | `171.25.158.95` | `1080` | 129.54ms | ✅ فعال |
| 4 | `31.131.31.246` | `1080` | 133.14ms | ✅ فعال |
| 5 | `111.119.162.248` | `10923` | 254.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.49.86` | `80` | 777.76ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 271.20ms | ✅ فعال |
| 3 | `193.122.105.251` | `65535` | 154.88ms | ✅ فعال |
| 4 | `142.147.128.107` | `6607` | 32.50ms | ✅ فعال |
| 5 | `208.102.51.6` | `58208` | 101.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.107.44.221` | `1337` | 107.79ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 215.91ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 209.91ms | ✅ فعال |
| 4 | `97.76.251.138` | `8080` | 1104.33ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 161.67ms | ✅ فعال |
