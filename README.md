...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:23 31-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `149.62.186.244` | `1080` | 164.22ms | ✅ فعال |
| 2 | `154.223.51.114` | `9000` | 159.48ms | ✅ فعال |
| 3 | `198.8.94.174` | `39078` | 89.95ms | ✅ فعال |
| 4 | `36.138.53.26` | `10019` | 179.93ms | ✅ فعال |
| 5 | `47.91.29.151` | `194` | 119.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.213` | `4145` | 122.10ms | ✅ فعال |
| 2 | `149.57.85.250` | `6218` | 60.79ms | ✅ فعال |
| 3 | `46.161.27.244` | `995` | 129.78ms | ✅ فعال |
| 4 | `89.124.79.162` | `1080` | 131.45ms | ✅ فعال |
| 5 | `46.17.47.48` | `80` | 212.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.25.20.155` | `3128` | 135.58ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 54.02ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 2278.95ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 182.53ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 137.26ms | ✅ فعال |
