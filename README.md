...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 21-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.7.125` | `80` | 2.87ms | ✅ فعال |
| 2 | `147.185.161.63` | `80` | 2.78ms | ✅ فعال |
| 3 | `172.67.179.200` | `80` | 1.61ms | ✅ فعال |
| 4 | `66.235.200.5` | `80` | 2.90ms | ✅ فعال |
| 5 | `45.8.211.55` | `80` | 2.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 791.68ms | ✅ فعال |
| 2 | `177.85.65.177` | `4153` | 1213.36ms | ✅ فعال |
| 3 | `8.130.39.117` | `8080` | 248.81ms | ✅ فعال |
| 4 | `8.130.36.245` | `8080` | 253.26ms | ✅ فعال |
| 5 | `47.90.167.27` | `102` | 22.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.28.50` | `80` | 2.62ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 1.47ms | ✅ فعال |
| 3 | `104.19.66.163` | `80` | 2.33ms | ✅ فعال |
| 4 | `23.227.39.103` | `80` | 2.35ms | ✅ فعال |
