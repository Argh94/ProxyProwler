...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:27 14-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.151.128` | `3128` | 186.07ms | ✅ فعال |
| 2 | `193.53.127.169` | `80` | 169.76ms | ✅ فعال |
| 3 | `172.200.72.48` | `80` | 4.02ms | ✅ فعال |
| 4 | `45.43.70.56` | `6343` | 84.36ms | ✅ فعال |
| 5 | `34.1.133.104` | `3128` | 221.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.33.97` | `6673` | 81.28ms | ✅ فعال |
| 2 | `184.181.217.213` | `4145` | 85.28ms | ✅ فعال |
| 3 | `8.220.205.172` | `3128` | 188.91ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 81.45ms | ✅ فعال |
| 5 | `49.0.199.132` | `19` | 269.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.202.49.74` | `80` | 102.98ms | ✅ فعال |
| 2 | `41.220.16.208` | `80` | 2283.19ms | ✅ فعال |
| 3 | `34.81.160.132` | `80` | 187.65ms | ✅ فعال |
| 4 | `190.144.238.66` | `8080` | 1082.73ms | ✅ فعال |
| 5 | `34.44.49.215` | `80` | 30.74ms | ✅ فعال |
