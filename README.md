...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:13 09-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.49.49.11` | `31034` | 415.20ms | ✅ فعال |
| 2 | `176.126.164.213` | `80` | 203.77ms | ✅ فعال |
| 3 | `8.211.200.183` | `9098` | 665.65ms | ✅ فعال |
| 4 | `154.61.76.24` | `8083` | 242.55ms | ✅ فعال |
| 5 | `175.101.240.38` | `80` | 263.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `1081` | 120.61ms | ✅ فعال |
| 2 | `72.49.49.11` | `31034` | 535.78ms | ✅ فعال |
| 3 | `184.181.217.213` | `4145` | 88.22ms | ✅ فعال |
| 4 | `174.77.111.196` | `4145` | 1186.13ms | ✅ فعال |
| 5 | `45.131.6.148` | `80` | 15.17ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (45 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `108.137.1.116` | `26215` | 214.86ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 26.51ms | ✅ فعال |
| 3 | `13.61.155.35` | `54515` | 126.83ms | ✅ فعال |
| 4 | `16.79.112.218` | `58875` | 215.17ms | ✅ فعال |
| 5 | `78.12.249.123` | `46432` | 57.96ms | ✅ فعال |
