...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 03-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.106.74` | `80` | 18.04ms | ✅ فعال |
| 2 | `104.18.85.107` | `80` | 18.16ms | ✅ فعال |
| 3 | `104.21.18.75` | `80` | 18.24ms | ✅ فعال |
| 4 | `45.12.31.6` | `80` | 17.94ms | ✅ فعال |
| 5 | `185.193.29.99` | `80` | 18.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `77.242.22.227` | `8000` | 163.39ms | ✅ فعال |
| 2 | `45.79.203.254` | `48388` | 1093.73ms | ✅ فعال |
| 3 | `47.238.60.156` | `5060` | 691.49ms | ✅ فعال |
| 4 | `77.51.178.156` | `3629` | 170.15ms | ✅ فعال |
| 5 | `119.13.111.169` | `18081` | 183.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.160.151.84` | `59723` | 136.94ms | ✅ فعال |
| 2 | `78.12.249.123` | `9898` | 45.83ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 210.31ms | ✅ فعال |
| 4 | `43.217.136.176` | `10103` | 193.66ms | ✅ فعال |
| 5 | `157.175.42.134` | `8006` | 212.83ms | ✅ فعال |
