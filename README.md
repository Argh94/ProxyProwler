...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:51 03-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.211.142.115` | `8192` | 2175.22ms | ✅ فعال |
| 2 | `45.131.5.251` | `80` | 14.82ms | ✅ فعال |
| 3 | `172.67.176.58` | `80` | 14.21ms | ✅ فعال |
| 4 | `104.17.105.161` | `80` | 14.13ms | ✅ فعال |
| 5 | `8.211.195.173` | `100` | 770.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.49.222` | `7302` | 243.51ms | ✅ فعال |
| 2 | `104.20.61.52` | `80` | 14.74ms | ✅ فعال |
| 3 | `8.220.205.172` | `9020` | 831.70ms | ✅ فعال |
| 4 | `192.252.211.197` | `14921` | 71.84ms | ✅ فعال |
| 5 | `8.213.197.208` | `34567` | 222.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.139` | `80` | 14.49ms | ✅ فعال |
| 2 | `103.169.142.78` | `80` | 23.77ms | ✅ فعال |
| 3 | `104.24.85.134` | `80` | 28.53ms | ✅ فعال |
| 4 | `172.67.88.21` | `80` | 15.45ms | ✅ فعال |
| 5 | `104.17.106.99` | `80` | 15.36ms | ✅ فعال |
