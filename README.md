...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 05-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `147.185.161.210` | `80` | 6.16ms | ✅ فعال |
| 2 | `45.85.118.121` | `80` | 5.98ms | ✅ فعال |
| 3 | `172.67.126.41` | `80` | 6.17ms | ✅ فعال |
| 4 | `104.17.160.201` | `80` | 6.37ms | ✅ فعال |
| 5 | `185.162.228.97` | `80` | 5.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.210` | `3629` | 253.79ms | ✅ فعال |
| 2 | `43.204.255.199` | `8080` | 216.00ms | ✅ فعال |
| 3 | `46.8.60.34` | `1080` | 1205.30ms | ✅ فعال |
| 4 | `79.110.202.131` | `8081` | 100.99ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 198.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 6.28ms | ✅ فعال |
| 2 | `52.47.164.226` | `41736` | 86.11ms | ✅ فعال |
| 3 | `43.205.124.165` | `36923` | 201.91ms | ✅ فعال |
| 4 | `3.26.218.182` | `13365` | 198.49ms | ✅ فعال |
| 5 | `41.65.55.10` | `1981` | 266.34ms | ✅ فعال |
