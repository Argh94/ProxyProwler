...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:30 08-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `20.27.14.220` | `8561` | 134.13ms | ✅ فعال |
| 2 | `40.89.145.14` | `80` | 121.07ms | ✅ فعال |
| 3 | `74.119.147.209` | `4145` | 112.34ms | ✅ فعال |
| 4 | `154.219.101.86` | `8888` | 190.62ms | ✅ فعال |
| 5 | `20.210.39.153` | `8561` | 133.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `140.238.9.210` | `8080` | 165.26ms | ✅ فعال |
| 2 | `192.111.130.2` | `4145` | 137.94ms | ✅ فعال |
| 3 | `182.160.16.234` | `8020` | 265.36ms | ✅ فعال |
| 4 | `47.238.134.126` | `8004` | 182.82ms | ✅ فعال |
| 5 | `103.166.39.81` | `3629` | 281.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.27.100.80` | `443` | 143.84ms | ✅ فعال |
| 2 | `41.191.203.164` | `80` | 257.53ms | ✅ فعال |
| 3 | `45.59.186.60` | `80` | 38.54ms | ✅ فعال |
| 4 | `14.56.118.184` | `3128` | 172.55ms | ✅ فعال |
| 5 | `46.47.197.210` | `3128` | 133.97ms | ✅ فعال |
