...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 22-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.239.1` | `4145` | 63.91ms | ✅ فعال |
| 2 | `72.37.216.68` | `4145` | 64.30ms | ✅ فعال |
| 3 | `46.202.78.153` | `8415` | 7.78ms | ✅ فعال |
| 4 | `51.254.132.238` | `80` | 2157.81ms | ✅ فعال |
| 5 | `39.109.113.97` | `4090` | 218.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.33.15` | `6591` | 94.08ms | ✅ فعال |
| 2 | `8.211.200.183` | `10002` | 98.20ms | ✅ فعال |
| 3 | `142.54.235.9` | `4145` | 63.66ms | ✅ فعال |
| 4 | `142.54.239.1` | `4145` | 64.61ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 793.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 134.86ms | ✅ فعال |
| 2 | `202.154.19.7` | `8080` | 237.41ms | ✅ فعال |
| 3 | `45.174.168.8` | `999` | 54.29ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 228.12ms | ✅ فعال |
| 5 | `176.57.189.138` | `3128` | 237.65ms | ✅ فعال |
