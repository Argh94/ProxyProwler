...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 02-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.112.235.63` | `80` | 2.52ms | ✅ فعال |
| 2 | `172.67.70.97` | `80` | 2.24ms | ✅ فعال |
| 3 | `47.91.89.3` | `11` | 102.36ms | ✅ فعال |
| 4 | `91.193.59.244` | `80` | 3.71ms | ✅ فعال |
| 5 | `154.194.12.80` | `80` | 2.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.18.250.168` | `80` | 2.24ms | ✅ فعال |
| 2 | `45.41.171.233` | `6269` | 1.89ms | ✅ فعال |
| 3 | `91.247.250.215` | `4145` | 122.78ms | ✅ فعال |
| 4 | `155.254.34.21` | `6001` | 76.00ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 227.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.143.173.102` | `8761` | 224.77ms | ✅ فعال |
| 2 | `164.163.42.9` | `10000` | 158.11ms | ✅ فعال |
| 3 | `13.59.113.45` | `9030` | 20.72ms | ✅ فعال |
| 4 | `109.135.16.145` | `8789` | 2176.30ms | ✅ فعال |
| 5 | `18.179.12.21` | `26361` | 160.76ms | ✅ فعال |
