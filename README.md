...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 22-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.221.172` | `80` | 35.63ms | ✅ فعال |
| 2 | `154.197.75.144` | `80` | 2.43ms | ✅ فعال |
| 3 | `104.18.181.209` | `80` | 2.45ms | ✅ فعال |
| 4 | `62.72.166.190` | `80` | 3.65ms | ✅ فعال |
| 5 | `184.178.172.17` | `4145` | 89.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.160.61.103` | `4145` | 221.83ms | ✅ فعال |
| 2 | `8.130.34.44` | `3128` | 693.47ms | ✅ فعال |
| 3 | `212.31.100.138` | `4153` | 157.54ms | ✅ فعال |
| 4 | `70.166.167.38` | `57728` | 90.00ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 129.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.192.14.136` | `9292` | 229.34ms | ✅ فعال |
| 2 | `16.78.41.33` | `7070` | 224.13ms | ✅ فعال |
| 3 | `120.92.212.16` | `8890` | 264.57ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 140.73ms | ✅ فعال |
| 5 | `41.223.119.156` | `3128` | 257.45ms | ✅ فعال |
