...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:09 20-10-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (30 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `31433` | 140.57ms | ✅ فعال |
| 2 | `176.101.220.90` | `8090` | 178.18ms | ✅ فعال |
| 3 | `8.211.195.139` | `8889` | 192.27ms | ✅ فعال |
| 4 | `67.201.59.70` | `4145` | 34.58ms | ✅ فعال |
| 5 | `184.95.235.194` | `1080` | 2117.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.2.239.42` | `4153` | 1215.84ms | ✅ فعال |
| 2 | `8.134.149.133` | `8081` | 216.40ms | ✅ فعال |
| 3 | `31.59.33.99` | `6675` | 133.59ms | ✅ فعال |
| 4 | `110.238.116.82` | `55443` | 213.70ms | ✅ فعال |
| 5 | `162.245.85.36` | `80` | 64.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 154.77ms | ✅ فعال |
| 2 | `144.125.164.222` | `8080` | 2.59ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 55.60ms | ✅ فعال |
| 4 | `13.246.11.197` | `621` | 267.18ms | ✅ فعال |
| 5 | `94.130.177.190` | `9999` | 2170.30ms | ✅ فعال |
