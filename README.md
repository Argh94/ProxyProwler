...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:36 19-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `57.129.144.178` | `40000` | 117.78ms | ✅ فعال |
| 2 | `68.1.210.189` | `4145` | 119.44ms | ✅ فعال |
| 3 | `45.43.64.67` | `6325` | 117.93ms | ✅ فعال |
| 4 | `184.178.172.25` | `15291` | 116.04ms | ✅ فعال |
| 5 | `113.11.183.202` | `4145` | 211.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.239.237.211` | `5857` | 55.24ms | ✅ فعال |
| 2 | `94.131.122.129` | `1082` | 128.60ms | ✅ فعال |
| 3 | `91.211.115.127` | `1080` | 144.36ms | ✅ فعال |
| 4 | `47.176.213.210` | `39593` | 1060.48ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 217.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 182.52ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 160.56ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 2264.86ms | ✅ فعال |
| 4 | `188.165.249.131` | `3129` | 129.72ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 137.52ms | ✅ فعال |
