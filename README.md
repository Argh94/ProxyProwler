...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:49 02-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `136.0.109.67` | `6353` | 47.70ms | ✅ فعال |
| 2 | `203.30.191.218` | `80` | 14.37ms | ✅ فعال |
| 3 | `91.193.59.110` | `80` | 14.16ms | ✅ فعال |
| 4 | `104.17.4.166` | `80` | 12.49ms | ✅ فعال |
| 5 | `104.27.15.19` | `80` | 12.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `68.71.243.14` | `4145` | 66.84ms | ✅ فعال |
| 2 | `1.180.49.222` | `7302` | 248.22ms | ✅ فعال |
| 3 | `8.211.195.139` | `8334` | 719.43ms | ✅ فعال |
| 4 | `202.40.181.220` | `31247` | 253.94ms | ✅ فعال |
| 5 | `101.51.138.138` | `8080` | 287.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `62.72.166.211` | `80` | 9.98ms | ✅ فعال |
| 2 | `23.227.39.103` | `80` | 12.57ms | ✅ فعال |
| 3 | `172.67.161.245` | `80` | 15.39ms | ✅ فعال |
| 4 | `102.177.176.178` | `80` | 15.01ms | ✅ فعال |
| 5 | `45.131.4.93` | `80` | 14.28ms | ✅ فعال |
