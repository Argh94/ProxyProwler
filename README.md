...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 22-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.19.1` | `80` | 6.01ms | ✅ فعال |
| 2 | `199.34.228.201` | `80` | 6.14ms | ✅ فعال |
| 3 | `188.42.89.4` | `80` | 6.33ms | ✅ فعال |
| 4 | `188.166.197.129` | `3128` | 1153.41ms | ✅ فعال |
| 5 | `45.131.5.213` | `80` | 5.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.229.126.150` | `7679` | 63.88ms | ✅ فعال |
| 2 | `200.41.182.243` | `4145` | 144.34ms | ✅ فعال |
| 3 | `39.104.57.33` | `34567` | 275.21ms | ✅ فعال |
| 4 | `154.6.8.119` | `5586` | 12.49ms | ✅ فعال |
| 5 | `8.148.23.202` | `9098` | 261.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.221.193.221` | `29613` | 98.78ms | ✅ فعال |
| 2 | `152.53.36.101` | `32943` | 6.44ms | ✅ فعال |
| 3 | `179.96.28.58` | `80` | 133.26ms | ✅ فعال |
| 4 | `116.68.203.3` | `3128` | 264.51ms | ✅ فعال |
| 5 | `108.137.1.116` | `9015` | 244.63ms | ✅ فعال |
