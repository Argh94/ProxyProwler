...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:50 14-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.121.21` | `80` | 8.97ms | ✅ فعال |
| 2 | `104.24.58.40` | `80` | 8.97ms | ✅ فعال |
| 3 | `104.21.77.115` | `80` | 9.01ms | ✅ فعال |
| 4 | `46.161.6.165` | `8080` | 163.09ms | ✅ فعال |
| 5 | `184.181.217.213` | `4145` | 119.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `110.238.116.82` | `55443` | 208.04ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 195.07ms | ✅ فعال |
| 3 | `8.130.34.44` | `3128` | 212.75ms | ✅ فعال |
| 4 | `95.43.244.15` | `4153` | 167.40ms | ✅ فعال |
| 5 | `185.226.207.4` | `5553` | 135.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 150.42ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 183.13ms | ✅ فعال |
| 3 | `164.163.42.60` | `10000` | 1182.57ms | ✅ فعال |
| 4 | `40.177.211.224` | `215` | 55.50ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 1189.65ms | ✅ فعال |
