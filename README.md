...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:38 27-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.154.110` | `5788` | 90.37ms | ✅ فعال |
| 2 | `68.71.242.118` | `4145` | 63.55ms | ✅ فعال |
| 3 | `118.145.141.251` | `44177` | 226.47ms | ✅ فعال |
| 4 | `129.151.9.55` | `10808` | 58.97ms | ✅ فعال |
| 5 | `64.83.12.6` | `1080` | 49.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `150.241.70.103` | `6666` | 120.04ms | ✅ فعال |
| 2 | `47.90.149.238` | `5060` | 18.79ms | ✅ فعال |
| 3 | `107.181.154.110` | `5788` | 93.47ms | ✅ فعال |
| 4 | `98.188.47.150` | `4145` | 93.03ms | ✅ فعال |
| 5 | `47.89.184.18` | `3128` | 18.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.70.236.194` | `999` | 117.82ms | ✅ فعال |
| 2 | `41.65.55.10` | `1981` | 1168.61ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 2248.44ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 124.88ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 227.24ms | ✅ فعال |
