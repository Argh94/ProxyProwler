...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 17-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.244.79` | `80` | 2.39ms | ✅ فعال |
| 2 | `162.159.152.67` | `80` | 1.92ms | ✅ فعال |
| 3 | `173.245.59.237` | `80` | 1.90ms | ✅ فعال |
| 4 | `199.34.229.136` | `80` | 1.91ms | ✅ فعال |
| 5 | `104.25.208.196` | `80` | 1.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 209.71ms | ✅ فعال |
| 2 | `31.59.20.7` | `6585` | 147.76ms | ✅ فعال |
| 3 | `188.42.88.22` | `80` | 1.80ms | ✅ فعال |
| 4 | `68.1.210.163` | `4145` | 213.08ms | ✅ فعال |
| 5 | `43.209.130.76` | `621` | 197.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.225.148.130` | `1120` | 2520.30ms | ✅ فعال |
| 2 | `43.217.97.201` | `23918` | 179.10ms | ✅ فعال |
| 3 | `16.78.47.161` | `53053` | 186.14ms | ✅ فعال |
| 4 | `51.16.49.113` | `45001` | 196.15ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 152.36ms | ✅ فعال |
