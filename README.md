...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:11 09-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.89.96.140` | `1080` | 37.36ms | ✅ فعال |
| 2 | `93.113.63.11` | `1080` | 175.77ms | ✅ فعال |
| 3 | `143.255.109.76` | `1080` | 168.39ms | ✅ فعال |
| 4 | `192.111.137.35` | `4145` | 102.94ms | ✅ فعال |
| 5 | `144.217.12.20` | `10808` | 48.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `117.50.194.130` | `7890` | 227.14ms | ✅ فعال |
| 2 | `8.213.197.208` | `31433` | 211.44ms | ✅ فعال |
| 3 | `174.77.111.197` | `4145` | 84.95ms | ✅ فعال |
| 4 | `103.146.170.233` | `5678` | 229.64ms | ✅ فعال |
| 5 | `70.166.167.38` | `57728` | 85.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `178.205.101.67` | `3129` | 2217.16ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 204.87ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 45.66ms | ✅ فعال |
| 4 | `103.159.195.221` | `8080` | 200.04ms | ✅ فعال |
| 5 | `51.79.207.21` | `8080` | 186.49ms | ✅ فعال |
