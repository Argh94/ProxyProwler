...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:09 07-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.26.229.52` | `9443` | 35.45ms | ✅ فعال |
| 2 | `49.0.250.196` | `14265` | 182.21ms | ✅ فعال |
| 3 | `211.230.49.122` | `3128` | 159.52ms | ✅ فعال |
| 4 | `98.64.128.182` | `3128` | 117.52ms | ✅ فعال |
| 5 | `146.103.3.145` | `7198` | 104.32ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (66 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.44` | `3128` | 251.52ms | ✅ فعال |
| 2 | `142.54.239.1` | `4145` | 70.48ms | ✅ فعال |
| 3 | `52.47.164.226` | `1194` | 115.73ms | ✅ فعال |
| 4 | `193.221.203.121` | `8888` | 138.08ms | ✅ فعال |
| 5 | `16.78.219.183` | `1964` | 211.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.59.113.45` | `10051` | 27.53ms | ✅ فعال |
| 2 | `78.12.230.52` | `268` | 41.45ms | ✅ فعال |
| 3 | `51.85.49.118` | `168` | 178.48ms | ✅ فعال |
| 4 | `40.176.96.235` | `4467` | 70.23ms | ✅ فعال |
| 5 | `40.177.211.224` | `509` | 71.02ms | ✅ فعال |
