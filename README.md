...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 15-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `24.249.199.12` | `4145` | 71.19ms | ✅ فعال |
| 2 | `13.36.243.194` | `8072` | 84.40ms | ✅ فعال |
| 3 | `8.211.200.183` | `10000` | 724.23ms | ✅ فعال |
| 4 | `104.17.221.232` | `80` | 2.07ms | ✅ فعال |
| 5 | `104.16.0.0` | `80` | 2.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.40.144.129` | `8888` | 2204.01ms | ✅ فعال |
| 2 | `39.104.23.154` | `4006` | 218.93ms | ✅ فعال |
| 3 | `142.54.228.193` | `4145` | 103.55ms | ✅ فعال |
| 4 | `49.0.199.132` | `19` | 267.68ms | ✅ فعال |
| 5 | `8.208.84.236` | `7657` | 887.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.93.66.245` | `10099` | 2.72ms | ✅ فعال |
| 2 | `51.20.126.89` | `8124` | 99.90ms | ✅ فعال |
| 3 | `108.137.1.116` | `9099` | 236.38ms | ✅ فعال |
| 4 | `43.208.129.50` | `10808` | 250.47ms | ✅ فعال |
| 5 | `202.154.18.1` | `8080` | 255.19ms | ✅ فعال |
