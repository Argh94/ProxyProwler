...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:13 17-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `158.178.243.225` | `443` | 191.57ms | ✅ فعال |
| 2 | `66.80.0.115` | `3128` | 8.68ms | ✅ فعال |
| 3 | `154.29.232.135` | `6795` | 58.41ms | ✅ فعال |
| 4 | `45.41.162.5` | `6642` | 54.73ms | ✅ فعال |
| 5 | `203.202.232.20` | `3128` | 2213.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.3.40` | `7093` | 139.15ms | ✅ فعال |
| 2 | `67.201.58.190` | `4145` | 52.07ms | ✅ فعال |
| 3 | `203.23.103.127` | `80` | 10.50ms | ✅ فعال |
| 4 | `8.209.253.237` | `8499` | 109.89ms | ✅ فعال |
| 5 | `192.252.214.20` | `15864` | 97.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.59.186.60` | `80` | 9.08ms | ✅ فعال |
| 2 | `47.74.157.194` | `80` | 182.90ms | ✅ فعال |
| 3 | `38.60.196.214` | `80` | 2164.86ms | ✅ فعال |
| 4 | `35.225.22.61` | `80` | 49.88ms | ✅ فعال |
| 5 | `13.36.243.194` | `9899` | 128.00ms | ✅ فعال |
