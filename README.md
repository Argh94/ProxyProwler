...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:53 11-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.247.29.193` | `50000` | 90.22ms | ✅ فعال |
| 2 | `142.54.239.1` | `4145` | 70.40ms | ✅ فعال |
| 3 | `8.209.96.245` | `1234` | 96.25ms | ✅ فعال |
| 4 | `46.8.104.176` | `1080` | 2148.23ms | ✅ فعال |
| 5 | `82.24.238.91` | `6898` | 12.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `115.190.91.223` | `7897` | 2326.70ms | ✅ فعال |
| 2 | `45.3.35.97` | `3129` | 5.50ms | ✅ فعال |
| 3 | `1.245.175.180` | `1080` | 1207.42ms | ✅ فعال |
| 4 | `184.181.217.206` | `4145` | 84.50ms | ✅ فعال |
| 5 | `47.252.18.37` | `80` | 6.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 6.38ms | ✅ فعال |
| 2 | `103.189.116.20` | `8080` | 2269.98ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 6.56ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 118.65ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 239.42ms | ✅ فعال |
