...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:12 25-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.20.45.246` | `80` | 7.41ms | ✅ فعال |
| 2 | `31.12.75.109` | `80` | 2.67ms | ✅ فعال |
| 3 | `154.194.12.236` | `80` | 2.18ms | ✅ فعال |
| 4 | `164.38.155.71` | `80` | 2.29ms | ✅ فعال |
| 5 | `104.18.65.244` | `80` | 2.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.49.49.11` | `31034` | 643.13ms | ✅ فعال |
| 2 | `5.199.173.4` | `9068` | 115.63ms | ✅ فعال |
| 3 | `88.216.68.90` | `9086` | 18.75ms | ✅ فعال |
| 4 | `8.138.133.207` | `8008` | 260.40ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 1255.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.3.251` | `9067` | 219.57ms | ✅ فعال |
| 2 | `16.79.112.218` | `16614` | 240.69ms | ✅ فعال |
| 3 | `78.12.230.52` | `9323` | 67.53ms | ✅ فعال |
| 4 | `51.17.184.165` | `49668` | 142.99ms | ✅ فعال |
| 5 | `78.12.143.148` | `12094` | 67.82ms | ✅ فعال |
