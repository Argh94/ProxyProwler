...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:42 14-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.14.149.33` | `4145` | 109.02ms | ✅ فعال |
| 2 | `46.98.184.203` | `5678` | 2203.95ms | ✅ فعال |
| 3 | `84.39.112.144` | `3128` | 92.27ms | ✅ فعال |
| 4 | `141.98.153.86` | `80` | 94.61ms | ✅ فعال |
| 5 | `166.88.217.114` | `6447` | 70.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.111.48.15` | `6792` | 60.47ms | ✅ فعال |
| 2 | `155.254.38.47` | `5723` | 76.41ms | ✅ فعال |
| 3 | `154.16.146.41` | `80` | 23.46ms | ✅ فعال |
| 4 | `97.105.12.186` | `4153` | 48.73ms | ✅ فعال |
| 5 | `102.223.9.53` | `80` | 193.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 229.82ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 197.20ms | ✅ فعال |
| 3 | `202.154.19.7` | `8080` | 243.74ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 259.83ms | ✅ فعال |
| 5 | `180.250.219.58` | `53281` | 299.09ms | ✅ فعال |
