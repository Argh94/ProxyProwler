...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:33 05-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `48.210.225.96` | `80` | 133.02ms | ✅ فعال |
| 2 | `156.146.59.29` | `9002` | 32.54ms | ✅ فعال |
| 3 | `45.88.0.114` | `3128` | 104.34ms | ✅ فعال |
| 4 | `116.171.106.78` | `3000` | 223.54ms | ✅ فعال |
| 5 | `45.88.0.116` | `3128` | 1123.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.24.225` | `8081` | 225.32ms | ✅ فعال |
| 2 | `24.249.199.12` | `4145` | 263.68ms | ✅ فعال |
| 3 | `192.111.139.162` | `4145` | 73.64ms | ✅ فعال |
| 4 | `185.216.106.120` | `6197` | 68.33ms | ✅ فعال |
| 5 | `185.176.94.75` | `1080` | 130.47ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (17 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `181.78.65.252` | `999` | 98.30ms | ✅ فعال |
| 2 | `179.96.28.58` | `80` | 161.02ms | ✅ فعال |
| 3 | `18.229.170.122` | `3128` | 155.45ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 197.42ms | ✅ فعال |
| 5 | `5.161.155.252` | `80` | 28.67ms | ✅ فعال |
