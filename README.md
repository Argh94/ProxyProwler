...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 19-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `194.152.44.92` | `80` | 2.24ms | ✅ فعال |
| 2 | `89.116.250.215` | `80` | 2.32ms | ✅ فعال |
| 3 | `199.34.229.42` | `80` | 2.67ms | ✅ فعال |
| 4 | `104.17.197.199` | `80` | 2.04ms | ✅ فعال |
| 5 | `68.1.210.189` | `4145` | 87.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `9500` | 145.02ms | ✅ فعال |
| 2 | `88.216.68.24` | `9080` | 2.14ms | ✅ فعال |
| 3 | `203.188.245.98` | `52837` | 243.97ms | ✅ فعال |
| 4 | `101.132.248.7` | `1337` | 230.81ms | ✅ فعال |
| 5 | `202.162.212.164` | `4153` | 244.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 234.43ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 138.28ms | ✅ فعال |
| 3 | `13.36.243.194` | `9239` | 102.11ms | ✅ فعال |
| 4 | `51.16.49.113` | `8585` | 429.25ms | ✅ فعال |
| 5 | `40.177.211.224` | `215` | 66.66ms | ✅ فعال |
