...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 14-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.228.166` | `80` | 20.87ms | ✅ فعال |
| 2 | `155.254.38.234` | `5910` | 132.12ms | ✅ فعال |
| 3 | `146.103.56.97` | `5645` | 138.01ms | ✅ فعال |
| 4 | `104.25.174.15` | `80` | 9.05ms | ✅ فعال |
| 5 | `104.19.161.79` | `80` | 16.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.32.4.65` | `4153` | 156.02ms | ✅ فعال |
| 2 | `47.243.175.55` | `443` | 162.13ms | ✅ فعال |
| 3 | `43.167.177.49` | `6006` | 1150.61ms | ✅ فعال |
| 4 | `185.32.4.102` | `4153` | 151.95ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 203.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `196.251.221.30` | `8080` | 277.47ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 180.59ms | ✅ فعال |
| 3 | `13.246.11.197` | `621` | 259.25ms | ✅ فعال |
| 4 | `13.36.243.194` | `9239` | 132.77ms | ✅ فعال |
| 5 | `164.163.40.15` | `10000` | 2230.99ms | ✅ فعال |
