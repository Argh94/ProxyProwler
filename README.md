...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:56 07-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `46.47.197.210` | `3128` | 138.06ms | ✅ فعال |
| 2 | `202.162.219.12` | `1080` | 238.60ms | ✅ فعال |
| 3 | `178.156.224.42` | `3128` | 26.15ms | ✅ فعال |
| 4 | `147.45.60.136` | `1082` | 30.27ms | ✅ فعال |
| 5 | `8.212.165.164` | `41890` | 208.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.70.208` | `6495` | 101.74ms | ✅ فعال |
| 2 | `177.66.43.189` | `4145` | 171.74ms | ✅ فعال |
| 3 | `178.156.224.42` | `3128` | 27.09ms | ✅ فعال |
| 4 | `65.109.201.146` | `9081` | 142.59ms | ✅ فعال |
| 5 | `92.255.190.64` | `4153` | 182.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 23.93ms | ✅ فعال |
| 2 | `182.78.42.112` | `83` | 273.21ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 156.50ms | ✅ فعال |
| 4 | `103.153.149.18` | `8181` | 215.04ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 208.64ms | ✅ فعال |
