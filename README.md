...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:02 03-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.79.144.123` | `8009` | 174.93ms | ✅ فعال |
| 2 | `104.143.226.90` | `5693` | 84.29ms | ✅ فعال |
| 3 | `66.253.43.134` | `1080` | 2.99ms | ✅ فعال |
| 4 | `38.54.51.14` | `30001` | 236.97ms | ✅ فعال |
| 5 | `104.238.37.109` | `6666` | 38.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.18.47.79` | `4145` | 234.33ms | ✅ فعال |
| 2 | `198.105.100.111` | `6362` | 76.14ms | ✅ فعال |
| 3 | `92.255.190.64` | `4153` | 148.62ms | ✅ فعال |
| 4 | `85.214.100.194` | `80` | 110.17ms | ✅ فعال |
| 5 | `69.55.49.177` | `38182` | 10.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.79.207.21` | `8080` | 222.16ms | ✅ فعال |
| 2 | `110.34.1.180` | `32650` | 2297.00ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 233.63ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 240.43ms | ✅ فعال |
| 5 | `79.121.102.227` | `8080` | 107.55ms | ✅ فعال |
