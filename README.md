...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:55 15-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `101.36.109.77` | `8118` | 146.49ms | ✅ فعال |
| 2 | `8.220.204.92` | `8008` | 130.56ms | ✅ فعال |
| 3 | `91.149.243.181` | `1080` | 132.07ms | ✅ فعال |
| 4 | `206.123.156.199` | `9285` | 154.37ms | ✅ فعال |
| 5 | `121.43.109.88` | `8008` | 188.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.191.234.224` | `1081` | 148.63ms | ✅ فعال |
| 2 | `47.83.134.196` | `1011` | 145.78ms | ✅ فعال |
| 3 | `8.213.195.191` | `8080` | 192.77ms | ✅ فعال |
| 4 | `31.13.239.4` | `5678` | 178.39ms | ✅ فعال |
| 5 | `178.252.149.46` | `4153` | 1239.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 180.65ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 181.17ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 1222.52ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 68.03ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 68.96ms | ✅ فعال |
