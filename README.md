...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 24-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (15 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.206.118.204` | `6442` | 8.69ms | ✅ فعال |
| 2 | `98.188.47.132` | `4145` | 178.67ms | ✅ فعال |
| 3 | `104.239.81.107` | `6642` | 40.22ms | ✅ فعال |
| 4 | `82.23.206.191` | `5997` | 71.13ms | ✅ فعال |
| 5 | `198.105.100.156` | `6407` | 145.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.165.106` | `8090` | 181.74ms | ✅ فعال |
| 2 | `206.206.118.204` | `6442` | 8.46ms | ✅ فعال |
| 3 | `8.209.96.245` | `193` | 161.03ms | ✅ فعال |
| 4 | `98.175.31.222` | `4145` | 123.60ms | ✅ فعال |
| 5 | `8.219.160.198` | `1011` | 168.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.177.56.190` | `80` | 2.08ms | ✅ فعال |
| 2 | `102.177.176.178` | `80` | 1.85ms | ✅ فعال |
| 3 | `172.66.40.96` | `80` | 6.33ms | ✅ فعال |
| 4 | `69.84.182.59` | `80` | 1.79ms | ✅ فعال |
| 5 | `45.8.211.248` | `80` | 2.00ms | ✅ فعال |
