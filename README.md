...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 02-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.135.18` | `18301` | 85.37ms | ✅ فعال |
| 2 | `34.44.49.215` | `80` | 19.14ms | ✅ فعال |
| 3 | `103.138.145.174` | `9090` | 1299.89ms | ✅ فعال |
| 4 | `144.31.222.106` | `7890` | 147.17ms | ✅ فعال |
| 5 | `31.58.18.93` | `6362` | 95.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.49.86` | `8081` | 113.55ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 165.11ms | ✅ فعال |
| 3 | `8.211.42.167` | `8005` | 1674.58ms | ✅ فعال |
| 4 | `199.7.149.96` | `3128` | 19.67ms | ✅ فعال |
| 5 | `198.105.111.242` | `6920` | 97.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 129.58ms | ✅ فعال |
| 2 | `177.234.217.85` | `999` | 1143.69ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 228.37ms | ✅ فعال |
