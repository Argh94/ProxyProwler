...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:55 30-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.90.12` | `80` | 2.02ms | ✅ فعال |
| 2 | `185.238.228.167` | `80` | 2.44ms | ✅ فعال |
| 3 | `45.131.5.95` | `80` | 2.58ms | ✅ فعال |
| 4 | `104.21.23.169` | `80` | 2.51ms | ✅ فعال |
| 5 | `39.102.214.152` | `80` | 251.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `93.90.212.2` | `4153` | 147.92ms | ✅ فعال |
| 2 | `80.78.74.8` | `65530` | 121.86ms | ✅ فعال |
| 3 | `37.193.71.189` | `1080` | 167.55ms | ✅ فعال |
| 4 | `46.8.60.2` | `1080` | 1191.36ms | ✅ فعال |
| 5 | `192.111.137.35` | `4145` | 73.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 2311.90ms | ✅ فعال |
| 2 | `3.122.235.189` | `9507` | 91.76ms | ✅ فعال |
| 3 | `43.217.134.46` | `1080` | 230.54ms | ✅ فعال |
| 4 | `16.78.104.244` | `9091` | 243.07ms | ✅ فعال |
| 5 | `54.199.199.66` | `9333` | 155.75ms | ✅ فعال |
