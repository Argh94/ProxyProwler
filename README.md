...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:50 09-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.119.151` | `80` | 17.97ms | ✅ فعال |
| 2 | `185.148.105.84` | `80` | 18.30ms | ✅ فعال |
| 3 | `45.80.108.137` | `80` | 17.87ms | ✅ فعال |
| 4 | `108.162.193.134` | `80` | 18.04ms | ✅ فعال |
| 5 | `185.170.166.95` | `80` | 19.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.189.159.241` | `1080` | 215.43ms | ✅ فعال |
| 2 | `31.59.20.186` | `6764` | 119.19ms | ✅ فعال |
| 3 | `8.220.205.172` | `11` | 915.54ms | ✅ فعال |
| 4 | `47.176.213.210` | `39593` | 1083.80ms | ✅ فعال |
| 5 | `47.254.153.78` | `999` | 130.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.158.81` | `27610` | 189.45ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 182.33ms | ✅ فعال |
| 3 | `51.16.49.113` | `8639` | 191.87ms | ✅ فعال |
| 4 | `193.95.53.131` | `8077` | 185.97ms | ✅ فعال |
| 5 | `78.12.220.164` | `52786` | 44.45ms | ✅ فعال |
