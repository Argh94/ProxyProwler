...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:49 07-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.87.199` | `20000` | 51.31ms | ✅ فعال |
| 2 | `121.169.46.116` | `1090` | 166.55ms | ✅ فعال |
| 3 | `176.9.107.170` | `1081` | 113.92ms | ✅ فعال |
| 4 | `91.210.171.169` | `9050` | 130.99ms | ✅ فعال |
| 5 | `174.75.211.193` | `4145` | 87.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.216.232.213` | `4153` | 208.60ms | ✅ فعال |
| 2 | `47.251.87.199` | `20000` | 50.78ms | ✅ فعال |
| 3 | `47.90.149.238` | `9050` | 18.92ms | ✅ فعال |
| 4 | `184.181.217.213` | `4145` | 86.98ms | ✅ فعال |
| 5 | `8.210.17.35` | `80` | 186.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 209.15ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 220.61ms | ✅ فعال |
| 3 | `195.25.20.155` | `3128` | 114.11ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 134.39ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 16.39ms | ✅ فعال |
