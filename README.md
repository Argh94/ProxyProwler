...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:09 24-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.253.118.174` | `80` | 105.62ms | ✅ فعال |
| 2 | `185.18.250.83` | `80` | 12.42ms | ✅ فعال |
| 3 | `222.213.85.99` | `9002` | 641.19ms | ✅ فعال |
| 4 | `130.193.123.34` | `5678` | 1192.62ms | ✅ فعال |
| 5 | `209.127.143.253` | `8352` | 42.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.92` | `4145` | 156.11ms | ✅ فعال |
| 2 | `192.252.215.5` | `16137` | 88.79ms | ✅ فعال |
| 3 | `68.71.247.130` | `4145` | 74.32ms | ✅ فعال |
| 4 | `45.138.69.29` | `562` | 47.79ms | ✅ فعال |
| 5 | `8.211.152.121` | `10000` | 135.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.225.22.61` | `80` | 22.11ms | ✅ فعال |
| 2 | `38.60.196.214` | `80` | 108.66ms | ✅ فعال |
| 3 | `34.135.166.24` | `80` | 1064.79ms | ✅ فعال |
| 4 | `23.88.88.102` | `80` | 128.09ms | ✅ فعال |
| 5 | `38.145.218.76` | `8443` | 65.52ms | ✅ فعال |
