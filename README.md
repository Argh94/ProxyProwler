...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 05-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.30.213` | `80` | 7.51ms | ✅ فعال |
| 2 | `47.91.29.151` | `91` | 162.82ms | ✅ فعال |
| 3 | `103.169.142.244` | `80` | 5.52ms | ✅ فعال |
| 4 | `172.67.202.50` | `80` | 6.11ms | ✅ فعال |
| 5 | `104.18.45.220` | `80` | 5.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.92.199` | `3128` | 203.76ms | ✅ فعال |
| 2 | `47.91.29.151` | `91` | 179.40ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 224.28ms | ✅ فعال |
| 4 | `104.27.114.22` | `80` | 5.96ms | ✅ فعال |
| 5 | `45.43.64.236` | `6494` | 80.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.230.78.244` | `41883` | 114.78ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 6.14ms | ✅ فعال |
| 3 | `47.129.154.60` | `36397` | 223.74ms | ✅ فعال |
| 4 | `18.188.141.177` | `1145` | 21.74ms | ✅ فعال |
| 5 | `18.144.52.143` | `3541` | 63.51ms | ✅ فعال |
