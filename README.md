...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:14 08-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.191.0.37` | `4145` | 153.41ms | ✅ فعال |
| 2 | `5.75.133.113` | `10811` | 154.05ms | ✅ فعال |
| 3 | `151.243.153.157` | `8118` | 93.25ms | ✅ فعال |
| 4 | `103.237.102.191` | `11111` | 151.03ms | ✅ فعال |
| 5 | `86.53.111.249` | `8080` | 162.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 121.04ms | ✅ فعال |
| 2 | `192.198.126.154` | `7197` | 32.83ms | ✅ فعال |
| 3 | `37.18.73.60` | `5566` | 183.54ms | ✅ فعال |
| 4 | `86.53.111.249` | `8080` | 158.20ms | ✅ فعال |
| 5 | `13.125.44.24` | `80` | 127.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 182.20ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 161.29ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 100.08ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 187.04ms | ✅ فعال |
