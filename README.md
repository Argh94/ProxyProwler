...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:19 23-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `112.90.88.102` | `20000` | 243.26ms | ✅ فعال |
| 2 | `107.181.148.192` | `6052` | 93.05ms | ✅ فعال |
| 3 | `123.58.219.171` | `10808` | 190.91ms | ✅ فعال |
| 4 | `165.22.161.41` | `8118` | 2130.27ms | ✅ فعال |
| 5 | `72.195.34.60` | `27391` | 91.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 281.89ms | ✅ فعال |
| 2 | `212.31.100.138` | `4153` | 132.34ms | ✅ فعال |
| 3 | `67.201.39.14` | `4145` | 64.62ms | ✅ فعال |
| 4 | `8.220.204.92` | `4145` | 168.77ms | ✅ فعال |
| 5 | `72.195.34.60` | `27391` | 96.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.57.189.138` | `3128` | 123.35ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 134.92ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 2303.34ms | ✅ فعال |
