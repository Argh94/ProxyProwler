...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:29 25-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 25.82ms | ✅ فعال |
| 2 | `153.0.171.163` | `8085` | 257.08ms | ✅ فعال |
| 3 | `8.209.96.245` | `89` | 92.82ms | ✅ فعال |
| 4 | `47.56.110.204` | `8990` | 213.74ms | ✅ فعال |
| 5 | `219.65.73.81` | `80` | 246.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.253.237` | `8499` | 162.32ms | ✅ فعال |
| 2 | `107.152.98.5` | `4145` | 74.45ms | ✅ فعال |
| 3 | `184.170.249.65` | `4145` | 53.52ms | ✅ فعال |
| 4 | `8.213.222.247` | `8008` | 244.55ms | ✅ فعال |
| 5 | `184.178.172.18` | `15280` | 69.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.88.88.102` | `80` | 93.87ms | ✅ فعال |
| 2 | `163.5.128.165` | `14270` | 2.12ms | ✅ فعال |
| 3 | `20.210.113.32` | `8123` | 172.55ms | ✅ فعال |
| 4 | `13.78.120.128` | `80` | 165.68ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 1101.65ms | ✅ فعال |
