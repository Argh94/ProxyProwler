...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 24-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.58` | `4145` | 87.58ms | ✅ فعال |
| 2 | `185.162.229.138` | `80` | 1.64ms | ✅ فعال |
| 3 | `104.17.161.148` | `80` | 1.87ms | ✅ فعال |
| 4 | `104.16.100.78` | `80` | 2.62ms | ✅ فعال |
| 5 | `8.213.215.187` | `8081` | 232.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.24.98` | `3128` | 221.38ms | ✅ فعال |
| 2 | `8.213.215.187` | `8081` | 231.43ms | ✅ فعال |
| 3 | `39.102.210.176` | `8081` | 248.05ms | ✅ فعال |
| 4 | `8.130.34.237` | `1234` | 267.46ms | ✅ فعال |
| 5 | `39.102.213.187` | `18080` | 239.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.25.3` | `80` | 1.92ms | ✅ فعال |
| 2 | `104.17.190.13` | `80` | 1.93ms | ✅ فعال |
| 3 | `172.67.161.245` | `80` | 2.16ms | ✅ فعال |
| 4 | `45.131.4.9` | `80` | 3.76ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 204.11ms | ✅ فعال |
