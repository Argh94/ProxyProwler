...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 23-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `158.160.81.185` | `1080` | 187.75ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 175.36ms | ✅ فعال |
| 3 | `66.235.200.9` | `80` | 4.14ms | ✅ فعال |
| 4 | `185.18.250.146` | `80` | 1.74ms | ✅ فعال |
| 5 | `192.200.160.177` | `80` | 1.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `201.174.239.22` | `4153` | 54.11ms | ✅ فعال |
| 2 | `51.16.49.113` | `50001` | 195.51ms | ✅ فعال |
| 3 | `92.42.8.20` | `4145` | 1268.08ms | ✅ فعال |
| 4 | `188.114.96.14` | `80` | 1.91ms | ✅ فعال |
| 5 | `40.192.27.104` | `13128` | 216.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 70.23ms | ✅ فعال |
| 2 | `116.254.115.129` | `1080` | 2262.86ms | ✅ فعال |
| 3 | `3.110.127.255` | `1111` | 227.22ms | ✅ فعال |
| 4 | `3.38.101.138` | `8045` | 136.14ms | ✅ فعال |
| 5 | `43.208.129.50` | `8345` | 199.98ms | ✅ فعال |
