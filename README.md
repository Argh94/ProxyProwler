...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 29-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.170.166.150` | `80` | 5.88ms | ✅ فعال |
| 2 | `172.67.153.119` | `80` | 6.62ms | ✅ فعال |
| 3 | `104.21.24.254` | `80` | 6.63ms | ✅ فعال |
| 4 | `184.178.172.14` | `4145` | 72.80ms | ✅ فعال |
| 5 | `8.211.51.115` | `8443` | 96.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.21.186.252` | `1080` | 102.83ms | ✅ فعال |
| 2 | `171.247.243.110` | `1080` | 234.59ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 1125.23ms | ✅ فعال |
| 4 | `8.211.51.115` | `4002` | 89.47ms | ✅ فعال |
| 5 | `184.178.172.14` | `4145` | 73.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.196.63` | `9437` | 175.32ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 250.71ms | ✅ فعال |
| 3 | `54.199.199.66` | `9333` | 160.65ms | ✅ فعال |
| 4 | `3.249.110.142` | `136` | 70.74ms | ✅ فعال |
| 5 | `123.57.0.163` | `8888` | 257.62ms | ✅ فعال |
