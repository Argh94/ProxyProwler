...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:09 06-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.226.214` | `4145` | 72.66ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 219.26ms | ✅ فعال |
| 3 | `158.178.198.31` | `1080` | 85.45ms | ✅ فعال |
| 4 | `58.19.55.88` | `15100` | 243.90ms | ✅ فعال |
| 5 | `129.159.152.152` | `6666` | 128.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.226.214` | `4145` | 76.97ms | ✅ فعال |
| 2 | `199.188.93.214` | `9000` | 64.02ms | ✅ فعال |
| 3 | `31.58.18.57` | `6326` | 77.78ms | ✅ فعال |
| 4 | `142.111.124.118` | `6138` | 20.36ms | ✅ فعال |
| 5 | `47.252.11.233` | `3129` | 2.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 223.60ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 94.87ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 166.74ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 120.02ms | ✅ فعال |
| 5 | `13.127.170.8` | `3128` | 200.21ms | ✅ فعال |
