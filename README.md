...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 11-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.25.199` | `80` | 6.54ms | ✅ فعال |
| 2 | `104.16.186.6` | `80` | 1.87ms | ✅ فعال |
| 3 | `8.210.17.35` | `8080` | 869.88ms | ✅ فعال |
| 4 | `154.92.9.76` | `80` | 2.29ms | ✅ فعال |
| 5 | `173.214.176.190` | `6161` | 9.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.167.27` | `5060` | 628.27ms | ✅ فعال |
| 2 | `31.58.18.159` | `6428` | 136.75ms | ✅ فعال |
| 3 | `173.214.176.190` | `6161` | 8.40ms | ✅ فعال |
| 4 | `125.234.89.37` | `1080` | 186.29ms | ✅ فعال |
| 5 | `192.111.130.2` | `4145` | 93.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.170.170` | `480` | 242.10ms | ✅ فعال |
| 2 | `45.14.224.247` | `80` | 378.91ms | ✅ فعال |
| 3 | `13.59.97.103` | `8196` | 60.30ms | ✅ فعال |
| 4 | `201.144.25.10` | `8080` | 59.75ms | ✅ فعال |
| 5 | `36.93.73.154` | `8080` | 2244.34ms | ✅ فعال |
