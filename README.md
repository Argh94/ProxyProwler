...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:04 16-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.213.97.78` | `80` | 267.59ms | ✅ فعال |
| 2 | `103.151.20.131` | `80` | 253.79ms | ✅ فعال |
| 3 | `162.248.165.72` | `1080` | 93.00ms | ✅ فعال |
| 4 | `94.23.9.170` | `80` | 87.03ms | ✅ فعال |
| 5 | `116.171.106.111` | `3000` | 249.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.99.112.148` | `9098` | 247.62ms | ✅ فعال |
| 2 | `192.252.208.70` | `14282` | 57.37ms | ✅ فعال |
| 3 | `98.188.47.150` | `4145` | 69.73ms | ✅ فعال |
| 4 | `39.102.213.3` | `3129` | 257.50ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 92.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 2256.95ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 220.46ms | ✅ فعال |
| 3 | `23.247.136.254` | `80` | 66.22ms | ✅ فعال |
| 4 | `23.88.88.105` | `443` | 95.44ms | ✅ فعال |
| 5 | `46.29.162.166` | `80` | 168.74ms | ✅ فعال |
