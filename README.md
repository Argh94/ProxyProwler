...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 19-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.229.38` | `80` | 1.87ms | ✅ فعال |
| 2 | `104.19.211.156` | `80` | 1.94ms | ✅ فعال |
| 3 | `172.64.229.77` | `80` | 2.10ms | ✅ فعال |
| 4 | `45.196.29.119` | `80` | 1.84ms | ✅ فعال |
| 5 | `8.213.222.157` | `3128` | 552.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `110.238.116.82` | `55443` | 208.78ms | ✅ فعال |
| 2 | `47.74.157.194` | `80` | 168.07ms | ✅ فعال |
| 3 | `154.17.224.118` | `80` | 8.89ms | ✅ فعال |
| 4 | `45.43.81.41` | `5688` | 140.49ms | ✅ فعال |
| 5 | `61.184.189.124` | `10800` | 224.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.36.243.194` | `9239` | 144.42ms | ✅ فعال |
| 2 | `162.240.154.26` | `3128` | 31.09ms | ✅ فعال |
| 3 | `3.110.127.255` | `48200` | 222.15ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 163.41ms | ✅ فعال |
| 5 | `144.125.164.222` | `8080` | 1.39ms | ✅ فعال |
