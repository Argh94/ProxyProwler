...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:58 25-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.225` | `4530` | 2183.44ms | ✅ فعال |
| 2 | `144.31.152.222` | `1080` | 113.63ms | ✅ فعال |
| 3 | `185.230.191.240` | `1080` | 105.24ms | ✅ فعال |
| 4 | `167.99.236.14` | `80` | 7.03ms | ✅ فعال |
| 5 | `192.252.209.155` | `14455` | 62.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.111.112.118` | `4145` | 113.10ms | ✅ فعال |
| 2 | `75.84.71.14` | `80` | 1098.37ms | ✅ فعال |
| 3 | `91.247.92.63` | `5678` | 1148.47ms | ✅ فعال |
| 4 | `45.238.57.1` | `3629` | 87.85ms | ✅ فعال |
| 5 | `186.216.195.1` | `4153` | 111.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 236.31ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 2.70ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 262.82ms | ✅ فعال |
