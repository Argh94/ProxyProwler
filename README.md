...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:43 06-01-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (54 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.206` | `4145` | 1190.59ms | ✅ فعال |
| 2 | `115.231.37.248` | `11383` | 218.20ms | ✅ فعال |
| 3 | `65.108.203.35` | `18080` | 179.67ms | ✅ فعال |
| 4 | `102.219.209.86` | `8080` | 1283.34ms | ✅ فعال |
| 5 | `43.250.54.139` | `60000` | 145.73ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (20 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.130.219.11` | `4153` | 1152.36ms | ✅ فعال |
| 2 | `43.250.54.139` | `60000` | 146.09ms | ✅ فعال |
| 3 | `103.166.39.81` | `3629` | 219.12ms | ✅ فعال |
| 4 | `163.123.181.147` | `9950` | 47.61ms | ✅ فعال |
| 5 | `177.66.43.189` | `4145` | 196.52ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (5 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 1219.37ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1431.82ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 135.84ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 185.07ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 1204.49ms | ✅ فعال |
