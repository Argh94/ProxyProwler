...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:33 22-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.215.2` | `4145` | 66.53ms | ✅ فعال |
| 2 | `157.151.196.142` | `1080` | 20.55ms | ✅ فعال |
| 3 | `191.44.118.236` | `1080` | 103.16ms | ✅ فعال |
| 4 | `166.88.64.226` | `6609` | 49.02ms | ✅ فعال |
| 5 | `178.212.144.7` | `80` | 116.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.207.92.87` | `1088` | 23.98ms | ✅ فعال |
| 2 | `8.221.138.111` | `8443` | 150.03ms | ✅ فعال |
| 3 | `8.221.138.111` | `6379` | 148.75ms | ✅ فعال |
| 4 | `98.182.147.97` | `4145` | 96.86ms | ✅ فعال |
| 5 | `45.10.42.68` | `1080` | 112.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 209.17ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 112.72ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 222.98ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 214.80ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 2220.90ms | ✅ فعال |
