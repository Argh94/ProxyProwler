...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 01-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.123.255.68` | `80` | 1.61ms | ✅ فعال |
| 2 | `185.148.107.245` | `80` | 1.95ms | ✅ فعال |
| 3 | `164.38.155.17` | `80` | 1.98ms | ✅ فعال |
| 4 | `8.211.49.86` | `9098` | 92.34ms | ✅ فعال |
| 5 | `186.65.109.21` | `81` | 196.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 208.82ms | ✅ فعال |
| 2 | `47.243.50.83` | `81` | 219.18ms | ✅ فعال |
| 3 | `8.213.156.191` | `12000` | 196.03ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 260.84ms | ✅ فعال |
| 5 | `39.104.57.170` | `3000` | 257.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.243.149.86` | `31028` | 61.78ms | ✅ فعال |
| 2 | `3.38.101.138` | `7010` | 186.48ms | ✅ فعال |
| 3 | `173.212.237.47` | `3128` | 89.41ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 3.57ms | ✅ فعال |
| 5 | `218.89.134.230` | `3333` | 265.81ms | ✅ فعال |
