...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 18-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.18.37` | `8443` | 7.02ms | ✅ فعال |
| 2 | `104.24.56.243` | `80` | 1.85ms | ✅ فعال |
| 3 | `154.92.9.91` | `80` | 1.99ms | ✅ فعال |
| 4 | `185.170.166.114` | `80` | 2.54ms | ✅ فعال |
| 5 | `206.238.236.223` | `80` | 2.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 267.44ms | ✅ فعال |
| 2 | `193.122.105.251` | `65535` | 202.58ms | ✅ فعال |
| 3 | `108.162.194.8` | `80` | 2.03ms | ✅ فعال |
| 4 | `43.209.130.76` | `621` | 250.52ms | ✅ فعال |
| 5 | `135.125.174.192` | `80` | 96.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.198.248.18` | `1981` | 257.93ms | ✅ فعال |
| 2 | `16.78.47.161` | `53053` | 286.37ms | ✅ فعال |
| 3 | `157.175.196.63` | `182` | 168.83ms | ✅ فعال |
| 4 | `200.59.191.232` | `999` | 94.70ms | ✅ فعال |
| 5 | `43.206.234.160` | `15498` | 207.40ms | ✅ فعال |
