...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:32 06-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `143.42.66.91` | `80` | 207.80ms | ✅ فعال |
| 2 | `8.213.195.191` | `4002` | 851.03ms | ✅ فعال |
| 3 | `98.181.137.80` | `4145` | 127.64ms | ✅ فعال |
| 4 | `8.221.138.111` | `2000` | 141.90ms | ✅ فعال |
| 5 | `167.103.115.102` | `8800` | 207.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.134.213` | `1000` | 182.63ms | ✅ فعال |
| 2 | `198.37.116.163` | `6122` | 26.75ms | ✅ فعال |
| 3 | `137.220.150.170` | `6005` | 205.47ms | ✅ فعال |
| 4 | `103.166.39.81` | `3629` | 270.67ms | ✅ فعال |
| 5 | `8.137.62.53` | `9080` | 273.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.130.104.106` | `33333` | 150.54ms | ✅ فعال |
| 2 | `102.164.252.150` | `8080` | 2232.55ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 233.52ms | ✅ فعال |
| 4 | `179.96.28.58` | `80` | 150.37ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 228.14ms | ✅ فعال |
