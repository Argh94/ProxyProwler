...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 08-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.95.250.52` | `6325` | 35.99ms | ✅ فعال |
| 2 | `8.210.17.35` | `8003` | 843.74ms | ✅ فعال |
| 3 | `8.211.42.167` | `1080` | 121.88ms | ✅ فعال |
| 4 | `8.221.139.222` | `6379` | 438.27ms | ✅ فعال |
| 5 | `104.21.31.177` | `80` | 12.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.44.62.153` | `9090` | 250.81ms | ✅ فعال |
| 2 | `185.88.177.197` | `8080` | 180.14ms | ✅ فعال |
| 3 | `79.106.170.126` | `4145` | 138.60ms | ✅ فعال |
| 4 | `8.213.129.15` | `3129` | 159.17ms | ✅ فعال |
| 5 | `101.51.138.138` | `8080` | 233.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.114.96.63` | `80` | 14.13ms | ✅ فعال |
| 2 | `104.17.25.3` | `80` | 12.38ms | ✅ فعال |
| 3 | `104.17.26.109` | `80` | 9.67ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 14.17ms | ✅ فعال |
| 5 | `185.162.230.130` | `80` | 11.80ms | ✅ فعال |
