...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:09 25-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.30.52` | `80` | 2.55ms | ✅ فعال |
| 2 | `108.162.198.113` | `80` | 16.16ms | ✅ فعال |
| 3 | `45.67.215.186` | `80` | 2.65ms | ✅ فعال |
| 4 | `141.193.213.49` | `80` | 2.07ms | ✅ فعال |
| 5 | `51.83.190.248` | `19050` | 119.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.45` | `80` | 2.56ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 1184.02ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 2174.61ms | ✅ فعال |
| 4 | `98.181.137.83` | `4145` | 89.39ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 238.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `147.75.33.108` | `10113` | 492.62ms | ✅ فعال |
| 2 | `45.4.202.170` | `999` | 99.92ms | ✅ فعال |
| 3 | `203.202.241.4` | `3128` | 248.10ms | ✅ فعال |
| 4 | `145.40.97.148` | `10010` | 1386.96ms | ✅ فعال |
| 5 | `157.175.43.137` | `1085` | 189.92ms | ✅ فعال |
