...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:45 23-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.220` | `17801` | 151.94ms | ✅ فعال |
| 2 | `206.206.69.22` | `6286` | 8.13ms | ✅ فعال |
| 3 | `64.90.1.178` | `1080` | 154.09ms | ✅ فعال |
| 4 | `8.213.134.213` | `8081` | 129.48ms | ✅ فعال |
| 5 | `123.58.219.150` | `7890` | 150.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `77.110.116.93` | `7443` | 1158.16ms | ✅ فعال |
| 2 | `8.213.134.213` | `8081` | 128.24ms | ✅ فعال |
| 3 | `146.103.56.142` | `5690` | 146.75ms | ✅ فعال |
| 4 | `217.69.121.158` | `5823` | 146.16ms | ✅ فعال |
| 5 | `200.108.50.254` | `4145` | 113.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.2.64.185` | `8118` | 2210.51ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 191.91ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 68.08ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 115.06ms | ✅ فعال |
| 5 | `128.90.145.79` | `8118` | 173.61ms | ✅ فعال |
