...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 29-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.1.118` | `80` | 1.73ms | ✅ فعال |
| 2 | `23.227.60.138` | `80` | 2.56ms | ✅ فعال |
| 3 | `45.39.4.247` | `5672` | 151.99ms | ✅ فعال |
| 4 | `104.16.100.57` | `80` | 2.63ms | ✅ فعال |
| 5 | `104.24.247.90` | `80` | 170.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 240.58ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 2.01ms | ✅ فعال |
| 3 | `79.127.56.147` | `8080` | 2340.35ms | ✅ فعال |
| 4 | `104.16.0.195` | `80` | 1.75ms | ✅ فعال |
| 5 | `23.227.60.138` | `80` | 2.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.66.40.96` | `80` | 2.82ms | ✅ فعال |
| 2 | `198.177.56.190` | `80` | 1.93ms | ✅ فعال |
| 3 | `104.25.1.112` | `80` | 67.79ms | ✅ فعال |
| 4 | `202.137.8.150` | `8080` | 221.06ms | ✅ فعال |
| 5 | `62.72.166.211` | `80` | 2.76ms | ✅ فعال |
