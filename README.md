...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 01-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.42` | `80` | 1.80ms | ✅ فعال |
| 2 | `47.91.29.151` | `8443` | 597.02ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 168.56ms | ✅ فعال |
| 4 | `194.152.44.77` | `80` | 2.36ms | ✅ فعال |
| 5 | `104.19.166.205` | `80` | 1.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 207.20ms | ✅ فعال |
| 2 | `97.107.136.153` | `80` | 1130.14ms | ✅ فعال |
| 3 | `8.130.34.44` | `3128` | 462.95ms | ✅ فعال |
| 4 | `198.199.86.11` | `80` | 78.71ms | ✅ فعال |
| 5 | `47.252.29.28` | `11222` | 63.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 66.97ms | ✅ فعال |
| 2 | `43.216.214.104` | `1080` | 174.28ms | ✅ فعال |
| 3 | `88.216.98.55` | `48852` | 73.00ms | ✅ فعال |
| 4 | `13.212.76.113` | `50445` | 169.81ms | ✅ فعال |
| 5 | `13.115.193.75` | `859` | 106.15ms | ✅ فعال |
