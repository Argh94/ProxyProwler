...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:49 16-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `170.114.45.135` | `80` | 2.00ms | ✅ فعال |
| 2 | `169.150.213.229` | `10794` | 142.98ms | ✅ فعال |
| 3 | `45.131.208.145` | `80` | 2.18ms | ✅ فعال |
| 4 | `39.102.210.176` | `8008` | 200.86ms | ✅ فعال |
| 5 | `209.46.30.120` | `80` | 3.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.0.0.4` | `80` | 1.66ms | ✅ فعال |
| 2 | `209.50.180.176` | `3129` | 163.68ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 201.80ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 203.00ms | ✅ فعال |
| 5 | `8.213.129.20` | `4001` | 131.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.230.130` | `80` | 1.84ms | ✅ فعال |
| 2 | `5.10.246.51` | `80` | 2.02ms | ✅ فعال |
| 3 | `173.245.49.114` | `80` | 1.77ms | ✅ فعال |
| 4 | `23.227.39.55` | `80` | 1.75ms | ✅ فعال |
| 5 | `104.16.0.165` | `80` | 1.68ms | ✅ فعال |
