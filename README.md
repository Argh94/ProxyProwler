...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:25 14-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.211` | `13240` | 121.64ms | ✅ فعال |
| 2 | `66.42.224.229` | `41679` | 127.19ms | ✅ فعال |
| 3 | `176.111.37.216` | `39811` | 99.75ms | ✅ فعال |
| 4 | `197.221.249.196` | `80` | 242.31ms | ✅ فعال |
| 5 | `192.252.211.197` | `14921` | 65.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `181.115.207.114` | `1080` | 1202.26ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 259.08ms | ✅ فعال |
| 3 | `103.179.189.15` | `10001` | 255.72ms | ✅ فعال |
| 4 | `192.252.208.67` | `14287` | 64.65ms | ✅ فعال |
| 5 | `145.223.44.228` | `5911` | 35.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.130.70.253` | `83` | 1339.87ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 117.32ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 2.49ms | ✅ فعال |
| 4 | `195.25.20.155` | `3128` | 1114.04ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.62ms | ✅ فعال |
