...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:16 14-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `161.35.82.57` | `1080` | 117.22ms | ✅ فعال |
| 2 | `192.111.135.18` | `18301` | 77.60ms | ✅ فعال |
| 3 | `154.62.226.187` | `9051` | 123.40ms | ✅ فعال |
| 4 | `20.164.75.153` | `8080` | 245.44ms | ✅ فعال |
| 5 | `206.123.156.207` | `5285` | 135.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.73.22.230` | `1080` | 215.69ms | ✅ فعال |
| 2 | `98.178.72.21` | `10919` | 107.42ms | ✅ فعال |
| 3 | `181.48.243.194` | `4153` | 1137.35ms | ✅ فعال |
| 4 | `98.103.88.158` | `46104` | 29.91ms | ✅ فعال |
| 5 | `72.205.0.67` | `4145` | 104.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 137.14ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 204.81ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 154.43ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 196.03ms | ✅ فعال |
