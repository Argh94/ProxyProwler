...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:41 13-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.183.251` | `4145` | 93.47ms | ✅ فعال |
| 2 | `165.22.63.133` | `1080` | 168.08ms | ✅ فعال |
| 3 | `119.188.131.55` | `17981` | 199.01ms | ✅ فعال |
| 4 | `144.91.121.61` | `1088` | 1282.63ms | ✅ فعال |
| 5 | `98.178.72.21` | `10919` | 110.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.13.239.4` | `5678` | 185.20ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 245.21ms | ✅ فعال |
| 3 | `101.255.166.134` | `80` | 182.95ms | ✅ فعال |
| 4 | `184.178.172.17` | `4145` | 111.57ms | ✅ فعال |
| 5 | `177.136.124.46` | `56113` | 2287.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 184.16ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 114.77ms | ✅ فعال |
| 3 | `103.130.61.61` | `8081` | 1249.70ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 176.87ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 191.77ms | ✅ فعال |
