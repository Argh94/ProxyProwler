...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:32 14-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `165.22.243.171` | `1080` | 222.21ms | ✅ فعال |
| 2 | `23.94.76.170` | `1080` | 18.60ms | ✅ فعال |
| 3 | `145.223.44.236` | `5919` | 35.29ms | ✅ فعال |
| 4 | `192.198.117.137` | `7730` | 55.75ms | ✅ فعال |
| 5 | `65.21.252.66` | `10801` | 114.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `50.238.47.86` | `32100` | 2065.44ms | ✅ فعال |
| 2 | `8.220.204.215` | `8443` | 186.31ms | ✅ فعال |
| 3 | `45.194.41.73` | `8080` | 199.57ms | ✅ فعال |
| 4 | `144.202.16.214` | `1088` | 15.32ms | ✅ فعال |
| 5 | `185.130.219.11` | `4153` | 92.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 1279.27ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 223.94ms | ✅ فعال |
| 3 | `103.130.61.61` | `8081` | 2286.51ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 117.46ms | ✅ فعال |
| 5 | `103.146.170.193` | `82` | 205.95ms | ✅ فعال |
