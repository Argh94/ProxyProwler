...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:06 12-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `135.125.174.192` | `80` | 92.31ms | ✅ فعال |
| 2 | `120.92.212.16` | `7890` | 269.80ms | ✅ فعال |
| 3 | `185.233.202.217` | `5858` | 98.71ms | ✅ فعال |
| 4 | `67.215.13.242` | `27220` | 21.36ms | ✅ فعال |
| 5 | `45.135.139.150` | `6453` | 81.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `213.156.124.3` | `33333` | 2167.12ms | ✅ فعال |
| 2 | `185.226.204.161` | `5714` | 76.40ms | ✅ فعال |
| 3 | `49.0.199.132` | `19` | 266.59ms | ✅ فعال |
| 4 | `208.102.51.6` | `58208` | 1577.00ms | ✅ فعال |
| 5 | `46.8.60.34` | `1080` | 1164.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `207.5.207.47` | `3128` | 65.79ms | ✅ فعال |
| 2 | `40.192.16.115` | `14186` | 223.90ms | ✅ فعال |
| 3 | `157.175.197.28` | `750` | 176.93ms | ✅ فعال |
| 4 | `13.212.14.16` | `28080` | 221.09ms | ✅ فعال |
| 5 | `78.12.230.52` | `8111` | 60.04ms | ✅ فعال |
