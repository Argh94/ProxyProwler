...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:46 31-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.115.134` | `1080` | 187.27ms | ✅ فعال |
| 2 | `23.236.255.254` | `7030` | 8.75ms | ✅ فعال |
| 3 | `68.71.243.14` | `4145` | 26.58ms | ✅ فعال |
| 4 | `134.199.148.128` | `1080` | 142.44ms | ✅ فعال |
| 5 | `206.123.156.228` | `4273` | 2218.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.190.10.47` | `1080` | 137.65ms | ✅ فعال |
| 2 | `67.201.35.145` | `4145` | 24.64ms | ✅ فعال |
| 3 | `31.59.20.67` | `6645` | 127.22ms | ✅ فعال |
| 4 | `8.211.51.115` | `8889` | 141.74ms | ✅ فعال |
| 5 | `8.130.54.67` | `80` | 221.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 54.32ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 141.99ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 201.55ms | ✅ فعال |
| 4 | `209.141.54.136` | `5555` | 19.32ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 174.60ms | ✅ فعال |
