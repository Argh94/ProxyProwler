...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 13-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.117.229` | `80` | 5.86ms | ✅ فعال |
| 2 | `5.10.246.160` | `80` | 5.71ms | ✅ فعال |
| 3 | `172.67.229.29` | `80` | 5.96ms | ✅ فعال |
| 4 | `8.148.22.214` | `20002` | 268.31ms | ✅ فعال |
| 5 | `104.21.224.204` | `80` | 17.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `123.57.1.16` | `5555` | 230.36ms | ✅ فعال |
| 2 | `81.169.213.169` | `8888` | 104.60ms | ✅ فعال |
| 3 | `110.238.116.82` | `55443` | 265.80ms | ✅ فعال |
| 4 | `136.0.180.253` | `6274` | 24.64ms | ✅ فعال |
| 5 | `120.26.104.146` | `8089` | 266.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.225.207.182` | `999` | 114.93ms | ✅ فعال |
| 2 | `13.59.113.45` | `9545` | 23.17ms | ✅ فعال |
| 3 | `199.48.129.114` | `3120` | 1036.14ms | ✅ فعال |
| 4 | `43.217.141.124` | `11857` | 233.15ms | ✅ فعال |
| 5 | `16.78.93.162` | `46364` | 243.79ms | ✅ فعال |
