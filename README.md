...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 14-09-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (76 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.26.8.123` | `80` | 18.54ms | ✅ فعال |
| 2 | `8.221.139.222` | `8443` | 123.61ms | ✅ فعال |
| 3 | `172.67.181.65` | `80` | 18.47ms | ✅ فعال |
| 4 | `104.27.72.135` | `80` | 18.34ms | ✅ فعال |
| 5 | `104.21.31.125` | `80` | 18.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.252.152` | `8888` | 204.59ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 283.69ms | ✅ فعال |
| 3 | `39.102.211.64` | `8088` | 213.91ms | ✅ فعال |
| 4 | `166.88.83.16` | `6673` | 27.51ms | ✅ فعال |
| 5 | `119.13.111.169` | `4006` | 189.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.38.101.138` | `45563` | 147.11ms | ✅ فعال |
| 2 | `13.59.113.45` | `9545` | 44.78ms | ✅ فعال |
| 3 | `45.225.207.183` | `999` | 139.88ms | ✅ فعال |
| 4 | `13.231.159.110` | `52654` | 129.62ms | ✅ فعال |
| 5 | `16.78.47.161` | `43710` | 198.08ms | ✅ فعال |
