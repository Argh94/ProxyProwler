...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:13 18-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.54.178.193` | `1080` | 236.61ms | ✅ فعال |
| 2 | `104.19.7.209` | `80` | 1.52ms | ✅ فعال |
| 3 | `194.152.44.187` | `80` | 1.68ms | ✅ فعال |
| 4 | `104.16.0.88` | `80` | 2.06ms | ✅ فعال |
| 5 | `5.10.247.100` | `80` | 1.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `96.126.111.39` | `1081` | 66.96ms | ✅ فعال |
| 2 | `8.148.22.214` | `8080` | 292.40ms | ✅ فعال |
| 3 | `47.238.60.156` | `8008` | 158.88ms | ✅ فعال |
| 4 | `104.248.203.234` | `1080` | 140.98ms | ✅ فعال |
| 5 | `139.196.151.191` | `8090` | 197.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.16.49.113` | `8585` | 349.76ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 72.23ms | ✅ فعال |
| 3 | `13.246.11.197` | `621` | 278.44ms | ✅ فعال |
| 4 | `15.160.148.69` | `49547` | 159.63ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 167.33ms | ✅ فعال |
