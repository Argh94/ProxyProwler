...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:15 23-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.156.191` | `800` | 585.32ms | ✅ فعال |
| 2 | `58.241.88.13` | `800` | 137.74ms | ✅ فعال |
| 3 | `192.73.244.36` | `80` | 9.67ms | ✅ فعال |
| 4 | `8.211.194.78` | `8005` | 2838.18ms | ✅ فعال |
| 5 | `185.76.240.134` | `10001` | 218.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 1263.74ms | ✅ فعال |
| 2 | `91.84.125.92` | `1080` | 146.24ms | ✅ فعال |
| 3 | `154.29.87.143` | `6564` | 61.47ms | ✅ فعال |
| 4 | `146.103.3.96` | `7149` | 139.96ms | ✅ فعال |
| 5 | `8.213.156.191` | `800` | 693.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 180.27ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 115.16ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 181.06ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 167.46ms | ✅ فعال |
