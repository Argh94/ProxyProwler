...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:52 24-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.204` | `7907` | 116.61ms | ✅ فعال |
| 2 | `67.227.37.51` | `5593` | 61.78ms | ✅ فعال |
| 3 | `65.109.191.98` | `3080` | 113.36ms | ✅ فعال |
| 4 | `139.28.241.247` | `1081` | 197.75ms | ✅ فعال |
| 5 | `216.68.128.121` | `4145` | 87.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.3.69.222` | `8080` | 149.75ms | ✅ فعال |
| 2 | `155.254.38.243` | `5919` | 84.06ms | ✅ فعال |
| 3 | `145.220.226.236` | `8080` | 90.80ms | ✅ فعال |
| 4 | `69.48.201.94` | `80` | 33.04ms | ✅ فعال |
| 5 | `68.71.249.153` | `48606` | 72.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `58.69.125.145` | `8081` | 224.03ms | ✅ فعال |
| 2 | `46.10.209.230` | `8080` | 133.11ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 243.82ms | ✅ فعال |
