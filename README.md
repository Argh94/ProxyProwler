...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:50 02-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `157.230.220.25` | `4857` | 35.68ms | ✅ فعال |
| 2 | `142.54.231.38` | `4145` | 78.46ms | ✅ فعال |
| 3 | `188.114.99.205` | `80` | 2.42ms | ✅ فعال |
| 4 | `45.131.211.101` | `80` | 1.86ms | ✅ فعال |
| 5 | `104.16.66.212` | `80` | 2.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.30.252.55` | `5186` | 20.74ms | ✅ فعال |
| 2 | `64.64.115.52` | `5687` | 31.80ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 238.54ms | ✅ فعال |
| 4 | `79.106.170.126` | `4145` | 2195.43ms | ✅ فعال |
| 5 | `1.180.49.222` | `7302` | 260.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 2165.05ms | ✅ فعال |
| 2 | `185.148.104.15` | `80` | 1.93ms | ✅ فعال |
| 3 | `104.16.1.135` | `80` | 3.06ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 1.71ms | ✅ فعال |
| 5 | `190.93.247.0` | `80` | 2.59ms | ✅ فعال |
