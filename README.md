...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 01-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.200.183` | `9098` | 146.26ms | ✅ فعال |
| 2 | `8.220.204.92` | `80` | 134.79ms | ✅ فعال |
| 3 | `145.241.223.213` | `805` | 138.28ms | ✅ فعال |
| 4 | `34.134.231.117` | `3129` | 49.55ms | ✅ فعال |
| 5 | `118.145.141.251` | `44144` | 2239.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.214.205.160` | `40448` | 168.94ms | ✅ فعال |
| 2 | `101.255.166.134` | `80` | 183.60ms | ✅ فعال |
| 3 | `45.43.70.128` | `6415` | 138.38ms | ✅ فعال |
| 4 | `37.18.73.60` | `5566` | 184.48ms | ✅ فعال |
| 5 | `23.27.208.112` | `5822` | 64.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 145.43ms | ✅ فعال |
| 2 | `103.130.61.61` | `8081` | 198.09ms | ✅ فعال |
| 3 | `195.87.182.10` | `9090` | 2237.30ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 168.52ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 185.91ms | ✅ فعال |
