...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:45 12-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.197.218.238` | `8080` | 12.72ms | ✅ فعال |
| 2 | `103.82.23.118` | `5207` | 244.60ms | ✅ فعال |
| 3 | `51.141.175.118` | `80` | 45.05ms | ✅ فعال |
| 4 | `8.212.177.126` | `8080` | 1259.51ms | ✅ فعال |
| 5 | `142.93.202.130` | `3128` | 33.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.114.89.74` | `1080` | 146.98ms | ✅ فعال |
| 2 | `50.238.47.86` | `32100` | 1075.69ms | ✅ فعال |
| 3 | `206.220.175.2` | `4145` | 89.89ms | ✅ فعال |
| 4 | `39.104.59.56` | `1081` | 230.50ms | ✅ فعال |
| 5 | `104.37.135.145` | `4145` | 1124.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.60.222.217` | `28731` | 233.54ms | ✅ فعال |
| 2 | `40.192.3.100` | `7777` | 233.47ms | ✅ فعال |
| 3 | `40.177.211.224` | `8705` | 54.19ms | ✅ فعال |
| 4 | `43.205.124.165` | `8445` | 219.11ms | ✅ فعال |
| 5 | `40.192.100.189` | `10810` | 235.88ms | ✅ فعال |
