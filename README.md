...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:05 25-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.108.13.120` | `8083` | 226.96ms | ✅ فعال |
| 2 | `46.17.47.48` | `80` | 186.30ms | ✅ فعال |
| 3 | `113.108.13.120` | `4433` | 221.73ms | ✅ فعال |
| 4 | `36.138.53.26` | `10017` | 206.42ms | ✅ فعال |
| 5 | `49.4.117.146` | `3128` | 222.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.60.156` | `18080` | 743.02ms | ✅ فعال |
| 2 | `39.104.57.33` | `34567` | 220.75ms | ✅ فعال |
| 3 | `192.111.134.10` | `4145` | 60.41ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 255.75ms | ✅ فعال |
| 5 | `47.243.124.21` | `6666` | 161.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 181.29ms | ✅ فعال |
| 2 | `61.76.95.217` | `40088` | 143.11ms | ✅ فعال |
| 3 | `5.9.218.168` | `3128` | 130.35ms | ✅ فعال |
| 4 | `179.255.219.182` | `8080` | 219.56ms | ✅ فعال |
| 5 | `5.161.155.252` | `80` | 1065.14ms | ✅ فعال |
