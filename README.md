...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:20 30-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.225` | `6764` | 131.71ms | ✅ فعال |
| 2 | `79.137.199.99` | `1080` | 143.40ms | ✅ فعال |
| 3 | `45.135.139.182` | `6485` | 126.16ms | ✅ فعال |
| 4 | `184.95.220.42` | `1080` | 1086.99ms | ✅ فعال |
| 5 | `113.176.118.150` | `1080` | 198.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.188.245.98` | `52837` | 224.80ms | ✅ فعال |
| 2 | `8.220.204.92` | `1088` | 143.32ms | ✅ فعال |
| 3 | `104.161.23.122` | `5034` | 35.94ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 266.61ms | ✅ فعال |
| 5 | `103.253.43.144` | `80` | 225.58ms | ✅ فعال |
...
| 2 | `195.57.239.25` | `8080` | 162.72ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 181.79ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 49.66ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 242.09ms | ✅ فعال |
