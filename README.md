...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:24 14-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.104.28.135` | `4216` | 158.00ms | ✅ فعال |
| 2 | `145.100.181.155` | `80` | 1169.70ms | ✅ فعال |
| 3 | `198.8.84.3` | `4145` | 22.50ms | ✅ فعال |
| 4 | `51.141.175.118` | `80` | 22.58ms | ✅ فعال |
| 5 | `133.18.234.13` | `80` | 117.01ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (8 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `161.35.82.57` | `1080` | 145.58ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 398.09ms | ✅ فعال |
| 3 | `184.170.248.5` | `4145` | 105.07ms | ✅ فعال |
| 4 | `47.104.28.135` | `4216` | 158.64ms | ✅ فعال |
| 5 | `184.181.217.194` | `4145` | 144.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 112.91ms | ✅ فعال |
| 2 | `104.128.228.69` | `8118` | 1070.57ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 177.86ms | ✅ فعال |
| 4 | `62.23.184.84` | `8080` | 1185.53ms | ✅ فعال |
| 5 | `45.119.85.216` | `3128` | 748.97ms | ✅ فعال |
