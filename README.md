...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:32 15-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.197.208` | `8443` | 221.64ms | ✅ فعال |
| 2 | `72.194.42.131` | `4145` | 80.81ms | ✅ فعال |
| 3 | `95.81.230.8` | `1080` | 170.28ms | ✅ فعال |
| 4 | `72.49.49.11` | `31034` | 96.48ms | ✅ فعال |
| 5 | `68.183.177.34` | `1080` | 198.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.26.243.106` | `3129` | 120.83ms | ✅ فعال |
| 2 | `8.211.42.167` | `8888` | 115.55ms | ✅ فعال |
| 3 | `92.255.190.64` | `4153` | 192.15ms | ✅ فعال |
| 4 | `38.154.191.224` | `8801` | 45.08ms | ✅ فعال |
| 5 | `13.125.44.24` | `80` | 167.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 207.00ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 217.72ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 135.33ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 157.65ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 238.84ms | ✅ فعال |
