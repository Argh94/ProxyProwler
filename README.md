...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:23 07-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.232.101.224` | `8356` | 64.92ms | ✅ فعال |
| 2 | `98.170.57.231` | `4145` | 75.33ms | ✅ فعال |
| 3 | `40.89.145.14` | `80` | 81.00ms | ✅ فعال |
| 4 | `173.211.69.40` | `6633` | 59.45ms | ✅ فعال |
| 5 | `31.59.33.13` | `6589` | 80.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.102.210.176` | `9098` | 255.48ms | ✅ فعال |
| 2 | `72.223.188.67` | `4145` | 75.04ms | ✅ فعال |
| 3 | `110.5.113.227` | `80` | 2336.75ms | ✅ فعال |
| 4 | `187.44.211.118` | `4153` | 149.52ms | ✅ فعال |
| 5 | `184.178.172.26` | `4145` | 93.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 223.03ms | ✅ فعال |
| 2 | `37.27.100.112` | `443` | 117.62ms | ✅ فعال |
| 3 | `14.56.107.244` | `3128` | 187.08ms | ✅ فعال |
| 4 | `34.44.49.215` | `80` | 34.23ms | ✅ فعال |
| 5 | `41.191.203.162` | `80` | 228.74ms | ✅ فعال |
