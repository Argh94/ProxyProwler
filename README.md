...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:10 05-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.17` | `80` | 1.84ms | ✅ فعال |
| 2 | `162.159.244.202` | `80` | 2.66ms | ✅ فعال |
| 3 | `104.16.232.20` | `80` | 2.07ms | ✅ فعال |
| 4 | `172.67.171.213` | `80` | 2.38ms | ✅ فعال |
| 5 | `45.131.6.84` | `80` | 1.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.177.202` | `111` | 236.84ms | ✅ فعال |
| 2 | `110.238.109.146` | `19` | 211.43ms | ✅ فعال |
| 3 | `8.213.215.187` | `1080` | 236.03ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 268.56ms | ✅ فعال |
| 5 | `23.227.39.17` | `80` | 2.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.14.16` | `28080` | 209.06ms | ✅ فعال |
| 2 | `13.115.193.75` | `46264` | 142.19ms | ✅ فعال |
| 3 | `3.110.127.255` | `5534` | 212.07ms | ✅ فعال |
| 4 | `3.35.25.117` | `891` | 171.83ms | ✅ فعال |
| 5 | `40.177.211.224` | `8705` | 52.42ms | ✅ فعال |
