...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:30 04-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `87.107.111.50` | `4444` | 229.93ms | ✅ فعال |
| 2 | `190.104.8.142` | `14888` | 161.10ms | ✅ فعال |
| 3 | `174.77.111.197` | `4145` | 83.51ms | ✅ فعال |
| 4 | `8.211.49.86` | `10000` | 133.33ms | ✅ فعال |
| 5 | `98.188.47.150` | `4145` | 83.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `61.82.175.76` | `1080` | 142.10ms | ✅ فعال |
| 2 | `8.211.49.86` | `10000` | 138.03ms | ✅ فعال |
| 3 | `176.111.37.216` | `39811` | 142.78ms | ✅ فعال |
| 4 | `203.188.245.98` | `52837` | 248.47ms | ✅ فعال |
| 5 | `168.138.210.69` | `1080` | 125.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 52.58ms | ✅ فعال |
| 2 | `101.255.117.138` | `2020` | 2271.63ms | ✅ فعال |
| 3 | `45.174.168.4` | `999` | 2117.20ms | ✅ فعال |
| 4 | `180.191.14.210` | `8081` | 206.67ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 145.09ms | ✅ فعال |
