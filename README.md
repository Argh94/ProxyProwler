...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 07-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `69.84.182.145` | `80` | 1.87ms | ✅ فعال |
| 2 | `216.205.52.208` | `80` | 2.32ms | ✅ فعال |
| 3 | `172.67.71.46` | `80` | 2.29ms | ✅ فعال |
| 4 | `31.56.137.8` | `6084` | 27.05ms | ✅ فعال |
| 5 | `8.210.17.35` | `8003` | 870.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.160.16.234` | `8020` | 228.95ms | ✅ فعال |
| 2 | `39.104.79.145` | `1234` | 262.35ms | ✅ فعال |
| 3 | `120.26.104.146` | `8089` | 247.88ms | ✅ فعال |
| 4 | `39.104.62.128` | `5000` | 263.97ms | ✅ فعال |
| 5 | `109.248.236.150` | `60606` | 160.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.158.81` | `27610` | 226.71ms | ✅ فعال |
| 2 | `152.42.206.102` | `8080` | 220.33ms | ✅ فعال |
| 3 | `43.217.136.176` | `8007` | 226.58ms | ✅ فعال |
| 4 | `40.176.96.235` | `315` | 76.63ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.36ms | ✅ فعال |
