...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 01:33 04-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `38.54.71.67` | `80` | 251.94ms | ✅ فعال |
| 2 | `103.66.176.45` | `32251` | 238.02ms | ✅ فعال |
| 3 | `161.123.154.20` | `6550` | 61.20ms | ✅ فعال |
| 4 | `185.216.105.13` | `6590` | 27.39ms | ✅ فعال |
| 5 | `1.180.0.162` | `7302` | 208.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `97.105.12.186` | `4153` | 55.92ms | ✅ فعال |
| 2 | `1.180.49.222` | `7302` | 224.76ms | ✅ فعال |
| 3 | `166.88.235.91` | `5719` | 2.90ms | ✅ فعال |
| 4 | `51.158.105.157` | `16379` | 2220.31ms | ✅ فعال |
| 5 | `101.200.158.109` | `8880` | 204.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.103` | `80` | 2.13ms | ✅ فعال |
| 2 | `172.67.88.21` | `80` | 142.83ms | ✅ فعال |
| 3 | `45.131.4.93` | `80` | 2.03ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 2.02ms | ✅ فعال |
| 5 | `173.245.49.93` | `80` | 1.96ms | ✅ فعال |
