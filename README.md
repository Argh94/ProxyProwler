...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 05-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.194.53.199` | `80` | 1.55ms | ✅ فعال |
| 2 | `34.124.190.108` | `8080` | 176.34ms | ✅ فعال |
| 3 | `104.18.199.130` | `80` | 1.76ms | ✅ فعال |
| 4 | `141.101.114.220` | `80` | 2.13ms | ✅ فعال |
| 5 | `173.245.49.23` | `80` | 1.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.44` | `3128` | 222.01ms | ✅ فعال |
| 2 | `45.43.81.6` | `5653` | 140.62ms | ✅ فعال |
| 3 | `31.169.65.90` | `1080` | 2240.77ms | ✅ فعال |
| 4 | `49.0.199.132` | `19` | 209.30ms | ✅ فعال |
| 5 | `98.175.31.195` | `4145` | 193.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.240.77` | `10034` | 195.59ms | ✅ فعال |
| 2 | `204.236.163.94` | `37048` | 1.52ms | ✅ فعال |
| 3 | `16.79.112.218` | `9050` | 184.71ms | ✅ فعال |
| 4 | `18.163.210.76` | `80` | 156.64ms | ✅ فعال |
| 5 | `13.212.76.113` | `9084` | 170.05ms | ✅ فعال |
