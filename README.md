...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 20:38 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.214.109.69` | `80` | 56.58ms | ✅ فعال |
| 2 | `188.114.99.37` | `80` | 2.13ms | ✅ فعال |
| 3 | `162.159.242.202` | `80` | 2.09ms | ✅ فعال |
| 4 | `184.168.47.129` | `80` | 2.17ms | ✅ فعال |
| 5 | `59.153.100.98` | `80` | 309.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.6.101.97` | `4153` | 113.22ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 1.76ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 121.47ms | ✅ فعال |
| 4 | `47.254.36.213` | `80` | 76.75ms | ✅ فعال |
| 5 | `47.254.36.213` | `8443` | 77.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.246.51` | `80` | 1.79ms | ✅ فعال |
| 2 | `198.177.56.190` | `80` | 2.39ms | ✅ فعال |
| 3 | `45.8.211.248` | `80` | 2.42ms | ✅ فعال |
| 4 | `45.131.4.93` | `80` | 2.22ms | ✅ فعال |
| 5 | `103.39.49.156` | `3128` | 256.30ms | ✅ فعال |
