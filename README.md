...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:12 10-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.139.59` | `80` | 2.08ms | ✅ فعال |
| 2 | `104.24.57.112` | `80` | 2.04ms | ✅ فعال |
| 3 | `166.88.235.97` | `5725` | 1.63ms | ✅ فعال |
| 4 | `104.25.252.179` | `80` | 1.63ms | ✅ فعال |
| 5 | `141.101.120.122` | `80` | 2.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.223.188.67` | `4145` | 194.07ms | ✅ فعال |
| 2 | `49.0.252.39` | `9000` | 161.15ms | ✅ فعال |
| 3 | `47.89.159.212` | `3128` | 66.88ms | ✅ فعال |
| 4 | `119.13.111.169` | `4006` | 173.16ms | ✅ فعال |
| 5 | `45.43.64.46` | `6304` | 144.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `54.180.143.12` | `25907` | 133.49ms | ✅ فعال |
| 2 | `45.70.236.194` | `999` | 125.47ms | ✅ فعال |
| 3 | `89.187.163.133` | `9091` | 172.52ms | ✅ فعال |
| 4 | `13.246.11.197` | `621` | 277.89ms | ✅ فعال |
| 5 | `3.110.127.255` | `48200` | 2297.77ms | ✅ فعال |
