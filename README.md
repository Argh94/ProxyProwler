...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 06-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.48.214` | `80` | 8.68ms | ✅ فعال |
| 2 | `159.224.232.194` | `8888` | 183.22ms | ✅ فعال |
| 3 | `141.101.122.236` | `80` | 8.80ms | ✅ فعال |
| 4 | `45.131.211.252` | `80` | 8.81ms | ✅ فعال |
| 5 | `104.16.216.121` | `80` | 16.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.194` | `4145` | 116.85ms | ✅ فعال |
| 2 | `168.232.213.9` | `4153` | 2200.98ms | ✅ فعال |
| 3 | `47.254.153.78` | `999` | 140.93ms | ✅ فعال |
| 4 | `123.57.1.16` | `5555` | 206.78ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 168.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.82.73` | `9788` | 191.91ms | ✅ فعال |
| 2 | `35.183.25.134` | `45` | 71.45ms | ✅ فعال |
| 3 | `78.12.220.164` | `268` | 1081.19ms | ✅ فعال |
| 4 | `51.20.125.203` | `57562` | 156.61ms | ✅ فعال |
| 5 | `18.60.222.217` | `395` | 220.49ms | ✅ فعال |
