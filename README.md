...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:47 13-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.246.55.69` | `80` | 1.90ms | ✅ فعال |
| 2 | `172.67.70.127` | `80` | 2.52ms | ✅ فعال |
| 3 | `72.195.114.169` | `4145` | 85.88ms | ✅ فعال |
| 4 | `172.67.227.170` | `80` | 2.50ms | ✅ فعال |
| 5 | `136.0.105.228` | `6238` | 20.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.51.110` | `9080` | 238.50ms | ✅ فعال |
| 2 | `101.200.158.109` | `8880` | 234.95ms | ✅ فعال |
| 3 | `198.89.123.43` | `6585` | 48.71ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 251.02ms | ✅ فعال |
| 5 | `45.80.108.144` | `80` | 2.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.85.134` | `80` | 1.97ms | ✅ فعال |
| 2 | `173.245.49.93` | `80` | 2.68ms | ✅ فعال |
| 3 | `103.39.49.156` | `3128` | 239.38ms | ✅ فعال |
| 4 | `5.10.247.49` | `80` | 1.80ms | ✅ فعال |
| 5 | `94.130.177.190` | `9999` | 107.58ms | ✅ فعال |
