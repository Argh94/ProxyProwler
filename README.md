...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 09-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.159.219.68` | `80` | 2.35ms | ✅ فعال |
| 2 | `136.0.105.186` | `6196` | 20.60ms | ✅ فعال |
| 3 | `172.67.222.230` | `80` | 3.27ms | ✅ فعال |
| 4 | `205.233.181.126` | `80` | 1.68ms | ✅ فعال |
| 5 | `156.225.72.165` | `80` | 6.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.104.79.145` | `1234` | 243.58ms | ✅ فعال |
| 2 | `8.130.54.67` | `1111` | 241.52ms | ✅ فعال |
| 3 | `80.254.50.71` | `3629` | 136.42ms | ✅ فعال |
| 4 | `197.221.234.253` | `80` | 264.08ms | ✅ فعال |
| 5 | `154.30.242.123` | `9517` | 48.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `210.87.74.85` | `9090` | 221.36ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 16.02ms | ✅ فعال |
| 3 | `78.12.193.250` | `2000` | 53.61ms | ✅ فعال |
| 4 | `200.174.198.32` | `8888` | 138.53ms | ✅ فعال |
| 5 | `47.129.154.60` | `9028` | 206.94ms | ✅ فعال |
