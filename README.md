...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 05-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `79.110.200.148` | `8081` | 118.83ms | ✅ فعال |
| 2 | `45.131.209.82` | `80` | 1.89ms | ✅ فعال |
| 3 | `90.156.169.163` | `80` | 157.29ms | ✅ فعال |
| 4 | `199.34.229.54` | `80` | 1.82ms | ✅ فعال |
| 5 | `66.81.247.249` | `80` | 2.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.168.118.95` | `6051` | 15.62ms | ✅ فعال |
| 2 | `8.130.36.245` | `8080` | 217.14ms | ✅ فعال |
| 3 | `90.156.169.163` | `80` | 157.17ms | ✅ فعال |
| 4 | `197.164.101.13` | `1981` | 1160.08ms | ✅ فعال |
| 5 | `149.129.226.9` | `93` | 956.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.197.20` | `80` | 30.32ms | ✅ فعال |
| 2 | `185.148.104.15` | `80` | 2.02ms | ✅ فعال |
| 3 | `23.227.39.103` | `80` | 2.35ms | ✅ فعال |
| 4 | `172.67.161.245` | `80` | 56.56ms | ✅ فعال |
| 5 | `5.10.247.49` | `80` | 2.92ms | ✅ فعال |
