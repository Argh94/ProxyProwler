...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 20-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.237.34` | `4145` | 25.19ms | ✅ فعال |
| 2 | `185.193.30.8` | `80` | 2.37ms | ✅ فعال |
| 3 | `45.80.110.126` | `80` | 1.87ms | ✅ فعال |
| 4 | `8.211.51.115` | `4000` | 2017.48ms | ✅ فعال |
| 5 | `8.213.215.187` | `8443` | 193.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `9500` | 107.02ms | ✅ فعال |
| 2 | `216.154.201.132` | `54321` | 60.09ms | ✅ فعال |
| 3 | `72.223.188.67` | `4145` | 171.89ms | ✅ فعال |
| 4 | `139.196.151.191` | `8090` | 191.19ms | ✅ فعال |
| 5 | `161.123.151.4` | `5988` | 55.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 167.08ms | ✅ فعال |
| 2 | `162.240.154.26` | `3128` | 31.01ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 163.59ms | ✅ فعال |
| 4 | `176.57.189.138` | `3128` | 176.31ms | ✅ فعال |
| 5 | `56.228.5.197` | `26403` | 167.02ms | ✅ فعال |
