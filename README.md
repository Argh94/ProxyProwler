...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:06 31-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `219.93.101.60` | `80` | 253.06ms | ✅ فعال |
| 2 | `27.65.29.213` | `1080` | 243.44ms | ✅ فعال |
| 3 | `27.75.151.143` | `1080` | 243.95ms | ✅ فعال |
| 4 | `174.138.161.195` | `31786` | 61.47ms | ✅ فعال |
| 5 | `23.175.248.21` | `1080` | 28.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.2.239.42` | `4153` | 1181.61ms | ✅ فعال |
| 2 | `178.220.148.82` | `10801` | 119.96ms | ✅ فعال |
| 3 | `85.214.204.79` | `80` | 2141.64ms | ✅ فعال |
| 4 | `103.166.39.145` | `3629` | 244.64ms | ✅ فعال |
| 5 | `52.229.30.3` | `80` | 66.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.234.217.82` | `999` | 2171.73ms | ✅ فعال |
| 2 | `103.157.79.83` | `1111` | 235.25ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 7.84ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 224.79ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 93.90ms | ✅ فعال |
