...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:10 10-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.124.59.186` | `1080` | 107.57ms | ✅ فعال |
| 2 | `39.106.170.168` | `8080` | 2312.08ms | ✅ فعال |
| 3 | `5.255.123.162` | `1080` | 91.23ms | ✅ فعال |
| 4 | `43.164.3.124` | `1080` | 248.81ms | ✅ فعال |
| 5 | `82.102.11.164` | `3460` | 85.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.35.145` | `4145` | 77.12ms | ✅ فعال |
| 2 | `103.39.51.156` | `1080` | 1278.56ms | ✅ فعال |
| 3 | `154.6.59.102` | `6570` | 8.61ms | ✅ فعال |
| 4 | `110.49.66.210` | `8080` | 272.83ms | ✅ فعال |
| 5 | `192.111.137.37` | `18762` | 59.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.89ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 2.65ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 244.01ms | ✅ فعال |
| 4 | `185.196.182.22` | `8080` | 118.36ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 234.25ms | ✅ فعال |
