...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 16-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.43.179.179` | `80` | 1.64ms | ✅ فعال |
| 2 | `91.193.58.248` | `80` | 1.56ms | ✅ فعال |
| 3 | `188.114.99.255` | `80` | 52.12ms | ✅ فعال |
| 4 | `104.25.1.65` | `80` | 17.02ms | ✅ فعال |
| 5 | `104.17.38.14` | `80` | 9.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.51.138.138` | `8080` | 199.85ms | ✅ فعال |
| 2 | `107.172.163.135` | `6651` | 69.87ms | ✅ فعال |
| 3 | `154.118.231.30` | `80` | 290.33ms | ✅ فعال |
| 4 | `103.146.137.233` | `1081` | 266.97ms | ✅ فعال |
| 5 | `1.180.0.162` | `7302` | 217.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.229.172` | `80` | 1.45ms | ✅ فعال |
| 2 | `104.25.1.112` | `80` | 16.88ms | ✅ فعال |
| 3 | `45.80.108.229` | `80` | 1.62ms | ✅ فعال |
| 4 | `173.245.49.93` | `80` | 1.38ms | ✅ فعال |
| 5 | `45.131.211.217` | `80` | 1.52ms | ✅ فعال |
