...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:07 29-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.26` | `4145` | 81.02ms | ✅ فعال |
| 2 | `8.221.141.88` | `8118` | 138.10ms | ✅ فعال |
| 3 | `43.164.136.189` | `1080` | 156.85ms | ✅ فعال |
| 4 | `31.59.33.158` | `6734` | 111.77ms | ✅ فعال |
| 5 | `8.211.49.86` | `161` | 906.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 172.41ms | ✅ فعال |
| 2 | `101.255.166.134` | `80` | 223.30ms | ✅ فعال |
| 3 | `43.133.175.183` | `7890` | 135.58ms | ✅ فعال |
| 4 | `8.209.96.245` | `3128` | 901.54ms | ✅ فعال |
| 5 | `216.10.27.82` | `6760` | 42.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 199.19ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 161.70ms | ✅ فعال |
