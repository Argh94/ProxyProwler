...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 27-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.216.86` | `4145` | 86.85ms | ✅ فعال |
| 2 | `63.141.128.0` | `80` | 2.90ms | ✅ فعال |
| 3 | `172.67.255.59` | `80` | 2.67ms | ✅ فعال |
| 4 | `47.91.115.179` | `8080` | 177.32ms | ✅ فعال |
| 5 | `47.237.169.183` | `1080` | 210.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.216.86` | `4145` | 64.49ms | ✅ فعال |
| 2 | `47.243.50.83` | `81` | 194.02ms | ✅ فعال |
| 3 | `8.209.68.1` | `8081` | 106.36ms | ✅ فعال |
| 4 | `47.243.175.55` | `443` | 196.88ms | ✅ فعال |
| 5 | `49.0.252.39` | `9000` | 195.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.70.236.194` | `999` | 95.60ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 21.39ms | ✅ فعال |
| 3 | `43.198.99.209` | `8496` | 195.40ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 2313.47ms | ✅ فعال |
| 5 | `103.130.70.233` | `83` | 241.59ms | ✅ فعال |
