...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:00 21-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.171.106.15` | `3000` | 1479.60ms | ✅ فعال |
| 2 | `185.76.240.237` | `10001` | 142.42ms | ✅ فعال |
| 3 | `155.254.38.123` | `5799` | 98.17ms | ✅ فعال |
| 4 | `8.211.51.115` | `8081` | 116.83ms | ✅ فعال |
| 5 | `77.93.89.128` | `47146` | 196.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `200.108.50.254` | `4145` | 84.54ms | ✅ فعال |
| 2 | `8.211.195.139` | `100` | 105.18ms | ✅ فعال |
| 3 | `72.195.34.41` | `4145` | 106.70ms | ✅ فعال |
| 4 | `47.74.46.81` | `80` | 327.37ms | ✅ فعال |
| 5 | `8.42.68.93` | `39593` | 45.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 1280.27ms | ✅ فعال |
| 2 | `103.154.146.58` | `8080` | 2304.13ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 132.73ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 1167.72ms | ✅ فعال |
