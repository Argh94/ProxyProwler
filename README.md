...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:45 22-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.251.142.232` | `80` | 121.28ms | ✅ فعال |
| 2 | `206.206.118.231` | `6469` | 8.58ms | ✅ فعال |
| 3 | `74.176.195.135` | `80` | 107.48ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 137.38ms | ✅ فعال |
| 5 | `162.220.246.34` | `6318` | 140.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.170.57.249` | `4145` | 127.29ms | ✅ فعال |
| 2 | `198.105.111.248` | `6926` | 156.10ms | ✅ فعال |
| 3 | `136.0.108.85` | `5761` | 1.73ms | ✅ فعال |
| 4 | `39.104.79.145` | `1234` | 230.36ms | ✅ فعال |
| 5 | `104.143.224.42` | `5903` | 143.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.249.123` | `33333` | 58.48ms | ✅ فعال |
| 2 | `34.14.143.185` | `3128` | 230.06ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 175.60ms | ✅ فعال |
| 4 | `158.101.175.124` | `5566` | 149.85ms | ✅ فعال |
| 5 | `120.240.35.161` | `22222` | 195.29ms | ✅ فعال |
