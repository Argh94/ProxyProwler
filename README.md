...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 07-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.206.69.172` | `6436` | 8.40ms | ✅ فعال |
| 2 | `185.174.138.221` | `80` | 8.99ms | ✅ فعال |
| 3 | `172.67.207.89` | `80` | 9.04ms | ✅ فعال |
| 4 | `104.21.19.187` | `80` | 8.93ms | ✅ فعال |
| 5 | `104.21.24.131` | `80` | 8.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.44` | `3128` | 214.97ms | ✅ فعال |
| 2 | `8.130.34.237` | `1234` | 210.14ms | ✅ فعال |
| 3 | `202.40.181.220` | `31247` | 300.00ms | ✅ فعال |
| 4 | `27.74.215.131` | `30245` | 192.53ms | ✅ فعال |
| 5 | `101.255.208.62` | `8080` | 193.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.1.112` | `80` | 8.79ms | ✅ فعال |
| 2 | `41.65.55.10` | `1981` | 215.49ms | ✅ فعال |
| 3 | `94.25.85.100` | `8123` | 2297.26ms | ✅ فعال |
| 4 | `190.93.247.0` | `80` | 16.82ms | ✅ فعال |
| 5 | `104.17.26.109` | `80` | 16.62ms | ✅ فعال |
