...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 03:38 30-05-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (105 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.109.201` | `80` | 9.09ms | ✅ فعال |
| 2 | `190.93.244.37` | `80` | 1.64ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 218.46ms | ✅ فعال |
| 4 | `41.191.203.160` | `80` | 291.00ms | ✅ فعال |
| 5 | `47.238.60.156` | `8443` | 190.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.158.70.246` | `16379` | 154.20ms | ✅ فعال |
| 2 | `89.58.55.33` | `80` | 158.99ms | ✅ فعال |
| 3 | `68.71.249.153` | `48606` | 22.48ms | ✅ فعال |
| 4 | `161.35.70.249` | `8080` | 164.30ms | ✅ فعال |
| 5 | `8.220.204.215` | `8086` | 183.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.245.221.183` | `80` | 1.61ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 206.48ms | ✅ فعال |
| 3 | `188.114.96.63` | `80` | 152.88ms | ✅ فعال |
| 4 | `45.131.4.9` | `80` | 1.43ms | ✅ فعال |
| 5 | `198.177.56.190` | `80` | 1.37ms | ✅ فعال |
