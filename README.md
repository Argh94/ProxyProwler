...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:10 10-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.136.204.40` | `80` | 9.10ms | ✅ فعال |
| 2 | `212.114.194.72` | `80` | 2217.35ms | ✅ فعال |
| 3 | `23.227.38.134` | `80` | 1.50ms | ✅ فعال |
| 4 | `23.190.168.41` | `80` | 71.27ms | ✅ فعال |
| 5 | `8.213.222.247` | `18080` | 197.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.130.5` | `17002` | 98.71ms | ✅ فعال |
| 2 | `104.37.135.145` | `4145` | 47.74ms | ✅ فعال |
| 3 | `139.196.151.191` | `8090` | 193.38ms | ✅ فعال |
| 4 | `23.227.38.134` | `80` | 1.66ms | ✅ فعال |
| 5 | `98.170.57.249` | `4145` | 137.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.110.127.255` | `808` | 221.88ms | ✅ فعال |
| 2 | `13.115.193.75` | `3897` | 106.17ms | ✅ فعال |
| 3 | `179.255.219.182` | `8080` | 227.39ms | ✅ فعال |
| 4 | `40.192.16.115` | `31974` | 217.03ms | ✅ فعال |
| 5 | `72.10.164.178` | `2593` | 82.32ms | ✅ فعال |
