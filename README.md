...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:15 29-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.223` | `11508` | 105.22ms | ✅ فعال |
| 2 | `109.199.107.68` | `1080` | 155.88ms | ✅ فعال |
| 3 | `185.135.69.34` | `80` | 192.04ms | ✅ فعال |
| 4 | `98.178.72.30` | `4145` | 85.49ms | ✅ فعال |
| 5 | `174.77.111.196` | `4145` | 87.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.36.213` | `9098` | 68.15ms | ✅ فعال |
| 2 | `107.181.154.205` | `5883` | 80.22ms | ✅ فعال |
| 3 | `104.164.254.227` | `6906` | 69.56ms | ✅ فعال |
| 4 | `47.91.29.151` | `8090` | 165.92ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 187.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `88.119.139.237` | `53281` | 2202.75ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 8.39ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 86.45ms | ✅ فعال |
| 4 | `103.149.194.11` | `32650` | 1353.73ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 116.33ms | ✅ فعال |
