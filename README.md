...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:40 13-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `39.109.113.97` | `4090` | 1203.03ms | ✅ فعال |
| 2 | `77.76.202.157` | `80` | 159.11ms | ✅ فعال |
| 3 | `107.174.194.22` | `5464` | 71.79ms | ✅ فعال |
| 4 | `34.44.49.215` | `80` | 47.22ms | ✅ فعال |
| 5 | `4.213.167.178` | `80` | 211.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.200.135.46` | `4145` | 43.55ms | ✅ فعال |
| 2 | `103.166.39.233` | `3629` | 203.34ms | ✅ فعال |
| 3 | `184.174.25.186` | `6075` | 29.93ms | ✅ فعال |
| 4 | `69.61.200.104` | `36181` | 144.13ms | ✅ فعال |
| 5 | `192.111.139.163` | `19404` | 124.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 164.76ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 2261.13ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 130.47ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 96.60ms | ✅ فعال |
| 5 | `180.250.219.58` | `53281` | 243.82ms | ✅ فعال |
