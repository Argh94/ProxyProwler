...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:35 18-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `143.42.66.91` | `80` | 170.96ms | ✅ فعال |
| 2 | `4.213.167.178` | `80` | 218.08ms | ✅ فعال |
| 3 | `47.76.144.139` | `8081` | 147.39ms | ✅ فعال |
| 4 | `89.185.85.138` | `1080` | 156.46ms | ✅ فعال |
| 5 | `165.227.118.27` | `80` | 77.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.141.168.37` | `8888` | 364.14ms | ✅ فعال |
| 2 | `47.243.124.21` | `6666` | 147.84ms | ✅ فعال |
| 3 | `216.26.236.103` | `3129` | 57.29ms | ✅ فعال |
| 4 | `159.138.252.45` | `8888` | 202.96ms | ✅ فعال |
| 5 | `88.216.68.168` | `9107` | 48.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 111.30ms | ✅ فعال |
| 2 | `20.210.113.32` | `8123` | 105.49ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 166.84ms | ✅ فعال |
| 4 | `34.44.49.215` | `80` | 47.95ms | ✅ فعال |
| 5 | `1.225.116.115` | `1080` | 130.55ms | ✅ فعال |
