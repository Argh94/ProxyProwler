...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 15-10-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (26 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `170.114.46.136` | `80` | 5.83ms | ✅ فعال |
| 2 | `184.178.172.23` | `4145` | 74.61ms | ✅ فعال |
| 3 | `107.181.148.94` | `5954` | 83.56ms | ✅ فعال |
| 4 | `139.162.200.213` | `80` | 80.68ms | ✅ فعال |
| 5 | `46.0.205.4` | `1080` | 158.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.215.187` | `1080` | 249.96ms | ✅ فعال |
| 2 | `8.221.141.88` | `9500` | 161.55ms | ✅ فعال |
| 3 | `78.109.139.51` | `5678` | 163.20ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 92.47ms | ✅ فعال |
| 5 | `82.180.132.69` | `80` | 1120.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `144.125.164.222` | `8080` | 6.30ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 97.49ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 224.99ms | ✅ فعال |
| 4 | `103.154.120.147` | `8080` | 2306.06ms | ✅ فعال |
| 5 | `115.114.77.133` | `9090` | 208.18ms | ✅ فعال |
