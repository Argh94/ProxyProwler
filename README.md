...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 08-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.28.138` | `80` | 22.87ms | ✅ فعال |
| 2 | `62.72.166.60` | `80` | 18.27ms | ✅ فعال |
| 3 | `104.16.1.99` | `80` | 26.23ms | ✅ فعال |
| 4 | `185.193.31.14` | `80` | 17.99ms | ✅ فعال |
| 5 | `95.66.244.250` | `80` | 172.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `180.104.208.76` | `8081` | 227.96ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 265.01ms | ✅ فعال |
| 3 | `1.180.0.162` | `7302` | 240.56ms | ✅ فعال |
| 4 | `8.211.49.86` | `2002` | 807.66ms | ✅ فعال |
| 5 | `1.180.49.222` | `7302` | 241.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.161.245` | `80` | 49.12ms | ✅ فعال |
| 2 | `104.24.85.134` | `80` | 34.24ms | ✅ فعال |
| 3 | `23.227.39.103` | `80` | 23.27ms | ✅ فعال |
| 4 | `195.245.221.183` | `80` | 18.40ms | ✅ فعال |
| 5 | `104.17.190.13` | `80` | 25.08ms | ✅ فعال |
