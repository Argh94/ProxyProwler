...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 23-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (19 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.214.20` | `15864` | 81.54ms | ✅ فعال |
| 2 | `192.252.215.5` | `16137` | 94.73ms | ✅ فعال |
| 3 | `8.211.194.78` | `8008` | 127.97ms | ✅ فعال |
| 4 | `47.90.167.27` | `8081` | 51.26ms | ✅ فعال |
| 5 | `38.170.190.13` | `9364` | 32.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 222.48ms | ✅ فعال |
| 2 | `5.172.24.68` | `1080` | 1232.27ms | ✅ فعال |
| 3 | `46.202.248.128` | `5622` | 30.60ms | ✅ فعال |
| 4 | `67.227.113.115` | `5655` | 32.56ms | ✅ فعال |
| 5 | `8.220.205.172` | `80` | 475.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.229.172` | `80` | 18.61ms | ✅ فعال |
| 2 | `45.131.4.9` | `80` | 17.95ms | ✅ فعال |
| 3 | `104.17.106.99` | `80` | 17.86ms | ✅ فعال |
| 4 | `23.227.39.103` | `80` | 17.91ms | ✅ فعال |
| 5 | `45.131.4.93` | `80` | 17.87ms | ✅ فعال |
