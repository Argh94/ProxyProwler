...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:32 13-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.193.178.226` | `80` | 48.27ms | ✅ فعال |
| 2 | `172.200.72.48` | `80` | 28.12ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 206.50ms | ✅ فعال |
| 4 | `45.7.80.12` | `80` | 130.75ms | ✅ فعال |
| 5 | `192.252.220.89` | `4145` | 64.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.220.247.44` | `6639` | 97.01ms | ✅ فعال |
| 2 | `52.233.95.88` | `1080` | 1100.82ms | ✅ فعال |
| 3 | `198.12.112.150` | `5161` | 49.18ms | ✅ فعال |
| 4 | `31.57.82.21` | `6602` | 42.33ms | ✅ فعال |
| 5 | `104.164.254.240` | `6919` | 47.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 528.67ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 139.43ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 212.22ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 217.06ms | ✅ فعال |
