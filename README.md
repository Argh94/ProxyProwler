...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:31 07-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.247.136.254` | `80` | 47.68ms | ✅ فعال |
| 2 | `47.91.104.88` | `3128` | 198.56ms | ✅ فعال |
| 3 | `146.103.56.121` | `5669` | 106.99ms | ✅ فعال |
| 4 | `192.111.139.162` | `4145` | 86.53ms | ✅ فعال |
| 5 | `72.56.59.17` | `61931` | 107.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.246.130` | `6789` | 181.61ms | ✅ فعال |
| 2 | `110.238.116.82` | `55443` | 242.24ms | ✅ فعال |
| 3 | `121.128.121.34` | `3128` | 1188.61ms | ✅ فعال |
| 4 | `184.178.172.14` | `4145` | 93.14ms | ✅ فعال |
| 5 | `8.211.194.78` | `8080` | 734.63ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (21 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.17.47.48` | `80` | 169.37ms | ✅ فعال |
| 2 | `14.56.118.164` | `3128` | 2264.85ms | ✅ فعال |
| 3 | `38.60.196.214` | `80` | 101.12ms | ✅ فعال |
| 4 | `8.212.177.126` | `8080` | 221.72ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 122.14ms | ✅ فعال |
