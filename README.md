...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:25 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.165.147` | `80` | 1.59ms | ✅ فعال |
| 2 | `104.18.198.201` | `80` | 1.71ms | ✅ فعال |
| 3 | `89.116.250.242` | `80` | 1.73ms | ✅ فعال |
| 4 | `204.69.207.234` | `80` | 1.70ms | ✅ فعال |
| 5 | `184.178.172.11` | `4145` | 127.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.25.236.121` | `3128` | 152.97ms | ✅ فعال |
| 2 | `172.67.150.69` | `80` | 9.87ms | ✅ فعال |
| 3 | `142.54.237.34` | `4145` | 58.14ms | ✅ فعال |
| 4 | `1.0.0.4` | `80` | 2.58ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 202.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.28` | `80` | 1.77ms | ✅ فعال |
| 2 | `185.148.104.15` | `80` | 1.72ms | ✅ فعال |
| 3 | `182.253.109.189` | `8080` | 190.47ms | ✅ فعال |
| 4 | `104.19.66.163` | `80` | 1.58ms | ✅ فعال |
| 5 | `216.24.57.248` | `80` | 1.52ms | ✅ فعال |
