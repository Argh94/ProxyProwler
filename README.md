...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:28 09-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.88.88.102` | `80` | 108.69ms | ✅ فعال |
| 2 | `46.241.57.29` | `1080` | 173.51ms | ✅ فعال |
| 3 | `193.53.127.169` | `80` | 186.11ms | ✅ فعال |
| 4 | `188.165.199.207` | `80` | 105.48ms | ✅ فعال |
| 5 | `185.187.92.42` | `80` | 145.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `70.166.167.38` | `57728` | 86.88ms | ✅ فعال |
| 2 | `47.254.153.78` | `999` | 111.51ms | ✅ فعال |
| 3 | `8.209.253.237` | `8499` | 144.02ms | ✅ فعال |
| 4 | `212.114.194.72` | `80` | 1155.30ms | ✅ فعال |
| 5 | `184.178.172.26` | `4145` | 89.33ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (58 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.197.28` | `8801` | 194.35ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 213.43ms | ✅ فعال |
| 3 | `43.198.99.209` | `426` | 196.67ms | ✅ فعال |
| 4 | `15.236.38.248` | `28049` | 107.15ms | ✅ فعال |
| 5 | `78.13.74.125` | `1991` | 53.65ms | ✅ فعال |
