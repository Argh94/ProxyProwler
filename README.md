...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:15 09-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.8.84.3` | `4145` | 101.44ms | ✅ فعال |
| 2 | `168.235.82.57` | `443` | 12.41ms | ✅ فعال |
| 3 | `134.209.29.120` | `80` | 81.02ms | ✅ فعال |
| 4 | `104.21.225.111` | `80` | 16.94ms | ✅ فعال |
| 5 | `185.148.104.174` | `80` | 9.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.220.92` | `17328` | 95.85ms | ✅ فعال |
| 2 | `104.21.225.111` | `80` | 17.01ms | ✅ فعال |
| 3 | `197.221.240.176` | `80` | 1254.01ms | ✅ فعال |
| 4 | `8.211.195.173` | `28737` | 81.28ms | ✅ فعال |
| 5 | `212.103.118.77` | `5678` | 174.49ms | ✅ فعال |
...
| 2 | `13.36.243.194` | `9255` | 86.06ms | ✅ فعال |
| 3 | `27.34.242.98` | `80` | 232.06ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 168.74ms | ✅ فعال |
| 5 | `40.177.211.224` | `8705` | 75.98ms | ✅ فعال |
