...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:50 17-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.202.175.5` | `6793` | 49.16ms | ✅ فعال |
| 2 | `173.239.219.229` | `6138` | 45.95ms | ✅ فعال |
| 3 | `164.38.155.115` | `80` | 9.95ms | ✅ فعال |
| 4 | `159.246.55.116` | `80` | 12.44ms | ✅ فعال |
| 5 | `92.113.1.241` | `5941` | 23.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.222.157` | `6379` | 371.99ms | ✅ فعال |
| 2 | `216.10.27.148` | `6826` | 37.36ms | ✅ فعال |
| 3 | `136.0.105.53` | `6063` | 44.26ms | ✅ فعال |
| 4 | `1.234.23.159` | `80` | 157.01ms | ✅ فعال |
| 5 | `101.200.158.109` | `8880` | 237.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.246.51` | `80` | 14.61ms | ✅ فعال |
| 2 | `45.131.7.142` | `80` | 14.41ms | ✅ فعال |
| 3 | `141.101.122.238` | `80` | 18.31ms | ✅ فعال |
| 4 | `172.67.161.245` | `80` | 11.53ms | ✅ فعال |
| 5 | `45.131.4.9` | `80` | 17.23ms | ✅ فعال |
