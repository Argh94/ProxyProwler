...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 14-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.238.228.75` | `80` | 8.85ms | ✅ فعال |
| 2 | `141.101.120.238` | `80` | 9.52ms | ✅ فعال |
| 3 | `8.213.195.191` | `3129` | 779.37ms | ✅ فعال |
| 4 | `63.141.128.76` | `80` | 9.21ms | ✅ فعال |
| 5 | `216.74.118.108` | `6263` | 9.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.92` | `8081` | 810.12ms | ✅ فعال |
| 2 | `51.158.105.157` | `16379` | 135.44ms | ✅ فعال |
| 3 | `157.175.42.134` | `3902` | 222.10ms | ✅ فعال |
| 4 | `198.105.111.24` | `6702` | 130.55ms | ✅ فعال |
| 5 | `46.47.197.210` | `3128` | 167.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.180.121.252` | `12689` | 167.05ms | ✅ فعال |
| 2 | `3.38.101.138` | `20282` | 138.62ms | ✅ فعال |
| 3 | `51.20.192.194` | `20279` | 157.50ms | ✅ فعال |
| 4 | `15.168.235.57` | `8082` | 116.05ms | ✅ فعال |
| 5 | `43.208.251.198` | `80` | 205.69ms | ✅ فعال |
