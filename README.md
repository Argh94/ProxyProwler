...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:38 16-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.239.1` | `4145` | 23.65ms | ✅ فعال |
| 2 | `185.135.69.34` | `80` | 206.65ms | ✅ فعال |
| 3 | `206.123.156.207` | `5292` | 162.69ms | ✅ فعال |
| 4 | `154.90.61.23` | `20002` | 153.81ms | ✅ فعال |
| 5 | `92.101.193.58` | `1080` | 197.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `147.231.163.133` | `80` | 151.65ms | ✅ فعال |
| 2 | `158.160.215.167` | `8123` | 170.60ms | ✅ فعال |
| 3 | `200.108.50.254` | `4145` | 1135.67ms | ✅ فعال |
| 4 | `24.249.199.4` | `4145` | 143.77ms | ✅ فعال |
| 5 | `45.249.78.177` | `5678` | 234.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 172.35ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 157.05ms | ✅ فعال |
