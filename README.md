...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:19 29-04-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (52 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `147.45.66.115` | `1081` | 169.63ms | ✅ فعال |
| 2 | `206.123.156.223` | `21028` | 144.36ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 251.72ms | ✅ فعال |
| 4 | `142.54.231.38` | `4145` | 22.73ms | ✅ فعال |
| 5 | `192.252.214.20` | `15864` | 102.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.56.7` | `5555` | 138.44ms | ✅ فعال |
| 2 | `184.181.217.194` | `4145` | 101.00ms | ✅ فعال |
| 3 | `192.252.208.67` | `14287` | 106.82ms | ✅ فعال |
| 4 | `203.160.61.99` | `4145` | 191.38ms | ✅ فعال |
| 5 | `107.181.154.175` | `5853` | 128.15ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (10 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 200.16ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 193.72ms | ✅ فعال |
| 3 | `103.191.165.9` | `8080` | 198.41ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 56.51ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 55.94ms | ✅ فعال |
