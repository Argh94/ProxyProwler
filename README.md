...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:19 09-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `190.119.132.62` | `80` | 132.73ms | ✅ فعال |
| 2 | `216.68.128.121` | `4145` | 74.13ms | ✅ فعال |
| 3 | `113.212.111.4` | `8090` | 253.51ms | ✅ فعال |
| 4 | `206.123.156.211` | `5549` | 115.90ms | ✅ فعال |
| 5 | `47.251.87.199` | `1036` | 46.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.46.81` | `1000` | 145.71ms | ✅ فعال |
| 2 | `8.213.134.213` | `443` | 169.96ms | ✅ فعال |
| 3 | `80.74.54.148` | `3128` | 109.27ms | ✅ فعال |
| 4 | `47.251.87.199` | `1036` | 47.25ms | ✅ فعال |
| 5 | `113.212.111.4` | `8090` | 253.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 213.31ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 143.78ms | ✅ فعال |
| 3 | `13.127.170.8` | `3128` | 213.42ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 139.42ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 225.51ms | ✅ فعال |
