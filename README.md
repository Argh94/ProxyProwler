...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 18-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.247.154` | `80` | 2.15ms | ✅ فعال |
| 2 | `185.162.228.12` | `80` | 2.21ms | ✅ فعال |
| 3 | `141.193.213.146` | `80` | 2.35ms | ✅ فعال |
| 4 | `104.21.119.116` | `80` | 2.18ms | ✅ فعال |
| 5 | `184.174.25.240` | `6129` | 61.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.22.214` | `8080` | 278.24ms | ✅ فعال |
| 2 | `39.104.62.128` | `5000` | 280.18ms | ✅ فعال |
| 3 | `8.213.197.208` | `34567` | 1005.73ms | ✅ فعال |
| 4 | `106.15.137.41` | `50` | 244.10ms | ✅ فعال |
| 5 | `103.251.223.106` | `6085` | 61.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 221.21ms | ✅ فعال |
| 2 | `51.16.49.113` | `8585` | 281.44ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 246.01ms | ✅ فعال |
| 4 | `201.89.97.222` | `8080` | 122.48ms | ✅ فعال |
| 5 | `3.110.127.255` | `48200` | 190.51ms | ✅ فعال |
