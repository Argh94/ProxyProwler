...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 01:03 12-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.60.156` | `31433` | 150.77ms | ✅ فعال |
| 2 | `142.54.237.34` | `4145` | 21.52ms | ✅ فعال |
| 3 | `46.62.214.3` | `1080` | 1227.99ms | ✅ فعال |
| 4 | `192.111.137.37` | `18762` | 120.88ms | ✅ فعال |
| 5 | `183.215.23.242` | `9091` | 210.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.81` | `3629` | 216.81ms | ✅ فعال |
| 2 | `173.211.69.67` | `6660` | 10.47ms | ✅ فعال |
| 3 | `8.221.141.88` | `6443` | 106.81ms | ✅ فعال |
| 4 | `192.111.130.5` | `17002` | 109.15ms | ✅ فعال |
| 5 | `183.110.216.159` | `8090` | 140.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 177.21ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 68.99ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 172.67ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 181.01ms | ✅ فعال |
| 5 | `182.253.109.162` | `8080` | 1221.43ms | ✅ فعال |
