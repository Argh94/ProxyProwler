...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:34 22-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `162.245.85.36` | `80` | 22.24ms | ✅ فعال |
| 2 | `81.169.213.169` | `8888` | 127.91ms | ✅ فعال |
| 3 | `184.178.172.25` | `15291` | 131.10ms | ✅ فعال |
| 4 | `70.60.132.130` | `5678` | 2091.37ms | ✅ فعال |
| 5 | `47.119.22.156` | `5060` | 221.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.223.90.144` | `80` | 36.98ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 261.56ms | ✅ فعال |
| 3 | `199.102.104.70` | `4145` | 84.76ms | ✅ فعال |
| 4 | `107.181.168.145` | `4145` | 97.17ms | ✅ فعال |
| 5 | `47.254.153.78` | `5555` | 121.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.96.28.58` | `80` | 162.77ms | ✅ فعال |
| 2 | `46.29.162.166` | `80` | 201.78ms | ✅ فعال |
| 3 | `8.213.195.191` | `90` | 220.95ms | ✅ فعال |
| 4 | `20.210.113.32` | `8123` | 133.74ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 200.12ms | ✅ فعال |
