...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 20:52 29-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `65.108.203.35` | `28080` | 172.98ms | ✅ فعال |
| 2 | `67.43.228.252` | `13001` | 65.84ms | ✅ فعال |
| 3 | `8.211.194.85` | `18080` | 506.04ms | ✅ فعال |
| 4 | `147.75.33.104` | `10021` | 2566.29ms | ✅ فعال |
| 5 | `161.35.31.237` | `1080` | 150.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.126.201` | `80` | 3.10ms | ✅ فعال |
| 2 | `206.206.119.76` | `5987` | 9.17ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 201.09ms | ✅ فعال |
| 4 | `46.254.93.41` | `80` | 1.65ms | ✅ فعال |
| 5 | `184.178.172.5` | `15303` | 124.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.103` | `80` | 1.45ms | ✅ فعال |
| 2 | `104.24.197.20` | `80` | 1.63ms | ✅ فعال |
| 3 | `45.85.118.80` | `80` | 1.56ms | ✅ فعال |
| 4 | `188.114.96.63` | `80` | 10.46ms | ✅ فعال |
| 5 | `172.67.161.245` | `80` | 8.95ms | ✅ فعال |
