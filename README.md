...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:10 10-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.183.226` | `4145` | 75.70ms | ✅ فعال |
| 2 | `59.152.97.233` | `1080` | 247.17ms | ✅ فعال |
| 3 | `117.50.194.130` | `7890` | 221.74ms | ✅ فعال |
| 4 | `206.245.131.160` | `80` | 135.54ms | ✅ فعال |
| 5 | `8.213.215.187` | `104` | 206.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.57.131.158` | `1080` | 117.51ms | ✅ فعال |
| 2 | `45.43.81.136` | `5783` | 115.92ms | ✅ فعال |
| 3 | `47.238.128.246` | `85` | 160.92ms | ✅ فعال |
| 4 | `8.211.51.115` | `4145` | 137.27ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 816.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 161.63ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 200.19ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 46.39ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 50.69ms | ✅ فعال |
