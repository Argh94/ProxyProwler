...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:36 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.65.238` | `80` | 17.84ms | ✅ فعال |
| 2 | `104.21.127.23` | `80` | 38.49ms | ✅ فعال |
| 3 | `104.24.214.136` | `80` | 28.64ms | ✅ فعال |
| 4 | `206.238.237.218` | `80` | 18.15ms | ✅ فعال |
| 5 | `145.223.58.219` | `6488` | 17.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.40.181.220` | `31247` | 240.83ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 216.16ms | ✅ فعال |
| 3 | `140.245.102.185` | `3128` | 186.13ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 218.99ms | ✅ فعال |
| 5 | `104.249.55.137` | `6505` | 117.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 28.29ms | ✅ فعال |
| 2 | `104.17.26.109` | `80` | 17.59ms | ✅ فعال |
| 3 | `23.227.39.55` | `80` | 17.75ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 17.89ms | ✅ فعال |
| 5 | `104.17.247.188` | `80` | 17.76ms | ✅ فعال |
