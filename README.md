...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:24 21-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.70` | `14282` | 78.67ms | ✅ فعال |
| 2 | `48.210.225.96` | `80` | 108.65ms | ✅ فعال |
| 3 | `199.58.184.97` | `4145` | 78.33ms | ✅ فعال |
| 4 | `186.148.180.46` | `999` | 99.68ms | ✅ فعال |
| 5 | `193.43.159.200` | `80` | 185.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.81` | `3629` | 223.77ms | ✅ فعال |
| 2 | `72.49.49.11` | `31034` | 200.99ms | ✅ فعال |
| 3 | `8.221.139.222` | `3128` | 108.74ms | ✅ فعال |
| 4 | `8.209.253.237` | `8499` | 109.55ms | ✅ فعال |
| 5 | `39.104.23.154` | `8004` | 214.41ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (29 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.250.251.246` | `80` | 119.36ms | ✅ فعال |
| 2 | `46.17.47.48` | `80` | 197.19ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 203.54ms | ✅ فعال |
| 4 | `45.136.130.175` | `8443` | 11.21ms | ✅ فعال |
| 5 | `23.88.88.105` | `443` | 139.39ms | ✅ فعال |
