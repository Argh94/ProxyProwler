...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 14-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `83.168.105.136` | `8080` | 168.77ms | ✅ فعال |
| 2 | `91.193.59.99` | `80` | 1.84ms | ✅ فعال |
| 3 | `104.21.210.223` | `80` | 10.81ms | ✅ فعال |
| 4 | `23.227.38.255` | `80` | 2.00ms | ✅ فعال |
| 5 | `170.114.46.191` | `80` | 3.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 834.05ms | ✅ فعال |
| 2 | `46.21.186.252` | `1080` | 170.24ms | ✅ فعال |
| 3 | `31.43.179.88` | `80` | 2.38ms | ✅ فعال |
| 4 | `8.215.12.103` | `8888` | 886.84ms | ✅ فعال |
| 5 | `192.252.211.193` | `4145` | 111.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.129.50` | `8900` | 195.63ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 72.66ms | ✅ فعال |
| 3 | `43.209.130.76` | `11659` | 196.24ms | ✅ فعال |
| 4 | `51.48.124.225` | `44229` | 169.80ms | ✅ فعال |
| 5 | `54.180.143.12` | `9992` | 136.09ms | ✅ فعال |
