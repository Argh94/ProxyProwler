...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:24 28-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `43.163.124.191` | `8080` | 205.01ms | ✅ فعال |
| 2 | `8.220.205.172` | `6379` | 759.49ms | ✅ فعال |
| 3 | `72.194.42.156` | `4145` | 89.81ms | ✅ فعال |
| 4 | `185.132.1.221` | `4145` | 137.02ms | ✅ فعال |
| 5 | `103.88.234.239` | `40004` | 47.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `174.77.111.197` | `4145` | 87.65ms | ✅ فعال |
| 2 | `90.188.92.116` | `36335` | 189.10ms | ✅ فعال |
| 3 | `185.114.89.74` | `1080` | 143.49ms | ✅ فعال |
| 4 | `8.213.215.187` | `5060` | 858.74ms | ✅ فعال |
| 5 | `47.252.18.37` | `9080` | 673.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 205.71ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 140.02ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 136.95ms | ✅ فعال |
| 4 | `190.7.138.78` | `80` | 98.43ms | ✅ فعال |
| 5 | `103.130.61.61` | `8081` | 260.00ms | ✅ فعال |
