...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:47 18-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `219.93.101.62` | `80` | 219.24ms | ✅ فعال |
| 2 | `35.237.28.196` | `2222` | 39.57ms | ✅ فعال |
| 3 | `164.90.187.185` | `1081` | 125.95ms | ✅ فعال |
| 4 | `167.71.222.124` | `10001` | 200.58ms | ✅ فعال |
| 5 | `206.123.156.225` | `8557` | 124.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.147.152.12` | `1080` | 115.17ms | ✅ فعال |
| 2 | `8.211.195.173` | `8008` | 111.57ms | ✅ فعال |
| 3 | `193.169.245.15` | `1080` | 114.05ms | ✅ فعال |
| 4 | `46.4.181.126` | `61298` | 2187.23ms | ✅ فعال |
| 5 | `185.32.4.102` | `4153` | 138.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.7.138.78` | `80` | 109.83ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 202.38ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 164.57ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 195.92ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 170.83ms | ✅ فعال |
