...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:50 18-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.156.157` | `80` | 6.05ms | ✅ فعال |
| 2 | `5.10.246.136` | `80` | 5.61ms | ✅ فعال |
| 3 | `172.67.176.16` | `80` | 5.96ms | ✅ فعال |
| 4 | `47.76.144.139` | `3128` | 206.80ms | ✅ فعال |
| 5 | `98.175.31.222` | `4145` | 71.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `3128` | 261.47ms | ✅ فعال |
| 2 | `65.111.5.174` | `3129` | 5.59ms | ✅ فعال |
| 3 | `103.146.170.233` | `5678` | 278.71ms | ✅ فعال |
| 4 | `185.162.231.238` | `80` | 6.63ms | ✅ فعال |
| 5 | `8.213.195.191` | `37` | 254.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.245.221.183` | `80` | 5.78ms | ✅ فعال |
| 2 | `62.72.166.211` | `80` | 5.95ms | ✅ فعال |
| 3 | `104.18.40.13` | `80` | 6.94ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 6.42ms | ✅ فعال |
| 5 | `23.227.39.103` | `80` | 6.69ms | ✅ فعال |
