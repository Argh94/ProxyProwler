...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 02-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.30.182` | `80` | 2.00ms | ✅ فعال |
| 2 | `82.24.219.140` | `5962` | 158.17ms | ✅ فعال |
| 3 | `45.85.118.52` | `80` | 1.93ms | ✅ فعال |
| 4 | `104.21.229.163` | `80` | 20.82ms | ✅ فعال |
| 5 | `206.238.236.187` | `80` | 1.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.51.138.138` | `8080` | 211.29ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 203.03ms | ✅ فعال |
| 3 | `187.44.211.118` | `4153` | 1244.74ms | ✅ فعال |
| 4 | `88.216.98.233` | `53983` | 65.28ms | ✅ فعال |
| 5 | `8.130.34.237` | `1234` | 201.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.24.57.248` | `80` | 1.75ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 2.12ms | ✅ فعال |
| 3 | `45.131.4.9` | `80` | 2.12ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 2.27ms | ✅ فعال |
| 5 | `104.17.106.99` | `80` | 1.76ms | ✅ فعال |
