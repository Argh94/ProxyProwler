...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 15-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.176.118.150` | `1080` | 2319.10ms | ✅ فعال |
| 2 | `72.37.216.68` | `4145` | 71.52ms | ✅ فعال |
| 3 | `159.246.55.233` | `80` | 2.42ms | ✅ فعال |
| 4 | `162.159.242.58` | `80` | 2.23ms | ✅ فعال |
| 5 | `13.233.223.41` | `3128` | 246.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `87.250.60.66` | `8080` | 133.88ms | ✅ فعال |
| 2 | `47.251.73.54` | `90` | 52.62ms | ✅ فعال |
| 3 | `8.215.19.18` | `1011` | 218.94ms | ✅ فعال |
| 4 | `142.54.226.214` | `4145` | 84.07ms | ✅ فعال |
| 5 | `101.132.222.120` | `80` | 237.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.104.15` | `80` | 4.36ms | ✅ فعال |
| 2 | `103.39.49.156` | `3128` | 247.79ms | ✅ فعال |
| 3 | `45.80.108.229` | `80` | 2.04ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 2.54ms | ✅ فعال |
| 5 | `104.17.247.188` | `80` | 2.30ms | ✅ فعال |
