...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 29-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.17.173` | `443` | 5.73ms | ✅ فعال |
| 2 | `102.177.176.127` | `80` | 6.18ms | ✅ فعال |
| 3 | `43.161.250.102` | `8080` | 209.03ms | ✅ فعال |
| 4 | `67.201.33.10` | `25283` | 71.13ms | ✅ فعال |
| 5 | `216.205.52.55` | `80` | 5.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.196.151.191` | `8090` | 253.90ms | ✅ فعال |
| 2 | `49.0.199.132` | `19` | 264.05ms | ✅ فعال |
| 3 | `82.24.212.33` | `5339` | 12.62ms | ✅ فعال |
| 4 | `104.16.249.37` | `80` | 5.73ms | ✅ فعال |
| 5 | `67.201.33.10` | `25283` | 75.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 5.96ms | ✅ فعال |
| 2 | `199.48.129.114` | `3120` | 11.53ms | ✅ فعال |
| 3 | `18.143.173.102` | `162` | 224.63ms | ✅ فعال |
| 4 | `3.38.101.138` | `8337` | 193.84ms | ✅ فعال |
| 5 | `18.143.167.190` | `12354` | 226.14ms | ✅ فعال |
