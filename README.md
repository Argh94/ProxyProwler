...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 13-08-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (84 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.93.70` | `80` | 16.37ms | ✅ فعال |
| 2 | `47.254.36.213` | `8001` | 171.64ms | ✅ فعال |
| 3 | `104.25.50.8` | `80` | 9.02ms | ✅ فعال |
| 4 | `102.177.176.130` | `80` | 8.75ms | ✅ فعال |
| 5 | `82.23.206.7` | `5813` | 71.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `111.68.127.170` | `4153` | 1228.30ms | ✅ فعال |
| 2 | `159.138.255.141` | `20002` | 204.35ms | ✅ فعال |
| 3 | `18.60.222.217` | `57032` | 221.68ms | ✅ فعال |
| 4 | `82.23.206.7` | `5813` | 71.53ms | ✅ فعال |
| 5 | `198.37.118.194` | `5653` | 52.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.3.251` | `8660` | 160.42ms | ✅ فعال |
| 2 | `18.163.3.251` | `6236` | 159.03ms | ✅ فعال |
| 3 | `5.252.33.13` | `2025` | 2263.73ms | ✅ فعال |
| 4 | `13.60.209.160` | `10965` | 155.42ms | ✅ فعال |
| 5 | `145.40.97.148` | `9400` | 1754.42ms | ✅ فعال |
