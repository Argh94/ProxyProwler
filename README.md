...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:54 05-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.220.92` | `17328` | 64.12ms | ✅ فعال |
| 2 | `149.62.186.244` | `1080` | 122.88ms | ✅ فعال |
| 3 | `58.19.55.7` | `15088` | 196.78ms | ✅ فعال |
| 4 | `142.54.229.249` | `4145` | 64.03ms | ✅ فعال |
| 5 | `67.201.39.14` | `4145` | 62.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `178.220.148.82` | `10801` | 1173.40ms | ✅ فعال |
| 2 | `202.150.1.87` | `80` | 227.31ms | ✅ فعال |
| 3 | `47.91.120.190` | `1080` | 182.67ms | ✅ فعال |
| 4 | `198.105.111.109` | `6787` | 97.53ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 151.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 228.74ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 183.02ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 144.68ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 133.15ms | ✅ فعال |
| 5 | `13.127.170.8` | `3128` | 213.56ms | ✅ فعال |
