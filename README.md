...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 30-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.49.86` | `2002` | 155.17ms | ✅ فعال |
| 2 | `172.67.161.96` | `80` | 2.12ms | ✅ فعال |
| 3 | `8.210.17.35` | `8008` | 856.30ms | ✅ فعال |
| 4 | `45.80.110.129` | `80` | 2.30ms | ✅ فعال |
| 5 | `104.19.223.79` | `80` | 11.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.29.214.232` | `7083` | 131.30ms | ✅ فعال |
| 2 | `145.223.51.215` | `6748` | 151.06ms | ✅ فعال |
| 3 | `182.160.16.234` | `8020` | 289.58ms | ✅ فعال |
| 4 | `39.102.213.3` | `9098` | 212.83ms | ✅ فعال |
| 5 | `94.159.106.252` | `1080` | 1195.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.196.63` | `9437` | 230.12ms | ✅ فعال |
| 2 | `43.208.129.50` | `10844` | 194.48ms | ✅ فعال |
| 3 | `3.122.235.189` | `9507` | 149.92ms | ✅ فعال |
| 4 | `35.183.64.191` | `30309` | 85.76ms | ✅ فعال |
| 5 | `43.208.25.125` | `140` | 195.32ms | ✅ فعال |
