...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:33 04-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.174.231.218` | `8888` | 36.19ms | ✅ فعال |
| 2 | `192.73.244.36` | `80` | 64.56ms | ✅ فعال |
| 3 | `74.119.147.209` | `4145` | 78.77ms | ✅ فعال |
| 4 | `212.47.232.28` | `80` | 88.79ms | ✅ فعال |
| 5 | `155.212.132.241` | `3128` | 135.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.8.84.3` | `4145` | 75.87ms | ✅ فعال |
| 2 | `198.8.94.174` | `39078` | 79.80ms | ✅ فعال |
| 3 | `45.41.173.21` | `6388` | 1.91ms | ✅ فعال |
| 4 | `206.206.71.220` | `5860` | 57.23ms | ✅ فعال |
| 5 | `45.93.30.177` | `6005` | 2536.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 732.56ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 220.05ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 163.38ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 217.99ms | ✅ فعال |
| 5 | `162.243.149.86` | `31028` | 61.41ms | ✅ فعال |
