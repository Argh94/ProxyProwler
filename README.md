...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:54 14-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.81.110` | `5757` | 137.88ms | ✅ فعال |
| 2 | `3.84.72.152` | `5555` | 68.93ms | ✅ فعال |
| 3 | `45.194.33.12` | `30001` | 162.28ms | ✅ فعال |
| 4 | `145.223.46.64` | `5614` | 144.96ms | ✅ فعال |
| 5 | `217.117.160.188` | `7330` | 66.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.117.160.188` | `7330` | 66.92ms | ✅ فعال |
| 2 | `13.125.44.24` | `80` | 133.50ms | ✅ فعال |
| 3 | `177.136.124.46` | `56113` | 1197.67ms | ✅ فعال |
| 4 | `8.221.141.88` | `11` | 2823.38ms | ✅ فعال |
| 5 | `177.73.248.26` | `55290` | 1196.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 114.72ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 179.16ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 168.20ms | ✅ فعال |
