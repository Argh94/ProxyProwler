...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:40 29-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (35 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `109.236.88.82` | `80` | 106.63ms | ✅ فعال |
| 2 | `88.218.206.170` | `22` | 123.33ms | ✅ فعال |
| 3 | `23.247.136.254` | `80` | 131.94ms | ✅ فعال |
| 4 | `181.205.113.218` | `1080` | 1128.53ms | ✅ فعال |
| 5 | `142.54.226.214` | `4145` | 63.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.102.107.145` | `4145` | 62.29ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 263.80ms | ✅ فعال |
| 3 | `146.103.55.165` | `6217` | 18.79ms | ✅ فعال |
| 4 | `78.28.152.113` | `80` | 140.50ms | ✅ فعال |
| 5 | `144.124.232.204` | `443` | 100.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 147.38ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 21.34ms | ✅ فعال |
| 3 | `94.130.177.190` | `9999` | 116.01ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 134.82ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 20.94ms | ✅ فعال |
