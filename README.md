...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:51 03-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `139.162.78.109` | `8080` | 105.10ms | ✅ فعال |
| 2 | `89.116.250.163` | `80` | 2.64ms | ✅ فعال |
| 3 | `185.170.166.199` | `80` | 1.98ms | ✅ فعال |
| 4 | `104.254.140.195` | `80` | 1.96ms | ✅ فعال |
| 5 | `23.27.75.196` | `6276` | 29.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.131.199.127` | `3629` | 1217.16ms | ✅ فعال |
| 2 | `101.44.62.153` | `9090` | 1261.33ms | ✅ فعال |
| 3 | `216.205.52.221` | `80` | 1.93ms | ✅ فعال |
| 4 | `47.109.110.100` | `9080` | 227.56ms | ✅ فعال |
| 5 | `1.180.49.222` | `7302` | 237.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.55` | `80` | 2.02ms | ✅ فعال |
| 2 | `216.24.57.248` | `80` | 1.79ms | ✅ فعال |
| 3 | `45.12.31.28` | `80` | 2.28ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 1.86ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 73.21ms | ✅ فعال |
