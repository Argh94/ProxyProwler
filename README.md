...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 24-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `162.159.251.173` | `80` | 15.12ms | ✅ فعال |
| 2 | `195.85.23.118` | `80` | 8.85ms | ✅ فعال |
| 3 | `185.18.250.203` | `80` | 9.63ms | ✅ فعال |
| 4 | `216.205.52.81` | `80` | 12.59ms | ✅ فعال |
| 5 | `102.177.176.218` | `80` | 14.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 260.24ms | ✅ فعال |
| 2 | `157.230.45.111` | `1080` | 195.70ms | ✅ فعال |
| 3 | `171.241.21.61` | `5678` | 2281.55ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 114.44ms | ✅ فعال |
| 5 | `8.130.34.44` | `3128` | 232.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 27.39ms | ✅ فعال |
| 2 | `89.58.45.94` | `10054` | 128.80ms | ✅ فعال |
| 3 | `15.223.188.196` | `10033` | 33.81ms | ✅ فعال |
| 4 | `13.61.155.35` | `8028` | 131.68ms | ✅ فعال |
| 5 | `51.20.126.89` | `28707` | 131.84ms | ✅ فعال |
