...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 05-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.159.219.162` | `80` | 1.95ms | ✅ فعال |
| 2 | `45.131.5.136` | `80` | 2.72ms | ✅ فعال |
| 3 | `104.16.192.118` | `80` | 2.76ms | ✅ فعال |
| 4 | `45.159.219.12` | `80` | 2.13ms | ✅ فعال |
| 5 | `104.253.91.254` | `6687` | 131.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.222.120` | `80` | 227.35ms | ✅ فعال |
| 2 | `98.181.137.80` | `4145` | 89.36ms | ✅ فعال |
| 3 | `104.253.91.254` | `6687` | 131.60ms | ✅ فعال |
| 4 | `1.0.0.4` | `80` | 2.42ms | ✅ فعال |
| 5 | `202.40.181.220` | `31247` | 262.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.39.49.156` | `3128` | 1257.51ms | ✅ فعال |
| 2 | `89.116.250.4` | `80` | 2.99ms | ✅ فعال |
| 3 | `172.67.181.33` | `80` | 2.94ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 2.71ms | ✅ فعال |
| 5 | `102.177.176.178` | `80` | 2.23ms | ✅ فعال |
