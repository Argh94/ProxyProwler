...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:50 15-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `49.254.42.64` | `6475` | 130.63ms | ✅ فعال |
| 2 | `170.114.45.226` | `80` | 5.76ms | ✅ فعال |
| 3 | `162.159.153.86` | `80` | 2.06ms | ✅ فعال |
| 4 | `164.38.155.182` | `80` | 1.97ms | ✅ فعال |
| 5 | `170.114.45.125` | `80` | 2.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.238.57.1` | `3629` | 124.31ms | ✅ فعال |
| 2 | `8.208.84.236` | `7657` | 142.13ms | ✅ فعال |
| 3 | `104.17.80.92` | `80` | 1.87ms | ✅ فعال |
| 4 | `202.162.212.164` | `4153` | 205.97ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 230.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `175.208.236.55` | `8082` | 131.95ms | ✅ فعال |
| 2 | `13.212.14.16` | `10985` | 172.15ms | ✅ فعال |
| 3 | `201.89.97.222` | `8080` | 184.98ms | ✅ فعال |
| 4 | `13.115.193.75` | `55081` | 106.39ms | ✅ فعال |
| 5 | `15.160.151.84` | `9287` | 162.49ms | ✅ فعال |
