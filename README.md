...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 19-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 196.13ms | ✅ فعال |
| 2 | `104.25.103.111` | `80` | 12.68ms | ✅ فعال |
| 3 | `45.12.31.148` | `80` | 14.66ms | ✅ فعال |
| 4 | `68.71.254.6` | `4145` | 79.13ms | ✅ فعال |
| 5 | `45.131.4.172` | `80` | 14.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.111.161.81` | `6452` | 12.80ms | ✅ فعال |
| 2 | `91.223.52.141` | `5678` | 1138.64ms | ✅ فعال |
| 3 | `119.13.111.169` | `18081` | 196.63ms | ✅ فعال |
| 4 | `8.220.204.215` | `3128` | 165.93ms | ✅ فعال |
| 5 | `47.254.153.78` | `999` | 119.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.221.193.221` | `26149` | 118.83ms | ✅ فعال |
| 2 | `34.216.224.9` | `8664` | 45.15ms | ✅ فعال |
| 3 | `15.160.148.69` | `223` | 120.95ms | ✅ فعال |
| 4 | `116.96.101.151` | `6616` | 240.53ms | ✅ فعال |
| 5 | `119.148.14.201` | `39044` | 2342.86ms | ✅ فعال |
