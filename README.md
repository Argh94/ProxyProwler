...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 23-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.34.228.79` | `80` | 2.88ms | ✅ فعال |
| 2 | `104.27.46.180` | `80` | 2.24ms | ✅ فعال |
| 3 | `86.38.154.239` | `5882` | 83.98ms | ✅ فعال |
| 4 | `23.227.39.38` | `80` | 1.98ms | ✅ فعال |
| 5 | `206.238.237.148` | `80` | 2.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 213.23ms | ✅ فعال |
| 2 | `198.105.100.223` | `6474` | 76.12ms | ✅ فعال |
| 3 | `192.145.31.160` | `4145` | 89.52ms | ✅ فعال |
| 4 | `91.221.177.40` | `80` | 147.27ms | ✅ فعال |
| 5 | `178.220.148.82` | `10801` | 2204.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.14.16` | `28080` | 230.79ms | ✅ فعال |
| 2 | `13.61.155.35` | `54515` | 98.93ms | ✅ فعال |
| 3 | `43.208.240.77` | `50822` | 250.30ms | ✅ فعال |
| 4 | `15.160.148.69` | `8349` | 94.72ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 3.19ms | ✅ فعال |
