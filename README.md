...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:55 04-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `8443` | 1890.72ms | ✅ فعال |
| 2 | `125.141.133.49` | `5566` | 174.42ms | ✅ فعال |
| 3 | `161.123.5.142` | `5191` | 16.18ms | ✅ فعال |
| 4 | `5.182.34.208` | `80` | 1.86ms | ✅ فعال |
| 5 | `104.17.66.69` | `80` | 2.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.119.6` | `80` | 3.38ms | ✅ فعال |
| 2 | `194.152.44.2` | `80` | 2.21ms | ✅ فعال |
| 3 | `45.85.119.122` | `80` | 2.59ms | ✅ فعال |
| 4 | `141.193.213.44` | `80` | 2.45ms | ✅ فعال |
| 5 | `184.178.172.26` | `4145` | 86.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.197.20` | `80` | 2.31ms | ✅ فعال |
| 2 | `216.24.57.248` | `80` | 3.15ms | ✅ فعال |
| 3 | `45.80.108.229` | `80` | 1.79ms | ✅ فعال |
| 4 | `104.19.66.163` | `80` | 2.19ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 16.92ms | ✅ فعال |
