...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:24 05-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `14.225.240.23` | `8562` | 1273.71ms | ✅ فعال |
| 2 | `174.138.119.88` | `80` | 13.05ms | ✅ فعال |
| 3 | `61.158.175.38` | `9002` | 215.19ms | ✅ فعال |
| 4 | `163.5.128.129` | `14270` | 1009.06ms | ✅ فعال |
| 5 | `188.165.199.207` | `80` | 1124.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.114.253.210` | `3389` | 113.62ms | ✅ فعال |
| 2 | `47.76.144.139` | `11` | 201.28ms | ✅ فعال |
| 3 | `120.26.104.146` | `6379` | 258.63ms | ✅ فعال |
| 4 | `103.166.39.81` | `3629` | 256.05ms | ✅ فعال |
| 5 | `47.251.74.38` | `80` | 69.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 546.27ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 234.98ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 166.64ms | ✅ فعال |
| 4 | `179.96.28.58` | `80` | 140.09ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 232.63ms | ✅ فعال |
