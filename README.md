...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:30 25-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.32.217.35` | `10808` | 237.31ms | ✅ فعال |
| 2 | `219.93.101.62` | `80` | 250.08ms | ✅ فعال |
| 3 | `8.220.205.172` | `6379` | 771.15ms | ✅ فعال |
| 4 | `194.87.219.78` | `1080` | 88.97ms | ✅ فعال |
| 5 | `145.220.226.221` | `8080` | 91.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.53.216.73` | `4145` | 1312.87ms | ✅ فعال |
| 2 | `41.220.16.208` | `80` | 236.08ms | ✅ فعال |
| 3 | `200.10.31.74` | `49992` | 2147.70ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 111.59ms | ✅ فعال |
| 5 | `203.188.245.98` | `52837` | 246.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 243.15ms | ✅ فعال |
