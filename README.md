...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 06-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `139.162.78.109` | `8080` | 105.32ms | ✅ فعال |
| 2 | `98.181.137.83` | `4145` | 127.29ms | ✅ فعال |
| 3 | `172.67.181.57` | `80` | 1.74ms | ✅ فعال |
| 4 | `8.213.222.247` | `80` | 221.68ms | ✅ فعال |
| 5 | `8.211.195.139` | `8443` | 1880.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.137.37` | `18762` | 129.27ms | ✅ فعال |
| 2 | `201.148.125.126` | `4153` | 194.80ms | ✅ فعال |
| 3 | `18.226.170.181` | `36970` | 59.06ms | ✅ فعال |
| 4 | `97.105.12.186` | `4153` | 55.61ms | ✅ فعال |
| 5 | `142.111.161.42` | `6413` | 50.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.211.217` | `80` | 1.77ms | ✅ فعال |
| 2 | `104.17.247.188` | `80` | 1.64ms | ✅ فعال |
| 3 | `23.227.39.55` | `80` | 1.60ms | ✅ فعال |
| 4 | `104.17.106.99` | `80` | 1.67ms | ✅ فعال |
| 5 | `103.169.142.78` | `80` | 1.54ms | ✅ فعال |
