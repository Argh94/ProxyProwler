...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 23-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.254.140.190` | `80` | 1.85ms | ✅ فعال |
| 2 | `8.213.156.191` | `30000` | 826.96ms | ✅ فعال |
| 3 | `104.27.64.84` | `80` | 2.18ms | ✅ فعال |
| 4 | `72.37.217.3` | `4145` | 1110.48ms | ✅ فعال |
| 5 | `181.214.1.186` | `80` | 2.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.18.37` | `5060` | 810.00ms | ✅ فعال |
| 2 | `139.99.237.62` | `80` | 137.93ms | ✅ فعال |
| 3 | `8.213.215.187` | `143` | 192.68ms | ✅ فعال |
| 4 | `103.146.42.179` | `8086` | 217.34ms | ✅ فعال |
| 5 | `36.37.189.64` | `5678` | 2286.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.153.234.91` | `3128` | 2223.13ms | ✅ فعال |
| 2 | `147.75.33.99` | `10392` | 697.31ms | ✅ فعال |
| 3 | `116.203.139.209` | `3128` | 156.78ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 169.02ms | ✅ فعال |
| 5 | `40.176.96.235` | `20` | 39.96ms | ✅ فعال |
