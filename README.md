...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:13 14-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.215.15.163` | `50` | 236.14ms | ✅ فعال |
| 2 | `23.88.88.105` | `443` | 94.70ms | ✅ فعال |
| 3 | `120.92.212.16` | `8890` | 271.84ms | ✅ فعال |
| 4 | `143.198.135.176` | `80` | 2093.08ms | ✅ فعال |
| 5 | `120.92.212.16` | `7890` | 276.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `123.57.1.16` | `5555` | 251.79ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 2172.00ms | ✅ فعال |
| 3 | `220.116.142.217` | `80` | 186.04ms | ✅ فعال |
| 4 | `47.252.11.233` | `5060` | 2.36ms | ✅ فعال |
| 5 | `206.220.175.2` | `4145` | 82.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.210.113.32` | `8123` | 156.77ms | ✅ فعال |
| 2 | `179.96.28.58` | `80` | 147.26ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 99.27ms | ✅ فعال |
| 4 | `23.88.88.102` | `80` | 95.02ms | ✅ فعال |
| 5 | `41.220.16.215` | `80` | 2297.01ms | ✅ فعال |
