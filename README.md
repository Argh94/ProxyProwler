...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 16-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.197.208` | `18080` | 903.82ms | ✅ فعال |
| 2 | `47.74.46.81` | `11310` | 106.39ms | ✅ فعال |
| 3 | `104.20.56.115` | `80` | 1.95ms | ✅ فعال |
| 4 | `8.220.204.92` | `9080` | 784.14ms | ✅ فعال |
| 5 | `69.84.182.134` | `80` | 1.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.162.212.164` | `4153` | 206.34ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 131.14ms | ✅ فعال |
| 3 | `24.249.199.12` | `4145` | 1229.33ms | ✅ فعال |
| 4 | `162.220.247.86` | `6681` | 145.62ms | ✅ فعال |
| 5 | `47.251.73.54` | `808` | 2.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 110.90ms | ✅ فعال |
| 2 | `43.210.30.230` | `10` | 201.59ms | ✅ فعال |
| 3 | `50.17.40.179` | `240` | 64.05ms | ✅ فعال |
| 4 | `18.143.165.238` | `8124` | 171.12ms | ✅ فعال |
| 5 | `144.125.164.158` | `8080` | 1.53ms | ✅ فعال |
