...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:16 08-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.245.148` | `4145` | 66.53ms | ✅ فعال |
| 2 | `5.255.117.250` | `1080` | 131.40ms | ✅ فعال |
| 3 | `27.254.99.183` | `8118` | 233.73ms | ✅ فعال |
| 4 | `8.221.138.111` | `8081` | 144.58ms | ✅ فعال |
| 5 | `43.167.245.99` | `3128` | 146.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.215.5.202` | `5232` | 51.85ms | ✅ فعال |
| 2 | `68.183.52.128` | `9280` | 27.67ms | ✅ فعال |
| 3 | `43.167.245.99` | `3128` | 146.36ms | ✅ فعال |
| 4 | `47.238.128.246` | `4145` | 186.48ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 1146.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 16.37ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 131.81ms | ✅ فعال |
| 3 | `45.174.168.1` | `999` | 2089.63ms | ✅ فعال |
| 4 | `115.248.66.131` | `3129` | 272.01ms | ✅ فعال |
| 5 | `165.232.119.106` | `8080` | 107.14ms | ✅ فعال |
