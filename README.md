...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:08 11-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.171.133.81` | `1080` | 200.75ms | ✅ فعال |
| 2 | `43.161.253.113` | `1080` | 147.00ms | ✅ فعال |
| 3 | `217.76.54.178` | `9052` | 145.41ms | ✅ فعال |
| 4 | `34.94.46.8` | `80` | 9.45ms | ✅ فعال |
| 5 | `121.43.154.123` | `20000` | 187.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `219.93.101.62` | `80` | 192.29ms | ✅ فعال |
| 2 | `94.102.89.44` | `1080` | 177.84ms | ✅ فعال |
| 3 | `69.58.12.145` | `8150` | 65.60ms | ✅ فعال |
| 4 | `103.234.35.199` | `3128` | 1263.81ms | ✅ فعال |
| 5 | `47.253.201.85` | `7890` | 62.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 175.79ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 64.66ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 64.31ms | ✅ فعال |
