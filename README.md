...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:44 18-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `43.165.6.179` | `1080` | 129.90ms | ✅ فعال |
| 2 | `192.241.125.106` | `8150` | 36.44ms | ✅ فعال |
| 3 | `139.224.186.221` | `9080` | 202.64ms | ✅ فعال |
| 4 | `171.247.244.22` | `1080` | 188.63ms | ✅ فعال |
| 5 | `206.123.156.227` | `4036` | 1171.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.140.105.75` | `8009` | 215.24ms | ✅ فعال |
| 2 | `178.156.224.42` | `3128` | 50.59ms | ✅ فعال |
| 3 | `196.240.190.74` | `20424` | 228.06ms | ✅ فعال |
| 4 | `192.241.125.106` | `8150` | 36.57ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 2232.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 202.81ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 194.46ms | ✅ فعال |
| 3 | `103.158.252.99` | `80` | 197.72ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 51.32ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 1268.90ms | ✅ فعال |
