...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 28-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.53.150` | `80` | 6.28ms | ✅ فعال |
| 2 | `107.181.148.243` | `6103` | 79.58ms | ✅ فعال |
| 3 | `45.131.210.126` | `80` | 5.85ms | ✅ فعال |
| 4 | `104.18.4.18` | `80` | 5.97ms | ✅ فعال |
| 5 | `216.24.57.225` | `80` | 6.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.199.166.250` | `9115` | 224.20ms | ✅ فعال |
| 2 | `5.199.173.2` | `9081` | 112.28ms | ✅ فعال |
| 3 | `5.199.166.240` | `9115` | 221.98ms | ✅ فعال |
| 4 | `91.142.79.166` | `8080` | 1166.69ms | ✅ فعال |
| 5 | `8.130.34.44` | `7777` | 277.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.129.50` | `8830` | 250.44ms | ✅ فعال |
| 2 | `35.183.64.191` | `39580` | 24.97ms | ✅ فعال |
| 3 | `34.236.148.220` | `8007` | 5.68ms | ✅ فعال |
| 4 | `15.160.134.84` | `19386` | 100.80ms | ✅ فعال |
| 5 | `43.217.141.124` | `31833` | 232.44ms | ✅ فعال |
