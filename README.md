...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 13-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.203.242` | `80` | 12.32ms | ✅ فعال |
| 2 | `104.17.156.148` | `80` | 6.19ms | ✅ فعال |
| 3 | `45.159.216.154` | `80` | 5.60ms | ✅ فعال |
| 4 | `185.238.228.211` | `80` | 5.85ms | ✅ فعال |
| 5 | `45.131.6.108` | `80` | 5.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.237` | `1234` | 317.03ms | ✅ فعال |
| 2 | `45.187.76.2` | `3629` | 157.86ms | ✅ فعال |
| 3 | `8.215.3.250` | `1080` | 651.62ms | ✅ فعال |
| 4 | `66.81.247.112` | `80` | 6.09ms | ✅ فعال |
| 5 | `51.20.192.194` | `13327` | 104.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.176.96.235` | `8132` | 89.16ms | ✅ فعال |
| 2 | `40.192.3.100` | `331` | 208.15ms | ✅ فعال |
| 3 | `144.91.81.25` | `3128` | 2168.38ms | ✅ فعال |
| 4 | `16.78.105.11` | `16877` | 236.55ms | ✅ فعال |
| 5 | `43.216.1.13` | `1787` | 229.10ms | ✅ فعال |
