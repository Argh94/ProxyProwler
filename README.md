...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 25-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 167.23ms | ✅ فعال |
| 2 | `175.110.113.246` | `11140` | 144.03ms | ✅ فعال |
| 3 | `104.17.4.219` | `80` | 1.73ms | ✅ فعال |
| 4 | `45.8.211.226` | `80` | 1.47ms | ✅ فعال |
| 5 | `104.16.56.234` | `80` | 1.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.237.92.86` | `45` | 172.32ms | ✅ فعال |
| 2 | `91.65.94.20` | `80` | 181.62ms | ✅ فعال |
| 3 | `88.216.215.143` | `9107` | 171.74ms | ✅ فعال |
| 4 | `120.237.27.34` | `22222` | 193.33ms | ✅ فعال |
| 5 | `5.199.166.232` | `9090` | 166.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.3.251` | `9149` | 155.54ms | ✅ فعال |
| 2 | `54.90.159.174` | `52929` | 66.20ms | ✅ فعال |
| 3 | `3.110.127.255` | `35179` | 222.00ms | ✅ فعال |
| 4 | `51.17.184.165` | `37572` | 195.46ms | ✅ فعال |
| 5 | `176.57.189.138` | `3128` | 153.31ms | ✅ فعال |
