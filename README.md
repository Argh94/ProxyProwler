...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:50 04-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.128.246` | `6379` | 207.64ms | ✅ فعال |
| 2 | `159.246.55.218` | `80` | 5.47ms | ✅ فعال |
| 3 | `173.245.49.90` | `80` | 5.58ms | ✅ فعال |
| 4 | `104.25.50.237` | `80` | 5.58ms | ✅ فعال |
| 5 | `104.254.140.105` | `80` | 5.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.110.201.235` | `8081` | 107.06ms | ✅ فعال |
| 2 | `188.114.96.93` | `80` | 5.88ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 278.82ms | ✅ فعال |
| 4 | `104.18.33.8` | `80` | 5.56ms | ✅ فعال |
| 5 | `47.238.128.246` | `6379` | 207.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.122.238` | `80` | 5.96ms | ✅ فعال |
| 2 | `45.131.4.9` | `80` | 6.89ms | ✅ فعال |
| 3 | `45.85.118.80` | `80` | 6.13ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 5.33ms | ✅ فعال |
| 5 | `45.131.7.159` | `80` | 5.74ms | ✅ فعال |
