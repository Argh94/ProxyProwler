...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:35 08-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.105.122.98` | `6671` | 97.14ms | ✅ فعال |
| 2 | `8.220.141.8` | `45` | 248.41ms | ✅ فعال |
| 3 | `152.232.101.82` | `8214` | 46.15ms | ✅ فعال |
| 4 | `45.41.178.43` | `6264` | 25.32ms | ✅ فعال |
| 5 | `66.42.224.229` | `41679` | 537.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.237.107.41` | `3128` | 214.48ms | ✅ فعال |
| 2 | `219.93.101.60` | `80` | 228.49ms | ✅ فعال |
| 3 | `47.91.89.3` | `9080` | 111.60ms | ✅ فعال |
| 4 | `152.232.101.82` | `8214` | 44.82ms | ✅ فعال |
| 5 | `45.41.178.43` | `6264` | 23.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.127.170.8` | `3128` | 226.41ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 134.06ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 206.24ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 144.44ms | ✅ فعال |
