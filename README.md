...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:44 07-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.183.251` | `4145` | 99.26ms | ✅ فعال |
| 2 | `192.252.208.70` | `14282` | 105.20ms | ✅ فعال |
| 3 | `113.204.79.230` | `9091` | 197.42ms | ✅ فعال |
| 4 | `13.140.164.179` | `3587` | 1280.49ms | ✅ فعال |
| 5 | `142.111.104.171` | `6181` | 69.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `170.106.173.62` | `8080` | 2.94ms | ✅ فعال |
| 2 | `136.0.186.128` | `6489` | 67.62ms | ✅ فعال |
| 3 | `70.166.167.55` | `57745` | 147.10ms | ✅ فعال |
| 4 | `167.99.236.14` | `80` | 75.26ms | ✅ فعال |
| 5 | `104.239.106.251` | `5896` | 56.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 181.26ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 66.89ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 187.29ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 183.15ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 69.39ms | ✅ فعال |
