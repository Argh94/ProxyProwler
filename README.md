...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:24 06-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.206.74.126` | `4145` | 106.43ms | ✅ فعال |
| 2 | `58.19.55.7` | `15396` | 181.09ms | ✅ فعال |
| 3 | `179.61.166.211` | `6634` | 47.09ms | ✅ فعال |
| 4 | `167.172.161.22` | `1085` | 119.73ms | ✅ فعال |
| 5 | `58.19.55.88` | `15059` | 182.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `212.41.8.52` | `11245` | 160.53ms | ✅ فعال |
| 2 | `8.211.195.139` | `28737` | 906.71ms | ✅ فعال |
| 3 | `72.195.114.184` | `4145` | 106.67ms | ✅ فعال |
| 4 | `103.166.39.81` | `3629` | 242.21ms | ✅ فعال |
| 5 | `8.215.15.163` | `4145` | 236.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 196.53ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 150.74ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 134.31ms | ✅ فعال |
