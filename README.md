...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 28-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `46.254.92.108` | `80` | 14.33ms | ✅ فعال |
| 2 | `8.211.195.139` | `8001` | 665.18ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 200.05ms | ✅ فعال |
| 4 | `104.21.224.4` | `80` | 14.05ms | ✅ فعال |
| 5 | `185.162.229.54` | `80` | 14.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `4006` | 201.37ms | ✅ فعال |
| 2 | `123.57.1.16` | `5555` | 244.82ms | ✅ فعال |
| 3 | `49.0.252.39` | `9000` | 187.03ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 212.95ms | ✅ فعال |
| 5 | `84.39.112.144` | `3128` | 120.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.143.173.102` | `162` | 199.07ms | ✅ فعال |
| 2 | `3.110.127.255` | `5534` | 222.02ms | ✅ فعال |
| 3 | `3.38.101.138` | `7010` | 159.90ms | ✅ فعال |
| 4 | `176.57.189.138` | `3128` | 1145.23ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 23.88ms | ✅ فعال |
