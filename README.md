...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:37 30-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.231` | `8157` | 88.94ms | ✅ فعال |
| 2 | `199.66.183.226` | `4145` | 56.87ms | ✅ فعال |
| 3 | `199.102.104.70` | `4145` | 78.62ms | ✅ فعال |
| 4 | `92.42.8.5` | `4145` | 1185.37ms | ✅ فعال |
| 5 | `154.88.189.21` | `5678` | 51.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 115.60ms | ✅ فعال |
| 2 | `203.174.26.137` | `4153` | 2360.16ms | ✅ فعال |
| 3 | `8.211.194.78` | `3128` | 82.38ms | ✅ فعال |
| 4 | `174.104.115.21` | `80` | 1072.05ms | ✅ فعال |
| 5 | `188.165.199.207` | `80` | 2169.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 117.92ms | ✅ فعال |
| 2 | `51.79.207.21` | `8080` | 225.62ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 6.36ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 236.93ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 7.99ms | ✅ فعال |
