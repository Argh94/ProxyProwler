...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:26 05-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.253.145.138` | `6980` | 221.50ms | ✅ فعال |
| 2 | `188.239.43.6` | `80` | 221.76ms | ✅ فعال |
| 3 | `181.119.84.221` | `8080` | 70.53ms | ✅ فعال |
| 4 | `45.140.147.155` | `1082` | 90.86ms | ✅ فعال |
| 5 | `36.138.53.26` | `10017` | 230.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.184.67.25` | `1080` | 1244.88ms | ✅ فعال |
| 2 | `177.66.43.189` | `4145` | 1158.02ms | ✅ فعال |
| 3 | `47.91.120.190` | `80` | 170.13ms | ✅ فعال |
| 4 | `98.170.57.231` | `4145` | 91.17ms | ✅ فعال |
| 5 | `107.181.148.103` | `5963` | 83.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 237.59ms | ✅ فعال |
| 2 | `103.165.128.171` | `8080` | 235.60ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 2154.50ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 191.88ms | ✅ فعال |
| 5 | `24.199.124.151` | `3128` | 67.98ms | ✅ فعال |
