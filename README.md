...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:08 12-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `68.71.254.6` | `4145` | 21.63ms | ✅ فعال |
| 2 | `38.59.241.162` | `1080` | 17.13ms | ✅ فعال |
| 3 | `144.31.152.222` | `1080` | 163.98ms | ✅ فعال |
| 4 | `192.111.137.37` | `18762` | 85.47ms | ✅ فعال |
| 5 | `188.113.182.218` | `1080` | 2221.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 150.32ms | ✅ فعال |
| 2 | `125.141.133.47` | `5566` | 132.02ms | ✅ فعال |
| 3 | `209.127.143.28` | `8127` | 62.52ms | ✅ فعال |
| 4 | `138.94.28.234` | `40658` | 162.51ms | ✅ فعال |
| 5 | `185.32.4.126` | `4153` | 1180.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 178.47ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 121.35ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 169.73ms | ✅ فعال |
