...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 07-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.245` | `80` | 1.87ms | ✅ فعال |
| 2 | `103.47.53.136` | `8434` | 12.33ms | ✅ فعال |
| 3 | `91.193.59.112` | `80` | 1.94ms | ✅ فعال |
| 4 | `185.148.105.167` | `80` | 1.70ms | ✅ فعال |
| 5 | `104.238.8.63` | `5921` | 150.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `50` | 105.46ms | ✅ فعال |
| 2 | `4.195.16.140` | `80` | 137.90ms | ✅ فعال |
| 3 | `159.246.55.170` | `80` | 1.98ms | ✅ فعال |
| 4 | `45.128.133.205` | `1080` | 1208.17ms | ✅ فعال |
| 5 | `1.180.0.162` | `7302` | 204.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.84.182.59` | `80` | 1.94ms | ✅ فعال |
| 2 | `104.18.40.13` | `80` | 1.83ms | ✅ فعال |
| 3 | `45.131.4.93` | `80` | 1.87ms | ✅ فعال |
| 4 | `185.148.104.15` | `80` | 1.89ms | ✅ فعال |
| 5 | `23.227.39.103` | `80` | 1.89ms | ✅ فعال |
