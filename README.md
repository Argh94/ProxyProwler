...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 29-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.222.157` | `4000` | 928.87ms | ✅ فعال |
| 2 | `47.252.29.28` | `11222` | 1064.39ms | ✅ فعال |
| 3 | `107.173.36.78` | `5533` | 37.04ms | ✅ فعال |
| 4 | `24.249.199.4` | `4145` | 72.89ms | ✅ فعال |
| 5 | `51.159.226.86` | `443` | 117.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.156.191` | `800` | 768.98ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 234.96ms | ✅ فعال |
| 3 | `93.90.212.2` | `4153` | 144.37ms | ✅ فعال |
| 4 | `51.159.226.86` | `443` | 91.39ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 117.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.25.125` | `140` | 256.20ms | ✅ فعال |
| 2 | `3.122.235.189` | `9507` | 93.69ms | ✅ فعال |
| 3 | `54.90.159.174` | `25371` | 5.88ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 98.09ms | ✅ فعال |
| 5 | `157.180.121.252` | `14865` | 117.22ms | ✅ فعال |
