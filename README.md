...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:47 08-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `84.8.102.52` | `1080` | 216.19ms | ✅ فعال |
| 2 | `45.61.96.93` | `6073` | 67.74ms | ✅ فعال |
| 3 | `43.99.100.108` | `3128` | 138.83ms | ✅ فعال |
| 4 | `216.68.128.121` | `4145` | 124.62ms | ✅ فعال |
| 5 | `45.74.31.42` | `5381` | 1171.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `66.42.224.229` | `41679` | 123.41ms | ✅ فعال |
| 2 | `72.195.34.41` | `4145` | 150.14ms | ✅ فعال |
| 3 | `184.178.172.5` | `15303` | 151.02ms | ✅ فعال |
| 4 | `45.61.96.93` | `6073` | 67.36ms | ✅ فعال |
| 5 | `13.125.44.24` | `80` | 125.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 181.59ms | ✅ فعال |
| 2 | `103.130.61.61` | `8081` | 2240.82ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 186.35ms | ✅ فعال |
| 4 | `102.68.128.212` | `8080` | 175.24ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 160.55ms | ✅ فعال |
