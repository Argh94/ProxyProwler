...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:55 03-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.153.1.242` | `80` | 8.94ms | ✅ فعال |
| 2 | `160.153.1.111` | `80` | 8.78ms | ✅ فعال |
| 3 | `154.83.2.140` | `80` | 8.64ms | ✅ فعال |
| 4 | `104.16.154.203` | `80` | 16.26ms | ✅ فعال |
| 5 | `104.18.144.228` | `80` | 16.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.205.172` | `6379` | 141.95ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 8.74ms | ✅ فعال |
| 3 | `67.201.33.10` | `25283` | 23.29ms | ✅ فعال |
| 4 | `187.44.211.118` | `4153` | 2271.52ms | ✅ فعال |
| 5 | `188.40.57.101` | `80` | 144.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.28` | `80` | 9.37ms | ✅ فعال |
| 2 | `198.177.56.190` | `80` | 8.79ms | ✅ فعال |
| 3 | `104.17.247.188` | `80` | 22.91ms | ✅ فعال |
| 4 | `45.131.7.159` | `80` | 9.04ms | ✅ فعال |
| 5 | `185.148.104.15` | `80` | 9.09ms | ✅ فعال |
