...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:53 19-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (83 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.58.212` | `80` | 17.76ms | ✅ فعال |
| 2 | `185.170.166.127` | `80` | 17.78ms | ✅ فعال |
| 3 | `104.16.171.41` | `80` | 18.24ms | ✅ فعال |
| 4 | `138.68.60.8` | `80` | 23.84ms | ✅ فعال |
| 5 | `36.64.238.82` | `1080` | 211.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.114.201` | `80` | 17.97ms | ✅ فعال |
| 2 | `172.67.142.6` | `80` | 17.43ms | ✅ فعال |
| 3 | `8.130.34.237` | `1234` | 220.49ms | ✅ فعال |
| 4 | `142.147.128.247` | `6747` | 50.71ms | ✅ فعال |
| 5 | `8.211.194.78` | `8443` | 807.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.181.33` | `80` | 18.04ms | ✅ فعال |
| 2 | `104.18.40.13` | `80` | 17.95ms | ✅ فعال |
| 3 | `5.10.247.49` | `80` | 17.70ms | ✅ فعال |
| 4 | `45.85.118.80` | `80` | 17.60ms | ✅ فعال |
| 5 | `69.84.182.59` | `80` | 17.60ms | ✅ فعال |
