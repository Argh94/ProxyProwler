...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 06-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.211.142.115` | `8192` | 1171.94ms | ✅ فعال |
| 2 | `154.17.224.118` | `80` | 38.83ms | ✅ فعال |
| 3 | `154.194.12.172` | `80` | 15.11ms | ✅ فعال |
| 4 | `104.18.6.146` | `80` | 14.19ms | ✅ فعال |
| 5 | `47.90.149.238` | `4145` | 30.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.109.139.51` | `5678` | 2267.42ms | ✅ فعال |
| 2 | `49.0.252.39` | `9000` | 181.92ms | ✅ فعال |
| 3 | `8.130.36.163` | `8888` | 235.08ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 1155.65ms | ✅ فعال |
| 5 | `47.243.124.21` | `6666` | 181.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `144.124.227.90` | `10808` | 114.35ms | ✅ فعال |
| 2 | `13.115.193.75` | `3897` | 134.37ms | ✅ فعال |
| 3 | `116.203.139.209` | `3128` | 119.96ms | ✅ فعال |
| 4 | `43.198.99.209` | `8496` | 183.95ms | ✅ فعال |
| 5 | `157.175.43.137` | `8334` | 201.72ms | ✅ فعال |
