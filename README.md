...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:54 23-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.236` | `6337` | 1155.31ms | ✅ فعال |
| 2 | `104.194.146.9` | `80` | 130.44ms | ✅ فعال |
| 3 | `206.123.156.229` | `8500` | 146.19ms | ✅ فعال |
| 4 | `206.123.156.215` | `5067` | 146.99ms | ✅ فعال |
| 5 | `38.60.162.195` | `1080` | 19.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.220.246.43` | `6327` | 129.83ms | ✅ فعال |
| 2 | `74.119.147.209` | `4145` | 85.69ms | ✅ فعال |
| 3 | `8.213.195.191` | `10000` | 203.55ms | ✅ فعال |
| 4 | `172.120.112.176` | `5855` | 19.92ms | ✅ فعال |
| 5 | `101.255.166.134` | `80` | 195.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 197.46ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 169.03ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 50.42ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 2217.33ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 193.04ms | ✅ فعال |
