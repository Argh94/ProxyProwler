...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:54 02-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.76.144.139` | `59394` | 209.57ms | ✅ فعال |
| 2 | `45.43.81.60` | `5707` | 80.00ms | ✅ فعال |
| 3 | `192.252.208.70` | `14282` | 70.29ms | ✅ فعال |
| 4 | `147.15.17.132` | `1088` | 119.23ms | ✅ فعال |
| 5 | `174.75.211.193` | `4145` | 84.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `113.166.93.239` | `5678` | 236.47ms | ✅ فعال |
| 2 | `85.198.81.83` | `3128` | 137.99ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 114.90ms | ✅ فعال |
| 4 | `98.175.31.195` | `4145` | 85.66ms | ✅ فعال |
| 5 | `37.26.86.206` | `4145` | 120.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 245.49ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 6.52ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 6.88ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 239.02ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 243.99ms | ✅ فعال |
