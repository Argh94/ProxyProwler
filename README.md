...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:16 01-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.233` | `7529` | 139.00ms | ✅ فعال |
| 2 | `206.123.156.219` | `10821` | 126.60ms | ✅ فعال |
| 3 | `206.123.156.188` | `9661` | 159.17ms | ✅ فعال |
| 4 | `31.211.142.115` | `8192` | 159.10ms | ✅ فعال |
| 5 | `89.124.79.162` | `1080` | 131.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.105.122.198` | `6771` | 124.88ms | ✅ فعال |
| 2 | `23.175.248.21` | `1080` | 48.77ms | ✅ فعال |
| 3 | `202.162.219.12` | `1080` | 205.51ms | ✅ فعال |
| 4 | `91.223.52.141` | `5678` | 156.31ms | ✅ فعال |
| 5 | `45.61.121.167` | `6766` | 18.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 56.31ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 167.27ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 52.94ms | ✅ فعال |
