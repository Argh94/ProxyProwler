...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:24 06-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.217` | `4725` | 162.73ms | ✅ فعال |
| 2 | `206.123.156.211` | `18262` | 145.28ms | ✅ فعال |
| 3 | `58.19.55.7` | `15002` | 203.22ms | ✅ فعال |
| 4 | `58.19.55.7` | `15039` | 206.17ms | ✅ فعال |
| 5 | `94.130.90.236` | `40479` | 1179.86ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (16 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.72.244.27` | `7777` | 249.61ms | ✅ فعال |
| 2 | `46.29.116.3` | `4145` | 185.08ms | ✅ فعال |
| 3 | `104.165.66.125` | `7280` | 27.17ms | ✅ فعال |
| 4 | `185.162.230.255` | `80` | 17.89ms | ✅ فعال |
| 5 | `45.39.115.4` | `5415` | 18.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 161.01ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 132.12ms | ✅ فعال |
| 3 | `13.127.170.8` | `3128` | 238.77ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 139.55ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 182.54ms | ✅ فعال |
