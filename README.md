...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:10 15-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.237.73.24` | `80` | 197.18ms | ✅ فعال |
| 2 | `164.92.179.1` | `1080` | 118.35ms | ✅ فعال |
| 3 | `164.90.237.11` | `1094` | 122.20ms | ✅ فعال |
| 4 | `72.52.131.65` | `80` | 28.74ms | ✅ فعال |
| 5 | `185.135.69.34` | `80` | 188.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.47.197.210` | `3128` | 131.31ms | ✅ فعال |
| 2 | `82.204.198.28` | `1080` | 203.18ms | ✅ فعال |
| 3 | `199.102.106.94` | `4145` | 60.62ms | ✅ فعال |
| 4 | `97.213.76.123` | `80` | 2139.65ms | ✅ فعال |
| 5 | `72.52.131.65` | `80` | 29.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 154.07ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 131.21ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 203.30ms | ✅ فعال |
