...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:20 10-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.211` | `11083` | 152.37ms | ✅ فعال |
| 2 | `47.238.79.105` | `1080` | 168.80ms | ✅ فعال |
| 3 | `157.245.130.30` | `20813` | 154.41ms | ✅ فعال |
| 4 | `12.50.107.222` | `80` | 53.36ms | ✅ فعال |
| 5 | `37.59.249.78` | `1080` | 127.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.26.86.206` | `4145` | 166.40ms | ✅ فعال |
| 2 | `203.95.196.148` | `8080` | 219.76ms | ✅ فعال |
| 3 | `103.118.17.250` | `60000` | 227.96ms | ✅ فعال |
| 4 | `37.187.109.70` | `10111` | 2185.50ms | ✅ فعال |
| 5 | `47.176.213.210` | `39593` | 2072.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 160.27ms | ✅ فعال |
| 2 | `144.91.81.25` | `3128` | 1130.05ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 182.43ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 139.23ms | ✅ فعال |
| 5 | `103.154.146.58` | `8080` | 205.22ms | ✅ فعال |
