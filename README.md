...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 29-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `69.84.182.190` | `80` | 2.00ms | ✅ فعال |
| 2 | `104.27.80.177` | `80` | 1.92ms | ✅ فعال |
| 3 | `8.213.128.6` | `8009` | 567.08ms | ✅ فعال |
| 4 | `104.24.209.179` | `80` | 2.14ms | ✅ فعال |
| 5 | `89.116.250.103` | `80` | 2.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.237` | `1234` | 223.67ms | ✅ فعال |
| 2 | `97.105.12.186` | `4153` | 56.05ms | ✅ فعال |
| 3 | `45.12.31.66` | `80` | 3.46ms | ✅ فعال |
| 4 | `89.31.143.12` | `80` | 166.68ms | ✅ فعال |
| 5 | `107.174.194.173` | `5615` | 42.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.106.99` | `80` | 3.97ms | ✅ فعال |
| 2 | `45.85.118.80` | `80` | 2.06ms | ✅ فعال |
| 3 | `195.245.221.183` | `80` | 2.05ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 115.13ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 169.60ms | ✅ فعال |
