...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:32 27-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.81.119` | `5766` | 109.91ms | ✅ فعال |
| 2 | `8.211.49.86` | `7777` | 118.03ms | ✅ فعال |
| 3 | `47.252.18.37` | `13` | 29.70ms | ✅ فعال |
| 4 | `194.87.83.113` | `3128` | 116.04ms | ✅ فعال |
| 5 | `192.252.211.197` | `14921` | 93.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.73.54` | `8834` | 39.52ms | ✅ فعال |
| 2 | `47.89.159.212` | `11` | 30.42ms | ✅ فعال |
| 3 | `12.50.107.219` | `80` | 46.92ms | ✅ فعال |
| 4 | `190.2.104.201` | `4153` | 216.91ms | ✅ فعال |
| 5 | `203.170.146.146` | `4153` | 223.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.162.16.45` | `8080` | 2282.50ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 167.58ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 209.36ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 24.10ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 28.03ms | ✅ فعال |
