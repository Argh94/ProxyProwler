...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 05-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.159` | `80` | 8.81ms | ✅ فعال |
| 2 | `156.225.72.210` | `80` | 8.74ms | ✅ فعال |
| 3 | `45.131.209.16` | `80` | 9.23ms | ✅ فعال |
| 4 | `172.67.182.54` | `80` | 8.84ms | ✅ فعال |
| 5 | `45.12.31.37` | `80` | 8.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.8.94.170` | `4145` | 82.38ms | ✅ فعال |
| 2 | `172.64.154.63` | `80` | 8.92ms | ✅ فعال |
| 3 | `23.236.196.193` | `6283` | 8.92ms | ✅ فعال |
| 4 | `188.114.96.0` | `80` | 9.09ms | ✅ فعال |
| 5 | `47.76.144.139` | `59394` | 158.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 8.84ms | ✅ فعال |
| 2 | `173.245.49.114` | `80` | 9.07ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 566.29ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 8.81ms | ✅ فعال |
| 5 | `104.17.25.3` | `80` | 16.50ms | ✅ فعال |
