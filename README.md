...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 01-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.118.87` | `80` | 8.96ms | ✅ فعال |
| 2 | `172.67.173.86` | `80` | 11.80ms | ✅ فعال |
| 3 | `184.168.47.92` | `80` | 15.06ms | ✅ فعال |
| 4 | `141.193.213.24` | `80` | 11.84ms | ✅ فعال |
| 5 | `23.247.136.254` | `80` | 51.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.199.166.232` | `9077` | 194.64ms | ✅ فعال |
| 2 | `88.216.215.149` | `9095` | 132.64ms | ✅ فعال |
| 3 | `5.75.168.247` | `8064` | 123.46ms | ✅ فعال |
| 4 | `202.162.212.164` | `4153` | 224.95ms | ✅ فعال |
| 5 | `5.199.166.238` | `9077` | 194.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.85.49.118` | `58366` | 162.04ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 130.66ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 26.00ms | ✅ فعال |
| 4 | `78.12.230.52` | `9323` | 41.56ms | ✅ فعال |
| 5 | `43.216.1.13` | `15894` | 201.75ms | ✅ فعال |
