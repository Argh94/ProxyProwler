...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:01 08-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.234` | `10987` | 1198.60ms | ✅ فعال |
| 2 | `103.75.118.84` | `1080` | 109.55ms | ✅ فعال |
| 3 | `91.247.250.215` | `4145` | 171.14ms | ✅ فعال |
| 4 | `83.220.165.109` | `8085` | 174.84ms | ✅ فعال |
| 5 | `72.223.188.92` | `4145` | 137.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.49.86` | `9050` | 135.39ms | ✅ فعال |
| 2 | `138.124.50.251` | `40000` | 144.82ms | ✅ فعال |
| 3 | `203.170.146.146` | `4153` | 1255.94ms | ✅ فعال |
| 4 | `47.250.11.111` | `8085` | 181.83ms | ✅ فعال |
| 5 | `82.132.19.108` | `4153` | 1197.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 54.52ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 1197.69ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 171.01ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 53.81ms | ✅ فعال |
