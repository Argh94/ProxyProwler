...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:51 20-03-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (68 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.151.20.131` | `80` | 256.71ms | ✅ فعال |
| 2 | `206.123.156.225` | `4745` | 101.75ms | ✅ فعال |
| 3 | `141.148.158.143` | `1080` | 65.90ms | ✅ فعال |
| 4 | `64.112.125.154` | `9055` | 111.46ms | ✅ فعال |
| 5 | `41.216.188.132` | `9050` | 119.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.2.239.42` | `4153` | 124.41ms | ✅ فعال |
| 2 | `192.252.210.233` | `4145` | 70.81ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 125.58ms | ✅ فعال |
| 4 | `188.166.249.234` | `3128` | 227.22ms | ✅ فعال |
| 5 | `178.220.148.82` | `10801` | 2195.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.141.62.12` | `5555` | 1090.11ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.80ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 230.86ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 131.88ms | ✅ فعال |
| 5 | `190.7.138.78` | `80` | 86.28ms | ✅ فعال |
