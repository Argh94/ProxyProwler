...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:13 10-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `176.99.134.183` | `8090` | 178.40ms | ✅ فعال |
| 2 | `146.103.3.46` | `7099` | 147.98ms | ✅ فعال |
| 3 | `151.241.234.208` | `8443` | 224.99ms | ✅ فعال |
| 4 | `192.252.214.20` | `15864` | 96.46ms | ✅ فعال |
| 5 | `23.175.248.21` | `1080` | 64.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `124.6.225.124` | `1088` | 213.59ms | ✅ فعال |
| 2 | `133.232.90.156` | `80` | 172.86ms | ✅ فعال |
| 3 | `89.249.195.40` | `6795` | 17.36ms | ✅ فعال |
| 4 | `142.147.245.13` | `5704` | 67.51ms | ✅ فعال |
| 5 | `45.76.104.16` | `1080` | 124.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 169.13ms | ✅ فعال |
| 2 | `165.232.119.106` | `8080` | 152.88ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 178.62ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 65.36ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 61.77ms | ✅ فعال |
