...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 27-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.1.22` | `80` | 9.47ms | ✅ فعال |
| 2 | `8.213.222.247` | `8008` | 467.58ms | ✅ فعال |
| 3 | `198.105.111.154` | `6832` | 134.94ms | ✅ فعال |
| 4 | `46.254.92.99` | `80` | 8.65ms | ✅ فعال |
| 5 | `5.10.244.228` | `80` | 9.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `93.190.143.27` | `11433` | 139.38ms | ✅ فعال |
| 2 | `8.210.31.241` | `1100` | 164.72ms | ✅ فعال |
| 3 | `198.105.111.154` | `6832` | 127.46ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 146.39ms | ✅ فعال |
| 5 | `198.105.122.247` | `6820` | 138.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.108.50` | `9481` | 193.23ms | ✅ فعال |
| 2 | `43.210.30.230` | `371` | 205.12ms | ✅ فعال |
| 3 | `111.48.191.100` | `7890` | 1173.74ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 53.73ms | ✅ فعال |
| 5 | `13.232.2.142` | `39395` | 232.17ms | ✅ فعال |
