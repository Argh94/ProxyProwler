...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 15-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 226.64ms | ✅ فعال |
| 2 | `160.153.1.208` | `80` | 5.77ms | ✅ فعال |
| 3 | `185.193.29.139` | `80` | 5.82ms | ✅ فعال |
| 4 | `185.146.173.167` | `80` | 6.04ms | ✅ فعال |
| 5 | `185.193.28.34` | `80` | 5.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.68.1` | `8081` | 88.69ms | ✅ فعال |
| 2 | `192.252.214.17` | `4145` | 54.62ms | ✅ فعال |
| 3 | `184.178.172.5` | `15303` | 71.74ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 80.97ms | ✅ فعال |
| 5 | `182.160.16.234` | `8020` | 231.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.206.234.160` | `719` | 160.43ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 224.49ms | ✅ فعال |
| 3 | `15.160.151.84` | `9287` | 98.16ms | ✅ فعال |
| 4 | `128.199.114.189` | `9090` | 229.72ms | ✅ فعال |
| 5 | `45.185.160.56` | `999` | 86.90ms | ✅ فعال |
