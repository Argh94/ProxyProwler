...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:37 31-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `27.34.242.98` | `80` | 241.37ms | ✅ فعال |
| 2 | `8.221.138.111` | `8081` | 100.69ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 161.45ms | ✅ فعال |
| 4 | `44.193.20.213` | `443` | 66.91ms | ✅ فعال |
| 5 | `70.34.249.28` | `2001` | 165.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.46.81` | `6606` | 101.41ms | ✅ فعال |
| 2 | `217.25.228.102` | `8888` | 189.28ms | ✅ فعال |
| 3 | `101.255.166.134` | `80` | 175.91ms | ✅ فعال |
| 4 | `8.221.138.111` | `8081` | 100.75ms | ✅ فعال |
| 5 | `39.102.211.64` | `8443` | 190.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 161.50ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 181.40ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 183.06ms | ✅ فعال |
