...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 07-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.52.179` | `80` | 1.71ms | ✅ فعال |
| 2 | `45.12.30.4` | `80` | 4.75ms | ✅ فعال |
| 3 | `8.211.194.78` | `8005` | 618.53ms | ✅ فعال |
| 4 | `171.250.217.188` | `1080` | 215.28ms | ✅ فعال |
| 5 | `45.194.53.225` | `80` | 1.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `122.116.125.115` | `8888` | 138.03ms | ✅ فعال |
| 2 | `8.211.194.78` | `8005` | 847.38ms | ✅ فعال |
| 3 | `171.250.217.188` | `1080` | 186.50ms | ✅ فعال |
| 4 | `34.124.190.108` | `8080` | 184.66ms | ✅ فعال |
| 5 | `45.70.201.64` | `999` | 2174.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 114.95ms | ✅ فعال |
| 2 | `51.95.58.31` | `8080` | 158.51ms | ✅ فعال |
| 3 | `121.165.162.9` | `8561` | 137.75ms | ✅ فعال |
| 4 | `13.115.193.75` | `40243` | 105.61ms | ✅ فعال |
| 5 | `51.44.169.116` | `2526` | 149.85ms | ✅ فعال |
