...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 15-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.112.32` | `80` | 1.89ms | ✅ فعال |
| 2 | `104.16.115.253` | `80` | 1.60ms | ✅ فعال |
| 3 | `147.231.163.133` | `80` | 164.11ms | ✅ فعال |
| 4 | `104.168.118.254` | `6210` | 69.35ms | ✅ فعال |
| 5 | `104.17.167.103` | `80` | 2.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `136.0.184.35` | `6456` | 8.53ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 296.73ms | ✅ فعال |
| 3 | `8.148.22.214` | `8080` | 209.76ms | ✅ فعال |
| 4 | `139.196.151.191` | `8090` | 191.24ms | ✅ فعال |
| 5 | `46.202.224.139` | `5691` | 65.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 180.35ms | ✅ فعال |
| 2 | `201.89.97.222` | `8080` | 181.79ms | ✅ فعال |
| 3 | `13.246.11.197` | `621` | 282.79ms | ✅ فعال |
| 4 | `190.7.138.78` | `80` | 129.16ms | ✅ فعال |
| 5 | `3.110.127.255` | `48200` | 251.72ms | ✅ فعال |
