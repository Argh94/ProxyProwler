...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:35 14-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `43.199.65.214` | `3128` | 206.94ms | ✅ فعال |
| 2 | `12.50.107.222` | `80` | 34.90ms | ✅ فعال |
| 3 | `20.210.39.153` | `8561` | 155.48ms | ✅ فعال |
| 4 | `87.239.31.42` | `80` | 127.21ms | ✅ فعال |
| 5 | `92.119.126.229` | `8118` | 97.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.68.1` | `8081` | 88.89ms | ✅ فعال |
| 2 | `8.209.253.237` | `8499` | 153.07ms | ✅ فعال |
| 3 | `184.181.217.201` | `4145` | 69.97ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 318.30ms | ✅ فعال |
| 5 | `185.32.4.102` | `4153` | 2169.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `158.178.203.189` | `3222` | 2133.66ms | ✅ فعال |
| 2 | `46.29.162.166` | `80` | 162.76ms | ✅ فعال |
| 3 | `35.209.198.222` | `80` | 2069.98ms | ✅ فعال |
| 4 | `62.109.19.5` | `80` | 125.51ms | ✅ فعال |
| 5 | `8.220.149.222` | `80` | 242.70ms | ✅ فعال |
