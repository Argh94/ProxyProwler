...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:45 18-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `46.17.47.48` | `80` | 168.36ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 207.20ms | ✅ فعال |
| 3 | `145.223.46.174` | `5724` | 97.28ms | ✅ فعال |
| 4 | `120.26.52.35` | `3128` | 233.75ms | ✅ فعال |
| 5 | `172.237.73.24` | `80` | 204.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.145` | `3629` | 239.80ms | ✅ فعال |
| 2 | `168.232.213.9` | `4153` | 1192.51ms | ✅ فعال |
| 3 | `20.120.230.128` | `1080` | 55.19ms | ✅ فعال |
| 4 | `120.26.52.35` | `8080` | 229.42ms | ✅ فعال |
| 5 | `38.145.208.244` | `8446` | 47.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 222.70ms | ✅ فعال |
| 2 | `45.70.236.194` | `999` | 98.74ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 1257.26ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 135.51ms | ✅ فعال |
