...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:46 06-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `64.188.77.221` | `1080` | 104.11ms | ✅ فعال |
| 2 | `206.123.156.223` | `4768` | 115.49ms | ✅ فعال |
| 3 | `202.179.83.169` | `51951` | 1254.08ms | ✅ فعال |
| 4 | `176.111.37.5` | `39811` | 115.11ms | ✅ فعال |
| 5 | `206.123.156.219` | `6459` | 1152.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.253.43.144` | `80` | 226.16ms | ✅ فعال |
| 2 | `206.206.118.4` | `6242` | 50.15ms | ✅ فعال |
| 3 | `158.94.208.76` | `9050` | 137.57ms | ✅ فعال |
| 4 | `47.238.134.126` | `8443` | 186.08ms | ✅ فعال |
| 5 | `43.128.68.75` | `1100` | 207.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 16.93ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 140.75ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 17.41ms | ✅ فعال |
| 4 | `138.2.64.185` | `8118` | 205.77ms | ✅ فعال |
| 5 | `92.247.12.136` | `9510` | 2202.02ms | ✅ فعال |
