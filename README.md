...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 01-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.29.151` | `80` | 180.89ms | ✅ فعال |
| 2 | `141.101.123.105` | `80` | 5.84ms | ✅ فعال |
| 3 | `142.111.113.65` | `6426` | 30.56ms | ✅ فعال |
| 4 | `143.92.61.149` | `8082` | 547.44ms | ✅ فعال |
| 5 | `91.200.115.49` | `1080` | 114.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.40.181.220` | `31247` | 300.38ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 2188.79ms | ✅ فعال |
| 3 | `184.178.172.14` | `4145` | 76.55ms | ✅ فعال |
| 4 | `216.26.224.6` | `3129` | 5.21ms | ✅ فعال |
| 5 | `46.188.2.42` | `5678` | 122.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 227.56ms | ✅ فعال |
| 2 | `104.16.0.165` | `80` | 6.15ms | ✅ فعال |
| 3 | `45.85.118.80` | `80` | 6.16ms | ✅ فعال |
| 4 | `45.131.7.159` | `80` | 5.84ms | ✅ فعال |
| 5 | `5.10.246.51` | `80` | 5.69ms | ✅ فعال |
