...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:49 10-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.144.133` | `80` | 2.75ms | ✅ فعال |
| 2 | `45.80.110.203` | `80` | 2.77ms | ✅ فعال |
| 3 | `45.131.7.126` | `80` | 2.58ms | ✅ فعال |
| 4 | `103.65.237.92` | `5678` | 224.76ms | ✅ فعال |
| 5 | `104.17.235.109` | `80` | 1.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.37.216.68` | `4145` | 62.63ms | ✅ فعال |
| 2 | `185.146.173.98` | `80` | 1.99ms | ✅ فعال |
| 3 | `8.221.141.88` | `8443` | 826.90ms | ✅ فعال |
| 4 | `101.200.158.109` | `3128` | 237.80ms | ✅ فعال |
| 5 | `31.207.47.30` | `11141` | 103.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.104.15` | `80` | 2.06ms | ✅ فعال |
| 2 | `23.227.39.55` | `80` | 2.01ms | ✅ فعال |
| 3 | `69.84.182.59` | `80` | 2.74ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 1.95ms | ✅ فعال |
| 5 | `62.72.166.211` | `80` | 2.89ms | ✅ فعال |
