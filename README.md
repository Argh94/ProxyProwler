...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:20 27-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.233` | `9482` | 1145.53ms | ✅ فعال |
| 2 | `8.211.49.86` | `119` | 131.95ms | ✅ فعال |
| 3 | `72.195.34.42` | `4145` | 93.10ms | ✅ فعال |
| 4 | `51.250.86.201` | `2080` | 165.53ms | ✅ فعال |
| 5 | `219.249.37.107` | `8380` | 150.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.111.166.184` | `80` | 35.50ms | ✅ فعال |
| 2 | `177.73.248.26` | `55290` | 152.99ms | ✅ فعال |
| 3 | `74.119.144.60` | `4145` | 82.15ms | ✅ فعال |
| 4 | `8.215.12.103` | `8447` | 196.05ms | ✅ فعال |
| 5 | `146.103.56.60` | `5608` | 127.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 51.31ms | ✅ فعال |
| 2 | `187.251.222.69` | `8080` | 1105.12ms | ✅ فعال |
| 3 | `119.82.242.200` | `8080` | 1214.69ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 125.76ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 162.25ms | ✅ فعال |
