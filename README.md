...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:38 11-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `87.120.187.113` | `1080` | 158.70ms | ✅ فعال |
| 2 | `184.181.178.33` | `4145` | 125.94ms | ✅ فعال |
| 3 | `184.178.172.5` | `15303` | 119.22ms | ✅ فعال |
| 4 | `65.109.87.121` | `28080` | 179.43ms | ✅ فعال |
| 5 | `72.207.109.5` | `4145` | 120.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `85.158.145.47` | `8080` | 142.50ms | ✅ فعال |
| 2 | `198.105.100.134` | `6385` | 134.94ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 2209.55ms | ✅ فعال |
| 4 | `23.236.247.128` | `8160` | 30.79ms | ✅ فعال |
| 5 | `206.206.69.0` | `6264` | 30.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.70.236.194` | `999` | 1159.88ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 180.60ms | ✅ فعال |
| 3 | `119.82.242.200` | `8080` | 186.64ms | ✅ فعال |
| 4 | `170.0.231.254` | `999` | 66.41ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 71.70ms | ✅ فعال |
