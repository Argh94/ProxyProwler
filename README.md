...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 27-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `147.185.161.75` | `80` | 6.24ms | ✅ فعال |
| 2 | `206.238.237.14` | `80` | 6.16ms | ✅ فعال |
| 3 | `104.18.24.9` | `80` | 5.87ms | ✅ فعال |
| 4 | `66.81.247.83` | `80` | 6.07ms | ✅ فعال |
| 5 | `107.181.148.52` | `5912` | 80.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.23.103.19` | `80` | 5.78ms | ✅ فعال |
| 2 | `31.59.33.146` | `6722` | 1135.61ms | ✅ فعال |
| 3 | `185.26.168.17` | `4153` | 156.61ms | ✅ فعال |
| 4 | `134.209.29.120` | `80` | 80.89ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 350.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.230.52` | `52643` | 58.10ms | ✅ فعال |
| 2 | `51.85.49.118` | `31583` | 138.07ms | ✅ فعال |
| 3 | `51.85.49.118` | `58366` | 143.81ms | ✅ فعال |
| 4 | `40.177.211.224` | `509` | 75.57ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 6.46ms | ✅ فعال |
