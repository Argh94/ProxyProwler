...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 30-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.135.139.81` | `6384` | 101.28ms | ✅ فعال |
| 2 | `45.43.70.230` | `6517` | 95.91ms | ✅ فعال |
| 3 | `72.37.217.3` | `4145` | 73.62ms | ✅ فعال |
| 4 | `192.177.87.118` | `5964` | 47.43ms | ✅ فعال |
| 5 | `8.213.134.213` | `9080` | 314.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.36.245` | `8080` | 242.13ms | ✅ فعال |
| 2 | `198.8.94.174` | `39078` | 63.14ms | ✅ فعال |
| 3 | `101.132.222.120` | `80` | 223.68ms | ✅ فعال |
| 4 | `65.111.9.148` | `3129` | 15.19ms | ✅ فعال |
| 5 | `193.106.57.96` | `5678` | 2196.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 17.58ms | ✅ فعال |
| 2 | `45.131.7.142` | `80` | 2.69ms | ✅ فعال |
| 3 | `185.193.28.50` | `80` | 2.39ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 2.36ms | ✅ فعال |
| 5 | `69.84.182.59` | `80` | 2.73ms | ✅ فعال |
