...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 30-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.5.173` | `80` | 5.90ms | ✅ فعال |
| 2 | `65.111.5.103` | `3129` | 5.31ms | ✅ فعال |
| 3 | `45.85.118.30` | `80` | 5.53ms | ✅ فعال |
| 4 | `185.148.107.213` | `80` | 5.82ms | ✅ فعال |
| 5 | `194.36.55.116` | `80` | 5.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 284.51ms | ✅ فعال |
| 2 | `104.16.1.142` | `80` | 6.23ms | ✅ فعال |
| 3 | `47.238.134.126` | `808` | 218.51ms | ✅ فعال |
| 4 | `8.211.200.183` | `1720` | 1842.00ms | ✅ فعال |
| 5 | `209.50.174.39` | `3129` | 6.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.25.3` | `80` | 5.85ms | ✅ فعال |
| 2 | `216.24.57.248` | `80` | 5.90ms | ✅ فعال |
| 3 | `104.24.197.20` | `80` | 6.05ms | ✅ فعال |
| 4 | `45.131.211.217` | `80` | 5.98ms | ✅ فعال |
| 5 | `104.24.85.134` | `80` | 6.14ms | ✅ فعال |
