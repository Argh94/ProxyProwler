...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:38 24-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.195.191` | `9091` | 207.72ms | ✅ فعال |
| 2 | `195.26.230.202` | `8080` | 153.17ms | ✅ فعال |
| 3 | `47.104.27.165` | `8081` | 265.99ms | ✅ فعال |
| 4 | `66.163.118.99` | `10006` | 133.98ms | ✅ فعال |
| 5 | `142.54.226.214` | `4145` | 49.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.129.150` | `4145` | 76.16ms | ✅ فعال |
| 2 | `200.43.231.17` | `4145` | 185.02ms | ✅ فعال |
| 3 | `47.252.18.37` | `999` | 41.65ms | ✅ فعال |
| 4 | `8.211.200.183` | `10002` | 118.52ms | ✅ فعال |
| 5 | `103.94.52.70` | `3128` | 1251.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 162.37ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 186.44ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 182.29ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 124.65ms | ✅ فعال |
| 5 | `51.38.230.146` | `80` | 122.74ms | ✅ فعال |
