...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:16 16-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (63 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.207` | `12403` | 146.20ms | ✅ فعال |
| 2 | `86.21.239.166` | `9050` | 121.00ms | ✅ فعال |
| 3 | `181.119.97.24` | `999` | 110.66ms | ✅ فعال |
| 4 | `184.181.217.210` | `4145` | 112.14ms | ✅ فعال |
| 5 | `206.123.156.213` | `4494` | 1250.38ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (27 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.6.101.98` | `4153` | 1175.39ms | ✅ فعال |
| 2 | `171.248.210.77` | `1080` | 191.30ms | ✅ فعال |
| 3 | `190.119.132.61` | `80` | 225.75ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 157.56ms | ✅ فعال |
| 5 | `212.42.203.227` | `6275` | 35.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 165.58ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 182.04ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 144.43ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 165.26ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 181.93ms | ✅ فعال |
