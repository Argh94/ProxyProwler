...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:23 02-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `171.229.222.190` | `1080` | 329.78ms | ✅ فعال |
| 2 | `206.123.156.222` | `10089` | 130.71ms | ✅ فعال |
| 3 | `42.48.46.223` | `1080` | 254.43ms | ✅ فعال |
| 4 | `138.2.78.251` | `8100` | 226.93ms | ✅ فعال |
| 5 | `27.75.148.210` | `1080` | 229.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.30.250.195` | `5707` | 13.95ms | ✅ فعال |
| 2 | `31.58.18.112` | `6381` | 80.98ms | ✅ فعال |
| 3 | `8.221.139.222` | `8889` | 161.89ms | ✅ فعال |
| 4 | `198.46.202.18` | `5298` | 24.40ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 1311.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 6.89ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 120.74ms | ✅ فعال |
| 3 | `173.212.237.47` | `3128` | 121.45ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 7.14ms | ✅ فعال |
