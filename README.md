...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 06-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.2.60.135` | `80` | 29.52ms | ✅ فعال |
| 2 | `185.162.229.118` | `80` | 1.48ms | ✅ فعال |
| 3 | `23.227.38.254` | `80` | 1.51ms | ✅ فعال |
| 4 | `185.170.166.159` | `80` | 1.46ms | ✅ فعال |
| 5 | `45.159.219.232` | `80` | 2.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.9.81` | `80` | 5.46ms | ✅ فعال |
| 2 | `118.141.251.64` | `80` | 199.86ms | ✅ فعال |
| 3 | `201.148.125.126` | `4153` | 145.54ms | ✅ فعال |
| 4 | `34.122.187.196` | `80` | 11.90ms | ✅ فعال |
| 5 | `213.156.124.3` | `33333` | 2186.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.28` | `80` | 1.94ms | ✅ فعال |
| 2 | `45.131.4.9` | `80` | 1.77ms | ✅ فعال |
| 3 | `104.24.85.134` | `80` | 2.02ms | ✅ فعال |
| 4 | `103.169.142.78` | `80` | 2.27ms | ✅ فعال |
| 5 | `23.227.39.103` | `80` | 1.99ms | ✅ فعال |
