...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:42 04-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.214.20` | `15864` | 59.69ms | ✅ فعال |
| 2 | `47.91.109.17` | `80` | 176.44ms | ✅ فعال |
| 3 | `130.110.103.245` | `3128` | 181.72ms | ✅ فعال |
| 4 | `195.133.65.238` | `10909` | 89.43ms | ✅ فعال |
| 5 | `72.195.101.99` | `4145` | 90.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.176.213.210` | `39593` | 1089.16ms | ✅ فعال |
| 2 | `185.226.207.100` | `5649` | 82.84ms | ✅ فعال |
| 3 | `136.0.126.170` | `5931` | 60.30ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 222.19ms | ✅ فعال |
| 5 | `64.64.118.48` | `6631` | 8.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 158.55ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 116.31ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 198.21ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 240.79ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 221.90ms | ✅ فعال |
