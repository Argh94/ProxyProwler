...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:35 18-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.5.195` | `80` | 2.68ms | ✅ فعال |
| 2 | `104.24.203.65` | `80` | 18.98ms | ✅ فعال |
| 3 | `104.20.60.30` | `80` | 2.90ms | ✅ فعال |
| 4 | `45.131.6.98` | `80` | 3.00ms | ✅ فعال |
| 5 | `104.16.238.49` | `80` | 2.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 588.33ms | ✅ فعال |
| 2 | `47.104.198.111` | `8443` | 230.72ms | ✅ فعال |
| 3 | `1.0.0.4` | `80` | 2.88ms | ✅ فعال |
| 4 | `103.166.39.145` | `3629` | 254.62ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 1608.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 19.01ms | ✅ فعال |
| 2 | `45.8.211.248` | `80` | 2.37ms | ✅ فعال |
| 3 | `185.193.28.50` | `80` | 2.88ms | ✅ فعال |
| 4 | `45.85.118.80` | `80` | 2.17ms | ✅ فعال |
| 5 | `102.177.176.178` | `80` | 2.56ms | ✅ فعال |
