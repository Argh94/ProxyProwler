...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:30 28-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.233` | `6301` | 1174.85ms | ✅ فعال |
| 2 | `206.123.156.177` | `4777` | 178.75ms | ✅ فعال |
| 3 | `195.39.233.14` | `44567` | 1194.61ms | ✅ فعال |
| 4 | `206.123.156.187` | `7561` | 173.65ms | ✅ فعال |
| 5 | `206.123.156.228` | `8030` | 162.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.65.39.7` | `80` | 1227.07ms | ✅ فعال |
| 2 | `182.53.216.73` | `4145` | 205.08ms | ✅ فعال |
| 3 | `143.137.116.72` | `1080` | 2255.24ms | ✅ فعال |
| 4 | `184.178.172.3` | `4145` | 137.49ms | ✅ فعال |
| 5 | `47.252.11.233` | `8080` | 61.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 167.98ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 185.66ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 179.53ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 116.75ms | ✅ فعال |
| 5 | `51.79.71.106` | `8080` | 74.85ms | ✅ فعال |
