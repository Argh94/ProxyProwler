...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 02:51 29-05-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (104 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.245.117.43` | `80` | 225.12ms | ✅ فعال |
| 2 | `154.194.12.37` | `80` | 1.66ms | ✅ فعال |
| 3 | `91.200.115.49` | `1080` | 107.41ms | ✅ فعال |
| 4 | `8.211.195.173` | `8008` | 81.85ms | ✅ فعال |
| 5 | `198.41.196.211` | `80` | 1.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 251.64ms | ✅ فعال |
| 2 | `103.158.252.67` | `80` | 239.72ms | ✅ فعال |
| 3 | `103.249.120.207` | `80` | 190.44ms | ✅ فعال |
| 4 | `101.51.138.138` | `8080` | 274.16ms | ✅ فعال |
| 5 | `199.34.230.94` | `80` | 2.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.7.142` | `80` | 2.06ms | ✅ فعال |
| 2 | `185.162.229.172` | `80` | 1.96ms | ✅ فعال |
| 3 | `62.72.166.211` | `80` | 9.22ms | ✅ فعال |
| 4 | `104.25.1.112` | `80` | 1.61ms | ✅ فعال |
| 5 | `45.12.31.28` | `80` | 1.95ms | ✅ فعال |
