...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:51 17-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `195.245.221.149` | `80` | 7.15ms | ✅ فعال |
| 2 | `191.96.117.79` | `6834` | 57.01ms | ✅ فعال |
| 3 | `47.74.63.50` | `1011` | 159.84ms | ✅ فعال |
| 4 | `104.17.169.228` | `80` | 6.52ms | ✅ فعال |
| 5 | `172.64.149.68` | `80` | 6.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.49.222` | `7302` | 282.09ms | ✅ فعال |
| 2 | `101.200.158.109` | `8880` | 261.03ms | ✅ فعال |
| 3 | `47.79.94.78` | `1122` | 161.92ms | ✅ فعال |
| 4 | `204.69.207.29` | `80` | 5.91ms | ✅ فعال |
| 5 | `191.96.117.79` | `6834` | 55.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.245.221.183` | `80` | 8.91ms | ✅ فعال |
| 2 | `172.66.40.96` | `80` | 6.13ms | ✅ فعال |
| 3 | `45.131.7.142` | `80` | 5.93ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 5.90ms | ✅ فعال |
| 5 | `185.148.104.15` | `80` | 5.69ms | ✅ فعال |
