...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:52 06-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `169.40.32.118` | `9082` | 122.63ms | ✅ فعال |
| 2 | `151.232.18.66` | `5678` | 201.46ms | ✅ فعال |
| 3 | `8.220.204.215` | `9080` | 156.55ms | ✅ فعال |
| 4 | `116.203.19.71` | `9082` | 121.21ms | ✅ فعال |
| 5 | `184.181.217.220` | `4145` | 80.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.215.187` | `8443` | 256.08ms | ✅ فعال |
| 2 | `200.108.50.254` | `4145` | 135.40ms | ✅ فعال |
| 3 | `206.206.118.193` | `6431` | 47.14ms | ✅ فعال |
| 4 | `41.216.232.213` | `4153` | 217.97ms | ✅ فعال |
| 5 | `143.137.116.72` | `1080` | 1167.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 217.42ms | ✅ فعال |
| 2 | `154.73.28.49` | `8080` | 129.60ms | ✅ فعال |
| 3 | `103.176.96.134` | `8082` | 211.10ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 209.28ms | ✅ فعال |
| 5 | `185.196.182.22` | `8080` | 143.39ms | ✅ فعال |
