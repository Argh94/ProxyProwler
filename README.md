...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:00 09-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.3.91` | `7144` | 104.75ms | ✅ فعال |
| 2 | `43.160.255.142` | `7890` | 1235.47ms | ✅ فعال |
| 3 | `185.226.207.93` | `5642` | 101.74ms | ✅ فعال |
| 4 | `192.252.209.155` | `14455` | 65.17ms | ✅ فعال |
| 5 | `77.110.102.252` | `1080` | 113.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.3.91` | `7144` | 105.47ms | ✅ فعال |
| 2 | `187.44.211.118` | `4153` | 169.51ms | ✅ فعال |
| 3 | `185.32.4.102` | `4153` | 2166.03ms | ✅ فعال |
| 4 | `104.154.186.48` | `80` | 13.09ms | ✅ فعال |
| 5 | `92.255.190.64` | `4153` | 164.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 16.83ms | ✅ فعال |
| 2 | `180.211.161.110` | `8080` | 1272.94ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 133.25ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 16.58ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 227.85ms | ✅ فعال |
