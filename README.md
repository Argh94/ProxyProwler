...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:37 26-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.85` | `3129` | 93.08ms | ✅ فعال |
| 2 | `145.220.226.196` | `8080` | 97.43ms | ✅ فعال |
| 3 | `184.181.217.194` | `4145` | 104.24ms | ✅ فعال |
| 4 | `45.131.46.106` | `1080` | 234.26ms | ✅ فعال |
| 5 | `178.216.152.110` | `1629` | 168.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.143.224.37` | `5898` | 91.12ms | ✅ فعال |
| 2 | `209.50.161.211` | `3129` | 5.71ms | ✅ فعال |
| 3 | `185.226.204.40` | `5593` | 100.17ms | ✅ فعال |
| 4 | `147.15.17.132` | `1082` | 1139.87ms | ✅ فعال |
| 5 | `101.36.109.77` | `8118` | 206.40ms | ✅ فعال |
...
| 2 | `195.57.239.25` | `8080` | 120.80ms | ✅ فعال |
| 3 | `114.129.19.139` | `8080` | 1304.23ms | ✅ فعال |
| 4 | `84.52.125.113` | `8082` | 132.69ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 6.47ms | ✅ فعال |
