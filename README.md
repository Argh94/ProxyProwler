...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 22-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.108` | `80` | 5.94ms | ✅ فعال |
| 2 | `104.17.118.23` | `80` | 5.62ms | ✅ فعال |
| 3 | `8.35.211.43` | `80` | 5.97ms | ✅ فعال |
| 4 | `188.165.199.207` | `80` | 85.02ms | ✅ فعال |
| 5 | `173.245.49.235` | `80` | 5.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.11.233` | `6379` | 579.59ms | ✅ فعال |
| 2 | `49.0.199.132` | `19` | 265.06ms | ✅ فعال |
| 3 | `8.210.17.35` | `8082` | 2980.03ms | ✅ فعال |
| 4 | `45.187.76.2` | `3629` | 154.72ms | ✅ فعال |
| 5 | `47.243.50.83` | `81` | 205.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `115.114.77.133` | `9090` | 212.67ms | ✅ فعال |
| 2 | `13.218.86.1` | `57317` | 5.64ms | ✅ فعال |
| 3 | `16.78.93.162` | `382` | 240.55ms | ✅ فعال |
| 4 | `217.174.106.15` | `8118` | 122.84ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 229.88ms | ✅ فعال |
