...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 08-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.208.143` | `80` | 5.74ms | ✅ فعال |
| 2 | `172.67.129.96` | `80` | 5.66ms | ✅ فعال |
| 3 | `39.102.208.149` | `5060` | 281.99ms | ✅ فعال |
| 4 | `104.233.26.17` | `5855` | 36.25ms | ✅ فعال |
| 5 | `103.169.142.8` | `80` | 6.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `149.202.94.235` | `9059` | 86.17ms | ✅ فعال |
| 2 | `184.174.126.248` | `6540` | 55.39ms | ✅ فعال |
| 3 | `8.208.84.236` | `7657` | 112.62ms | ✅ فعال |
| 4 | `159.138.252.45` | `8888` | 270.05ms | ✅ فعال |
| 5 | `45.56.71.129` | `1081` | 33.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.14.16` | `28080` | 223.59ms | ✅ فعال |
| 2 | `13.212.81.49` | `957` | 224.06ms | ✅ فعال |
| 3 | `201.89.97.222` | `8080` | 122.30ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 5.83ms | ✅ فعال |
| 5 | `218.89.134.230` | `3333` | 273.62ms | ✅ فعال |
