...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 04-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `162.220.246.239` | `6523` | 135.31ms | ✅ فعال |
| 2 | `104.16.204.128` | `80` | 1.69ms | ✅ فعال |
| 3 | `164.38.155.27` | `80` | 1.43ms | ✅ فعال |
| 4 | `104.27.19.155` | `80` | 2.05ms | ✅ فعال |
| 5 | `45.12.30.147` | `80` | 1.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `159.138.252.45` | `8888` | 207.11ms | ✅ فعال |
| 2 | `5.199.173.4` | `9079` | 166.91ms | ✅ فعال |
| 3 | `5.199.166.235` | `9070` | 166.87ms | ✅ فعال |
| 4 | `116.105.24.222` | `9176` | 231.85ms | ✅ فعال |
| 5 | `45.61.122.103` | `6395` | 46.64ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (40 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.249.123` | `46432` | 59.98ms | ✅ فعال |
| 2 | `158.178.214.173` | `3235` | 142.39ms | ✅ فعال |
| 3 | `78.13.74.125` | `16427` | 58.15ms | ✅ فعال |
| 4 | `78.12.230.52` | `32014` | 58.53ms | ✅ فعال |
| 5 | `43.217.141.124` | `8410` | 173.68ms | ✅ فعال |
