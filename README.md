...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:09 15-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.172.116.241` | `5697` | 19.86ms | ✅ فعال |
| 2 | `153.0.171.163` | `8085` | 259.41ms | ✅ فعال |
| 3 | `209.50.173.73` | `3129` | 2.20ms | ✅ فعال |
| 4 | `34.44.49.215` | `80` | 26.76ms | ✅ فعال |
| 5 | `212.95.32.85` | `3128` | 91.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 229.66ms | ✅ فعال |
| 2 | `188.165.199.207` | `80` | 91.04ms | ✅ فعال |
| 3 | `194.163.160.97` | `10808` | 145.85ms | ✅ فعال |
| 4 | `46.249.100.124` | `80` | 95.94ms | ✅ فعال |
| 5 | `145.223.44.119` | `5802` | 34.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.96.28.58` | `80` | 134.27ms | ✅ فعال |
| 2 | `51.79.135.131` | `8080` | 228.53ms | ✅ فعال |
| 3 | `35.209.198.222` | `80` | 1082.94ms | ✅ فعال |
| 4 | `23.88.88.102` | `80` | 96.33ms | ✅ فعال |
| 5 | `47.76.144.139` | `3128` | 249.17ms | ✅ فعال |
