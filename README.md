...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:20 11-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `161.123.101.149` | `6775` | 28.86ms | ✅ فعال |
| 2 | `47.91.65.23` | `3128` | 120.36ms | ✅ فعال |
| 3 | `74.119.147.209` | `4145` | 68.35ms | ✅ فعال |
| 4 | `101.200.158.109` | `9200` | 229.93ms | ✅ فعال |
| 5 | `140.238.9.210` | `8080` | 162.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `123.57.1.16` | `5555` | 233.92ms | ✅ فعال |
| 2 | `66.42.224.229` | `41679` | 207.80ms | ✅ فعال |
| 3 | `37.27.100.102` | `443` | 142.62ms | ✅ فعال |
| 4 | `192.111.135.17` | `18302` | 70.41ms | ✅ فعال |
| 5 | `199.102.105.242` | `4145` | 83.46ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (16 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.210.113.32` | `8123` | 139.69ms | ✅ فعال |
| 2 | `31.40.204.250` | `80` | 407.16ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 198.18ms | ✅ فعال |
| 4 | `23.95.242.79` | `3128` | 22.83ms | ✅ فعال |
| 5 | `41.191.203.160` | `80` | 253.44ms | ✅ فعال |
