...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 27-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.41.207.58` | `80` | 1.89ms | ✅ فعال |
| 2 | `148.135.151.18` | `5511` | 49.02ms | ✅ فعال |
| 3 | `45.131.6.182` | `80` | 2.84ms | ✅ فعال |
| 4 | `31.211.142.115` | `8192` | 140.92ms | ✅ فعال |
| 5 | `185.148.106.168` | `80` | 2.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 269.94ms | ✅ فعال |
| 2 | `98.170.57.241` | `4145` | 111.65ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 140.79ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 242.12ms | ✅ فعال |
| 5 | `8.138.133.207` | `8008` | 230.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 1121.21ms | ✅ فعال |
| 2 | `15.160.125.231` | `97` | 109.90ms | ✅ فعال |
| 3 | `47.252.29.28` | `11222` | 18.86ms | ✅ فعال |
| 4 | `41.65.55.10` | `1981` | 163.82ms | ✅ فعال |
| 5 | `13.218.86.1` | `8323` | 27.19ms | ✅ فعال |
