...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:18 08-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.78` | `31433` | 87.47ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 226.60ms | ✅ فعال |
| 3 | `154.6.11.218` | `5687` | 12.51ms | ✅ فعال |
| 4 | `8.213.151.128` | `3128` | 187.30ms | ✅ فعال |
| 5 | `66.235.200.140` | `80` | 6.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.51.243.173` | `5678` | 80.73ms | ✅ فعال |
| 2 | `185.226.207.105` | `5654` | 84.18ms | ✅ فعال |
| 3 | `45.3.37.116` | `3129` | 5.36ms | ✅ فعال |
| 4 | `47.113.219.226` | `59394` | 268.81ms | ✅ فعال |
| 5 | `8.211.194.78` | `31433` | 88.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 251.64ms | ✅ فعال |
| 2 | `18.143.173.102` | `162` | 223.41ms | ✅ فعال |
| 3 | `190.12.150.244` | `999` | 83.09ms | ✅ فعال |
| 4 | `3.35.25.117` | `216` | 193.88ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 5.63ms | ✅ فعال |
