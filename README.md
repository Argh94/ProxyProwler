...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:34 02-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.215.2` | `4145` | 106.89ms | ✅ فعال |
| 2 | `47.236.177.236` | `1080` | 167.82ms | ✅ فعال |
| 3 | `178.250.156.112` | `443` | 181.35ms | ✅ فعال |
| 4 | `147.45.60.252` | `1081` | 60.57ms | ✅ فعال |
| 5 | `145.220.226.167` | `8080` | 1173.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.13.239.4` | `5678` | 1230.79ms | ✅ فعال |
| 2 | `103.18.47.79` | `4145` | 1197.49ms | ✅ فعال |
| 3 | `129.205.244.185` | `5678` | 283.21ms | ✅ فعال |
| 4 | `82.22.235.87` | `6893` | 70.11ms | ✅ فعال |
| 5 | `218.252.192.228` | `80` | 147.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 186.95ms | ✅ فعال |
| 2 | `36.88.170.170` | `8080` | 1215.57ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 68.34ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 183.28ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 72.80ms | ✅ فعال |
