...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:52 22-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `145.220.226.229` | `8080` | 134.36ms | ✅ فعال |
| 2 | `184.182.240.211` | `4145` | 112.66ms | ✅ فعال |
| 3 | `206.123.156.233` | `5277` | 139.82ms | ✅ فعال |
| 4 | `145.220.226.219` | `8080` | 143.33ms | ✅ فعال |
| 5 | `206.123.156.203` | `5919` | 137.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.200.177.138` | `445` | 1147.88ms | ✅ فعال |
| 2 | `47.74.46.81` | `1000` | 110.08ms | ✅ فعال |
| 3 | `89.185.80.251` | `1081` | 1024.32ms | ✅ فعال |
| 4 | `197.221.249.197` | `80` | 290.95ms | ✅ فعال |
| 5 | `109.194.34.246` | `8082` | 217.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 145.63ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 60.46ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 196.24ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 172.49ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 54.67ms | ✅ فعال |
