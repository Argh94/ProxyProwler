...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:44 25-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `168.144.41.8` | `1080` | 223.52ms | ✅ فعال |
| 2 | `47.83.116.184` | `50161` | 204.60ms | ✅ فعال |
| 3 | `8.216.32.38` | `1080` | 158.63ms | ✅ فعال |
| 4 | `206.123.156.222` | `13637` | 2159.57ms | ✅ فعال |
| 5 | `8.213.215.187` | `10000` | 252.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.13` | `15311` | 91.93ms | ✅ فعال |
| 2 | `47.238.60.156` | `3129` | 215.53ms | ✅ فعال |
| 3 | `193.122.105.251` | `65535` | 200.86ms | ✅ فعال |
| 4 | `52.34.243.150` | `8080` | 83.48ms | ✅ فعال |
| 5 | `88.99.82.67` | `443` | 94.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 156.97ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.75ms | ✅ فعال |
| 3 | `79.121.102.227` | `8080` | 106.75ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 115.72ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 226.93ms | ✅ فعال |
