...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:55 17-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `188.131.155.235` | `1088` | 287.55ms | ✅ فعال |
| 2 | `68.71.247.130` | `4145` | 80.95ms | ✅ فعال |
| 3 | `95.85.233.144` | `18443` | 98.40ms | ✅ فعال |
| 4 | `185.185.80.58` | `1088` | 182.00ms | ✅ فعال |
| 5 | `45.95.232.35` | `1080` | 1256.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.6.129.139` | `5609` | 8.43ms | ✅ فعال |
| 2 | `124.6.225.124` | `1088` | 244.10ms | ✅ فعال |
| 3 | `103.171.92.242` | `9050` | 238.56ms | ✅ فعال |
| 4 | `192.9.171.168` | `1080` | 206.16ms | ✅ فعال |
| 5 | `185.226.204.67` | `5620` | 82.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.79.207.21` | `8080` | 224.76ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 1099.84ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 115.37ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 3.26ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 2.89ms | ✅ فعال |
