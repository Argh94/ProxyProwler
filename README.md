...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 08-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.197.72` | `80` | 1.97ms | ✅ فعال |
| 2 | `173.245.59.108` | `80` | 1.97ms | ✅ فعال |
| 3 | `172.64.88.217` | `80` | 10.72ms | ✅ فعال |
| 4 | `104.21.28.55` | `80` | 10.21ms | ✅ فعال |
| 5 | `38.153.156.51` | `9734` | 79.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.179.151.165` | `31948` | 223.14ms | ✅ فعال |
| 2 | `8.213.134.213` | `1111` | 130.23ms | ✅ فعال |
| 3 | `184.178.172.11` | `4145` | 135.02ms | ✅ فعال |
| 4 | `220.247.163.185` | `1080` | 1253.45ms | ✅ فعال |
| 5 | `161.123.5.245` | `5294` | 60.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.66.40.96` | `80` | 10.96ms | ✅ فعال |
| 2 | `173.245.49.93` | `80` | 1.72ms | ✅ فعال |
| 3 | `89.116.250.4` | `80` | 1.82ms | ✅ فعال |
| 4 | `104.25.1.112` | `80` | 10.76ms | ✅ فعال |
| 5 | `45.12.31.28` | `80` | 2.01ms | ✅ فعال |
