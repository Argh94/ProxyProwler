...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:14 19-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.70` | `14282` | 67.97ms | ✅ فعال |
| 2 | `5.161.155.252` | `80` | 15.70ms | ✅ فعال |
| 3 | `47.89.184.18` | `3128` | 17.94ms | ✅ فعال |
| 4 | `8.220.204.92` | `8081` | 166.61ms | ✅ فعال |
| 5 | `176.61.151.123` | `80` | 1197.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.161.81` | `4145` | 81.28ms | ✅ فعال |
| 2 | `103.125.31.222` | `80` | 248.84ms | ✅ فعال |
| 3 | `88.216.63.158` | `9133` | 103.48ms | ✅ فعال |
| 4 | `47.74.46.81` | `18080` | 143.28ms | ✅ فعال |
| 5 | `47.99.112.148` | `9098` | 222.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.225.22.61` | `80` | 11.83ms | ✅ فعال |
| 2 | `38.60.196.214` | `80` | 147.94ms | ✅ فعال |
| 3 | `45.136.130.223` | `8443` | 48.02ms | ✅ فعال |
| 4 | `46.249.100.124` | `80` | 114.32ms | ✅ فعال |
| 5 | `46.250.251.246` | `80` | 189.85ms | ✅ فعال |
