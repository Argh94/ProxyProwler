...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 08-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `175.214.151.119` | `80` | 199.36ms | ✅ فعال |
| 2 | `37.110.147.13` | `80` | 130.06ms | ✅ فعال |
| 3 | `203.30.191.218` | `80` | 6.14ms | ✅ فعال |
| 4 | `185.162.231.32` | `80` | 5.65ms | ✅ فعال |
| 5 | `45.80.111.143` | `80` | 5.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.120.190` | `8880` | 169.55ms | ✅ فعال |
| 2 | `8.208.84.236` | `7657` | 342.90ms | ✅ فعال |
| 3 | `179.1.209.73` | `5678` | 70.72ms | ✅ فعال |
| 4 | `91.107.154.214` | `80` | 90.87ms | ✅ فعال |
| 5 | `8.211.200.183` | `80` | 84.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.160.134.84` | `8345` | 97.46ms | ✅ فعال |
| 2 | `13.212.181.77` | `138` | 223.27ms | ✅ فعال |
| 3 | `59.153.16.214` | `1120` | 273.90ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 98.75ms | ✅ فعال |
| 5 | `101.47.17.165` | `7890` | 236.11ms | ✅ فعال |
