...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 04-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `156.225.72.153` | `80` | 14.05ms | ✅ فعال |
| 2 | `185.148.105.22` | `80` | 9.23ms | ✅ فعال |
| 3 | `212.183.88.241` | `80` | 15.30ms | ✅ فعال |
| 4 | `154.83.2.176` | `80` | 12.87ms | ✅ فعال |
| 5 | `212.41.8.52` | `12047` | 143.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.24.98` | `3128` | 210.74ms | ✅ فعال |
| 2 | `138.197.208.93` | `8080` | 38.96ms | ✅ فعال |
| 3 | `47.74.46.81` | `45` | 132.66ms | ✅ فعال |
| 4 | `47.251.87.199` | `4145` | 39.45ms | ✅ فعال |
| 5 | `101.51.138.138` | `8080` | 236.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 225.56ms | ✅ فعال |
| 2 | `216.24.57.248` | `80` | 12.30ms | ✅ فعال |
| 3 | `89.116.250.4` | `80` | 14.38ms | ✅ فعال |
| 4 | `104.17.106.99` | `80` | 14.31ms | ✅ فعال |
| 5 | `104.25.1.112` | `80` | 14.34ms | ✅ فعال |
