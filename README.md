...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 24-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.72` | `80` | 1.72ms | ✅ فعال |
| 2 | `172.67.166.1` | `80` | 1.63ms | ✅ فعال |
| 3 | `45.131.211.161` | `80` | 1.77ms | ✅ فعال |
| 4 | `31.43.179.8` | `80` | 1.68ms | ✅ فعال |
| 5 | `172.67.98.86` | `80` | 1.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.124.21` | `6666` | 158.14ms | ✅ فعال |
| 2 | `37.18.73.60` | `5566` | 183.66ms | ✅ فعال |
| 3 | `49.0.246.130` | `6789` | 159.52ms | ✅ فعال |
| 4 | `46.8.60.34` | `1080` | 212.51ms | ✅ فعال |
| 5 | `104.233.49.107` | `3199` | 66.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.192.14.136` | `9292` | 213.34ms | ✅ فعال |
| 2 | `116.80.62.226` | `3172` | 2165.44ms | ✅ فعال |
| 3 | `13.114.9.221` | `712` | 105.78ms | ✅ فعال |
| 4 | `36.110.143.55` | `8080` | 208.89ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 68.75ms | ✅ فعال |
