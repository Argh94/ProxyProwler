...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 16-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.171.106.111` | `3000` | 196.12ms | ✅ فعال |
| 2 | `8.213.151.128` | `3128` | 131.72ms | ✅ فعال |
| 3 | `199.102.107.145` | `4145` | 22.68ms | ✅ فعال |
| 4 | `120.92.212.16` | `8890` | 220.93ms | ✅ فعال |
| 5 | `193.43.159.200` | `80` | 189.33ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (52 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `1080` | 163.69ms | ✅ فعال |
| 2 | `8.213.151.128` | `3128` | 131.70ms | ✅ فعال |
| 3 | `119.148.4.10` | `22122` | 2258.99ms | ✅ فعال |
| 4 | `95.43.244.15` | `4153` | 178.94ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 202.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 111.25ms | ✅ فعال |
| 2 | `179.96.28.58` | `80` | 198.14ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 134.50ms | ✅ فعال |
| 4 | `179.255.219.182` | `8080` | 213.57ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 181.31ms | ✅ فعال |
