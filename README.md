...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:29 27-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.212.246.157` | `3128` | 317.45ms | ✅ فعال |
| 2 | `45.167.124.52` | `8080` | 95.39ms | ✅ فعال |
| 3 | `139.59.103.183` | `80` | 176.13ms | ✅ فعال |
| 4 | `8.211.195.173` | `9797` | 129.44ms | ✅ فعال |
| 5 | `98.170.57.231` | `4145` | 2280.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.105.122.72` | `80` | 206.73ms | ✅ فعال |
| 2 | `8.210.17.35` | `100` | 759.72ms | ✅ فعال |
| 3 | `8.210.17.35` | `3128` | 756.26ms | ✅ فعال |
| 4 | `38.34.179.179` | `8443` | 1026.06ms | ✅ فعال |
| 5 | `46.29.162.166` | `80` | 214.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.124.97.12` | `8080` | 1308.40ms | ✅ فعال |
| 2 | `179.96.28.58` | `80` | 179.10ms | ✅ فعال |
| 3 | `94.23.19.184` | `2912` | 141.32ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 177.10ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 177.59ms | ✅ فعال |
