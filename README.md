...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 09-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.124.112` | `80` | 1.76ms | ✅ فعال |
| 2 | `103.160.204.98` | `80` | 1.85ms | ✅ فعال |
| 3 | `142.54.235.9` | `4145` | 22.35ms | ✅ فعال |
| 4 | `45.67.215.169` | `80` | 1.81ms | ✅ فعال |
| 5 | `138.197.68.35` | `4857` | 80.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.20.227.66` | `4145` | 1214.07ms | ✅ فعال |
| 2 | `104.238.38.122` | `6390` | 41.53ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 219.78ms | ✅ فعال |
| 4 | `149.12.110.109` | `5678` | 174.79ms | ✅ فعال |
| 5 | `162.238.123.152` | `1080` | 4.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.139` | `80` | 1.82ms | ✅ فعال |
| 2 | `172.67.88.21` | `80` | 19.68ms | ✅ فعال |
| 3 | `45.12.31.28` | `80` | 1.70ms | ✅ فعال |
| 4 | `5.10.246.51` | `80` | 2.13ms | ✅ فعال |
| 5 | `45.131.4.9` | `80` | 1.79ms | ✅ فعال |
