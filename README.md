...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:55 06-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 169.07ms | ✅ فعال |
| 2 | `66.42.224.229` | `41679` | 1619.08ms | ✅ فعال |
| 3 | `160.153.0.107` | `80` | 1.94ms | ✅ فعال |
| 4 | `170.114.45.246` | `80` | 2.11ms | ✅ فعال |
| 5 | `104.16.106.101` | `80` | 1.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `68.71.247.130` | `4145` | 52.38ms | ✅ فعال |
| 2 | `185.148.107.169` | `80` | 1.87ms | ✅ فعال |
| 3 | `90.188.56.158` | `4153` | 247.12ms | ✅ فعال |
| 4 | `51.254.32.143` | `80` | 172.84ms | ✅ فعال |
| 5 | `206.238.237.190` | `80` | 1.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.198.248.18` | `54277` | 157.90ms | ✅ فعال |
| 2 | `15.160.125.231` | `10019` | 236.22ms | ✅ فعال |
| 3 | `18.188.141.177` | `1145` | 59.11ms | ✅ فعال |
| 4 | `52.47.164.226` | `41736` | 143.57ms | ✅ فعال |
| 5 | `43.208.25.125` | `3088` | 197.61ms | ✅ فعال |
