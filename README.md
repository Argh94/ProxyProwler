...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:47 19-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `18.188.141.177` | `28080` | 21.86ms | ✅ فعال |
| 2 | `62.171.159.232` | `8888` | 160.01ms | ✅ فعال |
| 3 | `172.67.177.7` | `80` | 5.61ms | ✅ فعال |
| 4 | `43.135.36.240` | `80` | 210.69ms | ✅ فعال |
| 5 | `91.193.58.244` | `80` | 5.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.58.12.68` | `8073` | 13.11ms | ✅ فعال |
| 2 | `46.249.100.124` | `80` | 98.95ms | ✅ فعال |
| 3 | `1.0.0.4` | `80` | 6.32ms | ✅ فعال |
| 4 | `101.51.138.138` | `8080` | 256.78ms | ✅ فعال |
| 5 | `31.59.20.237` | `6815` | 81.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.8.211.248` | `80` | 6.03ms | ✅ فعال |
| 2 | `104.17.26.109` | `80` | 5.82ms | ✅ فعال |
| 3 | `185.193.28.50` | `80` | 5.63ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 5.83ms | ✅ فعال |
| 5 | `5.10.247.49` | `80` | 6.60ms | ✅ فعال |
