...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 24-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.205.0.67` | `4145` | 108.81ms | ✅ فعال |
| 2 | `101.36.104.46` | `10808` | 2150.25ms | ✅ فعال |
| 3 | `192.111.138.29` | `4145` | 102.90ms | ✅ فعال |
| 4 | `43.164.3.124` | `1080` | 194.45ms | ✅ فعال |
| 5 | `194.163.174.78` | `1082` | 148.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `92.113.150.45` | `3128` | 151.22ms | ✅ فعال |
| 2 | `45.13.186.134` | `1080` | 1161.00ms | ✅ فعال |
| 3 | `72.195.34.60` | `27391` | 1164.55ms | ✅ فعال |
| 4 | `45.41.176.166` | `6464` | 41.96ms | ✅ فعال |
| 5 | `47.252.18.37` | `8080` | 62.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 1199.15ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 148.99ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 114.96ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 182.07ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 168.67ms | ✅ فعال |
