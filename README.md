...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:04 22-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.36.213` | `20` | 796.68ms | ✅ فعال |
| 2 | `184.168.47.203` | `80` | 2.67ms | ✅ فعال |
| 3 | `104.24.81.221` | `80` | 2.03ms | ✅ فعال |
| 4 | `194.152.44.247` | `80` | 1.92ms | ✅ فعال |
| 5 | `209.135.168.41` | `80` | 31.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.197.89.213` | `80` | 48.37ms | ✅ فعال |
| 2 | `88.216.215.148` | `9090` | 123.20ms | ✅ فعال |
| 3 | `5.199.166.237` | `9107` | 202.57ms | ✅ فعال |
| 4 | `45.43.81.15` | `5662` | 96.69ms | ✅ فعال |
| 5 | `88.216.215.149` | `9090` | 131.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.16.9` | `8808` | 233.23ms | ✅ فعال |
| 2 | `43.208.16.9` | `9378` | 231.24ms | ✅ فعال |
| 3 | `54.90.159.174` | `52929` | 19.05ms | ✅ فعال |
| 4 | `78.12.223.246` | `56163` | 53.68ms | ✅ فعال |
| 5 | `15.236.38.248` | `28049` | 107.47ms | ✅ فعال |
