...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 13-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.11` | `80` | 2.58ms | ✅ فعال |
| 2 | `212.183.88.115` | `80` | 1.62ms | ✅ فعال |
| 3 | `198.41.202.233` | `80` | 411.63ms | ✅ فعال |
| 4 | `45.131.7.50` | `80` | 1.55ms | ✅ فعال |
| 5 | `104.25.1.5` | `80` | 52.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.223.188.67` | `4145` | 147.65ms | ✅ فعال |
| 2 | `49.0.252.39` | `9000` | 158.56ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 262.78ms | ✅ فعال |
| 4 | `107.181.154.16` | `5694` | 145.47ms | ✅ فعال |
| 5 | `139.196.151.191` | `8090` | 190.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.36.243.194` | `9239` | 152.69ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 171.69ms | ✅ فعال |
| 3 | `115.114.77.133` | `9090` | 207.39ms | ✅ فعال |
| 4 | `15.160.148.69` | `49547` | 159.71ms | ✅ فعال |
| 5 | `160.20.55.230` | `8080` | 159.04ms | ✅ فعال |
