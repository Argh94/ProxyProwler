...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 10-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.210.252` | `80` | 2.25ms | ✅ فعال |
| 2 | `172.67.70.115` | `80` | 2.24ms | ✅ فعال |
| 3 | `104.24.189.66` | `80` | 2.25ms | ✅ فعال |
| 4 | `194.152.44.149` | `80` | 2.85ms | ✅ فعال |
| 5 | `8.211.194.78` | `6379` | 660.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.223.188.67` | `4145` | 91.18ms | ✅ فعال |
| 2 | `47.113.219.226` | `59394` | 260.36ms | ✅ فعال |
| 3 | `8.221.141.88` | `9500` | 140.44ms | ✅ فعال |
| 4 | `159.138.252.45` | `8888` | 276.76ms | ✅ فعال |
| 5 | `8.130.54.67` | `80` | 248.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 224.48ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 136.78ms | ✅ فعال |
| 3 | `3.110.127.255` | `48200` | 212.89ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 211.34ms | ✅ فعال |
| 5 | `56.228.5.197` | `26403` | 121.09ms | ✅ فعال |
