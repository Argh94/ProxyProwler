...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:57 16-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.215.110` | `80` | 1.99ms | ✅ فعال |
| 2 | `45.67.215.76` | `80` | 1.91ms | ✅ فعال |
| 3 | `146.103.56.19` | `5567` | 94.04ms | ✅ فعال |
| 4 | `31.43.179.49` | `80` | 2.38ms | ✅ فعال |
| 5 | `188.114.98.232` | `80` | 1.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.0.10.69` | `6245` | 15.39ms | ✅ فعال |
| 2 | `39.102.208.236` | `8090` | 232.05ms | ✅ فعال |
| 3 | `110.238.116.82` | `55443` | 268.46ms | ✅ فعال |
| 4 | `70.166.167.55` | `57745` | 101.24ms | ✅ فعال |
| 5 | `182.160.16.234` | `8020` | 245.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.79.71.106` | `8080` | 19.87ms | ✅ فعال |
| 2 | `51.16.49.113` | `8585` | 301.93ms | ✅ فعال |
| 3 | `13.36.243.194` | `9239` | 102.87ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 207.18ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 16.54ms | ✅ فعال |
