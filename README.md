...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 20:10 31-05-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `161.123.93.150` | `5880` | 79.51ms | ✅ فعال |
| 2 | `199.58.185.9` | `4145` | 99.74ms | ✅ فعال |
| 3 | `45.131.7.219` | `80` | 2.09ms | ✅ فعال |
| 4 | `31.43.179.153` | `80` | 1.67ms | ✅ فعال |
| 5 | `104.27.197.137` | `80` | 141.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.0.162` | `7302` | 212.84ms | ✅ فعال |
| 2 | `72.195.34.35` | `27360` | 125.85ms | ✅ فعال |
| 3 | `167.172.86.46` | `10471` | 169.33ms | ✅ فعال |
| 4 | `147.185.161.180` | `80` | 1.99ms | ✅ فعال |
| 5 | `101.51.138.138` | `8080` | 201.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 140.69ms | ✅ فعال |
| 2 | `45.8.211.248` | `80` | 1.91ms | ✅ فعال |
| 3 | `206.238.236.139` | `80` | 1.82ms | ✅ فعال |
| 4 | `185.162.230.130` | `80` | 2.26ms | ✅ فعال |
| 5 | `104.24.197.20` | `80` | 149.30ms | ✅ فعال |
