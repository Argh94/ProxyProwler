...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:07 17-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.59.70` | `4145` | 75.17ms | ✅ فعال |
| 2 | `166.88.3.214` | `6685` | 65.61ms | ✅ فعال |
| 3 | `141.98.85.49` | `1080` | 110.39ms | ✅ فعال |
| 4 | `81.177.165.209` | `10808` | 143.76ms | ✅ فعال |
| 5 | `192.252.208.70` | `14282` | 60.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.183.226` | `4145` | 56.99ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 110.87ms | ✅ فعال |
| 3 | `20.246.133.88` | `8080` | 7.09ms | ✅ فعال |
| 4 | `138.199.221.100` | `9050` | 93.99ms | ✅ فعال |
| 5 | `192.252.208.70` | `14282` | 60.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 115.12ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 10.49ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 707.80ms | ✅ فعال |
| 4 | `185.196.182.22` | `8080` | 2151.25ms | ✅ فعال |
| 5 | `176.194.189.40` | `80` | 1169.16ms | ✅ فعال |
