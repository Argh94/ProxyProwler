...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 30-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `108.162.193.170` | `80` | 2.03ms | ✅ فعال |
| 2 | `216.205.52.89` | `80` | 2.10ms | ✅ فعال |
| 3 | `185.162.228.255` | `80` | 5.76ms | ✅ فعال |
| 4 | `143.42.66.91` | `80` | 219.80ms | ✅ فعال |
| 5 | `141.101.115.33` | `80` | 2.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.29.116.3` | `4145` | 142.23ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 229.51ms | ✅ فعال |
| 3 | `47.254.153.78` | `5555` | 93.07ms | ✅ فعال |
| 4 | `45.56.71.129` | `1081` | 33.45ms | ✅ فعال |
| 5 | `198.105.100.140` | `6391` | 75.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 1275.68ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 218.51ms | ✅ فعال |
| 3 | `43.208.25.125` | `140` | 244.77ms | ✅ فعال |
| 4 | `123.57.0.163` | `8888` | 274.33ms | ✅ فعال |
| 5 | `43.208.129.50` | `58980` | 245.45ms | ✅ فعال |
