...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:59 11-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.121.182.88` | `8090` | 235.80ms | ✅ فعال |
| 2 | `91.107.179.153` | `9050` | 115.30ms | ✅ فعال |
| 3 | `213.176.113.24` | `50001` | 110.99ms | ✅ فعال |
| 4 | `206.123.156.230` | `5377` | 99.82ms | ✅ فعال |
| 5 | `70.35.196.194` | `8087` | 31.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 255.20ms | ✅ فعال |
| 2 | `47.121.182.88` | `8090` | 239.62ms | ✅ فعال |
| 3 | `190.2.104.201` | `4153` | 165.63ms | ✅ فعال |
| 4 | `156.38.112.11` | `80` | 197.26ms | ✅ فعال |
| 5 | `8.221.138.111` | `80` | 141.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 16.32ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 176.25ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 132.80ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 19.29ms | ✅ فعال |
| 5 | `103.36.11.21` | `8080` | 261.99ms | ✅ فعال |
