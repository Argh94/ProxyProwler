...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 22-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `162.159.242.90` | `80` | 17.70ms | ✅ فعال |
| 2 | `172.67.74.128` | `80` | 17.76ms | ✅ فعال |
| 3 | `199.102.107.145` | `4145` | 45.84ms | ✅ فعال |
| 4 | `45.12.31.87` | `80` | 17.92ms | ✅ فعال |
| 5 | `154.194.12.183` | `80` | 18.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `91.223.52.141` | `5678` | 1200.09ms | ✅ فعال |
| 2 | `8.220.136.174` | `992` | 1963.03ms | ✅ فعال |
| 3 | `106.15.58.163` | `1337` | 202.74ms | ✅ فعال |
| 4 | `120.79.217.196` | `9090` | 248.81ms | ✅ فعال |
| 5 | `8.211.194.78` | `5800` | 122.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.240.77` | `12587` | 213.61ms | ✅ فعال |
| 2 | `13.229.106.200` | `4707` | 187.24ms | ✅ فعال |
| 3 | `51.16.56.189` | `293` | 177.10ms | ✅ فعال |
| 4 | `43.217.158.81` | `47944` | 192.59ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 131.71ms | ✅ فعال |
