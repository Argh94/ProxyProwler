...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:25 23-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.233` | `5365` | 165.02ms | ✅ فعال |
| 2 | `206.123.156.188` | `4636` | 170.48ms | ✅ فعال |
| 3 | `46.62.214.3` | `1080` | 181.79ms | ✅ فعال |
| 4 | `206.123.156.192` | `4308` | 1205.36ms | ✅ فعال |
| 5 | `206.123.156.204` | `10635` | 162.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `9080` | 146.77ms | ✅ فعال |
| 2 | `81.181.104.227` | `80` | 152.82ms | ✅ فعال |
| 3 | `47.116.181.146` | `8090` | 183.44ms | ✅ فعال |
| 4 | `213.197.136.218` | `5678` | 170.63ms | ✅ فعال |
| 5 | `8.213.222.157` | `100` | 192.46ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (2 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 68.53ms | ✅ فعال |
| 2 | `129.154.225.163` | `8100` | 218.83ms | ✅ فعال |
