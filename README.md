...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:53 27-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.182.145.141` | `8118` | 107.65ms | ✅ فعال |
| 2 | `61.118.38.234` | `60808` | 193.07ms | ✅ فعال |
| 3 | `117.7.80.193` | `1093` | 232.75ms | ✅ فعال |
| 4 | `58.186.168.168` | `1049` | 260.25ms | ✅ فعال |
| 5 | `185.135.81.149` | `9060` | 177.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.238.228.143` | `80` | 3.20ms | ✅ فعال |
| 2 | `95.178.108.189` | `5678` | 121.48ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 2177.09ms | ✅ فعال |
| 4 | `91.193.58.1` | `80` | 1.92ms | ✅ فعال |
| 5 | `103.146.170.233` | `5678` | 214.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 221.75ms | ✅ فعال |
| 2 | `103.36.11.21` | `8080` | 2286.15ms | ✅ فعال |
| 3 | `154.73.28.49` | `8080` | 120.38ms | ✅ فعال |
| 4 | `103.147.247.171` | `8080` | 221.56ms | ✅ فعال |
| 5 | `36.64.162.194` | `8080` | 1249.88ms | ✅ فعال |
