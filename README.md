...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 23-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.111.5` | `80` | 5.72ms | ✅ فعال |
| 2 | `212.127.95.235` | `8081` | 98.48ms | ✅ فعال |
| 3 | `104.16.207.149` | `80` | 6.13ms | ✅ فعال |
| 4 | `45.8.211.52` | `80` | 5.88ms | ✅ فعال |
| 5 | `172.67.192.27` | `80` | 6.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `124.6.225.124` | `1088` | 2298.53ms | ✅ فعال |
| 2 | `212.127.95.235` | `8081` | 101.92ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 283.09ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 232.80ms | ✅ فعال |
| 5 | `46.8.60.2` | `1080` | 151.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 225.11ms | ✅ فعال |
| 2 | `3.35.25.117` | `50` | 189.98ms | ✅ فعال |
| 3 | `54.74.104.194` | `9256` | 112.08ms | ✅ فعال |
| 4 | `43.208.16.199` | `40268` | 252.15ms | ✅ فعال |
| 5 | `40.192.100.189` | `357` | 212.25ms | ✅ فعال |
