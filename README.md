...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:13 08-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.238.30.68` | `63744` | 102.13ms | ✅ فعال |
| 2 | `184.178.172.18` | `15280` | 168.86ms | ✅ فعال |
| 3 | `140.238.9.210` | `8080` | 188.16ms | ✅ فعال |
| 4 | `185.135.69.34` | `80` | 180.91ms | ✅ فعال |
| 5 | `160.251.142.232` | `80` | 195.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.134.126` | `18080` | 220.37ms | ✅ فعال |
| 2 | `198.8.94.174` | `39078` | 64.12ms | ✅ فعال |
| 3 | `184.178.172.26` | `4145` | 143.63ms | ✅ فعال |
| 4 | `216.26.250.71` | `3129` | 15.83ms | ✅ فعال |
| 5 | `202.40.180.14` | `1080` | 258.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.225.22.61` | `80` | 25.97ms | ✅ فعال |
| 2 | `46.62.204.83` | `80` | 119.16ms | ✅ فعال |
| 3 | `179.96.28.58` | `80` | 134.82ms | ✅ فعال |
| 4 | `46.17.47.48` | `80` | 138.05ms | ✅ فعال |
| 5 | `41.191.203.162` | `80` | 230.63ms | ✅ فعال |
