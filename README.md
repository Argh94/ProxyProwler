...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:45 28-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.245.148` | `4145` | 71.85ms | ✅ فعال |
| 2 | `206.123.156.187` | `31944` | 122.92ms | ✅ فعال |
| 3 | `94.130.16.48` | `30009` | 934.08ms | ✅ فعال |
| 4 | `136.0.105.82` | `6092` | 24.49ms | ✅ فعال |
| 5 | `117.236.124.166` | `3128` | 270.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.206` | `4145` | 103.79ms | ✅ فعال |
| 2 | `123.200.6.58` | `5678` | 1288.84ms | ✅ فعال |
| 3 | `185.32.4.102` | `4153` | 129.65ms | ✅ فعال |
| 4 | `45.127.248.134` | `5135` | 56.62ms | ✅ فعال |
| 5 | `47.92.152.43` | `9098` | 268.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 232.23ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 228.22ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 126.60ms | ✅ فعال |
| 4 | `186.215.87.194` | `10312` | 153.24ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 142.27ms | ✅ فعال |
