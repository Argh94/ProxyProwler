...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:33 03-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `153.0.171.163` | `8085` | 242.27ms | ✅ فعال |
| 2 | `103.84.95.54` | `7890` | 182.59ms | ✅ فعال |
| 3 | `193.43.159.200` | `80` | 144.63ms | ✅ فعال |
| 4 | `45.3.51.253` | `3129` | 15.90ms | ✅ فعال |
| 5 | `123.30.154.171` | `7777` | 237.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.89.159.212` | `993` | 536.32ms | ✅ فعال |
| 2 | `8.213.215.187` | `80` | 1884.97ms | ✅ فعال |
| 3 | `198.105.100.66` | `6317` | 104.29ms | ✅ فعال |
| 4 | `198.204.249.42` | `17004` | 13.24ms | ✅ فعال |
| 5 | `34.124.190.108` | `8080` | 205.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 209.01ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 140.58ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 1379.04ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 206.06ms | ✅ فعال |
