...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:33 26-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.138.119.88` | `80` | 70.25ms | ✅ فعال |
| 2 | `23.88.88.105` | `443` | 152.51ms | ✅ فعال |
| 3 | `45.88.0.113` | `3128` | 156.12ms | ✅ فعال |
| 4 | `47.251.73.54` | `64` | 23.06ms | ✅ فعال |
| 5 | `45.88.0.99` | `3128` | 161.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `167.250.75.19` | `80` | 183.89ms | ✅ فعال |
| 2 | `192.252.208.70` | `14282` | 95.98ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 1208.42ms | ✅ فعال |
| 4 | `8.211.195.139` | `1080` | 146.25ms | ✅ فعال |
| 5 | `47.99.112.148` | `9098` | 136.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 183.80ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1211.39ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 164.70ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 165.94ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 96.22ms | ✅ فعال |
