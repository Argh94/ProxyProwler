...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:11 09-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.37.251` | `80` | 5.63ms | ✅ فعال |
| 2 | `199.34.230.82` | `80` | 6.12ms | ✅ فعال |
| 3 | `157.245.40.210` | `80` | 87.70ms | ✅ فعال |
| 4 | `104.25.1.196` | `80` | 6.07ms | ✅ فعال |
| 5 | `45.131.211.225` | `80` | 6.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.238` | `80` | 6.03ms | ✅ فعال |
| 2 | `45.43.70.60` | `6347` | 82.98ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 283.98ms | ✅ فعال |
| 4 | `101.132.248.7` | `1337` | 242.78ms | ✅ فعال |
| 5 | `47.251.73.54` | `64` | 75.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.181.77` | `138` | 223.62ms | ✅ فعال |
| 2 | `203.80.138.81` | `50000` | 161.20ms | ✅ فعال |
| 3 | `13.212.14.16` | `8900` | 223.20ms | ✅ فعال |
| 4 | `104.168.10.224` | `8888` | 87.08ms | ✅ فعال |
| 5 | `176.126.103.194` | `44214` | 143.54ms | ✅ فعال |
