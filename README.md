...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:40 17-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `143.255.109.76` | `1080` | 130.53ms | ✅ فعال |
| 2 | `90.182.147.170` | `4145` | 1119.39ms | ✅ فعال |
| 3 | `47.252.47.39` | `1080` | 2.52ms | ✅ فعال |
| 4 | `104.143.224.58` | `5919` | 80.22ms | ✅ فعال |
| 5 | `72.195.114.184` | `4145` | 86.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 182.51ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 240.77ms | ✅ فعال |
| 3 | `8.220.204.92` | `5060` | 203.15ms | ✅ فعال |
| 4 | `8.134.149.133` | `3128` | 246.02ms | ✅ فعال |
| 5 | `190.57.131.158` | `1080` | 1145.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 116.11ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 231.98ms | ✅ فعال |
| 3 | `200.251.41.61` | `8002` | 1176.63ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 158.33ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 243.19ms | ✅ فعال |
