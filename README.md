...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 06-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.46.81` | `50` | 132.80ms | ✅ فعال |
| 2 | `185.193.28.155` | `80` | 11.99ms | ✅ فعال |
| 3 | `154.197.75.125` | `80` | 15.14ms | ✅ فعال |
| 4 | `107.172.163.185` | `6701` | 22.86ms | ✅ فعال |
| 5 | `206.238.237.141` | `80` | 14.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.38.201` | `80` | 14.45ms | ✅ فعال |
| 2 | `109.106.196.250` | `4145` | 156.63ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 240.03ms | ✅ فعال |
| 4 | `107.172.163.185` | `6701` | 45.77ms | ✅ فعال |
| 5 | `8.130.36.163` | `8888` | 254.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.143.173.102` | `162` | 200.26ms | ✅ فعال |
| 2 | `3.38.101.138` | `7010` | 160.45ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 128.35ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 199.82ms | ✅ فعال |
| 5 | `13.115.193.75` | `46264` | 136.00ms | ✅ فعال |
