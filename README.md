...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 01-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.191.145` | `80` | 5.35ms | ✅ فعال |
| 2 | `139.177.229.239` | `8080` | 2.16ms | ✅ فعال |
| 3 | `108.162.195.6` | `80` | 2.31ms | ✅ فعال |
| 4 | `185.162.230.63` | `80` | 2.25ms | ✅ فعال |
| 5 | `172.66.44.135` | `80` | 1.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.177.229.225` | `8080` | 1.86ms | ✅ فعال |
| 2 | `96.126.111.39` | `1081` | 8.00ms | ✅ فعال |
| 3 | `176.226.200.167` | `80` | 146.32ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 258.84ms | ✅ فعال |
| 5 | `47.113.219.226` | `59394` | 266.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.14.16` | `28080` | 218.61ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 247.31ms | ✅ فعال |
| 3 | `18.163.49.218` | `3629` | 208.15ms | ✅ فعال |
| 4 | `18.143.173.102` | `162` | 219.69ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 90.40ms | ✅ فعال |
