...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:14 26-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.229.17` | `80` | 2.22ms | ✅ فعال |
| 2 | `104.16.109.21` | `80` | 1.56ms | ✅ فعال |
| 3 | `185.162.230.98` | `80` | 3.09ms | ✅ فعال |
| 4 | `113.160.188.21` | `1080` | 257.35ms | ✅ فعال |
| 5 | `104.17.21.152` | `80` | 2.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `88.216.215.149` | `9075` | 122.76ms | ✅ فعال |
| 2 | `185.162.229.17` | `80` | 2.19ms | ✅ فعال |
| 3 | `88.216.68.7` | `9098` | 20.16ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 126.04ms | ✅ فعال |
| 5 | `5.199.166.246` | `9119` | 212.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.129.50` | `38464` | 242.37ms | ✅ فعال |
| 2 | `43.208.129.50` | `135` | 243.26ms | ✅ فعال |
| 3 | `40.177.211.224` | `181` | 67.39ms | ✅ فعال |
| 4 | `176.57.189.138` | `3128` | 133.54ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 2151.15ms | ✅ فعال |
