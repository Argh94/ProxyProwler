...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:05 29-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.39.125.104` | `80` | 2.66ms | ✅ فعال |
| 2 | `172.64.152.83` | `80` | 2.63ms | ✅ فعال |
| 3 | `185.148.105.72` | `80` | 2.88ms | ✅ فعال |
| 4 | `45.12.30.42` | `80` | 2.43ms | ✅ فعال |
| 5 | `172.67.70.138` | `80` | 2.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.205.0.93` | `4145` | 76.10ms | ✅ فعال |
| 2 | `88.216.215.142` | `9069` | 108.41ms | ✅ فعال |
| 3 | `45.249.59.176` | `6152` | 62.50ms | ✅ فعال |
| 4 | `5.199.166.244` | `9084` | 225.48ms | ✅ فعال |
| 5 | `104.27.96.132` | `80` | 2.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.82.73` | `34742` | 239.27ms | ✅ فعال |
| 2 | `18.183.141.82` | `52996` | 164.29ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 222.99ms | ✅ فعال |
| 4 | `58.152.58.208` | `80` | 223.03ms | ✅ فعال |
| 5 | `41.191.203.167` | `80` | 237.48ms | ✅ فعال |
