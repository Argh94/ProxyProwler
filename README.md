...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 28-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.230` | `80` | 2.02ms | ✅ فعال |
| 2 | `194.152.44.195` | `80` | 2.59ms | ✅ فعال |
| 3 | `46.29.116.6` | `4145` | 2194.50ms | ✅ فعال |
| 4 | `160.153.0.100` | `80` | 2.32ms | ✅ فعال |
| 5 | `104.24.56.243` | `80` | 1.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.199.174.153` | `9102` | 122.62ms | ✅ فعال |
| 2 | `192.111.135.18` | `18301` | 63.68ms | ✅ فعال |
| 3 | `62.182.204.81` | `88` | 170.38ms | ✅ فعال |
| 4 | `88.216.215.144` | `9107` | 123.04ms | ✅ فعال |
| 5 | `121.43.154.123` | `7890` | 227.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 11.74ms | ✅ فعال |
| 2 | `201.245.201.18` | `3128` | 76.27ms | ✅ فعال |
| 3 | `40.192.105.58` | `55939` | 236.49ms | ✅ فعال |
| 4 | `43.209.130.76` | `29712` | 229.81ms | ✅ فعال |
| 5 | `27.34.242.98` | `80` | 231.26ms | ✅ فعال |
