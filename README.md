...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:13 03-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.27.93.92` | `5671` | 16.10ms | ✅ فعال |
| 2 | `206.123.156.234` | `5507` | 160.27ms | ✅ فعال |
| 3 | `18.142.236.222` | `1080` | 175.88ms | ✅ فعال |
| 4 | `206.123.156.182` | `5652` | 1183.01ms | ✅ فعال |
| 5 | `187.63.9.62` | `63253` | 155.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 1158.06ms | ✅ فعال |
| 2 | `139.59.105.64` | `8080` | 176.09ms | ✅ فعال |
| 3 | `83.143.29.161` | `1080` | 270.82ms | ✅ فعال |
| 4 | `3.19.239.254` | `1080` | 55.54ms | ✅ فعال |
| 5 | `47.91.29.151` | `41` | 109.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 56.59ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 119.70ms | ✅ فعال |
| 3 | `79.121.102.227` | `8080` | 153.18ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 50.04ms | ✅ فعال |
| 5 | `138.2.64.185` | `8118` | 177.90ms | ✅ فعال |
