...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:38 25-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `149.57.17.57` | `5525` | 12.71ms | ✅ فعال |
| 2 | `184.170.248.5` | `4145` | 85.92ms | ✅ فعال |
| 3 | `8.138.131.110` | `3128` | 243.29ms | ✅ فعال |
| 4 | `206.123.156.203` | `8717` | 1112.85ms | ✅ فعال |
| 5 | `141.193.213.31` | `80` | 5.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `187.44.211.118` | `4153` | 147.53ms | ✅ فعال |
| 2 | `184.181.217.210` | `4145` | 95.02ms | ✅ فعال |
| 3 | `8.138.131.110` | `3128` | 245.61ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 234.16ms | ✅ فعال |
| 5 | `136.0.186.135` | `6496` | 15.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 238.88ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.46ms | ✅ فعال |
| 3 | `103.191.165.9` | `8080` | 241.02ms | ✅ فعال |
| 4 | `1.0.171.213` | `8080` | 1305.05ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 120.68ms | ✅ فعال |
