...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:57 06-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `110.38.234.74` | `1080` | 233.01ms | ✅ فعال |
| 2 | `184.178.172.25` | `15291` | 86.79ms | ✅ فعال |
| 3 | `37.18.73.60` | `5566` | 134.20ms | ✅ فعال |
| 4 | `45.150.23.94` | `6564` | 16.04ms | ✅ فعال |
| 5 | `138.197.68.35` | `4857` | 7.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.139.222` | `8028` | 161.55ms | ✅ فعال |
| 2 | `80.90.188.187` | `24530` | 125.54ms | ✅ فعال |
| 3 | `8.221.139.222` | `8085` | 161.34ms | ✅ فعال |
| 4 | `144.91.83.39` | `9050` | 89.79ms | ✅ فعال |
| 5 | `200.108.50.254` | `4145` | 846.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.64ms | ✅ فعال |
| 2 | `51.79.207.21` | `8080` | 221.05ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 236.02ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 118.34ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 1108.61ms | ✅ فعال |
