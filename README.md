...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:51 04-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `58.19.55.4` | `15242` | 247.00ms | ✅ فعال |
| 2 | `8.211.194.78` | `9080` | 76.42ms | ✅ فعال |
| 3 | `58.19.55.4` | `15359` | 235.08ms | ✅ فعال |
| 4 | `8.211.42.167` | `81` | 105.34ms | ✅ فعال |
| 5 | `142.54.236.97` | `4145` | 83.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.42.167` | `81` | 119.07ms | ✅ فعال |
| 2 | `8.215.12.103` | `8448` | 229.39ms | ✅ فعال |
| 3 | `203.24.108.179` | `80` | 1.94ms | ✅ فعال |
| 4 | `97.105.12.186` | `4153` | 48.83ms | ✅ فعال |
| 5 | `103.65.237.92` | `5678` | 237.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 115.87ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 162.76ms | ✅ فعال |
| 3 | `13.127.170.8` | `3128` | 206.85ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 219.11ms | ✅ فعال |
