...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:51 02-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `3.69.148.57` | `1080` | 110.88ms | ✅ فعال |
| 2 | `192.252.208.67` | `14287` | 63.47ms | ✅ فعال |
| 3 | `198.24.188.139` | `8080` | 2.41ms | ✅ فعال |
| 4 | `142.93.202.130` | `3128` | 7.29ms | ✅ فعال |
| 5 | `8.209.255.13` | `3128` | 168.61ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (12 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.67` | `14287` | 64.19ms | ✅ فعال |
| 2 | `178.220.148.82` | `10801` | 1163.90ms | ✅ فعال |
| 3 | `200.174.198.32` | `8888` | 116.38ms | ✅ فعال |
| 4 | `191.101.26.85` | `5824` | 59.73ms | ✅ فعال |
| 5 | `103.166.39.145` | `3629` | 245.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 117.54ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 3.08ms | ✅ فعال |
| 3 | `209.141.62.12` | `5555` | 64.11ms | ✅ فعال |
| 4 | `103.147.247.171` | `8080` | 2287.85ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 3.10ms | ✅ فعال |
