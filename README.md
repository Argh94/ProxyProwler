...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 26-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.159.216.10` | `80` | 2.27ms | ✅ فعال |
| 2 | `206.206.118.232` | `6470` | 65.26ms | ✅ فعال |
| 3 | `188.114.96.160` | `80` | 2.62ms | ✅ فعال |
| 4 | `49.0.87.62` | `1080` | 258.10ms | ✅ فعال |
| 5 | `23.27.91.223` | `6302` | 68.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.86.43.255` | `1111` | 208.40ms | ✅ فعال |
| 2 | `47.116.210.163` | `1337` | 658.09ms | ✅ فعال |
| 3 | `104.207.34.220` | `3128` | 1.87ms | ✅ فعال |
| 4 | `157.230.45.111` | `1080` | 221.01ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 276.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.41ms | ✅ فعال |
| 2 | `18.163.3.251` | `54012` | 206.52ms | ✅ فعال |
| 3 | `116.80.63.164` | `3172` | 2211.58ms | ✅ فعال |
| 4 | `198.145.118.250` | `8080` | 155.43ms | ✅ فعال |
| 5 | `103.70.79.3` | `8080` | 2304.05ms | ✅ فعال |
