...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:36 14-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `164.90.185.232` | `1081` | 98.47ms | ✅ فعال |
| 2 | `206.123.156.236` | `5686` | 90.56ms | ✅ فعال |
| 3 | `39.102.210.222` | `10000` | 206.15ms | ✅ فعال |
| 4 | `171.248.217.155` | `1080` | 229.79ms | ✅ فعال |
| 5 | `8.211.51.115` | `4022` | 98.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.61.200.104` | `36181` | 148.92ms | ✅ فعال |
| 2 | `34.71.229.255` | `3128` | 25.55ms | ✅ فعال |
| 3 | `142.54.236.97` | `4145` | 82.05ms | ✅ فعال |
| 4 | `109.68.215.56` | `80` | 114.02ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 535.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 1223.28ms | ✅ فعال |
| 2 | `190.7.138.78` | `80` | 91.21ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 225.18ms | ✅ فعال |
