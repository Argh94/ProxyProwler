...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:34 08-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.79.31` | `80` | 2.11ms | ✅ فعال |
| 2 | `45.159.218.200` | `80` | 1.80ms | ✅ فعال |
| 3 | `24.249.199.4` | `4145` | 127.25ms | ✅ فعال |
| 4 | `104.16.250.206` | `80` | 1.76ms | ✅ فعال |
| 5 | `72.195.114.184` | `4145` | 126.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.8.211.54` | `80` | 1.91ms | ✅ فعال |
| 2 | `192.252.209.155` | `14455` | 95.65ms | ✅ فعال |
| 3 | `47.239.93.59` | `1100` | 1193.99ms | ✅ فعال |
| 4 | `8.220.204.92` | `80` | 812.70ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 181.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.114` | `80` | 2.38ms | ✅ فعال |
| 2 | `104.17.247.188` | `80` | 2.16ms | ✅ فعال |
| 3 | `198.177.56.190` | `80` | 1.55ms | ✅ فعال |
| 4 | `195.245.221.183` | `80` | 6.24ms | ✅ فعال |
| 5 | `45.131.7.159` | `80` | 2.11ms | ✅ فعال |
