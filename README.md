...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:50 15-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 226.38ms | ✅ فعال |
| 2 | `141.101.121.221` | `80` | 5.92ms | ✅ فعال |
| 3 | `45.131.6.34` | `80` | 5.85ms | ✅ فعال |
| 4 | `172.67.182.24` | `80` | 6.28ms | ✅ فعال |
| 5 | `104.19.143.108` | `80` | 6.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.29.65.188` | `6296` | 17.77ms | ✅ فعال |
| 2 | `8.209.96.245` | `4002` | 92.92ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 261.95ms | ✅ فعال |
| 4 | `36.64.27.123` | `5678` | 1300.27ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 257.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.93` | `80` | 6.36ms | ✅ فعال |
| 2 | `172.67.181.33` | `80` | 5.66ms | ✅ فعال |
| 3 | `45.131.211.217` | `80` | 6.02ms | ✅ فعال |
| 4 | `104.24.85.134` | `80` | 5.92ms | ✅ فعال |
| 5 | `89.116.250.4` | `80` | 6.03ms | ✅ فعال |
