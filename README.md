...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 18-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 32.84ms | ✅ فعال |
| 2 | `139.59.103.183` | `80` | 180.82ms | ✅ فعال |
| 3 | `141.98.153.86` | `80` | 136.43ms | ✅ فعال |
| 4 | `184.181.217.201` | `4145` | 104.31ms | ✅ فعال |
| 5 | `149.14.243.178` | `10878` | 139.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.246.130` | `6789` | 165.99ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 274.87ms | ✅ فعال |
| 3 | `8.148.22.214` | `80` | 212.11ms | ✅ فعال |
| 4 | `45.43.64.89` | `6347` | 117.87ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 150.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.161.155.252` | `80` | 46.79ms | ✅ فعال |
| 2 | `41.223.119.156` | `3128` | 278.31ms | ✅ فعال |
| 3 | `209.38.222.145` | `8080` | 1151.53ms | ✅ فعال |
| 4 | `62.113.119.14` | `8080` | 165.37ms | ✅ فعال |
| 5 | `27.34.242.98` | `80` | 260.19ms | ✅ فعال |
