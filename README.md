...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:05 06-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.72.77` | `80` | 2.40ms | ✅ فعال |
| 2 | `104.18.155.141` | `80` | 1.68ms | ✅ فعال |
| 3 | `160.153.0.110` | `80` | 2.12ms | ✅ فعال |
| 4 | `154.66.108.52` | `3629` | 2383.38ms | ✅ فعال |
| 5 | `104.27.6.112` | `80` | 2.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.21.172.174` | `8080` | 303.30ms | ✅ فعال |
| 2 | `8.148.24.225` | `83` | 204.59ms | ✅ فعال |
| 3 | `110.78.148.205` | `4145` | 212.51ms | ✅ فعال |
| 4 | `39.104.23.154` | `8004` | 246.50ms | ✅ فعال |
| 5 | `84.21.172.174` | `4145` | 170.10ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (60 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.79.112.218` | `16614` | 184.26ms | ✅ فعال |
| 2 | `40.192.3.100` | `4266` | 211.85ms | ✅ فعال |
| 3 | `201.89.97.222` | `8080` | 177.47ms | ✅ فعال |
| 4 | `78.12.143.148` | `4466` | 58.61ms | ✅ فعال |
| 5 | `154.236.191.48` | `1981` | 197.31ms | ✅ فعال |
