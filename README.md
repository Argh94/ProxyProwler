...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 21-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.15.247` | `80` | 2.17ms | ✅ فعال |
| 2 | `104.24.66.236` | `80` | 2.01ms | ✅ فعال |
| 3 | `72.195.34.41` | `4145` | 90.75ms | ✅ فعال |
| 4 | `199.116.114.11` | `4145` | 66.13ms | ✅ فعال |
| 5 | `104.17.231.143` | `80` | 2.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.56.80` | `5628` | 94.25ms | ✅ فعال |
| 2 | `47.243.175.55` | `443` | 199.06ms | ✅ فعال |
| 3 | `202.162.212.164` | `4153` | 248.09ms | ✅ فعال |
| 4 | `49.0.199.132` | `19` | 266.86ms | ✅ فعال |
| 5 | `47.254.153.78` | `5555` | 109.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 16.35ms | ✅ فعال |
| 2 | `120.92.212.16` | `7890` | 262.51ms | ✅ فعال |
| 3 | `217.174.106.15` | `8118` | 143.20ms | ✅ فعال |
| 4 | `51.16.56.189` | `293` | 160.43ms | ✅ فعال |
| 5 | `8.212.177.126` | `8080` | 238.78ms | ✅ فعال |
