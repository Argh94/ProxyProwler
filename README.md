...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:15 28-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (43 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `4145` | 174.83ms | ✅ فعال |
| 2 | `206.123.156.222` | `9302` | 1125.83ms | ✅ فعال |
| 3 | `79.117.37.49` | `9050` | 89.08ms | ✅ فعال |
| 4 | `206.123.156.228` | `9203` | 131.01ms | ✅ فعال |
| 5 | `185.135.69.34` | `80` | 189.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.29.87.165` | `6586` | 1.84ms | ✅ فعال |
| 2 | `68.1.210.189` | `4145` | 89.58ms | ✅ فعال |
| 3 | `98.175.31.195` | `4145` | 86.14ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 108.25ms | ✅ فعال |
| 5 | `31.59.33.66` | `6642` | 76.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 94.72ms | ✅ فعال |
| 2 | `51.79.71.106` | `8080` | 17.37ms | ✅ فعال |
| 3 | `97.76.251.138` | `8080` | 1084.91ms | ✅ فعال |
| 4 | `103.158.252.99` | `80` | 241.52ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.96ms | ✅ فعال |
