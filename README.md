...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:56 05-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `218.95.39.100` | `59999` | 311.59ms | ✅ فعال |
| 2 | `194.31.212.115` | `1080` | 160.34ms | ✅ فعال |
| 3 | `178.128.53.12` | `1080` | 182.45ms | ✅ فعال |
| 4 | `112.28.149.156` | `8443` | 157.62ms | ✅ فعال |
| 5 | `23.236.247.115` | `8147` | 8.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.181.137.80` | `4145` | 104.02ms | ✅ فعال |
| 2 | `172.120.120.11` | `5166` | 20.18ms | ✅ فعال |
| 3 | `81.162.249.129` | `4153` | 186.66ms | ✅ فعال |
| 4 | `159.65.221.25` | `80` | 60.37ms | ✅ فعال |
| 5 | `206.206.119.147` | `6058` | 10.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 1257.76ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 232.82ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 53.42ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 198.47ms | ✅ فعال |
