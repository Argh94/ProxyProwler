...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 17-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.200.160.224` | `80` | 2.45ms | ✅ فعال |
| 2 | `104.143.226.204` | `5807` | 91.61ms | ✅ فعال |
| 3 | `206.238.237.244` | `80` | 2.75ms | ✅ فعال |
| 4 | `45.131.6.7` | `80` | 2.62ms | ✅ فعال |
| 5 | `185.162.228.105` | `80` | 2.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `14.63.49.131` | `4145` | 167.42ms | ✅ فعال |
| 2 | `45.131.211.21` | `80` | 2.61ms | ✅ فعال |
| 3 | `124.158.149.66` | `4153` | 223.65ms | ✅ فعال |
| 4 | `36.64.238.83` | `1080` | 232.87ms | ✅ فعال |
| 5 | `49.0.87.62` | `1080` | 242.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.42.134` | `27343` | 185.60ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 232.34ms | ✅ فعال |
| 3 | `190.15.211.43` | `8080` | 1227.53ms | ✅ فعال |
| 4 | `196.189.44.49` | `1234` | 1209.10ms | ✅ فعال |
| 5 | `16.78.82.73` | `11714` | 219.19ms | ✅ فعال |
