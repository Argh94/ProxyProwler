...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 26-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (17 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.79.221.107` | `1080` | 55.87ms | ✅ فعال |
| 2 | `95.182.78.8` | `5678` | 2260.37ms | ✅ فعال |
| 3 | `38.154.205.51` | `5319` | 70.03ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 168.09ms | ✅ فعال |
| 5 | `47.238.60.156` | `18080` | 154.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.49.222` | `7302` | 227.19ms | ✅ فعال |
| 2 | `8.211.195.139` | `18080` | 836.45ms | ✅ فعال |
| 3 | `202.40.181.220` | `31247` | 219.11ms | ✅ فعال |
| 4 | `8.130.36.245` | `8080` | 206.05ms | ✅ فعال |
| 5 | `45.79.221.107` | `1080` | 55.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.181.33` | `80` | 1.65ms | ✅ فعال |
| 2 | `104.25.1.112` | `80` | 1.68ms | ✅ فعال |
| 3 | `185.148.104.15` | `80` | 2.11ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 1.55ms | ✅ فعال |
| 5 | `45.131.7.142` | `80` | 1.70ms | ✅ فعال |
