...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 01-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `139.177.229.116` | `8080` | 15.66ms | ✅ فعال |
| 2 | `102.177.176.56` | `80` | 2.65ms | ✅ فعال |
| 3 | `185.193.31.170` | `80` | 2.07ms | ✅ فعال |
| 4 | `104.27.77.219` | `80` | 2.19ms | ✅ فعال |
| 5 | `104.17.187.219` | `80` | 1.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 268.23ms | ✅ فعال |
| 2 | `49.0.246.130` | `6789` | 192.14ms | ✅ فعال |
| 3 | `77.110.104.126` | `80` | 149.00ms | ✅ فعال |
| 4 | `139.196.151.191` | `8090` | 246.90ms | ✅ فعال |
| 5 | `8.130.34.44` | `9001` | 264.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.129.50` | `8830` | 236.47ms | ✅ فعال |
| 2 | `43.198.99.209` | `8496` | 196.09ms | ✅ فعال |
| 3 | `51.20.184.59` | `80` | 119.26ms | ✅ فعال |
| 4 | `13.212.14.16` | `28080` | 207.17ms | ✅ فعال |
| 5 | `3.35.25.117` | `216` | 166.65ms | ✅ فعال |
