...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:16 24-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.170.57.249` | `4145` | 155.04ms | ✅ فعال |
| 2 | `72.37.217.3` | `4145` | 22.37ms | ✅ فعال |
| 3 | `216.68.128.121` | `4145` | 140.61ms | ✅ فعال |
| 4 | `98.170.57.231` | `4145` | 140.12ms | ✅ فعال |
| 5 | `98.188.47.132` | `4145` | 141.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.68.235.51` | `80` | 2036.17ms | ✅ فعال |
| 2 | `174.138.174.171` | `8001` | 1042.50ms | ✅ فعال |
| 3 | `64.64.110.205` | `6728` | 76.84ms | ✅ فعال |
| 4 | `195.208.3.50` | `1080` | 195.34ms | ✅ فعال |
| 5 | `216.68.128.121` | `4145` | 198.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 187.36ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 63.06ms | ✅ فعال |
| 3 | `119.82.242.200` | `8080` | 196.96ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 183.12ms | ✅ فعال |
| 5 | `129.154.225.163` | `8100` | 1241.98ms | ✅ فعال |
