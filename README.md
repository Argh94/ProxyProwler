...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 11-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `150.109.236.146` | `3128` | 125.15ms | ✅ فعال |
| 2 | `47.91.65.23` | `3128` | 165.26ms | ✅ فعال |
| 3 | `8.212.177.126` | `8080` | 1247.39ms | ✅ فعال |
| 4 | `4.213.167.178` | `80` | 220.75ms | ✅ فعال |
| 5 | `116.171.106.78` | `3000` | 198.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.151.226` | `2829` | 180.97ms | ✅ فعال |
| 2 | `103.154.113.243` | `4153` | 192.86ms | ✅ فعال |
| 3 | `194.150.110.134` | `80` | 153.01ms | ✅ فعال |
| 4 | `47.76.144.139` | `80` | 152.36ms | ✅ فعال |
| 5 | `216.10.27.162` | `6840` | 8.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 173.43ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 233.26ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 111.87ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 170.70ms | ✅ فعال |
