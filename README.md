...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 20-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.193.18` | `80` | 31.50ms | ✅ فعال |
| 2 | `47.252.18.37` | `10002` | 788.81ms | ✅ فعال |
| 3 | `104.17.182.252` | `80` | 12.00ms | ✅ فعال |
| 4 | `104.18.26.88` | `80` | 14.34ms | ✅ فعال |
| 5 | `47.251.73.54` | `8080` | 45.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.151.128` | `3128` | 167.49ms | ✅ فعال |
| 2 | `47.243.50.83` | `81` | 185.80ms | ✅ فعال |
| 3 | `184.178.172.25` | `15291` | 90.09ms | ✅ فعال |
| 4 | `162.220.247.92` | `6687` | 104.00ms | ✅ فعال |
| 5 | `192.252.215.5` | `16137` | 1144.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 29.77ms | ✅ فعال |
| 2 | `51.17.184.165` | `9401` | 164.06ms | ✅ فعال |
| 3 | `18.143.165.238` | `20399` | 203.89ms | ✅ فعال |
| 4 | `18.163.49.218` | `9320` | 183.73ms | ✅ فعال |
| 5 | `56.124.106.170` | `8022` | 145.18ms | ✅ فعال |
