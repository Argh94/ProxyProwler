...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 12-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.150.229` | `80` | 19.27ms | ✅ فعال |
| 2 | `107.172.156.229` | `5877` | 45.43ms | ✅ فعال |
| 3 | `45.135.139.221` | `6524` | 122.27ms | ✅ فعال |
| 4 | `23.227.60.68` | `80` | 18.45ms | ✅ فعال |
| 5 | `172.67.181.217` | `80` | 18.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `174.77.111.196` | `4145` | 96.44ms | ✅ فعال |
| 2 | `49.0.199.132` | `19` | 245.34ms | ✅ فعال |
| 3 | `142.93.202.130` | `3128` | 60.75ms | ✅ فعال |
| 4 | `85.228.42.230` | `4153` | 130.19ms | ✅ فعال |
| 5 | `47.91.110.148` | `1080` | 201.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 207.99ms | ✅ فعال |
| 2 | `43.205.124.165` | `227` | 232.57ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 43.55ms | ✅ فعال |
| 4 | `150.242.12.169` | `80` | 1271.18ms | ✅ فعال |
| 5 | `43.198.248.18` | `7469` | 174.50ms | ✅ فعال |
