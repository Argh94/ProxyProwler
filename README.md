...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:23 13-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.109.17` | `89` | 199.84ms | ✅ فعال |
| 2 | `120.92.212.16` | `8890` | 243.61ms | ✅ فعال |
| 3 | `211.171.114.154` | `3128` | 157.79ms | ✅ فعال |
| 4 | `202.133.88.173` | `80` | 151.73ms | ✅ فعال |
| 5 | `8.130.90.177` | `9080` | 235.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.90.177` | `9080` | 234.83ms | ✅ فعال |
| 2 | `8.213.134.213` | `1080` | 323.15ms | ✅ فعال |
| 3 | `184.178.172.25` | `15291` | 99.22ms | ✅ فعال |
| 4 | `31.59.20.134` | `6712` | 111.25ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 266.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `14.56.177.44` | `3128` | 161.80ms | ✅ فعال |
| 2 | `41.191.203.160` | `80` | 258.83ms | ✅ فعال |
| 3 | `128.90.43.194` | `8118` | 47.30ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 115.13ms | ✅ فعال |
| 5 | `35.225.22.61` | `80` | 21.87ms | ✅ فعال |
