...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 28-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.13.226.125` | `80` | 101.26ms | ✅ فعال |
| 2 | `104.18.1.99` | `80` | 2.77ms | ✅ فعال |
| 3 | `194.36.55.10` | `80` | 2.72ms | ✅ فعال |
| 4 | `185.193.31.90` | `80` | 2.74ms | ✅ فعال |
| 5 | `31.12.75.201` | `80` | 1.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `96.126.111.39` | `1081` | 24.98ms | ✅ فعال |
| 2 | `8.208.84.236` | `7657` | 93.28ms | ✅ فعال |
| 3 | `192.252.208.67` | `14287` | 69.77ms | ✅ فعال |
| 4 | `45.56.71.129` | `1081` | 28.09ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 239.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.115.193.75` | `3897` | 145.68ms | ✅ فعال |
| 2 | `16.78.108.50` | `9439` | 225.76ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 136.28ms | ✅ فعال |
| 4 | `13.115.193.75` | `46264` | 140.57ms | ✅ فعال |
| 5 | `157.175.43.137` | `8334` | 192.24ms | ✅ فعال |
