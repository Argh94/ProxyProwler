...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:50 10-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.159.217.186` | `80` | 5.73ms | ✅ فعال |
| 2 | `89.116.250.14` | `80` | 5.81ms | ✅ فعال |
| 3 | `104.24.29.140` | `80` | 13.27ms | ✅ فعال |
| 4 | `206.238.238.111` | `80` | 5.70ms | ✅ فعال |
| 5 | `5.10.246.33` | `80` | 5.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `178.220.148.82` | `10801` | 120.66ms | ✅ فعال |
| 2 | `181.48.243.194` | `4153` | 73.64ms | ✅ فعال |
| 3 | `8.220.204.215` | `8889` | 1901.54ms | ✅ فعال |
| 4 | `101.200.158.109` | `8880` | 253.51ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 253.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.93.247.0` | `80` | 5.88ms | ✅ فعال |
| 2 | `104.18.40.13` | `80` | 5.53ms | ✅ فعال |
| 3 | `45.85.118.80` | `80` | 5.93ms | ✅ فعال |
| 4 | `23.227.39.55` | `80` | 5.73ms | ✅ فعال |
| 5 | `104.17.25.3` | `80` | 5.95ms | ✅ فعال |
