...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 20-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.70.50` | `80` | 1.93ms | ✅ فعال |
| 2 | `141.101.123.16` | `80` | 2.24ms | ✅ فعال |
| 3 | `63.141.128.68` | `80` | 2.00ms | ✅ فعال |
| 4 | `147.185.161.246` | `80` | 1.73ms | ✅ فعال |
| 5 | `169.155.48.155` | `3128` | 8.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 158.64ms | ✅ فعال |
| 2 | `120.55.240.71` | `8647` | 143.39ms | ✅ فعال |
| 3 | `1.180.0.162` | `7302` | 162.80ms | ✅ فعال |
| 4 | `8.211.194.78` | `5800` | 137.79ms | ✅ فعال |
| 5 | `103.249.120.207` | `80` | 226.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.114.96.63` | `80` | 2.17ms | ✅ فعال |
| 2 | `199.48.129.114` | `3120` | 73.31ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 2.32ms | ✅ فعال |
| 4 | `172.67.88.21` | `80` | 1.72ms | ✅ فعال |
| 5 | `23.227.39.103` | `80` | 2.93ms | ✅ فعال |
