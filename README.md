...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:25 15-03-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (40 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.244.181.58` | `80` | 14.89ms | ✅ فعال |
| 2 | `69.58.12.175` | `8180` | 30.82ms | ✅ فعال |
| 3 | `206.123.156.223` | `7743` | 128.12ms | ✅ فعال |
| 4 | `183.80.40.243` | `1048` | 1280.94ms | ✅ فعال |
| 5 | `72.207.109.5` | `4145` | 92.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.139.222` | `8080` | 133.93ms | ✅ فعال |
| 2 | `122.224.198.218` | `1080` | 233.54ms | ✅ فعال |
| 3 | `103.19.78.127` | `1080` | 1251.45ms | ✅ فعال |
| 4 | `185.226.207.151` | `5700` | 117.44ms | ✅ فعال |
| 5 | `37.110.147.13` | `80` | 156.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 150.10ms | ✅ فعال |
| 2 | `138.2.64.185` | `8118` | 200.73ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 200.96ms | ✅ فعال |
| 4 | `209.141.54.136` | `5555` | 46.52ms | ✅ فعال |
| 5 | `51.38.230.146` | `80` | 114.85ms | ✅ فعال |
