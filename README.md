...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:01 23-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.230.190.195` | `1080` | 107.04ms | ✅ فعال |
| 2 | `200.174.198.32` | `8888` | 113.81ms | ✅ فعال |
| 3 | `98.175.31.195` | `4145` | 89.61ms | ✅ فعال |
| 4 | `4.213.167.178` | `80` | 206.57ms | ✅ فعال |
| 5 | `72.37.217.3` | `4145` | 72.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.188.196.40` | `9100` | 86.87ms | ✅ فعال |
| 2 | `64.49.67.164` | `5678` | 11.66ms | ✅ فعال |
| 3 | `87.120.205.164` | `444` | 106.59ms | ✅ فعال |
| 4 | `221.225.50.2` | `8989` | 269.93ms | ✅ فعال |
| 5 | `107.174.136.3` | `5945` | 35.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `129.154.225.163` | `8100` | 1242.86ms | ✅ فعال |
| 2 | `202.154.19.7` | `8080` | 2338.67ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 187.13ms | ✅ فعال |
| 4 | `110.164.175.110` | `8080` | 254.55ms | ✅ فعال |
