...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 02:00 10-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `51.146.240.4` | `8080` | 199.72ms | ✅ فعال |
| 2 | `62.148.236.156` | `10808` | 215.17ms | ✅ فعال |
| 3 | `47.251.87.74` | `6379` | 23.85ms | ✅ فعال |
| 4 | `199.66.183.226` | `4145` | 101.53ms | ✅ فعال |
| 5 | `142.54.237.38` | `4145` | 43.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.50.98.219` | `171` | 77.36ms | ✅ فعال |
| 2 | `213.165.185.211` | `4153` | 185.98ms | ✅ فعال |
| 3 | `103.43.191.71` | `8888` | 1207.24ms | ✅ فعال |
| 4 | `47.119.19.221` | `8081` | 178.78ms | ✅ فعال |
| 5 | `47.91.29.151` | `8081` | 102.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 152.61ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 184.37ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 162.19ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 185.79ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 100.99ms | ✅ فعال |
