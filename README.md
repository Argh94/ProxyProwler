...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:43 02-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.202` | `5832` | 93.24ms | ✅ فعال |
| 2 | `91.107.239.221` | `10390` | 94.76ms | ✅ فعال |
| 3 | `58.19.55.4` | `15203` | 246.83ms | ✅ فعال |
| 4 | `58.19.55.4` | `15007` | 247.70ms | ✅ فعال |
| 5 | `206.123.156.211` | `4233` | 85.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.55.20` | `6072` | 2.84ms | ✅ فعال |
| 2 | `64.64.118.247` | `6830` | 8.27ms | ✅ فعال |
| 3 | `68.1.210.163` | `4145` | 85.49ms | ✅ فعال |
| 4 | `14.143.222.113` | `57788` | 214.81ms | ✅ فعال |
| 5 | `163.172.53.142` | `80` | 87.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 219.72ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 166.97ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 116.02ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 119.37ms | ✅ فعال |
