...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:40 17-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `66.42.224.229` | `41679` | 146.73ms | ✅ فعال |
| 2 | `47.254.36.25` | `11080` | 25.25ms | ✅ فعال |
| 3 | `103.73.67.219` | `10800` | 172.12ms | ✅ فعال |
| 4 | `18.220.132.36` | `10001` | 116.98ms | ✅ فعال |
| 5 | `144.126.197.184` | `1088` | 115.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `170.239.84.103` | `3128` | 142.03ms | ✅ فعال |
| 2 | `46.29.116.3` | `4145` | 196.28ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 1182.05ms | ✅ فعال |
| 4 | `74.119.147.209` | `4145` | 77.27ms | ✅ فعال |
| 5 | `195.211.124.50` | `1080` | 128.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 1206.88ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 162.48ms | ✅ فعال |
| 3 | `182.253.109.30` | `8080` | 200.98ms | ✅ فعال |
| 4 | `103.130.61.61` | `8081` | 230.07ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 125.67ms | ✅ فعال |
