...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:47 06-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.165.243.246` | `6906` | 27.89ms | ✅ فعال |
| 2 | `8.220.204.215` | `3129` | 147.84ms | ✅ فعال |
| 3 | `91.107.143.176` | `20000` | 135.26ms | ✅ فعال |
| 4 | `184.181.217.210` | `4145` | 84.06ms | ✅ فعال |
| 5 | `104.232.211.27` | `5640` | 18.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.175.135.182` | `6623` | 19.17ms | ✅ فعال |
| 2 | `47.254.36.213` | `80` | 24.96ms | ✅ فعال |
| 3 | `201.184.239.75` | `5678` | 1146.47ms | ✅ فعال |
| 4 | `98.103.88.158` | `46104` | 2133.75ms | ✅ فعال |
| 5 | `23.229.110.198` | `8726` | 35.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 163.91ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 50.15ms | ✅ فعال |
| 3 | `103.156.15.73` | `8080` | 2233.85ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 201.33ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 49.32ms | ✅ فعال |
