...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:28 06-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.55.71.43` | `1080` | 42.20ms | ✅ فعال |
| 2 | `206.123.156.232` | `13006` | 132.49ms | ✅ فعال |
| 3 | `117.175.168.195` | `1080` | 214.72ms | ✅ فعال |
| 4 | `206.123.156.221` | `7224` | 120.67ms | ✅ فعال |
| 5 | `72.195.34.60` | `27391` | 79.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `68.183.52.128` | `9069` | 38.83ms | ✅ فعال |
| 2 | `72.195.34.35` | `27360` | 78.56ms | ✅ فعال |
| 3 | `187.44.211.118` | `4153` | 1226.94ms | ✅ فعال |
| 4 | `216.74.115.146` | `6740` | 52.29ms | ✅ فعال |
| 5 | `8.211.194.85` | `1080` | 105.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 196.18ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 127.86ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 27.22ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 24.57ms | ✅ فعال |
