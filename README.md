...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 16-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.205.172` | `3749` | 150.20ms | ✅ فعال |
| 2 | `91.200.115.49` | `1080` | 1214.47ms | ✅ فعال |
| 3 | `46.254.92.247` | `80` | 18.33ms | ✅ فعال |
| 4 | `104.16.250.196` | `80` | 18.10ms | ✅ فعال |
| 5 | `188.114.96.79` | `80` | 17.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.0.0.4` | `80` | 18.17ms | ✅ فعال |
| 2 | `192.252.216.81` | `4145` | 73.45ms | ✅ فعال |
| 3 | `47.251.87.74` | `13` | 24.86ms | ✅ فعال |
| 4 | `178.220.148.82` | `10801` | 159.67ms | ✅ فعال |
| 5 | `46.19.68.45` | `2333` | 124.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.4.9` | `80` | 18.27ms | ✅ فعال |
| 2 | `104.16.1.135` | `80` | 17.74ms | ✅ فعال |
| 3 | `206.238.236.139` | `80` | 18.80ms | ✅ فعال |
| 4 | `104.18.40.13` | `80` | 17.93ms | ✅ فعال |
| 5 | `173.245.49.114` | `80` | 18.02ms | ✅ فعال |
