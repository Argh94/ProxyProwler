...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:13 10-03-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (87 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.79.255.222` | `1080` | 175.84ms | ✅ فعال |
| 2 | `47.82.144.151` | `1080` | 172.73ms | ✅ فعال |
| 3 | `47.82.178.221` | `1080` | 176.74ms | ✅ فعال |
| 4 | `47.79.252.232` | `1080` | 670.08ms | ✅ فعال |
| 5 | `72.207.109.5` | `4145` | 143.44ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (45 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.82.144.151` | `1080` | 172.72ms | ✅ فعال |
| 2 | `47.82.150.186` | `1080` | 173.45ms | ✅ فعال |
| 3 | `47.82.178.75` | `1080` | 645.66ms | ✅ فعال |
| 4 | `84.2.239.42` | `4153` | 178.65ms | ✅ فعال |
| 5 | `203.190.8.59` | `1088` | 215.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 75.02ms | ✅ فعال |
| 2 | `182.253.109.162` | `8080` | 2284.30ms | ✅ فعال |
| 3 | `195.25.20.155` | `3128` | 155.23ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 173.28ms | ✅ فعال |
| 5 | `177.234.217.83` | `999` | 2211.81ms | ✅ فعال |
