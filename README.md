...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 10-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `89.249.195.29` | `6784` | 47.24ms | ✅ فعال |
| 2 | `104.25.225.86` | `80` | 2.21ms | ✅ فعال |
| 3 | `104.18.116.252` | `80` | 2.57ms | ✅ فعال |
| 4 | `45.131.4.179` | `80` | 2.75ms | ✅ فعال |
| 5 | `172.64.88.159` | `80` | 3.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.138.133.207` | `8008` | 220.76ms | ✅ فعال |
| 2 | `47.91.89.3` | `6379` | 105.54ms | ✅ فعال |
| 3 | `200.43.231.17` | `4145` | 168.11ms | ✅ فعال |
| 4 | `104.18.93.33` | `80` | 2.72ms | ✅ فعال |
| 5 | `47.238.128.246` | `1000` | 551.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.60.209.160` | `10073` | 120.38ms | ✅ فعال |
| 2 | `18.163.3.251` | `14953` | 190.66ms | ✅ فعال |
| 3 | `91.121.106.55` | `4444` | 108.53ms | ✅ فعال |
| 4 | `35.183.64.191` | `36` | 20.47ms | ✅ فعال |
| 5 | `164.163.42.5` | `10000` | 162.89ms | ✅ فعال |
