...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 21-08-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (85 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.21.129` | `80` | 1.62ms | ✅ فعال |
| 2 | `185.162.229.189` | `80` | 2.69ms | ✅ فعال |
| 3 | `198.41.201.144` | `80` | 1.72ms | ✅ فعال |
| 4 | `8.211.194.78` | `81` | 874.60ms | ✅ فعال |
| 5 | `138.199.25.13` | `3909` | 205.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.68.1` | `8081` | 108.72ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 246.66ms | ✅ فعال |
| 3 | `104.17.55.95` | `80` | 2.72ms | ✅ فعال |
| 4 | `161.123.154.96` | `6626` | 8.99ms | ✅ فعال |
| 5 | `49.0.246.130` | `8999` | 194.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.47.161` | `13595` | 219.57ms | ✅ فعال |
| 2 | `157.180.121.252` | `27193` | 133.82ms | ✅ فعال |
| 3 | `65.108.203.37` | `18080` | 134.02ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 209.04ms | ✅ فعال |
| 5 | `16.78.104.244` | `37` | 222.11ms | ✅ فعال |
