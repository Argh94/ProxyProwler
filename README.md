...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:13 12-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.155.16` | `80` | 5.95ms | ✅ فعال |
| 2 | `67.201.59.70` | `4145` | 72.59ms | ✅ فعال |
| 3 | `104.21.68.179` | `80` | 6.19ms | ✅ فعال |
| 4 | `104.254.140.210` | `80` | 6.39ms | ✅ فعال |
| 5 | `45.80.108.100` | `80` | 5.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.102.6.82` | `80` | 209.25ms | ✅ فعال |
| 2 | `8.221.141.88` | `9500` | 159.03ms | ✅ فعال |
| 3 | `8.148.22.214` | `8080` | 258.67ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 235.11ms | ✅ فعال |
| 5 | `31.58.10.171` | `6139` | 74.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `160.20.55.230` | `8080` | 204.55ms | ✅ فعال |
| 2 | `54.180.143.12` | `25907` | 187.24ms | ✅ فعال |
| 3 | `115.114.77.133` | `9090` | 204.92ms | ✅ فعال |
| 4 | `202.154.18.1` | `8080` | 253.21ms | ✅ فعال |
| 5 | `56.228.5.197` | `26403` | 102.48ms | ✅ فعال |
