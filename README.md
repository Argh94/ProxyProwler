...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:05 17-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.160.132.26` | `8080` | 218.89ms | ✅ فعال |
| 2 | `113.176.118.150` | `1080` | 214.74ms | ✅ فعال |
| 3 | `203.19.38.114` | `1080` | 210.95ms | ✅ فعال |
| 4 | `206.123.156.217` | `4769` | 1161.10ms | ✅ فعال |
| 5 | `47.238.203.170` | `50000` | 173.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.205.172` | `8008` | 156.79ms | ✅ فعال |
| 2 | `184.170.245.148` | `4145` | 72.02ms | ✅ فعال |
| 3 | `162.220.246.192` | `6476` | 109.17ms | ✅ فعال |
| 4 | `15.204.56.51` | `9150` | 64.52ms | ✅ فعال |
| 5 | `45.6.101.98` | `4153` | 1159.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 149.77ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 208.80ms | ✅ فعال |
| 3 | `186.121.235.66` | `8080` | 141.24ms | ✅ فعال |
