...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:41 02-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.178.72.21` | `10919` | 86.82ms | ✅ فعال |
| 2 | `72.37.217.3` | `4145` | 74.35ms | ✅ فعال |
| 3 | `200.43.43.126` | `4145` | 163.71ms | ✅ فعال |
| 4 | `104.168.118.87` | `6043` | 19.07ms | ✅ فعال |
| 5 | `118.145.141.251` | `44176` | 257.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.129.145` | `16894` | 71.36ms | ✅ فعال |
| 2 | `47.81.56.193` | `8888` | 247.00ms | ✅ فعال |
| 3 | `49.13.22.249` | `10801` | 103.59ms | ✅ فعال |
| 4 | `184.178.172.11` | `4145` | 85.78ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 184.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.19.7` | `8080` | 2328.70ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 241.65ms | ✅ فعال |
| 3 | `185.196.182.22` | `8080` | 1148.97ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 223.65ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 123.60ms | ✅ فعال |
