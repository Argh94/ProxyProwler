...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:57 20-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.153.0.33` | `80` | 2.80ms | ✅ فعال |
| 2 | `184.168.47.108` | `80` | 2.15ms | ✅ فعال |
| 3 | `45.80.108.150` | `80` | 2.70ms | ✅ فعال |
| 4 | `194.152.44.103` | `80` | 3.78ms | ✅ فعال |
| 5 | `8.209.96.245` | `4153` | 93.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.208.84.236` | `7657` | 95.53ms | ✅ فعال |
| 2 | `8.209.68.1` | `8081` | 92.79ms | ✅ فعال |
| 3 | `119.192.157.20` | `80` | 220.54ms | ✅ فعال |
| 4 | `16.78.41.33` | `372` | 232.58ms | ✅ فعال |
| 5 | `198.23.236.47` | `1111` | 68.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `52.47.164.226` | `642` | 165.09ms | ✅ فعال |
| 2 | `43.208.129.50` | `9252` | 246.09ms | ✅ فعال |
| 3 | `190.242.157.215` | `8080` | 75.15ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 102.00ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 2.61ms | ✅ فعال |
