...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:48 23-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.228` | `6274` | 2172.41ms | ✅ فعال |
| 2 | `95.140.154.211` | `8080` | 132.11ms | ✅ فعال |
| 3 | `178.212.144.7` | `80` | 160.04ms | ✅ فعال |
| 4 | `206.123.156.229` | `8303` | 128.20ms | ✅ فعال |
| 5 | `5.181.23.213` | `8443` | 142.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 266.75ms | ✅ فعال |
| 2 | `185.196.61.251` | `1080` | 48.82ms | ✅ فعال |
| 3 | `38.49.210.79` | `40000` | 50.80ms | ✅ فعال |
| 4 | `185.238.228.130` | `80` | 26.65ms | ✅ فعال |
| 5 | `178.220.148.82` | `10801` | 1191.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 48.95ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 51.10ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 1120.56ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 202.88ms | ✅ فعال |
| 5 | `185.196.182.22` | `8080` | 179.16ms | ✅ فعال |
