...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 30-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.112.167` | `80` | 18.43ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 182.49ms | ✅ فعال |
| 3 | `185.238.228.68` | `80` | 17.92ms | ✅ فعال |
| 4 | `104.21.55.80` | `80` | 18.34ms | ✅ فعال |
| 5 | `45.131.4.183` | `80` | 17.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.90.112` | `80` | 18.12ms | ✅ فعال |
| 2 | `45.41.169.221` | `6882` | 47.47ms | ✅ فعال |
| 3 | `23.94.138.150` | `6424` | 44.83ms | ✅ فعال |
| 4 | `23.227.39.38` | `80` | 17.89ms | ✅ فعال |
| 5 | `104.253.48.219` | `5643` | 18.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.66.40.96` | `80` | 17.65ms | ✅ فعال |
| 2 | `188.114.96.63` | `80` | 18.21ms | ✅ فعال |
| 3 | `172.67.161.245` | `80` | 17.97ms | ✅ فعال |
| 4 | `185.148.104.15` | `80` | 17.75ms | ✅ فعال |
| 5 | `198.177.56.190` | `80` | 18.18ms | ✅ فعال |
