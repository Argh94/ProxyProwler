...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:25 18-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `95.83.154.38` | `1080` | 142.42ms | ✅ فعال |
| 2 | `8.211.49.86` | `8008` | 105.48ms | ✅ فعال |
| 3 | `23.95.244.21` | `5974` | 30.99ms | ✅ فعال |
| 4 | `192.111.137.34` | `18765` | 70.76ms | ✅ فعال |
| 5 | `193.105.62.11` | `58973` | 136.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.135.139.172` | `6475` | 95.63ms | ✅ فعال |
| 2 | `185.125.201.149` | `7443` | 96.61ms | ✅ فعال |
| 3 | `199.58.184.97` | `4145` | 71.12ms | ✅ فعال |
| 4 | `178.220.148.82` | `10801` | 130.58ms | ✅ فعال |
| 5 | `82.132.19.108` | `4153` | 121.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 132.18ms | ✅ فعال |
| 2 | `62.210.136.222` | `3128` | 107.61ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 16.85ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 220.61ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 211.17ms | ✅ فعال |
