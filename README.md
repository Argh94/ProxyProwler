...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 09-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.70.218` | `80` | 9.04ms | ✅ فعال |
| 2 | `185.146.173.101` | `80` | 8.89ms | ✅ فعال |
| 3 | `89.116.250.177` | `80` | 8.46ms | ✅ فعال |
| 4 | `104.21.19.227` | `80` | 8.76ms | ✅ فعال |
| 5 | `8.213.197.208` | `3128` | 205.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.90.177` | `8080` | 212.80ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 204.27ms | ✅ فعال |
| 3 | `101.132.222.120` | `80` | 189.80ms | ✅ فعال |
| 4 | `216.205.52.50` | `80` | 8.41ms | ✅ فعال |
| 5 | `216.26.236.54` | `3129` | 67.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.8.211.248` | `80` | 9.09ms | ✅ فعال |
| 2 | `45.12.31.28` | `80` | 8.73ms | ✅ فعال |
| 3 | `172.66.40.96` | `80` | 8.55ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 16.01ms | ✅ فعال |
| 5 | `104.19.66.163` | `80` | 8.60ms | ✅ فعال |
