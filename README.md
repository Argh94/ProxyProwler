...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:54 17-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `157.90.183.51` | `5555` | 162.86ms | ✅ فعال |
| 2 | `23.94.246.160` | `8113` | 67.47ms | ✅ فعال |
| 3 | `144.76.159.120` | `1080` | 153.03ms | ✅ فعال |
| 4 | `206.123.156.217` | `17628` | 146.24ms | ✅ فعال |
| 5 | `61.158.175.38` | `9002` | 161.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.134.10` | `4145` | 23.05ms | ✅ فعال |
| 2 | `92.118.234.124` | `1080` | 169.50ms | ✅ فعال |
| 3 | `203.170.146.146` | `4153` | 2239.87ms | ✅ فعال |
| 4 | `98.175.31.195` | `4145` | 143.75ms | ✅ فعال |
| 5 | `8.213.197.208` | `808` | 192.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 186.70ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 181.68ms | ✅ فعال |
| 3 | `186.121.235.66` | `8080` | 164.72ms | ✅ فعال |
