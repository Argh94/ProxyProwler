...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 24-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.126.244` | `80` | 14.45ms | ✅ فعال |
| 2 | `195.245.221.251` | `80` | 14.02ms | ✅ فعال |
| 3 | `206.238.239.173` | `80` | 14.25ms | ✅ فعال |
| 4 | `185.193.31.208` | `80` | 14.14ms | ✅ فعال |
| 5 | `104.16.9.229` | `80` | 14.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `194.87.114.52` | `50100` | 114.74ms | ✅ فعال |
| 2 | `159.138.252.45` | `8888` | 242.94ms | ✅ فعال |
| 3 | `95.173.218.76` | `8082` | 196.09ms | ✅ فعال |
| 4 | `47.254.153.78` | `5555` | 124.12ms | ✅ فعال |
| 5 | `199.116.114.11` | `4145` | 69.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.179.12.21` | `4036` | 133.55ms | ✅ فعال |
| 2 | `13.59.113.45` | `1084` | 27.17ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 137.06ms | ✅ فعال |
| 4 | `162.218.112.60` | `60001` | 38.00ms | ✅ فعال |
| 5 | `147.75.33.99` | `10099` | 1519.60ms | ✅ فعال |
