...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:11 19-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.195.191` | `3000` | 220.39ms | ✅ فعال |
| 2 | `85.214.107.177` | `80` | 122.39ms | ✅ فعال |
| 3 | `185.142.156.229` | `2080` | 229.43ms | ✅ فعال |
| 4 | `5.188.159.23` | `2080` | 137.67ms | ✅ فعال |
| 5 | `51.159.97.242` | `10006` | 119.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `92.255.190.64` | `4153` | 173.87ms | ✅ فعال |
| 2 | `39.102.214.152` | `3128` | 182.64ms | ✅ فعال |
| 3 | `8.211.195.173` | `18080` | 103.66ms | ✅ فعال |
| 4 | `200.108.50.254` | `4145` | 2398.16ms | ✅ فعال |
| 5 | `45.137.43.0` | `1081` | 1182.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 149.97ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 199.51ms | ✅ فعال |
| 3 | `51.79.71.106` | `8080` | 45.81ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 32.88ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 208.98ms | ✅ فعال |
