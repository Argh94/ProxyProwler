...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:24 18-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `61.158.175.38` | `9002` | 227.66ms | ✅ فعال |
| 2 | `4.213.167.178` | `80` | 219.32ms | ✅ فعال |
| 3 | `103.125.31.222` | `80` | 249.41ms | ✅ فعال |
| 4 | `8.210.17.35` | `80` | 785.39ms | ✅ فعال |
| 5 | `36.138.53.26` | `10017` | 227.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.249.96` | `808` | 144.92ms | ✅ فعال |
| 2 | `185.18.250.83` | `80` | 1.97ms | ✅ فعال |
| 3 | `39.104.62.128` | `5000` | 247.03ms | ✅ فعال |
| 4 | `70.166.167.55` | `57745` | 94.67ms | ✅ فعال |
| 5 | `107.181.161.81` | `4145` | 65.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.60.196.214` | `80` | 92.16ms | ✅ فعال |
| 2 | `23.95.242.79` | `3128` | 22.42ms | ✅ فعال |
| 3 | `34.44.49.215` | `80` | 11.90ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 136.09ms | ✅ فعال |
| 5 | `35.180.127.14` | `1001` | 103.83ms | ✅ فعال |
