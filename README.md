...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:55 14-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `14.238.8.63` | `9090` | 231.89ms | ✅ فعال |
| 2 | `65.109.217.76` | `2223` | 141.83ms | ✅ فعال |
| 3 | `193.233.218.213` | `1080` | 132.42ms | ✅ فعال |
| 4 | `72.205.0.67` | `4145` | 109.28ms | ✅ فعال |
| 5 | `103.1.224.34` | `18080` | 138.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.103.88.158` | `46104` | 1063.41ms | ✅ فعال |
| 2 | `47.245.117.43` | `80` | 196.43ms | ✅ فعال |
| 3 | `192.227.176.161` | `10808` | 47.98ms | ✅ فعال |
| 4 | `198.105.122.56` | `6629` | 95.99ms | ✅ فعال |
| 5 | `45.116.114.37` | `5678` | 1285.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 220.33ms | ✅ فعال |
| 2 | `103.124.97.12` | `8080` | 296.96ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 30.91ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 196.84ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 161.72ms | ✅ فعال |
