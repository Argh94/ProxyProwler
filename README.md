...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:15 02-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.212.245.136` | `8888` | 264.06ms | ✅ فعال |
| 2 | `184.182.240.211` | `4145` | 89.18ms | ✅ فعال |
| 3 | `199.66.182.232` | `4145` | 63.56ms | ✅ فعال |
| 4 | `219.65.73.81` | `80` | 272.83ms | ✅ فعال |
| 5 | `199.58.184.97` | `4145` | 66.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.110.200.27` | `8000` | 119.52ms | ✅ فعال |
| 2 | `101.2.167.141` | `1088` | 258.39ms | ✅ فعال |
| 3 | `45.146.163.31` | `80` | 149.56ms | ✅ فعال |
| 4 | `195.26.230.202` | `8080` | 147.17ms | ✅ فعال |
| 5 | `47.89.159.212` | `80` | 54.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 145.42ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 217.54ms | ✅ فعال |
| 3 | `180.211.161.110` | `8080` | 2306.86ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 129.71ms | ✅ فعال |
| 5 | `177.234.217.83` | `999` | 111.85ms | ✅ فعال |
