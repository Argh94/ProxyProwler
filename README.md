...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 02-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.89.3` | `9050` | 89.57ms | ✅ فعال |
| 2 | `159.112.235.175` | `80` | 6.06ms | ✅ فعال |
| 3 | `104.27.4.116` | `80` | 5.98ms | ✅ فعال |
| 4 | `104.16.244.38` | `80` | 5.64ms | ✅ فعال |
| 5 | `23.229.125.65` | `5334` | 11.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.44` | `3128` | 267.68ms | ✅ فعال |
| 2 | `5.10.246.158` | `80` | 6.07ms | ✅ فعال |
| 3 | `98.191.0.37` | `4145` | 72.25ms | ✅ فعال |
| 4 | `107.181.154.21` | `5699` | 79.32ms | ✅ فعال |
| 5 | `38.170.172.25` | `5026` | 62.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.247.188` | `80` | 6.56ms | ✅ فعال |
| 2 | `206.238.236.139` | `80` | 6.28ms | ✅ فعال |
| 3 | `69.84.182.59` | `80` | 5.68ms | ✅ فعال |
| 4 | `104.17.190.13` | `80` | 5.90ms | ✅ فعال |
| 5 | `188.114.96.63` | `80` | 5.97ms | ✅ فعال |
