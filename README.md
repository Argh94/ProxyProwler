...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 23-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.73.54` | `64` | 69.26ms | ✅ فعال |
| 2 | `109.236.88.82` | `80` | 84.14ms | ✅ فعال |
| 3 | `8.221.139.222` | `3128` | 158.32ms | ✅ فعال |
| 4 | `103.205.64.153` | `80` | 218.07ms | ✅ فعال |
| 5 | `8.211.49.86` | `10801` | 92.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.22.214` | `8081` | 265.74ms | ✅ فعال |
| 2 | `45.230.172.29` | `1080` | 2143.65ms | ✅ فعال |
| 3 | `47.74.46.81` | `18080` | 159.60ms | ✅ فعال |
| 4 | `8.221.139.222` | `3128` | 158.33ms | ✅ فعال |
| 5 | `8.213.151.128` | `3128` | 194.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 30.22ms | ✅ فعال |
| 2 | `86.109.3.28` | `10049` | 226.26ms | ✅ فعال |
| 3 | `45.136.130.211` | `8447` | 60.05ms | ✅ فعال |
| 4 | `39.109.113.97` | `4090` | 214.09ms | ✅ فعال |
| 5 | `65.108.203.37` | `28080` | 113.66ms | ✅ فعال |
