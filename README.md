...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:38 28-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `68.1.210.163` | `4145` | 74.17ms | ✅ فعال |
| 2 | `101.47.73.135` | `3128` | 212.50ms | ✅ فعال |
| 3 | `142.54.229.249` | `4145` | 78.35ms | ✅ فعال |
| 4 | `58.241.88.13` | `800` | 241.17ms | ✅ فعال |
| 5 | `141.253.118.174` | `80` | 85.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `196.29.231.1` | `4145` | 2260.27ms | ✅ فعال |
| 2 | `45.88.0.117` | `3128` | 1107.32ms | ✅ فعال |
| 3 | `103.113.70.189` | `1081` | 2057.47ms | ✅ فعال |
| 4 | `143.137.116.72` | `1080` | 116.17ms | ✅ فعال |
| 5 | `192.252.215.5` | `16137` | 53.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 163.93ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 222.15ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 221.73ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 897.70ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 93.24ms | ✅ فعال |
