...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:14 29-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `101.36.104.239` | `10808` | 104.92ms | ✅ فعال |
| 2 | `140.82.39.50` | `9081` | 150.01ms | ✅ فعال |
| 3 | `206.123.156.221` | `6276` | 146.51ms | ✅ فعال |
| 4 | `103.82.23.118` | `6221` | 197.97ms | ✅ فعال |
| 5 | `141.98.153.86` | `80` | 153.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.220.16.215` | `80` | 288.49ms | ✅ فعال |
| 2 | `183.81.153.17` | `5678` | 2213.63ms | ✅ فعال |
| 3 | `64.188.62.23` | `37104` | 142.30ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 174.21ms | ✅ فعال |
| 5 | `198.105.100.18` | `6269` | 145.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.159.195.221` | `8080` | 2214.77ms | ✅ فعال |
| 2 | `103.191.165.9` | `8080` | 183.25ms | ✅ فعال |
| 3 | `103.133.27.143` | `8080` | 188.07ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 68.30ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 72.51ms | ✅ فعال |
