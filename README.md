...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:59 20-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.129.242.58` | `1080` | 1148.25ms | ✅ فعال |
| 2 | `192.111.137.35` | `4145` | 64.61ms | ✅ فعال |
| 3 | `176.191.124.3` | `80` | 2134.48ms | ✅ فعال |
| 4 | `203.25.208.163` | `1011` | 258.63ms | ✅ فعال |
| 5 | `23.27.91.65` | `6144` | 62.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.12.95.170` | `37209` | 124.67ms | ✅ فعال |
| 2 | `155.254.38.115` | `5791` | 84.13ms | ✅ فعال |
| 3 | `142.93.226.59` | `80` | 88.28ms | ✅ فعال |
| 4 | `65.109.148.248` | `1080` | 115.78ms | ✅ فعال |
| 5 | `184.174.46.100` | `5729` | 55.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 6.45ms | ✅ فعال |
| 2 | `195.25.20.155` | `3128` | 88.51ms | ✅ فعال |
| 3 | `209.141.62.12` | `5555` | 63.66ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 196.58ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 212.53ms | ✅ فعال |
