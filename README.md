...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:46 27-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.194` | `4145` | 103.80ms | ✅ فعال |
| 2 | `72.205.0.67` | `4145` | 103.77ms | ✅ فعال |
| 3 | `176.61.151.123` | `80` | 111.32ms | ✅ فعال |
| 4 | `98.191.0.47` | `4145` | 103.60ms | ✅ فعال |
| 5 | `91.132.92.231` | `80` | 126.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.20.112` | `6690` | 98.32ms | ✅ فعال |
| 2 | `145.223.46.205` | `5755` | 97.91ms | ✅ فعال |
| 3 | `47.90.149.238` | `9098` | 18.28ms | ✅ فعال |
| 4 | `47.238.128.246` | `202` | 203.55ms | ✅ فعال |
| 5 | `142.147.128.20` | `6520` | 18.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 172.60ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 133.02ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 223.35ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 142.17ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 235.25ms | ✅ فعال |
