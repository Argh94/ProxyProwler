...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:21 27-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.37.216.68` | `4145` | 71.94ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 239.53ms | ✅ فعال |
| 3 | `195.158.8.123` | `3128` | 159.85ms | ✅ فعال |
| 4 | `98.170.57.249` | `4145` | 94.30ms | ✅ فعال |
| 5 | `184.95.220.42` | `1080` | 27.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `149.129.226.9` | `6379` | 233.51ms | ✅ فعال |
| 2 | `195.24.65.4` | `1090` | 1171.52ms | ✅ فعال |
| 3 | `195.19.48.214` | `1080` | 198.30ms | ✅ فعال |
| 4 | `139.99.237.62` | `80` | 200.89ms | ✅ فعال |
| 5 | `27.76.197.164` | `1080` | 249.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.42ms | ✅ فعال |
| 2 | `195.25.20.155` | `3128` | 101.37ms | ✅ فعال |
| 3 | `173.212.237.47` | `3128` | 709.41ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 1280.72ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 117.64ms | ✅ فعال |
