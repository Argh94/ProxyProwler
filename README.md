...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 16-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.245.103` | `80` | 2.46ms | ✅ فعال |
| 2 | `212.183.88.36` | `80` | 1.62ms | ✅ فعال |
| 3 | `104.27.42.79` | `80` | 2.06ms | ✅ فعال |
| 4 | `45.131.4.223` | `80` | 2.53ms | ✅ فعال |
| 5 | `45.131.7.153` | `80` | 2.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.153.78` | `5555` | 105.55ms | ✅ فعال |
| 2 | `199.102.105.242` | `4145` | 91.57ms | ✅ فعال |
| 3 | `174.75.211.193` | `4145` | 110.48ms | ✅ فعال |
| 4 | `202.162.219.12` | `1080` | 232.55ms | ✅ فعال |
| 5 | `184.178.172.26` | `4145` | 97.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.45.145` | `124` | 180.74ms | ✅ فعال |
| 2 | `15.160.181.77` | `8596` | 110.80ms | ✅ فعال |
| 3 | `13.218.86.1` | `583` | 22.86ms | ✅ فعال |
| 4 | `147.75.68.201` | `80` | 47.06ms | ✅ فعال |
| 5 | `196.189.44.49` | `1234` | 175.56ms | ✅ فعال |
