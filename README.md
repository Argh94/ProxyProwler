...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 25-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.217` | `80` | 6.15ms | ✅ فعال |
| 2 | `49.0.87.62` | `1080` | 264.28ms | ✅ فعال |
| 3 | `91.107.171.19` | `80` | 92.63ms | ✅ فعال |
| 4 | `104.25.0.61` | `80` | 5.99ms | ✅ فعال |
| 5 | `104.18.1.196` | `80` | 7.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.74.38` | `79` | 82.66ms | ✅ فعال |
| 2 | `139.196.151.191` | `8090` | 278.83ms | ✅ فعال |
| 3 | `206.206.64.182` | `6143` | 58.42ms | ✅ فعال |
| 4 | `189.203.181.34` | `1080` | 49.27ms | ✅ فعال |
| 5 | `5.10.246.238` | `80` | 5.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.126.103.194` | `44214` | 135.17ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 240.32ms | ✅ فعال |
| 3 | `43.206.234.160` | `8472` | 168.21ms | ✅ فعال |
| 4 | `38.156.14.34` | `999` | 45.39ms | ✅ فعال |
| 5 | `54.154.27.41` | `19603` | 73.06ms | ✅ فعال |
