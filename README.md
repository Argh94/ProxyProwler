...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:01 02-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.113.40` | `80` | 6.00ms | ✅ فعال |
| 2 | `45.131.5.18` | `80` | 5.65ms | ✅ فعال |
| 3 | `63.141.128.239` | `80` | 6.09ms | ✅ فعال |
| 4 | `194.36.55.178` | `80` | 6.09ms | ✅ فعال |
| 5 | `45.85.118.199` | `80` | 6.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.153.78` | `5555` | 88.95ms | ✅ فعال |
| 2 | `8.130.36.163` | `8888` | 279.99ms | ✅ فعال |
| 3 | `139.224.56.162` | `10001` | 245.60ms | ✅ فعال |
| 4 | `139.177.229.134` | `8080` | 5.57ms | ✅ فعال |
| 5 | `85.237.62.189` | `3629` | 146.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.38.101.138` | `8337` | 187.48ms | ✅ فعال |
| 2 | `144.124.227.90` | `10808` | 89.62ms | ✅ فعال |
| 3 | `54.180.143.12` | `37751` | 189.70ms | ✅ فعال |
| 4 | `43.198.99.209` | `8496` | 206.10ms | ✅ فعال |
| 5 | `13.115.193.75` | `3897` | 160.54ms | ✅ فعال |
