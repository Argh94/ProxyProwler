...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 06-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.120.105` | `80` | 2.46ms | ✅ فعال |
| 2 | `185.162.228.29` | `80` | 2.21ms | ✅ فعال |
| 3 | `160.123.255.29` | `80` | 2.22ms | ✅ فعال |
| 4 | `104.24.244.196` | `80` | 1.88ms | ✅ فعال |
| 5 | `45.131.210.244` | `80` | 2.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.148.2` | `8080` | 244.50ms | ✅ فعال |
| 2 | `8.213.129.20` | `20201` | 242.84ms | ✅ فعال |
| 3 | `101.51.138.138` | `8080` | 265.79ms | ✅ فعال |
| 4 | `95.43.244.15` | `4153` | 121.80ms | ✅ فعال |
| 5 | `47.91.115.179` | `3129` | 173.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.116.250.4` | `80` | 2.28ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 2.23ms | ✅ فعال |
| 3 | `185.162.229.172` | `80` | 2.70ms | ✅ فعال |
| 4 | `45.80.108.229` | `80` | 2.62ms | ✅ فعال |
| 5 | `104.16.0.165` | `80` | 2.14ms | ✅ فعال |
