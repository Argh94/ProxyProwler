...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:19 24-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `194.152.44.21` | `80` | 15.41ms | ✅ فعال |
| 2 | `47.91.120.190` | `80` | 188.56ms | ✅ فعال |
| 3 | `216.24.57.89` | `80` | 13.92ms | ✅ فعال |
| 4 | `185.18.250.66` | `80` | 9.98ms | ✅ فعال |
| 5 | `103.116.7.74` | `80` | 9.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.151.134.157` | `3629` | 177.86ms | ✅ فعال |
| 2 | `8.209.68.1` | `8081` | 121.39ms | ✅ فعال |
| 3 | `47.91.120.190` | `80` | 188.35ms | ✅ فعال |
| 4 | `88.216.68.91` | `9073` | 14.09ms | ✅ فعال |
| 5 | `31.131.135.247` | `4153` | 186.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `108.137.1.116` | `9440` | 306.03ms | ✅ فعال |
| 2 | `43.208.129.50` | `135` | 265.42ms | ✅ فعال |
| 3 | `35.183.64.191` | `8228` | 27.91ms | ✅ فعال |
| 4 | `45.225.207.182` | `999` | 1148.26ms | ✅ فعال |
| 5 | `13.36.243.194` | `9255` | 114.06ms | ✅ فعال |
