...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:47 10-03-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (92 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.82.150.156` | `1080` | 196.99ms | ✅ فعال |
| 2 | `47.82.147.208` | `1080` | 232.14ms | ✅ فعال |
| 3 | `47.82.146.6` | `1080` | 200.36ms | ✅ فعال |
| 4 | `47.82.179.72` | `1080` | 195.47ms | ✅ فعال |
| 5 | `47.82.146.79` | `1080` | 195.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.82.147.92` | `1080` | 196.80ms | ✅ فعال |
| 2 | `192.252.214.20` | `15864` | 78.09ms | ✅ فعال |
| 3 | `185.17.153.178` | `8080` | 147.36ms | ✅ فعال |
| 4 | `47.82.177.71` | `1080` | 206.83ms | ✅ فعال |
| 5 | `92.255.190.64` | `4153` | 205.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `158.101.175.124` | `5566` | 144.34ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 26.24ms | ✅ فعال |
| 3 | `177.234.217.83` | `999` | 1168.96ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 163.32ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 150.45ms | ✅ فعال |
