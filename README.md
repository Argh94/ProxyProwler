...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:29 10-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `202.133.88.173` | `80` | 106.26ms | ✅ فعال |
| 2 | `210.76.192.250` | `10809` | 242.33ms | ✅ فعال |
| 3 | `120.92.212.16` | `7890` | 275.67ms | ✅ فعال |
| 4 | `154.65.39.7` | `80` | 148.43ms | ✅ فعال |
| 5 | `92.118.115.36` | `80` | 174.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `70.166.167.38` | `57728` | 159.81ms | ✅ فعال |
| 2 | `184.181.217.201` | `4145` | 71.39ms | ✅ فعال |
| 3 | `185.226.204.168` | `5721` | 79.71ms | ✅ فعال |
| 4 | `47.243.175.55` | `443` | 196.67ms | ✅ فعال |
| 5 | `46.8.69.128` | `1080` | 97.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.240.77` | `9007` | 246.68ms | ✅ فعال |
| 2 | `40.192.3.100` | `8019` | 231.73ms | ✅ فعال |
| 3 | `18.60.222.217` | `37777` | 230.15ms | ✅ فعال |
| 4 | `43.217.141.124` | `2764` | 226.93ms | ✅ فعال |
| 5 | `35.180.127.14` | `444` | 85.12ms | ✅ فعال |
