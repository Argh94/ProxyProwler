...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:13 30-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.0.222` | `80` | 1046.94ms | ✅ فعال |
| 2 | `45.80.110.55` | `80` | 53.07ms | ✅ فعال |
| 3 | `141.193.213.71` | `80` | 9.08ms | ✅ فعال |
| 4 | `199.102.106.94` | `4145` | 33.50ms | ✅ فعال |
| 5 | `103.169.142.56` | `80` | 8.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 161.22ms | ✅ فعال |
| 2 | `8.209.255.13` | `3128` | 109.50ms | ✅ فعال |
| 3 | `115.29.140.201` | `8499` | 219.36ms | ✅ فعال |
| 4 | `119.13.111.169` | `18081` | 178.65ms | ✅ فعال |
| 5 | `45.56.71.129` | `1081` | 34.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.197.28` | `1090` | 221.97ms | ✅ فعال |
| 2 | `43.208.240.77` | `35031` | 201.19ms | ✅ فعال |
| 3 | `13.212.14.16` | `10443` | 177.63ms | ✅ فعال |
| 4 | `15.168.235.57` | `205` | 125.46ms | ✅ فعال |
| 5 | `16.78.82.73` | `4938` | 191.72ms | ✅ فعال |
