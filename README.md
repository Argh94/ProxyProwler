...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:13 27-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `195.114.209.50` | `80` | 100.32ms | ✅ فعال |
| 2 | `184.178.172.3` | `4145` | 77.02ms | ✅ فعال |
| 3 | `217.69.121.195` | `5860` | 80.76ms | ✅ فعال |
| 4 | `45.115.195.15` | `5993` | 54.59ms | ✅ فعال |
| 5 | `141.98.153.86` | `80` | 95.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.249.96` | `808` | 157.05ms | ✅ فعال |
| 2 | `72.214.108.67` | `4145` | 73.76ms | ✅ فعال |
| 3 | `199.187.210.54` | `4145` | 108.26ms | ✅ فعال |
| 4 | `72.195.101.99` | `4145` | 81.92ms | ✅ فعال |
| 5 | `8.220.136.174` | `8443` | 241.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.39.112.144` | `3128` | 102.73ms | ✅ فعال |
| 2 | `41.191.203.160` | `80` | 230.17ms | ✅ فعال |
| 3 | `13.78.120.128` | `80` | 155.03ms | ✅ فعال |
| 4 | `72.56.50.17` | `59787` | 89.11ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 163.70ms | ✅ فعال |
