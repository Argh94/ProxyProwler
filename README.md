...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:29 27-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `114.130.89.94` | `1080` | 281.43ms | ✅ فعال |
| 2 | `46.21.186.252` | `1080` | 141.10ms | ✅ فعال |
| 3 | `103.88.234.239` | `40002` | 41.28ms | ✅ فعال |
| 4 | `64.64.115.60` | `5695` | 72.15ms | ✅ فعال |
| 5 | `103.88.234.239` | `40002` | 45.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `133.232.90.85` | `80` | 1659.88ms | ✅ فعال |
| 2 | `103.88.234.239` | `40002` | 41.16ms | ✅ فعال |
| 3 | `115.85.86.114` | `5678` | 2234.59ms | ✅ فعال |
| 4 | `45.43.81.153` | `5800` | 121.66ms | ✅ فعال |
| 5 | `13.125.44.24` | `80` | 145.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.74.144.4` | `83` | 254.52ms | ✅ فعال |
| 2 | `213.136.72.147` | `3128` | 135.73ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 124.42ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 182.09ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 163.62ms | ✅ فعال |
