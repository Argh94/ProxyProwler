...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 29-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.237.94` | `80` | 2.79ms | ✅ فعال |
| 2 | `104.18.243.134` | `80` | 9.75ms | ✅ فعال |
| 3 | `104.17.230.157` | `80` | 2.24ms | ✅ فعال |
| 4 | `172.67.255.2` | `80` | 2.45ms | ✅ فعال |
| 5 | `138.199.25.13` | `3909` | 172.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.135.18` | `18301` | 187.86ms | ✅ فعال |
| 2 | `47.243.124.21` | `6666` | 159.47ms | ✅ فعال |
| 3 | `185.191.165.28` | `1080` | 184.93ms | ✅ فعال |
| 4 | `45.135.139.121` | `6424` | 147.62ms | ✅ فعال |
| 5 | `47.113.219.226` | `59394` | 218.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.110.127.255` | `5534` | 228.28ms | ✅ فعال |
| 2 | `16.78.108.50` | `9439` | 185.74ms | ✅ فعال |
| 3 | `3.35.25.117` | `891` | 134.17ms | ✅ فعال |
| 4 | `13.212.14.16` | `28080` | 171.74ms | ✅ فعال |
| 5 | `199.48.129.114` | `3120` | 72.36ms | ✅ فعال |
