...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:40 24-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `129.226.208.98` | `443` | 180.07ms | ✅ فعال |
| 2 | `84.200.24.154` | `1080` | 152.35ms | ✅ فعال |
| 3 | `198.8.94.170` | `4145` | 77.45ms | ✅ فعال |
| 4 | `202.133.88.173` | `80` | 140.42ms | ✅ فعال |
| 5 | `139.99.237.62` | `80` | 159.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.20.126` | `8080` | 219.68ms | ✅ فعال |
| 2 | `184.178.172.17` | `4145` | 106.82ms | ✅ فعال |
| 3 | `107.181.161.81` | `4145` | 48.70ms | ✅ فعال |
| 4 | `92.113.241.101` | `6186` | 216.34ms | ✅ فعال |
| 5 | `174.64.199.82` | `4145` | 105.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.225.22.61` | `80` | 32.62ms | ✅ فعال |
| 2 | `209.38.222.145` | `8080` | 132.29ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 181.06ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 114.47ms | ✅ فعال |
| 5 | `5.9.218.168` | `3128` | 136.44ms | ✅ فعال |
