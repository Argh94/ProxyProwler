...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 19-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (72 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `136.244.96.236` | `50000` | 97.13ms | ✅ فعال |
| 2 | `168.197.182.222` | `8080` | 135.11ms | ✅ فعال |
| 3 | `185.132.1.221` | `4145` | 1144.60ms | ✅ فعال |
| 4 | `91.247.250.215` | `4145` | 2164.30ms | ✅ فعال |
| 5 | `37.193.125.68` | `1090` | 171.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.2.239.42` | `4153` | 177.29ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 1158.66ms | ✅ فعال |
| 3 | `162.220.247.202` | `6797` | 96.63ms | ✅ فعال |
| 4 | `8.221.139.222` | `3128` | 140.34ms | ✅ فعال |
| 5 | `79.106.170.126` | `4145` | 132.45ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (3 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 112.14ms | ✅ فعال |
| 2 | `45.70.236.194` | `999` | 95.25ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 138.25ms | ✅ فعال |
