...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 18-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.16.185` | `80` | 2.34ms | ✅ فعال |
| 2 | `8.221.139.222` | `8028` | 162.18ms | ✅ فعال |
| 3 | `45.131.6.181` | `80` | 2.76ms | ✅ فعال |
| 4 | `188.42.89.78` | `80` | 2.71ms | ✅ فعال |
| 5 | `104.16.180.119` | `80` | 2.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.81` | `3629` | 270.28ms | ✅ فعال |
| 2 | `198.46.137.169` | `6373` | 66.06ms | ✅ فعال |
| 3 | `68.71.249.153` | `48606` | 105.43ms | ✅ فعال |
| 4 | `104.17.2.92` | `80` | 2.59ms | ✅ فعال |
| 5 | `216.24.57.19` | `80` | 2.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.192.3.100` | `59723` | 205.35ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 245.70ms | ✅ فعال |
| 3 | `165.22.71.191` | `443` | 2174.34ms | ✅ فعال |
| 4 | `196.189.44.49` | `1234` | 158.37ms | ✅ فعال |
| 5 | `160.19.19.23` | `8080` | 2300.02ms | ✅ فعال |
