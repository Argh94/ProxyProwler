...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:01 25-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.179` | `5534` | 94.43ms | ✅ فعال |
| 2 | `112.198.22.122` | `80` | 244.66ms | ✅ فعال |
| 3 | `185.198.27.38` | `3128` | 147.61ms | ✅ فعال |
| 4 | `159.65.230.46` | `8888` | 11.22ms | ✅ فعال |
| 5 | `153.0.171.163` | `8085` | 256.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `115.127.112.178` | `1080` | 257.89ms | ✅ فعال |
| 2 | `46.29.162.166` | `80` | 166.98ms | ✅ فعال |
| 3 | `103.166.39.81` | `3629` | 254.78ms | ✅ فعال |
| 4 | `81.10.234.234` | `80` | 106.43ms | ✅ فعال |
| 5 | `195.160.223.99` | `9050` | 97.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 154.46ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 99.92ms | ✅ فعال |
| 3 | `51.79.207.21` | `8080` | 228.43ms | ✅ فعال |
| 4 | `51.91.76.186` | `8080` | 90.44ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 224.88ms | ✅ فعال |
