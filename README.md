...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 16-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.12.112.211` | `5222` | 8.40ms | ✅ فعال |
| 2 | `172.67.254.249` | `80` | 1.53ms | ✅ فعال |
| 3 | `194.87.77.22` | `80` | 149.87ms | ✅ فعال |
| 4 | `173.245.59.0` | `80` | 1.49ms | ✅ فعال |
| 5 | `104.21.204.159` | `80` | 1.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.12.112.211` | `5222` | 8.27ms | ✅ فعال |
| 2 | `2.57.17.13` | `8000` | 155.24ms | ✅ فعال |
| 3 | `194.87.77.22` | `80` | 150.50ms | ✅ فعال |
| 4 | `166.88.85.211` | `6291` | 1.80ms | ✅ فعال |
| 5 | `201.174.239.28` | `4153` | 52.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `50.17.40.179` | `240` | 72.14ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 175.33ms | ✅ فعال |
| 3 | `40.177.211.224` | `8080` | 42.23ms | ✅ فعال |
| 4 | `41.223.119.156` | `3128` | 311.27ms | ✅ فعال |
| 5 | `35.183.64.191` | `20183` | 78.52ms | ✅ فعال |
