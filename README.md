...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 07-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.94.86` | `80` | 2.01ms | ✅ فعال |
| 2 | `185.162.231.110` | `80` | 2.48ms | ✅ فعال |
| 3 | `31.135.21.185` | `80` | 132.60ms | ✅ فعال |
| 4 | `8.213.128.6` | `9000` | 166.44ms | ✅ فعال |
| 5 | `160.153.0.232` | `80` | 2.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.36.163` | `8888` | 260.79ms | ✅ فعال |
| 2 | `47.243.124.21` | `6666` | 196.67ms | ✅ فعال |
| 3 | `177.67.136.221` | `4153` | 146.45ms | ✅ فعال |
| 4 | `188.245.218.56` | `80` | 108.74ms | ✅ فعال |
| 5 | `139.196.151.191` | `8090` | 237.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.229.112.25` | `8080` | 39.43ms | ✅ فعال |
| 2 | `157.175.43.137` | `8334` | 183.01ms | ✅ فعال |
| 3 | `94.25.85.100` | `8123` | 220.82ms | ✅ فعال |
| 4 | `13.115.193.75` | `3897` | 143.16ms | ✅ فعال |
| 5 | `3.38.101.138` | `7010` | 1195.13ms | ✅ فعال |
