...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 04-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.224.190` | `80` | 19.12ms | ✅ فعال |
| 2 | `45.8.211.202` | `80` | 2.00ms | ✅ فعال |
| 3 | `104.17.247.229` | `80` | 1.95ms | ✅ فعال |
| 4 | `146.103.56.65` | `5613` | 145.87ms | ✅ فعال |
| 5 | `46.202.224.74` | `5626` | 66.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.227.119.156` | `6485` | 8.77ms | ✅ فعال |
| 2 | `96.126.111.39` | `1081` | 72.63ms | ✅ فعال |
| 3 | `31.59.18.17` | `6598` | 22.73ms | ✅ فعال |
| 4 | `121.43.154.123` | `8081` | 191.75ms | ✅ فعال |
| 5 | `146.103.56.65` | `5613` | 145.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `167.114.65.167` | `8888` | 65.34ms | ✅ فعال |
| 2 | `16.78.105.11` | `8082` | 183.25ms | ✅ فعال |
| 3 | `18.60.222.217` | `8540` | 213.08ms | ✅ فعال |
| 4 | `157.175.196.63` | `37719` | 239.67ms | ✅ فعال |
| 5 | `78.12.249.123` | `9898` | 58.62ms | ✅ فعال |
