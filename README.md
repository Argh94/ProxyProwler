...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:04 24-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.241.49` | `80` | 2.38ms | ✅ فعال |
| 2 | `45.80.111.51` | `80` | 2.01ms | ✅ فعال |
| 3 | `63.141.128.62` | `80` | 1.93ms | ✅ فعال |
| 4 | `45.8.211.13` | `80` | 1.82ms | ✅ فعال |
| 5 | `104.17.107.47` | `80` | 1.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.212.165.164` | `3128` | 186.93ms | ✅ فعال |
| 2 | `8.148.22.214` | `4006` | 208.27ms | ✅ فعال |
| 3 | `88.216.68.41` | `9068` | 50.75ms | ✅ فعال |
| 4 | `94.131.7.1` | `31477` | 186.71ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 187.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.3.251` | `9149` | 157.30ms | ✅ فعال |
| 2 | `40.192.14.136` | `44860` | 212.53ms | ✅ فعال |
| 3 | `43.208.16.199` | `41665` | 197.67ms | ✅ فعال |
| 4 | `16.79.112.218` | `50909` | 183.27ms | ✅ فعال |
| 5 | `43.198.185.30` | `35466` | 155.94ms | ✅ فعال |
