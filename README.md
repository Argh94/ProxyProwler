...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:26 04-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.174.231.218` | `8888` | 42.02ms | ✅ فعال |
| 2 | `47.56.110.204` | `8990` | 150.09ms | ✅ فعال |
| 3 | `180.125.216.109` | `8118` | 1200.39ms | ✅ فعال |
| 4 | `120.92.212.16` | `7890` | 213.21ms | ✅ فعال |
| 5 | `61.158.175.38` | `9002` | 200.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `167.160.40.182` | `10036` | 148.50ms | ✅ فعال |
| 2 | `34.44.49.215` | `80` | 49.16ms | ✅ فعال |
| 3 | `154.6.116.241` | `6210` | 78.12ms | ✅ فعال |
| 4 | `23.236.255.89` | `6865` | 9.45ms | ✅ فعال |
| 5 | `23.236.170.162` | `9195` | 10.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 111.15ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1338.32ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 167.63ms | ✅ فعال |
