...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 12-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `167.160.40.162` | `24304` | 104.82ms | ✅ فعال |
| 2 | `160.153.0.21` | `80` | 2.51ms | ✅ فعال |
| 3 | `172.67.181.158` | `80` | 2.45ms | ✅ فعال |
| 4 | `172.67.180.35` | `80` | 2.61ms | ✅ فعال |
| 5 | `185.176.24.74` | `80` | 1.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.196.151.191` | `8090` | 229.53ms | ✅ فعال |
| 2 | `8.221.141.88` | `9500` | 142.63ms | ✅ فعال |
| 3 | `43.133.6.171` | `6006` | 144.60ms | ✅ فعال |
| 4 | `110.238.116.82` | `55443` | 268.21ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 110.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.154.18.1` | `8080` | 241.55ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 207.27ms | ✅ فعال |
| 3 | `162.240.154.26` | `3128` | 36.69ms | ✅ فعال |
| 4 | `164.163.40.15` | `10000` | 158.94ms | ✅ فعال |
| 5 | `51.79.207.21` | `8080` | 212.72ms | ✅ فعال |
