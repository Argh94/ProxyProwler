...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:20 07-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.161.209` | `80` | 2.21ms | ✅ فعال |
| 2 | `139.162.78.109` | `3128` | 104.70ms | ✅ فعال |
| 3 | `142.54.231.38` | `4145` | 24.29ms | ✅ فعال |
| 4 | `199.34.230.8` | `80` | 1.93ms | ✅ فعال |
| 5 | `45.131.7.52` | `80` | 1.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `200.108.50.254` | `4145` | 1578.21ms | ✅ فعال |
| 2 | `70.166.167.55` | `57745` | 123.93ms | ✅ فعال |
| 3 | `185.176.24.185` | `80` | 1.66ms | ✅ فعال |
| 4 | `8.130.36.163` | `8888` | 205.06ms | ✅ فعال |
| 5 | `49.0.252.39` | `9000` | 159.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.116.210.100` | `3128` | 188.73ms | ✅ فعال |
| 2 | `3.38.101.138` | `7010` | 133.69ms | ✅ فعال |
| 3 | `43.208.129.50` | `8830` | 196.92ms | ✅ فعال |
| 4 | `18.143.167.190` | `12354` | 171.92ms | ✅ فعال |
| 5 | `16.78.108.50` | `9439` | 186.79ms | ✅ فعال |
