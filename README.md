...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:56 30-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.154.158` | `5836` | 97.70ms | ✅ فعال |
| 2 | `67.227.14.148` | `6740` | 52.03ms | ✅ فعال |
| 3 | `67.201.33.10` | `25283` | 63.18ms | ✅ فعال |
| 4 | `85.237.206.150` | `1234` | 186.00ms | ✅ فعال |
| 5 | `66.42.224.229` | `41679` | 74.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.175.248.21` | `1080` | 42.31ms | ✅ فعال |
| 2 | `101.53.134.45` | `3128` | 218.07ms | ✅ فعال |
| 3 | `47.252.18.37` | `8083` | 89.72ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 123.78ms | ✅ فعال |
| 5 | `147.124.198.36` | `5895` | 30.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 220.46ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 112.83ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 17.69ms | ✅ فعال |
| 4 | `138.2.64.185` | `8118` | 212.17ms | ✅ فعال |
| 5 | `202.58.206.15` | `8080` | 1303.67ms | ✅ فعال |
