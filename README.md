...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:00 18-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.188.47.132` | `4145` | 67.63ms | ✅ فعال |
| 2 | `104.21.238.13` | `80` | 14.08ms | ✅ فعال |
| 3 | `47.251.87.74` | `4002` | 674.71ms | ✅ فعال |
| 4 | `188.114.98.153` | `80` | 2.90ms | ✅ فعال |
| 5 | `170.114.45.31` | `80` | 1.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.14` | `4145` | 70.47ms | ✅ فعال |
| 2 | `8.148.22.214` | `8080` | 254.02ms | ✅ فعال |
| 3 | `107.174.25.133` | `5587` | 19.74ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 235.06ms | ✅ فعال |
| 5 | `72.223.188.67` | `4145` | 70.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.16.49.113` | `8585` | 275.57ms | ✅ فعال |
| 2 | `201.245.201.18` | `3128` | 71.18ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 3.25ms | ✅ فعال |
| 4 | `13.36.243.194` | `9239` | 87.92ms | ✅ فعال |
| 5 | `164.163.42.60` | `10000` | 157.81ms | ✅ فعال |
