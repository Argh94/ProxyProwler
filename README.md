...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:34 17-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `91.109.114.211` | `8888` | 80.15ms | ✅ فعال |
| 2 | `142.93.202.130` | `3128` | 9.32ms | ✅ فعال |
| 3 | `47.252.11.233` | `14186` | 2.81ms | ✅ فعال |
| 4 | `5.255.99.75` | `1080` | 85.76ms | ✅ فعال |
| 5 | `185.204.170.130` | `83` | 100.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.129.145` | `16894` | 59.10ms | ✅ فعال |
| 2 | `89.167.85.46` | `9050` | 110.36ms | ✅ فعال |
| 3 | `8.211.51.115` | `8008` | 93.17ms | ✅ فعال |
| 4 | `138.197.68.35` | `4857` | 1052.80ms | ✅ فعال |
| 5 | `98.170.57.241` | `4145` | 84.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 116.95ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 2.47ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 2.45ms | ✅ فعال |
| 4 | `103.48.68.108` | `82` | 2251.81ms | ✅ فعال |
| 5 | `209.141.62.12` | `5555` | 59.39ms | ✅ فعال |
