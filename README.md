...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:38 23-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 166.72ms | ✅ فعال |
| 2 | `45.43.64.216` | `6474` | 147.16ms | ✅ فعال |
| 3 | `72.195.34.58` | `4145` | 132.30ms | ✅ فعال |
| 4 | `103.66.176.45` | `32251` | 213.24ms | ✅ فعال |
| 5 | `150.230.104.3` | `16728` | 105.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `123.57.1.16` | `5555` | 201.97ms | ✅ فعال |
| 2 | `98.188.47.150` | `4145` | 167.43ms | ✅ فعال |
| 3 | `45.43.64.216` | `6474` | 147.23ms | ✅ فعال |
| 4 | `110.238.116.82` | `55443` | 202.83ms | ✅ فعال |
| 5 | `39.104.69.76` | `8888` | 208.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.88.88.102` | `80` | 152.87ms | ✅ فعال |
| 2 | `27.34.242.98` | `80` | 234.38ms | ✅ فعال |
| 3 | `45.140.147.82` | `1081` | 144.77ms | ✅ فعال |
| 4 | `45.59.186.60` | `80` | 9.52ms | ✅ فعال |
| 5 | `38.60.196.214` | `80` | 1151.49ms | ✅ فعال |
