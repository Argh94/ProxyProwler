...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:19 08-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `129.159.152.152` | `6666` | 144.19ms | ✅ فعال |
| 2 | `8.211.51.115` | `31433` | 113.91ms | ✅ فعال |
| 3 | `158.178.198.31` | `1080` | 98.95ms | ✅ فعال |
| 4 | `8.221.141.88` | `1200` | 141.15ms | ✅ فعال |
| 5 | `142.54.236.97` | `4145` | 65.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.197.208` | `18080` | 265.70ms | ✅ فعال |
| 2 | `136.0.180.243` | `6264` | 8.61ms | ✅ فعال |
| 3 | `172.120.101.96` | `6275` | 49.01ms | ✅ فعال |
| 4 | `154.30.1.136` | `5452` | 28.18ms | ✅ فعال |
| 5 | `212.231.191.23` | `80` | 105.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.127.170.8` | `3128` | 220.65ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 202.83ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 144.27ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 138.81ms | ✅ فعال |
| 5 | `190.7.138.78` | `80` | 95.11ms | ✅ فعال |
