...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:56 16-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.253.145.138` | `6980` | 221.78ms | ✅ فعال |
| 2 | `45.136.130.251` | `8449` | 51.84ms | ✅ فعال |
| 3 | `52.229.30.3` | `80` | 66.74ms | ✅ فعال |
| 4 | `8.219.229.53` | `443` | 222.06ms | ✅ فعال |
| 5 | `38.34.179.51` | `8449` | 1086.46ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (14 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `85.214.107.177` | `80` | 104.59ms | ✅ فعال |
| 2 | `213.19.205.18` | `54321` | 88.44ms | ✅ فعال |
| 3 | `38.34.179.213` | `8452` | 69.67ms | ✅ فعال |
| 4 | `192.111.129.145` | `16894` | 66.90ms | ✅ فعال |
| 5 | `62.87.154.36` | `80` | 110.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 224.11ms | ✅ فعال |
| 2 | `51.159.66.158` | `3128` | 89.63ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 221.62ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 150.57ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 101.71ms | ✅ فعال |
