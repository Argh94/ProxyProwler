...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:52 07-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `77.110.119.136` | `1080` | 71.89ms | ✅ فعال |
| 2 | `184.170.245.148` | `4145` | 119.92ms | ✅ فعال |
| 3 | `72.207.113.97` | `4145` | 138.58ms | ✅ فعال |
| 4 | `45.89.106.116` | `1082` | 221.91ms | ✅ فعال |
| 5 | `197.221.234.149` | `80` | 300.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.190.8.59` | `1088` | 2240.46ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 213.49ms | ✅ فعال |
| 3 | `8.213.134.213` | `9200` | 128.11ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 177.27ms | ✅ فعال |
| 5 | `177.85.65.177` | `4153` | 1214.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 72.67ms | ✅ فعال |
| 2 | `103.133.27.143` | `8080` | 185.76ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 64.54ms | ✅ فعال |
| 4 | `103.158.252.99` | `80` | 180.36ms | ✅ فعال |
| 5 | `182.253.109.139` | `8080` | 189.11ms | ✅ فعال |
