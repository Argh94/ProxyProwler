...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:37 02-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3907` | 182.80ms | ✅ فعال |
| 2 | `103.239.52.100` | `1080` | 1247.23ms | ✅ فعال |
| 3 | `149.62.186.244` | `1080` | 165.57ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 118.99ms | ✅ فعال |
| 5 | `148.230.96.73` | `1080` | 2753.16ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (13 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `64.49.67.164` | `5678` | 2138.22ms | ✅ فعال |
| 2 | `184.181.217.220` | `4145` | 119.24ms | ✅ فعال |
| 3 | `38.65.94.102` | `1080` | 33.82ms | ✅ فعال |
| 4 | `91.132.92.150` | `80` | 130.41ms | ✅ فعال |
| 5 | `15.165.71.55` | `1080` | 146.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.229.197.94` | `999` | 1112.00ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 54.11ms | ✅ فعال |
| 3 | `209.141.62.12` | `5555` | 32.93ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 60.89ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 2159.31ms | ✅ فعال |
