...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:49 11-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `188.114.99.244` | `80` | 1.96ms | ✅ فعال |
| 2 | `45.131.208.254` | `80` | 2.81ms | ✅ فعال |
| 3 | `185.148.107.179` | `80` | 2.67ms | ✅ فعال |
| 4 | `46.254.92.38` | `80` | 1.96ms | ✅ فعال |
| 5 | `154.83.2.136` | `80` | 2.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 259.67ms | ✅ فعال |
| 2 | `178.220.148.82` | `10801` | 2163.45ms | ✅ فعال |
| 3 | `123.58.219.225` | `8080` | 212.66ms | ✅ فعال |
| 4 | `107.174.136.143` | `6085` | 24.63ms | ✅ فعال |
| 5 | `1.180.0.162` | `7302` | 246.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.1.135` | `80` | 3.28ms | ✅ فعال |
| 2 | `89.116.250.4` | `80` | 2.39ms | ✅ فعال |
| 3 | `172.66.40.96` | `80` | 1.73ms | ✅ فعال |
| 4 | `23.227.39.55` | `80` | 1.89ms | ✅ فعال |
| 5 | `206.238.236.139` | `80` | 2.67ms | ✅ فعال |
