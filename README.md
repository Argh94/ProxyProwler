...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 10:27 23-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.24.72` | `80` | 5.63ms | ✅ فعال |
| 2 | `93.90.212.2` | `4153` | 147.51ms | ✅ فعال |
| 3 | `185.162.230.109` | `80` | 5.87ms | ✅ فعال |
| 4 | `192.111.130.5` | `17002` | 53.10ms | ✅ فعال |
| 5 | `107.174.194.134` | `5576` | 38.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.39.117` | `8080` | 259.06ms | ✅ فعال |
| 2 | `101.51.138.138` | `8080` | 255.05ms | ✅ فعال |
| 3 | `103.165.64.86` | `4153` | 292.30ms | ✅ فعال |
| 4 | `136.0.194.218` | `6955` | 25.59ms | ✅ فعال |
| 5 | `184.181.217.220` | `4145` | 70.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 5.70ms | ✅ فعال |
| 2 | `172.67.88.21` | `80` | 5.45ms | ✅ فعال |
| 3 | `104.16.0.165` | `80` | 5.67ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 5.51ms | ✅ فعال |
| 5 | `173.245.49.93` | `80` | 5.77ms | ✅ فعال |
