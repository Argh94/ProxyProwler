...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:58 19-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `70.166.167.55` | `57745` | 84.33ms | ✅ فعال |
| 2 | `43.135.176.121` | `1080` | 65.34ms | ✅ فعال |
| 3 | `206.220.175.2` | `4145` | 72.26ms | ✅ فعال |
| 4 | `98.191.0.47` | `4145` | 86.00ms | ✅ فعال |
| 5 | `103.75.118.84` | `1080` | 166.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.2.239.42` | `4153` | 123.17ms | ✅ فعال |
| 2 | `199.58.184.97` | `4145` | 59.23ms | ✅ فعال |
| 3 | `185.204.170.179` | `1133` | 86.96ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 180.80ms | ✅ فعال |
| 5 | `8.211.195.173` | `5060` | 1681.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 235.83ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 120.91ms | ✅ فعال |
| 3 | `103.189.116.20` | `8080` | 243.03ms | ✅ فعال |
| 4 | `110.34.1.180` | `32650` | 2276.10ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 1110.88ms | ✅ فعال |
