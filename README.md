...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 27-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.175.31.195` | `4145` | 85.63ms | ✅ فعال |
| 2 | `102.177.176.120` | `80` | 2.77ms | ✅ فعال |
| 3 | `161.123.151.51` | `6035` | 9.59ms | ✅ فعال |
| 4 | `85.220.141.220` | `80` | 133.99ms | ✅ فعال |
| 5 | `103.169.142.131` | `80` | 1.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `4006` | 212.74ms | ✅ فعال |
| 2 | `47.237.2.245` | `9098` | 217.89ms | ✅ فعال |
| 3 | `8.219.255.17` | `3128` | 213.38ms | ✅ فعال |
| 4 | `47.91.89.3` | `8081` | 108.17ms | ✅ فعال |
| 5 | `45.65.224.26` | `1080` | 150.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 17.65ms | ✅ فعال |
| 2 | `3.38.101.138` | `7010` | 168.97ms | ✅ فعال |
| 3 | `200.24.130.150` | `999` | 111.77ms | ✅ فعال |
| 4 | `16.78.108.50` | `9439` | 227.17ms | ✅ فعال |
| 5 | `3.35.25.117` | `216` | 172.75ms | ✅ فعال |
