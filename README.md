...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:20 13-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `8118` | 104.84ms | ✅ فعال |
| 2 | `193.53.127.169` | `80` | 211.09ms | ✅ فعال |
| 3 | `89.208.85.78` | `443` | 195.93ms | ✅ فعال |
| 4 | `61.158.175.38` | `9002` | 204.14ms | ✅ فعال |
| 5 | `214.59.21.181` | `3128` | 68.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.227.42.117` | `6094` | 10.82ms | ✅ فعال |
| 2 | `174.75.211.222` | `4145` | 122.27ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 264.78ms | ✅ فعال |
| 4 | `222.234.52.105` | `80` | 137.75ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 209.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.96.150.225` | `3128` | 128.97ms | ✅ فعال |
| 2 | `145.220.178.13` | `8118` | 181.90ms | ✅ فعال |
| 3 | `23.88.88.102` | `80` | 158.38ms | ✅ فعال |
| 4 | `41.220.16.215` | `80` | 2325.66ms | ✅ فعال |
| 5 | `65.108.209.73` | `80` | 177.94ms | ✅ فعال |
