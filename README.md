...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:25 22-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `89.208.85.78` | `443` | 125.05ms | ✅ فعال |
| 2 | `113.204.79.230` | `9091` | 251.91ms | ✅ فعال |
| 3 | `39.104.27.89` | `8888` | 536.57ms | ✅ فعال |
| 4 | `213.73.25.230` | `8080` | 106.45ms | ✅ فعال |
| 5 | `8.211.42.167` | `544` | 93.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.160.16.234` | `8020` | 234.19ms | ✅ فعال |
| 2 | `103.146.170.233` | `5678` | 235.96ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 121.40ms | ✅ فعال |
| 4 | `8.211.42.167` | `1080` | 94.03ms | ✅ فعال |
| 5 | `74.119.144.60` | `4145` | 59.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 163.99ms | ✅ فعال |
| 2 | `27.34.242.98` | `80` | 1271.24ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 220.87ms | ✅ فعال |
| 4 | `43.209.8.12` | `19050` | 245.13ms | ✅ فعال |
| 5 | `41.191.203.167` | `80` | 229.54ms | ✅ فعال |
