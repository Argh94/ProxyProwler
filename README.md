...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:07 02-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.198.27.38` | `3128` | 143.48ms | ✅ فعال |
| 2 | `192.154.250.21` | `5601` | 44.50ms | ✅ فعال |
| 3 | `141.98.153.86` | `80` | 142.39ms | ✅ فعال |
| 4 | `116.80.96.108` | `3172` | 1165.93ms | ✅ فعال |
| 5 | `74.176.195.135` | `80` | 109.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.56.110.204` | `8989` | 153.26ms | ✅ فعال |
| 2 | `51.4.59.110` | `1080` | 167.27ms | ✅ فعال |
| 3 | `103.166.39.81` | `3629` | 225.37ms | ✅ فعال |
| 4 | `146.103.3.127` | `7180` | 132.18ms | ✅ فعال |
| 5 | `47.76.102.90` | `1011` | 154.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 148.69ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 119.61ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 177.00ms | ✅ فعال |
| 4 | `103.176.96.134` | `8082` | 1247.40ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 185.05ms | ✅ فعال |
