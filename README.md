...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:44 11-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `167.71.196.28` | `8080` | 205.03ms | ✅ فعال |
| 2 | `140.246.125.194` | `9099` | 259.82ms | ✅ فعال |
| 3 | `103.84.95.54` | `7890` | 209.06ms | ✅ فعال |
| 4 | `178.212.144.7` | `80` | 119.11ms | ✅ فعال |
| 5 | `52.229.30.3` | `80` | 44.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `149.129.226.9` | `5060` | 222.51ms | ✅ فعال |
| 2 | `31.56.177.74` | `1090` | 122.72ms | ✅ فعال |
| 3 | `103.166.39.81` | `3629` | 243.24ms | ✅ فعال |
| 4 | `149.129.255.179` | `3128` | 220.18ms | ✅ فعال |
| 5 | `177.66.43.189` | `4145` | 2180.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 208.98ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1337.82ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 218.40ms | ✅ فعال |
