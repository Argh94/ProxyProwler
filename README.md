...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:17 04-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `213.131.85.27` | `1981` | 2158.96ms | ✅ فعال |
| 2 | `152.228.237.108` | `1080` | 93.48ms | ✅ فعال |
| 3 | `144.24.111.128` | `1088` | 201.46ms | ✅ فعال |
| 4 | `118.145.141.251` | `44192` | 1267.27ms | ✅ فعال |
| 5 | `45.43.81.162` | `5809` | 76.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.170.91` | `14680` | 165.38ms | ✅ فعال |
| 2 | `31.13.239.4` | `5678` | 121.81ms | ✅ فعال |
| 3 | `152.53.194.105` | `1080` | 3.00ms | ✅ فعال |
| 4 | `92.204.54.29` | `9100` | 94.35ms | ✅ فعال |
| 5 | `8.211.51.115` | `5060` | 99.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 242.93ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 223.39ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 158.05ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 123.24ms | ✅ فعال |
| 5 | `103.130.61.61` | `8081` | 260.96ms | ✅ فعال |
