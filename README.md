...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:46 28-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.32.114` | `80` | 12.77ms | ✅ فعال |
| 2 | `181.214.1.227` | `80` | 5.57ms | ✅ فعال |
| 3 | `142.147.129.11` | `5620` | 16.71ms | ✅ فعال |
| 4 | `104.27.65.8` | `80` | 5.82ms | ✅ فعال |
| 5 | `8.221.139.222` | `8108` | 159.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.233` | `3629` | 282.49ms | ✅ فعال |
| 2 | `154.118.231.30` | `80` | 215.55ms | ✅ فعال |
| 3 | `47.238.128.246` | `4002` | 918.60ms | ✅ فعال |
| 4 | `142.147.128.196` | `6696` | 16.61ms | ✅ فعال |
| 5 | `8.213.215.187` | `8443` | 394.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.1.135` | `80` | 5.42ms | ✅ فعال |
| 2 | `141.101.122.238` | `80` | 5.22ms | ✅ فعال |
| 3 | `45.131.4.93` | `80` | 5.63ms | ✅ فعال |
| 4 | `216.24.57.248` | `80` | 5.33ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 235.48ms | ✅ فعال |
