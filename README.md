...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 03-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.149.33` | `80` | 6.44ms | ✅ فعال |
| 2 | `45.80.110.80` | `80` | 5.56ms | ✅ فعال |
| 3 | `159.246.55.18` | `80` | 6.12ms | ✅ فعال |
| 4 | `172.67.70.138` | `80` | 5.85ms | ✅ فعال |
| 5 | `185.226.204.201` | `5754` | 80.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.221.203.121` | `4145` | 106.53ms | ✅ فعال |
| 2 | `72.195.114.184` | `4145` | 73.05ms | ✅ فعال |
| 3 | `5.199.166.250` | `9106` | 227.04ms | ✅ فعال |
| 4 | `39.104.79.145` | `1234` | 263.62ms | ✅ فعال |
| 5 | `200.110.173.17` | `3629` | 70.71ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (57 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.141.124` | `7413` | 233.32ms | ✅ فعال |
| 2 | `201.89.97.222` | `8080` | 121.03ms | ✅ فعال |
| 3 | `15.160.134.84` | `2529` | 100.01ms | ✅ فعال |
| 4 | `40.192.100.189` | `8168` | 228.73ms | ✅ فعال |
| 5 | `16.79.112.218` | `50909` | 240.61ms | ✅ فعال |
