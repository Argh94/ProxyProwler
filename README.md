...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:15 18-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.178.72.21` | `10919` | 108.88ms | ✅ فعال |
| 2 | `152.53.209.196` | `1080` | 21.94ms | ✅ فعال |
| 3 | `192.111.129.150` | `4145` | 66.80ms | ✅ فعال |
| 4 | `178.250.156.112` | `443` | 145.80ms | ✅ فعال |
| 5 | `147.45.60.250` | `1082` | 2109.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.43.191.71` | `8888` | 244.89ms | ✅ فعال |
| 2 | `8.211.194.85` | `4444` | 98.94ms | ✅ فعال |
| 3 | `177.234.247.218` | `1080` | 93.92ms | ✅ فعال |
| 4 | `8.213.222.247` | `77` | 230.05ms | ✅ فعال |
| 5 | `185.17.153.178` | `8080` | 144.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `165.232.119.106` | `8080` | 121.74ms | ✅ فعال |
| 2 | `103.191.165.9` | `8080` | 222.92ms | ✅ فعال |
