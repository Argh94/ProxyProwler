...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:49 27-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.75.211.193` | `4145` | 110.37ms | ✅ فعال |
| 2 | `143.92.61.47` | `1088` | 159.67ms | ✅ فعال |
| 3 | `219.93.101.60` | `80` | 217.52ms | ✅ فعال |
| 4 | `8.216.32.38` | `1080` | 109.62ms | ✅ فعال |
| 5 | `132.226.7.23` | `30277` | 1168.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.66.43.189` | `4145` | 1177.91ms | ✅ فعال |
| 2 | `136.0.186.147` | `6508` | 72.26ms | ✅ فعال |
| 3 | `199.58.184.97` | `4145` | 108.91ms | ✅ فعال |
| 4 | `47.254.36.213` | `999` | 25.09ms | ✅ فعال |
| 5 | `145.220.226.68` | `8080` | 1208.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 58.73ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 59.18ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 178.99ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 199.68ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 196.37ms | ✅ فعال |
