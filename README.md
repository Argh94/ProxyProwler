...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 26-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.121.80` | `80` | 14.75ms | ✅ فعال |
| 2 | `62.72.166.51` | `80` | 14.57ms | ✅ فعال |
| 3 | `198.41.208.82` | `80` | 14.32ms | ✅ فعال |
| 4 | `46.254.92.98` | `80` | 12.22ms | ✅ فعال |
| 5 | `8.220.204.92` | `443` | 940.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `65.108.203.35` | `18080` | 143.69ms | ✅ فعال |
| 2 | `39.102.210.222` | `8081` | 249.14ms | ✅ فعال |
| 3 | `168.235.82.57` | `80` | 40.82ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 211.14ms | ✅ فعال |
| 5 | `186.96.111.214` | `999` | 87.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.49.218` | `3629` | 183.60ms | ✅ فعال |
| 2 | `13.244.135.47` | `3333` | 247.60ms | ✅ فعال |
| 3 | `54.180.143.12` | `37751` | 160.28ms | ✅ فعال |
| 4 | `18.143.167.190` | `12354` | 199.79ms | ✅ فعال |
| 5 | `3.38.101.138` | `8337` | 159.99ms | ✅ فعال |
