...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:00 17-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.70` | `14282` | 54.33ms | ✅ فعال |
| 2 | `40.89.145.14` | `80` | 84.65ms | ✅ فعال |
| 3 | `103.125.31.222` | `80` | 250.62ms | ✅ فعال |
| 4 | `36.138.53.26` | `10017` | 225.48ms | ✅ فعال |
| 5 | `61.158.175.38` | `9002` | 256.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `4006` | 218.32ms | ✅ فعال |
| 2 | `139.224.186.221` | `1337` | 617.33ms | ✅ فعال |
| 3 | `123.57.1.16` | `5555` | 252.96ms | ✅ فعال |
| 4 | `80.78.70.253` | `65530` | 1177.99ms | ✅ فعال |
| 5 | `8.220.136.174` | `18080` | 291.84ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (19 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `86.109.3.28` | `10016` | 468.88ms | ✅ فعال |
| 2 | `31.40.204.250` | `80` | 387.53ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 220.61ms | ✅ فعال |
| 4 | `34.44.49.215` | `80` | 26.26ms | ✅ فعال |
| 5 | `23.95.242.79` | `3128` | 36.64ms | ✅ فعال |
