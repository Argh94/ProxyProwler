...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:10 08-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `176.101.220.90` | `8090` | 181.13ms | ✅ فعال |
| 2 | `48.210.225.96` | `80` | 106.92ms | ✅ فعال |
| 3 | `8.211.195.139` | `202` | 147.93ms | ✅ فعال |
| 4 | `167.103.31.122` | `8800` | 236.24ms | ✅ فعال |
| 5 | `16.78.119.130` | `443` | 189.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.167.27` | `8080` | 67.40ms | ✅ فعال |
| 2 | `89.188.242.243` | `80` | 1300.87ms | ✅ فعال |
| 3 | `45.43.64.126` | `6384` | 149.07ms | ✅ فعال |
| 4 | `8.210.17.35` | `1337` | 150.82ms | ✅ فعال |
| 5 | `217.69.121.3` | `5668` | 149.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 111.59ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 1004.56ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 166.66ms | ✅ فعال |
| 4 | `202.154.18.1` | `8080` | 201.42ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 2212.03ms | ✅ فعال |
