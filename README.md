...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:02 02-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `167.103.34.108` | `8800` | 214.26ms | ✅ فعال |
| 2 | `172.200.72.48` | `80` | 6.33ms | ✅ فعال |
| 3 | `8.213.197.208` | `8443` | 244.64ms | ✅ فعال |
| 4 | `31.59.20.235` | `6813` | 77.50ms | ✅ فعال |
| 5 | `184.178.172.14` | `4145` | 80.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.205.172` | `9098` | 191.55ms | ✅ فعال |
| 2 | `8.211.194.85` | `193` | 78.27ms | ✅ فعال |
| 3 | `8.211.49.86` | `2000` | 94.14ms | ✅ فعال |
| 4 | `121.126.185.63` | `25152` | 268.17ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 123.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 163.38ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 219.63ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 389.85ms | ✅ فعال |
