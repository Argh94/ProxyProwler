...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:03 12-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.194.33.12` | `30002` | 172.27ms | ✅ فعال |
| 2 | `103.179.189.64` | `9191` | 197.16ms | ✅ فعال |
| 3 | `95.3.69.222` | `8080` | 200.26ms | ✅ فعال |
| 4 | `78.109.200.168` | `9910` | 365.60ms | ✅ فعال |
| 5 | `8.220.197.112` | `30001` | 129.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.188.245.98` | `52837` | 212.29ms | ✅ فعال |
| 2 | `137.66.1.45` | `80` | 8.94ms | ✅ فعال |
| 3 | `136.0.186.213` | `6574` | 69.51ms | ✅ فعال |
| 4 | `186.33.45.220` | `999` | 1169.22ms | ✅ فعال |
| 5 | `98.170.57.231` | `4145` | 141.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 168.33ms | ✅ فعال |
| 2 | `103.137.84.17` | `84` | 2320.35ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 185.48ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 183.78ms | ✅ فعال |
