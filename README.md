...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 01:38 25-06-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.167.35` | `80` | 5.40ms | ✅ فعال |
| 2 | `154.16.146.43` | `80` | 27.23ms | ✅ فعال |
| 3 | `172.64.90.0` | `80` | 5.49ms | ✅ فعال |
| 4 | `185.176.24.222` | `80` | 5.64ms | ✅ فعال |
| 5 | `199.34.229.162` | `80` | 5.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.222.157` | `104` | 263.75ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 1320.17ms | ✅ فعال |
| 3 | `101.200.158.109` | `3128` | 212.08ms | ✅ فعال |
| 4 | `101.132.222.120` | `80` | 239.95ms | ✅ فعال |
| 5 | `198.74.51.79` | `8888` | 68.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 5.49ms | ✅ فعال |
| 2 | `45.85.118.80` | `80` | 5.66ms | ✅ فعال |
| 3 | `104.17.190.13` | `80` | 5.47ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 5.42ms | ✅ فعال |
| 5 | `69.84.182.59` | `80` | 5.72ms | ✅ فعال |
