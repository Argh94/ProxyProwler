...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:01 12-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `183.215.23.242` | `9091` | 244.58ms | ✅ فعال |
| 2 | `45.12.151.226` | `2829` | 125.71ms | ✅ فعال |
| 3 | `203.110.240.156` | `80` | 245.34ms | ✅ فعال |
| 4 | `47.91.65.23` | `3128` | 109.94ms | ✅ فعال |
| 5 | `8.211.51.115` | `80` | 109.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.87.74` | `8008` | 266.47ms | ✅ فعال |
| 2 | `198.105.111.225` | `6903` | 96.60ms | ✅ فعال |
| 3 | `132.226.7.23` | `30277` | 150.28ms | ✅ فعال |
| 4 | `193.122.105.251` | `65535` | 222.06ms | ✅ فعال |
| 5 | `8.213.215.187` | `202` | 229.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 205.58ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 140.70ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 212.42ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 230.85ms | ✅ فعال |
