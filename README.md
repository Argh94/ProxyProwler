...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:15 04-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `109.194.34.246` | `8082` | 227.73ms | ✅ فعال |
| 2 | `178.130.47.41` | `1082` | 23.44ms | ✅ فعال |
| 3 | `47.238.128.246` | `17` | 148.56ms | ✅ فعال |
| 4 | `45.61.129.165` | `9050` | 24.98ms | ✅ فعال |
| 5 | `8.215.3.250` | `3128` | 183.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `164.52.11.194` | `18080` | 1144.70ms | ✅ فعال |
| 2 | `8.215.3.250` | `3128` | 183.06ms | ✅ فعال |
| 3 | `109.194.34.246` | `8082` | 228.00ms | ✅ فعال |
| 4 | `104.232.211.241` | `5854` | 41.98ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 252.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 68.03ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 227.23ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 2221.29ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 63.72ms | ✅ فعال |
| 5 | `177.234.217.85` | `999` | 126.17ms | ✅ فعال |
