...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:25 27-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.14` | `4145` | 92.70ms | ✅ فعال |
| 2 | `103.84.95.54` | `7890` | 187.07ms | ✅ فعال |
| 3 | `23.26.94.90` | `6072` | 66.73ms | ✅ فعال |
| 4 | `8.211.194.78` | `6379` | 699.76ms | ✅ فعال |
| 5 | `52.229.30.3` | `80` | 45.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `128.199.104.190` | `41354` | 1271.48ms | ✅ فعال |
| 2 | `199.180.8.133` | `5844` | 33.30ms | ✅ فعال |
| 3 | `209.13.186.20` | `80` | 179.26ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 506.04ms | ✅ فعال |
| 5 | `177.66.43.189` | `4145` | 2234.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 206.14ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 688.05ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 140.38ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 1156.54ms | ✅ فعال |
| 5 | `179.96.28.58` | `80` | 153.87ms | ✅ فعال |
