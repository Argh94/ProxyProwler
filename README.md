...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:37 12-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `178.212.144.7` | `80` | 168.53ms | ✅ فعال |
| 2 | `167.103.31.122` | `8800` | 235.18ms | ✅ فعال |
| 3 | `123.30.154.171` | `7777` | 202.88ms | ✅ فعال |
| 4 | `162.220.247.229` | `6824` | 140.71ms | ✅ فعال |
| 5 | `141.253.118.174` | `80` | 151.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.150.1.87` | `80` | 186.63ms | ✅ فعال |
| 2 | `103.146.170.65` | `5678` | 222.64ms | ✅ فعال |
| 3 | `168.232.213.9` | `4153` | 167.33ms | ✅ فعال |
| 4 | `8.211.194.78` | `4002` | 144.68ms | ✅ فعال |
| 5 | `147.185.161.241` | `80` | 1.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 174.19ms | ✅ فعال |
| 2 | `79.121.102.227` | `8080` | 186.79ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 723.70ms | ✅ فعال |
