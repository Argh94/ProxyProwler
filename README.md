...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:41 29-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `146.56.185.39` | `10800` | 141.18ms | ✅ فعال |
| 2 | `154.6.83.127` | `6598` | 60.47ms | ✅ فعال |
| 3 | `137.184.239.147` | `1080` | 1023.34ms | ✅ فعال |
| 4 | `45.88.174.195` | `8080` | 135.22ms | ✅ فعال |
| 5 | `142.111.239.233` | `5811` | 16.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.197.190` | `1011` | 154.86ms | ✅ فعال |
| 2 | `65.108.203.36` | `18080` | 164.39ms | ✅ فعال |
| 3 | `97.213.76.123` | `80` | 78.05ms | ✅ فعال |
| 4 | `47.91.121.127` | `3129` | 244.75ms | ✅ فعال |
| 5 | `64.64.152.248` | `39593` | 40.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.212.237.47` | `3128` | 144.06ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 56.44ms | ✅ فعال |
| 3 | `185.196.182.22` | `8080` | 1192.07ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 244.20ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 166.38ms | ✅ فعال |
