...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:55 09-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.20.37.49` | `80` | 17.48ms | ✅ فعال |
| 2 | `172.67.229.20` | `80` | 17.50ms | ✅ فعال |
| 3 | `90.156.169.163` | `80` | 164.80ms | ✅ فعال |
| 4 | `67.227.1.198` | `6479` | 49.60ms | ✅ فعال |
| 5 | `185.162.228.206` | `80` | 17.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.85` | `10000` | 690.81ms | ✅ فعال |
| 2 | `202.40.181.220` | `31247` | 1334.65ms | ✅ فعال |
| 3 | `103.65.237.92` | `5678` | 243.31ms | ✅ فعال |
| 4 | `8.213.195.191` | `9091` | 359.89ms | ✅ فعال |
| 5 | `51.158.105.157` | `16379` | 128.60ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (41 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.104.244` | `57745` | 197.85ms | ✅ فعال |
| 2 | `78.12.223.246` | `46083` | 44.95ms | ✅ فعال |
| 3 | `13.231.159.110` | `8834` | 122.24ms | ✅ فعال |
| 4 | `15.160.186.74` | `8791` | 137.36ms | ✅ فعال |
| 5 | `47.97.24.122` | `8222` | 226.48ms | ✅ فعال |
