...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 11-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.0.3` | `80` | 17.53ms | ✅ فعال |
| 2 | `104.24.56.144` | `80` | 17.41ms | ✅ فعال |
| 3 | `104.27.26.84` | `80` | 18.10ms | ✅ فعال |
| 4 | `31.211.142.115` | `8192` | 154.37ms | ✅ فعال |
| 5 | `104.25.97.105` | `80` | 17.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.128.246` | `1000` | 378.33ms | ✅ فعال |
| 2 | `81.12.157.98` | `5678` | 167.06ms | ✅ فعال |
| 3 | `31.42.2.113` | `5678` | 2237.80ms | ✅ فعال |
| 4 | `79.106.170.126` | `4145` | 179.40ms | ✅ فعال |
| 5 | `203.189.159.241` | `1080` | 213.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `54.154.27.41` | `5555` | 108.10ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 43.52ms | ✅ فعال |
| 3 | `78.12.82.74` | `8505` | 45.16ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 1165.54ms | ✅ فعال |
| 5 | `103.39.49.156` | `3128` | 223.98ms | ✅ فعال |
