...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 13-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `209.46.30.227` | `80` | 5.89ms | ✅ فعال |
| 2 | `104.18.40.80` | `80` | 5.70ms | ✅ فعال |
| 3 | `104.17.62.250` | `80` | 5.76ms | ✅ فعال |
| 4 | `185.148.104.210` | `80` | 5.97ms | ✅ فعال |
| 5 | `104.27.10.149` | `80` | 6.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 214.75ms | ✅ فعال |
| 2 | `104.233.53.74` | `3199` | 27.34ms | ✅ فعال |
| 3 | `8.211.194.85` | `144` | 172.49ms | ✅ فعال |
| 4 | `51.20.192.194` | `13327` | 105.17ms | ✅ فعال |
| 5 | `27.66.100.236` | `1080` | 246.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 234.57ms | ✅ فعال |
| 2 | `78.12.82.74` | `2025` | 56.69ms | ✅ فعال |
| 3 | `51.16.49.113` | `9168` | 144.43ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 6.25ms | ✅ فعال |
| 5 | `5.252.33.13` | `2025` | 225.63ms | ✅ فعال |
