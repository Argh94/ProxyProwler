...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:17 01-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.43.179.212` | `80` | 18.80ms | ✅ فعال |
| 2 | `104.24.191.218` | `80` | 18.37ms | ✅ فعال |
| 3 | `104.21.30.85` | `80` | 18.71ms | ✅ فعال |
| 4 | `104.21.233.199` | `80` | 18.64ms | ✅ فعال |
| 5 | `162.220.247.78` | `6673` | 120.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.93.202.130` | `3128` | 54.84ms | ✅ فعال |
| 2 | `84.21.172.174` | `4145` | 183.62ms | ✅ فعال |
| 3 | `8.213.128.6` | `4444` | 143.82ms | ✅ فعال |
| 4 | `16.51.157.105` | `7219` | 172.16ms | ✅ فعال |
| 5 | `192.111.130.2` | `4145` | 77.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.25.125` | `9177` | 209.56ms | ✅ فعال |
| 2 | `43.208.25.125` | `13589` | 214.67ms | ✅ فعال |
| 3 | `18.183.141.82` | `52996` | 120.18ms | ✅ فعال |
| 4 | `51.85.49.118` | `8055` | 186.83ms | ✅ فعال |
| 5 | `78.12.143.148` | `59092` | 45.77ms | ✅ فعال |
