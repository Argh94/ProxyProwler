...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 14-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.170.166.111` | `80` | 17.73ms | ✅ فعال |
| 2 | `104.25.144.32` | `80` | 17.80ms | ✅ فعال |
| 3 | `104.24.146.182` | `80` | 17.70ms | ✅ فعال |
| 4 | `185.148.105.181` | `80` | 17.44ms | ✅ فعال |
| 5 | `154.83.2.172` | `80` | 17.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.104.62.128` | `5000` | 226.17ms | ✅ فعال |
| 2 | `8.220.205.172` | `1080` | 155.41ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 236.96ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 123.17ms | ✅ فعال |
| 5 | `39.104.79.145` | `1234` | 222.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.41.33` | `32718` | 201.71ms | ✅ فعال |
| 2 | `51.44.217.188` | `54000` | 130.58ms | ✅ فعال |
| 3 | `16.78.82.73` | `489` | 201.43ms | ✅ فعال |
| 4 | `157.175.43.137` | `908` | 210.32ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 190.42ms | ✅ فعال |
