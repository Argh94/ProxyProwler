...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:25 27-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `65.108.203.35` | `28080` | 119.01ms | ✅ فعال |
| 2 | `95.216.49.153` | `80` | 118.90ms | ✅ فعال |
| 3 | `104.238.30.37` | `59741` | 104.32ms | ✅ فعال |
| 4 | `72.11.149.12` | `6005` | 23.64ms | ✅ فعال |
| 5 | `212.33.248.45` | `1080` | 137.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.228.193` | `4145` | 103.23ms | ✅ فعال |
| 2 | `98.188.47.150` | `4145` | 74.41ms | ✅ فعال |
| 3 | `47.91.110.148` | `9090` | 187.55ms | ✅ فعال |
| 4 | `49.0.246.130` | `6789` | 196.64ms | ✅ فعال |
| 5 | `197.221.249.196` | `80` | 1346.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.79.135.131` | `8080` | 232.61ms | ✅ فعال |
| 2 | `38.60.196.214` | `80` | 79.93ms | ✅ فعال |
| 3 | `45.12.151.226` | `2828` | 150.50ms | ✅ فعال |
| 4 | `23.247.136.254` | `80` | 76.03ms | ✅ فعال |
| 5 | `47.238.203.170` | `50000` | 196.10ms | ✅ فعال |
