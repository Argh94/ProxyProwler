...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:12 12-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `143.198.135.176` | `80` | 57.23ms | ✅ فعال |
| 2 | `81.10.234.234` | `80` | 128.14ms | ✅ فعال |
| 3 | `98.178.72.21` | `10919` | 103.09ms | ✅ فعال |
| 4 | `191.96.130.188` | `5951` | 55.68ms | ✅ فعال |
| 5 | `3.213.157.4` | `3128` | 21.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.208.84.236` | `7657` | 96.92ms | ✅ فعال |
| 2 | `199.180.9.175` | `6195` | 35.92ms | ✅ فعال |
| 3 | `46.188.2.42` | `5678` | 142.54ms | ✅ فعال |
| 4 | `182.160.16.234` | `8020` | 248.75ms | ✅ فعال |
| 5 | `47.250.159.65` | `8008` | 219.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.191.203.161` | `80` | 245.87ms | ✅ فعال |
| 2 | `37.27.100.107` | `443` | 132.29ms | ✅ فعال |
| 3 | `34.44.49.215` | `80` | 19.84ms | ✅ فعال |
| 4 | `41.191.203.160` | `80` | 250.45ms | ✅ فعال |
| 5 | `41.191.203.167` | `80` | 243.75ms | ✅ فعال |
