...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:47 10-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.205.172` | `80` | 750.12ms | ✅ فعال |
| 2 | `153.0.171.163` | `8085` | 209.57ms | ✅ فعال |
| 3 | `107.181.148.209` | `6069` | 135.38ms | ✅ فعال |
| 4 | `139.159.99.242` | `8080` | 194.22ms | ✅ فعال |
| 5 | `222.234.52.105` | `80` | 145.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.170.57.231` | `4145` | 138.02ms | ✅ فعال |
| 2 | `160.123.255.71` | `80` | 12.09ms | ✅ فعال |
| 3 | `104.239.105.202` | `6732` | 27.62ms | ✅ فعال |
| 4 | `39.102.208.189` | `8008` | 211.82ms | ✅ فعال |
| 5 | `8.211.194.78` | `8080` | 143.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 118.56ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 156.54ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 177.25ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 1278.94ms | ✅ فعال |
