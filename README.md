...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:40 26-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `12.50.107.222` | `80` | 42.30ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 205.10ms | ✅ فعال |
| 3 | `104.143.226.179` | `5782` | 89.99ms | ✅ فعال |
| 4 | `46.17.47.48` | `80` | 157.85ms | ✅ فعال |
| 5 | `183.240.46.42` | `80` | 230.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `120.79.7.173` | `8499` | 258.42ms | ✅ فعال |
| 2 | `8.209.253.237` | `8499` | 148.13ms | ✅ فعال |
| 3 | `72.195.34.35` | `27360` | 96.00ms | ✅ فعال |
| 4 | `16.78.219.183` | `11267` | 223.56ms | ✅ فعال |
| 5 | `192.111.138.29` | `4145` | 59.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.191.203.162` | `80` | 243.69ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 207.19ms | ✅ فعال |
| 3 | `45.151.182.9` | `3128` | 143.35ms | ✅ فعال |
| 4 | `35.202.49.74` | `80` | 12.44ms | ✅ فعال |
| 5 | `45.12.151.226` | `2828` | 120.80ms | ✅ فعال |
