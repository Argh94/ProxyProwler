...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:30 20-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.137.43.0` | `1081` | 161.44ms | ✅ فعال |
| 2 | `45.43.81.215` | `5862` | 138.19ms | ✅ فعال |
| 3 | `94.233.120.194` | `1080` | 1284.34ms | ✅ فعال |
| 4 | `23.238.10.32` | `1080` | 8.90ms | ✅ فعال |
| 5 | `66.163.118.99` | `10006` | 160.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.40.179.18` | `4145` | 2276.95ms | ✅ فعال |
| 2 | `8.213.128.6` | `8800` | 131.32ms | ✅ فعال |
| 3 | `82.114.181.147` | `9050` | 525.77ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 129.96ms | ✅ فعال |
| 5 | `170.81.108.153` | `4153` | 1226.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 168.76ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 66.31ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 167.35ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 191.57ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 66.41ms | ✅ فعال |
