...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:44 24-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.247.136.254` | `80` | 42.50ms | ✅ فعال |
| 2 | `168.187.5.230` | `587` | 212.84ms | ✅ فعال |
| 3 | `206.123.156.215` | `5526` | 145.48ms | ✅ فعال |
| 4 | `183.110.216.159` | `8090` | 143.63ms | ✅ فعال |
| 5 | `103.65.237.92` | `5678` | 1215.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.92` | `9098` | 142.42ms | ✅ فعال |
| 2 | `8.213.222.157` | `8119` | 205.47ms | ✅ فعال |
| 3 | `5.95.121.180` | `4153` | 149.26ms | ✅ فعال |
| 4 | `178.171.106.94` | `5433` | 160.08ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 141.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 183.94ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 164.57ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 182.91ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 142.87ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 2279.50ms | ✅ فعال |
