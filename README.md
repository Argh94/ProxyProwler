...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:28 11-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.64.199.82` | `4145` | 109.94ms | ✅ فعال |
| 2 | `200.8.235.10` | `4145` | 105.14ms | ✅ فعال |
| 3 | `199.66.183.226` | `4145` | 64.39ms | ✅ فعال |
| 4 | `195.191.158.128` | `8080` | 136.84ms | ✅ فعال |
| 5 | `185.79.243.153` | `38431` | 116.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `128.199.104.190` | `41354` | 222.09ms | ✅ فعال |
| 2 | `98.103.88.158` | `46104` | 1057.25ms | ✅ فعال |
| 3 | `46.8.60.2` | `1080` | 2223.66ms | ✅ فعال |
| 4 | `160.238.65.6` | `3128` | 1162.77ms | ✅ فعال |
| 5 | `47.91.110.148` | `20` | 188.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.130.61.61` | `8081` | 226.03ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 223.27ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 141.96ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 208.53ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 134.77ms | ✅ فعال |
