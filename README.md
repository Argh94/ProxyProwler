...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:35 15-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `65.21.90.27` | `830` | 1206.48ms | ✅ فعال |
| 2 | `65.21.90.27` | `1009` | 173.12ms | ✅ فعال |
| 3 | `65.21.90.27` | `988` | 155.52ms | ✅ فعال |
| 4 | `172.200.72.48` | `80` | 34.39ms | ✅ فعال |
| 5 | `38.145.220.11` | `8447` | 37.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.236.247.56` | `8088` | 40.54ms | ✅ فعال |
| 2 | `107.181.148.13` | `5873` | 113.75ms | ✅ فعال |
| 3 | `67.227.37.117` | `5659` | 49.02ms | ✅ فعال |
| 4 | `47.91.109.17` | `1081` | 197.55ms | ✅ فعال |
| 5 | `86.38.154.131` | `5774` | 108.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 135.68ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 222.17ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 130.69ms | ✅ فعال |
| 4 | `115.127.95.82` | `8080` | 261.07ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 208.99ms | ✅ فعال |
