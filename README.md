...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:28 02-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `2.78.60.10` | `3129` | 333.80ms | ✅ فعال |
| 2 | `38.65.94.102` | `1080` | 50.32ms | ✅ فعال |
| 3 | `120.133.82.62` | `44158` | 2473.79ms | ✅ فعال |
| 4 | `103.239.52.100` | `1080` | 2252.63ms | ✅ فعال |
| 5 | `72.195.34.41` | `4145` | 110.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.220` | `4145` | 105.41ms | ✅ فعال |
| 2 | `125.141.133.46` | `5566` | 178.11ms | ✅ فعال |
| 3 | `192.252.216.81` | `4145` | 70.22ms | ✅ فعال |
| 4 | `15.165.71.55` | `1080` | 171.81ms | ✅ فعال |
| 5 | `191.101.26.85` | `5824` | 48.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 109.62ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 21.01ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 134.37ms | ✅ فعال |
| 4 | `110.164.175.110` | `8080` | 233.34ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 17.44ms | ✅ فعال |
