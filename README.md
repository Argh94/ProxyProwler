...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:56 30-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.22.17.4` | `9988` | 244.47ms | ✅ فعال |
| 2 | `192.252.209.155` | `14455` | 119.64ms | ✅ فعال |
| 3 | `125.141.133.49` | `5566` | 170.22ms | ✅ فعال |
| 4 | `143.198.135.176` | `80` | 48.60ms | ✅ فعال |
| 5 | `41.75.84.86` | `4153` | 179.97ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (36 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.6.128.191` | `6161` | 47.96ms | ✅ فعال |
| 2 | `103.18.47.79` | `4145` | 228.55ms | ✅ فعال |
| 3 | `182.155.254.159` | `80` | 182.05ms | ✅ فعال |
| 4 | `72.49.49.11` | `31034` | 84.63ms | ✅ فعال |
| 5 | `85.190.106.223` | `1080` | 113.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 209.70ms | ✅ فعال |
| 2 | `103.173.230.94` | `8080` | 223.70ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 1275.00ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 137.47ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 146.44ms | ✅ فعال |
