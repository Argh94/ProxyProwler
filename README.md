...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:02 13-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 280.95ms | ✅ فعال |
| 2 | `103.146.137.53` | `1081` | 220.40ms | ✅ فعال |
| 3 | `141.98.85.49` | `1080` | 142.05ms | ✅ فعال |
| 4 | `138.199.25.13` | `3908` | 180.92ms | ✅ فعال |
| 5 | `23.226.132.83` | `10808` | 39.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.13.147.241` | `5678` | 2173.35ms | ✅ فعال |
| 2 | `104.239.106.125` | `5770` | 17.94ms | ✅ فعال |
| 3 | `103.146.137.101` | `1081` | 1251.04ms | ✅ فعال |
| 4 | `184.178.172.26` | `4145` | 115.99ms | ✅ فعال |
| 5 | `74.119.144.60` | `4145` | 76.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 182.45ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 195.81ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 165.91ms | ✅ فعال |
