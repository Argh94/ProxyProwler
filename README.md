...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:12 01-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.115` | `80` | 5.91ms | ✅ فعال |
| 2 | `139.162.78.109` | `8080` | 161.63ms | ✅ فعال |
| 3 | `104.25.1.251` | `80` | 5.95ms | ✅ فعال |
| 4 | `185.193.28.94` | `80` | 6.07ms | ✅ فعال |
| 5 | `156.244.11.6` | `8888` | 177.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.160.16.234` | `8020` | 237.46ms | ✅ فعال |
| 2 | `103.146.170.244` | `5678` | 240.18ms | ✅ فعال |
| 3 | `101.132.252.152` | `8080` | 243.52ms | ✅ فعال |
| 4 | `5.199.166.236` | `9065` | 223.68ms | ✅ فعال |
| 5 | `46.8.60.2` | `1080` | 166.01ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (38 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.210.113.32` | `8123` | 162.08ms | ✅ فعال |
| 2 | `8.212.177.126` | `8080` | 247.84ms | ✅ فعال |
| 3 | `103.145.57.25` | `8080` | 254.64ms | ✅ فعال |
| 4 | `157.175.147.228` | `8028` | 190.21ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 6.04ms | ✅ فعال |
