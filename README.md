...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 22-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.149.238` | `6379` | 723.72ms | ✅ فعال |
| 2 | `45.80.111.183` | `80` | 2.42ms | ✅ فعال |
| 3 | `45.80.108.60` | `80` | 1.86ms | ✅ فعال |
| 4 | `185.176.26.79` | `80` | 2.44ms | ✅ فعال |
| 5 | `95.173.218.72` | `8081` | 216.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `8889` | 794.75ms | ✅ فعال |
| 2 | `46.151.27.219` | `1080` | 99.51ms | ✅ فعال |
| 3 | `39.104.79.145` | `1234` | 249.91ms | ✅ فعال |
| 4 | `198.8.94.170` | `4145` | 62.98ms | ✅ فعال |
| 5 | `51.16.49.113` | `50001` | 159.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.16.199` | `1515` | 236.41ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 17.29ms | ✅ فعال |
| 3 | `110.41.83.41` | `8790` | 270.17ms | ✅ فعال |
| 4 | `18.191.200.48` | `3128` | 10.36ms | ✅ فعال |
| 5 | `40.192.2.151` | `2698` | 230.07ms | ✅ فعال |
