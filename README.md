...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:38 29-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.175.31.195` | `4145` | 88.45ms | ✅ فعال |
| 2 | `95.211.174.135` | `3128` | 82.20ms | ✅ فعال |
| 3 | `72.195.114.169` | `4145` | 86.50ms | ✅ فعال |
| 4 | `147.161.246.39` | `33333` | 104.21ms | ✅ فعال |
| 5 | `98.170.57.231` | `4145` | 85.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.17.153.178` | `8080` | 124.87ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 225.97ms | ✅ فعال |
| 3 | `95.211.174.135` | `3128` | 84.19ms | ✅ فعال |
| 4 | `13.214.205.160` | `40448` | 222.59ms | ✅ فعال |
| 5 | `146.103.3.212` | `7265` | 83.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.209.219.244` | `8080` | 126.45ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 222.88ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 1281.63ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 119.64ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 236.05ms | ✅ فعال |
