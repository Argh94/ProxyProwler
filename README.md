...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:10 04-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.61.127.46` | `5985` | 16.25ms | ✅ فعال |
| 2 | `171.247.246.101` | `1080` | 213.58ms | ✅ فعال |
| 3 | `23.229.125.253` | `5522` | 42.98ms | ✅ فعال |
| 4 | `72.49.49.11` | `31034` | 114.63ms | ✅ فعال |
| 5 | `198.37.109.229` | `6336` | 36.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.67` | `14287` | 71.22ms | ✅ فعال |
| 2 | `112.198.22.122` | `80` | 1219.50ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 1186.43ms | ✅ فعال |
| 4 | `37.18.73.60` | `5566` | 154.68ms | ✅ فعال |
| 5 | `177.85.65.177` | `4153` | 2244.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 133.32ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 154.20ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 195.80ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 215.53ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 1292.03ms | ✅ فعال |
