...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 07-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `89.116.250.38` | `80` | 1.69ms | ✅ فعال |
| 2 | `185.193.28.43` | `80` | 1.42ms | ✅ فعال |
| 3 | `198.177.57.51` | `80` | 1.56ms | ✅ فعال |
| 4 | `172.67.70.49` | `80` | 2.29ms | ✅ فعال |
| 5 | `185.148.106.206` | `80` | 1.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.173.218.79` | `8082` | 168.63ms | ✅ فعال |
| 2 | `103.146.170.233` | `5678` | 215.77ms | ✅ فعال |
| 3 | `1.0.0.4` | `80` | 1.95ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 168.44ms | ✅ فعال |
| 5 | `45.39.17.21` | `5444` | 40.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.114.96.63` | `80` | 2.04ms | ✅ فعال |
| 2 | `89.116.250.4` | `80` | 1.88ms | ✅ فعال |
| 3 | `173.245.49.114` | `80` | 1.81ms | ✅ فعال |
| 4 | `206.238.236.139` | `80` | 1.58ms | ✅ فعال |
| 5 | `141.101.122.238` | `80` | 1.83ms | ✅ فعال |
