...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 23-08-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (25 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.197.208` | `9098` | 933.17ms | ✅ فعال |
| 2 | `111.61.73.175` | `7302` | 220.24ms | ✅ فعال |
| 3 | `185.18.250.135` | `80` | 6.04ms | ✅ فعال |
| 4 | `23.227.60.38` | `80` | 5.91ms | ✅ فعال |
| 5 | `8.213.128.6` | `8082` | 188.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.205.61.143` | `80` | 211.85ms | ✅ فعال |
| 2 | `113.53.91.26` | `4153` | 2290.66ms | ✅ فعال |
| 3 | `31.58.19.89` | `6361` | 75.17ms | ✅ فعال |
| 4 | `103.83.252.61` | `1080` | 232.12ms | ✅ فعال |
| 5 | `174.64.199.79` | `4145` | 72.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `120.92.212.16` | `8890` | 282.35ms | ✅ فعال |
| 2 | `147.75.68.201` | `80` | 67.89ms | ✅ فعال |
| 3 | `82.196.12.202` | `7777` | 88.84ms | ✅ فعال |
| 4 | `190.60.37.245` | `999` | 2149.04ms | ✅ فعال |
| 5 | `13.61.155.35` | `1000` | 106.61ms | ✅ فعال |
