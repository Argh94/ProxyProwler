...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 08-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.37.187` | `80` | 23.30ms | ✅ فعال |
| 2 | `185.148.105.243` | `80` | 2.92ms | ✅ فعال |
| 3 | `160.153.1.195` | `80` | 2.54ms | ✅ فعال |
| 4 | `47.238.130.212` | `8004` | 790.21ms | ✅ فعال |
| 5 | `108.162.194.167` | `80` | 1.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.216.186.250` | `4153` | 251.68ms | ✅ فعال |
| 2 | `47.238.130.212` | `8004` | 197.21ms | ✅ فعال |
| 3 | `58.65.167.165` | `4145` | 1298.32ms | ✅ فعال |
| 4 | `8.215.3.250` | `8008` | 217.73ms | ✅ فعال |
| 5 | `47.113.219.226` | `59394` | 253.21ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (43 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 1130.07ms | ✅ فعال |
| 2 | `40.192.39.118` | `1080` | 235.03ms | ✅ فعال |
| 3 | `40.172.232.213` | `130` | 197.88ms | ✅ فعال |
| 4 | `18.183.141.82` | `416` | 140.86ms | ✅ فعال |
| 5 | `86.109.3.23` | `10017` | 514.54ms | ✅ فعال |
