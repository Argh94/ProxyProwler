...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 12-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.174.58.36` | `5598` | 37.80ms | ✅ فعال |
| 2 | `104.17.117.212` | `80` | 16.52ms | ✅ فعال |
| 3 | `191.96.117.128` | `6883` | 49.07ms | ✅ فعال |
| 4 | `172.67.182.5` | `80` | 17.17ms | ✅ فعال |
| 5 | `108.162.198.119` | `80` | 14.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.20.160` | `6738` | 98.95ms | ✅ فعال |
| 2 | `47.116.126.57` | `8443` | 228.14ms | ✅ فعال |
| 3 | `8.213.129.20` | `20201` | 156.57ms | ✅ فعال |
| 4 | `45.8.211.107` | `80` | 11.86ms | ✅ فعال |
| 5 | `8.130.36.245` | `8080` | 278.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.192.3.100` | `331` | 245.60ms | ✅ فعال |
| 2 | `157.230.220.25` | `4857` | 1054.43ms | ✅ فعال |
| 3 | `13.60.209.160` | `10965` | 129.95ms | ✅ فعال |
| 4 | `78.12.82.74` | `2025` | 54.34ms | ✅ فعال |
| 5 | `157.175.196.122` | `8535` | 195.64ms | ✅ فعال |
