...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:24 05-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.143.226.220` | `5823` | 84.04ms | ✅ فعال |
| 2 | `20.243.211.46` | `3128` | 152.34ms | ✅ فعال |
| 3 | `36.138.53.26` | `10017` | 216.60ms | ✅ فعال |
| 4 | `52.229.30.3` | `80` | 66.83ms | ✅ فعال |
| 5 | `162.220.246.39` | `6323` | 83.61ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (60 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `24.249.199.4` | `4145` | 73.19ms | ✅ فعال |
| 2 | `82.137.90.192` | `80` | 160.46ms | ✅ فعال |
| 3 | `8.208.84.236` | `7657` | 193.61ms | ✅ فعال |
| 4 | `72.223.188.67` | `4145` | 73.59ms | ✅ فعال |
| 5 | `104.143.226.220` | `5823` | 84.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.81.205.173` | `80` | 1025.60ms | ✅ فعال |
| 2 | `27.34.242.98` | `80` | 2325.95ms | ✅ فعال |
| 3 | `14.56.118.234` | `3128` | 464.18ms | ✅ فعال |
| 4 | `46.47.197.210` | `3128` | 111.98ms | ✅ فعال |
| 5 | `8.220.204.92` | `4145` | 185.08ms | ✅ فعال |
