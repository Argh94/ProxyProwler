...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 26-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `136.0.118.39` | `6411` | 5.98ms | ✅ فعال |
| 2 | `104.19.7.209` | `80` | 1.83ms | ✅ فعال |
| 3 | `147.185.161.24` | `80` | 2.54ms | ✅ فعال |
| 4 | `104.18.34.65` | `80` | 2.75ms | ✅ فعال |
| 5 | `185.193.30.119` | `80` | 2.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.36.163` | `8888` | 268.02ms | ✅ فعال |
| 2 | `184.178.172.18` | `15280` | 95.12ms | ✅ فعال |
| 3 | `136.0.118.39` | `6411` | 3.20ms | ✅ فعال |
| 4 | `47.243.175.55` | `443` | 193.63ms | ✅ فعال |
| 5 | `45.135.139.76` | `6379` | 99.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.20.184.59` | `80` | 119.68ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 1260.53ms | ✅ فعال |
| 3 | `43.198.99.209` | `8496` | 197.10ms | ✅ فعال |
| 4 | `13.212.81.49` | `957` | 211.91ms | ✅ فعال |
| 5 | `54.180.143.12` | `37751` | 169.99ms | ✅ فعال |
