...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:01 07-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.100.220.22` | `1080` | 168.64ms | ✅ فعال |
| 2 | `47.238.128.246` | `45` | 139.01ms | ✅ فعال |
| 3 | `66.42.224.229` | `41679` | 124.93ms | ✅ فعال |
| 4 | `104.171.133.81` | `1080` | 183.53ms | ✅ فعال |
| 5 | `190.93.188.195` | `1080` | 1143.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.149.238` | `31281` | 64.77ms | ✅ فعال |
| 2 | `185.226.204.69` | `5622` | 143.17ms | ✅ فعال |
| 3 | `43.164.136.189` | `1080` | 122.37ms | ✅ فعال |
| 4 | `153.80.240.37` | `8080` | 1214.63ms | ✅ فعال |
| 5 | `202.5.50.151` | `1080` | 207.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 173.43ms | ✅ فعال |
| 2 | `103.102.85.1` | `8080` | 1275.04ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 183.25ms | ✅ فعال |
