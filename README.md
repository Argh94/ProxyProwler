...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:11 22-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.249.65` | `4145` | 59.74ms | ✅ فعال |
| 2 | `104.168.25.121` | `5803` | 59.33ms | ✅ فعال |
| 3 | `217.182.195.221` | `30006` | 85.04ms | ✅ فعال |
| 4 | `1.227.171.67` | `1080` | 193.39ms | ✅ فعال |
| 5 | `68.1.210.189` | `4145` | 87.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.50.175.1` | `3129` | 1.89ms | ✅ فعال |
| 2 | `91.223.52.141` | `5678` | 111.72ms | ✅ فعال |
| 3 | `151.243.153.157` | `8118` | 1163.38ms | ✅ فعال |
| 4 | `68.1.210.189` | `4145` | 87.65ms | ✅ فعال |
| 5 | `46.8.60.2` | `1080` | 161.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 243.77ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 119.92ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 220.04ms | ✅ فعال |
| 4 | `177.234.217.83` | `999` | 100.26ms | ✅ فعال |
| 5 | `51.79.207.21` | `8080` | 219.92ms | ✅ فعال |
