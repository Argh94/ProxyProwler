...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:02 26-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.89.3` | `3128` | 253.11ms | ✅ فعال |
| 2 | `23.95.150.44` | `6013` | 18.88ms | ✅ فعال |
| 3 | `43.156.199.63` | `8080` | 230.93ms | ✅ فعال |
| 4 | `195.135.255.98` | `1080` | 108.40ms | ✅ فعال |
| 5 | `72.205.0.67` | `4145` | 87.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.60` | `27391` | 84.98ms | ✅ فعال |
| 2 | `31.59.33.220` | `6796` | 76.40ms | ✅ فعال |
| 3 | `199.58.184.97` | `4145` | 60.09ms | ✅ فعال |
| 4 | `52.34.243.150` | `8080` | 77.61ms | ✅ فعال |
| 5 | `47.74.46.81` | `8081` | 159.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 236.28ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 157.13ms | ✅ فعال |
| 3 | `103.31.235.102` | `8080` | 235.18ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 228.80ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 122.26ms | ✅ فعال |
