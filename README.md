...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 10-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `142.111.48.227` | `7004` | 51.69ms | ✅ فعال |
| 2 | `65.108.203.36` | `28080` | 129.60ms | ✅ فعال |
| 3 | `172.67.151.67` | `80` | 37.00ms | ✅ فعال |
| 4 | `209.46.30.43` | `80` | 1.74ms | ✅ فعال |
| 5 | `199.34.229.105` | `80` | 2.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.121.183.107` | `100` | 238.82ms | ✅ فعال |
| 2 | `170.247.224.222` | `4153` | 39.87ms | ✅ فعال |
| 3 | `198.177.254.157` | `4145` | 67.48ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 231.69ms | ✅ فعال |
| 5 | `64.64.110.94` | `6617` | 30.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 2249.79ms | ✅ فعال |
| 2 | `4.149.153.123` | `3128` | 46.48ms | ✅ فعال |
| 3 | `43.216.1.13` | `47646` | 1228.93ms | ✅ فعال |
| 4 | `44.251.173.250` | `495` | 57.37ms | ✅ فعال |
| 5 | `43.217.141.124` | `52767` | 213.67ms | ✅ فعال |
