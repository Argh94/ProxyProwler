...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:59 02-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `212.42.203.152` | `6200` | 56.38ms | ✅ فعال |
| 2 | `67.201.35.145` | `4145` | 74.89ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 226.65ms | ✅ فعال |
| 4 | `45.43.64.107` | `6365` | 85.49ms | ✅ فعال |
| 5 | `45.43.64.220` | `6478` | 87.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `159.65.181.194` | `9056` | 11.48ms | ✅ فعال |
| 2 | `185.11.134.227` | `8443` | 98.05ms | ✅ فعال |
| 3 | `181.48.243.194` | `4153` | 1076.43ms | ✅ فعال |
| 4 | `216.26.243.63` | `3129` | 111.57ms | ✅ فعال |
| 5 | `46.107.230.122` | `1080` | 1144.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 7.45ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 121.68ms | ✅ فعال |
| 3 | `195.25.20.155` | `3128` | 88.44ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 10.50ms | ✅ فعال |
| 5 | `103.189.116.20` | `8080` | 245.22ms | ✅ فعال |
