...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:26 07-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `191.61.84.118` | `30588` | 165.61ms | ✅ فعال |
| 2 | `51.141.175.118` | `80` | 49.44ms | ✅ فعال |
| 3 | `116.171.106.111` | `3000` | 231.93ms | ✅ فعال |
| 4 | `38.145.208.210` | `8451` | 73.14ms | ✅ فعال |
| 5 | `98.178.72.30` | `4145` | 116.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `8443` | 134.42ms | ✅ فعال |
| 2 | `45.136.131.39` | `8443` | 48.18ms | ✅ فعال |
| 3 | `216.154.201.132` | `54321` | 34.48ms | ✅ فعال |
| 4 | `72.49.49.11` | `31034` | 180.43ms | ✅ فعال |
| 5 | `20.24.43.214` | `80` | 210.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 1173.03ms | ✅ فعال |
| 2 | `24.199.124.151` | `3128` | 1108.32ms | ✅ فعال |
| 3 | `202.154.19.7` | `8080` | 2306.54ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 214.28ms | ✅ فعال |
| 5 | `45.119.85.216` | `3128` | 244.89ms | ✅ فعال |
