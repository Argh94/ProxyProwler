...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 11-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.70.28` | `80` | 1.52ms | ✅ فعال |
| 2 | `185.162.228.165` | `80` | 1.54ms | ✅ فعال |
| 3 | `172.67.201.167` | `80` | 1.76ms | ✅ فعال |
| 4 | `173.245.58.127` | `80` | 1.33ms | ✅ فعال |
| 5 | `8.213.222.157` | `4000` | 194.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.106.216.202` | `3128` | 212.48ms | ✅ فعال |
| 2 | `39.104.62.128` | `5000` | 205.30ms | ✅ فعال |
| 3 | `185.216.105.253` | `6830` | 38.66ms | ✅ فعال |
| 4 | `8.130.34.44` | `9000` | 206.51ms | ✅ فعال |
| 5 | `8.208.84.236` | `7657` | 135.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.36.243.194` | `9239` | 155.04ms | ✅ فعال |
| 2 | `13.246.11.197` | `621` | 271.27ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 172.64ms | ✅ فعال |
| 4 | `162.240.154.26` | `3128` | 1070.43ms | ✅ فعال |
| 5 | `144.125.164.222` | `8080` | 0.99ms | ✅ فعال |
