...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 19:11 30-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.178.72.21` | `10919` | 86.98ms | ✅ فعال |
| 2 | `184.182.240.211` | `4145` | 85.51ms | ✅ فعال |
| 3 | `94.78.67.171` | `80` | 140.67ms | ✅ فعال |
| 4 | `45.43.70.143` | `6430` | 78.69ms | ✅ فعال |
| 5 | `121.126.62.150` | `23055` | 176.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.201.126.185` | `8080` | 218.95ms | ✅ فعال |
| 2 | `201.184.239.75` | `5678` | 81.04ms | ✅ فعال |
| 3 | `146.103.56.186` | `5734` | 83.80ms | ✅ فعال |
| 4 | `89.116.78.243` | `5854` | 75.51ms | ✅ فعال |
| 5 | `192.252.214.20` | `15864` | 60.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 119.13ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 157.65ms | ✅ فعال |
| 3 | `103.147.247.171` | `8080` | 1289.21ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 228.01ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 238.70ms | ✅ فعال |
