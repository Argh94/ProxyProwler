...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:32 15-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `57.128.249.250` | `9052` | 121.64ms | ✅ فعال |
| 2 | `1.180.49.222` | `7302` | 264.87ms | ✅ فعال |
| 3 | `47.251.87.74` | `3128` | 632.85ms | ✅ فعال |
| 4 | `147.45.60.139` | `1082` | 2104.97ms | ✅ فعال |
| 5 | `199.229.254.129` | `4145` | 67.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `178.220.148.82` | `10801` | 126.85ms | ✅ فعال |
| 2 | `174.77.111.197` | `4145` | 91.83ms | ✅ فعال |
| 3 | `98.181.137.83` | `4145` | 91.50ms | ✅ فعال |
| 4 | `98.175.31.222` | `4145` | 90.86ms | ✅ فعال |
| 5 | `192.111.139.162` | `4145` | 66.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 208.00ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 133.41ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 221.93ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 172.49ms | ✅ فعال |
| 5 | `103.130.61.61` | `8081` | 1309.46ms | ✅ فعال |
