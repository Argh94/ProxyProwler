...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 08-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.220.92` | `17328` | 58.41ms | ✅ فعال |
| 2 | `206.238.236.81` | `80` | 17.94ms | ✅ فعال |
| 3 | `104.18.149.246` | `80` | 18.73ms | ✅ فعال |
| 4 | `185.162.230.27` | `80` | 17.72ms | ✅ فعال |
| 5 | `103.169.142.112` | `80` | 18.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 217.46ms | ✅ فعال |
| 2 | `43.100.9.241` | `1100` | 173.21ms | ✅ فعال |
| 3 | `167.172.86.46` | `10471` | 186.94ms | ✅ فعال |
| 4 | `101.51.138.138` | `8080` | 220.81ms | ✅ فعال |
| 5 | `101.255.165.106` | `8090` | 194.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 50.27ms | ✅ فعال |
| 2 | `185.148.104.15` | `80` | 17.75ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 190.87ms | ✅ فعال |
| 4 | `104.17.190.13` | `80` | 18.52ms | ✅ فعال |
| 5 | `198.177.56.190` | `80` | 17.73ms | ✅ فعال |
