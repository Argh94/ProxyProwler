...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:15 16-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.175.248.21` | `1080` | 68.97ms | ✅ فعال |
| 2 | `103.35.190.182` | `1082` | 68.33ms | ✅ فعال |
| 3 | `46.249.100.124` | `80` | 161.41ms | ✅ فعال |
| 4 | `46.62.214.3` | `1080` | 175.05ms | ✅ فعال |
| 5 | `188.120.239.151` | `1080` | 180.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `122.116.125.115` | `8888` | 130.88ms | ✅ فعال |
| 2 | `145.223.46.78` | `5628` | 143.12ms | ✅ فعال |
| 3 | `8.211.195.173` | `1234` | 146.15ms | ✅ فعال |
| 4 | `143.137.116.72` | `1080` | 2243.59ms | ✅ فعال |
| 5 | `185.226.207.237` | `5786` | 138.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.200.38.56` | `8080` | 1246.86ms | ✅ فعال |
| 2 | `103.147.247.171` | `8080` | 184.07ms | ✅ فعال |
| 3 | `51.91.76.186` | `8080` | 205.96ms | ✅ فعال |
| 4 | `217.64.149.146` | `8118` | 200.83ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 218.54ms | ✅ فعال |
