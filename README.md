...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:48 30-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.148.158.143` | `1080` | 53.88ms | ✅ فعال |
| 2 | `51.89.139.190` | `1080` | 76.01ms | ✅ فعال |
| 3 | `46.241.57.29` | `1080` | 153.83ms | ✅ فعال |
| 4 | `47.105.126.142` | `80` | 251.93ms | ✅ فعال |
| 5 | `206.123.156.224` | `5050` | 96.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 2149.24ms | ✅ فعال |
| 2 | `8.213.156.191` | `800` | 182.18ms | ✅ فعال |
| 3 | `31.43.33.55` | `4153` | 128.52ms | ✅ فعال |
| 4 | `178.220.148.82` | `10801` | 1139.15ms | ✅ فعال |
| 5 | `176.12.72.62` | `1080` | 1211.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 186.32ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 90.04ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 221.84ms | ✅ فعال |
| 4 | `209.141.62.12` | `5555` | 62.13ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 123.40ms | ✅ فعال |
