...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 22-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.228.96` | `80` | 1.60ms | ✅ فعال |
| 2 | `14.251.13.0` | `8080` | 207.93ms | ✅ فعال |
| 3 | `162.220.246.56` | `6340` | 147.94ms | ✅ فعال |
| 4 | `205.233.181.135` | `80` | 1.57ms | ✅ فعال |
| 5 | `63.141.128.118` | `80` | 1.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.222.120` | `80` | 180.28ms | ✅ فعال |
| 2 | `101.200.158.109` | `8880` | 201.65ms | ✅ فعال |
| 3 | `198.105.122.125` | `6698` | 154.31ms | ✅ فعال |
| 4 | `104.253.48.123` | `5547` | 41.31ms | ✅ فعال |
| 5 | `173.211.8.148` | `6260` | 8.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 2.11ms | ✅ فعال |
| 2 | `69.84.182.59` | `80` | 2.55ms | ✅ فعال |
| 3 | `45.131.4.9` | `80` | 10.23ms | ✅ فعال |
| 4 | `172.66.40.96` | `80` | 1.88ms | ✅ فعال |
| 5 | `102.177.176.178` | `80` | 2.02ms | ✅ فعال |
