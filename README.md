...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 07-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.89.53` | `80` | 1.79ms | ✅ فعال |
| 2 | `104.25.0.78` | `80` | 2.07ms | ✅ فعال |
| 3 | `172.66.40.40` | `80` | 1.87ms | ✅ فعال |
| 4 | `172.67.177.171` | `80` | 2.49ms | ✅ فعال |
| 5 | `31.58.18.29` | `6298` | 141.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.118.232.12` | `5678` | 205.26ms | ✅ فعال |
| 2 | `31.58.18.29` | `6298` | 146.49ms | ✅ فعال |
| 3 | `47.250.177.202` | `8008` | 199.88ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 154.75ms | ✅ فعال |
| 5 | `178.220.148.82` | `10801` | 1200.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.38.101.138` | `8337` | 132.55ms | ✅ فعال |
| 2 | `47.116.210.100` | `3128` | 190.93ms | ✅ فعال |
| 3 | `157.175.43.137` | `8334` | 235.01ms | ✅ فعال |
| 4 | `16.78.108.50` | `9439` | 187.20ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 173.17ms | ✅ فعال |
