...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 06-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.40.243` | `80` | 17.92ms | ✅ فعال |
| 2 | `141.193.213.107` | `80` | 18.20ms | ✅ فعال |
| 3 | `104.18.47.31` | `80` | 17.95ms | ✅ فعال |
| 4 | `192.73.244.36` | `80` | 23.39ms | ✅ فعال |
| 5 | `8.35.211.160` | `80` | 18.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 234.17ms | ✅ فعال |
| 2 | `108.141.130.146` | `80` | 116.61ms | ✅ فعال |
| 3 | `198.98.57.213` | `31280` | 41.86ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 248.96ms | ✅ فعال |
| 5 | `94.23.222.122` | `34392` | 1156.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.118.80` | `80` | 17.96ms | ✅ فعال |
| 2 | `45.80.108.229` | `80` | 17.90ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 17.96ms | ✅ فعال |
| 4 | `104.18.40.13` | `80` | 17.98ms | ✅ فعال |
| 5 | `141.101.122.238` | `80` | 49.83ms | ✅ فعال |
