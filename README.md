...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:12 04-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.11` | `4145` | 138.27ms | ✅ فعال |
| 2 | `193.221.203.192` | `1080` | 162.40ms | ✅ فعال |
| 3 | `66.42.224.229` | `41679` | 156.42ms | ✅ فعال |
| 4 | `184.181.217.220` | `4145` | 136.80ms | ✅ فعال |
| 5 | `157.245.143.65` | `7890` | 59.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 154.98ms | ✅ فعال |
| 2 | `173.211.30.146` | `6580` | 18.15ms | ✅ فعال |
| 3 | `3.252.217.162` | `1080` | 115.29ms | ✅ فعال |
| 4 | `45.41.160.215` | `6197` | 25.94ms | ✅ فعال |
| 5 | `177.66.43.189` | `4145` | 1231.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 60.62ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 53.82ms | ✅ فعال |
| 3 | `103.154.146.58` | `8080` | 1210.91ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 174.23ms | ✅ فعال |
| 5 | `203.174.15.138` | `8080` | 194.87ms | ✅ فعال |
