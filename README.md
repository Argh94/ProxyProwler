...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:31 16-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.127.250.179` | `5788` | 8.67ms | ✅ فعال |
| 2 | `8.213.128.6` | `8024` | 136.47ms | ✅ فعال |
| 3 | `8.221.138.111` | `8443` | 105.93ms | ✅ فعال |
| 4 | `174.77.111.196` | `4145` | 185.40ms | ✅ فعال |
| 5 | `162.223.90.144` | `80` | 68.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.194` | `4145` | 122.69ms | ✅ فعال |
| 2 | `120.25.189.254` | `9000` | 217.09ms | ✅ فعال |
| 3 | `47.74.46.81` | `9080` | 105.56ms | ✅ فعال |
| 4 | `47.100.130.127` | `45` | 185.48ms | ✅ فعال |
| 5 | `31.56.137.169` | `6245` | 70.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.60.196.214` | `80` | 137.03ms | ✅ فعال |
| 2 | `4.195.16.140` | `80` | 138.22ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 171.68ms | ✅ فعال |
| 4 | `8.212.153.179` | `8080` | 2227.59ms | ✅ فعال |
| 5 | `45.59.186.60` | `80` | 8.93ms | ✅ فعال |
