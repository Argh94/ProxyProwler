...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:12 17-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.175` | `80` | 6.11ms | ✅ فعال |
| 2 | `159.112.235.27` | `80` | 6.01ms | ✅ فعال |
| 3 | `172.67.185.185` | `80` | 5.71ms | ✅ فعال |
| 4 | `198.41.204.102` | `80` | 5.65ms | ✅ فعال |
| 5 | `91.107.154.214` | `80` | 90.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.68.1` | `8081` | 88.56ms | ✅ فعال |
| 2 | `103.166.39.81` | `3629` | 249.63ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 267.50ms | ✅ فعال |
| 4 | `23.27.91.161` | `6240` | 70.22ms | ✅ فعال |
| 5 | `91.107.138.98` | `2255` | 92.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `65.109.177.138` | `8080` | 118.68ms | ✅ فعال |
| 2 | `144.125.164.222` | `8080` | 6.46ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 6.28ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 236.76ms | ✅ فعال |
| 5 | `220.128.223.136` | `8082` | 192.39ms | ✅ فعال |
