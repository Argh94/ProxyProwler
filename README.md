...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:17 05-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.251.30` | `11288` | 59.24ms | ✅ فعال |
| 2 | `147.45.126.5` | `1080` | 103.78ms | ✅ فعال |
| 3 | `8.213.222.157` | `5060` | 251.78ms | ✅ فعال |
| 4 | `184.178.172.25` | `15291` | 84.74ms | ✅ فعال |
| 5 | `192.252.209.158` | `4145` | 59.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `65.108.103.19` | `80` | 118.37ms | ✅ فعال |
| 2 | `173.211.68.91` | `6373` | 60.15ms | ✅ فعال |
| 3 | `47.238.60.156` | `8008` | 204.29ms | ✅ فعال |
| 4 | `103.31.14.121` | `9050` | 171.98ms | ✅ فعال |
| 5 | `184.181.217.201` | `4145` | 85.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 6.99ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.02ms | ✅ فعال |
| 3 | `158.101.175.124` | `5566` | 164.20ms | ✅ فعال |
| 4 | `79.121.102.227` | `8080` | 106.56ms | ✅ فعال |
| 5 | `195.25.20.155` | `3128` | 1128.88ms | ✅ فعال |
