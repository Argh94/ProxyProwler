...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:01 27-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.246.55.25` | `80` | 2.68ms | ✅ فعال |
| 2 | `107.175.31.81` | `1111` | 2.95ms | ✅ فعال |
| 3 | `172.64.94.22` | `80` | 2.59ms | ✅ فعال |
| 4 | `185.226.207.20` | `5569` | 94.39ms | ✅ فعال |
| 5 | `162.159.243.55` | `80` | 2.87ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (62 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.220.247.191` | `6786` | 91.21ms | ✅ فعال |
| 2 | `139.224.207.73` | `1337` | 227.11ms | ✅ فعال |
| 3 | `91.142.79.166` | `8888` | 2198.20ms | ✅ فعال |
| 4 | `104.165.243.228` | `6888` | 46.36ms | ✅ فعال |
| 5 | `5.199.173.2` | `9116` | 127.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.160.134.84` | `1466` | 114.25ms | ✅ فعال |
| 2 | `78.12.193.250` | `52795` | 53.15ms | ✅ فعال |
| 3 | `13.61.155.35` | `54515` | 1130.96ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 218.67ms | ✅ فعال |
| 5 | `13.229.106.200` | `26001` | 206.07ms | ✅ فعال |
