...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:46 20-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.121.13.73` | `1080` | 99.32ms | ✅ فعال |
| 2 | `185.135.69.34` | `80` | 185.63ms | ✅ فعال |
| 3 | `206.123.156.214` | `11113` | 124.19ms | ✅ فعال |
| 4 | `109.198.107.237` | `3128` | 140.88ms | ✅ فعال |
| 5 | `206.206.73.251` | `6867` | 62.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.160.209.58` | `1080` | 125.23ms | ✅ فعال |
| 2 | `23.27.78.240` | `5820` | 56.17ms | ✅ فعال |
| 3 | `47.238.130.212` | `20` | 200.32ms | ✅ فعال |
| 4 | `47.251.73.54` | `5060` | 67.81ms | ✅ فعال |
| 5 | `143.137.116.72` | `1080` | 118.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 219.75ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 120.01ms | ✅ فعال |
| 3 | `154.66.159.34` | `800` | 2520.36ms | ✅ فعال |
| 4 | `102.164.252.150` | `8080` | 1236.71ms | ✅ فعال |
| 5 | `103.156.74.186` | `8080` | 1259.99ms | ✅ فعال |
