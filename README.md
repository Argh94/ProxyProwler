...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:51 14-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.53.20.190` | `20000` | 152.75ms | ✅ فعال |
| 2 | `193.233.218.213` | `1080` | 172.00ms | ✅ فعال |
| 3 | `72.37.216.68` | `4145` | 55.39ms | ✅ فعال |
| 4 | `121.43.109.88` | `8008` | 203.03ms | ✅ فعال |
| 5 | `36.138.206.172` | `1080` | 173.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `114.4.200.222` | `5678` | 198.94ms | ✅ فعال |
| 2 | `52.34.243.150` | `8080` | 41.14ms | ✅ فعال |
| 3 | `185.130.219.12` | `4153` | 130.57ms | ✅ فعال |
| 4 | `8.211.51.115` | `1036` | 418.13ms | ✅ فعال |
| 5 | `39.102.213.3` | `20000` | 214.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 53.93ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 189.47ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 167.42ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 60.75ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 180.03ms | ✅ فعال |
