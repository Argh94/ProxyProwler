...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 19-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `212.227.65.114` | `80` | 164.98ms | ✅ فعال |
| 2 | `162.223.90.144` | `80` | 67.99ms | ✅ فعال |
| 3 | `213.73.25.230` | `8080` | 168.88ms | ✅ فعال |
| 4 | `8.213.215.187` | `2000` | 198.37ms | ✅ فعال |
| 5 | `113.204.79.230` | `9091` | 216.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.187.210.54` | `4145` | 23.07ms | ✅ فعال |
| 2 | `45.41.178.63` | `6284` | 43.29ms | ✅ فعال |
| 3 | `209.38.222.145` | `8080` | 159.61ms | ✅ فعال |
| 4 | `192.111.137.35` | `4145` | 95.16ms | ✅ فعال |
| 5 | `47.251.73.54` | `80` | 2.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.215.15.163` | `1080` | 191.95ms | ✅ فعال |
| 2 | `103.84.177.30` | `8083` | 1222.22ms | ✅ فعال |
| 3 | `47.250.51.110` | `8888` | 172.24ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 167.02ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 148.37ms | ✅ فعال |
