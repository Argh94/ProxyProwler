...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 20-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.255.195` | `80` | 8.92ms | ✅ فعال |
| 2 | `104.25.165.196` | `80` | 8.81ms | ✅ فعال |
| 3 | `45.85.118.148` | `80` | 9.05ms | ✅ فعال |
| 4 | `172.67.221.95` | `80` | 19.04ms | ✅ فعال |
| 5 | `104.27.6.104` | `80` | 8.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.246.130` | `6789` | 158.21ms | ✅ فعال |
| 2 | `154.31.113.209` | `80` | 108.73ms | ✅ فعال |
| 3 | `139.224.195.153` | `8888` | 191.95ms | ✅ فعال |
| 4 | `39.104.59.56` | `1081` | 237.40ms | ✅ فعال |
| 5 | `47.254.153.78` | `999` | 136.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.110.127.255` | `46866` | 230.77ms | ✅ فعال |
| 2 | `35.180.127.14` | `375` | 138.26ms | ✅ فعال |
| 3 | `15.168.235.57` | `982` | 115.17ms | ✅ فعال |
| 4 | `190.242.157.215` | `8080` | 101.93ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 1178.84ms | ✅ فعال |
