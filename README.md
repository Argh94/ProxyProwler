...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:16 02-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.6.204` | `80` | 2.47ms | ✅ فعال |
| 2 | `203.23.104.106` | `80` | 2.50ms | ✅ فعال |
| 3 | `185.226.207.176` | `5725` | 76.10ms | ✅ فعال |
| 4 | `205.233.181.38` | `80` | 2.71ms | ✅ فعال |
| 5 | `104.24.19.226` | `80` | 2.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `147.161.170.63` | `11143` | 99.26ms | ✅ فعال |
| 2 | `47.243.124.21` | `6666` | 204.20ms | ✅ فعال |
| 3 | `31.59.20.59` | `6637` | 78.40ms | ✅ فعال |
| 4 | `110.238.116.82` | `55443` | 266.19ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 273.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.223.246` | `56163` | 59.02ms | ✅ فعال |
| 2 | `3.110.127.255` | `20793` | 210.69ms | ✅ فعال |
| 3 | `43.208.16.199` | `9513` | 258.63ms | ✅ فعال |
| 4 | `18.163.3.251` | `5132` | 202.46ms | ✅ فعال |
| 5 | `157.175.197.28` | `8801` | 173.06ms | ✅ فعال |
