...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:25 26-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `83.147.216.208` | `1080` | 175.93ms | ✅ فعال |
| 2 | `31.59.20.167` | `6745` | 138.61ms | ✅ فعال |
| 3 | `45.32.160.61` | `1088` | 60.65ms | ✅ فعال |
| 4 | `107.167.18.122` | `443` | 8.20ms | ✅ فعال |
| 5 | `8.213.151.128` | `3128` | 129.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `116.202.108.111` | `3128` | 156.54ms | ✅ فعال |
| 2 | `198.105.100.241` | `6492` | 139.94ms | ✅ فعال |
| 3 | `203.170.146.146` | `4153` | 1194.45ms | ✅ فعال |
| 4 | `72.201.177.49` | `1080` | 1049.64ms | ✅ فعال |
| 5 | `92.255.190.64` | `4153` | 221.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 183.68ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 189.20ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 168.33ms | ✅ فعال |
