...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:05 24-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `80` | 174.84ms | ✅ فعال |
| 2 | `172.237.73.24` | `80` | 195.80ms | ✅ فعال |
| 3 | `4.213.98.253` | `80` | 224.42ms | ✅ فعال |
| 4 | `58.216.109.13` | `800` | 233.23ms | ✅ فعال |
| 5 | `159.65.230.46` | `8888` | 34.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.50.83` | `81` | 176.77ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 238.91ms | ✅ فعال |
| 3 | `8.210.17.35` | `80` | 657.23ms | ✅ فعال |
| 4 | `154.94.238.147` | `50161` | 218.92ms | ✅ فعال |
| 5 | `72.195.34.42` | `4145` | 93.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.212.177.126` | `8080` | 212.56ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 198.56ms | ✅ فعال |
| 3 | `12.50.107.222` | `80` | 45.88ms | ✅ فعال |
| 4 | `5.161.155.252` | `80` | 23.67ms | ✅ فعال |
| 5 | `38.145.218.14` | `8443` | 66.61ms | ✅ فعال |
