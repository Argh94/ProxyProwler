...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 09-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `217.69.121.99` | `5764` | 150.10ms | ✅ فعال |
| 2 | `45.12.31.106` | `80` | 1.78ms | ✅ فعال |
| 3 | `172.67.152.71` | `80` | 2.43ms | ✅ فعال |
| 4 | `47.238.134.126` | `9098` | 162.29ms | ✅ فعال |
| 5 | `142.111.239.150` | `5728` | 38.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.34.228.102` | `80` | 2.20ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 292.94ms | ✅ فعال |
| 3 | `114.215.127.92` | `12000` | 562.07ms | ✅ فعال |
| 4 | `101.132.252.152` | `3129` | 173.28ms | ✅ فعال |
| 5 | `119.13.111.169` | `4006` | 173.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.25.125` | `6192` | 196.98ms | ✅ فعال |
| 2 | `203.80.138.81` | `50000` | 104.86ms | ✅ فعال |
| 3 | `200.174.198.32` | `8888` | 176.43ms | ✅ فعال |
| 4 | `13.61.155.35` | `32650` | 157.67ms | ✅ فعال |
| 5 | `13.212.81.49` | `8015` | 172.59ms | ✅ فعال |
