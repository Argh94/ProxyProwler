...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 20-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `212.113.99.167` | `10800` | 94.12ms | ✅ فعال |
| 2 | `69.58.12.145` | `8150` | 12.89ms | ✅ فعال |
| 3 | `145.241.233.71` | `1080` | 88.96ms | ✅ فعال |
| 4 | `47.91.89.3` | `1000` | 116.78ms | ✅ فعال |
| 5 | `199.58.184.97` | `4145` | 59.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.71.110.129` | `8888` | 97.69ms | ✅ فعال |
| 2 | `110.74.195.152` | `1080` | 258.69ms | ✅ فعال |
| 3 | `193.56.28.118` | `3129` | 5.42ms | ✅ فعال |
| 4 | `192.252.211.197` | `14921` | 57.97ms | ✅ فعال |
| 5 | `216.26.225.84` | `3129` | 5.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.2.64.185` | `8118` | 226.44ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 8.68ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 227.02ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 7.17ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 249.87ms | ✅ فعال |
