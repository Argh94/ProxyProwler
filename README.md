...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:20 28-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.6.225` | `80` | 2.33ms | ✅ فعال |
| 2 | `188.114.96.186` | `80` | 3.43ms | ✅ فعال |
| 3 | `104.27.13.64` | `80` | 2.52ms | ✅ فعال |
| 4 | `172.67.159.204` | `80` | 2.39ms | ✅ فعال |
| 5 | `194.36.55.16` | `80` | 2.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.208.84.236` | `7657` | 180.60ms | ✅ فعال |
| 2 | `139.196.151.191` | `8090` | 247.24ms | ✅ فعال |
| 3 | `43.208.240.77` | `28586` | 232.57ms | ✅ فعال |
| 4 | `116.100.223.112` | `1080` | 229.25ms | ✅ فعال |
| 5 | `5.199.166.240` | `9112` | 201.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.177.211.224` | `4221` | 47.27ms | ✅ فعال |
| 2 | `43.209.130.76` | `331` | 231.18ms | ✅ فعال |
| 3 | `78.12.223.246` | `844` | 50.89ms | ✅ فعال |
| 4 | `78.12.223.246` | `59200` | 50.93ms | ✅ فعال |
| 5 | `176.57.189.138` | `3128` | 151.83ms | ✅ فعال |
