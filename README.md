...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:39 17-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `217.69.121.199` | `5864` | 76.27ms | ✅ فعال |
| 2 | `80.245.197.246` | `80` | 98.97ms | ✅ فعال |
| 3 | `69.61.200.104` | `36181` | 85.89ms | ✅ فعال |
| 4 | `45.159.79.101` | `1080` | 2130.46ms | ✅ فعال |
| 5 | `185.103.100.141` | `1080` | 123.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.134.213` | `30000` | 185.95ms | ✅ فعال |
| 2 | `109.237.97.176` | `36090` | 2156.94ms | ✅ فعال |
| 3 | `8.211.195.173` | `10000` | 78.93ms | ✅ فعال |
| 4 | `190.7.138.78` | `8080` | 1146.93ms | ✅ فعال |
| 5 | `85.214.204.79` | `80` | 108.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 240.77ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 234.05ms | ✅ فعال |
| 3 | `180.191.14.210` | `8081` | 2350.65ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 2.50ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 3.11ms | ✅ فعال |
