...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 08-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.88.88.102` | `443` | 136.17ms | ✅ فعال |
| 2 | `162.223.90.144` | `80` | 44.30ms | ✅ فعال |
| 3 | `137.184.96.68` | `80` | 56.04ms | ✅ فعال |
| 4 | `98.181.137.80` | `4145` | 137.68ms | ✅ فعال |
| 5 | `104.16.7.118` | `80` | 20.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `18081` | 181.24ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 254.68ms | ✅ فعال |
| 3 | `8.209.253.237` | `8499` | 120.04ms | ✅ فعال |
| 4 | `193.161.3.103` | `6207` | 134.17ms | ✅ فعال |
| 5 | `107.181.161.81` | `4145` | 66.19ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (44 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.205.124.165` | `8445` | 237.61ms | ✅ فعال |
| 2 | `16.78.82.73` | `4938` | 196.41ms | ✅ فعال |
| 3 | `8.212.165.164` | `443` | 207.85ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 182.88ms | ✅ فعال |
| 5 | `144.91.81.25` | `3128` | 1174.32ms | ✅ فعال |
