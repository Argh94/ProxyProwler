...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 06-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.160.188.21` | `1080` | 2299.25ms | ✅ فعال |
| 2 | `170.114.45.86` | `80` | 2.34ms | ✅ فعال |
| 3 | `198.41.203.79` | `80` | 1.79ms | ✅ فعال |
| 4 | `5.10.244.6` | `80` | 2.76ms | ✅ فعال |
| 5 | `5.10.245.158` | `80` | 2.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.24.98` | `3128` | 220.07ms | ✅ فعال |
| 2 | `45.128.133.199` | `1080` | 2143.15ms | ✅ فعال |
| 3 | `38.170.161.248` | `9299` | 51.62ms | ✅ فعال |
| 4 | `86.38.26.8` | `6173` | 94.29ms | ✅ فعال |
| 5 | `103.251.223.24` | `6003` | 50.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.114` | `80` | 4.41ms | ✅ فعال |
| 2 | `104.25.1.112` | `80` | 90.47ms | ✅ فعال |
| 3 | `45.85.118.80` | `80` | 2.11ms | ✅ فعال |
| 4 | `89.116.250.4` | `80` | 1.82ms | ✅ فعال |
| 5 | `45.131.4.9` | `80` | 2.79ms | ✅ فعال |
