...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 14-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.41.209.164` | `80` | 2.68ms | ✅ فعال |
| 2 | `184.168.47.47` | `80` | 2.14ms | ✅ فعال |
| 3 | `24.249.199.12` | `4145` | 86.26ms | ✅ فعال |
| 4 | `8.213.129.15` | `1111` | 181.02ms | ✅ فعال |
| 5 | `164.38.155.65` | `80` | 2.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.103.88.158` | `46104` | 2080.84ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 238.08ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 234.09ms | ✅ فعال |
| 4 | `212.231.197.29` | `4145` | 128.29ms | ✅ فعال |
| 5 | `85.102.10.94` | `4153` | 183.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.116.250.4` | `80` | 2.00ms | ✅ فعال |
| 2 | `104.24.85.134` | `80` | 2.90ms | ✅ فعال |
| 3 | `45.131.4.93` | `80` | 2.16ms | ✅ فعال |
| 4 | `104.17.247.188` | `80` | 2.37ms | ✅ فعال |
| 5 | `45.131.211.217` | `80` | 1.82ms | ✅ فعال |
