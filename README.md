...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 07-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.170.57.231` | `4145` | 86.12ms | ✅ فعال |
| 2 | `184.170.245.148` | `4145` | 71.90ms | ✅ فعال |
| 3 | `118.145.141.251` | `44217` | 1252.61ms | ✅ فعال |
| 4 | `62.133.62.27` | `1082` | 120.63ms | ✅ فعال |
| 5 | `137.66.42.196` | `1080` | 23.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.0.9.195` | `5778` | 25.23ms | ✅ فعال |
| 2 | `8.220.204.92` | `8888` | 159.95ms | ✅ فعال |
| 3 | `23.26.94.47` | `6029` | 47.32ms | ✅ فعال |
| 4 | `144.91.121.61` | `1088` | 157.16ms | ✅ فعال |
| 5 | `61.184.189.124` | `10800` | 1280.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 195.68ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 160.26ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 221.06ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 133.61ms | ✅ فعال |
