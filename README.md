...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 05-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `38.170.169.72` | `5313` | 10.78ms | ✅ فعال |
| 2 | `91.193.59.139` | `80` | 2.18ms | ✅ فعال |
| 3 | `104.25.0.222` | `80` | 9.15ms | ✅ فعال |
| 4 | `5.10.246.253` | `80` | 1.91ms | ✅ فعال |
| 5 | `104.27.12.230` | `80` | 10.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.170.169.72` | `5313` | 10.76ms | ✅ فعال |
| 2 | `185.235.16.12` | `80` | 187.94ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 246.43ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 217.24ms | ✅ فعال |
| 5 | `101.51.138.138` | `8080` | 212.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.197.20` | `80` | 10.61ms | ✅ فعال |
| 2 | `45.80.108.229` | `80` | 1.87ms | ✅ فعال |
| 3 | `206.238.236.139` | `80` | 1.92ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 64.21ms | ✅ فعال |
| 5 | `45.131.7.159` | `80` | 1.91ms | ✅ فعال |
