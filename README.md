...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:27 20-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 52.16ms | ✅ فعال |
| 2 | `49.151.187.10` | `8082` | 167.61ms | ✅ فعال |
| 3 | `23.88.88.105` | `443` | 160.51ms | ✅ فعال |
| 4 | `192.252.208.70` | `14282` | 101.22ms | ✅ فعال |
| 5 | `186.148.180.46` | `999` | 129.36ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (58 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `80` | 138.82ms | ✅ فعال |
| 2 | `8.211.195.139` | `1080` | 141.81ms | ✅ فعال |
| 3 | `8.220.204.92` | `4145` | 128.58ms | ✅ فعال |
| 4 | `167.250.75.19` | `80` | 190.04ms | ✅ فعال |
| 5 | `139.196.151.191` | `8090` | 189.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 52.28ms | ✅ فعال |
| 2 | `47.237.113.119` | `8443` | 162.17ms | ✅ فعال |
| 3 | `23.95.242.79` | `3128` | 52.95ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 173.34ms | ✅ فعال |
| 5 | `23.88.88.105` | `443` | 157.14ms | ✅ فعال |
