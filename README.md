...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 23-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.31.82` | `80` | 1.79ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 166.74ms | ✅ فعال |
| 3 | `198.105.100.20` | `6271` | 148.14ms | ✅ فعال |
| 4 | `185.148.105.39` | `80` | 1.65ms | ✅ فعال |
| 5 | `104.25.1.240` | `80` | 2.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.58.190` | `4145` | 26.43ms | ✅ فعال |
| 2 | `5.199.166.244` | `9067` | 166.98ms | ✅ فعال |
| 3 | `88.216.68.12` | `9097` | 48.21ms | ✅ فعال |
| 4 | `23.247.136.254` | `80` | 1.67ms | ✅ فعال |
| 5 | `5.199.173.4` | `9090` | 177.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 167.84ms | ✅ فعال |
| 2 | `157.175.170.170` | `52929` | 228.98ms | ✅ فعال |
| 3 | `176.57.189.138` | `3128` | 214.01ms | ✅ فعال |
| 4 | `54.90.159.174` | `133` | 64.17ms | ✅ فعال |
| 5 | `54.90.159.174` | `8369` | 64.78ms | ✅ فعال |
