...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 12-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.254.140.210` | `80` | 5.93ms | ✅ فعال |
| 2 | `159.112.235.177` | `80` | 5.87ms | ✅ فعال |
| 3 | `104.24.0.29` | `80` | 6.50ms | ✅ فعال |
| 4 | `104.17.70.32` | `80` | 5.96ms | ✅ فعال |
| 5 | `185.176.24.252` | `80` | 6.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.106.216.202` | `3128` | 242.57ms | ✅ فعال |
| 2 | `203.189.151.19` | `1080` | 256.69ms | ✅ فعال |
| 3 | `47.113.219.226` | `59394` | 249.66ms | ✅ فعال |
| 4 | `49.0.252.39` | `9000` | 211.96ms | ✅ فعال |
| 5 | `104.238.37.181` | `6738` | 35.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 6.00ms | ✅ فعال |
| 2 | `51.16.49.113` | `8585` | 132.15ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 99.06ms | ✅ فعال |
| 4 | `202.154.18.1` | `8080` | 254.02ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 7.27ms | ✅ فعال |
