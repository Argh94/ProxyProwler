...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 15-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `162.223.90.144` | `80` | 25.50ms | ✅ فعال |
| 2 | `103.94.52.70` | `3128` | 246.60ms | ✅ فعال |
| 3 | `95.216.49.153` | `80` | 133.36ms | ✅ فعال |
| 4 | `184.178.172.25` | `15291` | 114.80ms | ✅ فعال |
| 5 | `141.101.120.152` | `80` | 2.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.208.84.236` | `7657` | 113.37ms | ✅ فعال |
| 2 | `101.132.248.7` | `1337` | 229.27ms | ✅ فعال |
| 3 | `119.13.111.169` | `4006` | 205.90ms | ✅ فعال |
| 4 | `8.209.253.237` | `8499` | 146.75ms | ✅ فعال |
| 5 | `176.126.103.194` | `44214` | 144.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.110.127.255` | `48200` | 214.51ms | ✅ فعال |
| 2 | `144.125.164.222` | `8080` | 1.84ms | ✅ فعال |
| 3 | `164.163.40.15` | `10000` | 162.72ms | ✅ فعال |
| 4 | `45.224.99.88` | `999` | 1156.91ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 17.51ms | ✅ فعال |
