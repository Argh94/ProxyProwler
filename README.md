...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:15 09-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `2.59.43.253` | `22222` | 120.34ms | ✅ فعال |
| 2 | `65.21.252.66` | `10811` | 117.82ms | ✅ فعال |
| 3 | `78.109.137.53` | `1080` | 158.00ms | ✅ فعال |
| 4 | `43.98.172.166` | `3128` | 226.21ms | ✅ فعال |
| 5 | `82.26.208.126` | `5433` | 13.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.212.165.164` | `5004` | 859.65ms | ✅ فعال |
| 2 | `185.226.207.120` | `5669` | 91.21ms | ✅ فعال |
| 3 | `37.18.73.60` | `5566` | 126.66ms | ✅ فعال |
| 4 | `36.88.242.103` | `1080` | 268.63ms | ✅ فعال |
| 5 | `164.52.11.194` | `18080` | 198.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 240.40ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 1279.79ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 115.63ms | ✅ فعال |
| 4 | `103.130.61.61` | `8081` | 241.89ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 159.04ms | ✅ فعال |
