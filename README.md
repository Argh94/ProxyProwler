...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 21-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.105.199` | `80` | 6.19ms | ✅ فعال |
| 2 | `185.162.229.189` | `80` | 5.77ms | ✅ فعال |
| 3 | `45.194.53.218` | `80` | 6.03ms | ✅ فعال |
| 4 | `5.10.245.126` | `80` | 5.98ms | ✅ فعال |
| 5 | `104.16.169.10` | `80` | 6.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `187.44.211.118` | `4153` | 2237.81ms | ✅ فعال |
| 2 | `47.238.168.172` | `1011` | 209.62ms | ✅ فعال |
| 3 | `49.0.199.132` | `19` | 271.02ms | ✅ فعال |
| 4 | `8.221.139.222` | `3128` | 853.21ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 88.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.104.244` | `37` | 251.25ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 98.18ms | ✅ فعال |
| 3 | `82.196.12.202` | `7777` | 1130.90ms | ✅ فعال |
| 4 | `15.160.134.84` | `9492` | 101.31ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 6.05ms | ✅ فعال |
