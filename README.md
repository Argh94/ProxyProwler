...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:22 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.0.153` | `80` | 1.76ms | ✅ فعال |
| 2 | `63.141.128.29` | `80` | 1.89ms | ✅ فعال |
| 3 | `209.46.30.41` | `80` | 1.80ms | ✅ فعال |
| 4 | `172.67.190.86` | `80` | 4.38ms | ✅ فعال |
| 5 | `104.18.181.217` | `80` | 1.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `90` | 932.79ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 256.10ms | ✅ فعال |
| 3 | `141.193.213.134` | `80` | 1.56ms | ✅ فعال |
| 4 | `1.180.49.222` | `7302` | 286.19ms | ✅ فعال |
| 5 | `8.213.128.6` | `443` | 766.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.229.172` | `80` | 1.58ms | ✅ فعال |
| 2 | `182.253.109.189` | `8080` | 241.54ms | ✅ فعال |
| 3 | `185.193.28.50` | `80` | 1.89ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 2.15ms | ✅ فعال |
| 5 | `102.177.176.178` | `80` | 1.89ms | ✅ فعال |
