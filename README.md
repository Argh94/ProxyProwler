...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:28 18-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.215` | `7424` | 91.70ms | ✅ فعال |
| 2 | `45.95.233.237` | `1081` | 89.64ms | ✅ فعال |
| 3 | `195.135.255.98` | `1080` | 111.70ms | ✅ فعال |
| 4 | `206.123.156.233` | `4495` | 89.02ms | ✅ فعال |
| 5 | `72.205.0.67` | `4145` | 83.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.34.242.98` | `80` | 216.22ms | ✅ فعال |
| 2 | `190.2.104.201` | `4153` | 2229.40ms | ✅ فعال |
| 3 | `168.119.153.216` | `8888` | 92.37ms | ✅ فعال |
| 4 | `182.53.216.73` | `4145` | 2316.26ms | ✅ فعال |
| 5 | `45.56.173.236` | `6219` | 35.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 6.47ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 226.36ms | ✅ فعال |
| 3 | `106.249.44.10` | `3128` | 196.05ms | ✅ فعال |
| 4 | `209.141.62.12` | `5555` | 2104.79ms | ✅ فعال |
| 5 | `138.2.64.185` | `8118` | 225.51ms | ✅ فعال |
