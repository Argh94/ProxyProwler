...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:55 27-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `36.155.23.163` | `10808` | 175.08ms | ✅ فعال |
| 2 | `45.74.31.50` | `11996` | 113.35ms | ✅ فعال |
| 3 | `184.178.172.25` | `15291` | 90.48ms | ✅ فعال |
| 4 | `180.211.93.105` | `3108` | 237.02ms | ✅ فعال |
| 5 | `198.8.94.174` | `39078` | 77.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `80.87.193.111` | `12345` | 158.32ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 152.06ms | ✅ فعال |
| 3 | `8.213.197.208` | `808` | 933.12ms | ✅ فعال |
| 4 | `206.206.71.178` | `5818` | 46.54ms | ✅ فعال |
| 5 | `104.207.36.198` | `3129` | 29.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `213.136.72.147` | `3128` | 2209.20ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 151.02ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 143.47ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 201.17ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 196.18ms | ✅ فعال |
