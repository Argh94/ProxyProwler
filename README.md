...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 18-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `170.114.46.34` | `80` | 6.61ms | ✅ فعال |
| 2 | `198.41.203.85` | `80` | 6.69ms | ✅ فعال |
| 3 | `5.10.244.135` | `80` | 5.88ms | ✅ فعال |
| 4 | `101.200.158.109` | `9200` | 261.05ms | ✅ فعال |
| 5 | `47.76.144.139` | `8443` | 208.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.70.44` | `6331` | 82.13ms | ✅ فعال |
| 2 | `167.172.86.46` | `10471` | 231.59ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 292.74ms | ✅ فعال |
| 4 | `101.200.158.109` | `3128` | 264.07ms | ✅ فعال |
| 5 | `47.238.168.172` | `1011` | 210.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.7.159` | `80` | 5.78ms | ✅ فعال |
| 2 | `104.24.85.134` | `80` | 6.44ms | ✅ فعال |
| 3 | `23.227.39.55` | `80` | 6.32ms | ✅ فعال |
| 4 | `45.131.4.9` | `80` | 6.24ms | ✅ فعال |
| 5 | `104.24.197.20` | `80` | 8.35ms | ✅ فعال |
