...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:13 17-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (49 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `222.212.85.149` | `5678` | 229.79ms | ✅ فعال |
| 2 | `41.220.16.209` | `80` | 277.88ms | ✅ فعال |
| 3 | `217.162.8.134` | `80` | 136.61ms | ✅ فعال |
| 4 | `8.221.141.88` | `1200` | 127.10ms | ✅ فعال |
| 5 | `138.124.123.143` | `1080` | 42.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `162.220.246.135` | `6419` | 121.24ms | ✅ فعال |
| 2 | `45.150.23.223` | `6693` | 42.29ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 263.67ms | ✅ فعال |
| 4 | `79.106.170.126` | `4145` | 174.34ms | ✅ فعال |
| 5 | `39.109.113.97` | `4090` | 184.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.203.244` | `10933` | 24.73ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 182.75ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 153.21ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 142.41ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 165.89ms | ✅ فعال |
