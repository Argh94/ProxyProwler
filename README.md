...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:58 26-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.123.201` | `80` | 6.21ms | ✅ فعال |
| 2 | `104.16.253.130` | `80` | 5.77ms | ✅ فعال |
| 3 | `172.64.86.93` | `80` | 5.89ms | ✅ فعال |
| 4 | `104.20.62.122` | `80` | 5.78ms | ✅ فعال |
| 5 | `185.18.250.128` | `80` | 6.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.189.135.140` | `1080` | 249.03ms | ✅ فعال |
| 2 | `213.156.124.3` | `33333` | 109.57ms | ✅ فعال |
| 3 | `185.26.168.17` | `4153` | 149.73ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 240.85ms | ✅ فعال |
| 5 | `72.195.34.42` | `4145` | 106.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.198.99.209` | `10` | 215.98ms | ✅ فعال |
| 2 | `108.137.1.116` | `17277` | 237.21ms | ✅ فعال |
| 3 | `43.208.16.9` | `13580` | 248.54ms | ✅ فعال |
| 4 | `202.154.18.1` | `8080` | 265.47ms | ✅ فعال |
| 5 | `3.35.25.117` | `45366` | 190.73ms | ✅ فعال |
