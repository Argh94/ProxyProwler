...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:17 19-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.98.153.86` | `80` | 100.54ms | ✅ فعال |
| 2 | `187.63.9.62` | `63253` | 2159.70ms | ✅ فعال |
| 3 | `109.236.88.82` | `80` | 91.13ms | ✅ فعال |
| 4 | `185.18.250.83` | `80` | 6.16ms | ✅ فعال |
| 5 | `34.44.49.215` | `80` | 30.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.215.5` | `16137` | 54.05ms | ✅ فعال |
| 2 | `8.211.195.139` | `1080` | 631.39ms | ✅ فعال |
| 3 | `185.178.185.120` | `1080` | 1275.80ms | ✅ فعال |
| 4 | `85.105.194.113` | `4153` | 2213.18ms | ✅ فعال |
| 5 | `121.43.109.88` | `3129` | 252.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.17.47.48` | `80` | 142.97ms | ✅ فعال |
| 2 | `35.225.22.61` | `80` | 35.57ms | ✅ فعال |
| 3 | `47.89.159.212` | `8443` | 10.74ms | ✅ فعال |
| 4 | `163.5.128.87` | `14270` | 5.72ms | ✅ فعال |
| 5 | `47.250.159.65` | `9098` | 228.56ms | ✅ فعال |
