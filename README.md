...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:52 22-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `166.88.34.36` | `5747` | 3.63ms | ✅ فعال |
| 2 | `185.226.204.149` | `5702` | 104.43ms | ✅ فعال |
| 3 | `58.187.104.62` | `1082` | 242.82ms | ✅ فعال |
| 4 | `203.245.16.115` | `18090` | 1243.90ms | ✅ فعال |
| 5 | `65.109.219.215` | `9089` | 124.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.103.88.158` | `46104` | 34.98ms | ✅ فعال |
| 2 | `31.59.20.153` | `6731` | 99.30ms | ✅ فعال |
| 3 | `201.184.239.75` | `5678` | 2131.59ms | ✅ فعال |
| 4 | `8.221.141.88` | `5006` | 216.71ms | ✅ فعال |
| 5 | `185.226.204.149` | `5702` | 105.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 204.57ms | ✅ فعال |
| 2 | `51.79.71.106` | `8080` | 38.50ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 141.65ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 205.66ms | ✅ فعال |
| 5 | `36.88.170.170` | `8080` | 1313.22ms | ✅ فعال |
