...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 17-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.120.244` | `80` | 2.29ms | ✅ فعال |
| 2 | `193.53.127.169` | `80` | 175.24ms | ✅ فعال |
| 3 | `192.111.139.162` | `4145` | 52.83ms | ✅ فعال |
| 4 | `162.220.246.56` | `6340` | 76.12ms | ✅ فعال |
| 5 | `198.41.204.14` | `80` | 2.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.175.55` | `443` | 207.87ms | ✅ فعال |
| 2 | `203.189.141.138` | `1080` | 250.98ms | ✅ فعال |
| 3 | `200.123.109.166` | `4153` | 1172.63ms | ✅ فعال |
| 4 | `212.227.65.114` | `80` | 1160.76ms | ✅ فعال |
| 5 | `23.27.91.65` | `6144` | 85.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 216.81ms | ✅ فعال |
| 2 | `179.96.28.58` | `80` | 136.76ms | ✅ فعال |
| 3 | `13.246.11.197` | `621` | 211.96ms | ✅ فعال |
| 4 | `51.16.49.113` | `8585` | 274.17ms | ✅ فعال |
| 5 | `202.47.65.146` | `3129` | 245.13ms | ✅ فعال |
