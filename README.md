...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:58 27-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.38.141` | `80` | 2.04ms | ✅ فعال |
| 2 | `172.67.94.111` | `80` | 1.77ms | ✅ فعال |
| 3 | `104.19.31.34` | `80` | 1.96ms | ✅ فعال |
| 4 | `46.254.92.144` | `80` | 2.03ms | ✅ فعال |
| 5 | `156.225.72.84` | `80` | 2.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.214.20` | `15864` | 95.98ms | ✅ فعال |
| 2 | `41.191.203.160` | `80` | 286.35ms | ✅ فعال |
| 3 | `104.17.22.1` | `80` | 2.31ms | ✅ فعال |
| 4 | `47.237.169.183` | `1080` | 172.83ms | ✅ فعال |
| 5 | `45.65.224.26` | `1080` | 176.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.212.81.49` | `957` | 171.80ms | ✅ فعال |
| 2 | `218.89.134.230` | `3333` | 228.97ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 1145.01ms | ✅ فعال |
| 4 | `13.244.135.47` | `3333` | 276.71ms | ✅ فعال |
| 5 | `179.96.28.58` | `80` | 1204.25ms | ✅ فعال |
