...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:17 17-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.0.10.236` | `6412` | 20.26ms | ✅ فعال |
| 2 | `80.74.54.148` | `3128` | 100.54ms | ✅ فعال |
| 3 | `144.76.173.113` | `1080` | 114.55ms | ✅ فعال |
| 4 | `217.69.121.62` | `5727` | 96.85ms | ✅ فعال |
| 5 | `192.241.104.229` | `8323` | 42.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.238.57.1` | `3629` | 96.60ms | ✅ فعال |
| 2 | `89.58.55.33` | `80` | 111.36ms | ✅ فعال |
| 3 | `91.223.52.141` | `5678` | 118.01ms | ✅ فعال |
| 4 | `193.239.86.180` | `80` | 190.45ms | ✅ فعال |
| 5 | `185.32.4.126` | `4153` | 128.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 115.72ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 136.45ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 220.35ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 139.86ms | ✅ فعال |
