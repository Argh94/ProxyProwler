...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 30-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `145.223.46.121` | `5671` | 83.17ms | ✅ فعال |
| 2 | `185.162.230.175` | `80` | 5.89ms | ✅ فعال |
| 3 | `47.90.167.27` | `443` | 7.86ms | ✅ فعال |
| 4 | `104.16.104.93` | `80` | 5.98ms | ✅ فعال |
| 5 | `205.233.181.219` | `80` | 5.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `110.238.109.146` | `19` | 227.51ms | ✅ فعال |
| 2 | `35.197.89.213` | `80` | 68.89ms | ✅ فعال |
| 3 | `176.214.78.230` | `5678` | 126.59ms | ✅ فعال |
| 4 | `47.251.73.54` | `1080` | 67.35ms | ✅ فعال |
| 5 | `39.104.57.170` | `3000` | 272.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.229.112.25` | `8080` | 42.72ms | ✅ فعال |
| 2 | `13.212.14.16` | `28080` | 224.56ms | ✅ فعال |
| 3 | `43.198.99.209` | `8496` | 205.96ms | ✅ فعال |
| 4 | `157.175.43.137` | `8334` | 169.70ms | ✅ فعال |
| 5 | `202.154.18.1` | `8080` | 253.81ms | ✅ فعال |
