...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:28 14-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `62.148.236.156` | `10808` | 222.76ms | ✅ فعال |
| 2 | `184.181.217.194` | `4145` | 84.97ms | ✅ فعال |
| 3 | `149.57.17.65` | `5533` | 9.73ms | ✅ فعال |
| 4 | `81.0.49.104` | `18500` | 106.03ms | ✅ فعال |
| 5 | `184.178.172.5` | `15303` | 84.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.56.73.23` | `80` | 93.94ms | ✅ فعال |
| 2 | `154.68.64.2` | `80` | 292.37ms | ✅ فعال |
| 3 | `38.127.172.243` | `37234` | 10.23ms | ✅ فعال |
| 4 | `68.71.254.6` | `4145` | 70.92ms | ✅ فعال |
| 5 | `185.226.207.14` | `5563` | 82.96ms | ✅ فعال |
...
| 2 | `103.130.61.61` | `8081` | 244.53ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 121.67ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 157.29ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 242.15ms | ✅ فعال |
