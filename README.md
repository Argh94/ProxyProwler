...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 04-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.193.213.254` | `80` | 1.86ms | ✅ فعال |
| 2 | `104.16.198.195` | `80` | 3.27ms | ✅ فعال |
| 3 | `5.10.244.93` | `80` | 2.33ms | ✅ فعال |
| 4 | `162.159.152.242` | `80` | 2.19ms | ✅ فعال |
| 5 | `156.239.206.22` | `1338` | 15.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `83.219.1.130` | `5678` | 169.88ms | ✅ فعال |
| 2 | `8.221.141.88` | `9500` | 2898.10ms | ✅ فعال |
| 3 | `103.175.37.34` | `1080` | 234.39ms | ✅ فعال |
| 4 | `39.104.23.154` | `8004` | 247.79ms | ✅ فعال |
| 5 | `88.87.79.18` | `3629` | 1169.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.79.112.218` | `9050` | 221.10ms | ✅ فعال |
| 2 | `103.17.214.186` | `8080` | 2329.76ms | ✅ فعال |
| 3 | `51.96.154.27` | `21715` | 112.86ms | ✅ فعال |
| 4 | `18.230.78.244` | `8080` | 130.86ms | ✅ فعال |
| 5 | `54.74.104.194` | `8087` | 92.15ms | ✅ فعال |
