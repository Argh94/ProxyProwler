...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 14-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.105.95` | `80` | 8.50ms | ✅ فعال |
| 2 | `199.34.230.7` | `80` | 8.11ms | ✅ فعال |
| 3 | `65.111.8.60` | `3129` | 23.71ms | ✅ فعال |
| 4 | `192.111.135.18` | `18301` | 71.43ms | ✅ فعال |
| 5 | `185.170.166.138` | `80` | 3.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.226.214` | `4145` | 68.82ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 133.80ms | ✅ فعال |
| 3 | `45.187.76.2` | `3629` | 1228.36ms | ✅ فعال |
| 4 | `104.16.110.1` | `80` | 2.75ms | ✅ فعال |
| 5 | `47.243.175.55` | `443` | 198.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 17.23ms | ✅ فعال |
| 2 | `147.75.68.201` | `9443` | 60.81ms | ✅ فعال |
| 3 | `72.240.9.63` | `80` | 57.97ms | ✅ فعال |
| 4 | `157.175.152.104` | `8079` | 193.15ms | ✅ فعال |
| 5 | `157.175.196.63` | `88` | 195.30ms | ✅ فعال |
