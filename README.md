...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:44 09-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.82.146.247` | `1080` | 230.89ms | ✅ فعال |
| 2 | `64.188.77.221` | `1080` | 87.63ms | ✅ فعال |
| 3 | `47.82.150.176` | `1080` | 232.29ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 231.04ms | ✅ فعال |
| 5 | `65.108.203.35` | `18080` | 119.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `64.188.77.26` | `1080` | 93.58ms | ✅ فعال |
| 2 | `157.10.97.83` | `2021` | 258.60ms | ✅ فعال |
| 3 | `72.207.109.5` | `4145` | 86.94ms | ✅ فعال |
| 4 | `185.32.4.126` | `4153` | 1163.78ms | ✅ فعال |
| 5 | `31.13.239.4` | `5678` | 2153.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 2.34ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 2.35ms | ✅ فعال |
| 3 | `176.88.168.107` | `8080` | 144.45ms | ✅ فعال |
| 4 | `103.165.128.171` | `8080` | 243.45ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 117.85ms | ✅ فعال |
