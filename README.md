...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:34 14-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.182.135.85` | `3128` | 37.11ms | ✅ فعال |
| 2 | `203.25.208.163` | `1100` | 270.53ms | ✅ فعال |
| 3 | `82.223.151.29` | `1080` | 84.56ms | ✅ فعال |
| 4 | `45.3.33.89` | `3129` | 2.14ms | ✅ فعال |
| 5 | `212.77.75.25` | `1088` | 102.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.78` | `80` | 85.66ms | ✅ فعال |
| 2 | `178.220.148.82` | `10801` | 1145.20ms | ✅ فعال |
| 3 | `185.226.207.76` | `5625` | 83.79ms | ✅ فعال |
| 4 | `45.43.70.123` | `6410` | 84.84ms | ✅ فعال |
| 5 | `198.46.137.162` | `6366` | 61.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.141.54.136` | `5555` | 57.92ms | ✅ فعال |
| 2 | `103.147.247.171` | `8080` | 236.93ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 4.51ms | ✅ فعال |
| 4 | `103.162.16.45` | `8080` | 243.55ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 3.06ms | ✅ فعال |
