...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:17 26-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `176.126.164.213` | `80` | 204.39ms | ✅ فعال |
| 2 | `8.213.197.208` | `4002` | 235.18ms | ✅ فعال |
| 3 | `27.73.18.91` | `1080` | 222.69ms | ✅ فعال |
| 4 | `145.220.226.89` | `8080` | 127.56ms | ✅ فعال |
| 5 | `145.220.226.237` | `8080` | 121.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `91.202.185.69` | `80` | 168.21ms | ✅ فعال |
| 2 | `39.102.208.189` | `80` | 225.21ms | ✅ فعال |
| 3 | `202.133.88.173` | `80` | 135.50ms | ✅ فعال |
| 4 | `101.255.166.134` | `80` | 209.70ms | ✅ فعال |
| 5 | `202.40.179.18` | `4145` | 255.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 26.92ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 209.29ms | ✅ فعال |
| 3 | `103.36.11.21` | `8080` | 217.18ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 212.53ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 23.90ms | ✅ فعال |
