...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:46 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.64.85.89` | `80` | 9.03ms | ✅ فعال |
| 2 | `8.211.42.167` | `8083` | 748.04ms | ✅ فعال |
| 3 | `45.85.118.122` | `80` | 8.46ms | ✅ فعال |
| 4 | `45.131.6.125` | `80` | 8.42ms | ✅ فعال |
| 5 | `160.153.1.200` | `80` | 8.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.6.101.97` | `4153` | 1191.91ms | ✅ فعال |
| 2 | `88.216.98.211` | `53983` | 2127.29ms | ✅ فعال |
| 3 | `202.40.181.220` | `31247` | 239.03ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 266.73ms | ✅ فعال |
| 5 | `8.211.42.167` | `8083` | 140.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.28` | `80` | 8.60ms | ✅ فعال |
| 2 | `190.93.247.0` | `80` | 15.82ms | ✅ فعال |
| 3 | `45.131.7.159` | `80` | 8.29ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 10.51ms | ✅ فعال |
| 5 | `45.131.4.93` | `80` | 8.40ms | ✅ فعال |
