...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 11-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.67.215.10` | `80` | 2.13ms | ✅ فعال |
| 2 | `12.50.107.217` | `80` | 37.95ms | ✅ فعال |
| 3 | `86.38.154.246` | `5889` | 94.75ms | ✅ فعال |
| 4 | `104.16.62.176` | `80` | 22.48ms | ✅ فعال |
| 5 | `104.143.224.57` | `5918` | 91.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.237.2.245` | `808` | 209.19ms | ✅ فعال |
| 2 | `198.105.100.246` | `6497` | 92.54ms | ✅ فعال |
| 3 | `8.134.149.133` | `8081` | 247.64ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 237.58ms | ✅ فعال |
| 5 | `63.141.128.249` | `80` | 3.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 17.69ms | ✅ فعال |
| 2 | `13.246.11.197` | `621` | 235.34ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 18.88ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 213.06ms | ✅ فعال |
| 5 | `3.110.127.255` | `48200` | 1222.68ms | ✅ فعال |
