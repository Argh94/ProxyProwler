...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 13-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.112.180` | `80` | 2.75ms | ✅ فعال |
| 2 | `184.168.47.195` | `80` | 2.07ms | ✅ فعال |
| 3 | `104.17.108.8` | `80` | 2.03ms | ✅ فعال |
| 4 | `185.193.31.230` | `80` | 2.34ms | ✅ فعال |
| 5 | `172.67.89.138` | `80` | 1.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.0.0.4` | `80` | 2.47ms | ✅ فعال |
| 2 | `8.213.222.247` | `6379` | 232.09ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 239.15ms | ✅ فعال |
| 4 | `200.41.182.243` | `4145` | 156.95ms | ✅ فعال |
| 5 | `97.105.12.186` | `4153` | 2110.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.178` | `80` | 2.03ms | ✅ فعال |
| 2 | `141.101.122.238` | `80` | 2.62ms | ✅ فعال |
| 3 | `5.10.246.51` | `80` | 1.70ms | ✅ فعال |
| 4 | `89.116.250.4` | `80` | 1.84ms | ✅ فعال |
| 5 | `198.177.56.190` | `80` | 1.87ms | ✅ فعال |
