...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:19 24-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.118.127.222` | `4153` | 2308.58ms | ✅ فعال |
| 2 | `47.91.89.3` | `8443` | 96.70ms | ✅ فعال |
| 3 | `47.74.46.81` | `18080` | 162.73ms | ✅ فعال |
| 4 | `104.143.226.63` | `5666` | 84.70ms | ✅ فعال |
| 5 | `5.255.117.127` | `1080` | 2172.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.147.131.102` | `6002` | 31.92ms | ✅ فعال |
| 2 | `174.77.111.196` | `4145` | 85.29ms | ✅ فعال |
| 3 | `145.223.46.45` | `5595` | 88.06ms | ✅ فعال |
| 4 | `45.39.115.84` | `5495` | 34.34ms | ✅ فعال |
| 5 | `198.37.99.227` | `6018` | 15.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 239.23ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 119.05ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 6.72ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 6.17ms | ✅ فعال |
