...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:49 13-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.134.213` | `50` | 182.37ms | ✅ فعال |
| 2 | `43.160.255.142` | `7890` | 223.07ms | ✅ فعال |
| 3 | `174.138.119.88` | `80` | 7.37ms | ✅ فعال |
| 4 | `45.194.33.12` | `30001` | 211.45ms | ✅ فعال |
| 5 | `159.223.88.58` | `1080` | 222.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.167.18.122` | `443` | 55.86ms | ✅ فعال |
| 2 | `8.221.141.88` | `8083` | 163.10ms | ✅ فعال |
| 3 | `39.109.113.97` | `4090` | 213.76ms | ✅ فعال |
| 4 | `98.175.31.195` | `4145` | 85.18ms | ✅ فعال |
| 5 | `8.213.134.213` | `50` | 182.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.59.59.122` | `8118` | 194.05ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 157.07ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 115.47ms | ✅ فعال |
| 4 | `103.130.61.61` | `8081` | 262.47ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 223.07ms | ✅ فعال |
