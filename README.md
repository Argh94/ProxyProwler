...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 22-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.231.192` | `80` | 8.65ms | ✅ فعال |
| 2 | `45.131.7.123` | `80` | 8.94ms | ✅ فعال |
| 3 | `104.18.43.80` | `80` | 8.69ms | ✅ فعال |
| 4 | `98.181.137.80` | `4145` | 145.38ms | ✅ فعال |
| 5 | `91.193.58.35` | `80` | 8.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.181.137.80` | `4145` | 173.55ms | ✅ فعال |
| 2 | `217.26.67.57` | `3180` | 2217.90ms | ✅ فعال |
| 3 | `41.216.186.250` | `4153` | 218.73ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 165.11ms | ✅ فعال |
| 5 | `171.248.210.142` | `1080` | 182.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.121.123` | `17043` | 53.16ms | ✅ فعال |
| 2 | `15.160.134.84` | `9492` | 145.24ms | ✅ فعال |
| 3 | `1.10.141.115` | `8080` | 2247.37ms | ✅ فعال |
| 4 | `78.12.121.123` | `20112` | 51.39ms | ✅ فعال |
| 5 | `16.79.112.218` | `1981` | 193.34ms | ✅ فعال |
