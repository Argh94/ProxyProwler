...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 11-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.5.140` | `80` | 2.70ms | ✅ فعال |
| 2 | `47.251.87.74` | `1080` | 69.89ms | ✅ فعال |
| 3 | `8.213.215.187` | `9098` | 243.69ms | ✅ فعال |
| 4 | `154.30.242.191` | `9585` | 60.45ms | ✅ فعال |
| 5 | `185.148.105.202` | `80` | 1.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 273.11ms | ✅ فعال |
| 2 | `8.213.129.20` | `20201` | 742.59ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 267.20ms | ✅ فعال |
| 4 | `157.250.203.202` | `8080` | 41.43ms | ✅ فعال |
| 5 | `195.29.122.132` | `60606` | 117.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.246.51` | `80` | 1.82ms | ✅ فعال |
| 2 | `141.101.122.238` | `80` | 2.16ms | ✅ فعال |
| 3 | `172.67.181.33` | `80` | 2.46ms | ✅ فعال |
| 4 | `23.227.39.55` | `80` | 2.31ms | ✅ فعال |
| 5 | `104.17.106.99` | `80` | 2.51ms | ✅ فعال |
