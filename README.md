...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:35 28-04-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (38 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.18.93.138` | `19450` | 273.38ms | ✅ فعال |
| 2 | `45.133.210.241` | `1080` | 97.96ms | ✅ فعال |
| 3 | `103.83.87.75` | `9090` | 139.14ms | ✅ فعال |
| 4 | `98.182.147.97` | `4145` | 89.73ms | ✅ فعال |
| 5 | `209.50.180.248` | `3129` | 104.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.244.158.4` | `3129` | 121.65ms | ✅ فعال |
| 2 | `71.198.208.169` | `443` | 74.80ms | ✅ فعال |
| 3 | `221.157.45.249` | `80` | 186.04ms | ✅ فعال |
| 4 | `103.146.170.233` | `5678` | 232.45ms | ✅ فعال |
| 5 | `186.251.253.53` | `31337` | 2200.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 6.45ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 238.35ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 119.67ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 6.85ms | ✅ فعال |
| 5 | `103.189.116.20` | `8080` | 249.28ms | ✅ فعال |
