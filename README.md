...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 11-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.72.212` | `80` | 2.14ms | ✅ فعال |
| 2 | `195.85.23.66` | `80` | 1.96ms | ✅ فعال |
| 3 | `104.25.96.214` | `80` | 2.15ms | ✅ فعال |
| 4 | `154.83.2.199` | `80` | 1.85ms | ✅ فعال |
| 5 | `104.25.1.95` | `80` | 1.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `171.237.48.53` | `1080` | 232.68ms | ✅ فعال |
| 2 | `8.221.138.111` | `31433` | 877.94ms | ✅ فعال |
| 3 | `93.90.212.2` | `4153` | 1224.69ms | ✅ فعال |
| 4 | `96.126.111.39` | `1081` | 22.30ms | ✅ فعال |
| 5 | `47.91.110.148` | `1080` | 818.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.114.9.221` | `970` | 140.75ms | ✅ فعال |
| 2 | `45.186.6.104` | `3128` | 89.31ms | ✅ فعال |
| 3 | `16.78.105.11` | `9818` | 219.01ms | ✅ فعال |
| 4 | `16.78.82.73` | `1331` | 218.35ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 16.26ms | ✅ فعال |
