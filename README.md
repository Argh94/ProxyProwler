...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:11 20-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.238.40` | `80` | 6.58ms | ✅ فعال |
| 2 | `45.8.211.241` | `80` | 48.00ms | ✅ فعال |
| 3 | `104.19.153.242` | `80` | 6.14ms | ✅ فعال |
| 4 | `181.214.1.137` | `80` | 6.07ms | ✅ فعال |
| 5 | `104.27.94.97` | `80` | 6.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.41.33` | `372` | 238.03ms | ✅ فعال |
| 2 | `185.26.168.17` | `4153` | 159.48ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 226.46ms | ✅ فعال |
| 4 | `91.221.177.40` | `80` | 150.40ms | ✅ فعال |
| 5 | `47.250.11.111` | `1000` | 273.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.191.200.48` | `3128` | 17.33ms | ✅ فعال |
| 2 | `119.18.144.131` | `8585` | 1334.95ms | ✅ فعال |
| 3 | `3.249.110.142` | `5975` | 249.44ms | ✅ فعال |
| 4 | `15.168.235.57` | `982` | 168.54ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 98.55ms | ✅ فعال |
