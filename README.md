...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 19-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `89.46.249.143` | `13266` | 79.54ms | ✅ فعال |
| 2 | `104.21.3.69` | `80` | 7.71ms | ✅ فعال |
| 3 | `162.159.247.92` | `80` | 5.73ms | ✅ فعال |
| 4 | `104.21.66.71` | `80` | 13.63ms | ✅ فعال |
| 5 | `104.26.10.57` | `80` | 6.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.148.23.202` | `9091` | 267.74ms | ✅ فعال |
| 2 | `203.217.101.190` | `80` | 191.26ms | ✅ فعال |
| 3 | `194.146.110.228` | `1080` | 124.40ms | ✅ فعال |
| 4 | `47.237.107.41` | `8081` | 358.93ms | ✅ فعال |
| 5 | `43.134.237.216` | `443` | 228.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.216.224.9` | `8664` | 75.53ms | ✅ فعال |
| 2 | `146.190.80.158` | `9090` | 224.65ms | ✅ فعال |
| 3 | `78.12.220.164` | `8808` | 57.25ms | ✅ فعال |
| 4 | `43.209.8.12` | `13371` | 252.30ms | ✅ فعال |
| 5 | `3.122.235.189` | `9797` | 93.05ms | ✅ فعال |
