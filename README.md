...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:18 29-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.200.160.80` | `80` | 1.66ms | ✅ فعال |
| 2 | `134.209.29.120` | `80` | 146.56ms | ✅ فعال |
| 3 | `154.197.75.36` | `80` | 1.68ms | ✅ فعال |
| 4 | `206.238.236.198` | `80` | 1.57ms | ✅ فعال |
| 5 | `104.26.0.225` | `80` | 2.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.199.166.236` | `9078` | 167.07ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 183.53ms | ✅ فعال |
| 3 | `72.195.114.169` | `4145` | 124.26ms | ✅ فعال |
| 4 | `159.138.252.45` | `8888` | 209.20ms | ✅ فعال |
| 5 | `45.61.188.134` | `44499` | 104.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 60.52ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 169.68ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 263.37ms | ✅ فعال |
| 4 | `13.212.14.16` | `28080` | 170.20ms | ✅ فعال |
| 5 | `43.208.16.9` | `45605` | 194.95ms | ✅ فعال |
