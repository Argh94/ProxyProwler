...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:23 12-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.214.17` | `4145` | 108.09ms | ✅ فعال |
| 2 | `206.123.156.222` | `4652` | 189.77ms | ✅ فعال |
| 3 | `89.249.193.136` | `5874` | 19.27ms | ✅ فعال |
| 4 | `85.192.29.60` | `1080` | 157.78ms | ✅ فعال |
| 5 | `139.99.46.73` | `3128` | 167.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.6.59.102` | `6570` | 85.00ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 256.13ms | ✅ فعال |
| 3 | `45.135.139.7` | `6310` | 148.60ms | ✅ فعال |
| 4 | `184.182.240.211` | `4145` | 148.34ms | ✅ فعال |
| 5 | `85.192.29.60` | `1080` | 157.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.229.197.94` | `999` | 2147.45ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 181.00ms | ✅ فعال |
| 3 | `182.253.109.162` | `8080` | 1210.59ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 72.38ms | ✅ فعال |
| 5 | `195.25.20.155` | `3128` | 155.26ms | ✅ فعال |
