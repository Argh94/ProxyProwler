...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:55 18-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.169.142.0` | `80` | 11.09ms | ✅ فعال |
| 2 | `45.174.94.26` | `999` | 52.47ms | ✅ فعال |
| 3 | `172.67.167.41` | `80` | 9.22ms | ✅ فعال |
| 4 | `141.101.122.24` | `80` | 9.26ms | ✅ فعال |
| 5 | `133.18.234.13` | `80` | 1164.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.215` | `3128` | 730.13ms | ✅ فعال |
| 2 | `103.158.252.67` | `80` | 1259.89ms | ✅ فعال |
| 3 | `39.104.69.76` | `8888` | 207.21ms | ✅ فعال |
| 4 | `142.111.239.50` | `5628` | 31.75ms | ✅ فعال |
| 5 | `223.206.189.130` | `4153` | 1259.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `201.89.97.222` | `8080` | 163.51ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 54.27ms | ✅ فعال |
| 3 | `145.40.97.148` | `10615` | 285.21ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 123.58ms | ✅ فعال |
| 5 | `54.180.143.12` | `9482` | 135.51ms | ✅ فعال |
