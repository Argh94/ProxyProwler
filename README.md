...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:55 28-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.51.110` | `6379` | 226.64ms | ✅ فعال |
| 2 | `113.208.119.142` | `9002` | 253.87ms | ✅ فعال |
| 3 | `142.54.237.38` | `4145` | 70.93ms | ✅ فعال |
| 4 | `142.54.232.6` | `4145` | 75.95ms | ✅ فعال |
| 5 | `41.59.90.170` | `80` | 201.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.128.246` | `10002` | 200.93ms | ✅ فعال |
| 2 | `62.133.62.231` | `1081` | 194.75ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 116.99ms | ✅ فعال |
| 4 | `170.106.188.46` | `5432` | 73.47ms | ✅ فعال |
| 5 | `31.76.13.237` | `1080` | 110.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.212.237.47` | `3128` | 90.00ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 2.28ms | ✅ فعال |
| 3 | `209.141.62.12` | `5555` | 64.10ms | ✅ فعال |
| 4 | `195.25.20.155` | `3128` | 94.27ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.09ms | ✅ فعال |
