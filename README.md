...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:06 05-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `39.175.80.225` | `1080` | 202.19ms | ✅ فعال |
| 2 | `74.1.206.48` | `50161` | 190.65ms | ✅ فعال |
| 3 | `5.255.99.75` | `1080` | 87.84ms | ✅ فعال |
| 4 | `206.189.144.164` | `10808` | 223.87ms | ✅ فعال |
| 5 | `112.198.22.122` | `80` | 1252.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 227.89ms | ✅ فعال |
| 2 | `112.198.22.122` | `80` | 258.19ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 1121.21ms | ✅ فعال |
| 4 | `41.216.232.213` | `4153` | 2257.75ms | ✅ فعال |
| 5 | `199.229.254.129` | `4145` | 58.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 159.28ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 1138.87ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 3.37ms | ✅ فعال |
| 4 | `94.130.177.190` | `9999` | 97.95ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 223.41ms | ✅ فعال |
