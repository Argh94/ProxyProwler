...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:54 25-12-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (60 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 204.75ms | ✅ فعال |
| 2 | `137.220.150.152` | `6005` | 202.35ms | ✅ فعال |
| 3 | `98.178.72.21` | `10919` | 89.17ms | ✅ فعال |
| 4 | `107.174.231.218` | `8888` | 22.61ms | ✅ فعال |
| 5 | `103.125.31.222` | `80` | 277.22ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (53 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.151.128` | `3128` | 166.33ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 256.83ms | ✅ فعال |
| 3 | `142.54.229.249` | `4145` | 60.90ms | ✅ فعال |
| 4 | `184.178.172.18` | `15280` | 89.65ms | ✅ فعال |
| 5 | `110.238.111.229` | `8080` | 208.29ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (28 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 235.69ms | ✅ فعال |
| 2 | `38.145.203.106` | `8448` | 64.36ms | ✅ فعال |
| 3 | `38.145.203.105` | `8447` | 71.25ms | ✅ فعال |
| 4 | `38.145.208.172` | `8448` | 70.35ms | ✅ فعال |
| 5 | `38.145.208.160` | `8447` | 67.91ms | ✅ فعال |
