...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 21-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.235.82` | `80` | 16.78ms | ✅ فعال |
| 2 | `172.67.214.190` | `80` | 6.03ms | ✅ فعال |
| 3 | `5.10.246.30` | `80` | 6.22ms | ✅ فعال |
| 4 | `155.254.38.7` | `5683` | 80.37ms | ✅ فعال |
| 5 | `184.178.172.25` | `15291` | 106.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `88.216.215.147` | `9078` | 114.03ms | ✅ فعال |
| 2 | `8.211.49.86` | `3128` | 613.91ms | ✅ فعال |
| 3 | `74.119.147.209` | `4145` | 52.23ms | ✅ فعال |
| 4 | `88.216.68.10` | `9063` | 21.96ms | ✅ فعال |
| 5 | `139.196.151.191` | `8090` | 263.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.108.50` | `59375` | 237.17ms | ✅ فعال |
| 2 | `51.84.65.10` | `31362` | 137.73ms | ✅ فعال |
| 3 | `12.50.107.221` | `80` | 31.00ms | ✅ فعال |
| 4 | `13.59.97.103` | `50827` | 14.90ms | ✅ فعال |
| 5 | `16.79.112.218` | `44048` | 1299.08ms | ✅ فعال |
