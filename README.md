...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:50 11-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.194.33.12` | `30001` | 210.60ms | ✅ فعال |
| 2 | `116.104.252.1` | `1088` | 222.70ms | ✅ فعال |
| 3 | `184.178.172.17` | `4145` | 107.47ms | ✅ فعال |
| 4 | `103.75.118.84` | `1080` | 147.63ms | ✅ فعال |
| 5 | `216.68.128.121` | `4145` | 134.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 1171.38ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 173.30ms | ✅ فعال |
| 3 | `149.129.255.179` | `80` | 209.23ms | ✅ فعال |
| 4 | `8.211.194.78` | `5800` | 110.15ms | ✅ فعال |
| 5 | `8.213.197.208` | `1080` | 223.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 204.39ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 23.82ms | ✅ فعال |
| 3 | `103.158.252.99` | `80` | 207.83ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 23.91ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 158.61ms | ✅ فعال |
