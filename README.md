...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:55 08-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.11` | `4145` | 91.97ms | ✅ فعال |
| 2 | `78.29.43.50` | `1080` | 152.69ms | ✅ فعال |
| 3 | `116.106.111.147` | `1080` | 230.04ms | ✅ فعال |
| 4 | `185.17.57.179` | `8080` | 81.77ms | ✅ فعال |
| 5 | `184.181.217.210` | `4145` | 94.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 229.57ms | ✅ فعال |
| 2 | `176.192.41.172` | `4444` | 124.62ms | ✅ فعال |
| 3 | `162.220.246.190` | `6474` | 79.83ms | ✅ فعال |
| 4 | `68.1.210.163` | `4145` | 91.93ms | ✅ فعال |
| 5 | `81.168.119.85` | `443` | 2160.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 120.92ms | ✅ فعال |
| 2 | `195.25.20.155` | `3128` | 94.00ms | ✅ فعال |
| 3 | `158.101.175.124` | `5566` | 88.23ms | ✅ فعال |
| 4 | `209.141.54.136` | `5555` | 63.75ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 8.15ms | ✅ فعال |
