...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:57 18-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `111.206.4.163` | `18888` | 245.07ms | ✅ فعال |
| 2 | `51.210.5.144` | `1088` | 111.56ms | ✅ فعال |
| 3 | `184.181.217.206` | `4145` | 88.90ms | ✅ فعال |
| 4 | `198.105.111.87` | `6765` | 98.14ms | ✅ فعال |
| 5 | `104.232.211.76` | `5689` | 22.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.255.166.134` | `80` | 229.07ms | ✅ فعال |
| 2 | `219.65.73.81` | `80` | 293.83ms | ✅ فعال |
| 3 | `104.232.211.76` | `5689` | 23.47ms | ✅ فعال |
| 4 | `31.59.33.103` | `6679` | 97.30ms | ✅ فعال |
| 5 | `82.132.19.108` | `4153` | 127.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 1236.12ms | ✅ فعال |
| 2 | `203.150.128.2` | `8080` | 256.93ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 131.60ms | ✅ فعال |
| 4 | `94.130.177.190` | `9999` | 116.16ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 235.46ms | ✅ فعال |
