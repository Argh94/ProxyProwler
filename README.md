...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:36 01-07-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `36.155.23.163` | `10808` | 1261.76ms | ✅ فعال |
| 2 | `198.8.84.3` | `4145` | 69.99ms | ✅ فعال |
| 3 | `95.111.228.190` | `1081` | 149.96ms | ✅ فعال |
| 4 | `103.88.234.239` | `40002` | 60.51ms | ✅ فعال |
| 5 | `51.195.102.121` | `10084` | 91.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.105.111.102` | `6780` | 82.96ms | ✅ فعال |
| 2 | `198.12.37.25` | `1080` | 177.26ms | ✅ فعال |
| 3 | `189.203.181.34` | `1080` | 2129.88ms | ✅ فعال |
| 4 | `104.207.39.114` | `3129` | 5.71ms | ✅ فعال |
| 5 | `67.201.59.70` | `4145` | 70.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 123.14ms | ✅ فعال |
| 2 | `103.171.182.229` | `8080` | 2284.61ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 226.26ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 232.48ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 226.59ms | ✅ فعال |
