...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:18 13-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.76.104.16` | `1080` | 235.81ms | ✅ فعال |
| 2 | `43.161.217.219` | `1080` | 208.51ms | ✅ فعال |
| 3 | `173.181.143.245` | `80` | 1193.79ms | ✅ فعال |
| 4 | `206.123.156.221` | `20390` | 101.39ms | ✅ فعال |
| 5 | `154.219.125.240` | `58367` | 66.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.33.240` | `6816` | 77.13ms | ✅ فعال |
| 2 | `130.49.150.81` | `1080` | 124.75ms | ✅ فعال |
| 3 | `201.184.239.75` | `5678` | 76.05ms | ✅ فعال |
| 4 | `158.94.208.76` | `9050` | 129.70ms | ✅ فعال |
| 5 | `173.181.143.245` | `80` | 164.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.70.236.194` | `999` | 94.78ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 120.38ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 226.00ms | ✅ فعال |
| 4 | `138.2.64.185` | `8118` | 225.85ms | ✅ فعال |
| 5 | `103.158.252.99` | `80` | 238.13ms | ✅ فعال |
