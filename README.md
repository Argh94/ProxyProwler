...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 19-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.81.114` | `5761` | 77.10ms | ✅ فعال |
| 2 | `188.42.89.188` | `80` | 2.79ms | ✅ فعال |
| 3 | `104.17.44.85` | `80` | 2.42ms | ✅ فعال |
| 4 | `184.181.217.194` | `4145` | 67.40ms | ✅ فعال |
| 5 | `66.235.200.30` | `80` | 2.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.41.33` | `372` | 239.62ms | ✅ فعال |
| 2 | `8.213.222.157` | `8008` | 250.26ms | ✅ فعال |
| 3 | `16.78.41.33` | `5080` | 240.70ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 91.26ms | ✅ فعال |
| 5 | `47.119.19.221` | `9080` | 269.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `52.47.164.226` | `642` | 84.40ms | ✅ فعال |
| 2 | `43.208.129.50` | `9252` | 254.87ms | ✅ فعال |
| 3 | `170.239.205.74` | `8080` | 2128.74ms | ✅ فعال |
| 4 | `62.113.119.14` | `8080` | 122.71ms | ✅ فعال |
| 5 | `40.192.16.115` | `8721` | 207.46ms | ✅ فعال |
