...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 28-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.107.140` | `80` | 2.09ms | ✅ فعال |
| 2 | `216.205.52.230` | `80` | 1.90ms | ✅ فعال |
| 3 | `8.213.222.247` | `30000` | 228.07ms | ✅ فعال |
| 4 | `141.101.120.109` | `80` | 2.75ms | ✅ فعال |
| 5 | `104.25.218.144` | `80` | 2.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 258.65ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 122.39ms | ✅ فعال |
| 3 | `1.234.23.159` | `80` | 166.81ms | ✅ فعال |
| 4 | `187.111.144.102` | `8080` | 2183.44ms | ✅ فعال |
| 5 | `47.89.159.212` | `5060` | 18.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.93` | `80` | 2.10ms | ✅ فعال |
| 2 | `45.85.118.80` | `80` | 2.49ms | ✅ فعال |
| 3 | `172.66.40.96` | `80` | 1.89ms | ✅ فعال |
| 4 | `45.12.31.28` | `80` | 2.52ms | ✅ فعال |
| 5 | `141.101.122.238` | `80` | 2.60ms | ✅ فعال |
