...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:44 24-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.138.168.74` | `8001` | 3.61ms | ✅ فعال |
| 2 | `206.123.156.236` | `5193` | 1211.55ms | ✅ فعال |
| 3 | `43.165.6.179` | `1080` | 135.94ms | ✅ فعال |
| 4 | `8.39.228.21` | `39593` | 37.74ms | ✅ فعال |
| 5 | `171.248.217.155` | `1080` | 182.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.33.51` | `6627` | 132.07ms | ✅ فعال |
| 2 | `103.75.118.84` | `1080` | 120.82ms | ✅ فعال |
| 3 | `23.133.196.12` | `9000` | 1022.57ms | ✅ فعال |
| 4 | `93.171.157.249` | `8080` | 202.56ms | ✅ فعال |
| 5 | `8.221.139.222` | `199` | 111.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 54.68ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 167.60ms | ✅ فعال |
| 3 | `94.130.177.190` | `9999` | 141.48ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 150.92ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 61.25ms | ✅ فعال |
