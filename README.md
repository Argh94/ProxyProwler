...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:51 10-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `167.71.182.192` | `80` | 56.68ms | ✅ فعال |
| 2 | `187.63.9.62` | `63253` | 162.06ms | ✅ فعال |
| 3 | `8.137.13.191` | `80` | 243.62ms | ✅ فعال |
| 4 | `164.90.183.36` | `1093` | 140.93ms | ✅ فعال |
| 5 | `206.123.156.217` | `9753` | 2220.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.46.148.83` | `5771` | 58.60ms | ✅ فعال |
| 2 | `5.95.121.180` | `4153` | 159.15ms | ✅ فعال |
| 3 | `8.213.222.247` | `9098` | 201.41ms | ✅ فعال |
| 4 | `167.71.182.192` | `80` | 66.28ms | ✅ فعال |
| 5 | `8.221.138.111` | `9080` | 121.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 122.05ms | ✅ فعال |
| 2 | `209.141.54.136` | `5555` | 19.16ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 1238.11ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 168.74ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 178.00ms | ✅ فعال |
