...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:57 07-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `204.76.203.9` | `8080` | 116.42ms | ✅ فعال |
| 2 | `72.195.34.41` | `4145` | 108.01ms | ✅ فعال |
| 3 | `216.68.128.121` | `4145` | 269.29ms | ✅ فعال |
| 4 | `142.54.226.214` | `4145` | 61.58ms | ✅ فعال |
| 5 | `192.252.209.158` | `4145` | 75.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.41.11.138` | `8080` | 162.38ms | ✅ فعال |
| 2 | `13.125.44.24` | `80` | 162.04ms | ✅ فعال |
| 3 | `192.111.139.163` | `19404` | 73.12ms | ✅ فعال |
| 4 | `47.238.60.156` | `2526` | 729.28ms | ✅ فعال |
| 5 | `198.8.84.3` | `4145` | 66.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 196.35ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 152.97ms | ✅ فعال |
