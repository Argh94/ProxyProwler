...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:55 25-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `193.25.215.182` | `22222` | 119.30ms | ✅ فعال |
| 2 | `34.43.46.91` | `80` | 11.39ms | ✅ فعال |
| 3 | `45.43.64.40` | `6298` | 95.12ms | ✅ فعال |
| 4 | `184.182.240.12` | `4145` | 88.74ms | ✅ فعال |
| 5 | `72.49.49.11` | `31034` | 78.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.207.38.173` | `3129` | 15.86ms | ✅ فعال |
| 2 | `203.170.146.146` | `4153` | 238.39ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 131.06ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 249.77ms | ✅ فعال |
| 5 | `154.6.23.123` | `6590` | 48.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 222.84ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 208.88ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 222.40ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 140.52ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 156.23ms | ✅ فعال |
