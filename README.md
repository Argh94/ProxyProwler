...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 03:28 16-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.183.251` | `4145` | 79.60ms | ✅ فعال |
| 2 | `208.102.51.6` | `58208` | 161.89ms | ✅ فعال |
| 3 | `89.250.148.158` | `1080` | 2254.52ms | ✅ فعال |
| 4 | `184.181.217.206` | `4145` | 115.12ms | ✅ فعال |
| 5 | `139.59.103.183` | `80` | 176.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.6.59.137` | `6605` | 58.90ms | ✅ فعال |
| 2 | `92.255.190.64` | `4153` | 199.40ms | ✅ فعال |
| 3 | `47.176.213.210` | `39593` | 2081.94ms | ✅ فعال |
| 4 | `103.146.170.233` | `5678` | 239.31ms | ✅ فعال |
| 5 | `176.111.37.216` | `39811` | 151.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `102.164.252.150` | `8080` | 1279.61ms | ✅ فعال |
| 2 | `94.43.164.242` | `8080` | 208.62ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 59.71ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 52.93ms | ✅ فعال |
| 5 | `220.128.223.136` | `8082` | 148.60ms | ✅ فعال |
