...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:07 25-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.63.130.30` | `30001` | 230.33ms | ✅ فعال |
| 2 | `162.159.242.13` | `80` | 11.69ms | ✅ فعال |
| 3 | `206.238.239.129` | `80` | 14.36ms | ✅ فعال |
| 4 | `108.162.192.20` | `80` | 14.08ms | ✅ فعال |
| 5 | `104.26.2.171` | `80` | 14.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.42` | `80` | 9.78ms | ✅ فعال |
| 2 | `88.216.215.148` | `9116` | 139.07ms | ✅ فعال |
| 3 | `47.243.50.83` | `81` | 186.17ms | ✅ فعال |
| 4 | `139.162.78.109` | `8080` | 136.93ms | ✅ فعال |
| 5 | `47.252.18.37` | `8081` | 26.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.229.106.200` | `26001` | 223.95ms | ✅ فعال |
| 2 | `13.61.155.35` | `54515` | 135.05ms | ✅ فعال |
| 3 | `54.74.104.194` | `183` | 91.36ms | ✅ فعال |
| 4 | `43.208.129.50` | `9006` | 227.01ms | ✅ فعال |
| 5 | `78.12.223.246` | `844` | 41.05ms | ✅ فعال |
