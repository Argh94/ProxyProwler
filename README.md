...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:10 10-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `49.13.22.249` | `10808` | 155.58ms | ✅ فعال |
| 2 | `45.61.127.111` | `6050` | 59.55ms | ✅ فعال |
| 3 | `184.182.240.211` | `4145` | 149.96ms | ✅ فعال |
| 4 | `5.255.99.75` | `1080` | 144.59ms | ✅ فعال |
| 5 | `45.74.31.42` | `26044` | 145.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `159.65.245.255` | `80` | 72.16ms | ✅ فعال |
| 2 | `103.146.170.233` | `5678` | 216.39ms | ✅ فعال |
| 3 | `45.61.127.111` | `6050` | 59.65ms | ✅ فعال |
| 4 | `47.82.87.75` | `1011` | 140.00ms | ✅ فعال |
| 5 | `129.151.128.225` | `1080` | 261.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 185.32ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 189.59ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 100.01ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 174.63ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 160.63ms | ✅ فعال |
