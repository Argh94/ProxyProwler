...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:41 07-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.68.64.3` | `80` | 2353.97ms | ✅ فعال |
| 2 | `66.42.224.229` | `41679` | 88.49ms | ✅ فعال |
| 3 | `173.211.68.91` | `6373` | 60.34ms | ✅ فعال |
| 4 | `45.66.249.187` | `8080` | 62.81ms | ✅ فعال |
| 5 | `5.75.133.113` | `10801` | 95.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.103.88.158` | `46104` | 22.97ms | ✅ فعال |
| 2 | `8.213.222.247` | `666` | 244.15ms | ✅ فعال |
| 3 | `221.133.129.35` | `1080` | 186.83ms | ✅ فعال |
| 4 | `5.78.108.236` | `5555` | 73.90ms | ✅ فعال |
| 5 | `192.111.139.162` | `4145` | 58.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 119.88ms | ✅ فعال |
| 2 | `103.130.61.61` | `8081` | 252.02ms | ✅ فعال |
| 3 | `103.120.175.243` | `9191` | 1282.24ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 201.66ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 222.31ms | ✅ فعال |
