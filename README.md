...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 18-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.3.121` | `7174` | 145.87ms | ✅ فعال |
| 2 | `188.114.96.30` | `80` | 2.03ms | ✅ فعال |
| 3 | `172.67.182.19` | `80` | 2.10ms | ✅ فعال |
| 4 | `172.67.179.58` | `80` | 2.84ms | ✅ فعال |
| 5 | `172.67.70.59` | `80` | 2.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 202.82ms | ✅ فعال |
| 2 | `110.5.113.227` | `80` | 195.28ms | ✅ فعال |
| 3 | `200.123.109.166` | `4153` | 2245.79ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 175.55ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 151.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 72.95ms | ✅ فعال |
| 2 | `51.85.49.118` | `50918` | 203.04ms | ✅ فعال |
| 3 | `16.78.47.161` | `53053` | 189.92ms | ✅ فعال |
| 4 | `179.96.28.58` | `80` | 197.97ms | ✅ فعال |
| 5 | `3.38.101.138` | `37639` | 136.70ms | ✅ فعال |
