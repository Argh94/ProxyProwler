...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:57 09-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `3.217.195.80` | `8080` | 24.90ms | ✅ فعال |
| 2 | `67.201.59.70` | `4145` | 66.12ms | ✅ فعال |
| 3 | `175.138.231.145` | `80` | 304.50ms | ✅ فعال |
| 4 | `149.56.21.95` | `80` | 32.43ms | ✅ فعال |
| 5 | `41.191.203.162` | `80` | 257.07ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (56 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `121.128.121.34` | `3128` | 2262.09ms | ✅ فعال |
| 2 | `117.1.48.242` | `20068` | 210.49ms | ✅ فعال |
| 3 | `8.209.249.96` | `808` | 134.62ms | ✅ فعال |
| 4 | `121.128.121.124` | `3128` | 166.21ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 123.62ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (37 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.223.119.156` | `3128` | 264.08ms | ✅ فعال |
| 2 | `5.161.155.252` | `80` | 28.69ms | ✅ فعال |
| 3 | `51.79.135.131` | `8080` | 196.24ms | ✅ فعال |
| 4 | `52.188.28.218` | `3128` | 30.04ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 121.84ms | ✅ فعال |
