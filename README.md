...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:03 20-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `38.246.114.120` | `20202` | 21.79ms | ✅ فعال |
| 2 | `38.41.225.174` | `8888` | 1137.35ms | ✅ فعال |
| 3 | `210.177.178.148` | `80` | 175.22ms | ✅ فعال |
| 4 | `89.185.80.250` | `1082` | 20.13ms | ✅ فعال |
| 5 | `47.243.133.171` | `1011` | 147.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.226.207.94` | `5643` | 150.71ms | ✅ فعال |
| 2 | `2.78.60.10` | `3129` | 263.15ms | ✅ فعال |
| 3 | `198.105.100.249` | `6500` | 138.68ms | ✅ فعال |
| 4 | `173.0.9.139` | `5722` | 67.84ms | ✅ فعال |
| 5 | `37.32.29.226` | `2080` | 226.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 68.46ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 175.03ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 189.46ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 68.13ms | ✅ فعال |
