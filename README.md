...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 10-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.254.140.194` | `80` | 1.65ms | ✅ فعال |
| 2 | `159.112.235.13` | `80` | 1.55ms | ✅ فعال |
| 3 | `104.18.179.126` | `80` | 1.71ms | ✅ فعال |
| 4 | `45.131.7.168` | `80` | 1.76ms | ✅ فعال |
| 5 | `8.213.129.15` | `19` | 739.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.56.71.129` | `1081` | 40.86ms | ✅ فعال |
| 2 | `47.74.46.81` | `31433` | 106.26ms | ✅ فعال |
| 3 | `47.113.219.226` | `8085` | 214.55ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 135.92ms | ✅ فعال |
| 5 | `213.142.156.97` | `80` | 183.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.216.1.13` | `8770` | 183.41ms | ✅ فعال |
| 2 | `40.176.96.235` | `391` | 34.63ms | ✅ فعال |
| 3 | `13.60.209.160` | `10073` | 170.09ms | ✅ فعال |
| 4 | `13.115.193.75` | `10062` | 105.19ms | ✅ فعال |
| 5 | `78.12.230.52` | `114` | 70.82ms | ✅ فعال |
