...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 26-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.197.75.119` | `80` | 2.75ms | ✅ فعال |
| 2 | `164.38.155.132` | `80` | 2.69ms | ✅ فعال |
| 3 | `37.26.86.206` | `4145` | 2161.01ms | ✅ فعال |
| 4 | `104.18.11.98` | `80` | 1.67ms | ✅ فعال |
| 5 | `185.162.231.158` | `80` | 2.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.154.233` | `5911` | 91.22ms | ✅ فعال |
| 2 | `101.255.24.98` | `3128` | 218.81ms | ✅ فعال |
| 3 | `37.44.219.52` | `6017` | 92.31ms | ✅ فعال |
| 4 | `95.43.244.15` | `4153` | 148.16ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 235.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.8.211.248` | `80` | 2.55ms | ✅ فعال |
| 2 | `45.85.118.80` | `80` | 2.83ms | ✅ فعال |
| 3 | `141.101.122.238` | `80` | 1.97ms | ✅ فعال |
| 4 | `103.169.142.78` | `80` | 3.17ms | ✅ فعال |
| 5 | `206.238.236.139` | `80` | 2.69ms | ✅ فعال |
