...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:02 12-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.56.110.204` | `8989` | 194.57ms | ✅ فعال |
| 2 | `46.29.162.166` | `80` | 186.48ms | ✅ فعال |
| 3 | `46.241.57.29` | `1080` | 170.97ms | ✅ فعال |
| 4 | `120.92.212.16` | `7890` | 262.83ms | ✅ فعال |
| 5 | `107.181.154.82` | `5760` | 96.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.252.152` | `8080` | 231.05ms | ✅ فعال |
| 2 | `16.78.219.183` | `1964` | 221.46ms | ✅ فعال |
| 3 | `184.181.217.213` | `4145` | 88.92ms | ✅ فعال |
| 4 | `142.54.232.6` | `4145` | 73.83ms | ✅ فعال |
| 5 | `46.188.2.42` | `5678` | 144.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `78.12.143.148` | `9165` | 55.38ms | ✅ فعال |
| 2 | `78.12.143.148` | `137` | 58.14ms | ✅ فعال |
| 3 | `40.192.3.100` | `8770` | 241.78ms | ✅ فعال |
| 4 | `23.175.201.46` | `1234` | 195.60ms | ✅ فعال |
| 5 | `52.47.164.226` | `41254` | 103.18ms | ✅ فعال |
