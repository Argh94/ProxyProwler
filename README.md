...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:16 18-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.3.54.165` | `3129` | 151.87ms | ✅ فعال |
| 2 | `154.29.233.39` | `5800` | 65.14ms | ✅ فعال |
| 3 | `174.64.199.79` | `4145` | 118.72ms | ✅ فعال |
| 4 | `85.17.145.160` | `9150` | 142.65ms | ✅ فعال |
| 5 | `178.57.106.43` | `4145` | 193.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `83.220.46.106` | `4145` | 187.59ms | ✅ فعال |
| 2 | `212.103.118.77` | `5678` | 1229.12ms | ✅ فعال |
| 3 | `174.64.199.79` | `4145` | 118.28ms | ✅ فعال |
| 4 | `8.221.138.111` | `2000` | 100.93ms | ✅ فعال |
| 5 | `82.23.222.45` | `6351` | 68.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 190.14ms | ✅ فعال |
| 2 | `103.153.149.18` | `8181` | 2208.38ms | ✅ فعال |
| 3 | `161.49.116.131` | `1337` | 2201.56ms | ✅ فعال |
| 4 | `103.156.15.55` | `8080` | 176.67ms | ✅ فعال |
| 5 | `182.253.158.93` | `8080` | 176.80ms | ✅ فعال |
