...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:22 04-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.59.70` | `4145` | 77.73ms | ✅ فعال |
| 2 | `162.253.68.97` | `4145` | 78.26ms | ✅ فعال |
| 3 | `58.19.55.4` | `15280` | 245.10ms | ✅ فعال |
| 4 | `58.19.55.7` | `15080` | 245.33ms | ✅ فعال |
| 5 | `40.89.145.14` | `80` | 91.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `122.224.198.218` | `808` | 259.13ms | ✅ فعال |
| 2 | `34.81.160.132` | `80` | 192.28ms | ✅ فعال |
| 3 | `172.121.139.80` | `5259` | 64.89ms | ✅ فعال |
| 4 | `103.65.237.92` | `5678` | 241.76ms | ✅ فعال |
| 5 | `8.220.136.174` | `8443` | 228.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 226.36ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 168.44ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 224.90ms | ✅ فعال |
| 4 | `13.127.170.8` | `3128` | 201.85ms | ✅ فعال |
