...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:53 09-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.20.8.35` | `10808` | 11.23ms | ✅ فعال |
| 2 | `69.55.49.177` | `38182` | 62.29ms | ✅ فعال |
| 3 | `195.19.50.120` | `1080` | 387.74ms | ✅ فعال |
| 4 | `43.155.35.155` | `8888` | 157.05ms | ✅ فعال |
| 5 | `192.111.130.2` | `4145` | 80.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.116.181.146` | `9098` | 206.70ms | ✅ فعال |
| 2 | `107.181.154.142` | `5820` | 134.80ms | ✅ فعال |
| 3 | `37.79.248.25` | `80` | 219.36ms | ✅ فعال |
| 4 | `182.53.202.208` | `8080` | 214.58ms | ✅ فعال |
| 5 | `8.211.195.139` | `202` | 139.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 59.42ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 170.12ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 58.38ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 205.41ms | ✅ فعال |
