...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:04 07-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.172.163` | `80` | 6.21ms | ✅ فعال |
| 2 | `173.245.49.19` | `80` | 2.55ms | ✅ فعال |
| 3 | `162.159.242.36` | `80` | 2.68ms | ✅ فعال |
| 4 | `195.85.23.40` | `80` | 2.23ms | ✅ فعال |
| 5 | `172.67.254.254` | `80` | 2.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.226.204.87` | `5640` | 91.31ms | ✅ فعال |
| 2 | `68.1.210.163` | `4145` | 91.78ms | ✅ فعال |
| 3 | `88.216.68.89` | `9061` | 2.64ms | ✅ فعال |
| 4 | `5.199.166.251` | `9068` | 202.17ms | ✅ فعال |
| 5 | `202.162.212.164` | `4153` | 231.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `108.137.1.116` | `17277` | 220.63ms | ✅ فعال |
| 2 | `3.110.127.255` | `357` | 242.03ms | ✅ فعال |
| 3 | `43.208.240.77` | `28586` | 234.31ms | ✅ فعال |
| 4 | `18.163.3.251` | `5132` | 194.95ms | ✅ فعال |
| 5 | `15.160.134.84` | `1466` | 112.99ms | ✅ فعال |
