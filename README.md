...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:38 03-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (80 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.215.15.163` | `3128` | 216.29ms | ✅ فعال |
| 2 | `72.37.217.3` | `4145` | 64.18ms | ✅ فعال |
| 3 | `94.158.219.111` | `1080` | 132.60ms | ✅ فعال |
| 4 | `216.68.128.121` | `4145` | 147.72ms | ✅ فعال |
| 5 | `47.85.51.197` | `1080` | 18.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `5060` | 149.78ms | ✅ فعال |
| 2 | `184.174.126.92` | `6384` | 1084.63ms | ✅ فعال |
| 3 | `143.137.116.72` | `1080` | 2185.43ms | ✅ فعال |
| 4 | `8.215.15.163` | `3128` | 218.91ms | ✅ فعال |
| 5 | `198.8.94.170` | `4145` | 70.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 172.85ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 138.44ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 211.23ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 142.28ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 203.62ms | ✅ فعال |
