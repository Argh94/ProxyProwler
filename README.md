...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:14 03-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.230.59` | `80` | 1.80ms | ✅ فعال |
| 2 | `137.184.96.68` | `80` | 36.02ms | ✅ فعال |
| 3 | `104.21.31.212` | `80` | 2.52ms | ✅ فعال |
| 4 | `104.21.116.30` | `80` | 2.67ms | ✅ فعال |
| 5 | `172.67.70.50` | `80` | 1.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.221.203.121` | `1080` | 122.85ms | ✅ فعال |
| 2 | `88.216.68.8` | `9080` | 7.51ms | ✅ فعال |
| 3 | `72.195.34.58` | `4145` | 85.03ms | ✅ فعال |
| 4 | `16.78.219.183` | `1964` | 221.62ms | ✅ فعال |
| 5 | `104.21.31.212` | `80` | 2.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `52.47.164.226` | `19513` | 104.06ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 165.52ms | ✅ فعال |
| 3 | `43.198.99.209` | `19206` | 194.33ms | ✅ فعال |
| 4 | `13.61.155.35` | `54515` | 120.61ms | ✅ فعال |
| 5 | `40.192.100.189` | `10810` | 229.36ms | ✅ فعال |
