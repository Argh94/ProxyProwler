...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:09 15-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `85.143.254.38` | `1080` | 1214.99ms | ✅ فعال |
| 2 | `108.174.152.80` | `1080` | 37.04ms | ✅ فعال |
| 3 | `82.115.60.51` | `80` | 1214.45ms | ✅ فعال |
| 4 | `8.213.215.187` | `1081` | 209.59ms | ✅ فعال |
| 5 | `66.151.34.89` | `80` | 160.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.153.61.90` | `40000` | 16.30ms | ✅ فعال |
| 2 | `192.186.185.86` | `5086` | 8.96ms | ✅ فعال |
| 3 | `185.226.207.17` | `5566` | 131.07ms | ✅ فعال |
| 4 | `142.54.228.193` | `4145` | 20.93ms | ✅ فعال |
| 5 | `93.184.9.9` | `1080` | 178.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 188.79ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 195.57ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 166.87ms | ✅ فعال |
| 4 | `102.164.252.150` | `8080` | 253.78ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 120.18ms | ✅ فعال |
