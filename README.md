...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 28-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.196` | `80` | 6.15ms | ✅ فعال |
| 2 | `185.193.30.144` | `80` | 6.07ms | ✅ فعال |
| 3 | `162.159.244.61` | `80` | 6.03ms | ✅ فعال |
| 4 | `185.193.31.242` | `80` | 6.03ms | ✅ فعال |
| 5 | `31.12.75.255` | `80` | 5.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.65.224.26` | `1080` | 138.01ms | ✅ فعال |
| 2 | `68.71.240.210` | `4145` | 77.90ms | ✅ فعال |
| 3 | `47.243.124.21` | `6666` | 208.40ms | ✅ فعال |
| 4 | `179.1.209.73` | `5678` | 70.14ms | ✅ فعال |
| 5 | `68.71.249.153` | `48606` | 84.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.43.137` | `8334` | 177.28ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 241.26ms | ✅ فعال |
| 3 | `40.177.211.224` | `8705` | 77.47ms | ✅ فعال |
| 4 | `43.198.99.209` | `8496` | 206.03ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 88.15ms | ✅ فعال |
