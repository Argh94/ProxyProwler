...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:40 02-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.254.140.218` | `80` | 8.90ms | ✅ فعال |
| 2 | `188.114.99.15` | `80` | 9.63ms | ✅ فعال |
| 3 | `200.174.198.158` | `8888` | 155.08ms | ✅ فعال |
| 4 | `31.12.75.24` | `80` | 8.81ms | ✅ فعال |
| 5 | `158.255.77.169` | `80` | 237.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.43.244.15` | `4153` | 170.47ms | ✅ فعال |
| 2 | `202.40.181.220` | `31247` | 235.39ms | ✅ فعال |
| 3 | `142.54.237.34` | `4145` | 55.34ms | ✅ فعال |
| 4 | `8.213.128.6` | `90` | 139.90ms | ✅ فعال |
| 5 | `104.16.151.202` | `80` | 16.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.66.163` | `80` | 8.95ms | ✅ فعال |
| 2 | `23.227.39.55` | `80` | 8.95ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 16.82ms | ✅ فعال |
| 4 | `45.131.211.217` | `80` | 9.15ms | ✅ فعال |
| 5 | `62.72.166.211` | `80` | 8.82ms | ✅ فعال |
