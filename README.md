...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:08 04-07-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.59.70` | `4145` | 64.60ms | ✅ فعال |
| 2 | `45.74.31.23` | `4362` | 1170.94ms | ✅ فعال |
| 3 | `8.211.51.115` | `1036` | 125.87ms | ✅ فعال |
| 4 | `192.252.215.2` | `4145` | 86.32ms | ✅ فعال |
| 5 | `8.213.195.191` | `3333` | 237.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `145.220.227.6` | `1080` | 114.58ms | ✅ فعال |
| 2 | `67.201.59.70` | `4145` | 62.70ms | ✅ فعال |
| 3 | `177.85.65.177` | `4153` | 153.84ms | ✅ فعال |
| 4 | `144.76.42.215` | `8118` | 121.76ms | ✅ فعال |
| 5 | `8.211.51.115` | `1036` | 792.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 199.39ms | ✅ فعال |
| 2 | `51.79.207.21` | `8080` | 196.87ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 152.25ms | ✅ فعال |
| 4 | `103.177.176.62` | `8080` | 2250.78ms | ✅ فعال |
| 5 | `146.190.232.76` | `3128` | 118.37ms | ✅ فعال |
