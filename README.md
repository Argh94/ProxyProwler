...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:53 12-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `129.226.72.101` | `18080` | 146.65ms | ✅ فعال |
| 2 | `184.181.217.210` | `4145` | 111.58ms | ✅ فعال |
| 3 | `116.104.250.195` | `1081` | 2283.98ms | ✅ فعال |
| 4 | `172.236.14.204` | `1080` | 2200.60ms | ✅ فعال |
| 5 | `109.245.110.145` | `4145` | 182.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.195.191` | `9091` | 870.19ms | ✅ فعال |
| 2 | `184.178.172.5` | `15303` | 119.93ms | ✅ فعال |
| 3 | `8.211.51.115` | `84` | 2919.01ms | ✅ فعال |
| 4 | `129.226.72.101` | `18080` | 146.64ms | ✅ فعال |
| 5 | `104.168.118.3` | `5959` | 64.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 67.79ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 1232.77ms | ✅ فعال |
| 3 | `193.181.35.79` | `8118` | 336.42ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 185.13ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 64.52ms | ✅ فعال |
