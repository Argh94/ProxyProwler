...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:32 29-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.143.224.199` | `6060` | 84.54ms | ✅ فعال |
| 2 | `107.174.231.218` | `8888` | 35.28ms | ✅ فعال |
| 3 | `200.85.232.91` | `3128` | 158.73ms | ✅ فعال |
| 4 | `167.103.34.108` | `8800` | 216.63ms | ✅ فعال |
| 5 | `153.0.171.163` | `8085` | 261.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.43.244.15` | `4153` | 125.39ms | ✅ فعال |
| 2 | `47.238.128.246` | `10002` | 871.33ms | ✅ فعال |
| 3 | `104.143.224.199` | `6060` | 79.61ms | ✅ فعال |
| 4 | `8.211.195.139` | `202` | 287.85ms | ✅ فعال |
| 5 | `152.53.171.242` | `12238` | 6.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.130.177.190` | `9999` | 91.40ms | ✅ فعال |
| 2 | `164.90.155.209` | `3128` | 69.70ms | ✅ فعال |
