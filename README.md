...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 12-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.31.74` | `80` | 1.65ms | ✅ فعال |
| 2 | `206.238.236.62` | `80` | 2.30ms | ✅ فعال |
| 3 | `104.25.10.227` | `80` | 1.49ms | ✅ فعال |
| 4 | `164.38.155.41` | `80` | 1.39ms | ✅ فعال |
| 5 | `185.221.160.1` | `80` | 1.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.37.109.152` | `6259` | 63.17ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 180.42ms | ✅ فعال |
| 3 | `1.0.0.4` | `80` | 1.62ms | ✅ فعال |
| 4 | `205.233.181.13` | `80` | 1.80ms | ✅ فعال |
| 5 | `43.208.240.77` | `318` | 196.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.247.49` | `80` | 1.72ms | ✅ فعال |
| 2 | `45.131.7.142` | `80` | 1.69ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 182.77ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 1.49ms | ✅ فعال |
| 5 | `104.17.26.109` | `80` | 1.93ms | ✅ فعال |
