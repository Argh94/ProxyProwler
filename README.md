...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:17 01-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.114.184` | `4145` | 133.04ms | ✅ فعال |
| 2 | `47.91.104.88` | `3128` | 243.70ms | ✅ فعال |
| 3 | `12.50.107.220` | `80` | 64.63ms | ✅ فعال |
| 4 | `45.59.186.60` | `80` | 9.43ms | ✅ فعال |
| 5 | `64.176.34.132` | `5555` | 113.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `216.26.227.125` | `3129` | 68.88ms | ✅ فعال |
| 2 | `64.176.34.132` | `5555` | 113.26ms | ✅ فعال |
| 3 | `199.58.185.9` | `4145` | 122.53ms | ✅ فعال |
| 4 | `199.187.210.54` | `4145` | 57.97ms | ✅ فعال |
| 5 | `195.46.172.190` | `4153` | 2251.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.59.186.60` | `80` | 10.06ms | ✅ فعال |
| 2 | `202.29.215.78` | `8080` | 2307.04ms | ✅ فعال |
| 3 | `12.50.107.219` | `80` | 64.87ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 169.36ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 168.95ms | ✅ فعال |
