...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:37 08-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.49.49.11` | `31034` | 2116.24ms | ✅ فعال |
| 2 | `104.194.146.9` | `80` | 101.37ms | ✅ فعال |
| 3 | `47.238.134.126` | `18080` | 187.30ms | ✅ فعال |
| 4 | `192.111.134.10` | `4145` | 64.01ms | ✅ فعال |
| 5 | `194.190.169.197` | `3701` | 141.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `75.84.71.14` | `80` | 70.53ms | ✅ فعال |
| 2 | `162.220.247.247` | `6842` | 97.31ms | ✅ فعال |
| 3 | `8.213.156.191` | `8008` | 167.72ms | ✅ فعال |
| 4 | `80.90.188.187` | `24530` | 128.50ms | ✅ فعال |
| 5 | `39.104.59.56` | `8090` | 245.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 20.30ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 17.15ms | ✅ فعال |
| 3 | `94.130.177.190` | `9999` | 111.96ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 221.67ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 238.07ms | ✅ فعال |
