...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 03-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.180.10.133` | `6504` | 69.90ms | ✅ فعال |
| 2 | `188.114.96.9` | `80` | 1.59ms | ✅ فعال |
| 3 | `185.193.28.254` | `80` | 1.57ms | ✅ فعال |
| 4 | `104.17.99.185` | `80` | 1.81ms | ✅ فعال |
| 5 | `139.177.229.112` | `8080` | 66.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `49.0.199.132` | `19` | 203.53ms | ✅ فعال |
| 2 | `119.13.111.169` | `4006` | 173.09ms | ✅ فعال |
| 3 | `123.57.1.16` | `5555` | 204.86ms | ✅ فعال |
| 4 | `39.104.57.170` | `3000` | 211.02ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 221.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `218.89.134.230` | `3333` | 216.84ms | ✅ فعال |
| 2 | `110.34.1.180` | `32650` | 1336.01ms | ✅ فعال |
| 3 | `16.78.108.50` | `9439` | 184.71ms | ✅ فعال |
| 4 | `43.198.99.209` | `8496` | 156.41ms | ✅ فعال |
| 5 | `202.154.18.1` | `8080` | 198.82ms | ✅ فعال |
