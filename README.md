...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:03 01-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.210` | `46666` | 106.32ms | ✅ فعال |
| 2 | `98.170.57.241` | `4145` | 92.25ms | ✅ فعال |
| 3 | `87.117.11.57` | `1080` | 146.86ms | ✅ فعال |
| 4 | `103.75.118.84` | `1080` | 158.07ms | ✅ فعال |
| 5 | `47.237.169.183` | `1080` | 224.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `132.226.7.23` | `30277` | 163.47ms | ✅ فعال |
| 2 | `41.169.151.154` | `4153` | 279.31ms | ✅ فعال |
| 3 | `8.211.49.86` | `1088` | 89.40ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 107.13ms | ✅ فعال |
| 5 | `213.156.124.3` | `33333` | 1168.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 162.72ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 223.64ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 120.86ms | ✅ فعال |
