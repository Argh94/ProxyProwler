...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:05 01-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.219` | `4266` | 107.35ms | ✅ فعال |
| 2 | `206.123.156.210` | `21641` | 1170.84ms | ✅ فعال |
| 3 | `206.123.156.222` | `14304` | 98.56ms | ✅ فعال |
| 4 | `206.123.156.225` | `7429` | 1120.75ms | ✅ فعال |
| 5 | `206.123.156.191` | `11349` | 123.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.58.185.9` | `4145` | 63.90ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 144.86ms | ✅ فعال |
| 3 | `201.123.88.122` | `8080` | 1114.86ms | ✅ فعال |
| 4 | `134.209.29.120` | `80` | 76.29ms | ✅ فعال |
| 5 | `39.109.113.97` | `4090` | 215.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 2.62ms | ✅ فعال |
| 2 | `45.70.236.194` | `999` | 1134.52ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 3.34ms | ✅ فعال |
| 4 | `177.234.217.238` | `999` | 100.64ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 121.29ms | ✅ فعال |
