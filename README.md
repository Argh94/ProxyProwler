...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:22 29-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (44 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `134.122.136.120` | `10086` | 300.64ms | ✅ فعال |
| 2 | `206.123.156.220` | `18443` | 147.12ms | ✅ فعال |
| 3 | `197.221.234.252` | `80` | 264.30ms | ✅ فعال |
| 4 | `184.181.217.201` | `4145` | 112.32ms | ✅ فعال |
| 5 | `94.131.122.128` | `1081` | 112.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.75.153.199` | `1080` | 204.60ms | ✅ فعال |
| 2 | `142.54.231.38` | `4145` | 73.71ms | ✅ فعال |
| 3 | `8.220.204.215` | `8443` | 155.38ms | ✅ فعال |
| 4 | `91.223.52.141` | `5678` | 145.98ms | ✅ فعال |
| 5 | `191.96.104.143` | `5880` | 52.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 31.19ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 158.06ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 33.63ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 134.57ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 197.10ms | ✅ فعال |
