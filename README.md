...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 08-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.80.156` | `80` | 1.58ms | ✅ فعال |
| 2 | `185.148.107.220` | `80` | 1.86ms | ✅ فعال |
| 3 | `104.21.16.2` | `80` | 1.90ms | ✅ فعال |
| 4 | `104.27.9.77` | `80` | 1.74ms | ✅ فعال |
| 5 | `8.148.20.126` | `9098` | 212.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.200.158.109` | `8880` | 206.21ms | ✅ فعال |
| 2 | `150.242.12.169` | `80` | 389.99ms | ✅ فعال |
| 3 | `1.180.0.162` | `7302` | 207.90ms | ✅ فعال |
| 4 | `8.148.20.126` | `9098` | 212.30ms | ✅ فعال |
| 5 | `47.252.18.37` | `8888` | 100.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.148.104.15` | `80` | 1.64ms | ✅ فعال |
| 2 | `185.193.28.50` | `80` | 1.69ms | ✅ فعال |
| 3 | `173.245.49.114` | `80` | 1.99ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 1.77ms | ✅ فعال |
| 5 | `172.67.88.21` | `80` | 2.20ms | ✅ فعال |
