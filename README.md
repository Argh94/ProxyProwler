...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:13 16-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `167.103.31.122` | `8800` | 216.69ms | ✅ فعال |
| 2 | `94.23.9.170` | `80` | 1120.36ms | ✅ فعال |
| 3 | `167.103.144.127` | `8800` | 193.91ms | ✅ فعال |
| 4 | `38.145.208.230` | `8446` | 60.29ms | ✅ فعال |
| 5 | `47.91.89.3` | `3128` | 655.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `155.254.38.250` | `5926` | 76.48ms | ✅ فعال |
| 2 | `192.252.214.17` | `4145` | 65.68ms | ✅ فعال |
| 3 | `68.1.210.189` | `4145` | 85.64ms | ✅ فعال |
| 4 | `38.145.208.243` | `8447` | 63.16ms | ✅ فعال |
| 5 | `136.0.188.158` | `6121` | 66.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 222.99ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 154.16ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 221.69ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 94.16ms | ✅ فعال |
