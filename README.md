...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:46 22-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.53.183.107` | `8081` | 2154.65ms | ✅ فعال |
| 2 | `192.111.129.150` | `4145` | 59.29ms | ✅ فعال |
| 3 | `72.49.49.11` | `31034` | 113.64ms | ✅ فعال |
| 4 | `66.42.224.229` | `41679` | 94.96ms | ✅ فعال |
| 5 | `151.185.59.36` | `8080` | 227.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `194.58.97.165` | `9050` | 129.75ms | ✅ فعال |
| 2 | `46.202.248.115` | `8376` | 39.95ms | ✅ فعال |
| 3 | `101.255.166.134` | `80` | 233.35ms | ✅ فعال |
| 4 | `82.22.174.113` | `1080` | 87.79ms | ✅ فعال |
| 5 | `85.209.156.148` | `1080` | 121.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 156.88ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 227.49ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 1260.88ms | ✅ فعال |
| 4 | `82.65.98.35` | `3128` | 1096.97ms | ✅ فعال |
| 5 | `51.79.207.21` | `8080` | 227.52ms | ✅ فعال |
