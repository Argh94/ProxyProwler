...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:05 17-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `140.238.9.210` | `8080` | 168.14ms | ✅ فعال |
| 2 | `190.119.132.61` | `80` | 146.10ms | ✅ فعال |
| 3 | `51.141.175.118` | `80` | 35.77ms | ✅ فعال |
| 4 | `89.185.85.138` | `1080` | 114.47ms | ✅ فعال |
| 5 | `61.158.175.38` | `9002` | 229.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `80` | 802.92ms | ✅ فعال |
| 2 | `5.23.104.251` | `1080` | 152.93ms | ✅ فعال |
| 3 | `8.221.139.222` | `3128` | 138.69ms | ✅ فعال |
| 4 | `74.119.147.209` | `4145` | 66.89ms | ✅ فعال |
| 5 | `185.18.250.83` | `80` | 14.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `36.112.125.156` | `3226` | 230.73ms | ✅ فعال |
| 2 | `89.58.55.33` | `80` | 118.59ms | ✅ فعال |
| 3 | `84.39.112.144` | `3128` | 126.05ms | ✅ فعال |
| 4 | `23.88.88.105` | `443` | 124.16ms | ✅ فعال |
| 5 | `46.17.47.48` | `80` | 175.65ms | ✅ فعال |
