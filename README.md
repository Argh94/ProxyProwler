...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:26 19-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.153.247.74` | `12` | 244.95ms | ✅ فعال |
| 2 | `142.54.235.9` | `4145` | 52.87ms | ✅ فعال |
| 3 | `200.63.95.1` | `1085` | 189.06ms | ✅ فعال |
| 4 | `140.238.32.108` | `3128` | 132.55ms | ✅ فعال |
| 5 | `112.28.149.152` | `8443` | 180.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.64.105` | `6363` | 108.58ms | ✅ فعال |
| 2 | `8.213.222.247` | `8008` | 220.89ms | ✅ فعال |
| 3 | `70.166.167.55` | `57745` | 90.11ms | ✅ فعال |
| 4 | `161.97.119.1` | `8888` | 118.35ms | ✅ فعال |
| 5 | `145.239.196.123` | `80` | 113.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 28.27ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 208.49ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 151.47ms | ✅ فعال |
| 4 | `200.82.238.153` | `999` | 103.97ms | ✅ فعال |
| 5 | `202.29.215.78` | `8080` | 2344.40ms | ✅ فعال |
