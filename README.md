...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:40 03-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.59.70` | `4145` | 73.61ms | ✅ فعال |
| 2 | `185.226.204.78` | `5631` | 86.92ms | ✅ فعال |
| 3 | `45.43.81.176` | `5823` | 83.99ms | ✅ فعال |
| 4 | `151.241.30.105` | `1080` | 108.29ms | ✅ فعال |
| 5 | `80.74.54.148` | `3128` | 91.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.215` | `8000` | 2607.87ms | ✅ فعال |
| 2 | `45.43.81.176` | `5823` | 83.47ms | ✅ فعال |
| 3 | `46.224.153.114` | `9050` | 91.46ms | ✅ فعال |
| 4 | `161.123.93.77` | `5807` | 28.66ms | ✅ فعال |
| 5 | `8.221.141.88` | `4301` | 156.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 118.72ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 234.48ms | ✅ فعال |
| 3 | `41.65.55.10` | `1981` | 129.53ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 235.53ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 240.51ms | ✅ فعال |
