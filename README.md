...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:00 04-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.124.61.124` | `1080` | 139.94ms | ✅ فعال |
| 2 | `43.143.108.2` | `9701` | 199.26ms | ✅ فعال |
| 3 | `206.123.156.211` | `9064` | 2248.76ms | ✅ فعال |
| 4 | `195.114.209.50` | `80` | 1184.52ms | ✅ فعال |
| 5 | `206.123.156.200` | `5999` | 155.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.109.110.100` | `80` | 229.13ms | ✅ فعال |
| 2 | `79.106.170.126` | `4145` | 168.86ms | ✅ فعال |
| 3 | `31.58.18.21` | `6290` | 119.10ms | ✅ فعال |
| 4 | `45.43.64.4` | `6262` | 119.79ms | ✅ فعال |
| 5 | `8.221.141.88` | `8010` | 118.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 154.27ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 231.54ms | ✅ فعال |
| 3 | `103.158.252.99` | `80` | 197.01ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 53.99ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 134.48ms | ✅ فعال |
