...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 01:14 31-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `151.185.58.17` | `80` | 280.95ms | ✅ فعال |
| 2 | `70.166.167.55` | `57745` | 103.10ms | ✅ فعال |
| 3 | `161.97.129.202` | `9060` | 139.07ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 181.38ms | ✅ فعال |
| 5 | `98.190.239.3` | `4145` | 106.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.204.54.50` | `1080` | 257.62ms | ✅ فعال |
| 2 | `166.88.235.104` | `5732` | 19.95ms | ✅ فعال |
| 3 | `8.209.96.245` | `4002` | 843.40ms | ✅ فعال |
| 4 | `47.74.46.81` | `8080` | 755.23ms | ✅ فعال |
| 5 | `98.170.57.249` | `4145` | 104.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 178.35ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 174.89ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 198.86ms | ✅ فعال |
| 4 | `51.79.207.21` | `8080` | 1218.68ms | ✅ فعال |
