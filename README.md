...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:33 17-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.98.153.86` | `80` | 151.19ms | ✅ فعال |
| 2 | `8.209.255.13` | `3128` | 106.29ms | ✅ فعال |
| 3 | `192.252.208.70` | `14282` | 100.61ms | ✅ فعال |
| 4 | `48.210.225.96` | `80` | 104.99ms | ✅ فعال |
| 5 | `192.111.135.18` | `18301` | 93.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `80` | 155.70ms | ✅ فعال |
| 2 | `8.209.249.96` | `808` | 106.15ms | ✅ فعال |
| 3 | `192.252.209.155` | `14455` | 93.61ms | ✅ فعال |
| 4 | `91.221.177.40` | `80` | 211.61ms | ✅ فعال |
| 5 | `201.184.239.75` | `5678` | 2165.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `117.159.239.52` | `22222` | 165.75ms | ✅ فعال |
| 2 | `23.247.136.254` | `80` | 1.55ms | ✅ فعال |
| 3 | `61.72.221.94` | `3128` | 137.78ms | ✅ فعال |
| 4 | `61.72.110.54` | `3128` | 130.40ms | ✅ فعال |
| 5 | `46.29.162.166` | `80` | 212.88ms | ✅ فعال |
