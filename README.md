...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:55 25-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.112.136.219` | `18081` | 158.25ms | ✅ فعال |
| 2 | `104.18.33.178` | `80` | 1.84ms | ✅ فعال |
| 3 | `185.176.24.145` | `80` | 1.92ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 278.68ms | ✅ فعال |
| 5 | `108.162.196.127` | `80` | 1.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 284.51ms | ✅ فعال |
| 2 | `104.18.13.72` | `80` | 1.89ms | ✅ فعال |
| 3 | `8.221.138.111` | `8081` | 162.24ms | ✅ فعال |
| 4 | `72.195.34.58` | `4145` | 88.66ms | ✅ فعال |
| 5 | `107.172.156.235` | `5883` | 14.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.177.56.190` | `80` | 1.55ms | ✅ فعال |
| 2 | `195.245.221.183` | `80` | 3.11ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 1.68ms | ✅ فعال |
| 4 | `45.8.211.248` | `80` | 1.69ms | ✅ فعال |
| 5 | `185.162.230.130` | `80` | 2.54ms | ✅ فعال |
