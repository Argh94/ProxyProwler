...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:07 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.237.192` | `80` | 2.51ms | ✅ فعال |
| 2 | `185.162.229.71` | `80` | 2.09ms | ✅ فعال |
| 3 | `104.17.146.49` | `80` | 9.55ms | ✅ فعال |
| 4 | `104.21.17.221` | `80` | 11.20ms | ✅ فعال |
| 5 | `104.17.127.77` | `80` | 2.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.179.151.165` | `31948` | 221.11ms | ✅ فعال |
| 2 | `47.243.203.58` | `1100` | 1180.88ms | ✅ فعال |
| 3 | `47.254.36.213` | `8443` | 3.15ms | ✅ فعال |
| 4 | `8.220.204.92` | `6379` | 894.78ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 247.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.28.50` | `80` | 2.01ms | ✅ فعال |
| 2 | `104.17.106.99` | `80` | 1.98ms | ✅ فعال |
| 3 | `173.245.49.114` | `80` | 2.03ms | ✅ فعال |
| 4 | `104.17.26.109` | `80` | 9.63ms | ✅ فعال |
| 5 | `104.17.25.3` | `80` | 14.79ms | ✅ فعال |
