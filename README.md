...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 26-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `62.112.10.88` | `13095` | 94.92ms | ✅ فعال |
| 2 | `141.101.122.23` | `80` | 2.50ms | ✅ فعال |
| 3 | `160.153.1.20` | `80` | 2.21ms | ✅ فعال |
| 4 | `23.227.60.47` | `80` | 2.27ms | ✅ فعال |
| 5 | `185.193.31.13` | `80` | 2.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.124.21` | `6666` | 209.15ms | ✅ فعال |
| 2 | `45.41.176.2` | `6300` | 35.35ms | ✅ فعال |
| 3 | `8.211.194.85` | `9999` | 761.10ms | ✅ فعال |
| 4 | `8.211.195.139` | `6379` | 772.59ms | ✅ فعال |
| 5 | `104.143.226.8` | `5611` | 79.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.29.28` | `11222` | 2.38ms | ✅ فعال |
| 2 | `157.175.43.137` | `1085` | 176.58ms | ✅ فعال |
| 3 | `13.218.86.1` | `8323` | 2.43ms | ✅ فعال |
| 4 | `40.192.14.136` | `9292` | 205.61ms | ✅ فعال |
| 5 | `15.160.125.231` | `97` | 94.96ms | ✅ فعال |
