...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 25-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `12.50.107.221` | `80` | 36.05ms | ✅ فعال |
| 2 | `8.213.156.191` | `20` | 190.72ms | ✅ فعال |
| 3 | `47.91.89.3` | `8040` | 91.26ms | ✅ فعال |
| 4 | `91.132.92.231` | `80` | 96.63ms | ✅ فعال |
| 5 | `176.124.219.49` | `3128` | 125.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.18` | `15280` | 71.28ms | ✅ فعال |
| 2 | `8.209.68.1` | `8081` | 88.72ms | ✅ فعال |
| 3 | `47.91.29.151` | `8080` | 160.56ms | ✅ فعال |
| 4 | `98.188.47.132` | `4145` | 71.91ms | ✅ فعال |
| 5 | `39.104.62.128` | `5000` | 265.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.17.47.48` | `80` | 140.02ms | ✅ فعال |
| 2 | `5.75.198.16` | `1080` | 97.60ms | ✅ فعال |
| 3 | `8.219.229.53` | `8008` | 253.35ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 79.88ms | ✅ فعال |
| 5 | `45.59.186.60` | `80` | 57.58ms | ✅ فعال |
