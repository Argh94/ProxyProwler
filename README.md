...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:25 25-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `70.166.167.55` | `57745` | 83.92ms | ✅ فعال |
| 2 | `89.250.148.158` | `1080` | 181.82ms | ✅ فعال |
| 3 | `45.74.31.30` | `7876` | 131.90ms | ✅ فعال |
| 4 | `45.74.31.42` | `5219` | 142.36ms | ✅ فعال |
| 5 | `31.77.131.173` | `8080` | 125.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.226.214` | `4145` | 42.82ms | ✅ فعال |
| 2 | `39.100.88.89` | `8008` | 225.42ms | ✅ فعال |
| 3 | `213.210.67.186` | `3629` | 242.01ms | ✅ فعال |
| 4 | `150.241.70.126` | `1080` | 2181.00ms | ✅ فعال |
| 5 | `47.92.194.235` | `20000` | 230.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 125.23ms | ✅ فعال |
| 2 | `41.65.55.10` | `1981` | 173.20ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 182.72ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 231.88ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 167.89ms | ✅ فعال |
