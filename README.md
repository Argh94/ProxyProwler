...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 13-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.215.3.250` | `8008` | 182.11ms | ✅ فعال |
| 2 | `163.172.48.119` | `15016` | 157.88ms | ✅ فعال |
| 3 | `47.252.18.37` | `3129` | 67.27ms | ✅ فعال |
| 4 | `104.16.254.244` | `80` | 1.96ms | ✅ فعال |
| 5 | `45.131.4.216` | `80` | 4.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.215.3.250` | `8008` | 182.50ms | ✅ فعال |
| 2 | `39.104.23.154` | `1080` | 212.74ms | ✅ فعال |
| 3 | `149.129.226.9` | `9160` | 881.81ms | ✅ فعال |
| 4 | `47.254.153.78` | `999` | 155.13ms | ✅ فعال |
| 5 | `8.130.34.44` | `3128` | 210.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.44.217.188` | `9054` | 152.04ms | ✅ فعال |
| 2 | `43.217.134.46` | `3128` | 176.84ms | ✅ فعال |
| 3 | `201.89.97.222` | `8080` | 183.89ms | ✅ فعال |
| 4 | `43.204.25.18` | `37873` | 223.87ms | ✅ فعال |
| 5 | `18.60.222.217` | `8975` | 214.40ms | ✅ فعال |
