...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 09-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `46.249.100.124` | `80` | 157.04ms | ✅ فعال |
| 2 | `104.16.0.19` | `80` | 1.59ms | ✅ فعال |
| 3 | `31.12.75.178` | `80` | 1.63ms | ✅ فعال |
| 4 | `184.178.172.14` | `4145` | 122.97ms | ✅ فعال |
| 5 | `45.43.81.220` | `5867` | 140.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.133.37.149` | `1080` | 168.65ms | ✅ فعال |
| 2 | `79.106.170.126` | `4145` | 2218.02ms | ✅ فعال |
| 3 | `182.53.216.73` | `4145` | 2296.15ms | ✅ فعال |
| 4 | `8.211.194.85` | `3333` | 888.70ms | ✅ فعال |
| 5 | `45.80.111.228` | `80` | 1.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.60.209.160` | `172` | 168.33ms | ✅ فعال |
| 2 | `78.12.143.148` | `224` | 86.51ms | ✅ فعال |
| 3 | `15.160.186.74` | `8791` | 164.61ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 72.77ms | ✅ فعال |
| 5 | `43.208.240.77` | `37` | 195.10ms | ✅ فعال |
