...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:28 27-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (45 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.215` | `12609` | 1292.87ms | ✅ فعال |
| 2 | `134.122.136.120` | `10086` | 1302.79ms | ✅ فعال |
| 3 | `60.54.19.46` | `1080` | 208.47ms | ✅ فعال |
| 4 | `192.111.139.163` | `19404` | 82.51ms | ✅ فعال |
| 5 | `81.181.104.227` | `80` | 135.99ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (19 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.76.192.164` | `1080` | 202.17ms | ✅ فعال |
| 2 | `149.57.17.199` | `5667` | 54.49ms | ✅ فعال |
| 3 | `85.121.53.198` | `80` | 131.36ms | ✅ فعال |
| 4 | `199.58.185.9` | `4145` | 82.68ms | ✅ فعال |
| 5 | `145.223.46.188` | `5738` | 122.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 163.06ms | ✅ فعال |
| 2 | `94.130.177.190` | `9999` | 135.12ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 147.76ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 51.29ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 50.61ms | ✅ فعال |
