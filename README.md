...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:17 05-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.215` | `6859` | 87.28ms | ✅ فعال |
| 2 | `206.123.156.219` | `4098` | 1109.99ms | ✅ فعال |
| 3 | `152.232.121.253` | `6145` | 7.61ms | ✅ فعال |
| 4 | `8.213.156.191` | `10000` | 193.95ms | ✅ فعال |
| 5 | `103.65.237.92` | `5678` | 235.46ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.173` | `1000` | 78.33ms | ✅ فعال |
| 2 | `74.119.144.60` | `4145` | 73.63ms | ✅ فعال |
| 3 | `185.226.207.176` | `5725` | 84.94ms | ✅ فعال |
| 4 | `8.220.204.215` | `5060` | 189.19ms | ✅ فعال |
| 5 | `38.154.224.135` | `6676` | 8.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.18ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 116.93ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 193.55ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 2.16ms | ✅ فعال |
