...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:01 21-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `69.61.200.104` | `36181` | 93.14ms | ✅ فعال |
| 2 | `216.74.115.39` | `6633` | 61.68ms | ✅ فعال |
| 3 | `144.172.100.209` | `1080` | 55.15ms | ✅ فعال |
| 4 | `199.187.210.54` | `4145` | 71.97ms | ✅ فعال |
| 5 | `109.123.251.109` | `1080` | 151.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.206` | `4145` | 88.52ms | ✅ فعال |
| 2 | `103.246.3.202` | `4153` | 1269.89ms | ✅ فعال |
| 3 | `13.125.44.24` | `80` | 183.48ms | ✅ فعال |
| 4 | `31.59.33.58` | `6634` | 76.20ms | ✅ فعال |
| 5 | `200.43.43.121` | `4145` | 164.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 157.94ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 220.51ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 126.12ms | ✅ فعال |
