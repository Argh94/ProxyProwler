...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 00:06 11-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `157.90.113.23` | `9052` | 149.53ms | ✅ فعال |
| 2 | `82.115.60.51` | `80` | 239.31ms | ✅ فعال |
| 3 | `132.243.168.30` | `9150` | 164.78ms | ✅ فعال |
| 4 | `101.36.104.239` | `10808` | 108.50ms | ✅ فعال |
| 5 | `47.89.159.212` | `1080` | 151.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 245.22ms | ✅ فعال |
| 2 | `8.211.194.85` | `31433` | 784.12ms | ✅ فعال |
| 3 | `8.211.200.183` | `80` | 140.93ms | ✅ فعال |
| 4 | `47.89.159.212` | `1080` | 751.58ms | ✅ فعال |
| 5 | `203.188.245.98` | `52837` | 230.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 182.53ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 168.45ms | ✅ فعال |
| 3 | `103.130.61.61` | `8081` | 2307.09ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 149.51ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 182.13ms | ✅ فعال |
