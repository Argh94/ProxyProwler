...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:39 03-01-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (46 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.151.128` | `3128` | 1155.71ms | ✅ فعال |
| 2 | `120.92.212.16` | `7890` | 173.13ms | ✅ فعال |
| 3 | `97.74.87.226` | `80` | 169.61ms | ✅ فعال |
| 4 | `20.78.118.91` | `8561` | 105.45ms | ✅ فعال |
| 5 | `190.122.88.114` | `1080` | 186.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.67.136.221` | `4153` | 185.64ms | ✅ فعال |
| 2 | `190.122.88.114` | `1080` | 187.33ms | ✅ فعال |
| 3 | `187.44.211.118` | `4153` | 1203.88ms | ✅ فعال |
| 4 | `213.165.58.6` | `1080` | 157.22ms | ✅ فعال |
| 5 | `173.249.5.133` | `1080` | 2247.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.64.149.146` | `8118` | 182.54ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 213.30ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 170.14ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 138.86ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 111.41ms | ✅ فعال |
