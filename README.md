...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 09-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (27 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.170.173.232` | `7783` | 33.20ms | ✅ فعال |
| 2 | `89.58.55.33` | `80` | 130.00ms | ✅ فعال |
| 3 | `104.18.66.206` | `80` | 17.72ms | ✅ فعال |
| 4 | `136.0.207.157` | `6734` | 28.65ms | ✅ فعال |
| 5 | `8.211.51.115` | `10000` | 127.80ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.51.138.138` | `8080` | 220.56ms | ✅ فعال |
| 2 | `107.172.116.72` | `5528` | 46.72ms | ✅ فعال |
| 3 | `198.37.121.83` | `6503` | 46.55ms | ✅ فعال |
| 4 | `104.18.66.206` | `80` | 17.68ms | ✅ فعال |
| 5 | `172.67.151.134` | `80` | 17.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `102.177.176.178` | `80` | 18.00ms | ✅ فعال |
| 2 | `69.84.182.59` | `80` | 17.72ms | ✅ فعال |
| 3 | `141.101.122.238` | `80` | 17.63ms | ✅ فعال |
| 4 | `45.85.118.80` | `80` | 18.50ms | ✅ فعال |
| 5 | `185.148.104.15` | `80` | 17.46ms | ✅ فعال |
