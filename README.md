...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:22 06-11-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (82 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.102.107.145` | `4145` | 46.41ms | ✅ فعال |
| 2 | `188.40.57.101` | `80` | 134.90ms | ✅ فعال |
| 3 | `41.220.16.213` | `80` | 334.67ms | ✅ فعال |
| 4 | `185.146.173.93` | `80` | 18.59ms | ✅ فعال |
| 5 | `104.18.193.124` | `80` | 17.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `115.29.140.201` | `8499` | 226.25ms | ✅ فعال |
| 2 | `5.199.166.243` | `9068` | 180.74ms | ✅ فعال |
| 3 | `47.243.175.55` | `443` | 172.04ms | ✅ فعال |
| 4 | `193.221.203.121` | `4145` | 142.15ms | ✅ فعال |
| 5 | `68.1.210.163` | `4145` | 202.36ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (48 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.141.124` | `8326` | 187.24ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 51.72ms | ✅ فعال |
| 3 | `78.12.230.52` | `17002` | 44.53ms | ✅ فعال |
| 4 | `51.48.124.225` | `10030` | 142.71ms | ✅ فعال |
| 5 | `43.205.124.165` | `8445` | 236.75ms | ✅ فعال |
