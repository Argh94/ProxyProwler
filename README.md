...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:22 20-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `152.70.91.193` | `40000` | 191.50ms | ✅ فعال |
| 2 | `103.118.17.250` | `60000` | 197.08ms | ✅ فعال |
| 3 | `132.243.235.134` | `1080` | 90.99ms | ✅ فعال |
| 4 | `192.9.241.51` | `26568` | 63.19ms | ✅ فعال |
| 5 | `80.78.73.120` | `65530` | 118.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.182.240.12` | `4145` | 89.05ms | ✅ فعال |
| 2 | `8.211.195.139` | `80` | 88.70ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 113.67ms | ✅ فعال |
| 4 | `185.41.152.110` | `3128` | 84.20ms | ✅ فعال |
| 5 | `8.221.139.222` | `8081` | 156.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.236.191.44` | `1981` | 301.66ms | ✅ فعال |
| 2 | `188.132.221.169` | `8080` | 2177.99ms | ✅ فعال |
| 3 | `129.154.225.163` | `8100` | 189.23ms | ✅ فعال |
| 4 | `51.79.207.21` | `8080` | 223.16ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 152.86ms | ✅ فعال |
