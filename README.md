...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:41 24-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.74.31.30` | `8561` | 1105.68ms | ✅ فعال |
| 2 | `195.158.22.212` | `3128` | 206.66ms | ✅ فعال |
| 3 | `157.90.113.23` | `9052` | 114.21ms | ✅ فعال |
| 4 | `219.65.73.80` | `80` | 249.58ms | ✅ فعال |
| 5 | `199.66.182.232` | `4145` | 64.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.60.156` | `8093` | 828.98ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 286.48ms | ✅ فعال |
| 3 | `185.32.4.126` | `4153` | 126.92ms | ✅ فعال |
| 4 | `194.31.108.109` | `2080` | 184.35ms | ✅ فعال |
| 5 | `47.81.56.193` | `8888` | 238.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.2.64.185` | `8118` | 211.30ms | ✅ فعال |
| 2 | `103.130.61.61` | `8081` | 264.44ms | ✅ فعال |
| 3 | `51.79.207.21` | `8080` | 204.21ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 205.28ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 142.06ms | ✅ فعال |
