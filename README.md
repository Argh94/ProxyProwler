...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:04 03-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `195.26.230.202` | `8080` | 167.43ms | ✅ فعال |
| 2 | `107.173.93.175` | `6129` | 52.34ms | ✅ فعال |
| 3 | `192.111.134.10` | `4145` | 26.21ms | ✅ فعال |
| 4 | `52.34.243.150` | `8080` | 35.85ms | ✅ فعال |
| 5 | `199.66.183.226` | `4145` | 101.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.154.199.65` | `5219` | 59.27ms | ✅ فعال |
| 2 | `182.155.254.159` | `80` | 143.82ms | ✅ فعال |
| 3 | `186.216.195.1` | `4153` | 2199.01ms | ✅ فعال |
| 4 | `172.120.106.203` | `6358` | 20.09ms | ✅ فعال |
| 5 | `192.252.220.92` | `17328` | 23.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.65.55.10` | `1981` | 177.17ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 125.66ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 183.55ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 195.19ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 171.52ms | ✅ فعال |
