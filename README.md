...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:22 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.31.129` | `80` | 2.25ms | ✅ فعال |
| 2 | `198.199.86.11` | `8080` | 7.73ms | ✅ فعال |
| 3 | `188.114.99.37` | `80` | 2.28ms | ✅ فعال |
| 4 | `104.27.0.204` | `80` | 2.39ms | ✅ فعال |
| 5 | `63.141.128.43` | `80` | 2.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.154.83` | `5761` | 76.13ms | ✅ فعال |
| 2 | `201.148.125.126` | `4153` | 136.67ms | ✅ فعال |
| 3 | `184.181.217.194` | `4145` | 67.01ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 262.10ms | ✅ فعال |
| 5 | `1.20.227.66` | `4145` | 267.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.177.56.190` | `80` | 1.91ms | ✅ فعال |
| 2 | `45.8.211.248` | `80` | 2.17ms | ✅ فعال |
| 3 | `185.193.28.50` | `80` | 2.43ms | ✅ فعال |
| 4 | `172.67.161.245` | `80` | 2.48ms | ✅ فعال |
| 5 | `173.245.49.93` | `80` | 1.70ms | ✅ فعال |
