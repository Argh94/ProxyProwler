...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 24-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.1.48` | `80` | 1.87ms | ✅ فعال |
| 2 | `172.67.180.247` | `80` | 2.00ms | ✅ فعال |
| 3 | `77.42.31.147` | `80` | 177.86ms | ✅ فعال |
| 4 | `31.59.20.59` | `6637` | 146.52ms | ✅ فعال |
| 5 | `45.131.5.240` | `80` | 2.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.42.167` | `104` | 423.96ms | ✅ فعال |
| 2 | `216.26.255.78` | `3129` | 169.67ms | ✅ فعال |
| 3 | `110.238.116.82` | `55443` | 208.60ms | ✅ فعال |
| 4 | `49.0.199.132` | `19` | 208.04ms | ✅ فعال |
| 5 | `39.104.79.145` | `1234` | 215.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.46` | `11699` | 73.43ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 187.14ms | ✅ فعال |
| 3 | `3.35.25.117` | `50` | 136.26ms | ✅ فعال |
| 4 | `46.161.6.165` | `8080` | 179.90ms | ✅ فعال |
| 5 | `43.217.134.46` | `3128` | 176.73ms | ✅ فعال |
