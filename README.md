...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:22 12-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.60.156` | `100` | 160.07ms | ✅ فعال |
| 2 | `142.54.237.34` | `4145` | 43.16ms | ✅ فعال |
| 3 | `8.138.125.130` | `8081` | 201.86ms | ✅ فعال |
| 4 | `43.130.38.45` | `51029` | 2065.88ms | ✅ فعال |
| 5 | `103.156.17.158` | `8818` | 198.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.60.156` | `100` | 160.13ms | ✅ فعال |
| 2 | `184.178.172.13` | `15311` | 83.45ms | ✅ فعال |
| 3 | `80.151.57.81` | `8080` | 134.25ms | ✅ فعال |
| 4 | `8.148.22.214` | `8080` | 234.27ms | ✅ فعال |
| 5 | `203.189.153.170` | `1080` | 2242.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 50.67ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 51.73ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 164.58ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 153.72ms | ✅ فعال |
