...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 04-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `66.81.247.154` | `80` | 2.10ms | ✅ فعال |
| 2 | `172.67.177.169` | `80` | 1.58ms | ✅ فعال |
| 3 | `104.21.73.14` | `80` | 1.72ms | ✅ فعال |
| 4 | `185.162.231.160` | `80` | 2.09ms | ✅ فعال |
| 5 | `185.18.250.57` | `80` | 1.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.21.172.174` | `8080` | 207.46ms | ✅ فعال |
| 2 | `8.130.34.44` | `3128` | 213.59ms | ✅ فعال |
| 3 | `119.13.111.169` | `18081` | 167.64ms | ✅ فعال |
| 4 | `145.223.46.4` | `5554` | 141.70ms | ✅ فعال |
| 5 | `84.21.172.174` | `4145` | 217.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.181.173.74` | `15003` | 148.31ms | ✅ فعال |
| 2 | `43.217.141.124` | `8326` | 173.32ms | ✅ فعال |
| 3 | `15.160.134.84` | `1466` | 151.17ms | ✅ فعال |
| 4 | `35.181.173.74` | `8220` | 148.54ms | ✅ فعال |
| 5 | `35.180.127.14` | `25562` | 148.48ms | ✅ فعال |
