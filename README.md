...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 09-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.215.160` | `80` | 16.65ms | ✅ فعال |
| 2 | `68.1.210.163` | `4145` | 148.17ms | ✅ فعال |
| 3 | `172.67.71.62` | `80` | 9.15ms | ✅ فعال |
| 4 | `104.25.2.4` | `80` | 8.91ms | ✅ فعال |
| 5 | `104.27.81.121` | `80` | 9.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.208.84.236` | `7657` | 1416.74ms | ✅ فعال |
| 2 | `39.104.79.145` | `1234` | 209.15ms | ✅ فعال |
| 3 | `110.238.116.82` | `55443` | 213.25ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 136.51ms | ✅ فعال |
| 5 | `80.254.50.70` | `3629` | 179.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.205.124.165` | `10878` | 232.63ms | ✅ فعال |
| 2 | `152.53.36.101` | `45671` | 57.11ms | ✅ فعال |
| 3 | `179.96.28.58` | `80` | 1226.40ms | ✅ فعال |
| 4 | `35.152.239.124` | `9191` | 146.68ms | ✅ فعال |
| 5 | `43.217.136.176` | `55651` | 182.61ms | ✅ فعال |
