...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:11 15-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `65.21.90.27` | `761` | 113.69ms | ✅ فعال |
| 2 | `65.21.90.27` | `850` | 120.46ms | ✅ فعال |
| 3 | `65.21.90.27` | `864` | 125.87ms | ✅ فعال |
| 4 | `68.71.247.130` | `4145` | 78.88ms | ✅ فعال |
| 5 | `65.21.90.27` | `741` | 113.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.187.76.2` | `3629` | 150.75ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 122.28ms | ✅ فعال |
| 3 | `109.194.34.246` | `8082` | 160.92ms | ✅ فعال |
| 4 | `38.51.243.173` | `5678` | 80.26ms | ✅ فعال |
| 5 | `168.222.254.136` | `8888` | 103.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 222.39ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 2950.87ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 94.63ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 221.76ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 162.68ms | ✅ فعال |
