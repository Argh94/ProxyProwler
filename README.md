...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:27 11-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `164.90.183.36` | `1092` | 119.61ms | ✅ فعال |
| 2 | `46.101.184.29` | `1091` | 130.14ms | ✅ فعال |
| 3 | `161.35.82.57` | `1080` | 111.05ms | ✅ فعال |
| 4 | `27.65.116.45` | `1080` | 208.18ms | ✅ فعال |
| 5 | `66.42.224.229` | `41679` | 114.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.106.170.126` | `4145` | 143.90ms | ✅ فعال |
| 2 | `136.0.126.183` | `5944` | 41.80ms | ✅ فعال |
| 3 | `103.70.114.80` | `8080` | 229.86ms | ✅ فعال |
| 4 | `45.238.57.1` | `3629` | 109.73ms | ✅ فعال |
| 5 | `109.232.137.43` | `5678` | 162.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 134.14ms | ✅ فعال |
| 2 | `202.51.106.229` | `8080` | 2249.53ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 156.67ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 1208.72ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 199.78ms | ✅ فعال |
