...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:51 12-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.215` | `8524` | 144.82ms | ✅ فعال |
| 2 | `8.211.200.183` | `45` | 133.80ms | ✅ فعال |
| 3 | `34.44.49.215` | `80` | 48.04ms | ✅ فعال |
| 4 | `47.90.149.238` | `11` | 65.91ms | ✅ فعال |
| 5 | `5.255.117.127` | `1080` | 144.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 160.38ms | ✅ فعال |
| 2 | `147.231.163.133` | `80` | 150.96ms | ✅ فعال |
| 3 | `212.50.19.150` | `4153` | 1191.49ms | ✅ فعال |
| 4 | `103.96.233.10` | `1080` | 290.07ms | ✅ فعال |
| 5 | `157.180.84.115` | `443` | 170.66ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (1 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.159.154.43` | `3128` | 268.47ms | ✅ فعال |
