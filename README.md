...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:28 14-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.139.163` | `19404` | 79.41ms | ✅ فعال |
| 2 | `178.48.13.177` | `80` | 160.27ms | ✅ فعال |
| 3 | `208.82.61.64` | `3128` | 34.75ms | ✅ فعال |
| 4 | `5.255.113.177` | `1080` | 116.46ms | ✅ فعال |
| 5 | `47.238.128.246` | `8002` | 181.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `20` | 103.17ms | ✅ فعال |
| 2 | `103.160.59.108` | `4567` | 218.44ms | ✅ فعال |
| 3 | `92.255.190.64` | `4153` | 1184.23ms | ✅ فعال |
| 4 | `185.226.207.137` | `5686` | 107.90ms | ✅ فعال |
| 5 | `192.111.139.163` | `19404` | 92.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `58.69.125.145` | `8081` | 196.72ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 26.49ms | ✅ فعال |
| 3 | `103.153.149.18` | `8181` | 1236.04ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 25.12ms | ✅ فعال |
