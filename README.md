...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 02:04 05-06-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (103 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.110.200.148` | `8081` | 98.38ms | ✅ فعال |
| 2 | `8.213.137.155` | `8034` | 195.74ms | ✅ فعال |
| 3 | `98.181.137.83` | `4145` | 77.90ms | ✅ فعال |
| 4 | `31.211.142.115` | `8192` | 1178.24ms | ✅ فعال |
| 5 | `45.131.5.25` | `80` | 5.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.225.220.233` | `80` | 29.66ms | ✅ فعال |
| 2 | `8.213.222.247` | `666` | 945.51ms | ✅ فعال |
| 3 | `103.158.252.67` | `80` | 244.93ms | ✅ فعال |
| 4 | `104.25.0.46` | `80` | 5.56ms | ✅ فعال |
| 5 | `104.18.72.38` | `80` | 5.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.39.55` | `80` | 5.51ms | ✅ فعال |
| 2 | `5.10.246.51` | `80` | 5.50ms | ✅ فعال |
| 3 | `62.72.166.211` | `80` | 5.37ms | ✅ فعال |
| 4 | `172.66.40.96` | `80` | 5.26ms | ✅ فعال |
| 5 | `104.19.66.163` | `80` | 5.41ms | ✅ فعال |
