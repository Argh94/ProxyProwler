...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 28-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.245.124` | `80` | 1.94ms | ✅ فعال |
| 2 | `45.131.4.113` | `80` | 1.90ms | ✅ فعال |
| 3 | `45.131.208.115` | `80` | 1.89ms | ✅ فعال |
| 4 | `162.159.242.123` | `80` | 1.94ms | ✅ فعال |
| 5 | `104.19.11.38` | `80` | 1.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `181.174.164.221` | `80` | 107.45ms | ✅ فعال |
| 2 | `47.56.110.204` | `8989` | 158.74ms | ✅ فعال |
| 3 | `8.213.222.157` | `4002` | 194.29ms | ✅ فعال |
| 4 | `162.220.247.131` | `6726` | 140.11ms | ✅ فعال |
| 5 | `45.116.114.37` | `5678` | 1262.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.139` | `80` | 1.76ms | ✅ فعال |
| 2 | `172.67.181.33` | `80` | 1.92ms | ✅ فعال |
| 3 | `45.131.4.9` | `80` | 1.51ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 72.41ms | ✅ فعال |
| 5 | `45.131.7.142` | `80` | 1.83ms | ✅ فعال |
