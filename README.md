...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 30-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.123.147` | `80` | 5.92ms | ✅ فعال |
| 2 | `139.177.229.249` | `8080` | 2091.81ms | ✅ فعال |
| 3 | `74.119.147.209` | `4145` | 61.17ms | ✅ فعال |
| 4 | `8.221.138.111` | `8081` | 159.02ms | ✅ فعال |
| 5 | `63.141.128.227` | `80` | 6.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.65.224.26` | `1080` | 138.21ms | ✅ فعال |
| 2 | `8.211.194.85` | `5060` | 82.09ms | ✅ فعال |
| 3 | `139.177.229.198` | `8080` | 5.72ms | ✅ فعال |
| 4 | `8.130.36.163` | `8888` | 266.43ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 282.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.115.193.75` | `3897` | 160.53ms | ✅ فعال |
| 2 | `43.208.129.50` | `8830` | 252.57ms | ✅ فعال |
| 3 | `40.177.211.224` | `8705` | 70.84ms | ✅ فعال |
| 4 | `18.143.167.190` | `12354` | 226.06ms | ✅ فعال |
| 5 | `216.229.112.25` | `8080` | 42.75ms | ✅ فعال |
