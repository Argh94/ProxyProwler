...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 18-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.25.210` | `80` | 34.11ms | ✅ فعال |
| 2 | `31.43.179.121` | `80` | 17.62ms | ✅ فعال |
| 3 | `23.227.38.49` | `80` | 18.84ms | ✅ فعال |
| 4 | `141.193.213.116` | `80` | 17.98ms | ✅ فعال |
| 5 | `162.220.246.94` | `6378` | 128.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `167.172.86.46` | `10471` | 181.96ms | ✅ فعال |
| 2 | `1.180.0.162` | `7302` | 221.68ms | ✅ فعال |
| 3 | `188.42.89.167` | `80` | 17.66ms | ✅ فعال |
| 4 | `5.78.24.25` | `25290` | 33.05ms | ✅ فعال |
| 5 | `166.88.83.170` | `6827` | 27.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.25.3` | `80` | 19.06ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 50.79ms | ✅ فعال |
| 3 | `103.169.142.78` | `80` | 17.85ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 31.68ms | ✅ فعال |
| 5 | `104.17.26.109` | `80` | 17.79ms | ✅ فعال |
