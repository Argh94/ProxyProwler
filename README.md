...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:36 11-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `108.181.6.117` | `54893` | 58.41ms | ✅ فعال |
| 2 | `47.238.130.212` | `9050` | 201.86ms | ✅ فعال |
| 3 | `167.71.196.28` | `8080` | 219.81ms | ✅ فعال |
| 4 | `103.213.97.78` | `80` | 260.48ms | ✅ فعال |
| 5 | `183.215.23.242` | `9091` | 271.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.34.179.173` | `8452` | 60.92ms | ✅ فعال |
| 2 | `37.18.73.60` | `5566` | 2205.03ms | ✅ فعال |
| 3 | `23.27.196.228` | `6597` | 4.48ms | ✅ فعال |
| 4 | `72.205.0.67` | `4145` | 85.50ms | ✅ فعال |
| 5 | `38.154.193.213` | `5486` | 8.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 164.11ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 275.52ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 231.53ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 219.34ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 1153.40ms | ✅ فعال |
