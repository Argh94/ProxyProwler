...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:49 25-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.172.145` | `80` | 2.35ms | ✅ فعال |
| 2 | `104.21.224.150` | `80` | 18.97ms | ✅ فعال |
| 3 | `185.162.230.63` | `80` | 1.55ms | ✅ فعال |
| 4 | `47.254.36.213` | `8888` | 681.96ms | ✅ فعال |
| 5 | `5.10.247.181` | `80` | 1.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.124.21` | `6666` | 154.63ms | ✅ فعال |
| 2 | `67.201.33.10` | `25283` | 39.39ms | ✅ فعال |
| 3 | `39.102.209.128` | `100` | 497.10ms | ✅ فعال |
| 4 | `8.208.84.236` | `7657` | 617.83ms | ✅ فعال |
| 5 | `67.227.42.31` | `6008` | 11.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.115.193.75` | `9605` | 118.05ms | ✅ فعال |
| 2 | `54.154.27.41` | `122` | 138.40ms | ✅ فعال |
| 3 | `40.192.14.136` | `9292` | 2256.74ms | ✅ فعال |
| 4 | `4.149.153.123` | `3128` | 23.88ms | ✅ فعال |
| 5 | `116.80.80.222` | `3172` | 1109.05ms | ✅ فعال |
