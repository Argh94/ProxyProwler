...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:55 10-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.244.227` | `80` | 1.78ms | ✅ فعال |
| 2 | `74.119.147.209` | `4145` | 81.12ms | ✅ فعال |
| 3 | `104.207.34.24` | `3129` | 15.25ms | ✅ فعال |
| 4 | `23.227.39.60` | `80` | 2.59ms | ✅ فعال |
| 5 | `104.17.9.34` | `80` | 1.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.83.218.87` | `1111` | 198.35ms | ✅ فعال |
| 2 | `31.42.2.113` | `5678` | 141.56ms | ✅ فعال |
| 3 | `120.55.49.231` | `20201` | 230.94ms | ✅ فعال |
| 4 | `47.243.50.83` | `8088` | 196.18ms | ✅ فعال |
| 5 | `192.111.139.162` | `4145` | 88.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.226.170.181` | `9025` | 11.05ms | ✅ فعال |
| 2 | `43.209.8.12` | `20709` | 234.65ms | ✅ فعال |
| 3 | `157.175.196.122` | `8721` | 191.21ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 16.90ms | ✅ فعال |
| 5 | `78.12.82.74` | `8505` | 58.24ms | ✅ فعال |
