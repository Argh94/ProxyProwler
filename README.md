...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 28-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.177.128` | `80` | 18.94ms | ✅ فعال |
| 2 | `103.169.142.237` | `80` | 18.68ms | ✅ فعال |
| 3 | `104.19.162.60` | `80` | 17.70ms | ✅ فعال |
| 4 | `104.21.19.3` | `80` | 18.29ms | ✅ فعال |
| 5 | `104.24.153.149` | `80` | 18.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.37.135.145` | `4145` | 75.97ms | ✅ فعال |
| 2 | `47.76.144.139` | `9443` | 755.91ms | ✅ فعال |
| 3 | `8.39.228.21` | `39593` | 8.50ms | ✅ فعال |
| 4 | `91.247.250.215` | `4145` | 1192.34ms | ✅ فعال |
| 5 | `8.211.195.139` | `1000` | 815.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.112.209.152` | `32217` | 120.21ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 184.29ms | ✅ فعال |
| 3 | `108.137.1.116` | `28635` | 199.34ms | ✅ فعال |
| 4 | `13.212.76.113` | `8082` | 187.54ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 183.02ms | ✅ فعال |
