...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:10 25-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `79.110.200.27` | `8000` | 118.58ms | ✅ فعال |
| 2 | `104.16.2.116` | `80` | 1.88ms | ✅ فعال |
| 3 | `104.27.55.88` | `80` | 1.67ms | ✅ فعال |
| 4 | `104.19.147.8` | `80` | 2.11ms | ✅ فعال |
| 5 | `104.19.119.91` | `80` | 2.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.154.49.222` | `8800` | 25.15ms | ✅ فعال |
| 2 | `187.19.127.246` | `8011` | 2180.21ms | ✅ فعال |
| 3 | `49.0.246.130` | `6789` | 198.45ms | ✅ فعال |
| 4 | `8.209.68.1` | `8081` | 105.34ms | ✅ فعال |
| 5 | `8.220.204.92` | `18081` | 841.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.226.8` | `5001` | 213.32ms | ✅ فعال |
| 2 | `44.251.173.250` | `2723` | 57.46ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 16.94ms | ✅ فعال |
| 4 | `40.192.100.189` | `357` | 221.78ms | ✅ فعال |
| 5 | `3.35.25.117` | `50` | 173.99ms | ✅ فعال |
