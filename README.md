...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:26 13-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `1.231.81.166` | `3128` | 165.96ms | ✅ فعال |
| 2 | `183.110.216.128` | `8091` | 164.02ms | ✅ فعال |
| 3 | `174.138.119.88` | `80` | 33.60ms | ✅ فعال |
| 4 | `58.241.88.13` | `800` | 225.99ms | ✅ فعال |
| 5 | `47.89.184.18` | `3128` | 18.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.64.145` | `6403` | 96.59ms | ✅ فعال |
| 2 | `185.130.219.11` | `4153` | 112.65ms | ✅ فعال |
| 3 | `167.71.196.28` | `8080` | 202.29ms | ✅ فعال |
| 4 | `8.213.128.6` | `3128` | 175.35ms | ✅ فعال |
| 5 | `8.211.49.86` | `1088` | 109.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 136.38ms | ✅ فعال |
| 2 | `220.128.223.136` | `8082` | 171.57ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 208.51ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 1258.16ms | ✅ فعال |
