...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:21 30-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.143.224.149` | `6010` | 90.81ms | ✅ فعال |
| 2 | `185.135.69.34` | `80` | 186.77ms | ✅ فعال |
| 3 | `120.92.212.16` | `8890` | 274.02ms | ✅ فعال |
| 4 | `186.148.180.46` | `999` | 74.93ms | ✅ فعال |
| 5 | `45.59.186.60` | `80` | 57.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.25` | `15291` | 74.31ms | ✅ فعال |
| 2 | `72.211.46.124` | `4145` | 113.72ms | ✅ فعال |
| 3 | `72.37.216.68` | `4145` | 98.16ms | ✅ فعال |
| 4 | `47.74.46.81` | `50` | 157.40ms | ✅ فعال |
| 5 | `146.103.3.100` | `7153` | 79.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.249.100.124` | `80` | 94.78ms | ✅ فعال |
| 2 | `41.223.119.156` | `3128` | 236.24ms | ✅ فعال |
| 3 | `72.56.59.56` | `63127` | 86.18ms | ✅ فعال |
| 4 | `51.79.135.131` | `8080` | 221.47ms | ✅ فعال |
| 5 | `12.50.107.222` | `80` | 35.06ms | ✅ فعال |
