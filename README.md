...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 15-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.238.228.141` | `80` | 2.54ms | ✅ فعال |
| 2 | `172.67.181.166` | `80` | 22.45ms | ✅ فعال |
| 3 | `104.17.59.55` | `80` | 11.61ms | ✅ فعال |
| 4 | `31.12.75.13` | `80` | 1.87ms | ✅ فعال |
| 5 | `104.24.95.217` | `80` | 20.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `50` | 821.56ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 174.63ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 240.93ms | ✅ فعال |
| 4 | `23.229.125.252` | `5521` | 68.17ms | ✅ فعال |
| 5 | `8.130.34.44` | `3128` | 215.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.66.40.96` | `80` | 2.39ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 1.89ms | ✅ فعال |
| 3 | `23.227.39.55` | `80` | 2.08ms | ✅ فعال |
| 4 | `195.245.221.183` | `80` | 2.19ms | ✅ فعال |
| 5 | `45.131.7.142` | `80` | 2.05ms | ✅ فعال |
