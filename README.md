...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:58 04-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.101.13.80` | `1064` | 246.25ms | ✅ فعال |
| 2 | `98.178.72.21` | `10919` | 95.23ms | ✅ فعال |
| 3 | `8.210.17.35` | `9443` | 203.52ms | ✅ فعال |
| 4 | `192.252.208.67` | `14287` | 70.89ms | ✅ فعال |
| 5 | `65.109.179.84` | `8443` | 116.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `92.119.164.84` | `1088` | 87.98ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 1143.06ms | ✅ فعال |
| 3 | `41.220.16.208` | `80` | 231.89ms | ✅ فعال |
| 4 | `8.215.3.250` | `1081` | 244.95ms | ✅ فعال |
| 5 | `8.221.141.88` | `8080` | 160.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.121.102.227` | `8080` | 105.64ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 121.62ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 2.90ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 207.82ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 230.09ms | ✅ فعال |
