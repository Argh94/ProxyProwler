...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:58 04-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `89.116.250.160` | `80` | 1.66ms | ✅ فعال |
| 2 | `185.148.105.50` | `80` | 1.69ms | ✅ فعال |
| 3 | `172.66.40.185` | `80` | 1.58ms | ✅ فعال |
| 4 | `172.67.70.107` | `80` | 1.96ms | ✅ فعال |
| 5 | `91.200.115.49` | `1080` | 167.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.200.160.35` | `80` | 1.35ms | ✅ فعال |
| 2 | `1.180.49.222` | `7302` | 187.28ms | ✅ فعال |
| 3 | `47.238.60.156` | `8080` | 154.17ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 167.46ms | ✅ فعال |
| 5 | `142.54.226.214` | `4145` | 1094.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.26.109` | `80` | 1.60ms | ✅ فعال |
| 2 | `62.72.166.211` | `80` | 2.29ms | ✅ فعال |
| 3 | `1.10.141.115` | `8080` | 213.14ms | ✅ فعال |
| 4 | `5.10.247.49` | `80` | 5.55ms | ✅ فعال |
| 5 | `104.17.190.13` | `80` | 1.54ms | ✅ فعال |
