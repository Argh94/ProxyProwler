...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:17 13-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `171.25.158.95` | `1080` | 123.45ms | ✅ فعال |
| 2 | `8.211.195.139` | `20` | 81.71ms | ✅ فعال |
| 3 | `82.114.228.67` | `1080` | 2193.98ms | ✅ فعال |
| 4 | `91.188.213.143` | `1080` | 124.22ms | ✅ فعال |
| 5 | `91.233.169.23` | `8081` | 121.63ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `121.43.109.88` | `8080` | 250.94ms | ✅ فعال |
| 2 | `137.184.209.17` | `1080` | 13.17ms | ✅ فعال |
| 3 | `68.71.249.153` | `48606` | 71.03ms | ✅ فعال |
| 4 | `185.125.203.104` | `40760` | 2176.42ms | ✅ فعال |
| 5 | `8.211.195.139` | `20` | 879.29ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.79.71.106` | `8080` | 19.68ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.70ms | ✅ فعال |
| 3 | `170.0.231.254` | `999` | 2082.63ms | ✅ فعال |
