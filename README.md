...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 04-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.227.38.6` | `80` | 2.07ms | ✅ فعال |
| 2 | `45.80.108.172` | `80` | 2.46ms | ✅ فعال |
| 3 | `185.148.105.226` | `80` | 1.53ms | ✅ فعال |
| 4 | `47.91.29.151` | `81` | 142.06ms | ✅ فعال |
| 5 | `67.201.59.70` | `4145` | 89.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `9500` | 823.06ms | ✅ فعال |
| 2 | `213.19.205.18` | `54321` | 102.86ms | ✅ فعال |
| 3 | `198.105.111.144` | `6822` | 91.27ms | ✅ فعال |
| 4 | `72.37.217.3` | `4145` | 88.36ms | ✅ فعال |
| 5 | `154.16.146.44` | `80` | 2079.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.98.190.236` | `8002` | 234.07ms | ✅ فعال |
| 2 | `35.183.25.134` | `27865` | 24.09ms | ✅ فعال |
| 3 | `18.144.52.143` | `45074` | 61.76ms | ✅ فعال |
| 4 | `3.249.44.164` | `8080` | 87.03ms | ✅ فعال |
| 5 | `13.246.35.124` | `1004` | 229.18ms | ✅ فعال |
