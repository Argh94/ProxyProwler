...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:15 16-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.244.41.177` | `6361` | 8.45ms | ✅ فعال |
| 2 | `63.141.128.246` | `80` | 2.27ms | ✅ فعال |
| 3 | `219.65.73.81` | `80` | 243.85ms | ✅ فعال |
| 4 | `72.195.114.169` | `4145` | 58.95ms | ✅ فعال |
| 5 | `104.143.224.68` | `5929` | 80.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.145.235.200` | `3128` | 8.18ms | ✅ فعال |
| 2 | `16.51.157.105` | `7219` | 211.87ms | ✅ فعال |
| 3 | `45.8.88.236` | `1080` | 130.38ms | ✅ فعال |
| 4 | `8.130.54.67` | `80` | 267.53ms | ✅ فعال |
| 5 | `184.185.2.12` | `4145` | 57.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 223.34ms | ✅ فعال |
| 2 | `45.151.182.9` | `3128` | 119.00ms | ✅ فعال |
| 3 | `45.59.186.60` | `80` | 58.50ms | ✅ فعال |
| 4 | `8.212.177.126` | `8080` | 235.96ms | ✅ فعال |
| 5 | `46.29.162.166` | `80` | 168.27ms | ✅ فعال |
