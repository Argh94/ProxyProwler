...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 25-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.67.215.7` | `80` | 15.39ms | ✅ فعال |
| 2 | `104.25.190.7` | `80` | 14.92ms | ✅ فعال |
| 3 | `8.213.215.187` | `104` | 238.48ms | ✅ فعال |
| 4 | `104.239.124.159` | `6437` | 22.47ms | ✅ فعال |
| 5 | `199.58.185.9` | `4145` | 75.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `9050` | 811.43ms | ✅ فعال |
| 2 | `8.213.222.247` | `15` | 749.13ms | ✅ فعال |
| 3 | `39.102.213.3` | `8081` | 228.24ms | ✅ فعال |
| 4 | `101.200.158.109` | `3128` | 227.28ms | ✅ فعال |
| 5 | `8.130.34.44` | `3128` | 235.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.88.21` | `80` | 9.86ms | ✅ فعال |
| 2 | `104.17.106.99` | `80` | 16.80ms | ✅ فعال |
| 3 | `45.131.211.217` | `80` | 15.56ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 26.74ms | ✅ فعال |
| 5 | `185.162.229.172` | `80` | 14.10ms | ✅ فعال |
