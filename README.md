...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:08 20-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `191.223.220.23` | `1080` | 118.94ms | ✅ فعال |
| 2 | `113.160.132.26` | `8080` | 216.10ms | ✅ فعال |
| 3 | `199.66.182.243` | `4145` | 76.12ms | ✅ فعال |
| 4 | `95.181.213.41` | `10808` | 161.98ms | ✅ فعال |
| 5 | `95.181.213.41` | `10808` | 162.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.89.159.212` | `11` | 45.74ms | ✅ فعال |
| 2 | `8.211.200.183` | `3129` | 120.96ms | ✅ فعال |
| 3 | `192.9.231.220` | `30001` | 24.06ms | ✅ فعال |
| 4 | `31.59.20.17` | `6595` | 118.65ms | ✅ فعال |
| 5 | `184.174.126.30` | `6322` | 41.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 51.21ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 203.55ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 166.08ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 51.53ms | ✅ فعال |
| 5 | `110.34.1.180` | `32650` | 275.55ms | ✅ فعال |
