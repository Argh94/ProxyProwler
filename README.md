...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 24-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.2.49` | `80` | 5.97ms | ✅ فعال |
| 2 | `173.245.49.234` | `80` | 5.70ms | ✅ فعال |
| 3 | `172.66.43.217` | `80` | 6.12ms | ✅ فعال |
| 4 | `47.91.29.151` | `41` | 159.92ms | ✅ فعال |
| 5 | `104.26.11.63` | `80` | 5.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.0.162` | `7302` | 266.39ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 111.23ms | ✅ فعال |
| 3 | `101.132.222.120` | `80` | 244.36ms | ✅ فعال |
| 4 | `185.216.107.167` | `5744` | 73.23ms | ✅ فعال |
| 5 | `198.37.118.134` | `5593` | 16.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.8.211.248` | `80` | 5.96ms | ✅ فعال |
| 2 | `185.162.229.172` | `80` | 6.29ms | ✅ فعال |
| 3 | `45.80.108.229` | `80` | 6.10ms | ✅ فعال |
| 4 | `104.16.0.165` | `80` | 6.23ms | ✅ فعال |
| 5 | `173.245.49.93` | `80` | 5.80ms | ✅ فعال |
