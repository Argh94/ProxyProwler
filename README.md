...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:04 10-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.157.194` | `80` | 203.87ms | ✅ فعال |
| 2 | `185.226.207.127` | `5676` | 94.22ms | ✅ فعال |
| 3 | `45.131.211.220` | `80` | 2.94ms | ✅ فعال |
| 4 | `23.227.39.91` | `80` | 2.05ms | ✅ فعال |
| 5 | `192.200.160.247` | `80` | 3.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.50.83` | `8088` | 193.51ms | ✅ فعال |
| 2 | `116.100.223.56` | `1080` | 225.34ms | ✅ فعال |
| 3 | `27.73.21.139` | `1080` | 234.16ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 123.30ms | ✅ فعال |
| 5 | `8.210.17.35` | `8008` | 872.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.198.185.30` | `8099` | 193.28ms | ✅ فعال |
| 2 | `18.163.210.76` | `3128` | 195.14ms | ✅ فعال |
| 3 | `16.78.93.162` | `8449` | 220.26ms | ✅ فعال |
| 4 | `176.57.189.138` | `3128` | 139.93ms | ✅ فعال |
| 5 | `4.149.153.123` | `3128` | 51.36ms | ✅ فعال |
