...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:56 23-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.194.12.165` | `80` | 6.08ms | ✅ فعال |
| 2 | `104.233.52.93` | `3199` | 30.17ms | ✅ فعال |
| 3 | `167.172.181.111` | `80` | 99.92ms | ✅ فعال |
| 4 | `45.151.163.239` | `5992` | 98.71ms | ✅ فعال |
| 5 | `104.17.210.115` | `80` | 5.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.43.244.15` | `4153` | 116.92ms | ✅ فعال |
| 2 | `193.247.81.167` | `1080` | 104.54ms | ✅ فعال |
| 3 | `49.0.199.132` | `19` | 281.62ms | ✅ فعال |
| 4 | `104.27.18.24` | `80` | 6.23ms | ✅ فعال |
| 5 | `47.91.89.3` | `9050` | 93.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `44.251.173.250` | `155` | 79.26ms | ✅ فعال |
| 2 | `16.79.112.218` | `165` | 240.85ms | ✅ فعال |
| 3 | `120.92.212.16` | `8890` | 275.58ms | ✅ فعال |
| 4 | `40.192.14.136` | `9292` | 210.61ms | ✅ فعال |
| 5 | `13.61.155.35` | `1000` | 103.00ms | ✅ فعال |
