...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:30 13-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.83.87.186` | `1080` | 1175.56ms | ✅ فعال |
| 2 | `68.71.240.210` | `4145` | 80.39ms | ✅ فعال |
| 3 | `192.252.211.193` | `4145` | 70.14ms | ✅ فعال |
| 4 | `98.191.0.47` | `4145` | 85.08ms | ✅ فعال |
| 5 | `159.69.21.0` | `9050` | 95.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.65.30.137` | `1080` | 231.52ms | ✅ فعال |
| 2 | `141.147.9.254` | `80` | 2140.84ms | ✅ فعال |
| 3 | `8.213.151.128` | `3128` | 178.11ms | ✅ فعال |
| 4 | `183.80.130.9` | `4145` | 1298.04ms | ✅ فعال |
| 5 | `47.238.134.126` | `808` | 197.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 222.21ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 226.47ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 193.89ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 118.03ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 167.13ms | ✅ فعال |
