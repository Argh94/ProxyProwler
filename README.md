...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:44 30-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.224` | `6089` | 97.00ms | ✅ فعال |
| 2 | `184.95.220.42` | `1080` | 28.70ms | ✅ فعال |
| 3 | `61.158.175.38` | `9002` | 267.94ms | ✅ فعال |
| 4 | `23.175.248.21` | `1080` | 32.69ms | ✅ فعال |
| 5 | `98.188.47.132` | `4145` | 86.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `82.132.19.108` | `4153` | 109.76ms | ✅ فعال |
| 2 | `47.238.134.126` | `8181` | 213.57ms | ✅ فعال |
| 3 | `66.42.224.229` | `41679` | 334.52ms | ✅ فعال |
| 4 | `103.166.39.145` | `3629` | 251.50ms | ✅ فعال |
| 5 | `45.61.100.199` | `6467` | 2.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 2.96ms | ✅ فعال |
| 2 | `103.158.252.99` | `80` | 244.19ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 231.75ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 232.57ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 117.19ms | ✅ فعال |
