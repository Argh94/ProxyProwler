...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:29 16-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `51.178.49.241` | `1088` | 89.98ms | ✅ فعال |
| 2 | `5.249.165.195` | `20000` | 32.02ms | ✅ فعال |
| 3 | `31.172.133.253` | `4153` | 160.49ms | ✅ فعال |
| 4 | `162.214.159.94` | `8085` | 94.26ms | ✅ فعال |
| 5 | `14.161.10.46` | `80` | 234.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `135.125.179.41` | `3128` | 91.35ms | ✅ فعال |
| 2 | `47.251.87.199` | `1234` | 65.25ms | ✅ فعال |
| 3 | `91.223.52.141` | `5678` | 111.43ms | ✅ فعال |
| 4 | `8.213.222.157` | `8443` | 303.51ms | ✅ فعال |
| 5 | `82.132.19.108` | `4153` | 114.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.130.61.61` | `8081` | 244.71ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 227.58ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 1224.05ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 226.77ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 157.60ms | ✅ فعال |
