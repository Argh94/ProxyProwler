...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 22-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.76.80.215` | `1080` | 137.82ms | ✅ فعال |
| 2 | `47.238.128.246` | `80` | 179.52ms | ✅ فعال |
| 3 | `47.76.171.214` | `3128` | 177.72ms | ✅ فعال |
| 4 | `209.50.163.115` | `3129` | 40.84ms | ✅ فعال |
| 5 | `72.49.49.11` | `31034` | 230.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.64.116` | `6374` | 122.02ms | ✅ فعال |
| 2 | `36.64.238.82` | `1080` | 228.14ms | ✅ فعال |
| 3 | `103.82.20.76` | `8080` | 222.52ms | ✅ فعال |
| 4 | `162.214.159.94` | `3128` | 50.95ms | ✅ فعال |
| 5 | `95.38.160.79` | `10809` | 205.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 198.59ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 197.52ms | ✅ فعال |
