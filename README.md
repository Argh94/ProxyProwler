...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.176.120` | `80` | 8.61ms | ✅ فعال |
| 2 | `170.114.46.1` | `80` | 9.65ms | ✅ فعال |
| 3 | `104.19.171.218` | `80` | 16.72ms | ✅ فعال |
| 4 | `45.131.208.30` | `80` | 8.92ms | ✅ فعال |
| 5 | `103.169.142.205` | `80` | 8.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.20.227.66` | `4145` | 2287.53ms | ✅ فعال |
| 2 | `8.213.128.6` | `90` | 918.90ms | ✅ فعال |
| 3 | `8.130.34.237` | `1234` | 204.31ms | ✅ فعال |
| 4 | `101.200.158.109` | `8880` | 202.03ms | ✅ فعال |
| 5 | `158.255.77.169` | `80` | 231.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.190.13` | `80` | 16.94ms | ✅ فعال |
| 2 | `104.17.25.3` | `80` | 16.66ms | ✅ فعال |
| 3 | `172.67.181.33` | `80` | 8.97ms | ✅ فعال |
| 4 | `45.12.31.28` | `80` | 8.82ms | ✅ فعال |
| 5 | `188.114.96.63` | `80` | 9.09ms | ✅ فعال |
