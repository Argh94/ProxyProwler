...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:57 10-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.56.110.204` | `8989` | 185.27ms | ✅ فعال |
| 2 | `199.116.114.11` | `4145` | 64.32ms | ✅ فعال |
| 3 | `101.66.199.213` | `8085` | 225.12ms | ✅ فعال |
| 4 | `167.103.34.108` | `8800` | 234.47ms | ✅ فعال |
| 5 | `47.251.73.54` | `8834` | 46.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 258.47ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 169.68ms | ✅ فعال |
| 3 | `104.143.226.144` | `5747` | 94.49ms | ✅ فعال |
| 4 | `47.89.184.18` | `3128` | 17.81ms | ✅ فعال |
| 5 | `144.124.227.90` | `21074` | 102.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `180.250.219.58` | `53281` | 277.86ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 115.10ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 210.74ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 139.58ms | ✅ فعال |
| 5 | `202.154.19.7` | `8080` | 1278.69ms | ✅ فعال |
