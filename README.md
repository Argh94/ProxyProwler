...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:00 30-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.219` | `6700` | 155.49ms | ✅ فعال |
| 2 | `206.123.156.203` | `14497` | 183.23ms | ✅ فعال |
| 3 | `195.201.204.175` | `9110` | 143.61ms | ✅ فعال |
| 4 | `77.232.142.77` | `31336` | 175.80ms | ✅ فعال |
| 5 | `185.235.16.12` | `80` | 188.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `94.103.88.252` | `54101` | 174.67ms | ✅ فعال |
| 2 | `85.100.40.241` | `34036` | 1191.50ms | ✅ فعال |
| 3 | `104.238.49.129` | `5783` | 18.33ms | ✅ فعال |
| 4 | `185.32.4.102` | `4153` | 153.62ms | ✅ فعال |
| 5 | `178.210.130.89` | `5678` | 154.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 51.74ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 250.33ms | ✅ فعال |
| 3 | `158.101.175.124` | `5566` | 2196.19ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 51.07ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 137.93ms | ✅ فعال |
