...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 09:22 21-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.214.176.170` | `6141` | 24.24ms | ✅ فعال |
| 2 | `166.88.238.32` | `6012` | 27.74ms | ✅ فعال |
| 3 | `123.30.154.171` | `7777` | 219.35ms | ✅ فعال |
| 4 | `5.161.155.252` | `80` | 49.47ms | ✅ فعال |
| 5 | `174.136.204.40` | `80` | 33.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `208.102.51.6` | `58208` | 134.84ms | ✅ فعال |
| 2 | `173.214.176.170` | `6141` | 23.54ms | ✅ فعال |
| 3 | `142.54.228.193` | `4145` | 49.03ms | ✅ فعال |
| 4 | `121.43.154.123` | `80` | 585.50ms | ✅ فعال |
| 5 | `184.181.217.206` | `4145` | 106.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.223.66.48` | `8443` | 161.87ms | ✅ فعال |
| 2 | `5.161.155.252` | `80` | 1051.77ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 130.35ms | ✅ فعال |
| 4 | `47.74.157.194` | `80` | 180.55ms | ✅ فعال |
| 5 | `94.176.3.110` | `7443` | 197.02ms | ✅ فعال |
