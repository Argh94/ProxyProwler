...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:33 02-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `107.173.36.88` | `5543` | 36.41ms | ✅ فعال |
| 2 | `206.123.156.236` | `9735` | 91.19ms | ✅ فعال |
| 3 | `206.123.156.219` | `4495` | 85.38ms | ✅ فعال |
| 4 | `138.124.51.85` | `1080` | 94.79ms | ✅ فعال |
| 5 | `4.213.167.178` | `80` | 201.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.139` | `8080` | 77.00ms | ✅ فعال |
| 2 | `72.195.34.59` | `4145` | 91.64ms | ✅ فعال |
| 3 | `136.0.207.173` | `6750` | 69.93ms | ✅ فعال |
| 4 | `104.143.226.253` | `5856` | 81.07ms | ✅ فعال |
| 5 | `47.57.242.244` | `5080` | 201.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.59.59.122` | `8118` | 204.40ms | ✅ فعال |
| 2 | `38.7.16.194` | `999` | 1120.37ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 124.64ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 223.26ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 92.89ms | ✅ فعال |
