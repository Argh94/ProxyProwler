...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:23 21-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `4.213.98.253` | `80` | 218.04ms | ✅ فعال |
| 2 | `8.211.194.78` | `138` | 101.02ms | ✅ فعال |
| 3 | `152.53.65.215` | `8090` | 117.90ms | ✅ فعال |
| 4 | `132.226.7.23` | `30277` | 153.09ms | ✅ فعال |
| 5 | `45.135.139.32` | `6335` | 101.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.209.158` | `4145` | 72.41ms | ✅ فعال |
| 2 | `45.43.64.231` | `6489` | 98.04ms | ✅ فعال |
| 3 | `104.143.224.21` | `5882` | 94.81ms | ✅ فعال |
| 4 | `107.173.132.195` | `7149` | 2.75ms | ✅ فعال |
| 5 | `8.211.51.115` | `80` | 114.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 1158.07ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 173.94ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 206.30ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 137.25ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 204.42ms | ✅ فعال |
