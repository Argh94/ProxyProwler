...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:40 25-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.27.203.31` | `6766` | 18.54ms | ✅ فعال |
| 2 | `184.178.172.25` | `15291` | 102.55ms | ✅ فعال |
| 3 | `184.185.2.12` | `4145` | 1130.99ms | ✅ فعال |
| 4 | `194.87.55.194` | `2053` | 106.84ms | ✅ فعال |
| 5 | `46.62.214.3` | `1080` | 126.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.32.4.102` | `4153` | 122.90ms | ✅ فعال |
| 2 | `95.3.69.222` | `8080` | 151.35ms | ✅ فعال |
| 3 | `8.213.197.208` | `8000` | 232.53ms | ✅ فعال |
| 4 | `178.220.148.82` | `10801` | 130.20ms | ✅ فعال |
| 5 | `176.12.71.36` | `1234` | 153.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 208.08ms | ✅ فعال |
| 2 | `51.79.207.21` | `8080` | 267.58ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 221.01ms | ✅ فعال |
| 4 | `128.90.145.79` | `8118` | 124.04ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 209.24ms | ✅ فعال |
