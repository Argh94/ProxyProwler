...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:04 29-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.116.112.6` | `4145` | 78.70ms | ✅ فعال |
| 2 | `184.178.172.11` | `4145` | 80.65ms | ✅ فعال |
| 3 | `183.110.216.128` | `8090` | 1194.83ms | ✅ فعال |
| 4 | `130.193.43.183` | `1080` | 161.71ms | ✅ فعال |
| 5 | `47.119.19.221` | `9098` | 223.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `152.69.211.50` | `40001` | 195.11ms | ✅ فعال |
| 2 | `13.214.205.160` | `40448` | 197.18ms | ✅ فعال |
| 3 | `173.0.10.88` | `6264` | 33.47ms | ✅ فعال |
| 4 | `8.213.134.213` | `50` | 823.63ms | ✅ فعال |
| 5 | `47.237.92.86` | `3129` | 740.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 133.81ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 195.99ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 150.00ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 215.74ms | ✅ فعال |
