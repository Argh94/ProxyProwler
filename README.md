...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:15 19-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `65.108.203.37` | `28080` | 141.58ms | ✅ فعال |
| 2 | `167.99.255.141` | `1084` | 124.27ms | ✅ فعال |
| 3 | `152.53.53.166` | `1080` | 35.49ms | ✅ فعال |
| 4 | `184.181.217.220` | `4145` | 104.72ms | ✅ فعال |
| 5 | `203.22.223.47` | `80` | 12.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.220.204.215` | `8888` | 157.25ms | ✅ فعال |
| 2 | `65.108.203.37` | `28080` | 142.72ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 1182.94ms | ✅ فعال |
| 4 | `213.156.124.3` | `33333` | 1141.60ms | ✅ فعال |
| 5 | `134.209.170.92` | `80` | 39.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 199.54ms | ✅ فعال |
| 2 | `51.79.71.106` | `8080` | 48.46ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 157.02ms | ✅ فعال |
