...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:04 30-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.197.75.63` | `80` | 9.05ms | ✅ فعال |
| 2 | `190.93.246.15` | `80` | 16.75ms | ✅ فعال |
| 3 | `104.27.17.192` | `80` | 8.76ms | ✅ فعال |
| 4 | `102.177.176.184` | `80` | 9.51ms | ✅ فعال |
| 5 | `145.223.56.28` | `7080` | 58.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `156.244.11.6` | `8192` | 223.54ms | ✅ فعال |
| 2 | `202.162.212.164` | `4153` | 210.65ms | ✅ فعال |
| 3 | `39.104.69.76` | `8888` | 216.44ms | ✅ فعال |
| 4 | `138.36.199.14` | `4153` | 159.77ms | ✅ فعال |
| 5 | `109.232.106.150` | `52435` | 2232.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.240.77` | `9007` | 204.15ms | ✅ فعال |
| 2 | `43.208.16.9` | `45605` | 206.15ms | ✅ فعال |
| 3 | `15.168.235.57` | `741` | 116.15ms | ✅ فعال |
| 4 | `16.78.82.73` | `34742` | 189.24ms | ✅ فعال |
| 5 | `38.60.196.214` | `80` | 134.49ms | ✅ فعال |
