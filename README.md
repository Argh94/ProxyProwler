...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:19 24-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `24.249.199.12` | `4145` | 124.25ms | ✅ فعال |
| 2 | `217.217.254.94` | `8080` | 188.74ms | ✅ فعال |
| 3 | `61.158.175.38` | `9002` | 207.97ms | ✅ فعال |
| 4 | `113.108.13.120` | `8083` | 219.22ms | ✅ فعال |
| 5 | `150.230.104.3` | `16728` | 109.20ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (70 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.207.39.233` | `3128` | 61.15ms | ✅ فعال |
| 2 | `202.162.212.164` | `4153` | 224.11ms | ✅ فعال |
| 3 | `192.111.139.165` | `4145` | 105.36ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 215.60ms | ✅ فعال |
| 5 | `192.252.209.155` | `14455` | 92.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `85.214.204.79` | `80` | 1183.61ms | ✅ فعال |
| 2 | `190.9.109.196` | `999` | 58.75ms | ✅ فعال |
| 3 | `81.10.234.234` | `80` | 154.17ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 130.03ms | ✅ فعال |
| 5 | `85.133.227.182` | `80` | 261.34ms | ✅ فعال |
