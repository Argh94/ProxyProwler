...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:14 15-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `212.114.194.78` | `80` | 2185.15ms | ✅ فعال |
| 2 | `177.71.224.87` | `3128` | 115.27ms | ✅ فعال |
| 3 | `68.71.249.153` | `48606` | 105.40ms | ✅ فعال |
| 4 | `140.248.133.95` | `80` | 5.77ms | ✅ فعال |
| 5 | `89.116.88.19` | `80` | 156.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `174.75.211.222` | `4145` | 74.20ms | ✅ فعال |
| 2 | `47.243.124.21` | `6666` | 210.92ms | ✅ فعال |
| 3 | `106.15.137.41` | `3129` | 262.05ms | ✅ فعال |
| 4 | `200.85.232.91` | `3128` | 68.74ms | ✅ فعال |
| 5 | `98.181.137.80` | `4145` | 71.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.247.136.254` | `80` | 73.63ms | ✅ فعال |
| 2 | `2.144.6.212` | `12111` | 405.44ms | ✅ فعال |
| 3 | `41.220.16.215` | `80` | 246.96ms | ✅ فعال |
| 4 | `8.220.177.199` | `8080` | 245.75ms | ✅ فعال |
| 5 | `8.212.177.126` | `8080` | 253.91ms | ✅ فعال |
