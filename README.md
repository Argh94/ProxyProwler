...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:09 16-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.229.19.157` | `8752` | 10.05ms | ✅ فعال |
| 2 | `8.213.195.191` | `9080` | 195.02ms | ✅ فعال |
| 3 | `64.64.118.110` | `6693` | 72.96ms | ✅ فعال |
| 4 | `67.227.1.4` | `6285` | 10.29ms | ✅ فعال |
| 5 | `192.111.130.2` | `4145` | 105.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.137.45.84` | `55432` | 214.04ms | ✅ فعال |
| 2 | `41.220.16.209` | `80` | 307.53ms | ✅ فعال |
| 3 | `38.60.209.216` | `20002` | 166.70ms | ✅ فعال |
| 4 | `104.200.135.46` | `4145` | 23.44ms | ✅ فعال |
| 5 | `181.143.37.11` | `32767` | 110.08ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.7.138.78` | `80` | 121.06ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 170.49ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 112.90ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 164.54ms | ✅ فعال |
