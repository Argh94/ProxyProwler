...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:22 18-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.78` | `31433` | 76.81ms | ✅ فعال |
| 2 | `8.221.139.222` | `443` | 158.63ms | ✅ فعال |
| 3 | `47.252.18.37` | `8080` | 2.70ms | ✅ فعال |
| 4 | `72.195.114.184` | `4145` | 105.28ms | ✅ فعال |
| 5 | `206.123.156.228` | `32539` | 85.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `141.147.146.174` | `1080` | 165.30ms | ✅ فعال |
| 2 | `166.88.3.154` | `6625` | 65.97ms | ✅ فعال |
| 3 | `185.226.207.178` | `5727` | 83.57ms | ✅ فعال |
| 4 | `47.251.73.54` | `92` | 69.38ms | ✅ فعال |
| 5 | `177.85.65.177` | `4153` | 1207.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `158.101.175.124` | `5566` | 93.03ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 240.79ms | ✅ فعال |
| 3 | `170.0.231.254` | `999` | 71.32ms | ✅ فعال |
