...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:51 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.194.12.1` | `80` | 5.90ms | ✅ فعال |
| 2 | `104.16.0.172` | `80` | 6.19ms | ✅ فعال |
| 3 | `45.131.209.148` | `80` | 5.47ms | ✅ فعال |
| 4 | `185.221.160.199` | `80` | 5.53ms | ✅ فعال |
| 5 | `45.131.211.8` | `80` | 5.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.85` | `3128` | 759.12ms | ✅ فعال |
| 2 | `172.67.150.69` | `80` | 5.69ms | ✅ فعال |
| 3 | `8.130.36.245` | `8080` | 218.13ms | ✅ فعال |
| 4 | `201.148.125.126` | `4153` | 131.80ms | ✅ فعال |
| 5 | `202.40.181.220` | `31247` | 300.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.7.142` | `80` | 5.61ms | ✅ فعال |
| 2 | `45.12.31.28` | `80` | 9.13ms | ✅ فعال |
| 3 | `202.154.18.1` | `8080` | 247.86ms | ✅ فعال |
| 4 | `173.245.49.114` | `80` | 5.51ms | ✅ فعال |
| 5 | `185.162.229.172` | `80` | 5.65ms | ✅ فعال |
