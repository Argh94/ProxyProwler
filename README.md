...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:37 02-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `92.118.234.124` | `1080` | 107.37ms | ✅ فعال |
| 2 | `98.175.31.195` | `4145` | 92.93ms | ✅ فعال |
| 3 | `206.123.156.218` | `7223` | 85.63ms | ✅ فعال |
| 4 | `178.57.106.43` | `4145` | 139.62ms | ✅ فعال |
| 5 | `174.138.119.88` | `80` | 6.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `81.90.29.194` | `10808` | 118.49ms | ✅ فعال |
| 2 | `23.236.179.91` | `5722` | 8.52ms | ✅ فعال |
| 3 | `8.213.156.191` | `138` | 181.64ms | ✅ فعال |
| 4 | `198.105.111.56` | `6734` | 79.85ms | ✅ فعال |
| 5 | `199.102.107.145` | `4145` | 71.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 223.51ms | ✅ فعال |
| 2 | `102.68.128.215` | `8080` | 2194.44ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 158.61ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 209.94ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.30ms | ✅ فعال |
