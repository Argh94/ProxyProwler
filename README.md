...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 18-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `169.150.213.229` | `10794` | 80.76ms | ✅ فعال |
| 2 | `45.131.211.162` | `80` | 2.21ms | ✅ فعال |
| 3 | `194.36.55.135` | `80` | 2.50ms | ✅ فعال |
| 4 | `23.227.60.16` | `80` | 2.69ms | ✅ فعال |
| 5 | `172.67.211.192` | `80` | 2.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.173.14.99` | `36835` | 122.18ms | ✅ فعال |
| 2 | `103.165.64.86` | `4153` | 205.54ms | ✅ فعال |
| 3 | `104.21.69.79` | `80` | 2.35ms | ✅ فعال |
| 4 | `47.251.57.165` | `1080` | 1077.61ms | ✅ فعال |
| 5 | `8.211.200.183` | `10002` | 127.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.162.13.186` | `8888` | 224.41ms | ✅ فعال |
| 2 | `16.78.82.73` | `11714` | 232.35ms | ✅ فعال |
| 3 | `103.86.117.13` | `1111` | 2271.89ms | ✅ فعال |
| 4 | `18.188.141.177` | `1145` | 24.57ms | ✅ فعال |
| 5 | `157.175.42.134` | `27343` | 165.92ms | ✅ فعال |
