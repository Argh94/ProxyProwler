...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 19-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.5.242` | `80` | 10.39ms | ✅ فعال |
| 2 | `191.101.188.11` | `6765` | 34.64ms | ✅ فعال |
| 3 | `8.213.222.247` | `9098` | 201.04ms | ✅ فعال |
| 4 | `154.197.75.49` | `80` | 8.61ms | ✅ فعال |
| 5 | `206.237.31.132` | `1080` | 1163.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `138.68.21.132` | `40467` | 2050.79ms | ✅ فعال |
| 2 | `16.78.41.33` | `372` | 190.34ms | ✅ فعال |
| 3 | `213.136.92.199` | `8008` | 151.18ms | ✅ فعال |
| 4 | `47.242.81.226` | `1011` | 165.94ms | ✅ فعال |
| 5 | `8.213.195.191` | `9091` | 201.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.168.235.57` | `982` | 115.38ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 51.62ms | ✅ فعال |
| 3 | `120.92.212.16` | `8890` | 1250.36ms | ✅ فعال |
| 4 | `43.208.129.50` | `9252` | 202.37ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 192.83ms | ✅ فعال |
