...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:04 30-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.56.226` | `5774` | 104.83ms | ✅ فعال |
| 2 | `213.188.215.27` | `1080` | 2.46ms | ✅ فعال |
| 3 | `185.161.251.195` | `3128` | 109.20ms | ✅ فعال |
| 4 | `75.84.71.14` | `80` | 64.37ms | ✅ فعال |
| 5 | `8.218.212.95` | `1011` | 187.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.6.101.98` | `4153` | 130.80ms | ✅ فعال |
| 2 | `146.103.56.226` | `5774` | 104.88ms | ✅ فعال |
| 3 | `172.86.75.243` | `7301` | 104.18ms | ✅ فعال |
| 4 | `8.211.195.139` | `1000` | 95.36ms | ✅ فعال |
| 5 | `167.172.27.39` | `9068` | 27.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 208.04ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 208.06ms | ✅ فعال |
| 3 | `195.25.20.155` | `3128` | 114.46ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 137.07ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 16.81ms | ✅ فعال |
