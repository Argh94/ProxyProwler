...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:55 24-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.66.182.243` | `4145` | 64.70ms | ✅ فعال |
| 2 | `195.46.164.196` | `1080` | 181.00ms | ✅ فعال |
| 3 | `47.254.36.213` | `999` | 50.67ms | ✅ فعال |
| 4 | `43.164.3.124` | `1080` | 235.06ms | ✅ فعال |
| 5 | `83.149.198.215` | `1080` | 142.96ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.74.38` | `50` | 50.54ms | ✅ فعال |
| 2 | `185.130.219.11` | `4153` | 2179.50ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 259.88ms | ✅ فعال |
| 4 | `185.226.207.242` | `5791` | 101.47ms | ✅ فعال |
| 5 | `98.103.88.158` | `46104` | 1073.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.57.189.138` | `3128` | 150.32ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 208.07ms | ✅ فعال |
| 3 | `103.130.61.61` | `8081` | 1248.71ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 1234.98ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 134.47ms | ✅ فعال |
