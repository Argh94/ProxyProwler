...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 22-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `193.31.117.184` | `80` | 137.69ms | ✅ فعال |
| 2 | `8.130.34.44` | `4006` | 265.56ms | ✅ فعال |
| 3 | `104.18.95.226` | `80` | 5.65ms | ✅ فعال |
| 4 | `23.227.39.59` | `80` | 6.45ms | ✅ فعال |
| 5 | `212.183.88.84` | `80` | 6.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `38.153.152.240` | `9590` | 12.42ms | ✅ فعال |
| 2 | `104.18.95.226` | `80` | 5.84ms | ✅ فعال |
| 3 | `133.18.234.13` | `80` | 169.14ms | ✅ فعال |
| 4 | `192.111.129.150` | `4145` | 55.46ms | ✅ فعال |
| 5 | `47.74.46.81` | `9098` | 408.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.246.51` | `80` | 5.92ms | ✅ فعال |
| 2 | `104.17.190.13` | `80` | 6.30ms | ✅ فعال |
| 3 | `1.10.141.115` | `8080` | 1284.52ms | ✅ فعال |
| 4 | `69.84.182.59` | `80` | 6.22ms | ✅ فعال |
| 5 | `104.17.26.109` | `80` | 6.53ms | ✅ فعال |
