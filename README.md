...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 31-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `37.187.92.9` | `1031` | 101.34ms | ✅ فعال |
| 2 | `98.190.239.3` | `4145` | 89.95ms | ✅ فعال |
| 3 | `181.78.74.253` | `999` | 95.41ms | ✅ فعال |
| 4 | `184.181.217.201` | `4145` | 92.98ms | ✅ فعال |
| 5 | `45.38.143.77` | `10808` | 558.20ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `182.53.216.73` | `4145` | 1275.72ms | ✅ فعال |
| 2 | `8.213.128.6` | `8080` | 821.34ms | ✅ فعال |
| 3 | `45.146.163.31` | `80` | 144.34ms | ✅ فعال |
| 4 | `92.255.190.64` | `4153` | 1207.64ms | ✅ فعال |
| 5 | `8.221.138.111` | `5060` | 149.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 137.07ms | ✅ فعال |
| 2 | `103.156.17.83` | `8080` | 1280.51ms | ✅ فعال |
| 3 | `41.65.55.10` | `1981` | 143.70ms | ✅ فعال |
| 4 | `203.174.15.138` | `8080` | 224.18ms | ✅ فعال |
| 5 | `220.128.223.136` | `8082` | 2873.21ms | ✅ فعال |
