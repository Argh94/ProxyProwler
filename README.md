...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:47 19-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `62.72.166.173` | `80` | 2.83ms | ✅ فعال |
| 2 | `104.21.91.77` | `80` | 2.34ms | ✅ فعال |
| 3 | `104.17.10.10` | `80` | 2.63ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 165.26ms | ✅ فعال |
| 5 | `192.252.214.17` | `4145` | 67.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.61.121.161` | `6760` | 25.24ms | ✅ فعال |
| 2 | `101.200.158.109` | `3128` | 239.39ms | ✅ فعال |
| 3 | `101.200.158.109` | `8880` | 243.50ms | ✅ فعال |
| 4 | `8.213.129.15` | `8080` | 166.28ms | ✅ فعال |
| 5 | `8.130.34.237` | `1234` | 244.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.1.112` | `80` | 1.91ms | ✅ فعال |
| 2 | `45.85.118.80` | `80` | 2.75ms | ✅ فعال |
| 3 | `45.131.4.93` | `80` | 2.71ms | ✅ فعال |
| 4 | `172.66.40.96` | `80` | 2.98ms | ✅ فعال |
| 5 | `5.10.246.51` | `80` | 2.59ms | ✅ فعال |
