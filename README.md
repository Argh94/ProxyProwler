...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:01 05-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `63.141.128.86` | `80` | 2.18ms | ✅ فعال |
| 2 | `107.175.119.175` | `6703` | 47.89ms | ✅ فعال |
| 3 | `104.18.14.76` | `80` | 2.27ms | ✅ فعال |
| 4 | `45.12.30.88` | `80` | 1.65ms | ✅ فعال |
| 5 | `45.61.127.118` | `6057` | 24.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `88.216.68.90` | `9115` | 12.61ms | ✅ فعال |
| 2 | `67.227.37.105` | `5647` | 48.43ms | ✅ فعال |
| 3 | `8.148.22.214` | `3129` | 237.93ms | ✅ فعال |
| 4 | `216.74.118.7` | `6162` | 47.34ms | ✅ فعال |
| 5 | `64.188.65.195` | `1080` | 1164.88ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (47 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.34.242.98` | `80` | 235.90ms | ✅ فعال |
| 2 | `37.27.6.46` | `80` | 132.38ms | ✅ فعال |
| 3 | `38.180.189.145` | `80` | 193.26ms | ✅ فعال |
| 4 | `3.110.127.255` | `808` | 223.11ms | ✅ فعال |
| 5 | `43.209.8.12` | `21829` | 231.94ms | ✅ فعال |
