...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 11-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.185.150` | `80` | 55.50ms | ✅ فعال |
| 2 | `104.25.0.193` | `80` | 12.73ms | ✅ فعال |
| 3 | `104.18.45.119` | `80` | 12.06ms | ✅ فعال |
| 4 | `198.105.111.76` | `6754` | 105.01ms | ✅ فعال |
| 5 | `46.254.92.10` | `80` | 15.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `172.120.119.98` | `5758` | 50.60ms | ✅ فعال |
| 2 | `8.210.17.35` | `8008` | 186.10ms | ✅ فعال |
| 3 | `74.119.144.60` | `4145` | 104.49ms | ✅ فعال |
| 4 | `8.221.139.222` | `9098` | 132.65ms | ✅ فعال |
| 5 | `39.104.23.154` | `8004` | 246.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.92.46.203` | `33422` | 125.36ms | ✅ فعال |
| 2 | `15.160.134.84` | `35084` | 122.62ms | ✅ فعال |
| 3 | `18.226.170.181` | `1014` | 28.40ms | ✅ فعال |
| 4 | `157.175.170.170` | `6594` | 199.79ms | ✅ فعال |
| 5 | `40.192.3.100` | `5441` | 242.38ms | ✅ فعال |
