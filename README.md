...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:48 12-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.163.151` | `80` | 1.80ms | ✅ فعال |
| 2 | `104.21.51.20` | `80` | 1.59ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 168.34ms | ✅ فعال |
| 4 | `138.68.60.8` | `8080` | 2.32ms | ✅ فعال |
| 5 | `213.19.205.18` | `54321` | 142.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.168.145` | `4145` | 53.46ms | ✅ فعال |
| 2 | `35.197.89.213` | `80` | 21.71ms | ✅ فعال |
| 3 | `47.251.87.199` | `85` | 3.65ms | ✅ فعال |
| 4 | `103.65.237.92` | `5678` | 182.05ms | ✅ فعال |
| 5 | `206.220.175.2` | `4145` | 40.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.247.188` | `80` | 1.72ms | ✅ فعال |
| 2 | `198.177.56.190` | `80` | 2.27ms | ✅ فعال |
| 3 | `45.131.7.142` | `80` | 1.87ms | ✅ فعال |
| 4 | `104.19.66.163` | `80` | 1.93ms | ✅ فعال |
| 5 | `206.238.236.139` | `80` | 1.94ms | ✅ فعال |
