...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:08 18-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `216.68.128.121` | `4145` | 131.05ms | ✅ فعال |
| 2 | `220.158.233.26` | `1080` | 2287.02ms | ✅ فعال |
| 3 | `109.70.74.16` | `1080` | 140.79ms | ✅ فعال |
| 4 | `98.191.0.47` | `4145` | 108.96ms | ✅ فعال |
| 5 | `185.135.69.34` | `80` | 245.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `197.255.126.69` | `80` | 232.54ms | ✅ فعال |
| 2 | `47.91.109.17` | `10` | 255.67ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 156.76ms | ✅ فعال |
| 4 | `192.111.130.5` | `17002` | 84.23ms | ✅ فعال |
| 5 | `192.111.135.17` | `18302` | 78.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 50.62ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 59.54ms | ✅ فعال |
