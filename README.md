...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:54 29-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.2.13` | `80` | 1.82ms | ✅ فعال |
| 2 | `206.238.237.83` | `80` | 1.89ms | ✅ فعال |
| 3 | `185.238.228.89` | `80` | 1.88ms | ✅ فعال |
| 4 | `185.162.229.224` | `80` | 1.74ms | ✅ فعال |
| 5 | `184.170.249.65` | `4145` | 114.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `167.172.86.46` | `10471` | 168.28ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 1.80ms | ✅ فعال |
| 3 | `192.73.244.36` | `80` | 9.10ms | ✅ فعال |
| 4 | `72.214.108.67` | `4145` | 135.93ms | ✅ فعال |
| 5 | `192.111.135.18` | `18301` | 109.24ms | ✅ فعال |
...
| 2 | `104.24.85.134` | `80` | 10.41ms | ✅ فعال |
| 3 | `104.16.0.165` | `80` | 1.97ms | ✅ فعال |
| 4 | `172.67.181.33` | `80` | 8.99ms | ✅ فعال |
| 5 | `104.19.66.163` | `80` | 1.53ms | ✅ فعال |
