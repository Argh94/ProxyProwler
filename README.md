...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:30 23-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.156.191` | `8080` | 749.90ms | ✅ فعال |
| 2 | `137.66.1.45` | `80` | 29.73ms | ✅ فعال |
| 3 | `174.64.199.79` | `4145` | 119.45ms | ✅ فعال |
| 4 | `8.211.194.78` | `8443` | 1843.39ms | ✅ فعال |
| 5 | `144.91.121.61` | `1088` | 202.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.239.13.30` | `6659` | 68.55ms | ✅ فعال |
| 2 | `8.213.222.247` | `15` | 796.95ms | ✅ فعال |
| 3 | `45.116.114.37` | `5678` | 1206.50ms | ✅ فعال |
| 4 | `72.205.0.67` | `4145` | 122.25ms | ✅ فعال |
| 5 | `196.1.97.198` | `80` | 1260.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 188.06ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 151.69ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 161.50ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 174.97ms | ✅ فعال |
