...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:58 17-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `119.148.7.10` | `22122` | 2253.14ms | ✅ فعال |
| 2 | `38.154.227.203` | `5904` | 65.48ms | ✅ فعال |
| 3 | `107.181.168.145` | `4145` | 29.30ms | ✅ فعال |
| 4 | `103.125.31.222` | `80` | 213.05ms | ✅ فعال |
| 5 | `188.239.43.6` | `80` | 176.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.11.111` | `808` | 192.73ms | ✅ فعال |
| 2 | `184.178.172.18` | `15280` | 137.09ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 177.04ms | ✅ فعال |
| 4 | `47.238.128.246` | `8080` | 164.21ms | ✅ فعال |
| 5 | `31.59.33.152` | `6728` | 142.28ms | ✅ فعال |
...
| 2 | `47.74.226.8` | `5001` | 179.76ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 178.29ms | ✅ فعال |
| 4 | `154.73.29.65` | `8080` | 176.14ms | ✅ فعال |
