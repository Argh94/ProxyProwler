...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 28-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.167.35` | `80` | 54.53ms | ✅ فعال |
| 2 | `172.64.152.180` | `80` | 2.70ms | ✅ فعال |
| 3 | `172.67.182.105` | `80` | 23.91ms | ✅ فعال |
| 4 | `104.21.114.43` | `80` | 54.22ms | ✅ فعال |
| 5 | `185.162.231.189` | `80` | 2.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `8080` | 684.86ms | ✅ فعال |
| 2 | `8.220.204.92` | `9080` | 868.80ms | ✅ فعال |
| 3 | `172.64.152.180` | `80` | 2.68ms | ✅ فعال |
| 4 | `177.85.65.177` | `4153` | 161.73ms | ✅ فعال |
| 5 | `122.146.95.183` | `4145` | 2218.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.143.173.102` | `4097` | 210.53ms | ✅ فعال |
| 2 | `13.61.155.35` | `8228` | 121.92ms | ✅ فعال |
| 3 | `152.53.171.242` | `18943` | 21.57ms | ✅ فعال |
| 4 | `116.80.80.221` | `3172` | 2188.38ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 111.64ms | ✅ فعال |
