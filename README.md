...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 15:21 19-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.219` | `5738` | 90.41ms | ✅ فعال |
| 2 | `47.238.128.246` | `8081` | 205.17ms | ✅ فعال |
| 3 | `112.28.149.156` | `8443` | 210.29ms | ✅ فعال |
| 4 | `206.123.156.212` | `10097` | 98.53ms | ✅ فعال |
| 5 | `103.42.228.19` | `1080` | 261.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.99.134.183` | `8090` | 124.51ms | ✅ فعال |
| 2 | `146.103.55.150` | `6202` | 2.60ms | ✅ فعال |
| 3 | `162.220.246.2` | `6286` | 84.19ms | ✅ فعال |
| 4 | `217.69.127.132` | `6753` | 84.51ms | ✅ فعال |
| 5 | `174.64.199.79` | `4145` | 86.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 238.05ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 234.43ms | ✅ فعال |
| 3 | `104.129.194.43` | `10336` | 4.97ms | ✅ فعال |
| 4 | `103.189.116.20` | `8080` | 1291.33ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 4.98ms | ✅ فعال |
