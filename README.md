...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 25-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `93.100.133.197` | `1080` | 259.24ms | ✅ فعال |
| 2 | `47.76.171.214` | `3128` | 169.27ms | ✅ فعال |
| 3 | `203.160.61.104` | `4145` | 199.88ms | ✅ فعال |
| 4 | `223.254.141.102` | `6601` | 175.04ms | ✅ فعال |
| 5 | `31.76.15.189` | `1080` | 227.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.105.111.50` | `6728` | 129.09ms | ✅ فعال |
| 2 | `39.102.214.152` | `9999` | 288.34ms | ✅ فعال |
| 3 | `161.123.151.122` | `6106` | 52.62ms | ✅ فعال |
| 4 | `177.85.65.177` | `4153` | 189.54ms | ✅ فعال |
| 5 | `198.8.94.174` | `39078` | 82.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `220.128.223.136` | `8082` | 199.00ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 125.27ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 183.59ms | ✅ فعال |
| 4 | `176.57.189.138` | `3128` | 187.11ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 166.49ms | ✅ فعال |
