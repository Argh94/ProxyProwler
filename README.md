...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 20-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `66.235.200.74` | `80` | 2.58ms | ✅ فعال |
| 2 | `104.20.61.12` | `80` | 2.30ms | ✅ فعال |
| 3 | `154.30.250.128` | `5640` | 8.82ms | ✅ فعال |
| 4 | `184.178.172.18` | `15280` | 68.98ms | ✅ فعال |
| 5 | `172.67.222.223` | `80` | 2.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `201.174.239.28` | `4153` | 50.28ms | ✅ فعال |
| 2 | `199.102.104.70` | `4145` | 110.67ms | ✅ فعال |
| 3 | `187.44.211.118` | `4153` | 148.79ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 879.01ms | ✅ فعال |
| 5 | `79.110.198.37` | `8080` | 100.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.160.186.74` | `24` | 94.34ms | ✅ فعال |
| 2 | `37.221.193.221` | `17942` | 110.09ms | ✅ فعال |
| 3 | `56.124.106.170` | `8022` | 113.34ms | ✅ فعال |
| 4 | `13.212.76.113` | `9551` | 233.87ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.86ms | ✅ فعال |
