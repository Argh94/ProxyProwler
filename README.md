...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 13-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `66.235.200.103` | `80` | 2.50ms | ✅ فعال |
| 2 | `104.21.23.187` | `80` | 1.57ms | ✅ فعال |
| 3 | `104.24.226.19` | `80` | 1.77ms | ✅ فعال |
| 4 | `150.230.249.42` | `46818` | 1146.66ms | ✅ فعال |
| 5 | `104.254.140.180` | `80` | 1.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.103.56.188` | `5736` | 145.65ms | ✅ فعال |
| 2 | `103.166.39.81` | `3629` | 214.91ms | ✅ فعال |
| 3 | `172.66.43.163` | `80` | 1.41ms | ✅ فعال |
| 4 | `45.8.211.128` | `80` | 1.87ms | ✅ فعال |
| 5 | `47.238.134.126` | `8080` | 158.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `69.84.182.59` | `80` | 1.54ms | ✅ فعال |
| 2 | `45.8.211.248` | `80` | 1.87ms | ✅ فعال |
| 3 | `104.17.247.188` | `80` | 2.39ms | ✅ فعال |
| 4 | `62.72.166.211` | `80` | 4.97ms | ✅ فعال |
| 5 | `45.131.7.159` | `80` | 2.12ms | ✅ فعال |
