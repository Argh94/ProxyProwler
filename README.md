...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:51 25-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `1.231.81.166` | `3128` | 166.04ms | ✅ فعال |
| 2 | `192.252.208.70` | `14282` | 69.87ms | ✅ فعال |
| 3 | `151.236.24.38` | `80` | 121.00ms | ✅ فعال |
| 4 | `46.62.214.3` | `1080` | 133.71ms | ✅ فعال |
| 5 | `165.154.226.148` | `1080` | 187.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.129.227.157` | `3128` | 103.88ms | ✅ فعال |
| 2 | `104.239.104.7` | `6231` | 24.76ms | ✅ فعال |
| 3 | `154.29.232.184` | `6844` | 23.68ms | ✅ فعال |
| 4 | `89.58.55.33` | `80` | 111.71ms | ✅ فعال |
| 5 | `198.46.137.15` | `6219` | 54.10ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 209.09ms | ✅ فعال |
| 2 | `185.191.236.162` | `3128` | 145.66ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 17.13ms | ✅ فعال |
