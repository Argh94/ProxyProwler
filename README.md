...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:17 21-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `158.178.198.31` | `1080` | 98.49ms | ✅ فعال |
| 2 | `206.123.156.233` | `8775` | 102.31ms | ✅ فعال |
| 3 | `206.123.156.196` | `5757` | 2244.84ms | ✅ فعال |
| 4 | `206.123.156.204` | `8414` | 102.66ms | ✅ فعال |
| 5 | `206.123.156.233` | `8471` | 114.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `79.106.170.126` | `4145` | 1194.08ms | ✅ فعال |
| 2 | `147.231.163.133` | `80` | 113.18ms | ✅ فعال |
| 3 | `197.221.234.149` | `80` | 252.19ms | ✅ فعال |
| 4 | `177.66.43.189` | `4145` | 171.66ms | ✅ فعال |
| 5 | `47.85.51.197` | `1080` | 19.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 17.01ms | ✅ فعال |
| 2 | `129.154.225.163` | `8100` | 201.82ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 221.63ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 21.61ms | ✅ فعال |
| 5 | `103.157.79.83` | `1111` | 221.14ms | ✅ فعال |
