...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 17-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.160.188.21` | `1080` | 2278.37ms | ✅ فعال |
| 2 | `104.17.20.67` | `80` | 12.52ms | ✅ فعال |
| 3 | `216.205.52.84` | `80` | 12.67ms | ✅ فعال |
| 4 | `23.227.39.59` | `80` | 14.53ms | ✅ فعال |
| 5 | `104.18.5.176` | `80` | 14.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.114.97.5` | `80` | 15.27ms | ✅ فعال |
| 2 | `192.252.220.92` | `17328` | 69.19ms | ✅ فعال |
| 3 | `209.50.180.141` | `3129` | 118.87ms | ✅ فعال |
| 4 | `101.132.222.120` | `80` | 209.34ms | ✅ فعال |
| 5 | `45.85.119.211` | `80` | 12.75ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.93` | `80` | 14.40ms | ✅ فعال |
| 2 | `23.227.39.103` | `80` | 15.10ms | ✅ فعال |
| 3 | `103.169.142.78` | `80` | 12.82ms | ✅ فعال |
| 4 | `45.131.4.93` | `80` | 9.27ms | ✅ فعال |
| 5 | `103.39.49.156` | `3128` | 257.46ms | ✅ فعال |
