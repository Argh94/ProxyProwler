...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:23 22-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.220` | `8631` | 332.02ms | ✅ فعال |
| 2 | `89.163.206.215` | `9050` | 132.28ms | ✅ فعال |
| 3 | `206.123.156.226` | `4061` | 1223.42ms | ✅ فعال |
| 4 | `68.1.210.189` | `4145` | 140.26ms | ✅ فعال |
| 5 | `31.211.142.115` | `8192` | 169.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.43.159.98` | `1080` | 151.67ms | ✅ فعال |
| 2 | `8.211.194.85` | `1080` | 137.80ms | ✅ فعال |
| 3 | `76.144.40.133` | `9050` | 45.13ms | ✅ فعال |
| 4 | `203.190.8.59` | `1088` | 222.73ms | ✅ فعال |
| 5 | `184.181.217.206` | `4145` | 141.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 191.73ms | ✅ فعال |
| 2 | `158.101.175.124` | `5566` | 174.89ms | ✅ فعال |
| 3 | `79.121.102.227` | `8080` | 153.78ms | ✅ فعال |
| 4 | `202.154.19.7` | `8080` | 1221.18ms | ✅ فعال |
| 5 | `51.79.71.106` | `8080` | 77.57ms | ✅ فعال |
