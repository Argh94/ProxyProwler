...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:10 03-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.246.12` | `80` | 2.06ms | ✅ فعال |
| 2 | `104.16.1.103` | `80` | 2.34ms | ✅ فعال |
| 3 | `172.67.176.44` | `80` | 2.32ms | ✅ فعال |
| 4 | `104.18.16.230` | `80` | 2.35ms | ✅ فعال |
| 5 | `172.67.180.80` | `80` | 2.77ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.43.244.15` | `4153` | 119.59ms | ✅ فعال |
| 2 | `217.145.199.47` | `56746` | 1134.35ms | ✅ فعال |
| 3 | `212.39.114.139` | `5678` | 114.02ms | ✅ فعال |
| 4 | `173.211.68.91` | `6373` | 68.11ms | ✅ فعال |
| 5 | `149.57.17.227` | `5695` | 8.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `188.166.230.109` | `31028` | 1226.53ms | ✅ فعال |
| 2 | `40.176.96.235` | `25473` | 72.50ms | ✅ فعال |
| 3 | `120.92.212.16` | `7890` | 275.71ms | ✅ فعال |
| 4 | `210.87.74.85` | `9090` | 236.05ms | ✅ فعال |
| 5 | `45.191.47.3` | `999` | 82.51ms | ✅ فعال |
