...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:59 14-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `5.255.103.55` | `1080` | 123.00ms | ✅ فعال |
| 2 | `154.90.60.16` | `20002` | 113.66ms | ✅ فعال |
| 3 | `156.244.2.246` | `20002` | 69.55ms | ✅ فعال |
| 4 | `47.243.201.253` | `1011` | 208.23ms | ✅ فعال |
| 5 | `103.75.118.84` | `1080` | 1218.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.37.216.68` | `4145` | 70.66ms | ✅ فعال |
| 2 | `47.251.87.74` | `84` | 66.90ms | ✅ فعال |
| 3 | `8.210.17.35` | `8443` | 860.39ms | ✅ فعال |
| 4 | `31.43.33.56` | `4153` | 2195.37ms | ✅ فعال |
| 5 | `8.209.96.245` | `4153` | 97.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 168.47ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 218.78ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 116.22ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 195.07ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 102.71ms | ✅ فعال |
