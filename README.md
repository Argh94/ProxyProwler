...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:10 15-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `95.164.123.243` | `9050` | 105.46ms | ✅ فعال |
| 2 | `74.176.195.135` | `80` | 147.56ms | ✅ فعال |
| 3 | `195.133.84.57` | `1080` | 109.28ms | ✅ فعال |
| 4 | `206.123.156.230` | `11221` | 111.79ms | ✅ فعال |
| 5 | `115.29.148.215` | `45554` | 247.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `12.50.107.221` | `80` | 42.14ms | ✅ فعال |
| 2 | `150.241.106.113` | `1080` | 1214.88ms | ✅ فعال |
| 3 | `142.54.236.97` | `4145` | 65.32ms | ✅ فعال |
| 4 | `203.190.8.59` | `1088` | 249.73ms | ✅ فعال |
| 5 | `159.203.167.231` | `9057` | 24.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 16.75ms | ✅ فعال |
| 2 | `195.25.20.155` | `3128` | 111.75ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 205.82ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 142.36ms | ✅ فعال |
| 5 | `138.2.64.185` | `8118` | 207.10ms | ✅ فعال |
