...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:29 25-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `41.220.22.7` | `80` | 288.08ms | ✅ فعال |
| 2 | `206.123.156.211` | `11676` | 150.85ms | ✅ فعال |
| 3 | `89.111.181.247` | `1080` | 179.11ms | ✅ فعال |
| 4 | `47.251.74.38` | `9080` | 16.70ms | ✅ فعال |
| 5 | `206.123.156.198` | `9918` | 217.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.135.168.41` | `80` | 29.41ms | ✅ فعال |
| 2 | `64.64.115.118` | `5753` | 60.65ms | ✅ فعال |
| 3 | `41.220.22.7` | `80` | 288.60ms | ✅ فعال |
| 4 | `35.209.198.222` | `80` | 57.90ms | ✅ فعال |
| 5 | `91.242.229.129` | `8092` | 1158.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 50.23ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 175.82ms | ✅ فعال |
| 3 | `129.154.225.163` | `8100` | 224.51ms | ✅ فعال |
