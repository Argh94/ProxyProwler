...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:30 17-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.215.187` | `3000` | 238.21ms | ✅ فعال |
| 2 | `4.213.98.253` | `80` | 230.85ms | ✅ فعال |
| 3 | `8.221.141.88` | `5631` | 145.60ms | ✅ فعال |
| 4 | `184.178.172.25` | `15291` | 76.49ms | ✅ فعال |
| 5 | `8.220.188.140` | `443` | 1252.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `159.138.252.45` | `8888` | 271.28ms | ✅ فعال |
| 2 | `68.1.210.189` | `4145` | 92.81ms | ✅ فعال |
| 3 | `123.57.1.16` | `5555` | 247.12ms | ✅ فعال |
| 4 | `192.111.139.165` | `4145` | 72.05ms | ✅ فعال |
| 5 | `98.188.47.150` | `4145` | 76.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `4.190.168.163` | `3128` | 152.20ms | ✅ فعال |
| 2 | `38.60.196.214` | `80` | 92.30ms | ✅ فعال |
| 3 | `89.116.88.19` | `80` | 142.49ms | ✅ فعال |
| 4 | `27.34.242.98` | `80` | 243.33ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 113.17ms | ✅ فعال |
