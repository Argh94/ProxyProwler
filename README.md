...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 23:39 05-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.194.9.31` | `8888` | 42.45ms | ✅ فعال |
| 2 | `206.123.156.231` | `12653` | 174.95ms | ✅ فعال |
| 3 | `103.75.118.84` | `1080` | 132.08ms | ✅ فعال |
| 4 | `206.123.156.233` | `5536` | 2209.39ms | ✅ فعال |
| 5 | `88.99.82.67` | `443` | 125.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `93.184.9.9` | `1080` | 1178.59ms | ✅ فعال |
| 2 | `136.0.109.240` | `6526` | 49.52ms | ✅ فعال |
| 3 | `192.252.211.197` | `14921` | 84.20ms | ✅ فعال |
| 4 | `39.102.210.222` | `8081` | 233.24ms | ✅ فعال |
| 5 | `67.227.37.136` | `5678` | 41.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.145.34.10` | `55443` | 2241.76ms | ✅ فعال |
| 2 | `115.248.66.131` | `3129` | 281.88ms | ✅ فعال |
| 3 | `202.137.8.148` | `8080` | 210.37ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 201.54ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 34.19ms | ✅ فعال |
