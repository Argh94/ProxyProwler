...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 08-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.168.197` | `80` | 5.68ms | ✅ فعال |
| 2 | `203.160.61.104` | `4145` | 240.26ms | ✅ فعال |
| 3 | `162.159.242.19` | `80` | 5.93ms | ✅ فعال |
| 4 | `155.254.34.64` | `6044` | 82.72ms | ✅ فعال |
| 5 | `104.168.8.222` | `5675` | 27.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.229.254.129` | `4145` | 85.06ms | ✅ فعال |
| 2 | `119.13.111.169` | `18081` | 222.68ms | ✅ فعال |
| 3 | `104.21.28.92` | `80` | 5.61ms | ✅ فعال |
| 4 | `104.238.37.128` | `6685` | 34.46ms | ✅ فعال |
| 5 | `104.168.8.222` | `5675` | 27.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.176.96.235` | `315` | 77.45ms | ✅ فعال |
| 2 | `43.217.136.176` | `8007` | 231.67ms | ✅ فعال |
| 3 | `121.165.162.9` | `8564` | 197.48ms | ✅ فعال |
| 4 | `51.44.169.116` | `2526` | 84.29ms | ✅ فعال |
| 5 | `51.95.58.31` | `8080` | 98.22ms | ✅ فعال |
