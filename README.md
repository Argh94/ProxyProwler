...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 02-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `175.138.231.145` | `80` | 1487.80ms | ✅ فعال |
| 2 | `104.238.30.39` | `59741` | 101.69ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 219.48ms | ✅ فعال |
| 4 | `47.76.144.139` | `18080` | 204.55ms | ✅ فعال |
| 5 | `172.86.67.233` | `1080` | 89.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.237.113.119` | `8000` | 627.19ms | ✅ فعال |
| 2 | `8.213.197.208` | `100` | 869.50ms | ✅ فعال |
| 3 | `203.24.102.74` | `80` | 6.09ms | ✅ فعال |
| 4 | `72.214.108.67` | `4145` | 72.31ms | ✅ فعال |
| 5 | `70.166.167.38` | `57728` | 79.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `124.121.2.149` | `8080` | 2299.91ms | ✅ فعال |
| 2 | `72.56.59.62` | `63133` | 88.67ms | ✅ فعال |
| 3 | `34.44.49.215` | `80` | 30.76ms | ✅ فعال |
| 4 | `65.108.209.73` | `80` | 117.44ms | ✅ فعال |
| 5 | `12.50.107.220` | `80` | 29.39ms | ✅ فعال |
