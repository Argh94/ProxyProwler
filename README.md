...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:57 02-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.75.118.84` | `1080` | 166.56ms | ✅ فعال |
| 2 | `47.91.109.17` | `20000` | 188.99ms | ✅ فعال |
| 3 | `206.123.156.217` | `5069` | 2225.63ms | ✅ فعال |
| 4 | `185.135.69.34` | `80` | 220.11ms | ✅ فعال |
| 5 | `3.106.214.140` | `1080` | 251.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `35.212.206.106` | `1080` | 132.96ms | ✅ فعال |
| 2 | `31.145.106.120` | `1080` | 129.33ms | ✅ فعال |
| 3 | `199.102.106.94` | `4145` | 85.28ms | ✅ فعال |
| 4 | `157.254.188.28` | `8080` | 39.16ms | ✅ فعال |
| 5 | `177.234.247.18` | `1080` | 98.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 222.33ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 116.45ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 225.48ms | ✅ فعال |
| 4 | `94.130.177.190` | `9999` | 93.62ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 2.44ms | ✅ فعال |
