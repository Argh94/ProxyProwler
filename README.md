...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:06 06-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.143.224.251` | `6112` | 101.02ms | ✅ فعال |
| 2 | `160.153.0.139` | `80` | 14.54ms | ✅ فعال |
| 3 | `23.227.39.66` | `80` | 12.67ms | ✅ فعال |
| 4 | `31.43.179.236` | `80` | 11.99ms | ✅ فعال |
| 5 | `50.114.28.35` | `5520` | 68.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.21.172.174` | `8080` | 144.54ms | ✅ فعال |
| 2 | `88.216.68.8` | `9119` | 14.24ms | ✅ فعال |
| 3 | `198.105.100.157` | `6408` | 101.91ms | ✅ فعال |
| 4 | `162.220.246.166` | `6450` | 112.34ms | ✅ فعال |
| 5 | `84.21.172.174` | `5678` | 146.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.176.96.235` | `3643` | 71.31ms | ✅ فعال |
| 2 | `13.115.193.75` | `4916` | 133.46ms | ✅ فعال |
| 3 | `40.192.105.58` | `51056` | 237.25ms | ✅ فعال |
| 4 | `15.160.134.84` | `2529` | 126.70ms | ✅ فعال |
| 5 | `138.2.64.185` | `8118` | 201.35ms | ✅ فعال |
