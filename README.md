...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:50 02-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `23.88.88.105` | `80` | 92.50ms | ✅ فعال |
| 2 | `72.205.0.67` | `4145` | 91.09ms | ✅ فعال |
| 3 | `87.117.11.57` | `1080` | 153.82ms | ✅ فعال |
| 4 | `58.19.55.4` | `15373` | 240.00ms | ✅ فعال |
| 5 | `172.200.72.48` | `80` | 12.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `183.110.216.159` | `8090` | 185.87ms | ✅ فعال |
| 2 | `184.181.217.201` | `4145` | 91.10ms | ✅ فعال |
| 3 | `8.211.195.173` | `8081` | 82.77ms | ✅ فعال |
| 4 | `103.166.39.81` | `3629` | 250.08ms | ✅ فعال |
| 5 | `192.252.211.197` | `14921` | 64.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `115.248.66.131` | `3129` | 229.84ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 222.26ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 106.20ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 215.75ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 158.99ms | ✅ فعال |
