...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:11 12-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `195.19.50.120` | `1080` | 522.14ms | ✅ فعال |
| 2 | `136.0.186.19` | `6380` | 14.52ms | ✅ فعال |
| 3 | `8.213.128.6` | `8989` | 193.04ms | ✅ فعال |
| 4 | `12.50.107.219` | `80` | 30.33ms | ✅ فعال |
| 5 | `94.158.244.245` | `1080` | 81.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.11.233` | `9050` | 6.85ms | ✅ فعال |
| 2 | `98.188.47.150` | `4145` | 89.98ms | ✅ فعال |
| 3 | `173.211.8.210` | `6322` | 55.28ms | ✅ فعال |
| 4 | `8.213.128.6` | `8989` | 192.26ms | ✅ فعال |
| 5 | `27.34.242.98` | `80` | 244.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 6.40ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 6.78ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 223.80ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 120.71ms | ✅ فعال |
| 5 | `195.25.20.155` | `3128` | 138.83ms | ✅ فعال |
