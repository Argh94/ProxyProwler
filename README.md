...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:04 04-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.167.27` | `1000` | 18.41ms | ✅ فعال |
| 2 | `213.27.29.153` | `51000` | 1192.25ms | ✅ فعال |
| 3 | `58.19.55.4` | `15297` | 248.96ms | ✅ فعال |
| 4 | `58.19.55.4` | `15383` | 248.84ms | ✅ فعال |
| 5 | `8.211.51.115` | `8008` | 105.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `83.220.46.106` | `4145` | 137.82ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 129.64ms | ✅ فعال |
| 3 | `8.211.195.173` | `8443` | 98.71ms | ✅ فعال |
| 4 | `8.211.194.78` | `9080` | 97.96ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 271.31ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 141.81ms | ✅ فعال |
| 2 | `13.127.170.8` | `3128` | 227.05ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 133.14ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 203.12ms | ✅ فعال |
