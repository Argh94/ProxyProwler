...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:31 10-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `38.145.208.209` | `8444` | 8.98ms | ✅ فعال |
| 2 | `172.200.72.48` | `80` | 69.76ms | ✅ فعال |
| 3 | `72.37.217.3` | `4145` | 23.05ms | ✅ فعال |
| 4 | `97.74.87.226` | `80` | 169.99ms | ✅ فعال |
| 5 | `185.241.5.57` | `3128` | 191.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.120.190` | `8081` | 853.08ms | ✅ فعال |
| 2 | `174.77.111.196` | `4145` | 147.58ms | ✅ فعال |
| 3 | `45.12.151.226` | `2829` | 189.79ms | ✅ فعال |
| 4 | `104.248.203.234` | `1080` | 151.91ms | ✅ فعال |
| 5 | `213.238.168.109` | `80` | 182.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 213.28ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 229.83ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 170.21ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 168.93ms | ✅ فعال |
| 5 | `180.250.219.58` | `53281` | 255.52ms | ✅ فعال |
