...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:18 09-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `120.25.189.254` | `9098` | 246.25ms | ✅ فعال |
| 2 | `72.205.0.67` | `4145` | 93.73ms | ✅ فعال |
| 3 | `185.234.64.62` | `1082` | 81.42ms | ✅ فعال |
| 4 | `103.75.118.84` | `1080` | 157.05ms | ✅ فعال |
| 5 | `68.183.52.128` | `9081` | 11.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `120.25.189.254` | `9098` | 246.07ms | ✅ فعال |
| 2 | `36.64.27.123` | `5678` | 242.30ms | ✅ فعال |
| 3 | `47.238.60.156` | `8093` | 201.34ms | ✅ فعال |
| 4 | `216.26.237.165` | `3129` | 23.91ms | ✅ فعال |
| 5 | `52.34.243.150` | `8080` | 80.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 129.65ms | ✅ فعال |
| 2 | `209.141.62.12` | `5555` | 63.85ms | ✅ فعال |
| 3 | `195.25.20.155` | `3128` | 1111.34ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 9.25ms | ✅ فعال |
| 5 | `138.2.64.185` | `8118` | 226.46ms | ✅ فعال |
