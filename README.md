...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:02 27-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.238.134.126` | `8291` | 175.81ms | ✅ فعال |
| 2 | `142.54.232.6` | `4145` | 53.63ms | ✅ فعال |
| 3 | `142.54.239.1` | `4145` | 59.13ms | ✅ فعال |
| 4 | `51.15.253.45` | `8080` | 123.49ms | ✅ فعال |
| 5 | `101.36.104.239` | `10808` | 159.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 272.64ms | ✅ فعال |
| 2 | `198.37.98.197` | `5727` | 41.40ms | ✅ فعال |
| 3 | `90.188.92.116` | `36335` | 2249.06ms | ✅ فعال |
| 4 | `142.111.255.179` | `5468` | 48.09ms | ✅ فعال |
| 5 | `31.59.20.209` | `6787` | 110.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.130.61.61` | `8081` | 220.79ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 244.77ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 158.05ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 138.39ms | ✅ فعال |
| 5 | `103.156.17.83` | `8080` | 222.92ms | ✅ فعال |
