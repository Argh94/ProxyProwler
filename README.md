...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:45 26-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `216.26.228.94` | `3129` | 6.15ms | ✅ فعال |
| 2 | `23.175.248.21` | `1080` | 22.71ms | ✅ فعال |
| 3 | `206.123.156.204` | `8341` | 107.22ms | ✅ فعال |
| 4 | `192.111.137.34` | `18765` | 69.16ms | ✅ فعال |
| 5 | `142.54.226.214` | `4145` | 72.95ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.195.173` | `9080` | 82.06ms | ✅ فعال |
| 2 | `46.161.27.244` | `995` | 95.44ms | ✅ فعال |
| 3 | `185.226.207.252` | `5801` | 79.81ms | ✅ فعال |
| 4 | `8.220.141.8` | `8889` | 255.60ms | ✅ فعال |
| 5 | `104.143.224.149` | `6010` | 85.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 171.95ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 9.79ms | ✅ فعال |
| 3 | `188.132.221.27` | `8080` | 206.60ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 223.27ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 8.47ms | ✅ فعال |
