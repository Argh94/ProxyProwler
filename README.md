...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:57 25-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `212.183.88.28` | `80` | 18.47ms | ✅ فعال |
| 2 | `23.227.60.106` | `80` | 18.15ms | ✅ فعال |
| 3 | `184.181.217.210` | `4145` | 111.71ms | ✅ فعال |
| 4 | `104.24.69.222` | `80` | 17.51ms | ✅ فعال |
| 5 | `45.131.210.90` | `80` | 18.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `67.201.33.10` | `25283` | 58.73ms | ✅ فعال |
| 2 | `8.213.222.247` | `312` | 232.72ms | ✅ فعال |
| 3 | `188.143.169.22` | `33333` | 1230.49ms | ✅ فعال |
| 4 | `171.247.245.134` | `1080` | 202.07ms | ✅ فعال |
| 5 | `8.130.34.44` | `3128` | 662.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.179.12.21` | `50867` | 119.03ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 44.35ms | ✅ فعال |
| 3 | `54.74.104.194` | `9256` | 110.99ms | ✅ فعال |
| 4 | `44.251.173.250` | `2723` | 32.73ms | ✅ فعال |
| 5 | `3.110.127.255` | `9267` | 234.00ms | ✅ فعال |
