...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 14-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.250.244` | `80` | 1.67ms | ✅ فعال |
| 2 | `47.91.89.3` | `11` | 159.18ms | ✅ فعال |
| 3 | `184.178.172.3` | `4145` | 123.71ms | ✅ فعال |
| 4 | `45.8.211.41` | `80` | 1.99ms | ✅ فعال |
| 5 | `141.101.113.100` | `80` | 17.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.49.222` | `7302` | 212.50ms | ✅ فعال |
| 2 | `195.74.86.205` | `80` | 1180.35ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 177.66ms | ✅ فعال |
| 4 | `101.51.138.138` | `8080` | 202.86ms | ✅ فعال |
| 5 | `123.30.154.171` | `7777` | 245.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.139` | `80` | 1.72ms | ✅ فعال |
| 2 | `45.131.4.93` | `80` | 2.52ms | ✅ فعال |
| 3 | `141.101.122.238` | `80` | 19.76ms | ✅ فعال |
| 4 | `190.93.247.0` | `80` | 10.58ms | ✅ فعال |
| 5 | `104.17.26.109` | `80` | 1.76ms | ✅ فعال |
