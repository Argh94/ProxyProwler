...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 23-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.181.217.220` | `4145` | 125.74ms | ✅ فعال |
| 2 | `47.251.73.54` | `80` | 717.02ms | ✅ فعال |
| 3 | `104.21.94.248` | `80` | 2.46ms | ✅ فعال |
| 4 | `45.131.4.45` | `80` | 1.77ms | ✅ فعال |
| 5 | `5.10.244.5` | `80` | 1.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.222.120` | `80` | 191.56ms | ✅ فعال |
| 2 | `46.101.35.96` | `80` | 146.65ms | ✅ فعال |
| 3 | `8.211.42.167` | `80` | 174.38ms | ✅ فعال |
| 4 | `152.53.107.230` | `80` | 164.96ms | ✅ فعال |
| 5 | `139.162.78.109` | `8080` | 104.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.19.66.163` | `80` | 2.28ms | ✅ فعال |
| 2 | `104.17.190.13` | `80` | 1.78ms | ✅ فعال |
| 3 | `172.67.88.21` | `80` | 2.07ms | ✅ فعال |
| 4 | `206.238.236.139` | `80` | 2.20ms | ✅ فعال |
| 5 | `185.162.229.172` | `80` | 2.05ms | ✅ فعال |
