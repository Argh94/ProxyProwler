...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:15 23-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `144.76.159.120` | `1085` | 97.34ms | ✅ فعال |
| 2 | `34.44.49.215` | `80` | 27.41ms | ✅ فعال |
| 3 | `62.133.62.17` | `1081` | 94.65ms | ✅ فعال |
| 4 | `197.221.240.240` | `80` | 232.80ms | ✅ فعال |
| 5 | `206.123.156.212` | `13850` | 90.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `145.223.46.180` | `5730` | 84.38ms | ✅ فعال |
| 2 | `128.199.104.190` | `41354` | 230.48ms | ✅ فعال |
| 3 | `89.124.80.251` | `1080` | 142.43ms | ✅ فعال |
| 4 | `217.69.121.248` | `5913` | 77.00ms | ✅ فعال |
| 5 | `46.8.60.2` | `1080` | 160.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 3.33ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 2319.16ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 228.58ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 219.94ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 2.97ms | ✅ فعال |
