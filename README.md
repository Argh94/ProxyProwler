...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:57 21-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.207.193` | `80` | 2.55ms | ✅ فعال |
| 2 | `104.16.35.127` | `80` | 2.11ms | ✅ فعال |
| 3 | `172.64.148.75` | `80` | 2.20ms | ✅ فعال |
| 4 | `185.148.105.16` | `80` | 2.20ms | ✅ فعال |
| 5 | `45.8.211.246` | `80` | 2.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.56.175.170` | `5844` | 35.10ms | ✅ فعال |
| 2 | `154.6.121.128` | `6095` | 8.52ms | ✅ فعال |
| 3 | `45.128.133.253` | `1080` | 2122.06ms | ✅ فعال |
| 4 | `101.132.222.120` | `80` | 239.94ms | ✅ فعال |
| 5 | `202.40.181.220` | `31247` | 282.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.247.49` | `80` | 2.29ms | ✅ فعال |
| 2 | `69.84.182.59` | `80` | 2.26ms | ✅ فعال |
| 3 | `185.162.230.130` | `80` | 2.36ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 2.02ms | ✅ فعال |
| 5 | `141.101.122.238` | `80` | 2.41ms | ✅ فعال |
