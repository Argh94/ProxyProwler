...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 02-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `170.114.45.56` | `80` | 1.76ms | ✅ فعال |
| 2 | `104.25.55.125` | `80` | 2.14ms | ✅ فعال |
| 3 | `104.21.111.169` | `80` | 1.66ms | ✅ فعال |
| 4 | `188.42.88.253` | `80` | 3.01ms | ✅ فعال |
| 5 | `184.178.172.3` | `4145` | 125.35ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.12.31.95` | `80` | 1.67ms | ✅ فعال |
| 2 | `104.200.152.30` | `4145` | 22.98ms | ✅ فعال |
| 3 | `88.216.68.25` | `9077` | 49.08ms | ✅ فعال |
| 4 | `5.199.173.4` | `9080` | 172.28ms | ✅ فعال |
| 5 | `67.201.33.10` | `25283` | 22.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.168.235.57` | `696` | 112.79ms | ✅ فعال |
| 2 | `51.85.49.118` | `168` | 194.33ms | ✅ فعال |
| 3 | `108.137.1.116` | `26215` | 182.70ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 61.77ms | ✅ فعال |
| 5 | `102.164.252.150` | `8080` | 1341.49ms | ✅ فعال |
