...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 08-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.231.72` | `80` | 2.24ms | ✅ فعال |
| 2 | `50.114.14.55` | `6540` | 26.65ms | ✅ فعال |
| 3 | `66.42.224.229` | `41679` | 1454.59ms | ✅ فعال |
| 4 | `172.67.178.252` | `80` | 2.07ms | ✅ فعال |
| 5 | `104.25.0.232` | `80` | 1.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.254.153.78` | `999` | 155.16ms | ✅ فعال |
| 2 | `104.25.154.12` | `80` | 1.68ms | ✅ فعال |
| 3 | `39.104.62.128` | `5000` | 228.92ms | ✅ فعال |
| 4 | `8.130.54.67` | `1111` | 206.66ms | ✅ فعال |
| 5 | `159.138.252.45` | `8888` | 199.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `121.165.162.9` | `8564` | 131.32ms | ✅ فعال |
| 2 | `13.115.193.75` | `40243` | 105.68ms | ✅ فعال |
| 3 | `200.174.198.32` | `8888` | 173.72ms | ✅ فعال |
| 4 | `40.176.96.235` | `315` | 42.33ms | ✅ فعال |
| 5 | `43.217.158.81` | `27610` | 178.77ms | ✅ فعال |
