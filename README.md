...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 16:59 29-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `51.38.120.110` | `10008` | 88.68ms | ✅ فعال |
| 2 | `146.19.143.200` | `1080` | 113.70ms | ✅ فعال |
| 3 | `159.65.245.255` | `80` | 8.05ms | ✅ فعال |
| 4 | `69.61.200.104` | `36181` | 99.74ms | ✅ فعال |
| 5 | `45.74.31.25` | `7482` | 86.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `159.65.245.255` | `80` | 7.86ms | ✅ فعال |
| 2 | `185.114.89.74` | `1080` | 124.45ms | ✅ فعال |
| 3 | `198.46.137.195` | `6399` | 61.56ms | ✅ فعال |
| 4 | `8.209.96.245` | `31433` | 719.23ms | ✅ فعال |
| 5 | `103.82.20.76` | `8080` | 247.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 122.53ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 220.32ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 223.29ms | ✅ فعال |
| 4 | `217.64.149.146` | `8118` | 120.84ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 1197.80ms | ✅ فعال |
