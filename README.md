...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:16 14-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `113.204.79.230` | `9091` | 196.58ms | ✅ فعال |
| 2 | `217.182.195.221` | `30003` | 154.05ms | ✅ فعال |
| 3 | `72.11.151.159` | `6005` | 57.17ms | ✅ فعال |
| 4 | `157.230.220.25` | `4857` | 79.43ms | ✅ فعال |
| 5 | `38.145.208.170` | `8453` | 1027.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.49.86` | `5007` | 742.46ms | ✅ فعال |
| 2 | `45.59.117.163` | `8080` | 148.26ms | ✅ فعال |
| 3 | `45.43.64.222` | `6480` | 151.70ms | ✅ فعال |
| 4 | `143.42.66.91` | `80` | 168.61ms | ✅ فعال |
| 5 | `84.2.239.42` | `4153` | 204.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.59.59.122` | `8118` | 2251.99ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 172.54ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 640.00ms | ✅ فعال |
| 4 | `180.250.219.58` | `53281` | 251.47ms | ✅ فعال |
| 5 | `74.82.50.155` | `3128` | 113.23ms | ✅ فعال |
