...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:48 26-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.193.29.71` | `80` | 6.31ms | ✅ فعال |
| 2 | `104.16.106.101` | `80` | 5.91ms | ✅ فعال |
| 3 | `104.21.22.50` | `80` | 6.05ms | ✅ فعال |
| 4 | `45.43.70.100` | `6387` | 79.49ms | ✅ فعال |
| 5 | `149.14.243.178` | `10878` | 104.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.222.247` | `3000` | 888.05ms | ✅ فعال |
| 2 | `8.213.222.247` | `15` | 930.21ms | ✅ فعال |
| 3 | `192.252.208.70` | `14282` | 68.47ms | ✅ فعال |
| 4 | `1.0.0.4` | `80` | 5.97ms | ✅ فعال |
| 5 | `47.74.46.81` | `1081` | 169.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 5.71ms | ✅ فعال |
| 2 | `190.93.247.0` | `80` | 6.43ms | ✅ فعال |
| 3 | `172.67.88.21` | `80` | 6.08ms | ✅ فعال |
| 4 | `185.193.28.50` | `80` | 6.21ms | ✅ فعال |
| 5 | `202.154.18.1` | `8080` | 249.21ms | ✅ فعال |
