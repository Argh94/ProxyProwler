...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 18-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `68.71.243.14` | `4145` | 102.56ms | ✅ فعال |
| 2 | `138.199.25.13` | `3909` | 217.08ms | ✅ فعال |
| 3 | `170.114.46.121` | `80` | 1.88ms | ✅ فعال |
| 4 | `104.21.234.54` | `80` | 19.63ms | ✅ فعال |
| 5 | `104.21.225.220` | `80` | 19.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `18081` | 209.52ms | ✅ فعال |
| 2 | `157.175.196.63` | `9443` | 195.74ms | ✅ فعال |
| 3 | `39.104.79.145` | `1234` | 246.78ms | ✅ فعال |
| 4 | `198.105.111.176` | `6854` | 94.04ms | ✅ فعال |
| 5 | `49.0.252.39` | `9000` | 196.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `37.187.109.70` | `10111` | 100.92ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 241.05ms | ✅ فعال |
| 3 | `138.2.64.185` | `8118` | 1215.87ms | ✅ فعال |
| 4 | `74.82.50.155` | `3128` | 139.61ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 2269.87ms | ✅ فعال |
