...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:59 17-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `160.123.255.100` | `80` | 2.07ms | ✅ فعال |
| 2 | `41.223.119.156` | `3128` | 303.82ms | ✅ فعال |
| 3 | `192.111.129.145` | `16894` | 96.13ms | ✅ فعال |
| 4 | `104.21.233.218` | `80` | 19.16ms | ✅ فعال |
| 5 | `174.138.119.88` | `80` | 78.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `139.196.151.191` | `8090` | 201.52ms | ✅ فعال |
| 2 | `49.0.199.132` | `19` | 208.60ms | ✅ فعال |
| 3 | `39.104.16.201` | `2022` | 230.95ms | ✅ فعال |
| 4 | `39.104.62.128` | `5000` | 224.11ms | ✅ فعال |
| 5 | `45.3.36.202` | `3129` | 65.51ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.246.11.197` | `621` | 280.75ms | ✅ فعال |
| 2 | `56.228.5.197` | `26403` | 167.70ms | ✅ فعال |
| 3 | `144.125.164.222` | `8080` | 1.34ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 167.91ms | ✅ فعال |
| 5 | `185.191.236.162` | `3128` | 169.75ms | ✅ فعال |
