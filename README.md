...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 18:19 16-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.84.84.1` | `3128` | 192.31ms | ✅ فعال |
| 2 | `147.45.221.111` | `1082` | 1152.38ms | ✅ فعال |
| 3 | `47.90.149.238` | `31281` | 60.57ms | ✅ فعال |
| 4 | `45.43.81.76` | `5723` | 125.09ms | ✅ فعال |
| 5 | `173.212.245.136` | `8888` | 142.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.138.133.207` | `9080` | 208.12ms | ✅ فعال |
| 2 | `47.252.11.233` | `6379` | 54.92ms | ✅ فعال |
| 3 | `177.39.211.113` | `1080` | 2238.11ms | ✅ فعال |
| 4 | `13.125.44.24` | `80` | 138.82ms | ✅ فعال |
| 5 | `136.0.207.197` | `6774` | 27.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.7.138.78` | `80` | 115.61ms | ✅ فعال |
| 2 | `103.155.196.47` | `8181` | 195.29ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 196.67ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 183.55ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 176.33ms | ✅ فعال |
