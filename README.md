...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 04-07-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (24 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.58` | `4145` | 127.60ms | ✅ فعال |
| 2 | `94.182.146.250` | `8080` | 239.60ms | ✅ فعال |
| 3 | `45.172.176.1` | `59341` | 192.92ms | ✅ فعال |
| 4 | `47.238.60.156` | `81` | 158.48ms | ✅ فعال |
| 5 | `142.54.235.9` | `4145` | 23.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.166.219.80` | `4153` | 254.55ms | ✅ فعال |
| 2 | `1.0.0.4` | `80` | 1.67ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 219.78ms | ✅ فعال |
| 4 | `1.180.0.162` | `7302` | 214.08ms | ✅ فعال |
| 5 | `45.172.176.1` | `59341` | 192.76ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.85.134` | `80` | 1.53ms | ✅ فعال |
| 2 | `190.93.247.0` | `80` | 1.43ms | ✅ فعال |
| 3 | `172.66.40.96` | `80` | 1.47ms | ✅ فعال |
| 4 | `103.169.142.78` | `80` | 2.20ms | ✅ فعال |
| 5 | `185.162.230.130` | `80` | 1.67ms | ✅ فعال |
