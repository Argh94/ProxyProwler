...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:15 02-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `31.43.179.223` | `80` | 1.49ms | ✅ فعال |
| 2 | `23.236.255.199` | `6975` | 10.38ms | ✅ فعال |
| 3 | `104.16.104.228` | `80` | 1.93ms | ✅ فعال |
| 4 | `45.67.215.221` | `80` | 1.76ms | ✅ فعال |
| 5 | `8.213.128.6` | `1111` | 1188.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.8.60.34` | `1080` | 222.04ms | ✅ فعال |
| 2 | `178.185.221.186` | `8080` | 222.45ms | ✅ فعال |
| 3 | `192.177.87.88` | `5934` | 1.58ms | ✅ فعال |
| 4 | `8.210.59.178` | `1011` | 159.18ms | ✅ فعال |
| 5 | `47.251.74.38` | `9080` | 3.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 66.46ms | ✅ فعال |
| 2 | `45.61.139.153` | `2525` | 136.97ms | ✅ فعال |
| 3 | `109.122.17.129` | `999` | 92.78ms | ✅ فعال |
| 4 | `40.192.14.136` | `8053` | 213.41ms | ✅ فعال |
| 5 | `34.216.224.9` | `40715` | 21.94ms | ✅ فعال |
