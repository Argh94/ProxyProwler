...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:54 13-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `140.245.53.190` | `1088` | 208.60ms | ✅ فعال |
| 2 | `217.69.121.145` | `5810` | 96.93ms | ✅ فعال |
| 3 | `147.45.60.110` | `1082` | 20.22ms | ✅ فعال |
| 4 | `39.104.16.201` | `80` | 256.50ms | ✅ فعال |
| 5 | `123.58.219.171` | `10808` | 187.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.27.203.136` | `6871` | 38.43ms | ✅ فعال |
| 2 | `47.119.20.8` | `8080` | 228.75ms | ✅ فعال |
| 3 | `185.147.69.48` | `1080` | 1141.62ms | ✅ فعال |
| 4 | `98.170.57.249` | `4145` | 95.95ms | ✅ فعال |
| 5 | `39.104.16.201` | `80` | 251.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 228.17ms | ✅ فعال |
| 2 | `178.207.11.148` | `3129` | 165.59ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 223.54ms | ✅ فعال |
