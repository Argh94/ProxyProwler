...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 22-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.147.97` | `80` | 2.13ms | ✅ فعال |
| 2 | `104.25.206.4` | `80` | 2.51ms | ✅ فعال |
| 3 | `145.223.46.22` | `5572` | 76.32ms | ✅ فعال |
| 4 | `5.10.246.3` | `80` | 2.08ms | ✅ فعال |
| 5 | `5.10.244.173` | `80` | 2.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.178.72.30` | `4145` | 69.63ms | ✅ فعال |
| 2 | `185.226.204.183` | `5736` | 76.75ms | ✅ فعال |
| 3 | `104.18.1.196` | `80` | 2.50ms | ✅ فعال |
| 4 | `72.195.34.42` | `4145` | 71.04ms | ✅ فعال |
| 5 | `123.57.1.16` | `5555` | 262.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.160.134.84` | `8711` | 96.05ms | ✅ فعال |
| 2 | `56.124.106.170` | `1149` | 114.86ms | ✅ فعال |
| 3 | `43.208.240.77` | `9007` | 255.72ms | ✅ فعال |
| 4 | `43.216.1.13` | `15894` | 229.09ms | ✅ فعال |
| 5 | `51.20.192.194` | `45546` | 99.27ms | ✅ فعال |
