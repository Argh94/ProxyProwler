...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 06-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `204.217.245.200` | `6791` | 135.74ms | ✅ فعال |
| 2 | `173.245.58.101` | `80` | 8.85ms | ✅ فعال |
| 3 | `108.162.198.132` | `80` | 16.65ms | ✅ فعال |
| 4 | `172.67.181.101` | `80` | 9.36ms | ✅ فعال |
| 5 | `104.24.89.210` | `80` | 8.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.13.239.4` | `5678` | 167.19ms | ✅ فعال |
| 2 | `91.221.177.40` | `80` | 204.09ms | ✅ فعال |
| 3 | `182.160.16.234` | `8020` | 284.79ms | ✅ فعال |
| 4 | `159.138.252.45` | `8888` | 215.40ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 1209.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.60.222.217` | `395` | 225.12ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 208.75ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 50.37ms | ✅ فعال |
| 4 | `51.20.192.194` | `21507` | 155.83ms | ✅ فعال |
| 5 | `43.217.141.124` | `31833` | 180.08ms | ✅ فعال |
