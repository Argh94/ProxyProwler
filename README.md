...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:03 24-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.173.56` | `80` | 16.40ms | ✅ فعال |
| 2 | `170.114.45.251` | `80` | 8.87ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 175.16ms | ✅ فعال |
| 4 | `31.12.75.176` | `80` | 8.92ms | ✅ فعال |
| 5 | `170.114.45.162` | `80` | 9.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.194.78` | `4002` | 346.26ms | ✅ فعال |
| 2 | `101.132.252.152` | `1081` | 194.14ms | ✅ فعال |
| 3 | `210.16.86.105` | `5678` | 1254.24ms | ✅ فعال |
| 4 | `31.59.20.111` | `6689` | 127.61ms | ✅ فعال |
| 5 | `171.247.245.134` | `1080` | 188.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `217.174.106.15` | `8118` | 174.93ms | ✅ فعال |
| 2 | `104.129.194.46` | `11699` | 50.51ms | ✅ فعال |
| 3 | `3.35.25.117` | `50` | 144.98ms | ✅ فعال |
| 4 | `200.48.35.124` | `999` | 147.36ms | ✅ فعال |
| 5 | `43.217.134.46` | `3128` | 180.18ms | ✅ فعال |
