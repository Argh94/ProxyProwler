...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:58 21-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.202` | `5390` | 99.31ms | ✅ فعال |
| 2 | `206.123.156.199` | `7072` | 100.36ms | ✅ فعال |
| 3 | `147.45.60.252` | `1081` | 15.01ms | ✅ فعال |
| 4 | `91.196.35.167` | `443` | 124.55ms | ✅ فعال |
| 5 | `8.221.141.88` | `1027` | 160.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.54.228.193` | `4145` | 76.25ms | ✅ فعال |
| 2 | `193.106.250.227` | `8443` | 8.28ms | ✅ فعال |
| 3 | `78.159.131.112` | `1081` | 120.18ms | ✅ فعال |
| 4 | `82.132.19.108` | `4153` | 111.00ms | ✅ فعال |
| 5 | `31.13.239.4` | `5678` | 1178.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.62.179.122` | `8080` | 1069.57ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 231.26ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 240.76ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 2.59ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 115.89ms | ✅ فعال |
