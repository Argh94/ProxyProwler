...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:00 04-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.134.147` | `80` | 13.10ms | ✅ فعال |
| 2 | `216.26.225.205` | `3129` | 15.71ms | ✅ فعال |
| 3 | `104.21.9.202` | `80` | 2.34ms | ✅ فعال |
| 4 | `13.80.134.180` | `80` | 95.04ms | ✅ فعال |
| 5 | `146.103.3.108` | `7161` | 91.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.252.152` | `1081` | 231.80ms | ✅ فعال |
| 2 | `146.103.3.108` | `7161` | 93.64ms | ✅ فعال |
| 3 | `123.57.1.16` | `5555` | 241.14ms | ✅ فعال |
| 4 | `49.0.252.39` | `9000` | 193.89ms | ✅ فعال |
| 5 | `139.99.237.62` | `80` | 211.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `190.12.150.244` | `999` | 91.39ms | ✅ فعال |
| 2 | `43.208.129.50` | `8830` | 234.24ms | ✅ فعال |
| 3 | `47.116.210.100` | `3128` | 226.90ms | ✅ فعال |
| 4 | `3.35.25.117` | `891` | 169.40ms | ✅ فعال |
| 5 | `13.212.81.49` | `957` | 208.95ms | ✅ فعال |
