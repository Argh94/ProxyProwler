...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 01-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.66.46.120` | `80` | 1.91ms | ✅ فعال |
| 2 | `8.219.234.213` | `1011` | 204.04ms | ✅ فعال |
| 3 | `104.17.92.87` | `80` | 2.57ms | ✅ فعال |
| 4 | `104.25.104.237` | `80` | 1.99ms | ✅ فعال |
| 5 | `104.17.235.79` | `80` | 2.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.174.4.6` | `5975` | 14.51ms | ✅ فعال |
| 2 | `102.68.87.48` | `8888` | 256.04ms | ✅ فعال |
| 3 | `110.238.116.82` | `55443` | 264.79ms | ✅ فعال |
| 4 | `8.213.156.191` | `1080` | 875.45ms | ✅ فعال |
| 5 | `202.166.219.80` | `4153` | 245.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.59.97.103` | `15536` | 11.21ms | ✅ فعال |
| 2 | `123.57.0.163` | `8888` | 236.63ms | ✅ فعال |
| 3 | `16.78.104.244` | `9091` | 222.68ms | ✅ فعال |
| 4 | `152.53.171.242` | `12629` | 17.44ms | ✅ فعال |
| 5 | `3.122.235.189` | `9507` | 108.38ms | ✅ فعال |
