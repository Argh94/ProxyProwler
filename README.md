...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 07-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.7.160` | `80` | 2.25ms | ✅ فعال |
| 2 | `192.252.216.81` | `4145` | 107.27ms | ✅ فعال |
| 3 | `45.159.218.137` | `80` | 3.03ms | ✅ فعال |
| 4 | `104.16.109.57` | `80` | 2.39ms | ✅ فعال |
| 5 | `192.252.216.86` | `4145` | 89.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `134.209.29.120` | `80` | 92.63ms | ✅ فعال |
| 2 | `47.254.153.78` | `999` | 106.63ms | ✅ فعال |
| 3 | `104.18.40.27` | `80` | 2.89ms | ✅ فعال |
| 4 | `80.254.50.71` | `3629` | 137.29ms | ✅ فعال |
| 5 | `68.71.252.38` | `4145` | 94.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.152.54.1` | `10061` | 150.23ms | ✅ فعال |
| 2 | `43.217.136.176` | `8007` | 216.43ms | ✅ فعال |
| 3 | `193.95.53.131` | `8077` | 129.35ms | ✅ فعال |
| 4 | `131.100.48.73` | `999` | 92.20ms | ✅ فعال |
| 5 | `78.12.220.164` | `8428` | 51.36ms | ✅ فعال |
