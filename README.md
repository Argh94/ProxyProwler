...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 17-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `147.185.161.193` | `80` | 1.99ms | ✅ فعال |
| 2 | `203.30.188.224` | `80` | 2.49ms | ✅ فعال |
| 3 | `185.176.26.217` | `80` | 2.65ms | ✅ فعال |
| 4 | `104.16.1.214` | `80` | 2.20ms | ✅ فعال |
| 5 | `69.84.182.244` | `80` | 2.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.190.8.59` | `1088` | 246.58ms | ✅ فعال |
| 2 | `184.178.172.13` | `15311` | 68.15ms | ✅ فعال |
| 3 | `182.160.16.234` | `8020` | 235.56ms | ✅ فعال |
| 4 | `47.254.36.213` | `5060` | 69.59ms | ✅ فعال |
| 5 | `47.107.166.143` | `8008` | 266.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 3.06ms | ✅ فعال |
| 2 | `13.246.35.124` | `258` | 213.65ms | ✅ فعال |
| 3 | `51.85.49.118` | `50918` | 130.48ms | ✅ فعال |
| 4 | `43.217.158.81` | `10513` | 224.83ms | ✅ فعال |
| 5 | `157.175.196.63` | `182` | 168.31ms | ✅ فعال |
