...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:34 06-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.138.111` | `111` | 158.82ms | ✅ فعال |
| 2 | `98.175.31.195` | `4145` | 88.37ms | ✅ فعال |
| 3 | `157.230.220.25` | `4857` | 15.99ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 222.89ms | ✅ فعال |
| 5 | `45.167.124.52` | `8080` | 70.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.210.233` | `4145` | 66.24ms | ✅ فعال |
| 2 | `8.209.96.245` | `9080` | 89.29ms | ✅ فعال |
| 3 | `156.146.56.231` | `8081` | 221.35ms | ✅ فعال |
| 4 | `162.220.246.99` | `6383` | 80.00ms | ✅ فعال |
| 5 | `31.59.33.175` | `6751` | 80.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 223.14ms | ✅ فعال |
| 2 | `94.23.19.184` | `2912` | 1149.79ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 2272.45ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 272.33ms | ✅ فعال |
