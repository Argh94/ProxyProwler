...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:53 05-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.85.118.124` | `80` | 1.85ms | ✅ فعال |
| 2 | `156.225.72.66` | `80` | 6.80ms | ✅ فعال |
| 3 | `45.12.30.88` | `80` | 1.88ms | ✅ فعال |
| 4 | `172.67.196.58` | `80` | 1.97ms | ✅ فعال |
| 5 | `192.187.111.82` | `17025` | 33.90ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `136.0.126.39` | `5800` | 61.41ms | ✅ فعال |
| 2 | `39.101.65.228` | `81` | 259.79ms | ✅ فعال |
| 3 | `67.227.112.246` | `6286` | 66.47ms | ✅ فعال |
| 4 | `152.67.221.233` | `9050` | 181.48ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 119.82ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.114` | `80` | 1.96ms | ✅ فعال |
| 2 | `172.67.181.33` | `80` | 2.06ms | ✅ فعال |
| 3 | `45.131.7.142` | `80` | 1.73ms | ✅ فعال |
| 4 | `104.17.25.3` | `80` | 6.37ms | ✅ فعال |
| 5 | `185.148.104.15` | `80` | 1.95ms | ✅ فعال |
