...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:29 12-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `20.127.128.70` | `8080` | 68.87ms | ✅ فعال |
| 2 | `103.146.137.13` | `1081` | 257.57ms | ✅ فعال |
| 3 | `206.123.156.217` | `10807` | 177.15ms | ✅ فعال |
| 4 | `185.226.207.128` | `5677` | 140.38ms | ✅ فعال |
| 5 | `24.249.199.4` | `4145` | 296.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.46.152.18` | `1080` | 1241.56ms | ✅ فعال |
| 2 | `185.226.207.128` | `5677` | 140.57ms | ✅ فعال |
| 3 | `184.181.217.201` | `4145` | 368.53ms | ✅ فعال |
| 4 | `161.123.5.81` | `5130` | 53.01ms | ✅ فعال |
| 5 | `45.43.70.225` | `6512` | 145.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 174.84ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 186.55ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 127.33ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 172.15ms | ✅ فعال |
| 5 | `190.7.138.78` | `80` | 123.73ms | ✅ فعال |
