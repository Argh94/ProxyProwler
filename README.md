...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:00 19-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `120.92.211.211` | `7890` | 1281.83ms | ✅ فعال |
| 2 | `98.182.171.161` | `4145` | 72.21ms | ✅ فعال |
| 3 | `184.178.172.13` | `15311` | 74.15ms | ✅ فعال |
| 4 | `202.129.206.239` | `3128` | 252.18ms | ✅ فعال |
| 5 | `83.219.250.8` | `62920` | 100.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `184.178.172.25` | `15291` | 73.47ms | ✅ فعال |
| 2 | `50.114.15.99` | `6084` | 69.03ms | ✅ فعال |
| 3 | `70.166.167.55` | `57745` | 72.68ms | ✅ فعال |
| 4 | `47.91.121.127` | `6379` | 182.84ms | ✅ فعال |
| 5 | `8.209.249.96` | `808` | 158.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `14.143.222.113` | `10168` | 249.15ms | ✅ فعال |
| 2 | `38.60.196.214` | `80` | 81.18ms | ✅ فعال |
| 3 | `4.195.16.140` | `80` | 186.01ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 190.71ms | ✅ فعال |
| 5 | `39.109.113.97` | `4090` | 214.29ms | ✅ فعال |
