...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:39 27-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `221.231.13.198` | `1080` | 194.99ms | ✅ فعال |
| 2 | `47.237.116.215` | `1080` | 171.21ms | ✅ فعال |
| 3 | `175.101.240.38` | `80` | 214.93ms | ✅ فعال |
| 4 | `206.123.156.195` | `5112` | 367.30ms | ✅ فعال |
| 5 | `206.123.156.236` | `10535` | 168.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `109.232.106.150` | `52435` | 182.89ms | ✅ فعال |
| 2 | `124.6.225.124` | `1088` | 1243.27ms | ✅ فعال |
| 3 | `199.229.254.129` | `4145` | 100.24ms | ✅ فعال |
| 4 | `47.254.36.213` | `8080` | 1.85ms | ✅ فعال |
| 5 | `185.221.213.168` | `1080` | 1245.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 68.00ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 66.90ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 176.20ms | ✅ فعال |
| 4 | `102.164.252.150` | `8080` | 1289.43ms | ✅ فعال |
| 5 | `203.128.75.194` | `8080` | 1188.38ms | ✅ فعال |
