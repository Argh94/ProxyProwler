...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:54 05-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.0.63` | `80` | 15.01ms | ✅ فعال |
| 2 | `194.152.44.214` | `80` | 12.65ms | ✅ فعال |
| 3 | `23.227.60.211` | `80` | 15.27ms | ✅ فعال |
| 4 | `185.148.104.18` | `80` | 14.42ms | ✅ فعال |
| 5 | `45.131.7.207` | `80` | 15.18ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `5060` | 186.30ms | ✅ فعال |
| 2 | `31.43.179.180` | `80` | 9.84ms | ✅ فعال |
| 3 | `8.220.204.215` | `8889` | 157.28ms | ✅ فعال |
| 4 | `47.237.2.245` | `9098` | 200.27ms | ✅ فعال |
| 5 | `110.238.109.146` | `19` | 201.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `3.35.25.117` | `216` | 160.20ms | ✅ فعال |
| 2 | `157.175.43.137` | `8334` | 201.34ms | ✅ فعال |
| 3 | `218.89.134.230` | `3333` | 1316.87ms | ✅ فعال |
| 4 | `144.124.227.90` | `10808` | 111.16ms | ✅ فعال |
| 5 | `3.110.127.255` | `5534` | 226.32ms | ✅ فعال |
