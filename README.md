...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:13 16-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 166.71ms | ✅ فعال |
| 2 | `45.131.210.235` | `80` | 1.72ms | ✅ فعال |
| 3 | `124.108.6.20` | `8085` | 193.52ms | ✅ فعال |
| 4 | `185.148.104.233` | `80` | 1.53ms | ✅ فعال |
| 5 | `185.176.26.156` | `80` | 1.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.83.112.49` | `1080` | 158.84ms | ✅ فعال |
| 2 | `8.221.141.88` | `9500` | 104.72ms | ✅ فعال |
| 3 | `101.132.248.7` | `1337` | 206.35ms | ✅ فعال |
| 4 | `106.15.137.41` | `50` | 190.12ms | ✅ فعال |
| 5 | `50.238.47.86` | `32100` | 1092.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.36.243.194` | `9239` | 144.71ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 192.57ms | ✅ فعال |
| 3 | `160.20.55.230` | `8080` | 158.58ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 72.51ms | ✅ فعال |
| 5 | `164.163.42.60` | `10000` | 191.27ms | ✅ فعال |
