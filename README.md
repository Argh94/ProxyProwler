...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:11 11-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.182.240.211` | `4145` | 79.23ms | ✅ فعال |
| 2 | `173.214.176.13` | `5984` | 48.15ms | ✅ فعال |
| 3 | `18.138.102.128` | `3128` | 195.93ms | ✅ فعال |
| 4 | `155.254.38.122` | `5798` | 98.38ms | ✅ فعال |
| 5 | `91.98.86.26` | `8888` | 125.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `124.6.225.124` | `1088` | 1300.45ms | ✅ فعال |
| 2 | `72.37.217.3` | `4145` | 62.59ms | ✅ فعال |
| 3 | `198.105.122.206` | `6779` | 105.38ms | ✅ فعال |
| 4 | `185.226.204.89` | `5642` | 107.48ms | ✅ فعال |
| 5 | `8.213.128.6` | `8080` | 193.52ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 152.82ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 23.57ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 214.26ms | ✅ فعال |
| 4 | `203.174.15.83` | `8080` | 2238.75ms | ✅ فعال |
| 5 | `209.141.62.12` | `5555` | 47.43ms | ✅ فعال |
