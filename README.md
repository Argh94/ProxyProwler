...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 23-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.44.184` | `80` | 2.03ms | ✅ فعال |
| 2 | `199.34.228.52` | `80` | 2.77ms | ✅ فعال |
| 3 | `104.18.18.142` | `80` | 2.19ms | ✅ فعال |
| 4 | `187.63.9.62` | `63253` | 118.14ms | ✅ فعال |
| 5 | `142.54.229.249` | `4145` | 91.15ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.165.28` | `1080` | 1176.57ms | ✅ فعال |
| 2 | `133.18.234.13` | `80` | 167.27ms | ✅ فعال |
| 3 | `38.51.243.173` | `5678` | 80.00ms | ✅ فعال |
| 4 | `46.47.197.210` | `3128` | 114.41ms | ✅ فعال |
| 5 | `146.103.56.164` | `5712` | 75.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.85.134` | `80` | 2.27ms | ✅ فعال |
| 2 | `188.114.96.63` | `80` | 2.49ms | ✅ فعال |
| 3 | `104.16.0.165` | `80` | 2.31ms | ✅ فعال |
| 4 | `104.24.197.20` | `80` | 2.33ms | ✅ فعال |
| 5 | `206.238.236.139` | `80` | 2.39ms | ✅ فعال |
