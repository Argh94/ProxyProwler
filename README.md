...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:03 30-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `117.175.168.195` | `1080` | 190.49ms | ✅ فعال |
| 2 | `206.123.156.231` | `15558` | 1187.39ms | ✅ فعال |
| 3 | `109.71.244.97` | `1080` | 144.30ms | ✅ فعال |
| 4 | `69.61.200.104` | `36181` | 137.47ms | ✅ فعال |
| 5 | `197.221.240.176` | `80` | 293.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.170.57.231` | `4145` | 113.22ms | ✅ فعال |
| 2 | `39.104.27.89` | `10000` | 214.54ms | ✅ فعال |
| 3 | `176.99.134.183` | `8090` | 1200.21ms | ✅ فعال |
| 4 | `31.13.239.4` | `5678` | 1234.60ms | ✅ فعال |
| 5 | `198.105.100.219` | `6470` | 136.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 180.73ms | ✅ فعال |
| 2 | `210.201.86.72` | `8080` | 140.69ms | ✅ فعال |
| 3 | `103.191.165.9` | `8080` | 185.42ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 185.01ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 73.40ms | ✅ فعال |
