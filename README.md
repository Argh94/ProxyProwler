...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 19:11 01-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.1.216` | `80` | 2.80ms | ✅ فعال |
| 2 | `104.25.7.36` | `80` | 2.39ms | ✅ فعال |
| 3 | `45.194.53.131` | `80` | 2.57ms | ✅ فعال |
| 4 | `104.19.72.47` | `80` | 2.70ms | ✅ فعال |
| 5 | `45.194.53.141` | `80` | 1.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `202.40.181.220` | `31247` | 259.65ms | ✅ فعال |
| 2 | `51.15.228.52` | `8080` | 104.45ms | ✅ فعال |
| 3 | `1.180.49.222` | `7302` | 260.10ms | ✅ فعال |
| 4 | `46.202.71.118` | `6113` | 50.78ms | ✅ فعال |
| 5 | `101.200.158.109` | `3128` | 244.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.26.109` | `80` | 2.61ms | ✅ فعال |
| 2 | `104.17.247.188` | `80` | 2.67ms | ✅ فعال |
| 3 | `94.130.177.190` | `9999` | 108.67ms | ✅ فعال |
| 4 | `172.66.40.96` | `80` | 2.57ms | ✅ فعال |
| 5 | `172.67.181.33` | `80` | 2.29ms | ✅ فعال |
