...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:01 21-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.74.46.81` | `9098` | 700.42ms | ✅ فعال |
| 2 | `47.237.92.86` | `1081` | 220.56ms | ✅ فعال |
| 3 | `104.21.21.220` | `80` | 2.00ms | ✅ فعال |
| 4 | `45.131.5.119` | `80` | 1.95ms | ✅ فعال |
| 5 | `45.131.4.123` | `80` | 1.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.41.33` | `5080` | 189.21ms | ✅ فعال |
| 2 | `182.160.16.234` | `8020` | 294.96ms | ✅ فعال |
| 3 | `177.85.65.177` | `4153` | 206.08ms | ✅ فعال |
| 4 | `173.244.41.142` | `6326` | 76.83ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 159.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 152.63ms | ✅ فعال |
| 2 | `40.176.96.235` | `1234` | 40.53ms | ✅ فعال |
| 3 | `18.163.49.218` | `304` | 156.15ms | ✅ فعال |
| 4 | `3.249.110.142` | `5975` | 136.32ms | ✅ فعال |
| 5 | `43.208.129.50` | `9252` | 197.63ms | ✅ فعال |
