...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:33 11-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `138.199.25.13` | `3909` | 197.37ms | ✅ فعال |
| 2 | `103.113.70.189` | `1081` | 32.19ms | ✅ فعال |
| 3 | `41.191.203.161` | `80` | 255.92ms | ✅ فعال |
| 4 | `153.0.171.163` | `8085` | 233.04ms | ✅ فعال |
| 5 | `198.105.122.111` | `6684` | 101.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `205.209.118.30` | `3138` | 34.92ms | ✅ فعال |
| 2 | `8.209.68.1` | `8081` | 119.14ms | ✅ فعال |
| 3 | `8.146.200.53` | `80` | 228.46ms | ✅ فعال |
| 4 | `206.220.175.2` | `4145` | 86.07ms | ✅ فعال |
| 5 | `39.104.57.33` | `34567` | 236.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `4.195.16.140` | `80` | 174.61ms | ✅ فعال |
| 2 | `179.255.219.182` | `8080` | 205.15ms | ✅ فعال |
| 3 | `61.72.221.94` | `3128` | 171.88ms | ✅ فعال |
| 4 | `23.247.136.254` | `80` | 50.00ms | ✅ فعال |
| 5 | `34.44.49.215` | `80` | 20.02ms | ✅ فعال |
