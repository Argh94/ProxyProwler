...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:15 13-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `93.190.141.182` | `11968` | 89.04ms | ✅ فعال |
| 2 | `35.225.22.61` | `80` | 25.62ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 217.13ms | ✅ فعال |
| 4 | `47.6.9.54` | `80` | 57.37ms | ✅ فعال |
| 5 | `65.108.159.129` | `8081` | 114.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.58` | `4145` | 127.28ms | ✅ فعال |
| 2 | `92.42.8.22` | `4153` | 1149.31ms | ✅ فعال |
| 3 | `14.63.49.131` | `4145` | 186.12ms | ✅ فعال |
| 4 | `184.181.217.213` | `4145` | 72.29ms | ✅ فعال |
| 5 | `98.170.57.231` | `4145` | 66.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `20.81.205.173` | `80` | 2072.18ms | ✅ فعال |
| 2 | `45.59.186.60` | `80` | 62.30ms | ✅ فعال |
| 3 | `34.14.143.185` | `3128` | 222.70ms | ✅ فعال |
| 4 | `185.161.251.214` | `443` | 95.22ms | ✅ فعال |
| 5 | `14.143.222.113` | `10168` | 256.54ms | ✅ فعال |
