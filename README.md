...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 01:33 17-06-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (96 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.190.53` | `80` | 2.37ms | ✅ فعال |
| 2 | `72.195.114.184` | `4145` | 126.94ms | ✅ فعال |
| 3 | `45.159.216.111` | `80` | 1.82ms | ✅ فعال |
| 4 | `24.249.199.4` | `4145` | 129.33ms | ✅ فعال |
| 5 | `1.180.0.162` | `7302` | 209.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.96.245` | `5060` | 154.13ms | ✅ فعال |
| 2 | `206.206.122.114` | `5745` | 18.78ms | ✅ فعال |
| 3 | `45.61.188.134` | `44499` | 66.27ms | ✅ فعال |
| 4 | `122.116.125.115` | `8888` | 135.55ms | ✅ فعال |
| 5 | `8.211.195.173` | `10000` | 146.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 72.55ms | ✅ فعال |
| 2 | `45.131.211.217` | `80` | 1.58ms | ✅ فعال |
| 3 | `45.12.31.28` | `80` | 1.89ms | ✅ فعال |
| 4 | `195.245.221.183` | `80` | 1.82ms | ✅ فعال |
| 5 | `104.16.1.135` | `80` | 1.60ms | ✅ فعال |
