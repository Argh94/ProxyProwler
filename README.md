...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:11 04-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `204.69.207.109` | `80` | 15.06ms | ✅ فعال |
| 2 | `104.16.1.98` | `80` | 16.70ms | ✅ فعال |
| 3 | `104.17.148.22` | `80` | 13.17ms | ✅ فعال |
| 4 | `154.29.232.77` | `6737` | 35.71ms | ✅ فعال |
| 5 | `160.153.1.124` | `80` | 15.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.253.237` | `8499` | 133.44ms | ✅ فعال |
| 2 | `5.199.169.254` | `9081` | 129.97ms | ✅ فعال |
| 3 | `39.104.62.128` | `5000` | 241.22ms | ✅ فعال |
| 4 | `46.250.251.246` | `8080` | 159.72ms | ✅ فعال |
| 5 | `212.114.194.78` | `80` | 2197.59ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `54.74.104.194` | `183` | 104.66ms | ✅ فعال |
| 2 | `40.177.211.224` | `181` | 71.09ms | ✅ فعال |
| 3 | `18.179.12.21` | `34714` | 133.76ms | ✅ فعال |
| 4 | `43.216.1.13` | `8016` | 202.77ms | ✅ فعال |
| 5 | `43.208.16.199` | `596` | 221.13ms | ✅ فعال |
