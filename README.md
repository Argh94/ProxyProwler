...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:13 28-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.56.110.204` | `8989` | 176.68ms | ✅ فعال |
| 2 | `74.176.195.135` | `80` | 134.09ms | ✅ فعال |
| 3 | `202.141.161.53` | `10808` | 228.95ms | ✅ فعال |
| 4 | `38.145.220.8` | `8443` | 2065.42ms | ✅ فعال |
| 5 | `34.44.49.215` | `80` | 25.17ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.12.112.16` | `5027` | 48.12ms | ✅ فعال |
| 2 | `8.211.195.173` | `20002` | 111.01ms | ✅ فعال |
| 3 | `8.211.42.167` | `104` | 122.18ms | ✅ فعال |
| 4 | `121.126.185.63` | `25152` | 283.76ms | ✅ فعال |
| 5 | `47.89.159.212` | `11` | 27.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `146.190.232.76` | `3128` | 1148.66ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 198.92ms | ✅ فعال |
| 3 | `45.119.85.216` | `3128` | 1825.91ms | ✅ فعال |
| 4 | `36.64.162.194` | `8080` | 1284.85ms | ✅ فعال |
