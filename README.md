...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:19 26-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.254` | `34573` | 85.94ms | ✅ فعال |
| 2 | `158.178.198.31` | `1080` | 85.21ms | ✅ فعال |
| 3 | `106.12.167.86` | `10808` | 1299.04ms | ✅ فعال |
| 4 | `184.182.240.211` | `4145` | 86.04ms | ✅ فعال |
| 5 | `216.68.128.121` | `4145` | 132.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `145.241.117.33` | `8888` | 177.09ms | ✅ فعال |
| 2 | `45.39.115.52` | `5463` | 35.72ms | ✅ فعال |
| 3 | `168.232.213.9` | `4153` | 110.68ms | ✅ فعال |
| 4 | `45.39.4.57` | `5482` | 35.48ms | ✅ فعال |
| 5 | `107.181.168.145` | `4145` | 72.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.234.217.85` | `999` | 2171.27ms | ✅ فعال |
| 2 | `45.70.236.194` | `999` | 1088.87ms | ✅ فعال |
| 3 | `47.74.226.8` | `5001` | 225.70ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 232.20ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 2.85ms | ✅ فعال |
