...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:23 05-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.114.103` | `80` | 2.66ms | ✅ فعال |
| 2 | `141.101.115.160` | `80` | 3.04ms | ✅ فعال |
| 3 | `104.16.218.187` | `80` | 2.90ms | ✅ فعال |
| 4 | `107.181.154.30` | `5708` | 76.58ms | ✅ فعال |
| 5 | `104.18.14.76` | `80` | 2.38ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.221.203.121` | `8080` | 105.27ms | ✅ فعال |
| 2 | `107.181.154.30` | `5708` | 76.52ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 117.41ms | ✅ فعال |
| 4 | `84.21.172.174` | `8080` | 129.05ms | ✅ فعال |
| 5 | `5.199.173.103` | `9081` | 108.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.168.235.57` | `8057` | 169.41ms | ✅ فعال |
| 2 | `43.216.1.13` | `8016` | 224.00ms | ✅ فعال |
| 3 | `27.34.242.98` | `80` | 251.89ms | ✅ فعال |
| 4 | `94.130.177.190` | `9999` | 94.73ms | ✅ فعال |
| 5 | `45.70.236.194` | `999` | 92.42ms | ✅ فعال |
