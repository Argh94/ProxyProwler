...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 02:33 12-06-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (97 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.206.118.249` | `6487` | 18.75ms | ✅ فعال |
| 2 | `172.67.70.248` | `80` | 66.03ms | ✅ فعال |
| 3 | `62.72.166.194` | `80` | 1.95ms | ✅ فعال |
| 4 | `31.43.179.131` | `80` | 1.91ms | ✅ فعال |
| 5 | `72.195.34.35` | `27360` | 126.21ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.210.17.35` | `8444` | 160.92ms | ✅ فعال |
| 2 | `190.2.134.118` | `14830` | 151.99ms | ✅ فعال |
| 3 | `195.175.22.194` | `5678` | 2223.57ms | ✅ فعال |
| 4 | `103.158.252.67` | `80` | 192.58ms | ✅ فعال |
| 5 | `1.20.227.66` | `4145` | 214.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.247.188` | `80` | 66.18ms | ✅ فعال |
| 2 | `62.72.166.211` | `80` | 1.75ms | ✅ فعال |
| 3 | `141.101.122.238` | `80` | 66.95ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 72.76ms | ✅ فعال |
| 5 | `190.93.247.0` | `80` | 1.93ms | ✅ فعال |
