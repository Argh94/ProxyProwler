...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:00 24-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.138.119.88` | `80` | 47.63ms | ✅ فعال |
| 2 | `31.43.179.22` | `80` | 11.82ms | ✅ فعال |
| 3 | `45.131.210.57` | `80` | 15.48ms | ✅ فعال |
| 4 | `138.199.25.13` | `3909` | 2246.62ms | ✅ فعال |
| 5 | `104.17.67.73` | `80` | 14.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.23.104.251` | `1080` | 1201.94ms | ✅ فعال |
| 2 | `8.212.177.126` | `8080` | 214.83ms | ✅ فعال |
| 3 | `49.0.252.39` | `9000` | 186.91ms | ✅ فعال |
| 4 | `5.199.166.248` | `9115` | 194.35ms | ✅ فعال |
| 5 | `47.113.219.226` | `59394` | 227.67ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.236.38.248` | `20835` | 116.84ms | ✅ فعال |
| 2 | `13.61.18.44` | `8999` | 128.58ms | ✅ فعال |
| 3 | `47.237.2.245` | `119` | 198.27ms | ✅ فعال |
| 4 | `15.160.148.69` | `33153` | 126.46ms | ✅ فعال |
| 5 | `157.175.197.28` | `8801` | 199.77ms | ✅ فعال |
