...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 17:09 04-07-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.252.18.37` | `8083` | 5.97ms | ✅ فعال |
| 2 | `101.32.60.93` | `1080` | 202.93ms | ✅ فعال |
| 3 | `79.110.122.220` | `1080` | 120.45ms | ✅ فعال |
| 4 | `72.207.33.64` | `4145` | 92.68ms | ✅ فعال |
| 5 | `45.74.31.42` | `4716` | 1137.09ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.45.126.128` | `8080` | 122.66ms | ✅ فعال |
| 2 | `185.32.4.126` | `4153` | 1163.26ms | ✅ فعال |
| 3 | `8.213.128.6` | `8080` | 552.76ms | ✅ فعال |
| 4 | `202.166.219.80` | `4153` | 262.36ms | ✅ فعال |
| 5 | `182.184.30.96` | `8080` | 1247.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `154.73.29.65` | `8080` | 1174.48ms | ✅ فعال |
| 2 | `223.25.100.42` | `2222` | 1303.08ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 244.75ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 117.45ms | ✅ فعال |
| 5 | `185.196.182.22` | `8080` | 122.08ms | ✅ فعال |
