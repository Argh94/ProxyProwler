...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:25 19-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.67` | `14287` | 95.25ms | ✅ فعال |
| 2 | `98.178.72.21` | `10919` | 110.57ms | ✅ فعال |
| 3 | `66.42.224.229` | `41679` | 137.03ms | ✅ فعال |
| 4 | `136.0.184.100` | `6521` | 11.88ms | ✅ فعال |
| 5 | `8.213.156.191` | `1080` | 130.88ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `147.15.17.132` | `1081` | 171.78ms | ✅ فعال |
| 2 | `8.211.42.167` | `9098` | 156.10ms | ✅ فعال |
| 3 | `79.106.170.126` | `4145` | 1235.83ms | ✅ فعال |
| 4 | `140.245.238.56` | `53` | 217.74ms | ✅ فعال |
| 5 | `8.213.156.191` | `1080` | 131.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.172.212.233` | `8080` | 1281.93ms | ✅ فعال |
| 2 | `79.121.102.227` | `8080` | 170.44ms | ✅ فعال |
| 3 | `185.196.182.22` | `8080` | 177.16ms | ✅ فعال |
| 4 | `165.232.119.106` | `8080` | 157.55ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 72.56ms | ✅ فعال |
