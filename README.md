...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:11 06-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.202` | `7172` | 109.61ms | ✅ فعال |
| 2 | `47.91.29.151` | `4002` | 159.92ms | ✅ فعال |
| 3 | `171.250.222.240` | `1080` | 234.95ms | ✅ فعال |
| 4 | `103.42.228.19` | `1080` | 233.60ms | ✅ فعال |
| 5 | `178.250.187.25` | `29713` | 89.61ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `178.220.148.82` | `10801` | 121.76ms | ✅ فعال |
| 2 | `45.3.36.67` | `3129` | 5.52ms | ✅ فعال |
| 3 | `8.211.194.85` | `9999` | 82.15ms | ✅ فعال |
| 4 | `31.148.207.153` | `80` | 123.81ms | ✅ فعال |
| 5 | `40.89.145.14` | `80` | 81.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 7.47ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 170.46ms | ✅ فعال |
| 3 | `139.59.59.122` | `8118` | 207.69ms | ✅ فعال |
| 4 | `195.25.20.155` | `3128` | 1105.10ms | ✅ فعال |
| 5 | `158.101.175.124` | `5566` | 87.84ms | ✅ فعال |
