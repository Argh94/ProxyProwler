...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:47 14-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `8.209.255.13` | `3128` | 146.91ms | ✅ فعال |
| 2 | `185.130.225.170` | `8080` | 223.98ms | ✅ فعال |
| 3 | `113.212.111.4` | `8090` | 248.34ms | ✅ فعال |
| 4 | `203.30.188.224` | `80` | 5.25ms | ✅ فعال |
| 5 | `121.204.158.249` | `3128` | 2294.49ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (64 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `179.61.166.174` | `6597` | 49.87ms | ✅ فعال |
| 2 | `213.19.205.18` | `54321` | 100.77ms | ✅ فعال |
| 3 | `120.79.7.173` | `8499` | 253.29ms | ✅ فعال |
| 4 | `49.0.246.130` | `6789` | 188.05ms | ✅ فعال |
| 5 | `136.0.194.2` | `6739` | 3.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.95.242.79` | `3128` | 36.83ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 205.75ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 139.10ms | ✅ فعال |
| 4 | `185.191.236.162` | `3128` | 110.93ms | ✅ فعال |
| 5 | `23.88.88.102` | `80` | 113.52ms | ✅ فعال |
