...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 20:14 09-06-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `51.83.226.103` | `9055` | 102.97ms | ✅ فعال |
| 2 | `169.155.50.87` | `1080` | 3.97ms | ✅ فعال |
| 3 | `37.34.72.240` | `4145` | 2308.68ms | ✅ فعال |
| 4 | `101.96.219.251` | `44054` | 253.69ms | ✅ فعال |
| 5 | `47.238.134.126` | `4002` | 210.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `12.50.107.219` | `80` | 30.42ms | ✅ فعال |
| 2 | `161.123.5.174` | `5223` | 23.42ms | ✅ فعال |
| 3 | `46.202.78.241` | `8503` | 19.97ms | ✅ فعال |
| 4 | `31.59.20.53` | `6631` | 78.99ms | ✅ فعال |
| 5 | `142.147.132.93` | `6288` | 3.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 250.02ms | ✅ فعال |
| 2 | `114.130.175.18` | `8080` | 1278.09ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 158.37ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 120.85ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 223.26ms | ✅ فعال |
