...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:40 20-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `40.89.145.14` | `80` | 146.15ms | ✅ فعال |
| 2 | `141.253.118.174` | `80` | 138.23ms | ✅ فعال |
| 3 | `193.43.159.200` | `80` | 191.88ms | ✅ فعال |
| 4 | `150.107.140.238` | `3128` | 174.45ms | ✅ فعال |
| 5 | `12.50.107.219` | `80` | 77.19ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.42` | `4145` | 153.93ms | ✅ فعال |
| 2 | `203.188.245.98` | `52837` | 2280.90ms | ✅ فعال |
| 3 | `4.213.98.253` | `80` | 214.96ms | ✅ فعال |
| 4 | `155.254.38.52` | `5728` | 142.25ms | ✅ فعال |
| 5 | `213.165.185.211` | `4153` | 1236.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.83` | `8080` | 174.11ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 174.93ms | ✅ فعال |
| 3 | `177.234.217.82` | `999` | 137.22ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 160.65ms | ✅ فعال |
| 5 | `220.128.223.136` | `8082` | 131.74ms | ✅ فعال |
