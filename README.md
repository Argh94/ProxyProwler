...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:29 13-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `200.33.20.25` | `80` | 226.27ms | ✅ فعال |
| 2 | `103.84.95.54` | `7890` | 207.80ms | ✅ فعال |
| 3 | `125.128.12.14` | `3128` | 181.98ms | ✅ فعال |
| 4 | `103.84.95.54` | `7890` | 209.74ms | ✅ فعال |
| 5 | `89.116.88.19` | `80` | 156.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `72.214.108.67` | `4145` | 133.66ms | ✅ فعال |
| 2 | `103.146.170.233` | `5678` | 218.54ms | ✅ فعال |
| 3 | `142.54.228.193` | `4145` | 78.34ms | ✅ فعال |
| 4 | `119.13.111.169` | `4006` | 218.73ms | ✅ فعال |
| 5 | `49.0.252.39` | `9000` | 202.54ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `34.44.49.215` | `80` | 26.69ms | ✅ فعال |
| 2 | `4.195.16.140` | `80` | 210.55ms | ✅ فعال |
| 3 | `23.88.88.102` | `80` | 96.48ms | ✅ فعال |
| 4 | `38.60.196.214` | `80` | 76.11ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 220.34ms | ✅ فعال |
