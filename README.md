...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 07-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.34.224` | `80` | 7.02ms | ✅ فعال |
| 2 | `23.227.60.25` | `80` | 5.82ms | ✅ فعال |
| 3 | `36.147.78.166` | `80` | 269.64ms | ✅ فعال |
| 4 | `45.131.211.143` | `80` | 1.63ms | ✅ فعال |
| 5 | `47.82.116.255` | `1100` | 207.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.238.8.219` | `6077` | 84.94ms | ✅ فعال |
| 2 | `101.51.138.138` | `8080` | 255.90ms | ✅ فعال |
| 3 | `166.88.64.132` | `6515` | 68.67ms | ✅ فعال |
| 4 | `145.223.44.203` | `5886` | 34.35ms | ✅ فعال |
| 5 | `95.43.244.15` | `4153` | 119.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.236.139` | `80` | 5.83ms | ✅ فعال |
| 2 | `202.154.18.1` | `8080` | 246.24ms | ✅ فعال |
| 3 | `5.10.247.49` | `80` | 1.94ms | ✅ فعال |
| 4 | `45.131.4.9` | `80` | 1.89ms | ✅ فعال |
| 5 | `104.17.190.13` | `80` | 1.80ms | ✅ فعال |
