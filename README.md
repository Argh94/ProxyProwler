...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:25 29-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.250.155.254` | `8081` | 229.65ms | ✅ فعال |
| 2 | `48.210.225.96` | `80` | 151.70ms | ✅ فعال |
| 3 | `31.58.21.16` | `6287` | 76.92ms | ✅ فعال |
| 4 | `172.120.101.220` | `6399` | 69.25ms | ✅ فعال |
| 5 | `91.107.148.58` | `53967` | 92.01ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 232.59ms | ✅ فعال |
| 2 | `176.214.78.230` | `5678` | 128.64ms | ✅ فعال |
| 3 | `142.111.44.174` | `5886` | 24.33ms | ✅ فعال |
| 4 | `35.234.17.221` | `1080` | 187.26ms | ✅ فعال |
| 5 | `98.188.47.132` | `4145` | 82.76ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (18 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 163.03ms | ✅ فعال |
| 2 | `5.161.155.252` | `80` | 5.84ms | ✅ فعال |
| 3 | `45.151.182.9` | `3128` | 138.90ms | ✅ فعال |
| 4 | `4.195.16.140` | `80` | 197.16ms | ✅ فعال |
| 5 | `34.140.137.151` | `80` | 85.72ms | ✅ فعال |
