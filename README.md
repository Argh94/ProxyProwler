...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:03 09-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.195.49.27` | `1080` | 147.86ms | ✅ فعال |
| 2 | `64.188.65.230` | `1080` | 161.06ms | ✅ فعال |
| 3 | `5.255.117.127` | `1080` | 165.68ms | ✅ فعال |
| 4 | `152.70.237.238` | `3128` | 182.88ms | ✅ فعال |
| 5 | `91.246.1.6` | `4433` | 222.23ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `98.175.31.195` | `4145` | 101.98ms | ✅ فعال |
| 2 | `8.211.49.86` | `100` | 148.49ms | ✅ فعال |
| 3 | `84.2.239.42` | `4153` | 178.81ms | ✅ فعال |
| 4 | `217.69.121.201` | `5866` | 124.30ms | ✅ فعال |
| 5 | `154.6.116.67` | `6036` | 55.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10336` | 56.06ms | ✅ فعال |
| 2 | `79.121.102.227` | `8080` | 188.75ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 192.26ms | ✅ فعال |
| 4 | `209.141.54.136` | `5555` | 18.45ms | ✅ فعال |
| 5 | `104.129.194.43` | `10336` | 61.76ms | ✅ فعال |
