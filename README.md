...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:22 23-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `86.53.110.3` | `7890` | 143.41ms | ✅ فعال |
| 2 | `184.182.240.12` | `4145` | 108.28ms | ✅ فعال |
| 3 | `195.133.53.59` | `10808` | 226.78ms | ✅ فعال |
| 4 | `72.37.216.68` | `4145` | 23.00ms | ✅ فعال |
| 5 | `43.128.63.68` | `7890` | 146.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `95.181.160.39` | `80` | 148.70ms | ✅ فعال |
| 2 | `192.111.137.37` | `18762` | 99.49ms | ✅ فعال |
| 3 | `107.191.44.214` | `1081` | 41.37ms | ✅ فعال |
| 4 | `47.238.60.156` | `8443` | 147.66ms | ✅ فعال |
| 5 | `8.211.195.139` | `6379` | 144.48ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `176.57.189.138` | `3128` | 171.53ms | ✅ فعال |
| 2 | `185.196.182.22` | `8080` | 1195.28ms | ✅ فعال |
