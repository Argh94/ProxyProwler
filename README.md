...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 20-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `147.161.166.35` | `10326` | 91.42ms | ✅ فعال |
| 2 | `185.148.104.24` | `80` | 2.71ms | ✅ فعال |
| 3 | `213.147.107.178` | `4153` | 123.91ms | ✅ فعال |
| 4 | `5.10.244.233` | `80` | 2.69ms | ✅ فعال |
| 5 | `45.12.30.205` | `80` | 2.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.0.162` | `7302` | 254.57ms | ✅ فعال |
| 2 | `104.238.37.51` | `6608` | 25.13ms | ✅ فعال |
| 3 | `167.172.86.46` | `10471` | 206.52ms | ✅ فعال |
| 4 | `8.213.156.191` | `6666` | 203.40ms | ✅ فعال |
| 5 | `101.255.208.18` | `8090` | 2243.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `198.177.56.190` | `80` | 2.70ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 16.27ms | ✅ فعال |
| 3 | `94.25.85.100` | `8123` | 1218.10ms | ✅ فعال |
| 4 | `45.12.31.28` | `80` | 2.69ms | ✅ فعال |
| 5 | `104.24.85.134` | `80` | 2.27ms | ✅ فعال |
