...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:37 19-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.74.38` | `4840` | 74.14ms | ✅ فعال |
| 2 | `193.43.159.200` | `80` | 127.04ms | ✅ فعال |
| 3 | `184.178.172.11` | `4145` | 85.59ms | ✅ فعال |
| 4 | `154.30.1.231` | `5547` | 15.58ms | ✅ فعال |
| 5 | `68.1.210.163` | `4145` | 93.64ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.195.191` | `90` | 866.90ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 122.78ms | ✅ فعال |
| 3 | `47.238.130.212` | `8008` | 780.54ms | ✅ فعال |
| 4 | `193.233.254.63` | `1080` | 93.35ms | ✅ فعال |
| 5 | `47.238.128.246` | `3128` | 864.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 122.17ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 1257.75ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 160.25ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 225.75ms | ✅ فعال |
| 5 | `202.137.8.148` | `8080` | 231.64ms | ✅ فعال |
