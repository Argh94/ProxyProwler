...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:58 03-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.18.95.115` | `80` | 1.71ms | ✅ فعال |
| 2 | `173.245.49.31` | `80` | 2.14ms | ✅ فعال |
| 3 | `8.221.141.88` | `8003` | 848.60ms | ✅ فعال |
| 4 | `172.67.167.18` | `80` | 1.68ms | ✅ فعال |
| 5 | `205.233.181.58` | `80` | 2.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.6.219` | `80` | 2.63ms | ✅ فعال |
| 2 | `101.200.158.109` | `8880` | 253.05ms | ✅ فعال |
| 3 | `104.17.104.48` | `80` | 2.02ms | ✅ فعال |
| 4 | `104.18.92.233` | `80` | 1.64ms | ✅ فعال |
| 5 | `185.170.166.204` | `80` | 1.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.24.197.20` | `80` | 1.52ms | ✅ فعال |
| 2 | `89.116.250.4` | `80` | 1.84ms | ✅ فعال |
| 3 | `185.162.230.130` | `80` | 1.88ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 2.21ms | ✅ فعال |
| 5 | `185.193.28.50` | `80` | 1.92ms | ✅ فعال |
