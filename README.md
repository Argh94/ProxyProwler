...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 21-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `181.214.1.151` | `80` | 14.54ms | ✅ فعال |
| 2 | `104.17.76.195` | `80` | 9.58ms | ✅ فعال |
| 3 | `188.42.88.244` | `80` | 12.62ms | ✅ فعال |
| 4 | `104.25.41.152` | `80` | 15.29ms | ✅ فعال |
| 5 | `192.252.214.20` | `15864` | 71.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.221.141.88` | `9500` | 134.30ms | ✅ فعال |
| 2 | `8.213.197.208` | `18080` | 960.26ms | ✅ فعال |
| 3 | `8.209.68.1` | `8081` | 121.62ms | ✅ فعال |
| 4 | `174.138.119.88` | `80` | 46.09ms | ✅ فعال |
| 5 | `8.213.195.191` | `9191` | 858.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `164.163.40.15` | `10000` | 173.84ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 194.52ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 28.10ms | ✅ فعال |
| 4 | `162.240.154.26` | `3128` | 2080.68ms | ✅ فعال |
| 5 | `15.160.148.69` | `49547` | 123.67ms | ✅ فعال |
