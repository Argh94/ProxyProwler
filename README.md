...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:47 05-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.231.153` | `80` | 2.41ms | ✅ فعال |
| 2 | `45.159.219.162` | `80` | 1.92ms | ✅ فعال |
| 3 | `104.16.245.121` | `80` | 1.96ms | ✅ فعال |
| 4 | `45.80.110.28` | `80` | 2.65ms | ✅ فعال |
| 5 | `172.67.107.39` | `80` | 2.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.130.34.237` | `1234` | 248.36ms | ✅ فعال |
| 2 | `103.48.183.113` | `4145` | 1265.38ms | ✅ فعال |
| 3 | `101.51.138.138` | `8080` | 248.29ms | ✅ فعال |
| 4 | `8.210.17.35` | `119` | 196.12ms | ✅ فعال |
| 5 | `1.0.0.4` | `80` | 1.94ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 1.92ms | ✅ فعال |
| 2 | `172.67.161.245` | `80` | 2.37ms | ✅ فعال |
| 3 | `104.16.1.135` | `80` | 2.54ms | ✅ فعال |
| 4 | `5.10.246.51` | `80` | 1.79ms | ✅ فعال |
| 5 | `5.10.247.49` | `80` | 1.95ms | ✅ فعال |
