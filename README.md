...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:02 16-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `198.41.203.90` | `80` | 1.95ms | ✅ فعال |
| 2 | `69.84.182.117` | `80` | 2.37ms | ✅ فعال |
| 3 | `162.220.247.198` | `6793` | 75.47ms | ✅ فعال |
| 4 | `104.18.40.5` | `80` | 2.67ms | ✅ فعال |
| 5 | `104.21.73.94` | `80` | 2.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `124.6.225.124` | `1088` | 265.25ms | ✅ فعال |
| 2 | `93.115.18.235` | `9050` | 1093.99ms | ✅ فعال |
| 3 | `39.104.62.128` | `5000` | 265.36ms | ✅ فعال |
| 4 | `141.98.188.201` | `2080` | 120.00ms | ✅ فعال |
| 5 | `47.243.175.55` | `443` | 210.05ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `164.163.42.60` | `10000` | 175.00ms | ✅ فعال |
| 2 | `144.125.164.222` | `8080` | 2.46ms | ✅ فعال |
| 3 | `176.57.189.138` | `3128` | 116.48ms | ✅ فعال |
| 4 | `15.160.148.69` | `49547` | 92.75ms | ✅ فعال |
| 5 | `115.114.77.133` | `9090` | 200.73ms | ✅ فعال |
