...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 09-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `64.64.110.168` | `6691` | 12.56ms | ✅ فعال |
| 2 | `154.83.2.7` | `80` | 6.05ms | ✅ فعال |
| 3 | `199.34.230.212` | `80` | 5.82ms | ✅ فعال |
| 4 | `104.27.4.172` | `80` | 5.85ms | ✅ فعال |
| 5 | `23.227.39.254` | `80` | 5.78ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.112.19.200` | `9090` | 247.68ms | ✅ فعال |
| 2 | `47.250.159.65` | `161` | 703.03ms | ✅ فعال |
| 3 | `119.13.111.169` | `4006` | 221.15ms | ✅ فعال |
| 4 | `123.57.1.16` | `5555` | 277.17ms | ✅ فعال |
| 5 | `47.100.130.127` | `8082` | 246.34ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.80.138.81` | `50000` | 159.54ms | ✅ فعال |
| 2 | `45.225.207.183` | `999` | 1152.16ms | ✅ فعال |
| 3 | `200.174.198.32` | `8888` | 113.85ms | ✅ فعال |
| 4 | `43.208.25.125` | `6192` | 246.42ms | ✅ فعال |
| 5 | `15.160.134.84` | `8345` | 96.42ms | ✅ فعال |
