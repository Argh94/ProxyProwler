...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:12 14-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `95.179.242.209` | `80` | 158.06ms | ✅ فعال |
| 2 | `123.30.154.171` | `7777` | 237.99ms | ✅ فعال |
| 3 | `116.171.106.111` | `3000` | 213.23ms | ✅ فعال |
| 4 | `172.200.72.48` | `80` | 59.71ms | ✅ فعال |
| 5 | `188.239.43.6` | `80` | 175.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `50.238.47.86` | `32100` | 55.93ms | ✅ فعال |
| 2 | `107.150.52.100` | `80` | 44.39ms | ✅ فعال |
| 3 | `143.137.116.72` | `1080` | 2194.35ms | ✅ فعال |
| 4 | `185.130.219.12` | `4153` | 148.62ms | ✅ فعال |
| 5 | `119.13.111.169` | `4006` | 170.49ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.47.197.210` | `3128` | 168.95ms | ✅ فعال |
| 2 | `45.119.113.65` | `82` | 1242.52ms | ✅ فعال |
| 3 | `158.178.203.189` | `3177` | 143.08ms | ✅ فعال |
| 4 | `147.75.33.108` | `10006` | 1614.76ms | ✅ فعال |
| 5 | `34.122.187.196` | `80` | 49.13ms | ✅ فعال |
