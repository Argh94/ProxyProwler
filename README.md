...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 09-08-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (21 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.162.228.109` | `80` | 2.62ms | ✅ فعال |
| 2 | `16.78.104.244` | `9078` | 222.25ms | ✅ فعال |
| 3 | `152.67.221.233` | `9050` | 163.91ms | ✅ فعال |
| 4 | `45.92.77.55` | `6077` | 52.08ms | ✅ فعال |
| 5 | `185.148.104.125` | `80` | 2.89ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.81` | `3629` | 250.55ms | ✅ فعال |
| 2 | `139.196.151.191` | `8090` | 221.81ms | ✅ فعال |
| 3 | `72.195.114.184` | `4145` | 97.94ms | ✅ فعال |
| 4 | `185.148.104.125` | `80` | 2.80ms | ✅ فعال |
| 5 | `84.46.204.66` | `6369` | 91.74ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `13.60.209.160` | `172` | 119.55ms | ✅ فعال |
| 2 | `78.12.143.148` | `224` | 53.48ms | ✅ فعال |
| 3 | `45.189.116.100` | `999` | 1139.18ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 204.10ms | ✅ فعال |
| 5 | `54.154.27.41` | `9999` | 86.90ms | ✅ فعال |
