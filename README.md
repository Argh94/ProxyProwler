...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:04 03-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.103.228` | `80` | 14.38ms | ✅ فعال |
| 2 | `104.25.0.83` | `80` | 15.76ms | ✅ فعال |
| 3 | `185.146.173.178` | `80` | 16.02ms | ✅ فعال |
| 4 | `45.80.108.157` | `80` | 14.63ms | ✅ فعال |
| 5 | `173.245.49.201` | `80` | 15.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.199.166.250` | `9119` | 194.41ms | ✅ فعال |
| 2 | `5.199.169.254` | `9081` | 149.42ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 257.61ms | ✅ فعال |
| 4 | `5.199.173.4` | `9099` | 135.47ms | ✅ فعال |
| 5 | `45.131.4.32` | `80` | 12.00ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (46 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.44` | `10801` | 104.91ms | ✅ فعال |
| 2 | `34.236.148.220` | `8007` | 33.94ms | ✅ فعال |
| 3 | `78.12.143.148` | `41553` | 51.03ms | ✅ فعال |
| 4 | `43.198.99.209` | `21225` | 184.54ms | ✅ فعال |
| 5 | `108.137.1.116` | `17277` | 210.57ms | ✅ فعال |
