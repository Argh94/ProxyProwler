...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 03-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `154.29.87.81` | `6502` | 1.31ms | ✅ فعال |
| 2 | `8.213.195.191` | `3128` | 901.53ms | ✅ فعال |
| 3 | `141.101.120.17` | `80` | 1.24ms | ✅ فعال |
| 4 | `104.25.18.229` | `80` | 1.20ms | ✅ فعال |
| 5 | `141.101.122.12` | `80` | 1.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `101.132.222.120` | `80` | 232.88ms | ✅ فعال |
| 2 | `201.148.125.126` | `4153` | 129.83ms | ✅ فعال |
| 3 | `103.86.135.34` | `5678` | 1259.15ms | ✅ فعال |
| 4 | `8.130.34.44` | `3128` | 255.08ms | ✅ فعال |
| 5 | `8.221.141.88` | `8003` | 1902.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.247.188` | `80` | 1.27ms | ✅ فعال |
| 2 | `104.17.190.13` | `80` | 1.44ms | ✅ فعال |
| 3 | `195.245.221.183` | `80` | 1.36ms | ✅ فعال |
| 4 | `5.10.246.51` | `80` | 1.50ms | ✅ فعال |
| 5 | `104.18.40.13` | `80` | 1.29ms | ✅ فعال |
