...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:22 17-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `62.109.19.5` | `80` | 119.09ms | ✅ فعال |
| 2 | `152.70.137.18` | `8888` | 60.98ms | ✅ فعال |
| 3 | `49.4.117.146` | `3128` | 283.72ms | ✅ فعال |
| 4 | `192.111.134.10` | `4145` | 114.20ms | ✅ فعال |
| 5 | `8.213.134.213` | `9080` | 181.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `106.15.137.41` | `9090` | 263.54ms | ✅ فعال |
| 2 | `115.29.140.201` | `8499` | 281.04ms | ✅ فعال |
| 3 | `70.166.167.55` | `57745` | 56.93ms | ✅ فعال |
| 4 | `8.213.222.247` | `8080` | 263.48ms | ✅ فعال |
| 5 | `47.119.22.156` | `10000` | 264.47ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `27.34.242.98` | `80` | 226.67ms | ✅ فعال |
| 2 | `34.44.49.215` | `80` | 26.30ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 218.84ms | ✅ فعال |
| 4 | `209.38.222.145` | `8080` | 91.71ms | ✅ فعال |
| 5 | `81.169.213.169` | `8888` | 111.38ms | ✅ فعال |
