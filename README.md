...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:59 26-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `190.119.132.61` | `80` | 126.64ms | ✅ فعال |
| 2 | `167.71.226.135` | `1080` | 221.81ms | ✅ فعال |
| 3 | `193.233.254.82` | `1080` | 97.89ms | ✅ فعال |
| 4 | `5.104.87.17` | `8051` | 171.99ms | ✅ فعال |
| 5 | `147.161.210.140` | `8800` | 157.37ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.128.6` | `1000` | 209.65ms | ✅ فعال |
| 2 | `103.166.39.145` | `3629` | 249.11ms | ✅ فعال |
| 3 | `193.233.254.38` | `1080` | 97.88ms | ✅ فعال |
| 4 | `45.144.30.199` | `443` | 124.16ms | ✅ فعال |
| 5 | `62.4.37.104` | `60606` | 118.57ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.191.236.162` | `3128` | 106.42ms | ✅ فعال |
| 2 | `206.42.55.99` | `3128` | 131.51ms | ✅ فعال |
| 3 | `195.57.239.25` | `8080` | 118.04ms | ✅ فعال |
| 4 | `139.59.59.122` | `8118` | 1278.67ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 227.40ms | ✅ فعال |
