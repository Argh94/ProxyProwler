...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:19 13-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.188` | `33290` | 1227.57ms | ✅ فعال |
| 2 | `206.123.156.227` | `11421` | 1201.88ms | ✅ فعال |
| 3 | `35.237.28.196` | `2222` | 69.16ms | ✅ فعال |
| 4 | `109.120.156.122` | `8090` | 163.36ms | ✅ فعال |
| 5 | `94.230.127.180` | `1080` | 225.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `80.92.204.47` | `1081` | 149.16ms | ✅ فعال |
| 2 | `217.69.121.62` | `5727` | 140.68ms | ✅ فعال |
| 3 | `8.215.15.163` | `8118` | 185.41ms | ✅ فعال |
| 4 | `117.216.46.148` | `1080` | 2242.74ms | ✅ فعال |
| 5 | `72.195.101.99` | `4145` | 155.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 181.49ms | ✅ فعال |
| 2 | `8.219.97.248` | `80` | 167.60ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 116.58ms | ✅ فعال |
| 4 | `154.236.191.45` | `1976` | 328.39ms | ✅ فعال |
