...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 23-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `205.233.181.245` | `80` | 2.28ms | ✅ فعال |
| 2 | `104.25.0.49` | `80` | 1.73ms | ✅ فعال |
| 3 | `198.37.116.7` | `5966` | 24.46ms | ✅ فعال |
| 4 | `45.8.211.52` | `80` | 1.77ms | ✅ فعال |
| 5 | `185.193.29.53` | `80` | 5.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.16.49.113` | `50001` | 158.62ms | ✅ فعال |
| 2 | `8.220.204.92` | `18081` | 1015.77ms | ✅ فعال |
| 3 | `45.12.31.213` | `80` | 1.83ms | ✅ فعال |
| 4 | `49.0.199.132` | `19` | 266.40ms | ✅ فعال |
| 5 | `104.19.76.28` | `80` | 2.00ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `16.78.93.162` | `10072` | 222.09ms | ✅ فعال |
| 2 | `3.110.127.255` | `9267` | 213.42ms | ✅ فعال |
| 3 | `79.121.102.227` | `8080` | 118.60ms | ✅ فعال |
| 4 | `165.225.72.38` | `10001` | 1232.89ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 209.65ms | ✅ فعال |
