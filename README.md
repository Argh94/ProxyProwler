...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:19 29-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.123.156.231` | `6427` | 2131.40ms | ✅ فعال |
| 2 | `47.85.84.192` | `20000` | 6.12ms | ✅ فعال |
| 3 | `206.123.156.200` | `5167` | 95.41ms | ✅ فعال |
| 4 | `206.123.156.230` | `4457` | 97.73ms | ✅ فعال |
| 5 | `206.123.156.199` | `8792` | 116.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `31.59.20.120` | `6698` | 81.41ms | ✅ فعال |
| 2 | `8.211.49.86` | `8008` | 90.38ms | ✅ فعال |
| 3 | `198.144.190.41` | `5888` | 29.11ms | ✅ فعال |
| 4 | `36.138.53.26` | `10017` | 230.55ms | ✅ فعال |
| 5 | `163.172.167.48` | `80` | 91.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 171.59ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 112.57ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 222.61ms | ✅ فعال |
| 4 | `186.215.87.194` | `10312` | 137.54ms | ✅ فعال |
