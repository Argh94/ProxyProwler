...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:51 29-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.81.22` | `80` | 2.18ms | ✅ فعال |
| 2 | `8.212.165.33` | `3333` | 1290.00ms | ✅ فعال |
| 3 | `104.21.231.230` | `80` | 19.71ms | ✅ فعال |
| 4 | `104.27.15.9` | `80` | 2.08ms | ✅ فعال |
| 5 | `103.160.204.175` | `80` | 2.03ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.184.67.117` | `8080` | 216.51ms | ✅ فعال |
| 2 | `95.43.244.15` | `4153` | 140.27ms | ✅ فعال |
| 3 | `47.243.50.83` | `81` | 189.81ms | ✅ فعال |
| 4 | `8.212.165.33` | `3333` | 2283.45ms | ✅ فعال |
| 5 | `182.160.16.234` | `8020` | 243.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.208.129.50` | `10844` | 233.04ms | ✅ فعال |
| 2 | `123.57.0.163` | `8888` | 242.56ms | ✅ فعال |
| 3 | `3.122.235.189` | `9507` | 112.29ms | ✅ فعال |
| 4 | `157.180.121.252` | `10810` | 131.01ms | ✅ فعال |
| 5 | `43.217.134.46` | `1080` | 208.84ms | ✅ فعال |
