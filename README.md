...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:54 27-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `173.245.49.214` | `80` | 2.03ms | ✅ فعال |
| 2 | `185.18.250.123` | `80` | 3.07ms | ✅ فعال |
| 3 | `104.238.36.173` | `6180` | 35.46ms | ✅ فعال |
| 4 | `108.162.198.17` | `80` | 6.01ms | ✅ فعال |
| 5 | `104.16.186.6` | `80` | 2.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.0.0.4` | `80` | 2.77ms | ✅ فعال |
| 2 | `47.91.29.151` | `91` | 165.98ms | ✅ فعال |
| 3 | `8.42.68.109` | `39593` | 49.25ms | ✅ فعال |
| 4 | `8.130.36.245` | `8080` | 263.14ms | ✅ فعال |
| 5 | `104.238.36.173` | `6180` | 35.27ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `62.72.166.211` | `80` | 2.42ms | ✅ فعال |
| 2 | `104.17.247.188` | `80` | 2.39ms | ✅ فعال |
| 3 | `102.177.176.178` | `80` | 2.21ms | ✅ فعال |
| 4 | `185.162.229.172` | `80` | 2.84ms | ✅ فعال |
| 5 | `198.177.56.190` | `80` | 2.23ms | ✅ فعال |
