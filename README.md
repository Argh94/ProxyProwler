...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:44 07-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.136.130.178` | `8449` | 38.17ms | ✅ فعال |
| 2 | `34.96.238.40` | `8080` | 185.44ms | ✅ فعال |
| 3 | `184.178.172.25` | `15291` | 103.74ms | ✅ فعال |
| 4 | `111.61.73.175` | `7302` | 194.09ms | ✅ فعال |
| 5 | `167.103.31.122` | `8800` | 240.04ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.18.47.79` | `4145` | 208.10ms | ✅ فعال |
| 2 | `8.213.134.213` | `1081` | 159.07ms | ✅ فعال |
| 3 | `185.226.204.80` | `5633` | 104.10ms | ✅ فعال |
| 4 | `198.8.94.170` | `4145` | 79.52ms | ✅ فعال |
| 5 | `15.188.75.223` | `3128` | 114.79ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.119.85.216` | `3128` | 213.19ms | ✅ فعال |
| 2 | `203.174.15.83` | `8080` | 208.55ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 121.02ms | ✅ فعال |
