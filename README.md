...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:13 24-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `192.111.135.18` | `18301` | 84.06ms | ✅ فعال |
| 2 | `185.148.106.153` | `80` | 8.91ms | ✅ فعال |
| 3 | `104.27.6.100` | `80` | 8.68ms | ✅ فعال |
| 4 | `206.238.236.65` | `80` | 9.09ms | ✅ فعال |
| 5 | `138.199.25.13` | `3909` | 174.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.43.70.140` | `6427` | 123.36ms | ✅ فعال |
| 2 | `202.166.219.80` | `4153` | 251.36ms | ✅ فعال |
| 3 | `8.209.68.1` | `8081` | 135.07ms | ✅ فعال |
| 4 | `8.211.42.167` | `1080` | 812.85ms | ✅ فعال |
| 5 | `216.26.243.32` | `3129` | 155.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.179.12.21` | `50867` | 109.86ms | ✅ فعال |
| 2 | `47.74.226.8` | `5001` | 176.60ms | ✅ فعال |
| 3 | `176.57.189.138` | `3128` | 140.20ms | ✅ فعال |
| 4 | `18.191.200.48` | `3128` | 54.38ms | ✅ فعال |
| 5 | `35.180.127.14` | `7768` | 134.17ms | ✅ فعال |
