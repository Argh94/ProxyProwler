...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:05 30-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `72.195.34.41` | `4145` | 85.77ms | ✅ فعال |
| 2 | `13.214.151.56` | `8081` | 228.10ms | ✅ فعال |
| 3 | `216.68.128.121` | `4145` | 145.65ms | ✅ فعال |
| 4 | `216.48.180.117` | `8080` | 259.06ms | ✅ فعال |
| 5 | `185.93.104.246` | `1080` | 89.87ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `209.50.167.200` | `3129` | 1.77ms | ✅ فعال |
| 2 | `142.54.235.9` | `4145` | 84.94ms | ✅ فعال |
| 3 | `31.59.33.87` | `6663` | 77.75ms | ✅ فعال |
| 4 | `192.252.215.5` | `16137` | 59.90ms | ✅ فعال |
| 5 | `13.214.205.160` | `40448` | 224.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 196.20ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 1251.67ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 2300.89ms | ✅ فعال |
| 4 | `103.130.61.61` | `8081` | 240.56ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 115.92ms | ✅ فعال |
