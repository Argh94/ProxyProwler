...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:12 13-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.166.39.81` | `3629` | 244.79ms | ✅ فعال |
| 2 | `109.245.231.73` | `8192` | 128.06ms | ✅ فعال |
| 3 | `138.199.25.13` | `3909` | 220.24ms | ✅ فعال |
| 4 | `184.181.217.201` | `4145` | 68.70ms | ✅ فعال |
| 5 | `116.171.106.78` | `3000` | 459.80ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (50 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 218.37ms | ✅ فعال |
| 2 | `98.175.31.195` | `4145` | 71.62ms | ✅ فعال |
| 3 | `31.59.33.88` | `6664` | 76.70ms | ✅ فعال |
| 4 | `8.209.249.96` | `808` | 158.16ms | ✅ فعال |
| 5 | `8.209.68.1` | `8081` | 92.81ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (25 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 203.85ms | ✅ فعال |
| 2 | `23.95.242.79` | `3128` | 36.08ms | ✅ فعال |
| 3 | `27.34.242.98` | `80` | 261.32ms | ✅ فعال |
| 4 | `5.161.155.252` | `80` | 2.58ms | ✅ فعال |
| 5 | `51.79.135.131` | `8080` | 220.41ms | ✅ فعال |
