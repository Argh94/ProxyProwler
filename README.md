...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 25-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `206.238.238.244` | `80` | 6.36ms | ✅ فعال |
| 2 | `104.16.0.132` | `80` | 6.33ms | ✅ فعال |
| 3 | `45.131.209.246` | `80` | 5.95ms | ✅ فعال |
| 4 | `172.67.81.79` | `80` | 9.49ms | ✅ فعال |
| 5 | `173.245.49.220` | `80` | 6.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `39.104.62.128` | `5000` | 237.31ms | ✅ فعال |
| 2 | `47.74.46.81` | `50` | 294.81ms | ✅ فعال |
| 3 | `103.166.39.233` | `3629` | 272.53ms | ✅ فعال |
| 4 | `219.65.73.81` | `80` | 243.85ms | ✅ فعال |
| 5 | `39.104.59.56` | `1081` | 235.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `4.149.153.123` | `3128` | 68.09ms | ✅ فعال |
| 2 | `54.154.27.41` | `122` | 71.07ms | ✅ فعال |
| 3 | `74.82.50.155` | `3128` | 170.18ms | ✅ فعال |
| 4 | `18.163.3.251` | `54012` | 206.31ms | ✅ فعال |
| 5 | `41.223.119.156` | `3128` | 1273.77ms | ✅ فعال |
