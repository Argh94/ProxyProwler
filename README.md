...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:56 21-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `159.246.55.166` | `80` | 8.90ms | ✅ فعال |
| 2 | `104.25.1.25` | `80` | 8.56ms | ✅ فعال |
| 3 | `104.143.224.88` | `5949` | 125.15ms | ✅ فعال |
| 4 | `172.67.167.20` | `80` | 8.70ms | ✅ فعال |
| 5 | `23.227.39.20` | `80` | 11.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.243.50.83` | `8088` | 157.99ms | ✅ فعال |
| 2 | `91.221.177.40` | `80` | 195.75ms | ✅ فعال |
| 3 | `201.174.239.31` | `4153` | 45.48ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 197.56ms | ✅ فعال |
| 5 | `139.162.78.109` | `8080` | 108.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.217.141.124` | `338` | 183.13ms | ✅ فعال |
| 2 | `43.208.129.50` | `9252` | 203.65ms | ✅ فعال |
| 3 | `18.143.167.190` | `4348` | 177.01ms | ✅ فعال |
| 4 | `13.61.18.44` | `55020` | 156.90ms | ✅ فعال |
| 5 | `35.180.127.14` | `375` | 144.43ms | ✅ فعال |
