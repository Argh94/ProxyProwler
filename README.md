...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:24 13-04-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `125.76.110.48` | `1080` | 306.58ms | ✅ فعال |
| 2 | `149.62.186.244` | `1080` | 1122.43ms | ✅ فعال |
| 3 | `158.220.101.43` | `1080` | 90.16ms | ✅ فعال |
| 4 | `184.170.245.148` | `4145` | 60.03ms | ✅ فعال |
| 5 | `107.172.116.68` | `5524` | 18.85ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `85.105.98.6` | `5314` | 140.38ms | ✅ فعال |
| 2 | `84.2.239.42` | `4153` | 128.82ms | ✅ فعال |
| 3 | `85.97.109.179` | `1953` | 140.40ms | ✅ فعال |
| 4 | `155.254.38.209` | `5885` | 76.52ms | ✅ فعال |
| 5 | `103.94.52.70` | `3128` | 258.50ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 119.10ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 3.81ms | ✅ فعال |
| 3 | `97.76.251.138` | `8080` | 34.85ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 2.73ms | ✅ فعال |
