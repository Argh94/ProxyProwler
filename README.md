...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:33 18-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `109.236.88.82` | `80` | 93.31ms | ✅ فعال |
| 2 | `1.231.81.166` | `3128` | 182.75ms | ✅ فعال |
| 3 | `62.113.119.14` | `8080` | 127.23ms | ✅ فعال |
| 4 | `103.253.145.138` | `6980` | 226.00ms | ✅ فعال |
| 5 | `62.182.204.81` | `88` | 160.55ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `142.111.48.4` | `6781` | 56.67ms | ✅ فعال |
| 2 | `192.73.244.36` | `80` | 52.29ms | ✅ فعال |
| 3 | `107.174.194.48` | `5490` | 35.27ms | ✅ فعال |
| 4 | `103.66.176.45` | `32251` | 253.73ms | ✅ فعال |
| 5 | `79.106.170.126` | `4145` | 225.62ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 222.13ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 118.42ms | ✅ فعال |
| 3 | `180.250.219.58` | `53281` | 300.47ms | ✅ فعال |
| 4 | `45.119.85.216` | `3128` | 1414.86ms | ✅ فعال |
| 5 | `139.59.59.122` | `8118` | 1275.82ms | ✅ فعال |
