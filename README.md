...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:08 26-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `98.188.47.150` | `4145` | 99.11ms | ✅ فعال |
| 2 | `43.133.128.153` | `16012` | 210.15ms | ✅ فعال |
| 3 | `68.71.252.38` | `4145` | 57.43ms | ✅ فعال |
| 4 | `5.255.117.127` | `1080` | 137.92ms | ✅ فعال |
| 5 | `184.181.217.201` | `4145` | 97.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `221.157.45.249` | `80` | 156.04ms | ✅ فعال |
| 2 | `43.133.128.153` | `16012` | 210.16ms | ✅ فعال |
| 3 | `47.252.18.37` | `6379` | 27.56ms | ✅ فعال |
| 4 | `47.238.134.126` | `6379` | 173.74ms | ✅ فعال |
| 5 | `8.211.195.173` | `55555` | 99.66ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.219.97.248` | `80` | 195.10ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 133.33ms | ✅ فعال |
| 3 | `176.57.189.138` | `3128` | 1365.79ms | ✅ فعال |
| 4 | `103.156.17.83` | `8080` | 1251.10ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 142.57ms | ✅ فعال |
