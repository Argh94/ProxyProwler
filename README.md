...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 26-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.12.32` | `80` | 2.73ms | ✅ فعال |
| 2 | `198.41.203.13` | `80` | 3.96ms | ✅ فعال |
| 3 | `66.235.200.89` | `80` | 1.99ms | ✅ فعال |
| 4 | `160.153.1.90` | `80` | 2.85ms | ✅ فعال |
| 5 | `8.209.96.245` | `80` | 105.43ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.116.210.163` | `1337` | 228.29ms | ✅ فعال |
| 2 | `8.221.139.222` | `8026` | 742.90ms | ✅ فعال |
| 3 | `47.254.153.78` | `5555` | 105.71ms | ✅ فعال |
| 4 | `203.24.108.231` | `80` | 2.94ms | ✅ فعال |
| 5 | `47.243.124.21` | `6666` | 198.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.58.45.94` | `12496` | 112.49ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 16.95ms | ✅ فعال |
| 3 | `54.154.27.41` | `122` | 84.11ms | ✅ فعال |
| 4 | `116.80.80.222` | `3172` | 2202.75ms | ✅ فعال |
| 5 | `103.156.75.124` | `1111` | 1258.72ms | ✅ فعال |
