...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:28 23-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.251.73.54` | `11` | 17.32ms | ✅ فعال |
| 2 | `206.123.156.213` | `4290` | 145.87ms | ✅ فعال |
| 3 | `206.123.156.207` | `7154` | 160.75ms | ✅ فعال |
| 4 | `206.123.156.228` | `7300` | 144.87ms | ✅ فعال |
| 5 | `178.216.223.147` | `1080` | 246.56ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `62.233.43.82` | `9051` | 173.05ms | ✅ فعال |
| 2 | `47.251.73.54` | `11` | 17.42ms | ✅ فعال |
| 3 | `98.159.38.218` | `6518` | 61.55ms | ✅ فعال |
| 4 | `107.181.154.51` | `5729` | 140.38ms | ✅ فعال |
| 5 | `91.223.52.141` | `5678` | 157.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.174.15.138` | `8080` | 2274.05ms | ✅ فعال |
| 2 | `129.154.225.163` | `8100` | 230.52ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 146.82ms | ✅ فعال |
| 4 | `210.61.216.63` | `60808` | 2209.64ms | ✅ فعال |
