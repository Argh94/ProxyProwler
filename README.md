...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:58 14-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.90.167.27` | `3128` | 66.45ms | ✅ فعال |
| 2 | `116.203.19.71` | `9102` | 155.56ms | ✅ فعال |
| 3 | `192.220.34.124` | `80` | 9.96ms | ✅ فعال |
| 4 | `203.25.208.163` | `1552` | 231.32ms | ✅ فعال |
| 5 | `160.22.17.4` | `9988` | 197.70ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.221.228.50` | `5678` | 183.93ms | ✅ فعال |
| 2 | `103.146.170.233` | `5678` | 223.06ms | ✅ فعال |
| 3 | `107.173.93.150` | `6104` | 55.56ms | ✅ فعال |
| 4 | `177.91.35.202` | `4153` | 2203.86ms | ✅ فعال |
| 5 | `182.53.216.73` | `4145` | 200.22ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 67.97ms | ✅ فعال |
| 2 | `74.82.50.155` | `3128` | 115.01ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 168.63ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 186.88ms | ✅ فعال |
| 5 | `47.74.226.8` | `5001` | 168.36ms | ✅ فعال |
