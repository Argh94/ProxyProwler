...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:58 05-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `47.80.79.232` | `8080` | 235.45ms | ✅ فعال |
| 2 | `185.234.66.87` | `1082` | 152.11ms | ✅ فعال |
| 3 | `184.182.240.211` | `4145` | 103.71ms | ✅ فعال |
| 4 | `206.123.156.236` | `6194` | 118.56ms | ✅ فعال |
| 5 | `103.75.118.84` | `1080` | 146.07ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `203.170.146.146` | `4153` | 228.37ms | ✅ فعال |
| 2 | `85.192.28.199` | `1080` | 125.62ms | ✅ فعال |
| 3 | `177.85.65.177` | `4153` | 172.06ms | ✅ فعال |
| 4 | `142.147.132.115` | `6310` | 43.38ms | ✅ فعال |
| 5 | `8.211.42.167` | `3128` | 126.86ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.129.194.43` | `10336` | 23.99ms | ✅ فعال |
| 2 | `104.129.194.44` | `10336` | 25.41ms | ✅ فعال |
| 3 | `103.158.252.99` | `80` | 208.16ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 162.23ms | ✅ فعال |
| 5 | `177.234.217.238` | `999` | 117.14ms | ✅ فعال |
