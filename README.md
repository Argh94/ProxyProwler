...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 29-09-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.180.35` | `80` | 13.20ms | ✅ فعال |
| 2 | `104.18.214.172` | `80` | 28.47ms | ✅ فعال |
| 3 | `45.80.108.169` | `80` | 10.33ms | ✅ فعال |
| 4 | `104.25.89.25` | `80` | 9.17ms | ✅ فعال |
| 5 | `209.46.30.229` | `80` | 9.28ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.32.4.102` | `4153` | 155.39ms | ✅ فعال |
| 2 | `8.211.200.183` | `9080` | 410.76ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 212.73ms | ✅ فعال |
| 4 | `8.221.138.111` | `8072` | 204.52ms | ✅ فعال |
| 5 | `140.238.197.4` | `3128` | 161.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.49.218` | `3629` | 161.15ms | ✅ فعال |
| 2 | `13.212.81.49` | `957` | 175.87ms | ✅ فعال |
| 3 | `43.198.99.209` | `8496` | 160.24ms | ✅ فعال |
| 4 | `3.35.25.117` | `216` | 145.82ms | ✅ فعال |
| 5 | `43.208.129.50` | `8830` | 209.91ms | ✅ فعال |
