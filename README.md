...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 13:01 01-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.193.178.226` | `80` | 72.78ms | ✅ فعال |
| 2 | `150.109.236.146` | `3128` | 178.74ms | ✅ فعال |
| 3 | `8.212.130.232` | `8080` | 247.51ms | ✅ فعال |
| 4 | `84.39.112.144` | `3128` | 92.02ms | ✅ فعال |
| 5 | `139.99.237.62` | `80` | 190.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.197.227.134` | `443` | 2.20ms | ✅ فعال |
| 2 | `98.181.137.83` | `4145` | 70.12ms | ✅ فعال |
| 3 | `202.166.219.80` | `4153` | 229.65ms | ✅ فعال |
| 4 | `177.85.65.177` | `4153` | 1175.48ms | ✅ فعال |
| 5 | `75.84.71.14` | `80` | 1130.98ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 169.18ms | ✅ فعال |
| 2 | `45.119.85.216` | `3128` | 766.10ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 219.72ms | ✅ فعال |
| 4 | `47.74.226.8` | `5001` | 218.02ms | ✅ فعال |
| 5 | `103.156.75.124` | `1111` | 252.80ms | ✅ فعال |
