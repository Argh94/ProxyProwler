...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:50 22-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.21.80.190` | `80` | 9.55ms | ✅ فعال |
| 2 | `172.67.171.225` | `80` | 8.85ms | ✅ فعال |
| 3 | `181.214.1.182` | `80` | 9.27ms | ✅ فعال |
| 4 | `203.30.190.57` | `80` | 9.96ms | ✅ فعال |
| 5 | `104.16.181.198` | `80` | 16.33ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.180.49.222` | `7302` | 223.97ms | ✅ فعال |
| 2 | `167.172.86.46` | `10471` | 179.67ms | ✅ فعال |
| 3 | `85.214.155.58` | `8080` | 152.76ms | ✅ فعال |
| 4 | `202.162.219.10` | `1080` | 207.88ms | ✅ فعال |
| 5 | `8.211.194.85` | `1080` | 148.93ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.16.1.135` | `80` | 17.96ms | ✅ فعال |
| 2 | `23.227.39.55` | `80` | 8.82ms | ✅ فعال |
| 3 | `195.245.221.183` | `80` | 8.74ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 51.13ms | ✅ فعال |
| 5 | `5.10.247.49` | `80` | 8.88ms | ✅ فعال |
