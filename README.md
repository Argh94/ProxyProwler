...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:52 21-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `174.64.199.82` | `4145` | 126.02ms | ✅ فعال |
| 2 | `185.193.30.248` | `80` | 17.78ms | ✅ فعال |
| 3 | `104.17.195.86` | `80` | 17.73ms | ✅ فعال |
| 4 | `104.27.42.184` | `80` | 17.80ms | ✅ فعال |
| 5 | `104.24.169.119` | `80` | 17.99ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `23.95.250.23` | `6296` | 51.94ms | ✅ فعال |
| 2 | `202.62.50.222` | `1080` | 213.90ms | ✅ فعال |
| 3 | `116.63.130.30` | `90` | 206.35ms | ✅ فعال |
| 4 | `72.195.34.42` | `4145` | 103.15ms | ✅ فعال |
| 5 | `8.211.195.173` | `8080` | 430.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `43.209.8.12` | `21829` | 208.14ms | ✅ فعال |
| 2 | `51.20.192.194` | `45546` | 141.94ms | ✅ فعال |
| 3 | `43.208.16.199` | `57113` | 207.86ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 38.13ms | ✅ فعال |
| 5 | `13.212.14.16` | `15895` | 193.78ms | ✅ فعال |
