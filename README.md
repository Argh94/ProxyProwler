...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:00 27-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `181.214.1.149` | `80` | 11.66ms | ✅ فعال |
| 2 | `172.67.162.222` | `80` | 13.98ms | ✅ فعال |
| 3 | `104.18.32.201` | `80` | 15.41ms | ✅ فعال |
| 4 | `159.246.55.123` | `80` | 14.03ms | ✅ فعال |
| 5 | `104.21.25.246` | `80` | 12.58ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `107.181.148.206` | `6066` | 101.22ms | ✅ فعال |
| 2 | `101.255.208.18` | `8090` | 1215.70ms | ✅ فعال |
| 3 | `1.0.0.4` | `80` | 14.29ms | ✅ فعال |
| 4 | `107.174.194.156` | `5598` | 24.83ms | ✅ فعال |
| 5 | `173.249.38.205` | `3128` | 202.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `45.80.108.229` | `80` | 13.00ms | ✅ فعال |
| 2 | `104.16.0.165` | `80` | 14.55ms | ✅ فعال |
| 3 | `104.17.25.3` | `80` | 12.30ms | ✅ فعال |
| 4 | `202.154.18.1` | `8080` | 224.52ms | ✅ فعال |
| 5 | `104.19.66.163` | `80` | 15.44ms | ✅ فعال |
