...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:56 02-07-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.131.209.104` | `80` | 8.83ms | ✅ فعال |
| 2 | `104.16.9.168` | `80` | 16.87ms | ✅ فعال |
| 3 | `104.27.1.250` | `80` | 9.48ms | ✅ فعال |
| 4 | `102.177.176.109` | `80` | 9.39ms | ✅ فعال |
| 5 | `104.19.44.54` | `80` | 9.69ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `1.0.0.4` | `80` | 8.57ms | ✅ فعال |
| 2 | `5.10.248.107` | `80` | 233.48ms | ✅ فعال |
| 3 | `8.130.36.245` | `8080` | 212.90ms | ✅ فعال |
| 4 | `34.81.72.31` | `80` | 138.62ms | ✅ فعال |
| 5 | `36.89.56.127` | `5678` | 205.71ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `5.10.246.51` | `80` | 8.85ms | ✅ فعال |
| 2 | `173.245.49.93` | `80` | 8.92ms | ✅ فعال |
| 3 | `104.17.106.99` | `80` | 16.53ms | ✅ فعال |
| 4 | `45.131.211.217` | `80` | 9.20ms | ✅ فعال |
| 5 | `104.16.1.135` | `80` | 16.42ms | ✅ فعال |
