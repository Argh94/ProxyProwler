...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:45 02-07-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `57.128.231.218` | `1006` | 131.22ms | ✅ فعال |
| 2 | `172.237.102.212` | `3128` | 100.44ms | ✅ فعال |
| 3 | `45.74.31.30` | `7731` | 132.48ms | ✅ فعال |
| 4 | `49.13.22.249` | `10807` | 125.07ms | ✅ فعال |
| 5 | `192.111.130.2` | `4145` | 98.16ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `83.143.24.66` | `80` | 2302.91ms | ✅ فعال |
| 2 | `198.105.100.44` | `6295` | 104.39ms | ✅ فعال |
| 3 | `101.255.166.134` | `80` | 211.13ms | ✅ فعال |
| 4 | `8.213.128.6` | `8080` | 1386.46ms | ✅ فعال |
| 5 | `189.203.181.34` | `1080` | 1111.39ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `110.164.175.110` | `8080` | 226.56ms | ✅ فعال |
| 2 | `217.64.149.146` | `8118` | 145.63ms | ✅ فعال |
| 3 | `103.156.17.83` | `8080` | 219.98ms | ✅ فعال |
| 4 | `119.82.242.200` | `8080` | 248.47ms | ✅ فعال |
| 5 | `103.189.116.20` | `8080` | 1278.60ms | ✅ فعال |
