...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:36 20-01-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (48 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `170.64.170.204` | `8080` | 264.95ms | ✅ فعال |
| 2 | `1.231.81.166` | `3128` | 296.82ms | ✅ فعال |
| 3 | `173.212.246.157` | `3128` | 135.23ms | ✅ فعال |
| 4 | `130.61.30.221` | `8080` | 93.00ms | ✅ فعال |
| 5 | `116.171.106.78` | `3000` | 449.41ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (23 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `193.122.105.251` | `65535` | 254.22ms | ✅ فعال |
| 2 | `43.250.54.139` | `60000` | 88.14ms | ✅ فعال |
| 3 | `103.175.127.230` | `60606` | 2348.52ms | ✅ فعال |
| 4 | `220.128.223.136` | `8081` | 189.08ms | ✅ فعال |
| 5 | `160.250.54.5` | `9000` | 260.18ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (7 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 172.81ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 213.82ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 92.61ms | ✅ فعال |
| 4 | `220.128.223.136` | `8082` | 194.60ms | ✅ فعال |
| 5 | `203.174.15.83` | `8080` | 234.73ms | ✅ فعال |
