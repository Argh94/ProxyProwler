...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:37 13-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `185.187.92.42` | `80` | 123.97ms | ✅ فعال |
| 2 | `98.170.57.231` | `4145` | 71.15ms | ✅ فعال |
| 3 | `38.60.196.214` | `80` | 78.22ms | ✅ فعال |
| 4 | `8.213.222.247` | `4002` | 274.19ms | ✅ فعال |
| 5 | `31.24.16.151` | `80` | 102.12ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `110.238.109.146` | `19` | 235.02ms | ✅ فعال |
| 2 | `16.51.157.105` | `7219` | 218.96ms | ✅ فعال |
| 3 | `98.170.57.231` | `4145` | 69.93ms | ✅ فعال |
| 4 | `139.224.56.162` | `10001` | 254.64ms | ✅ فعال |
| 5 | `72.37.216.68` | `4145` | 104.14ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.191.203.162` | `80` | 230.42ms | ✅ فعال |
| 2 | `45.151.182.9` | `3128` | 128.90ms | ✅ فعال |
| 3 | `41.191.203.164` | `80` | 229.39ms | ✅ فعال |
| 4 | `8.220.188.140` | `80` | 248.16ms | ✅ فعال |
| 5 | `41.74.91.244` | `80` | 177.47ms | ✅ فعال |
