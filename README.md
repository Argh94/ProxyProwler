...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:03 26-10-1404 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (81 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `104.27.203.102` | `80` | 1.95ms | ✅ فعال |
| 2 | `104.21.19.81` | `80` | 2.03ms | ✅ فعال |
| 3 | `104.18.40.61` | `80` | 3.18ms | ✅ فعال |
| 4 | `185.193.28.158` | `80` | 2.02ms | ✅ فعال |
| 5 | `104.21.29.142` | `80` | 1.82ms | ✅ فعال |

</div>

<div align="center">

### 🔗 SOCKS4 Proxies (71 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `197.157.194.28` | `1080` | 2373.01ms | ✅ فعال |
| 2 | `199.102.107.145` | `4145` | 34.71ms | ✅ فعال |
| 3 | `159.138.252.45` | `8888` | 206.27ms | ✅ فعال |
| 4 | `8.138.133.207` | `8008` | 182.76ms | ✅ فعال |
| 5 | `5.199.166.238` | `9095` | 167.27ms | ✅ فعال |

</div>

<div align="center">

### 🔗 HTTPS Proxies (49 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `18.163.3.251` | `9149` | 156.31ms | ✅ فعال |
| 2 | `43.208.16.9` | `8808` | 196.64ms | ✅ فعال |
| 3 | `15.160.148.69` | `33153` | 163.54ms | ✅ فعال |
| 4 | `16.78.82.73` | `9099` | 183.60ms | ✅ فعال |
| 5 | `15.160.148.69` | `14455` | 164.06ms | ✅ فعال |
