...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 14:53 13-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `116.104.254.133` | `1080` | 207.97ms | ✅ فعال |
| 2 | `5.255.117.127` | `1080` | 121.48ms | ✅ فعال |
| 3 | `103.189.63.149` | `56457` | 2264.26ms | ✅ فعال |
| 4 | `199.116.112.6` | `4145` | 79.04ms | ✅ فعال |
| 5 | `107.173.36.244` | `5699` | 33.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.51.115` | `5060` | 114.57ms | ✅ فعال |
| 2 | `8.221.138.111` | `46691` | 136.82ms | ✅ فعال |
| 3 | `185.170.166.15` | `80` | 6.42ms | ✅ فعال |
| 4 | `185.226.204.228` | `5781` | 113.04ms | ✅ فعال |
| 5 | `98.103.88.158` | `46104` | 34.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.156.17.83` | `8080` | 218.80ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 149.44ms | ✅ فعال |
| 3 | `203.174.15.138` | `8080` | 210.70ms | ✅ فعال |
| 4 | `104.129.194.44` | `10336` | 26.70ms | ✅ فعال |
| 5 | `103.147.247.171` | `8080` | 1221.17ms | ✅ فعال |
