...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:52 16-03-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.81.110.212` | `35899` | 1229.95ms | ✅ فعال |
| 2 | `174.77.111.196` | `4145` | 118.76ms | ✅ فعال |
| 3 | `8.213.222.247` | `15` | 194.32ms | ✅ فعال |
| 4 | `98.190.239.3` | `4145` | 129.54ms | ✅ فعال |
| 5 | `47.237.1.50` | `10808` | 1200.13ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.211.200.183` | `1234` | 151.18ms | ✅ فعال |
| 2 | `8.137.13.195` | `80` | 188.58ms | ✅ فعال |
| 3 | `95.47.241.240` | `1080` | 1237.37ms | ✅ فعال |
| 4 | `8.211.195.173` | `8443` | 146.29ms | ✅ فعال |
| 5 | `47.238.130.212` | `4145` | 146.68ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 114.85ms | ✅ فعال |
| 2 | `209.141.62.12` | `5555` | 24.35ms | ✅ فعال |
| 3 | `104.129.194.44` | `10336` | 68.95ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 172.42ms | ✅ فعال |
| 5 | `195.57.239.25` | `8080` | 180.45ms | ✅ فعال |
