...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 05:21 09-12-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.248.5` | `4145` | 98.89ms | ✅ فعال |
| 2 | `172.193.178.226` | `80` | 23.71ms | ✅ فعال |
| 3 | `104.233.26.236` | `6074` | 17.45ms | ✅ فعال |
| 4 | `20.27.11.248` | `8561` | 121.40ms | ✅ فعال |
| 5 | `142.147.132.44` | `6239` | 51.25ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `68.1.210.189` | `4145` | 160.75ms | ✅ فعال |
| 2 | `174.75.211.222` | `4145` | 211.79ms | ✅ فعال |
| 3 | `92.113.3.152` | `6161` | 51.46ms | ✅ فعال |
| 4 | `45.43.81.130` | `5777` | 124.01ms | ✅ فعال |
| 5 | `47.254.153.78` | `999` | 133.06ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `14.56.118.154` | `3128` | 1182.79ms | ✅ فعال |
| 2 | `160.19.18.29` | `8080` | 215.16ms | ✅ فعال |
| 3 | `23.88.88.102` | `80` | 131.83ms | ✅ فعال |
| 4 | `52.188.28.218` | `3128` | 1067.97ms | ✅ فعال |
| 5 | `61.72.110.54` | `3128` | 150.83ms | ✅ فعال |
