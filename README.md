...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:06 27-01-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `202.133.88.173` | `80` | 150.30ms | ✅ فعال |
| 2 | `40.89.145.14` | `80` | 126.76ms | ✅ فعال |
| 3 | `152.53.144.223` | `1080` | 134.46ms | ✅ فعال |
| 4 | `144.31.27.49` | `1080` | 153.31ms | ✅ فعال |
| 5 | `143.208.130.155` | `5678` | 1157.45ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `24.249.199.4` | `4145` | 113.23ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 145.26ms | ✅ فعال |
| 3 | `31.13.239.4` | `5678` | 1210.67ms | ✅ فعال |
| 4 | `154.90.60.60` | `20002` | 153.49ms | ✅ فعال |
| 5 | `149.129.226.9` | `8081` | 197.92ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 140.05ms | ✅ فعال |
| 2 | `139.59.59.122` | `8118` | 232.87ms | ✅ فعال |
| 3 | `185.191.236.162` | `3128` | 146.58ms | ✅ فعال |
| 4 | `195.57.239.25` | `8080` | 157.64ms | ✅ فعال |
| 5 | `8.219.97.248` | `80` | 223.04ms | ✅ فعال |
