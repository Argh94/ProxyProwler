...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:41 30-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `2.57.20.11` | `6992` | 61.89ms | ✅ فعال |
| 2 | `199.66.183.251` | `4145` | 76.07ms | ✅ فعال |
| 3 | `216.74.115.138` | `6732` | 8.57ms | ✅ فعال |
| 4 | `5.255.103.55` | `1080` | 166.01ms | ✅ فعال |
| 5 | `144.124.232.204` | `5222` | 137.97ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `47.91.65.23` | `3128` | 132.41ms | ✅ فعال |
| 2 | `98.181.137.83` | `4145` | 101.52ms | ✅ فعال |
| 3 | `142.54.226.214` | `4145` | 25.26ms | ✅ فعال |
| 4 | `43.99.100.108` | `3128` | 153.16ms | ✅ فعال |
| 5 | `47.254.36.213` | `9080` | 16.65ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 120.07ms | ✅ فعال |
| 2 | `195.57.239.25` | `8080` | 167.58ms | ✅ فعال |
| 3 | `8.219.97.248` | `80` | 182.91ms | ✅ فعال |
