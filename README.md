...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 12-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.25.0.11` | `80` | 2.53ms | ✅ فعال |
| 2 | `142.54.228.193` | `4145` | 75.02ms | ✅ فعال |
| 3 | `188.114.99.14` | `80` | 2.91ms | ✅ فعال |
| 4 | `104.17.66.218` | `80` | 2.42ms | ✅ فعال |
| 5 | `45.159.216.111` | `80` | 2.53ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `118.174.143.38` | `4153` | 1328.66ms | ✅ فعال |
| 2 | `93.90.212.2` | `4153` | 157.80ms | ✅ فعال |
| 3 | `8.130.36.245` | `8080` | 315.91ms | ✅ فعال |
| 4 | `47.92.248.197` | `3127` | 239.49ms | ✅ فعال |
| 5 | `8.209.96.245` | `3128` | 110.73ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `157.175.196.122` | `8535` | 187.73ms | ✅ فعال |
| 2 | `157.175.152.104` | `8079` | 184.96ms | ✅ فعال |
| 3 | `147.75.68.201` | `9443` | 52.50ms | ✅ فعال |
| 4 | `157.230.220.25` | `4857` | 26.54ms | ✅ فعال |
| 5 | `40.192.3.100` | `331` | 229.68ms | ✅ فعال |
