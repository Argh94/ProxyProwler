...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:52 17-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `104.17.245.162` | `80` | 1.58ms | ✅ فعال |
| 2 | `198.105.122.8` | `6581` | 146.06ms | ✅ فعال |
| 3 | `46.254.93.172` | `80` | 1.61ms | ✅ فعال |
| 4 | `104.25.1.120` | `80` | 1.62ms | ✅ فعال |
| 5 | `45.249.59.62` | `6038` | 8.36ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `199.180.9.96` | `6116` | 69.36ms | ✅ فعال |
| 2 | `93.184.7.73` | `1080` | 2275.86ms | ✅ فعال |
| 3 | `74.119.144.60` | `4145` | 114.73ms | ✅ فعال |
| 4 | `84.52.123.163` | `4145` | 184.81ms | ✅ فعال |
| 5 | `72.205.0.67` | `4145` | 124.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `46.205.246.63` | `8080` | 218.53ms | ✅ فعال |
| 2 | `139.162.13.186` | `8888` | 168.39ms | ✅ فعال |
| 3 | `51.16.56.189` | `3127` | 200.76ms | ✅ فعال |
| 4 | `13.125.7.17` | `28070` | 133.43ms | ✅ فعال |
| 5 | `40.192.27.104` | `74` | 212.96ms | ✅ فعال |
