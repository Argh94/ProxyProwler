...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 22:25 16-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `184.170.245.148` | `4145` | 93.74ms | ✅ فعال |
| 2 | `144.31.222.106` | `7890` | 149.06ms | ✅ فعال |
| 3 | `46.37.123.166` | `1081` | 106.10ms | ✅ فعال |
| 4 | `175.27.250.85` | `44193` | 229.71ms | ✅ فعال |
| 5 | `69.55.49.177` | `38182` | 27.83ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `177.66.43.189` | `4145` | 161.01ms | ✅ فعال |
| 2 | `8.211.49.86` | `119` | 106.74ms | ✅ فعال |
| 3 | `46.181.243.194` | `1080` | 297.10ms | ✅ فعال |
| 4 | `47.238.134.126` | `51` | 181.95ms | ✅ فعال |
| 5 | `5.188.190.218` | `80` | 135.26ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 136.98ms | ✅ فعال |
| 2 | `203.174.15.138` | `8080` | 216.05ms | ✅ فعال |
| 3 | `200.82.238.153` | `999` | 92.88ms | ✅ فعال |
| 4 | `104.129.194.43` | `10336` | 17.19ms | ✅ فعال |
| 5 | `210.201.86.72` | `8080` | 1233.58ms | ✅ فعال |
