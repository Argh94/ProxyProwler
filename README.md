...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:57 15-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.115.215` | `80` | 16.29ms | ✅ فعال |
| 2 | `192.200.160.146` | `80` | 9.14ms | ✅ فعال |
| 3 | `66.81.247.51` | `80` | 9.05ms | ✅ فعال |
| 4 | `104.21.24.117` | `80` | 8.60ms | ✅ فعال |
| 5 | `160.153.0.109` | `80` | 8.81ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `103.146.170.233` | `5678` | 228.89ms | ✅ فعال |
| 2 | `142.147.244.225` | `6469` | 61.57ms | ✅ فعال |
| 3 | `95.43.244.15` | `4153` | 1191.26ms | ✅ فعال |
| 4 | `200.123.109.166` | `4153` | 2245.46ms | ✅ فعال |
| 5 | `138.68.60.8` | `80` | 16.40ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `15.168.235.57` | `8082` | 115.98ms | ✅ فعال |
| 2 | `40.192.3.100` | `4482` | 221.47ms | ✅ فعال |
| 3 | `15.160.186.74` | `147` | 151.54ms | ✅ فعال |
| 4 | `43.208.25.125` | `21503` | 205.42ms | ✅ فعال |
| 5 | `34.216.224.9` | `8999` | 35.70ms | ✅ فعال |
