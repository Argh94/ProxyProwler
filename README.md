...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 07:06 28-02-1405 (به وقت ایران)</p>
...
### 🔗 SOCKS5 Proxies (41 Active)

| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `192.252.208.70` | `14282` | 64.84ms | ✅ فعال |
| 2 | `95.106.209.89` | `4145` | 132.46ms | ✅ فعال |
| 3 | `41.220.16.218` | `80` | 234.41ms | ✅ فعال |
| 4 | `206.123.156.182` | `10128` | 1166.22ms | ✅ فعال |
| 5 | `164.132.168.87` | `50161` | 91.42ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `41.169.151.154` | `4153` | 295.88ms | ✅ فعال |
| 2 | `176.214.78.230` | `5678` | 128.93ms | ✅ فعال |
| 3 | `93.184.7.73` | `1080` | 1136.48ms | ✅ فعال |
| 4 | `8.211.194.78` | `5800` | 80.78ms | ✅ فعال |
| 5 | `103.166.39.81` | `3629` | 248.32ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `185.73.103.23` | `3128` | 98.30ms | ✅ فعال |
| 2 | `104.129.194.43` | `10336` | 6.00ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 1088.04ms | ✅ فعال |
| 4 | `129.154.225.163` | `8100` | 1251.74ms | ✅ فعال |
| 5 | `104.129.194.44` | `10336` | 6.12ms | ✅ فعال |
