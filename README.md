...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 21:59 14-10-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `103.130.70.253` | `83` | 1262.81ms | ✅ فعال |
| 2 | `104.24.254.249` | `80` | 2.84ms | ✅ فعال |
| 3 | `172.67.195.171` | `80` | 2.56ms | ✅ فعال |
| 4 | `31.58.18.207` | `6476` | 77.34ms | ✅ فعال |
| 5 | `104.19.16.115` | `80` | 2.24ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `119.13.111.169` | `4006` | 225.63ms | ✅ فعال |
| 2 | `107.173.36.92` | `5547` | 25.87ms | ✅ فعال |
| 3 | `47.243.175.55` | `443` | 209.09ms | ✅ فعال |
| 4 | `8.213.195.191` | `37` | 255.31ms | ✅ فعال |
| 5 | `166.88.64.144` | `6527` | 69.72ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `40.177.211.224` | `215` | 72.16ms | ✅ فعال |
| 2 | `3.110.127.255` | `48200` | 190.09ms | ✅ فعال |
| 3 | `45.70.236.194` | `999` | 2130.25ms | ✅ فعال |
| 4 | `15.160.148.69` | `49547` | 93.05ms | ✅ فعال |
| 5 | `202.154.18.1` | `8080` | 255.70ms | ✅ فعال |
