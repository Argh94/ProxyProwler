...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:40 26-05-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `45.135.139.160` | `6463` | 79.58ms | ✅ فعال |
| 2 | `111.119.162.248` | `10953` | 189.36ms | ✅ فعال |
| 3 | `47.250.115.134` | `1080` | 228.78ms | ✅ فعال |
| 4 | `47.238.130.212` | `8008` | 802.49ms | ✅ فعال |
| 5 | `144.91.121.61` | `1088` | 98.02ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `8.213.156.191` | `1080` | 888.63ms | ✅ فعال |
| 2 | `172.105.192.212` | `9080` | 158.58ms | ✅ فعال |
| 3 | `82.132.19.108` | `4153` | 109.46ms | ✅ فعال |
| 4 | `23.27.208.226` | `5936` | 32.65ms | ✅ فعال |
| 5 | `45.43.70.105` | `6392` | 76.41ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `195.57.239.25` | `8080` | 122.50ms | ✅ فعال |
| 2 | `176.57.189.138` | `3128` | 2365.51ms | ✅ فعال |
| 3 | `203.174.15.83` | `8080` | 235.96ms | ✅ فعال |
| 4 | `138.2.64.185` | `8118` | 222.24ms | ✅ فعال |
| 5 | `45.174.168.36` | `999` | 58.22ms | ✅ فعال |
