...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 12:53 05-11-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `141.101.115.255` | `80` | 2.40ms | ✅ فعال |
| 2 | `45.131.208.142` | `80` | 2.63ms | ✅ فعال |
| 3 | `104.25.1.203` | `80` | 2.89ms | ✅ فعال |
| 4 | `45.131.4.19` | `80` | 2.28ms | ✅ فعال |
| 5 | `45.43.81.11` | `5658` | 91.30ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `84.52.123.163` | `4145` | 124.14ms | ✅ فعال |
| 2 | `5.199.166.246` | `9080` | 209.23ms | ✅ فعال |
| 3 | `8.209.68.1` | `8081` | 110.52ms | ✅ فعال |
| 4 | `47.243.175.55` | `443` | 194.33ms | ✅ فعال |
| 5 | `8.209.253.237` | `8499` | 149.44ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `54.90.159.174` | `8369` | 16.84ms | ✅ فعال |
| 2 | `23.88.88.102` | `80` | 118.87ms | ✅ فعال |
| 3 | `27.34.242.98` | `80` | 256.19ms | ✅ فعال |
| 4 | `18.183.141.82` | `52996` | 141.64ms | ✅ فعال |
| 5 | `78.12.193.250` | `52795` | 50.89ms | ✅ فعال |
