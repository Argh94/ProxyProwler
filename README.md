...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 04:59 19-08-1404 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `172.67.193.241` | `80` | 19.20ms | ✅ فعال |
| 2 | `172.64.68.249` | `80` | 19.52ms | ✅ فعال |
| 3 | `160.153.1.207` | `80` | 19.56ms | ✅ فعال |
| 4 | `45.12.30.162` | `80` | 19.40ms | ✅ فعال |
| 5 | `185.18.250.209` | `80` | 19.60ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `89.249.193.50` | `5788` | 19.34ms | ✅ فعال |
| 2 | `212.127.95.235` | `8081` | 164.50ms | ✅ فعال |
| 3 | `45.56.71.129` | `1081` | 40.49ms | ✅ فعال |
| 4 | `178.220.148.82` | `10801` | 2234.47ms | ✅ فعال |
| 5 | `38.153.139.181` | `9857` | 10.84ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `51.20.126.89` | `58339` | 169.94ms | ✅ فعال |
| 2 | `35.181.173.74` | `12496` | 154.77ms | ✅ فعال |
| 3 | `178.32.123.218` | `1080` | 158.82ms | ✅ فعال |
| 4 | `196.189.44.49` | `1234` | 224.91ms | ✅ فعال |
| 5 | `40.192.27.104` | `37` | 214.08ms | ✅ فعال |
