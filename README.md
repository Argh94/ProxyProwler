...
<div align="center">
  <p><strong>آخرین به‌روزرسانی:</strong> 06:12 07-02-1405 (به وقت ایران)</p>
...
|---|---------------|-------------|-------------|----------------|
| 1 | `199.102.104.70` | `4145` | 75.85ms | ✅ فعال |
| 2 | `86.102.77.67` | `1080` | 222.10ms | ✅ فعال |
| 3 | `107.173.36.157` | `5612` | 21.70ms | ✅ فعال |
| 4 | `58.19.55.7` | `15253` | 244.91ms | ✅ فعال |
| 5 | `206.123.156.215` | `21496` | 1110.91ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `213.19.205.18` | `54321` | 88.35ms | ✅ فعال |
| 2 | `82.132.19.108` | `4153` | 1146.73ms | ✅ فعال |
| 3 | `142.111.255.47` | `5336` | 71.08ms | ✅ فعال |
| 4 | `173.230.129.71` | `80` | 14.86ms | ✅ فعال |
| 5 | `46.8.60.2` | `1080` | 1160.11ms | ✅ فعال |
...
| # | سرور (Server) | پورت (Port) | پینگ (Ping) | وضعیت (Status) |
|---|---------------|-------------|-------------|----------------|
| 1 | `74.82.50.155` | `3128` | 171.64ms | ✅ فعال |
| 2 | `190.7.138.78` | `80` | 92.23ms | ✅ فعال |
| 3 | `220.128.223.136` | `8082` | 198.41ms | ✅ فعال |
| 4 | `8.219.97.248` | `80` | 223.61ms | ✅ فعال |
| 5 | `13.127.170.8` | `3128` | 204.56ms | ✅ فعال |
